...
public abstract class f {
    ...
    private static final boolean f6434a;
    ...
    static {
        ...
        if (i10 == 26) {
            ...
            if (str2 != null) {
                if (StringsKt.a0(StringsKt.P0(str2, "SAMSUNG-"), "SM-", false, 2, null)) {
                    zContains = true;
                } else {
    ...
    public static final m a(q qVar) {
        int i10 = Build.VERSION.SDK_INT;
        return (i10 < 26 || f6434a) ? new o(false) : (i10 == 26 || i10 == 27) ? new p(qVar) : new o(true);
    }
}
