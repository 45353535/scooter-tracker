...
public abstract class SimpleThreadSafeToggle implements Toggle {
    ...
    private boolean f75314b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private final ArrayList f75315c;

    public SimpleThreadSafeToggle(boolean z10, @NotNull String str) {
        this.tag = str;
        this.f75314b = z10;
        this.f75315c = new ArrayList();
    }
    ...
    public synchronized void registerObserver(@NotNull ToggleObserver toggleObserver, boolean sticky) {
        this.f75315c.add(toggleObserver);
        if (sticky) {
