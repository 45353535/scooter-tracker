...
public final class TimePassedChecker {
    ...
    public final boolean didTimePassSeconds(long lastTimeSeconds, long intervalSeconds, @NotNull String tag) {
        long jCurrentTimeSeconds = this.f75304a.currentTimeSeconds();
