...
public final class CollectionUtils {
    ...
    public static final <T> T getFromMapIgnoreCase(@NotNull Map<String, ? extends T> map, @NotNull String key) {
        ...
        while (true) {
            ...
            if (charSequence != null && charSequence.length() != 0 && StringsKt.N((String) entry.getKey(), key, true)) {
                break;
            }
        }
    ...
    public static final <T> Set<T> unmodifiableSetOf(@NotNull T... values) {
        return DesugarCollections.unmodifiableSet(ArraysKt.toHashSet(values));
    }
}
