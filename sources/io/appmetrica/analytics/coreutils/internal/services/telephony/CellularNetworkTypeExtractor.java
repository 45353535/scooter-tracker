...
public final class CellularNetworkTypeExtractor {
    ...
    private final FunctionWithThrowable f75301b;
    ...
    public CellularNetworkTypeExtractor(@NotNull Context context) {
        ...
        this.f75301b = AndroidUtils.isApiAchieved(24) ? new a() : new b();
    }
    ...
    public final String getNetworkType() {
        return CellularNetworkTypeConverter.convert((Integer) SystemServiceUtils.accessSystemServiceByNameSafely(this.context, "phone", "Extracting cellular networkType", "TelephonyManager", this.f75301b));
    }
}
