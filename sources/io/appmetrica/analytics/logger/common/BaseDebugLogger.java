...
public abstract class BaseDebugLogger {
    ...
    public void error(@NonNull String str, @Nullable Throwable th2) {
    }

    public void error(@NonNull String str, @Nullable Throwable th2, @Nullable String str2, @Nullable Object... objArr) {
    }
}
