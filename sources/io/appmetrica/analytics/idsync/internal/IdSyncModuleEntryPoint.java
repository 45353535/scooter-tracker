...
public final class IdSyncModuleEntryPoint extends ModuleServiceEntryPoint<IdSyncConfig> implements RemoteConfigUpdateListener<IdSyncConfig> {
    ...
    private final IdSyncModuleEntryPoint$remoteConfigExtensionConfiguration$1 f75459e;
    ...
    public IdSyncModuleEntryPoint() {
        e eVar = new e();
        this.f75455a = new d(eVar);
        this.f75456b = new c(eVar);
        this.identifier = "id-sync";
        this.f75459e = new RemoteConfigExtensionConfiguration<IdSyncConfig>() { // from class: io.appmetrica.analytics.idsync.internal.IdSyncModuleEntryPoint$remoteConfigExtensionConfiguration$1
    ...
    public synchronized void onRemoteConfigUpdated(@NotNull ModuleRemoteConfig<IdSyncConfig> config) {
        ...
        if (featuresConfig != null && (hVar = this.f75457c) != null) {
            hVar.b(featuresConfig);
        }
    }
}
