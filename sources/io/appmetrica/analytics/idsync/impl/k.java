...
public final class k extends MessageNano {
    ...
    public static volatile k[] f75412c;
    ...
    public final k a() {
        this.f75413a = WireFormatNano.EMPTY_BYTES;
        this.f75414b = WireFormatNano.EMPTY_BYTES_ARRAY;
        this.cachedSize = -1;
        return this;
    }
    ...
    public final int computeSerializedSize() {
        ...
        if (!Arrays.equals(this.f75413a, WireFormatNano.EMPTY_BYTES)) {
            iComputeSerializedSize += CodedOutputByteBufferNano.computeBytesSize(1, this.f75413a);
        }
        byte[][] bArr = this.f75414b;
    ...
    public final void writeTo(CodedOutputByteBufferNano codedOutputByteBufferNano) throws IOException {
        if (!Arrays.equals(this.f75413a, WireFormatNano.EMPTY_BYTES)) {
            codedOutputByteBufferNano.writeBytes(1, this.f75413a);
        }
        byte[][] bArr = this.f75414b;
        if (bArr != null && bArr.length > 0) {
            int i10 = 0;
    ...
    public final k mergeFrom(CodedInputByteBufferNano codedInputByteBufferNano) throws IOException {
        while (true) {
            ...
            if (tag == 10) {
                this.f75413a = codedInputByteBufferNano.readBytes();
            } else if (tag != 18) {
