...
public enum EnumC5168ib {
    ...
    public final int f77427a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final String f77428b;

    static {
        for (EnumC5168ib enumC5168ib : values()) {
            K.put(Integer.valueOf(enumC5168ib.f77427a), enumC5168ib);
        }
    }

    EnumC5168ib(int i10, String str) {
        this.f77427a = i10;
        this.f77428b = str;
    }
    ...
    public static EnumC5168ib a(int i10) {
        EnumC5168ib enumC5168ib = (EnumC5168ib) K.get(Integer.valueOf(i10));
        return enumC5168ib == null ? EVENT_TYPE_UNDEFINED : enumC5168ib;
    }
}
