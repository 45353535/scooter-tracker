...
public final class b5 implements a5 {
    ...
    private final x4 f83263a;

    public b5(x4 x4Var) {
        this.f83263a = (x4) io.sentry.util.w.c(x4Var, "SendFireAndForgetDirPath is required");
    }
    ...
    public w4 b(b1 b1Var, v7 v7Var) {
        ...
        String strA = this.f83263a.a();
        if (strA != null && a(strA, v7Var.getLogger())) {
            return c(new b0(b1Var, v7Var.getSerializer(), v7Var.getLogger(), v7Var.getFlushTimeoutMillis(), v7Var.getMaxQueueSize()), strA, v7Var.getLogger());
        }
