...
public final class CacheProto {
    ...
    static final h0.f internal_static_bidmachine_protobuf_RequestTokenPayload_SessionData_SessionPlacementDataEntry_fieldAccessorTable;
    ...
    static final h0.f internal_static_bidmachine_protobuf_RequestTokenPayload_SessionData_SessionPlacementData_fieldAccessorTable;
    static final Descriptors.Descriptor internal_static_bidmachine_protobuf_RequestTokenPayload_SessionData_descriptor;
    static final h0.f internal_static_bidmachine_protobuf_RequestTokenPayload_SessionData_fieldAccessorTable;
    static final Descriptors.Descriptor internal_static_bidmachine_protobuf_RequestTokenPayload_descriptor;
    static final h0.f internal_static_bidmachine_protobuf_RequestTokenPayload_fieldAccessorTable;
    static final Descriptors.Descriptor internal_static_bidmachine_protobuf_ResponsePayload_descriptor;
    static final h0.f internal_static_bidmachine_protobuf_ResponsePayload_fieldAccessorTable;

    static {
        Descriptors.Descriptor descriptor2 = getDescriptor().getMessageTypes().get(0);
        internal_static_bidmachine_protobuf_ResponsePayload_descriptor = descriptor2;
        internal_static_bidmachine_protobuf_ResponsePayload_fieldAccessorTable = new h0.f(descriptor2, new String[]{"CacheTime", "RequestItemSpec", "ResponseCacheUrl", "ResponseCache", "PayloadOneof"});
        Descriptors.Descriptor descriptor3 = getDescriptor().getMessageTypes().get(1);
        internal_static_bidmachine_protobuf_RequestTokenPayload_descriptor = descriptor3;
        internal_static_bidmachine_protobuf_RequestTokenPayload_fieldAccessorTable = new h0.f(descriptor3, new String[]{"TokenHashValue", "AdType", "PlacementData", "SessionData", RtspHeaders.SESSION, "DeviceData", "UserData", "AppData", "HbPlacement", "CustomData", "Placement", "Ext"});
        Descriptors.Descriptor descriptor4 = descriptor3.getNestedTypes().get(0);
        internal_static_bidmachine_protobuf_RequestTokenPayload_SessionData_descriptor = descriptor4;
        internal_static_bidmachine_protobuf_RequestTokenPayload_SessionData_fieldAccessorTable = new h0.f(descriptor4, new String[]{"SessionId", "Sessionduration", "SessionPlacementData"});
        ...
        internal_static_bidmachine_protobuf_RequestTokenPayload_SessionData_SessionPlacementData_fieldAccessorTable = new h0.f(descriptor5, new String[]{"Impdepth", "Lastbundle", "Lastadomain", "Clickrate", "Lastclick", "Completionrate"});
        ...
        internal_static_bidmachine_protobuf_RequestTokenPayload_SessionData_SessionPlacementDataEntry_fieldAccessorTable = new h0.f(descriptor6, new String[]{"Key", "Value"});
        ...
        internal_static_bidmachine_protobuf_RequestTokenPayload_CustomDataEntry_fieldAccessorTable = new h0.f(descriptor7, new String[]{"Key", "Value"});
        b.a();
