...
public final class AnalyticsProto {
    ...
    static final h0.f internal_static_bidmachine_protobuf_analytics_AuctionContext_fieldAccessorTable;
    static final Descriptors.Descriptor internal_static_bidmachine_protobuf_analytics_BidEvent_descriptor;
    static final h0.f internal_static_bidmachine_protobuf_analytics_BidEvent_fieldAccessorTable;

    static {
        Descriptors.Descriptor descriptor2 = getDescriptor().getMessageTypes().get(0);
        internal_static_bidmachine_protobuf_analytics_AuctionContext_descriptor = descriptor2;
        internal_static_bidmachine_protobuf_analytics_AuctionContext_fieldAccessorTable = new h0.f(descriptor2, new String[]{RtspHeaders.TIMESTAMP, "Id", "Test", "At", "PlacementTag", "Item", "Placement", "Context"});
        Descriptors.Descriptor descriptor3 = getDescriptor().getMessageTypes().get(1);
        internal_static_bidmachine_protobuf_analytics_BidEvent_descriptor = descriptor3;
        internal_static_bidmachine_protobuf_analytics_BidEvent_fieldAccessorTable = new h0.f(descriptor3, new String[]{RtspHeaders.TIMESTAMP, "Bidid", "Seat", "AuctionContext", "Bid", t.f66040o});
        b.a();
