...
public final class SDKAnalyticProto {
    ...
    static final h0.f internal_static_bidmachine_protobuf_analytics_SDKAnalyticPayload_Metric_MetricData_Dimension_fieldAccessorTable;
    ...
    static final h0.f internal_static_bidmachine_protobuf_analytics_SDKAnalyticPayload_Metric_MetricData_Error_fieldAccessorTable;
    ...
    static final h0.f internal_static_bidmachine_protobuf_analytics_SDKAnalyticPayload_Metric_MetricData_Measure_fieldAccessorTable;
    ...
    static final h0.f internal_static_bidmachine_protobuf_analytics_SDKAnalyticPayload_Metric_MetricData_fieldAccessorTable;
    static final Descriptors.Descriptor internal_static_bidmachine_protobuf_analytics_SDKAnalyticPayload_Metric_descriptor;
    static final h0.f internal_static_bidmachine_protobuf_analytics_SDKAnalyticPayload_Metric_fieldAccessorTable;
    static final Descriptors.Descriptor internal_static_bidmachine_protobuf_analytics_SDKAnalyticPayload_descriptor;
    static final h0.f internal_static_bidmachine_protobuf_analytics_SDKAnalyticPayload_fieldAccessorTable;

    static {
        Descriptors.Descriptor descriptor2 = getDescriptor().getMessageTypes().get(0);
        internal_static_bidmachine_protobuf_analytics_SDKAnalyticPayload_descriptor = descriptor2;
        internal_static_bidmachine_protobuf_analytics_SDKAnalyticPayload_fieldAccessorTable = new h0.f(descriptor2, new String[]{"Metrics"});
        Descriptors.Descriptor descriptor3 = descriptor2.getNestedTypes().get(0);
        internal_static_bidmachine_protobuf_analytics_SDKAnalyticPayload_Metric_descriptor = descriptor3;
        internal_static_bidmachine_protobuf_analytics_SDKAnalyticPayload_Metric_fieldAccessorTable = new h0.f(descriptor3, new String[]{"Context", "Data"});
        Descriptors.Descriptor descriptor4 = descriptor3.getNestedTypes().get(0);
        internal_static_bidmachine_protobuf_analytics_SDKAnalyticPayload_Metric_MetricData_descriptor = descriptor4;
        internal_static_bidmachine_protobuf_analytics_SDKAnalyticPayload_Metric_MetricData_fieldAccessorTable = new h0.f(descriptor4, new String[]{RtspHeaders.TIMESTAMP, "Name", "Dimensions", "Measures", "Error", "Ts"});
        ...
        internal_static_bidmachine_protobuf_analytics_SDKAnalyticPayload_Metric_MetricData_Dimension_fieldAccessorTable = new h0.f(descriptor5, new String[]{"Name", "Value"});
        ...
        internal_static_bidmachine_protobuf_analytics_SDKAnalyticPayload_Metric_MetricData_Measure_fieldAccessorTable = new h0.f(descriptor6, new String[]{"Name", "Value"});
        ...
        internal_static_bidmachine_protobuf_analytics_SDKAnalyticPayload_Metric_MetricData_Error_fieldAccessorTable = new h0.f(descriptor7, new String[]{"Name", "Description"});
        k2.a();
    }
