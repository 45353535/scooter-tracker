...
@Deprecated
public final class RegsCcpaExtension extends h0 implements RegsCcpaExtensionOrBuilder {
    private static final RegsCcpaExtension DEFAULT_INSTANCE = new RegsCcpaExtension();
    private static final p1 PARSER = new b() { // from class: io.bidmachine.protobuf.RegsCcpaExtension.1
        @Override // com.explorestack.protobuf.p1
        public RegsCcpaExtension parsePartialFrom(l lVar, w wVar) throws InvalidProtocolBufferException {
            return new RegsCcpaExtension(lVar, wVar);
        }
    };
    ...
    public static RegsCcpaExtension parseDelimitedFrom(InputStream inputStream) throws IOException {
        return (RegsCcpaExtension) h0.parseDelimitedWithIOException(PARSER, inputStream);
    }
    ...
    public int getSerializedSize() {
        ...
        int iComputeStringSize = (!getUsPrivacyBytes().isEmpty() ? h0.computeStringSize(1, this.usPrivacy_) : 0) + this.unknownFields.getSerializedSize();
    ...
    public void writeTo(n nVar) throws IOException {
        if (!getUsPrivacyBytes().isEmpty()) {
            h0.writeString(nVar, 1, this.usPrivacy_);
        }
        this.unknownFields.writeTo(nVar);
    }

    public static final class Builder extends h0.b implements RegsCcpaExtensionOrBuilder {
        ...
        public Builder mergeFrom(RegsCcpaExtension regsCcpaExtension) {
            ...
            mergeUnknownFields(((h0) regsCcpaExtension).unknownFields);
            onChanged();
            return this;
        }
        ...
        */
        public io.bidmachine.protobuf.RegsCcpaExtension.Builder mergeFrom(com.explorestack.protobuf.l r3, com.explorestack.protobuf.w r4) throws java.lang.Throwable {
            /*
                r2 = this;
                r0 = 0
                com.explorestack.protobuf.p1 r1 = io.bidmachine.protobuf.RegsCcpaExtension.access$600()     // Catch: java.lang.Throwable -> L11 com.explorestack.protobuf.InvalidProtocolBufferException -> L13
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.bidmachine.protobuf.RegsCcpaExtension.Builder.mergeFrom(com.explorestack.protobuf.l, com.explorestack.protobuf.w):io.bidmachine.protobuf.RegsCcpaExtension$Builder");
        }
    }
    ...
    public static RegsCcpaExtension parseFrom(ByteBuffer byteBuffer, w wVar) throws InvalidProtocolBufferException {
        return (RegsCcpaExtension) PARSER.parseFrom(byteBuffer, wVar);
    }

    private RegsCcpaExtension(h0.b bVar) {
        super(bVar);
        this.memoizedIsInitialized = (byte) -1;
    }

    public static RegsCcpaExtension parseDelimitedFrom(InputStream inputStream, w wVar) throws IOException {
        return (RegsCcpaExtension) h0.parseDelimitedWithIOException(PARSER, inputStream, wVar);
    }
    ...
    public static RegsCcpaExtension parseFrom(ByteString byteString, w wVar) throws InvalidProtocolBufferException {
        return (RegsCcpaExtension) PARSER.parseFrom(byteString, wVar);
    }
    ...
    public static RegsCcpaExtension parseFrom(byte[] bArr, w wVar) throws InvalidProtocolBufferException {
        return (RegsCcpaExtension) PARSER.parseFrom(bArr, wVar);
    }

    public static RegsCcpaExtension parseFrom(InputStream inputStream) throws IOException {
        return (RegsCcpaExtension) h0.parseWithIOException(PARSER, inputStream);
    }

    private RegsCcpaExtension(l lVar, w wVar) throws InvalidProtocolBufferException {
        this();
        wVar.getClass();
        r2.b bVarG = r2.g();
        boolean z10 = false;
    ...
    public static RegsCcpaExtension parseFrom(InputStream inputStream, w wVar) throws IOException {
        return (RegsCcpaExtension) h0.parseWithIOException(PARSER, inputStream, wVar);
    }

    public static RegsCcpaExtension parseFrom(l lVar) throws IOException {
        return (RegsCcpaExtension) h0.parseWithIOException(PARSER, lVar);
    }

    public static RegsCcpaExtension parseFrom(l lVar, w wVar) throws IOException {
        return (RegsCcpaExtension) h0.parseWithIOException(PARSER, lVar, wVar);
    }
}
