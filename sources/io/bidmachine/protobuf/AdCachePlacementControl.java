...
public final class AdCachePlacementControl extends h0 implements AdCachePlacementControlOrBuilder {
    ...
    private static final p1 PARSER = new b() { // from class: io.bidmachine.protobuf.AdCachePlacementControl.1
        @Override // com.explorestack.protobuf.p1
        public AdCachePlacementControl parsePartialFrom(l lVar, w wVar) throws InvalidProtocolBufferException {
            return new AdCachePlacementControl(lVar, wVar);
        }
    };
    ...
    public static AdCachePlacementControl parseDelimitedFrom(InputStream inputStream) throws IOException {
        return (AdCachePlacementControl) h0.parseDelimitedWithIOException(PARSER, inputStream);
    }
    ...
    public static final class Builder extends h0.b implements AdCachePlacementControlOrBuilder {
        private int maxAge_;
        private int maxCacheSize_;
        private int maxRetainCount_;
        ...
        public Builder mergeFrom(AdCachePlacementControl adCachePlacementControl) {
            ...
            mergeUnknownFields(((h0) adCachePlacementControl).unknownFields);
            onChanged();
            return this;
        }
        ...
        */
        public io.bidmachine.protobuf.AdCachePlacementControl.Builder mergeFrom(com.explorestack.protobuf.l r3, com.explorestack.protobuf.w r4) throws java.lang.Throwable {
            /*
                r2 = this;
                r0 = 0
                com.explorestack.protobuf.p1 r1 = io.bidmachine.protobuf.AdCachePlacementControl.access$800()     // Catch: java.lang.Throwable -> L11 com.explorestack.protobuf.InvalidProtocolBufferException -> L13
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: io.bidmachine.protobuf.AdCachePlacementControl.Builder.mergeFrom(com.explorestack.protobuf.l, com.explorestack.protobuf.w):io.bidmachine.protobuf.AdCachePlacementControl$Builder");
        }
    }
    ...
    public static AdCachePlacementControl parseFrom(ByteBuffer byteBuffer, w wVar) throws InvalidProtocolBufferException {
        return (AdCachePlacementControl) PARSER.parseFrom(byteBuffer, wVar);
    }

    private AdCachePlacementControl(h0.b bVar) {
        super(bVar);
        this.memoizedIsInitialized = (byte) -1;
    }

    public static AdCachePlacementControl parseDelimitedFrom(InputStream inputStream, w wVar) throws IOException {
        return (AdCachePlacementControl) h0.parseDelimitedWithIOException(PARSER, inputStream, wVar);
    }
    ...
    public static AdCachePlacementControl parseFrom(ByteString byteString, w wVar) throws InvalidProtocolBufferException {
        return (AdCachePlacementControl) PARSER.parseFrom(byteString, wVar);
    }
    ...
    public static AdCachePlacementControl parseFrom(byte[] bArr, w wVar) throws InvalidProtocolBufferException {
        return (AdCachePlacementControl) PARSER.parseFrom(bArr, wVar);
    }

    private AdCachePlacementControl(l lVar, w wVar) throws InvalidProtocolBufferException {
        this();
        wVar.getClass();
        r2.b bVarG = r2.g();
        boolean z10 = false;
    ...
    public static AdCachePlacementControl parseFrom(InputStream inputStream) throws IOException {
        return (AdCachePlacementControl) h0.parseWithIOException(PARSER, inputStream);
    }

    public static AdCachePlacementControl parseFrom(InputStream inputStream, w wVar) throws IOException {
        return (AdCachePlacementControl) h0.parseWithIOException(PARSER, inputStream, wVar);
    }

    public static AdCachePlacementControl parseFrom(l lVar) throws IOException {
        return (AdCachePlacementControl) h0.parseWithIOException(PARSER, lVar);
    }

    public static AdCachePlacementControl parseFrom(l lVar, w wVar) throws IOException {
        return (AdCachePlacementControl) h0.parseWithIOException(PARSER, lVar, wVar);
    }
}
