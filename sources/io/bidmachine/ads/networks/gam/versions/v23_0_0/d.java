...
class d extends InternalGAMInterstitialAd {
    ...
    private AdManagerInterstitialAd f79268a;

    private static final class a extends AdManagerInterstitialAdLoadCallback {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final d f79269a;

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        private final InternalLoadListener f79270b;

        public a(d dVar, InternalLoadListener internalLoadListener) {
            this.f79269a = dVar;
            this.f79270b = internalLoadListener;
        }

        @Override // com.google.android.gms.ads.AdLoadCallback
        public void onAdFailedToLoad(LoadAdError loadAdError) {
            this.f79270b.onAdLoadFailed(this.f79269a, new ae.a(ae.a.f4247q, loadAdError.getCode(), loadAdError.getMessage()));
        }

        @Override // com.google.android.gms.ads.AdLoadCallback
        public void onAdLoaded(AdManagerInterstitialAd adManagerInterstitialAd) {
            this.f79269a.f79268a = adManagerInterstitialAd;
            this.f79269a.onAdLoaded();
            this.f79270b.onAdLoaded(this.f79269a);
        }
    }
    ...
    protected void destroyAd() {
        AdManagerInterstitialAd adManagerInterstitialAd = this.f79268a;
