...
class e extends InternalGAMRewardedAd {
    ...
    private static final class b extends RewardedAdLoadCallback {
        ...
        private final InternalLoadListener f79249b;

        public b(e eVar, InternalLoadListener internalLoadListener) {
            this.f79248a = eVar;
            this.f79249b = internalLoadListener;
        }

        @Override // com.google.android.gms.ads.AdLoadCallback
        public void onAdFailedToLoad(LoadAdError loadAdError) {
            this.f79249b.onAdLoadFailed(this.f79248a, new ae.a(ae.a.f4247q, loadAdError.getCode(), loadAdError.getMessage()));
        }

        @Override // com.google.android.gms.ads.AdLoadCallback
        public void onAdLoaded(RewardedAd rewardedAd) {
            this.f79248a.f79247a = rewardedAd;
            this.f79248a.onAdLoaded();
            this.f79249b.onAdLoaded(this.f79248a);
        }
    }
    ...
    protected void destroyAd() {
        RewardedAd rewardedAd = this.f79247a;
        if (rewardedAd != null) {
    ...
    protected void showAd(Activity activity, InternalGAMFullscreenAdPresentListener internalGAMFullscreenAdPresentListener) {
        ...
        if (rewardedAd == null) {
            ...
            this.f79247a.show(activity, new c());
        }
    }
}
