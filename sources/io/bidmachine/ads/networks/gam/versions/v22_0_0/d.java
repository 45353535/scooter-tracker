...
class d extends InternalGAMInterstitialAd {
    ...
    private AdManagerInterstitialAd f79256a;

    private static final class a extends AdManagerInterstitialAdLoadCallback {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final d f79257a;

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        private final InternalLoadListener f79258b;

        public a(d dVar, InternalLoadListener internalLoadListener) {
            this.f79257a = dVar;
            this.f79258b = internalLoadListener;
        }

        @Override // com.google.android.gms.ads.AdLoadCallback
        public void onAdFailedToLoad(LoadAdError loadAdError) {
            this.f79258b.onAdLoadFailed(this.f79257a, new ae.a(ae.a.f4247q, loadAdError.getCode(), loadAdError.getMessage()));
        }

        @Override // com.google.android.gms.ads.AdLoadCallback
        public void onAdLoaded(AdManagerInterstitialAd adManagerInterstitialAd) {
            this.f79257a.f79256a = adManagerInterstitialAd;
            this.f79257a.onAdLoaded();
            this.f79258b.onAdLoaded(this.f79257a);
        }
    }
    ...
    protected void destroyAd() {
        AdManagerInterstitialAd adManagerInterstitialAd = this.f79256a;
