...
class d extends InternalRewardedAd {
    ...
    private RewardedAd f79359a;

    /* JADX INFO: Access modifiers changed from: private */
    static final class b extends RewardedAdLoadCallback {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final d f79360a;

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        private final InternalLoadListener f79361b;

        public b(d dVar, InternalLoadListener internalLoadListener) {
            this.f79360a = dVar;
            this.f79361b = internalLoadListener;
        }

        @Override // com.google.android.gms.ads.AdLoadCallback
        public void onAdFailedToLoad(final LoadAdError loadAdError) {
            this.f79360a.onBackground(new Runnable() { // from class: io.bidmachine.ads.networks.gam_dynamic.versions.v22_0_0.m
                @Override // java.lang.Runnable
                public final void run() {
                    this.f79376b.a(loadAdError);
                }
            });
        }
        ...
        public /* synthetic */ void a(RewardedAd rewardedAd) {
            ...
            this.f79360a.onAdLoaded(internalAdLoadDataA);
            this.f79361b.onAdLoaded(this.f79360a, internalAdLoadDataA);
        }

        @Override // com.google.android.gms.ads.AdLoadCallback
        public void onAdLoaded(final RewardedAd rewardedAd) {
            rewardedAd.setOnPaidEventListener(new c());
            this.f79360a.f79359a = rewardedAd;
            this.f79360a.onBackground(new Runnable() { // from class: io.bidmachine.ads.networks.gam_dynamic.versions.v22_0_0.l
                @Override // java.lang.Runnable
                public final void run() {
                    this.f79374b.a(rewardedAd);
                }
            });
        }
        ...
        public /* synthetic */ void a(LoadAdError loadAdError) {
            this.f79361b.onAdLoadFailed(this.f79360a, e.a(ae.a.f4247q, loadAdError));
        }
    }
    ...
    static final class c implements OnPaidEventListener {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final d f79362a;

        @Override // com.google.android.gms.ads.OnPaidEventListener
        public void onPaidEvent(final AdValue adValue) {
            this.f79362a.onBackground(new Runnable() { // from class: io.bidmachine.ads.networks.gam_dynamic.versions.v22_0_0.n
                @Override // java.lang.Runnable
                public final void run() {
                    this.f79378b.a(adValue);
                }
            });
        }
        ...
        public /* synthetic */ void a(AdValue adValue) {
            this.f79362a.onPaidEvent(e.a(adValue));
        }
    }
    ...
    private static final class C0939d implements OnUserEarnedRewardListener {
        private C0939d() {
        }
    ...
    protected void destroyAd() {
        RewardedAd rewardedAd = this.f79359a;
        if (rewardedAd != null) {
            rewardedAd.setFullScreenContentCallback(null);
            this.f79359a.setOnPaidEventListener(null);
            this.f79359a = null;
        }
    }
    ...
    protected void showAd(Activity activity, InternalFullscreenAdPresentListener internalFullscreenAdPresentListener) {
        ...
        if (rewardedAd == null) {
            ...
            this.f79359a.show(activity, new C0939d());
        }
    }
}
