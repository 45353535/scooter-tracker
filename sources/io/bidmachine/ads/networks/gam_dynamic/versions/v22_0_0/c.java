...
class c extends InternalInterstitialAd {
    ...
    private AdManagerInterstitialAd f79355a;
    ...
    static final class b extends AdManagerInterstitialAdLoadCallback {
        ...
        private final InternalLoadListener f79357b;

        public b(c cVar, InternalLoadListener internalLoadListener) {
            this.f79356a = cVar;
            this.f79357b = internalLoadListener;
        }

        @Override // com.google.android.gms.ads.AdLoadCallback
        public void onAdFailedToLoad(final LoadAdError loadAdError) {
            this.f79356a.onBackground(new Runnable() { // from class: io.bidmachine.ads.networks.gam_dynamic.versions.v22_0_0.i
                @Override // java.lang.Runnable
                public final void run() {
                    this.f79368b.a(loadAdError);
                }
            });
        }
        ...
        public /* synthetic */ void a(AdManagerInterstitialAd adManagerInterstitialAd) {
            ...
            this.f79356a.onAdLoaded(internalAdLoadDataA);
            this.f79357b.onAdLoaded(this.f79356a, internalAdLoadDataA);
        }

        @Override // com.google.android.gms.ads.AdLoadCallback
        public void onAdLoaded(final AdManagerInterstitialAd adManagerInterstitialAd) {
            adManagerInterstitialAd.setOnPaidEventListener(new C0938c());
            this.f79356a.f79355a = adManagerInterstitialAd;
            this.f79356a.onBackground(new Runnable() { // from class: io.bidmachine.ads.networks.gam_dynamic.versions.v22_0_0.j
                @Override // java.lang.Runnable
                public final void run() {
                    this.f79370b.a(adManagerInterstitialAd);
                }
            });
        }
        ...
        public /* synthetic */ void a(LoadAdError loadAdError) {
            this.f79357b.onAdLoadFailed(this.f79356a, e.a(ae.a.f4247q, loadAdError));
        }
    }
    ...
    static final class C0938c implements OnPaidEventListener {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final c f79358a;

        @Override // com.google.android.gms.ads.OnPaidEventListener
        public void onPaidEvent(final AdValue adValue) {
            this.f79358a.onBackground(new Runnable() { // from class: io.bidmachine.ads.networks.gam_dynamic.versions.v22_0_0.k
                @Override // java.lang.Runnable
                public final void run() {
                    this.f79372b.a(adValue);
                }
            });
        }

        private C0938c(@NonNull c cVar) {
            this.f79358a = cVar;
        }

        /* JADX INFO: Access modifiers changed from: private */
        public /* synthetic */ void a(AdValue adValue) {
            this.f79358a.onPaidEvent(e.a(adValue));
        }
    }
    ...
    protected void destroyAd() {
        AdManagerInterstitialAd adManagerInterstitialAd = this.f79355a;
        if (adManagerInterstitialAd != null) {
            adManagerInterstitialAd.setFullScreenContentCallback(null);
            this.f79355a.setOnPaidEventListener(null);
            this.f79355a = null;
        }
    }
