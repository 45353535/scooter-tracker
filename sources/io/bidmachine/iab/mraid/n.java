...
public final class n {
    ...
    public String toString() {
        return "MRAIDOrientationProperties{allowOrientationChange=" + this.f80241a + ", forceOrientation=" + b() + '}';
    }
}
