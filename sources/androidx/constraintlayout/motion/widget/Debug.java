...
public class Debug {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            for (int i11 = 0; i11 < fields.length; i11++) {
                ...
                try {
                    ...
                    if (field.getName().contains("To") && !obj.toString().equals(X1.f42014f)) {
    ...
    public static void dumpPoc(Object obj) {
        ...
        for (Field field : cls.getFields()) {
            try {
                ...
                if (field.getName().startsWith("layout_constraint") && ((!(obj2 instanceof Integer) || !obj2.toString().equals(X1.f42014f)) && ((!(obj2 instanceof Integer) || !obj2.toString().equals("0")) && ((!(obj2 instanceof Float) || !obj2.toString().equals(NastAdapter.ADAPTER_SDK_VERSION_NAME)) && (!(obj2 instanceof Float) || !obj2.toString().equals("0.5")))))) {
    ...
    public static void logStack(String str, String str2, int i10) {
        ...
        for (int i11 = 1; i11 <= iMin; i11++) {
            ...
            str3 = str3 + " ";
            Log.v(str, str2 + str3 + (".(" + stackTrace[i11].getFileName() + StringUtils.PROCESS_POSTFIX_DELIMITER + stackTrace[i11].getLineNumber() + ") " + stackTrace[i11].getMethodName()) + str3);
        }
    }
    ...
    public static String getName(Context context, int[] iArr) {
        ...
        try {
            String str = iArr.length + C4240b4.j.f42672d;
            int i10 = 0;
    ...
    public static void dumpLayoutParams(ViewGroup.LayoutParams layoutParams, String str) {
        ...
        for (Field field : layoutParams.getClass().getFields()) {
            try {
                ...
                if (name.contains("To") && !obj.toString().equals(X1.f42014f)) {
