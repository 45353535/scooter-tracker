    ...
    public long solverMeasure(ConstraintWidgetContainer constraintWidgetContainer, int i10, int i11, int i12, int i13, int i14, int i15, int i16, int i17, int i18) {
        ...
        if (z12) {
            for (int i24 = 0; i24 < size; i24++) {
                ConstraintWidget constraintWidget = constraintWidgetContainer2.mChildren.get(i24);
        ...
        if (!zDirectMeasureWithOrientation || i19 != 2) {
            ...
            if (size2 > 0) {
                ...
                boolean z16 = constraintWidgetContainer2.getVerticalDimensionBehaviour() == dimensionBehaviour2;
                ...
                while (true) {
                    ...
                    while (i31 < size2) {
                        ...
                        if ((!(constraintWidget3 instanceof Helper) || (constraintWidget3 instanceof VirtualLayout)) && !(constraintWidget3 instanceof Guideline) && constraintWidget3.getVisibility() != 8 && ((!z18 || !constraintWidget3.mHorizontalRun.mDimension.resolved || !constraintWidget3.mVerticalRun.mDimension.resolved) && !(constraintWidget3 instanceof VirtualLayout))) {
                            ...
                            boolean zMeasure2 = zNeedSolverPass | basicMeasure.measure(measurer, constraintWidget3, i32);
                            ...
                            zNeedSolverPass = (!constraintWidget3.hasBaseline() || baselineDistance == constraintWidget3.getBaselineDistance()) ? z10 : true;
                        }
                        i31++;
                        basicMeasure = this;
                    ...
                    i30++;
                    solveLinearSystem(constraintWidgetContainer, "intermediate pass", i30, i27, i28);
                    basicMeasure = this;
                    constraintWidgetContainer2 = constraintWidgetContainer;
                    i29 = 2;
