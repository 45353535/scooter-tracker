    ...
    public boolean isValidConnection(ConstraintAnchor constraintAnchor) {
        ...
        switch (type2) {
            ...
            case RIGHT:
                ...
                return constraintAnchor.getOwner() instanceof Guideline ? z10 || type == Type.CENTER_X : z10;
            case TOP:
            case BOTTOM:
                boolean z11 = type == Type.TOP || type == Type.BOTTOM;
                return constraintAnchor.getOwner() instanceof Guideline ? z11 || type == Type.CENTER_Y : z11;
            case BASELINE:
