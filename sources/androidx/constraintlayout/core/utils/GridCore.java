        ...
        try {
            ...
            if (this.mRows != 1 && this.mColumns != 1) {
                for (int i10 = 0; i10 < strArrSplit.length; i10++) {
                    String[] strArrSplit2 = strArrSplit[i10].trim().split(StringUtils.PROCESS_POSTFIX_DELIMITER);
            ...
            for (int i13 = 0; i13 < strArrSplit.length; i13++) {
                String[] strArrSplit4 = strArrSplit[i13].trim().split(StringUtils.PROCESS_POSTFIX_DELIMITER);
