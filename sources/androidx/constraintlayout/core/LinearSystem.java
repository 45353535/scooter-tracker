...
public class LinearSystem {
    ...
    private SolverVariable createVariable(String str, SolverVariable.Type type) {
        ...
        this.mNumColumns++;
        solverVariableAcquireSolverVariable.f4444id = i10;
    ...
    private void displayRows() {
        ...
        String str = "";
        for (int i10 = 0; i10 < this.mNumRows; i10++) {
            str = (str + this.mRows[i10]) + IOUtils.LINE_SEPARATOR_UNIX;
        }
                                ...
                                while (i16 < currentSize) {
                                    ...
                                    if (f14 > f13) {
                                        for (int i17 = 0; i17 < 9; i17++) {
                                            float f15 = variable.mStrengthVector[i17] / f14;
                                            if ((f15 < f12 && i17 == i15) || i17 > i15) {
                                                i15 = i17;
                                                i14 = variable.f4444id;
                                                i13 = i12;
                                                f12 = f15;
                                            }
                                        }
                                ...
                                for (int i18 = 1; i18 < this.mNumColumns; i18++) {
                                    ...
                                    if (f16 > f10) {
                                        for (int i19 = 0; i19 < 9; i19++) {
                                            float f17 = solverVariable.mStrengthVector[i19] / f16;
                                            if ((f17 < f12 && i19 == i15) || i19 > i15) {
                                                i15 = i19;
                                                f12 = f17;
                                                i13 = i12;
                                                i14 = i18;
    ...
    private int optimize(Row row, boolean z10) {
        ...
        while (!z11) {
            ...
            if (i11 < this.mNumColumns * 2) {
                if (row.getKey() != null) {
                    this.mAlreadyTestedCandidates[row.getKey().f4444id] = true;
                }
                SolverVariable pivotCandidate = row.getPivotCandidate(this, this.mAlreadyTestedCandidates);
                if (pivotCandidate != null) {
                    boolean[] zArr = this.mAlreadyTestedCandidates;
                    int i12 = pivotCandidate.f4444id;
                    if (!zArr[i12]) {
                        zArr[i12] = true;
                    }
                }
    ...
    */
    ...
    public SolverVariable createErrorVariable(int i10, String str) {
        ...
        this.mNumColumns++;
        solverVariableAcquireSolverVariable.f4444id = i11;
    ...
    public void displayReadableRows() {
        ...
        for (int i10 = 0; i10 < this.mVariablesID + 1; i10++) {
            ...
            if (solverVariable != null && solverVariable.isFinalValue) {
                str = str + " $[" + i10 + "] => " + solverVariable + " = " + solverVariable.computedValue + IOUtils.LINE_SEPARATOR_UNIX;
            }
        }
        ...
        for (int i11 = 0; i11 < this.mVariablesID + 1; i11++) {
            ...
            if (solverVariable2 != null && solverVariable2.mIsSynonym) {
                str2 = str2 + " ~[" + i11 + "] => " + solverVariable2 + " = " + solverVariableArr[solverVariable2.mSynonym] + " + " + solverVariable2.mSynonymDelta + IOUtils.LINE_SEPARATOR_UNIX;
            }
        }
        String str3 = str2 + "\n\n #  ";
    ...
    public void displayVariablesReadableRows() {
        ...
        for (int i10 = 0; i10 < this.mNumRows; i10++) {
            if (this.mRows[i10].mVariable.mType == SolverVariable.Type.UNRESTRICTED) {
                str = (str + this.mRows[i10].toReadableString()) + IOUtils.LINE_SEPARATOR_UNIX;
            }
        }
        System.out.println(str + this.mGoal + IOUtils.LINE_SEPARATOR_UNIX);
    }
    ...
    public void addEquality(SolverVariable solverVariable, int i10) {
        ...
        if (USE_BASIC_SYNONYMS && solverVariable.mDefinitionId == -1) {
            ...
            for (int i11 = 0; i11 < this.mVariablesID + 1; i11++) {
                ...
                if (solverVariable2 != null && solverVariable2.mIsSynonym && solverVariable2.mSynonym == solverVariable.f4444id) {
