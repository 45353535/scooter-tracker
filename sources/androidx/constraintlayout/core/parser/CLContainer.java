...
public class CLContainer extends CLElement {
    ...
    public CLContainer mo4197clone() {
        CLContainer cLContainer = (CLContainer) super.mo4197clone();
        ArrayList<CLElement> arrayList = new ArrayList<>(this.mElements.size());
        Iterator<CLElement> it = this.mElements.iterator();
        while (it.hasNext()) {
            CLElement cLElementMo4197clone = it.next().mo4197clone();
            cLElementMo4197clone.setContainer(cLContainer);
            arrayList.add(cLElementMo4197clone);
        }
