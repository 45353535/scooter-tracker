...
public class SolverVariable implements Comparable<SolverVariable> {
    ...
    private static String getUniqueName(Type type, String str) {
        ...
        if (iOrdinal == 3) {
            ...
            sb5.append(EidRequestBuilder.REQUEST_FIELD_EMAIL);
    ...
    public void setSynonym(LinearSystem linearSystem, SolverVariable solverVariable, float f10) {
        ...
        this.mSynonym = solverVariable.f4444id;
    ...
    String strengthsToString() {
        String str = this + C4240b4.j.f42672d;
        boolean z10 = false;
        boolean z11 = true;
    ...
    public int compareTo(SolverVariable solverVariable) {
        return this.f4444id - solverVariable.f4444id;
    }
