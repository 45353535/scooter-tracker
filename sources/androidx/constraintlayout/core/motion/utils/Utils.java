...
public class Utils {
    ...
    public static void logStack(String str, int i10) {
        ...
        for (int i11 = 1; i11 <= iMin; i11++) {
            ...
            String str3 = ".(" + stackTraceElement.getFileName() + StringUtils.PROCESS_POSTFIX_DELIMITER + stackTraceElement.getLineNumber() + ") " + stackTraceElement.getMethodName();
            str2 = str2 + " ";
    ...
    public static void socketSend(String str) {
        try {
            ...
            System.err.println(e10.toString() + IOUtils.LINE_SEPARATOR_UNIX + Arrays.toString(e10.getStackTrace()).replace(C4240b4.j.f42672d, "   at ").replace(StringUtils.COMMA, "\n   at").replace(C4240b4.j.f42674e, ""));
        }
    }
