...
public class ConstraintSetParser {
    ...
    static void applyAttribute(State state, LayoutVariables layoutVariables, ConstraintReference constraintReference, CLObject cLObject, String str) throws CLParsingException {
        ...
        switch (str.hashCode()) {
            case -1448775240:
                b10 = !str.equals("centerVertically") ? (byte) -1 : (byte) 0;
                break;
            case -1364013995:
                b10 = !str.equals("center") ? (byte) -1 : (byte) 1;
                break;
            case -1349088399:
                b10 = !str.equals("custom") ? (byte) -1 : (byte) 2;
                break;
            case -1249320806:
                b10 = !str.equals("rotationX") ? (byte) -1 : (byte) 3;
                break;
            case -1249320805:
                b10 = !str.equals("rotationY") ? (byte) -1 : (byte) 4;
                break;
            case -1249320804:
                b10 = !str.equals("rotationZ") ? (byte) -1 : (byte) 5;
                break;
            case -1225497657:
                b10 = !str.equals("translationX") ? (byte) -1 : (byte) 6;
                break;
            case -1225497656:
                b10 = !str.equals("translationY") ? (byte) -1 : (byte) 7;
                break;
            case -1225497655:
                b10 = !str.equals("translationZ") ? (byte) -1 : (byte) 8;
                break;
            case -1221029593:
                b10 = !str.equals("height") ? (byte) -1 : (byte) 9;
                break;
            case -1068318794:
                b10 = !str.equals("motion") ? (byte) -1 : (byte) 10;
                break;
            case -987906986:
                b10 = !str.equals("pivotX") ? (byte) -1 : Ascii.VT;
                break;
            case -987906985:
                b10 = !str.equals("pivotY") ? (byte) -1 : Ascii.FF;
                break;
            case -908189618:
            ...
            case -908189617:
                ...
                break;
            case -247669061:
                b10 = !str.equals("hRtlBias") ? (byte) -1 : Ascii.SI;
                break;
            case -61505906:
                b10 = !str.equals("vWeight") ? (byte) -1 : Ascii.DLE;
                break;
            case 92909918:
                b10 = !str.equals("alpha") ? (byte) -1 : (byte) 17;
                break;
            case 98116417:
                b10 = !str.equals("hBias") ? (byte) -1 : Ascii.DC2;
                break;
            case 111045711:
                b10 = !str.equals("vBias") ? (byte) -1 : (byte) 19;
                break;
            case 113126854:
                b10 = !str.equals("width") ? (byte) -1 : Ascii.DC4;
                break;
            case 398344448:
                b10 = !str.equals("hWeight") ? (byte) -1 : Ascii.NAK;
                break;
            case 1404070310:
                b10 = !str.equals("centerHorizontally") ? (byte) -1 : Ascii.SYN;
                break;
            case 1941332754:
                b10 = !str.equals("visibility") ? (byte) -1 : Ascii.ETB;
                break;
            default:
                b10 = -1;
                break;
        ...
        switch (b10) {
            ...
            case 14:
                ...
                break;
            case 15:
                float f10 = layoutVariables.get(cLObject.get(str));
                if (state.isRtl()) {
                    f10 = 1.0f - f10;
                }
                constraintReference.horizontalBias(f10);
                break;
            case 16:
                ...
                case "contains":
                    ...
                    if (arrayOrNull != null) {
                        for (int i10 = 0; i10 < arrayOrNull.size(); i10++) {
                            barrierReferenceBarrier.add(state.constraints(arrayOrNull.get(i10).content()));
                        }
                        break;
                    } else {
                        break;
    ...
    */
    ...
    static Dimension parseDimensionMode(String str) {
        ...
        switch (str) {
            ...
            default:
                return str.endsWith("%") ? Dimension.createPercent(0, Float.parseFloat(str.substring(0, str.indexOf(37))) / 100.0f).suggested(0) : str.contains(StringUtils.PROCESS_POSTFIX_DELIMITER) ? Dimension.createRatio(str).suggested(Dimension.SPREAD_DIMENSION) : dimensionCreateFixed;
        }
    }
                ...
                if ((cLElement instanceof CLObject) && (objectOrNull = ((CLObject) cLElement).getObjectOrNull("custom")) != null) {
                    for (String str3 : objectOrNull.names()) {
                        ...
                        if (cLElement2 instanceof CLNumber) {
                            transition.addCustomFloat(i10, str2, str3, cLElement2.getFloat());
                        } else if (cLElement2 instanceof CLString) {
                            long colorString = parseColorString(cLElement2.content());
                            if (colorString != -1) {
                                transition.addCustomColor(i10, str2, str3, (int) colorString);
                            }
                        }
                    }
                }
    ...
    */
    public static void parseMotionSceneJSON(androidx.constraintlayout.core.state.CoreMotionScene r7, java.lang.String r8) {
        /*
            androidx.constraintlayout.core.parser.CLObject r8 = androidx.constraintlayout.core.parser.CLParser.parse(r8)     // Catch: androidx.constraintlayout.core.parser.CLParsingException -> L6e
            java.util.ArrayList r0 = r8.names()     // Catch: androidx.constraintlayout.core.parser.CLParsingException -> L6e
            if (r0 != 0) goto Lc
            goto L85
        Lc:
        ...
        L10:
            ...
            androidx.constraintlayout.core.parser.CLElement r2 = r8.get(r1)     // Catch: androidx.constraintlayout.core.parser.CLParsingException -> L6e
            boolean r3 = r2 instanceof androidx.constraintlayout.core.parser.CLObject     // Catch: androidx.constraintlayout.core.parser.CLParsingException -> L6e
            if (r3 == 0) goto L10
            androidx.constraintlayout.core.parser.CLObject r2 = (androidx.constraintlayout.core.parser.CLObject) r2     // Catch: androidx.constraintlayout.core.parser.CLParsingException -> L6e
        ...
        L5b:
            ...
            goto L10
        L62:
            parseHeader(r7, r2)     // Catch: androidx.constraintlayout.core.parser.CLParsingException -> L6e
            goto L10
        L66:
            parseTransitions(r7, r2)     // Catch: androidx.constraintlayout.core.parser.CLParsingException -> L6e
            goto L10
        L6a:
            parseConstraintSets(r7, r2)     // Catch: androidx.constraintlayout.core.parser.CLParsingException -> L6e
            goto L10
        L6e:
            r7 = move-exception
    ...
    private static void parseVariables(State state, LayoutVariables layoutVariables, CLObject cLObject) throws CLParsingException {
        ...
        for (String str : arrayListNames) {
            ...
            if (cLElement instanceof CLNumber) {
                ...
                } else if (cLObject2.has(s.z.f67720z)) {
                    layoutVariables.put(str, state.getIdsForTag(cLObject2.getString(s.z.f67720z)));
                }
            }
        }
    }
