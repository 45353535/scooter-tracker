...
public class ConstraintProperties {
    ...
    public ConstraintProperties removeFromHorizontalChain() {
        ...
        if (i10 != -1 || i11 != -1) {
            ...
            ConstraintLayout.LayoutParams layoutParams2 = this.mParams;
            if (i10 != -1 && i11 != -1) {
                constraintProperties.connect(2, i11, 1, 0);
                constraintProperties2.connect(1, i10, 2, 0);
            } else if (i10 != -1 || i11 != -1) {
                int i12 = layoutParams2.rightToRight;
                if (i12 != -1) {
                    constraintProperties.connect(2, i12, 2, 0);
                } else {
                    int i13 = layoutParams2.leftToLeft;
                    if (i13 != -1) {
                        constraintProperties2.connect(1, i13, 1, 0);
                    }
                }
            }
            removeConstraints(1);
        ...
        int i14 = layoutParams.startToEnd;
        int i15 = layoutParams.endToStart;
        if (i14 != -1 || i15 != -1) {
            ConstraintProperties constraintProperties3 = new ConstraintProperties(((ViewGroup) this.mView.getParent()).findViewById(i14));
            ConstraintProperties constraintProperties4 = new ConstraintProperties(((ViewGroup) this.mView.getParent()).findViewById(i15));
            ConstraintLayout.LayoutParams layoutParams3 = this.mParams;
            if (i14 != -1 && i15 != -1) {
                constraintProperties3.connect(7, i15, 6, 0);
                constraintProperties4.connect(6, i10, 7, 0);
            } else if (i10 != -1 || i15 != -1) {
                int i16 = layoutParams3.rightToRight;
                if (i16 != -1) {
                    constraintProperties3.connect(7, i16, 7, 0);
                } else {
                    int i17 = layoutParams3.leftToLeft;
                    if (i17 != -1) {
                        constraintProperties4.connect(6, i17, 6, 0);
                    }
                }
            }
        }
