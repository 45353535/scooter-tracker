...
public class MockView extends View {
    ...
    public void onDraw(@NonNull Canvas canvas) {
        ...
        if (this.mDrawDiagonals) {
            ...
            float f11 = height;
            canvas2 = canvas;
            canvas2.drawLine(0.0f, 0.0f, f10, f11, this.mPaintDiagonals);
            canvas2.drawLine(0.0f, f11, f10, 0.0f, this.mPaintDiagonals);
            canvas2.drawLine(0.0f, 0.0f, f10, 0.0f, this.mPaintDiagonals);
            canvas2.drawLine(f10, 0.0f, f10, f11, this.mPaintDiagonals);
            canvas2.drawLine(f10, f11, 0.0f, f11, this.mPaintDiagonals);
            canvas2.drawLine(0.0f, f11, 0.0f, 0.0f, this.mPaintDiagonals);
        } else {
            canvas2 = canvas;
        }
