...
public abstract class Transition implements Cloneable {
    ...
    class SeekController extends TransitionListenerAdapter implements TransitionSeekController, DynamicAnimation.OnAnimationUpdateListener {
        ...
        public static /* synthetic */ void a(SeekController seekController, DynamicAnimation dynamicAnimation, boolean z10, float f10, float f11) {
            if (z10) {
        ...
        private void ensureAnimation() {
            ...
            this.mSpringAnimation.addEndListener(new DynamicAnimation.OnAnimationEndListener() { // from class: androidx.transition.d
                ...
                public final void onAnimationEnd(DynamicAnimation dynamicAnimation, boolean z10, float f10, float f11) {
                    Transition.SeekController.a(this.f5466a, dynamicAnimation, z10, f10, f11);
                }
            });
        }
    ...
    void captureValues(@NonNull ViewGroup viewGroup, boolean z10) {
    ...
    void createAnimators(@NonNull ViewGroup viewGroup, @NonNull TransitionValuesMaps transitionValuesMaps, @NonNull TransitionValuesMaps transitionValuesMaps2, @NonNull ArrayList<TransitionValues> arrayList, @NonNull ArrayList<TransitionValues> arrayList2) {
        ...
        if (sparseIntArray.size() != 0) {
            for (int i16 = 0; i16 < sparseIntArray.size(); i16++) {
                ...
                animationInfo3.mAnimator.setStartDelay((((long) sparseIntArray.valueAt(i16)) - jMin) + animationInfo3.mAnimator.getStartDelay());
            }
        }
    }
    ...
    */
    ...
    void notifyListeners(TransitionNotification transitionNotification, boolean z10) {
