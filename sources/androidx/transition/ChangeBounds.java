...
public class ChangeBounds extends Transition {
    ...
    static {
        ...
        POSITION_PROPERTY = new Property<View, PointF>(cls, C4240b4.i.L) { // from class: androidx.transition.ChangeBounds.5
            @Override // android.util.Property
            public PointF get(View view) {
                return null;
            }
    ...
    public Animator createAnimator(@NonNull ViewGroup viewGroup, @Nullable TransitionValues transitionValues, @Nullable TransitionValues transitionValues2) {
        ...
        if (this.mResizeClip) {
            ViewUtils.setLeftTopRightBottom(view, i15, i17, Math.max(i23, i25) + i15, i17 + Math.max(i24, i26));
            if (i15 == i16 && i17 == i18) {
            ...
            if (rect.equals(rect6)) {
                ...
                ClipListener clipListener = new ClipListener(view, rect, z10, rect6, z11, i15, i17, i19, i11, i13, i18, i20, i12);
