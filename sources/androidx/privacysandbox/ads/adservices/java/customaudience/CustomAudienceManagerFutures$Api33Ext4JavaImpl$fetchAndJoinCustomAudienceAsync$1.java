...
final class CustomAudienceManagerFutures$Api33Ext4JavaImpl$fetchAndJoinCustomAudienceAsync$1 extends k implements Function2<CoroutineScope, Continuation, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i10 == 0) {
            ...
            this.label = 1;
            if (customAudienceManager.fetchAndJoinCustomAudience(fetchAndJoinCustomAudienceRequest, this) == objG) {
                return objG;
            }
        } else {
            if (i10 != 1) {
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation continuation) {
        return ((CustomAudienceManagerFutures$Api33Ext4JavaImpl$fetchAndJoinCustomAudienceAsync$1) create(coroutineScope, continuation)).invokeSuspend(Unit.f93236a);
    }
}
