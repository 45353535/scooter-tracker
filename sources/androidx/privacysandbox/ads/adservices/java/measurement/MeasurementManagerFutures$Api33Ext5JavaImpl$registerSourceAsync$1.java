...
final class MeasurementManagerFutures$Api33Ext5JavaImpl$registerSourceAsync$1 extends k implements Function2<CoroutineScope, Continuation, Object> {
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation continuation) {
        return ((MeasurementManagerFutures$Api33Ext5JavaImpl$registerSourceAsync$1) create(coroutineScope, continuation)).invokeSuspend(Unit.f93236a);
    }
}
