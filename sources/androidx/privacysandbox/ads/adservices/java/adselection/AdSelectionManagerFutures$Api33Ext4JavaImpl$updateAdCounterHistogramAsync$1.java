...
final class AdSelectionManagerFutures$Api33Ext4JavaImpl$updateAdCounterHistogramAsync$1 extends k implements Function2<CoroutineScope, Continuation, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i10 == 0) {
            ...
            this.label = 1;
            if (adSelectionManager.updateAdCounterHistogram(updateAdCounterHistogramRequest, this) == objG) {
                return objG;
            }
        } else {
            if (i10 != 1) {
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation continuation) {
        return ((AdSelectionManagerFutures$Api33Ext4JavaImpl$updateAdCounterHistogramAsync$1) create(coroutineScope, continuation)).invokeSuspend(Unit.f93236a);
    }
}
