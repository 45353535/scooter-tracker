...
final class AppSetIdManagerFutures$Api33Ext4JavaImpl$getAppSetIdAsync$1 extends k implements Function2<CoroutineScope, Continuation, Object> {
    int label;
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        return appSetId == objG ? objG : appSetId;
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation continuation) {
        return ((AppSetIdManagerFutures$Api33Ext4JavaImpl$getAppSetIdAsync$1) create(coroutineScope, continuation)).invokeSuspend(Unit.f93236a);
    }
}
