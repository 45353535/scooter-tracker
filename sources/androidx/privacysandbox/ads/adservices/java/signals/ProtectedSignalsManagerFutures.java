...
public abstract class ProtectedSignalsManagerFutures {
    ...
    static final class JavaImpl extends ProtectedSignalsManagerFutures {
        ...
        public ListenableFuture<Unit> updateSignalsAsync(@NotNull UpdateSignalsRequest request) {
            ...
            return CoroutineAdapterKt.asListenableFuture$default(i.b(kotlinx.coroutines.i.a(o0.a()), null, null, new ProtectedSignalsManagerFutures$JavaImpl$updateSignalsAsync$1(this, request, null), 3, null), null, 1, null);
        }
    }
