...
public class AppSetIdManagerImplCommon extends AppSetIdManager {
    ...
    @kotlin.coroutines.jvm.internal.e(c = "androidx.privacysandbox.ads.adservices.appsetid.AppSetIdManagerImplCommon", f = "AppSetIdManagerImplCommon.kt", l = {38}, m = "getAppSetId$suspendImpl")
    ...
    */
    static /* synthetic */ java.lang.Object getAppSetId$suspendImpl(androidx.privacysandbox.ads.adservices.appsetid.AppSetIdManagerImplCommon r4, kotlin.coroutines.Continuation r5) {
        /*
    ...
    public final Object getAppSetIdAsyncInternal(Continuation continuation) {
        kotlinx.coroutines.e eVar = new kotlinx.coroutines.e(pf.b.d(continuation), 1);
        eVar.I();
        this.mAppSetIdManager.getAppSetId(new androidx.media3.exoplayer.hls.offline.a(), OutcomeReceiverKt.asOutcomeReceiver(eVar));
        Object objC = eVar.C();
        if (objC == pf.b.g()) {
