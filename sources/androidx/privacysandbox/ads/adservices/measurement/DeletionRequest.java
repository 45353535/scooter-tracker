...
public final class DeletionRequest {
    ...
    public final android.adservices.measurement.DeletionRequest convertToAdServices$ads_adservices_release() {
        android.adservices.measurement.DeletionRequest deletionRequestBuild = h.a().setDeletionMode(this.deletionMode).setMatchBehavior(this.matchBehavior).setStart(TimeConversions.convert(this.start)).setEnd(TimeConversions.convert(this.end)).setDomainUris(this.domainUris).setOriginUris(this.originUris).build();
    ...
    public /* synthetic */ DeletionRequest(int i10, int i11, Instant MIN, Instant MAX, List list, List list2, int i12, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        this(i10, i11, instant, MAX, (i12 & 16) != 0 ? CollectionsKt.emptyList() : list, (i12 & 32) != 0 ? CollectionsKt.emptyList() : list2);
    }
}
