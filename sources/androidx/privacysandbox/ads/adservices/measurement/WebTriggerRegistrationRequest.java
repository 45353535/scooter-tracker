...
public final class WebTriggerRegistrationRequest {
    ...
    /* JADX INFO: renamed from: destination, reason: from kotlin metadata and from toString */
    @NotNull
    ...
    public final android.adservices.measurement.WebTriggerRegistrationRequest convertToAdServices$ads_adservices_release() {
        i0.a();
        android.adservices.measurement.WebTriggerRegistrationRequest webTriggerRegistrationRequestBuild = h0.a(WebTriggerParams.INSTANCE.convertWebTriggerParams$ads_adservices_release(this.webTriggerParams), this.Destination).build();
