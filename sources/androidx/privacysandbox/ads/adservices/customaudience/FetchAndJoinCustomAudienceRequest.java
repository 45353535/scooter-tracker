...
public final class FetchAndJoinCustomAudienceRequest {
    ...
    public final android.adservices.customaudience.FetchAndJoinCustomAudienceRequest convertToAdServices$ads_adservices_release() {
        i0.a();
        FetchAndJoinCustomAudienceRequest.Builder expirationTime = h0.a(this.fetchUri).setName(this.name).setActivationTime(TimeConversions.convert(this.activationTime)).setExpirationTime(TimeConversions.convert(this.expirationTime));
