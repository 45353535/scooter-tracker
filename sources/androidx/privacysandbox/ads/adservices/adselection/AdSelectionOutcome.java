...
public final class AdSelectionOutcome {
    ...
    public int hashCode() {
        return (androidx.collection.b.a(this.adSelectionId) * 31) + this.renderUri.hashCode();
    }
