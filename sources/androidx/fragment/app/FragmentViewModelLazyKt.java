...
public final class FragmentViewModelLazyKt {
    ...
    @Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001\"\n\b\u0000\u0010\u0002\u0018\u0001*\u00020\u0003H\n¢\u0006\u0002\b\u0004"}, d2 = {"<anonymous>", "Landroidx/lifecycle/ViewModelStore;", "VM", "Landroidx/lifecycle/ViewModel;", "invoke"}, k = 3, mv = {1, 8, 0}, xi = 176)
    public static final class C16492 extends Lambda implements Function0<ViewModelStore> {
        final /* synthetic */ Lazy $owner$delegate;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C16492(Lazy lazy) {
            super(0);
        ...
        @NotNull
        public final ViewModelStore invoke() {
            return FragmentViewModelLazyKt.m4207viewModels$lambda0(this.$owner$delegate).getViewModelStore();
        }
    }
    ...
    @Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001\"\n\b\u0000\u0010\u0002\u0018\u0001*\u00020\u0003H\n¢\u0006\u0002\b\u0004"}, d2 = {"<anonymous>", "Landroidx/lifecycle/viewmodel/CreationExtras;", "VM", "Landroidx/lifecycle/ViewModel;", "invoke"}, k = 3, mv = {1, 8, 0}, xi = 176)
    public static final class C16503 extends Lambda implements Function0<CreationExtras> {
        final /* synthetic */ Lazy $owner$delegate;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C16503(Lazy lazy) {
            super(0);
            this.$owner$delegate = lazy;
        }
        ...
        public final CreationExtras invoke() {
            ...
            ViewModelStoreOwner viewModelStoreOwnerM4207viewModels$lambda0 = FragmentViewModelLazyKt.m4207viewModels$lambda0(this.$owner$delegate);
            HasDefaultViewModelProviderFactory hasDefaultViewModelProviderFactory = viewModelStoreOwnerM4207viewModels$lambda0 instanceof HasDefaultViewModelProviderFactory ? (HasDefaultViewModelProviderFactory) viewModelStoreOwnerM4207viewModels$lambda0 : null;
    ...
    @Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001\"\n\b\u0000\u0010\u0002\u0018\u0001*\u00020\u0003H\n¢\u0006\u0002\b\u0004"}, d2 = {"<anonymous>", "Landroidx/lifecycle/ViewModelProvider$Factory;", "VM", "Landroidx/lifecycle/ViewModel;", "invoke"}, k = 3, mv = {1, 8, 0}, xi = 176)
    public static final class C16514 extends Lambda implements Function0<ViewModelProvider.Factory> {
        final /* synthetic */ Lazy $owner$delegate;
        final /* synthetic */ Fragment $this_viewModels;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C16514(Fragment fragment, Lazy lazy) {
            super(0);
    ...
    @Metadata(d1 = {"\u0000\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001\"\n\b\u0000\u0010\u0002\u0018\u0001*\u00020\u0003H\n¢\u0006\u0002\b\u0004"}, d2 = {"<anonymous>", "Landroidx/lifecycle/ViewModelStore;", "VM", "Landroidx/lifecycle/ViewModel;", "invoke"}, k = 3, mv = {1, 8, 0}, xi = 176)
    public static final class C16536 extends Lambda implements Function0<ViewModelStore> {
        final /* synthetic */ Lazy $owner$delegate;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public C16536(Lazy lazy) {
            super(0);
            this.$owner$delegate = lazy;
        }
        ...
        @NotNull
        public final ViewModelStore invoke() {
            return FragmentViewModelLazyKt.m4208viewModels$lambda1(this.$owner$delegate).getViewModelStore();
        }
    }
    ...
    public static final class AnonymousClass7 extends Lambda implements Function0<CreationExtras> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        public AnonymousClass7(Function0<? extends CreationExtras> function0, Lazy lazy) {
            super(0);
            this.$extrasProducer = function0;
            this.$owner$delegate = lazy;
        }
        ...
        public final CreationExtras invoke() {
            ...
            ViewModelStoreOwner viewModelStoreOwnerM4208viewModels$lambda1 = FragmentViewModelLazyKt.m4208viewModels$lambda1(this.$owner$delegate);
            HasDefaultViewModelProviderFactory hasDefaultViewModelProviderFactory = viewModelStoreOwnerM4208viewModels$lambda1 instanceof HasDefaultViewModelProviderFactory ? (HasDefaultViewModelProviderFactory) viewModelStoreOwnerM4208viewModels$lambda1 : null;
    ...
    public static final class AnonymousClass8 extends Lambda implements Function0<ViewModelProvider.Factory> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public AnonymousClass8(Fragment fragment, Lazy lazy) {
            super(0);
            this.$this_viewModels = fragment;
            this.$owner$delegate = lazy;
        }
    ...
    @MainThread
    public static final /* synthetic */ <VM extends ViewModel> Lazy activityViewModels(Fragment fragment, Function0<? extends ViewModelProvider.Factory> function0) {
        Intrinsics.checkNotNullParameter(fragment, "<this>");
        Intrinsics.reifiedOperationMarker(4, "VM");
        KClass kClassB = v0.b(ViewModel.class);
        ...
        return createViewModelLazy(fragment, kClassB, anonymousClass1, anonymousClass2, function0);
    }
    ...
    @MainThread
    public static final /* synthetic */ <VM extends ViewModel> Lazy viewModels(Fragment fragment, Function0<? extends ViewModelStoreOwner> ownerProducer, Function0<? extends ViewModelProvider.Factory> function0) {
        Intrinsics.checkNotNullParameter(fragment, "<this>");
        Intrinsics.checkNotNullParameter(ownerProducer, "ownerProducer");
        Lazy lazyB = lf.i.b(lf.l.f94211d, new FragmentViewModelLazyKt$viewModels$owner$2(ownerProducer));
        Intrinsics.reifiedOperationMarker(4, "VM");
        KClass kClassB = v0.b(ViewModel.class);
        C16492 c16492 = new C16492(lazyB);
        C16503 c16503 = new C16503(lazyB);
        if (function0 == null) {
            function0 = new C16514(fragment, lazyB);
        }
        return createViewModelLazy(fragment, kClassB, c16492, c16503, function0);
    }
    ...
    public static final ViewModelStoreOwner m4207viewModels$lambda0(Lazy lazy) {
        return (ViewModelStoreOwner) lazy.getValue();
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* JADX INFO: renamed from: viewModels$lambda-1, reason: not valid java name */
    public static final ViewModelStoreOwner m4208viewModels$lambda1(Lazy lazy) {
        return (ViewModelStoreOwner) lazy.getValue();
    }

    @MainThread
    public static final /* synthetic */ <VM extends ViewModel> Lazy activityViewModels(Fragment fragment, Function0<? extends CreationExtras> function0, Function0<? extends ViewModelProvider.Factory> function02) {
        Intrinsics.checkNotNullParameter(fragment, "<this>");
        Intrinsics.reifiedOperationMarker(4, "VM");
        KClass kClassB = v0.b(ViewModel.class);
    ...
    @MainThread
    public static final /* synthetic */ <VM extends ViewModel> Lazy viewModels(Fragment fragment, Function0<? extends ViewModelStoreOwner> ownerProducer, Function0<? extends CreationExtras> function0, Function0<? extends ViewModelProvider.Factory> function02) {
        Intrinsics.checkNotNullParameter(fragment, "<this>");
        Intrinsics.checkNotNullParameter(ownerProducer, "ownerProducer");
        Lazy lazyB = lf.i.b(lf.l.f94211d, new FragmentViewModelLazyKt$viewModels$owner$4(ownerProducer));
        Intrinsics.reifiedOperationMarker(4, "VM");
        KClass kClassB = v0.b(ViewModel.class);
        C16536 c16536 = new C16536(lazyB);
        AnonymousClass7 anonymousClass7 = new AnonymousClass7(function0, lazyB);
        if (function02 == null) {
            function02 = new AnonymousClass8(fragment, lazyB);
        }
        return createViewModelLazy(fragment, kClassB, c16536, anonymousClass7, function02);
    }
