...
public abstract class FragmentHostCallback<E> extends FragmentContainer {
    ...
    public void onStartActivityFromFragment(@NonNull Fragment fragment, @NonNull Intent intent, int i10) {
        onStartActivityFromFragment(fragment, intent, i10, null);
    }

    @Deprecated
    public void onStartIntentSenderFromFragment(@NonNull Fragment fragment, @NonNull IntentSender intentSender, int i10, @Nullable Intent intent, int i11, int i12, int i13, @Nullable Bundle bundle) throws IntentSender.SendIntentException {
        if (i10 != -1) {
    ...
    public void onStartActivityFromFragment(@NonNull Fragment fragment, @NonNull Intent intent, int i10, @Nullable Bundle bundle) {
        if (i10 != -1) {
