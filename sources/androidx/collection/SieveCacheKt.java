...
public final class SieveCacheKt {
    ...
    public static final long createDstMapping(long j10, int i10) {
        return (j10 & (-4294967296L)) | ((long) i10);
    }

    public static final long createLinkToNext(int i10) {
        return (((long) i10) & NodeLinkMask) | 4611686016279904256L;
    }

    public static final long createLinks(long j10, int i10, int i11, @NotNull long[] mapping) {
        Intrinsics.checkNotNullParameter(mapping, "mapping");
        return (((j10 & NodeMetaMask) | ((long) (i10 == Integer.MAX_VALUE ? Integer.MAX_VALUE : (int) (mapping[i10] & 4294967295L)))) << 31) | ((long) (i11 != Integer.MAX_VALUE ? (int) (mapping[i11] & 4294967295L) : Integer.MAX_VALUE));
    }
    ...
    public static final long setLinkToNext(long j10, int i10) {
        return (j10 & NodeMetaAndPreviousMask) | (((long) i10) & NodeLinkMask);
    }

    public static final long setLinkToPrevious(long j10, int i10) {
        return (j10 & NodeMetaAndNextMask) | ((((long) i10) & NodeLinkMask) << 31);
    }

    public static final long createLinks(long j10, int i10, int i11, @NotNull int[] mapping) {
        Intrinsics.checkNotNullParameter(mapping, "mapping");
        return (((j10 & NodeMetaMask) | ((long) (i10 == Integer.MAX_VALUE ? Integer.MAX_VALUE : mapping[i10]))) << 31) | ((long) (i11 != Integer.MAX_VALUE ? mapping[i11] : Integer.MAX_VALUE));
    }
}
