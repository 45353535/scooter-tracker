...
public final class MutableIntLongMap extends IntLongMap {
    ...
    public final void resizeStorage$collection(int newCapacity) {
        ...
        while (i12 < i10) {
            if (((jArr2[i12 >> 3] >> ((i12 & 7) << 3)) & 255) < 128) {
                ...
                int i15 = i14 ^ (i14 << 16);
                int iFindFirstAvailableSlot = mutableIntLongMap.findFirstAvailableSlot(i15 >>> 7);
                long j10 = i15 & 127;
    ...
    public final long put(int key, long value, long j10) {
        int iFindInsertIndex = findInsertIndex(key);
        if (iFindInsertIndex < 0) {
            iFindInsertIndex = ~iFindInsertIndex;
        } else {
