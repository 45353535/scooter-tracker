...
public final class MutableObjectFloatMap<K> extends ObjectFloatMap<K> {
    ...
    public final float put(K key, float value, float f10) {
        int iFindIndex = findIndex(key);
        if (iFindIndex < 0) {
            iFindIndex = ~iFindIndex;
        } else {
