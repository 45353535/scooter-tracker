...
public final class ArraySetKt {
    ...
    public static final <E> int indexOf(@NotNull ArraySet<E> arraySet, @Nullable Object obj, int i10) {
        ...
        for (int i13 = iBinarySearchInternal - 1; i13 >= 0 && arraySet.getHashes()[i13] == i10; i13--) {
    ...
    public static final <E> E removeAtInternal(@NotNull ArraySet<E> arraySet, int i10) {
        ...
        if (arraySet.getHashes().length <= 8 || arraySet.get_size$collection() >= arraySet.getHashes().length / 3) {
            if (i10 < i13) {
                int i14 = i10 + 1;
                ArraysKt.copyInto(arraySet.getHashes(), arraySet.getHashes(), i10, i14, i12);
                ArraysKt.copyInto(arraySet.getArray(), arraySet.getArray(), i10, i14, i12);
            }
            ...
            if (i10 > 0) {
                ...
                objArr = array;
                ArraysKt.copyInto$default(objArr, arraySet.getArray(), 0, 0, i10, 6, (Object) null);
                i11 = i10;
            } else {
                i11 = i10;
                objArr = array;
            ...
            if (i11 < i13) {
                int i16 = i11 + 1;
                ArraysKt.copyInto(hashes, arraySet.getHashes(), i11, i16, i12);
                ArraysKt.copyInto(objArr, arraySet.getArray(), i11, i16, i12);
            }
        }
