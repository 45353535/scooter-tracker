...
public final class MutableFloatLongMap extends FloatLongMap {
    ...
    public final void resizeStorage$collection(int newCapacity) {
        ...
        while (i12 < i10) {
            if (((jArr2[i12 >> 3] >> ((i12 & 7) << 3)) & 255) < 128) {
                ...
                int iFindFirstAvailableSlot = mutableFloatLongMap.findFirstAvailableSlot(i13 >>> 7);
                long j10 = i13 & 127;
    ...
    public final long put(float key, long value, long j10) {
        int iFindInsertIndex = findInsertIndex(key);
        if (iFindInsertIndex < 0) {
            iFindInsertIndex = ~iFindInsertIndex;
        } else {
