...
public final class MutableLongObjectMap<V> extends LongObjectMap<V> {
    ...
    */
    ...
    public final void resizeStorage$collection(int newCapacity) {
        ...
        int i10 = mutableLongObjectMap._capacity;
        ...
        while (i12 < i10) {
            if (((jArr2[i12 >> 3] >> ((i12 & 7) << 3)) & 255) < 128) {
                ...
                int i13 = iA ^ (iA << 16);
                int iFindFirstAvailableSlot = mutableLongObjectMap.findFirstAvailableSlot(i13 >>> 7);
                long j11 = i13 & 127;
