...
public final class MutableLongLongMap extends LongLongMap {
            ...
            if (j13 != 128 && j13 == 254) {
                ...
                if (((iFindFirstAvailableSlot - i19) & i10) / 8 == ((i14 - i19) & i10) / 8) {
                    ...
                    if (((j14 >> i21) & 255) == 128) {
                        ...
                        jArr2[iFindFirstAvailableSlot] = jArr2[i14];
                        jArr2[i14] = j15;
                        long j16 = jArr3[iFindFirstAvailableSlot];
                        jArr3[iFindFirstAvailableSlot] = jArr3[i14];
                        jArr3[i14] = j16;
                        i14--;
                    }
    ...
    public final void resizeStorage$collection(int newCapacity) {
        ...
        while (i12 < i10) {
            if (((jArr2[i12 >> 3] >> ((i12 & 7) << 3)) & 255) < 128) {
                ...
                int i13 = iA ^ (iA << 16);
                int iFindFirstAvailableSlot = mutableLongLongMap.findFirstAvailableSlot(i13 >>> 7);
                long j11 = i13 & 127;
                int i14 = iFindFirstAvailableSlot >> 3;
                int i15 = (iFindFirstAvailableSlot & 7) << 3;
                jArr = jArr2;
                long j12 = (jArr5[i14] & (~(255 << i15))) | (j11 << i15);
                jArr5[i14] = j12;
                jArr5[(((iFindFirstAvailableSlot - 7) & i11) + (i11 & 7)) >> 3] = j12;
                jArr6[iFindFirstAvailableSlot] = j10;
                jArr7[iFindFirstAvailableSlot] = jArr4[i12];
            } else {
                jArr = jArr2;
            }
            i12++;
    ...
    public final long put(long key, long value, long j10) {
        int iFindInsertIndex = findInsertIndex(key);
        if (iFindInsertIndex < 0) {
            iFindInsertIndex = ~iFindInsertIndex;
        } else {
