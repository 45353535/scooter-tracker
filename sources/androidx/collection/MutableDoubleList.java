...
public final class MutableDoubleList extends DoubleList {
    ...
    public final boolean addAll(@IntRange(from = 0) int index, @NotNull double[] elements) {
        ...
        int i10 = this._size;
        if (index != i10) {
            ArraysKt.copyInto(dArr, dArr, elements.length + index, index, i10);
        }
    ...
    public final double removeAt(@IntRange(from = 0) int index) {
        ...
        int i10 = this._size;
        if (index != i10 - 1) {
            ArraysKt.copyInto(dArr, dArr, index, index + 1, i10);
        }
        this._size--;
        return d10;
    }
    ...
    public final void removeRange(@IntRange(from = 0) int start, @IntRange(from = 0) int end) {
        ...
        if (end != start) {
            ...
            if (end < i11) {
                double[] dArr = this.content;
                ArraysKt.copyInto(dArr, dArr, start, end, i11);
            }
    ...
    public final void trim(int minCapacity) {
        ...
        double[] dArr = this.content;
        if (dArr.length > iMax) {
            double[] dArrCopyOf = Arrays.copyOf(dArr, iMax);
            Intrinsics.checkNotNullExpressionValue(dArrCopyOf, "copyOf(...)");
            this.content = dArrCopyOf;
        }
    }
    ...
    public final void add(@IntRange(from = 0) int index, double element) {
        ...
        int i10 = this._size;
        if (index != i10) {
            ArraysKt.copyInto(dArr, dArr, index + 1, index, i10);
        }
        dArr[index] = element;
        this._size++;
    }
    ...
    public final boolean addAll(@IntRange(from = 0) int index, @NotNull DoubleList elements) {
        Intrinsics.checkNotNullParameter(elements, "elements");
        if (index < 0 || index > this._size) {
            RuntimeHelpersKt.throwIndexOutOfBoundsException("");
        }
        ...
        int i11 = this._size;
        if (index != i11) {
            ArraysKt.copyInto(dArr, dArr, elements._size + index, index, i11);
        }
