...
final class Entries<K, V> implements Set<Map.Entry<? extends K, ? extends V>>, yf.a {
    ...
    @e(c = "androidx.collection.Entries$iterator$1", f = "ScatterMap.kt", l = {1414}, m = "invokeSuspend")
    static final class AnonymousClass1 extends j implements Function2<kotlin.sequences.j, Continuation, Object> {
        ...
        AnonymousClass1(Entries<K, V> entries, Continuation continuation) {
