...
public final class Mp3Extractor implements Extractor {
    ...
    private static long getId3TlenUs(@Nullable Metadata metadata) {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            ...
            if (entry instanceof TextInformationFrame) {
                ...
                if (textInformationFrame.f5301id.equals("TLEN")) {
    ...
    private Seeker getConstantBitrateSeeker(long j10, XingFrame xingFrame, long j11) {
        ...
        return new ConstantBitrateSeeker(j13, j10 + ((long) xingFrame.header.frameSize), Ints.checkedCast(Util.scaleLargeValue(j16, 8000000L, jComputeDurationUs, roundingMode)), Ints.checkedCast(LongMath.divide(j16, xingFrame.frameCount, roundingMode)), false);
    }
}
