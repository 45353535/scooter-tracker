...
public final class Mp4Extractor implements Extractor, SeekMap {
    ...
    private void processMoovAtom(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        List<TrackSampleTable> traks = AtomParsers.parseTraks(containerAtom, gaplessInfoHolder, -9223372036854775807L, null, (this.flags & 1) != 0, z10, new Function() { // from class: androidx.media3.extractor.mp4.d
        ...
        int size = -1;
        while (i14 < traks.size()) {
            TrackSampleTable trackSampleTable = traks.get(i14);
            if (trackSampleTable.sampleCount == 0) {
                ...
                i11 = i15 + 1;
                list = traks;
                Mp4Track mp4Track = new Mp4Track(track, trackSampleTable, this.extractorOutput.track(i15, track.type));
                int i16 = "audio/true-hd".equals(track.format.sampleMimeType) ? trackSampleTable.maximumSize * 16 : trackSampleTable.maximumSize + 30;
                ...
                if (track.type == 2) {
                    ...
                    if (j10 > 0 && (i12 = trackSampleTable.sampleCount) > 0) {
                        builderBuildUpon.setFrameRate(i12 / (j10 / 1000000.0f));
                    }
                }
                MetadataUtil.setFormatGaplessInfo(track.type, gaplessInfoHolder, builderBuildUpon);
                int i17 = track.type;
                Metadata[] metadataArr = new Metadata[3];
                metadataArr[i10] = this.slowMotionMetadataEntries.isEmpty() ? null : new Metadata(this.slowMotionMetadataEntries);
                metadataArr[1] = metadata;
                metadataArr[2] = metadata2;
                MetadataUtil.setFormatMetadata(i17, mdtaFromMeta, builderBuildUpon, metadataArr);
        ...
        Mp4Track[] mp4TrackArr = (Mp4Track[]) arrayList2.toArray(new Mp4Track[i13]);
