...
public class FragmentedMp4Extractor implements Extractor {
    ...
    public static ExtractorsFactory newFactory(final SubtitleParser.Factory factory) {
        return new ExtractorsFactory() { // from class: androidx.media3.extractor.mp4.c
            @Override // androidx.media3.extractor.ExtractorsFactory
            public final Extractor[] createExtractors() {
                return FragmentedMp4Extractor.a(factory);
            }
    ...
    private void onMoovContainerAtomRead(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        List<TrackSampleTable> traks = AtomParsers.parseTraks(containerAtom, new GaplessInfoHolder(), mehd, drmInitDataFromAtoms, (this.flags & 16) != 0, false, new Function() { // from class: androidx.media3.extractor.mp4.b
            @Override // com.google.common.base.Function
            public final Object apply(Object obj) {
                return this.f5305b.modifyTrack((Track) obj);
            }
        });
        ...
        if (this.trackBundles.size() != 0) {
            ...
            while (i10 < size2) {
                ...
                this.trackBundles.get(track.f5304id).reset(trackSampleTable, getDefaultSampleValues(sparseArray, track.f5304id));
                i10++;
            }
            return;
        }
        while (i10 < size2) {
            ...
            this.trackBundles.put(track2.f5304id, new TrackBundle(this.extractorOutput.track(i10, track2.type), trackSampleTable2, getDefaultSampleValues(sparseArray, track2.f5304id)));
