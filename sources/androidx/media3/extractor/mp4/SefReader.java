...
final class SefReader {
    ...
    private static SlowMotionData readSlowMotionData(ParsableByteArray parsableByteArray, int i10) throws ParserException {
        ...
        List<String> listSplitToList = ASTERISK_SPLITTER.splitToList(parsableByteArray.readString(i10));
        for (int i11 = 0; i11 < listSplitToList.size(); i11++) {
            List<String> listSplitToList2 = COLON_SPLITTER.splitToList(listSplitToList.get(i11));
