...
public final class TsExtractor implements Extractor {
    ...
    public int read(ExtractorInput extractorInput, PositionHolder positionHolder) throws IOException {
        ...
        if (this.tracksEnded) {
            if (length != -1 && !z10 && !this.durationReader.isDurationReadFinished()) {
        ...
        if (!fillBufferWithAtLeastOnePacket(extractorInput)) {
            for (int i11 = 0; i11 < this.tsPayloadReaders.size(); i11++) {
                TsPayloadReader tsPayloadReaderValueAt = this.tsPayloadReaders.valueAt(i11);
        ...
        int i12 = this.tsPacketBuffer.readInt();
        if ((8388608 & i12) != 0) {
            this.tsPacketBuffer.setPosition(iFindEndOfFirstTsPacketInBuffer);
            return 0;
        }
        int i13 = (4194304 & i12) != 0 ? 1 : 0;
        int i14 = (2096896 & i12) >> 8;
        boolean z11 = (i12 & 32) != 0;
        TsPayloadReader tsPayloadReader = (i12 & 16) != 0 ? this.tsPayloadReaders.get(i14) : null;
        ...
        if (z11) {
            ...
            i13 |= (this.tsPacketBuffer.readUnsignedByte() & 64) != 0 ? 2 : i10;
