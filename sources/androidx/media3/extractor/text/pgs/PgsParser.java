    ...
    private static final class CueBuilder {
        ...
        public void parsePaletteSection(ParsableByteArray parsableByteArray, int i10) {
            ...
            for (int i12 = 0; i12 < i11; i12++) {
                ...
                this.colors[unsignedByte] = (Util.constrainValue((int) ((d10 - (0.34414d * d12)) - (d11 * 0.71414d)), 0, 255) << 8) | (unsignedByte5 << 24) | (Util.constrainValue((int) ((1.402d * d11) + d10), 0, 255) << 16) | Util.constrainValue((int) (d10 + (d12 * 1.772d)), 0, 255);
            }
            this.colorsSet = true;
        }
