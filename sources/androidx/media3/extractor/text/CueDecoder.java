...
public final class CueDecoder {
    ...
    public CuesWithTiming decode(long j10, byte[] bArr, int i10, int i11) {
        ...
        return new CuesWithTiming(BundleCollectionUtil.fromBundleList(new androidx.media3.common.text.a(), (ArrayList) Assertions.checkNotNull(bundle.getParcelableArrayList("c"))), j10, bundle.getLong("d"));
    }
}
