...
public final class TextInformationFrame extends Id3Frame {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj != null && TextInformationFrame.class == obj.getClass()) {
            ...
            if (Util.areEqual(this.f5301id, textInformationFrame.f5301id) && Util.areEqual(this.description, textInformationFrame.description) && this.values.equals(textInformationFrame.values)) {
                return true;
            }
        }
        return false;
    ...
    public String toString() {
        return this.f5301id + ": description=" + this.description + ": values=" + this.values;
    }
