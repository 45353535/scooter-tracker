...
public final class BinaryFrame extends Id3Frame {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj != null && BinaryFrame.class == obj.getClass()) {
            ...
            if (this.f5301id.equals(binaryFrame.f5301id) && Arrays.equals(this.data, binaryFrame.data)) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        return ((IronSourceError.ERROR_NON_EXISTENT_INSTANCE + this.f5301id.hashCode()) * 31) + Arrays.hashCode(this.data);
    }
