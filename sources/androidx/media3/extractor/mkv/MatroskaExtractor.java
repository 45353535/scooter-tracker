    ...
    */
    ...
    public static ExtractorsFactory newFactory(final SubtitleParser.Factory factory) {
        return new ExtractorsFactory() { // from class: androidx.media3.extractor.mkv.a
            @Override // androidx.media3.extractor.ExtractorsFactory
            public final Extractor[] createExtractors() {
                return MatroskaExtractor.a(factory);
            }
    ...
    @CallSuper
    protected void binaryElement(int i10, int i11, ExtractorInput extractorInput) throws IOException {
        int i12;
        int i13;
        int i14;
        int i15;
        ...
        if (i10 != ID_BLOCK && i10 != ID_SIMPLE_BLOCK) {
            if (i10 == ID_BLOCK_ADDITIONAL) {
                ...
                handleBlockAdditionalData(this.tracks.get(this.blockTrackNumber), this.blockAdditionalId, extractorInput2, i11);
                return;
            }
            if (i10 == ID_BLOCK_ADD_ID_EXTRA_DATA) {
                handleBlockAddIDExtraData(getCurrentTrack(i10), extractorInput2, i11);
                return;
            }
            ...
            if (i10 == ID_CODEC_PRIVATE) {
                ...
                extractorInput2.readFully(bArr3, 0, i11);
                return;
            }
            ...
            extractorInput2.readFully(bArr4, 0, i11);
            return;
        }
        int i22 = 8;
        ...
        if (track == null) {
            extractorInput2.skipFully(i11 - this.blockTrackNumberLength);
            this.blockState = 0;
            return;
        }
        ...
        if (this.blockState == 1) {
            ...
            if (i23 == 0) {
                ...
                if (i23 == 2) {
                    int i25 = (i11 - this.blockTrackNumberLength) - 4;
                    ...
                    if (i23 != 1) {
                        ...
                        int i29 = 4;
                        while (true) {
                            int i30 = this.blockSampleCount;
                            i12 = i21;
                            if (i27 >= i30 - 1) {
                                i13 = i20;
                                this.blockSampleSizes[i30 - 1] = ((i11 - this.blockTrackNumberLength) - i29) - i28;
                                break;
                            }
                            this.blockSampleSizes[i27] = i20;
                            int i31 = i29 + 1;
                            readScratch(extractorInput2, i31);
                            if (this.scratch.getData()[i29] == 0) {
                            ...
                            while (true) {
                                ...
                                int i33 = i12 << (7 - i32);
                                i14 = i20;
                                if ((this.scratch.getData()[i29] & i33) != 0) {
                                    i31 += i32;
                                    readScratch(extractorInput2, i31);
                                    int i34 = i29 + 1;
                                    j10 = this.scratch.getData()[i29] & 255 & (~i33);
                                    while (true) {
                                        int i35 = i34;
                                        if (i35 >= i31) {
                                            break;
                                        ...
                                        i34 = i35 + 1;
                                        j10 = (j10 << i15) | ((long) (this.scratch.getData()[i35] & 255));
                                        i27 = i27;
                                    }
                                    i16 = i27;
                                    if (i16 > 0) {
                    ...
                    int i39 = 4;
                    while (true) {
                        i17 = this.blockSampleCount;
                        if (i37 >= i17 - 1) {
                            break;
                        }
                        this.blockSampleSizes[i37] = 0;
                        while (true) {
                            i18 = i39 + 1;
                            readScratch(extractorInput2, i18);
                            int i40 = this.scratch.getData()[i39] & 255;
                    ...
                    this.blockSampleSizes[i17 - 1] = ((i11 - this.blockTrackNumberLength) - i39) - i38;
                }
            }
            i13 = 0;
            i12 = 1;
            this.blockTimeUs = this.clusterTimecodeUs + scaleTimecodeToUs((this.scratch.getData()[i13] << 8) | (this.scratch.getData()[i12] & 255));
            this.blockFlags = (track.type == 2 || (i10 == ID_SIMPLE_BLOCK && (this.scratch.getData()[2] & 128) == 128)) ? i12 : i13;
            this.blockState = 2;
            this.blockSampleIndex = i13;
        } else {
            i12 = 1;
        }
        if (i10 == ID_SIMPLE_BLOCK) {
            ...
            while (true) {
                ...
                boolean z10 = i12;
                iArr3[i42] = writeSampleData(extractorInput, track, iArr3[i42], z10);
                this.blockSampleIndex += z10 ? 1 : 0;
            }
        }
    }

    @CallSuper
    protected void endMasterElement(int i10) throws ParserException {
        assertInitialized();
    ...
    @CallSuper
    protected void floatElement(int i10, double d10) throws ParserException {
    ...
    protected Track getCurrentTrack(int i10) throws ParserException {
        assertInTrackEntry(i10);
        return this.currentTrack;
    }

    @CallSuper
    protected int getElementType(int i10) {
        switch (i10) {
            case 131:
            case 136:
            case 155:
    ...
    protected void handleBlockAddIDExtraData(Track track, ExtractorInput extractorInput, int i10) throws IOException {
    ...
    protected void handleBlockAdditionalData(Track track, int i10, ExtractorInput extractorInput, int i11) throws IOException {
    ...
    @CallSuper
    protected void integerElement(int i10, long j10) throws ParserException {
    ...
    @CallSuper
    protected boolean isLevel1Element(int i10) {
    ...
    @CallSuper
    protected void startMasterElement(int i10, long j10, long j11) throws ParserException {
        assertInitialized();
        if (i10 == ID_BLOCK_GROUP) {
    ...
    @CallSuper
    protected void stringElement(int i10, String str) throws ParserException {
        if (i10 == 134) {
    ...
    MatroskaExtractor(EbmlReader ebmlReader, int i10, SubtitleParser.Factory factory) {
