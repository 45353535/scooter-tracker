...
public final class DtsUtil {
    ...
    */
    ...
    public static DtsHeader parseDtsHdHeader(byte[] bArr) throws ParserException {
        ...
        int bits3 = normalizedFrame.readBits(i10) + 1;
        ...
        if (bit) {
            ...
            i12 = SAMPLE_RATE_BY_INDEX[normalizedFrame.readBits(4)];
        ...
        return new DtsHeader("audio/vnd.dts.hd;profile=lbr", bits4, i17, bits3, jScaleLargeTimestamp, 0);
    }
    ...
    public static DtsHeader parseDtsUhdHeader(byte[] bArr, AtomicInteger atomicInteger) throws ParserException {
        ...
        return new DtsHeader("audio/vnd.dts.uhd;profile=p2", 2, i13, unsignedVarInt + unsignedVarInt2 + (atomicInteger2.get() != 0 ? parseUnsignedVarInt(normalizedFrame, UHD_AUDIO_CHUNK_SIZE_LENGTH_TABLE, true) : 0), j10, 0);
    }
