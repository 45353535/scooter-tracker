...
public final class DefaultAudioSink implements AudioSink {
    ...
    static final class OnRoutingChangedListenerApi24 {
        ...
        private AudioRouting.OnRoutingChangedListener listener = new AudioRouting.OnRoutingChangedListener() { // from class: androidx.media3.exoplayer.audio.m0
            public final void onRoutingChanged(AudioRouting audioRouting) {
                this.f4953a.onRoutingChanged(audioRouting);
            }
        };
    ...
    private void handleSkippedSilence(long j10) {
        ...
        this.reportSkippedSilenceHandler.postDelayed(new Runnable() { // from class: androidx.media3.exoplayer.audio.d0
            @Override // java.lang.Runnable
            public final void run() {
                this.f4939b.maybeReportSkippedSilence();
            }
        }, 100L);
    }
    ...
    private void maybeStartAudioCapabilitiesReceiver() {
        ...
        AudioCapabilitiesReceiver audioCapabilitiesReceiver = new AudioCapabilitiesReceiver(this.context, new AudioCapabilitiesReceiver.Listener() { // from class: androidx.media3.exoplayer.audio.e0
            ...
            public final void onAudioCapabilitiesChanged(AudioCapabilities audioCapabilities) {
                this.f4940a.onAudioCapabilitiesChanged(audioCapabilities);
            }
    ...
    public void configure(Format format, int i10, @Nullable int[] iArr) throws AudioSink.ConfigurationException {
        ...
        if ("audio/raw".equals(format.sampleMimeType)) {
            ...
            try {
                ...
                int i18 = audioFormatConfigure.encoding;
                i11 = audioFormatConfigure.sampleRate;
                int audioTrackChannelConfig = Util.getAudioTrackChannelConfig(audioFormatConfigure.channelCount);
                int pcmFrameSize2 = Util.getPcmFrameSize(i18, audioFormatConfigure.channelCount);
                i12 = 0;
                i13 = i18;
                i14 = audioTrackChannelConfig;
        ...
        if ("audio/vnd.dts.hd;profile=lbr".equals(format.sampleMimeType) && i19 == -1) {
            i19 = 768000;
        }
        int i20 = i19;
        if (i10 != 0) {
            ...
            i16 = i11;
            bufferSizeInBytes = this.audioTrackBufferSizeProvider.getBufferSizeInBytes(getAudioTrackMinBufferSize(i11, i14, i13), i13, i12, i15 != -1 ? i15 : 1, i16, i20, z11 ? 8.0d : 1.0d);
        }
        this.offloadDisabledUntilNextConfiguration = false;
        boolean z12 = z10;
        int i21 = i12;
        Configuration configuration = new Configuration(format, pcmFrameSize, i21, i15, i16, i14, i13, bufferSizeInBytes, audioProcessingPipeline, z11, z12, this.tunneling);
        if (isAudioTrackInitialized()) {
