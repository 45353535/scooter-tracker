...
final class MediaPeriodQueue {
    ...
    static boolean areDurationsCompatible(long j10, long j11) {
        return j10 == -9223372036854775807L || j10 == j11;
    }

    private boolean canKeepMediaPeriodHolder(MediaPeriodInfo mediaPeriodInfo, MediaPeriodInfo mediaPeriodInfo2) {
        return mediaPeriodInfo.startPositionUs == mediaPeriodInfo2.startPositionUs && mediaPeriodInfo.f4768id.equals(mediaPeriodInfo2.f4768id);
    }
    ...
    private MediaPeriodInfo getFirstMediaPeriodInfoOfNextPeriod(Timeline timeline, MediaPeriodHolder mediaPeriodHolder, long j10) {
        ...
        int nextPeriodIndex = timeline.getNextPeriodIndex(timeline.getIndexOfPeriod(mediaPeriodInfo.f4768id.periodUid), this.period, this.window, this.repeatMode, this.shuffleModeEnabled);
        ...
        long j12 = mediaPeriodInfo.f4768id.windowSequenceNumber;
        long j13 = 0;
        if (timeline.getWindow(i10, this.window).firstPeriodIndex == nextPeriodIndex) {
            ...
            if (next == null || !next.uid.equals(obj2)) {
                ...
                j12 = next.info.f4768id.windowSequenceNumber;
            }
            obj = obj2;
            j11 = jLongValue;
        ...
        if (j13 != -9223372036854775807L && mediaPeriodInfo.requestedContentPositionUs != -9223372036854775807L) {
            boolean zHasServerSideInsertedAds = hasServerSideInsertedAds(mediaPeriodInfo.f4768id.periodUid, timeline);
    ...
    */
    ...
    private void notifyQueueUpdate() {
        ...
        for (MediaPeriodHolder next = this.playing; next != null; next = next.getNext()) {
            builder.add(next.info.f4768id);
        }
        MediaPeriodHolder mediaPeriodHolder = this.reading;
        final MediaSource.MediaPeriodId mediaPeriodId = mediaPeriodHolder == null ? null : mediaPeriodHolder.info.f4768id;
        this.analyticsCollectorHandler.post(new Runnable() { // from class: androidx.media3.exoplayer.g2
            @Override // java.lang.Runnable
            public final void run() {
                this.f5025b.analyticsCollector.updateMediaPeriodQueueInfo(builder.build(), mediaPeriodId);
            }
        });
    }
    ...
    private long resolvePeriodUidToWindowSequenceNumber(Timeline timeline, Object obj) {
        ...
        for (MediaPeriodHolder next = this.playing; next != null; next = next.getNext()) {
            if (next.uid.equals(obj)) {
                return next.info.f4768id.windowSequenceNumber;
            }
        }
        for (MediaPeriodHolder next2 = this.playing; next2 != null; next2 = next2.getNext()) {
            ...
            if (indexOfPeriod2 != -1 && timeline.getPeriod(indexOfPeriod2, this.period).windowIndex == i10) {
                return next2.info.f4768id.windowSequenceNumber;
            }
        }
    ...
    private long resolvePeriodUidToWindowSequenceNumberInPreloadPeriods(Object obj) {
        for (int i10 = 0; i10 < this.preloadPriorityList.size(); i10++) {
            ...
            if (mediaPeriodHolder.uid.equals(obj)) {
                return mediaPeriodHolder.info.f4768id.windowSequenceNumber;
            }
        }
        return -1L;
    }
    ...
    public MediaPeriodHolder advancePlayingPeriod() {
        ...
        if (i10 == 0) {
            ...
            this.oldFrontPeriodWindowSequenceNumber = mediaPeriodHolder2.info.f4768id.windowSequenceNumber;
        }
    ...
    public void clear() {
        ...
        this.oldFrontPeriodWindowSequenceNumber = next.info.f4768id.windowSequenceNumber;
        while (next != null) {
            next.release();
            next = next.getNext();
        }
    ...
    */
    public androidx.media3.exoplayer.MediaPeriodInfo getUpdatedMediaPeriodInfo(androidx.media3.common.Timeline r16, androidx.media3.exoplayer.MediaPeriodInfo r17) {
        /*
            ...
            r1 = r16
            r2 = r17
            androidx.media3.exoplayer.source.MediaSource$MediaPeriodId r3 = r2.f4768id
            boolean r12 = r15.isLastInPeriod(r3)
            boolean r13 = r15.isLastInWindow(r1, r3)
            boolean r14 = r15.isLastInTimeline(r1, r3, r12)
            androidx.media3.exoplayer.source.MediaSource$MediaPeriodId r4 = r2.f4768id
    ...
    public void invalidatePreloadPool(Timeline timeline) {
        ...
        Pair<Object, Long> defaultPeriodPositionOfNextWindow = getDefaultPeriodPositionOfNextWindow(timeline, mediaPeriodHolder.info.f4768id.periodUid, 0L);
