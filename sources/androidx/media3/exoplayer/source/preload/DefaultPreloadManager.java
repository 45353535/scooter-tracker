...
public final class DefaultPreloadManager extends BasePreloadManager<Integer> {
    ...
    final class SourcePreloadControl implements PreloadMediaSource.PreloadControl {
        ...
        public static /* synthetic */ boolean a(long j10, Status status) {
        ...
        private boolean continueOrCompletePreloading(PreloadMediaSource preloadMediaSource, Predicate<Status> predicate, boolean z10) {
        ...
        public boolean onContinueLoadingRequested(PreloadMediaSource preloadMediaSource, final long j10) {
            return continueOrCompletePreloading(preloadMediaSource, new Predicate() { // from class: androidx.media3.exoplayer.source.preload.d
                ...
                public final boolean apply(Object obj) {
                    return DefaultPreloadManager.SourcePreloadControl.a(j10, (DefaultPreloadManager.Status) obj);
                }
            }, false);
        }
    ...
    @Override // androidx.media3.exoplayer.source.preload.BasePreloadManager
    protected void preloadSourceInternal(MediaSource mediaSource, long j10) {
        Assertions.checkArgument(mediaSource instanceof PreloadMediaSource);
