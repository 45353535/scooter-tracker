...
public final class ServerSideAdInsertionMediaSource extends BaseMediaSource implements MediaSource.MediaSourceCaller, MediaSourceEventListener, DrmSessionEventListener {
    ...
    static final class ServerSideAdInsertionTimeline extends ForwardingTimeline {
        ...
        public Timeline.Period getPeriod(int i10, Timeline.Period period, boolean z10) {
            ...
            period.set(period.f4635id, period.uid, period.windowIndex, mediaPeriodPositionUsForContent, mediaPeriodPositionUsForContent2, adPlaybackState, period.isPlaceholder);
            return period;
        }
            ...
            loop0: while (true) {
                ...
                if (exoTrackSelection != null) {
                    ...
                    for (int i11 = 0; i11 < trackGroup.length; i11++) {
                        ...
                        if (format.equals(mediaLoadData.trackFormat) || (z10 && (str = format.f4631id) != null && str.equals(mediaLoadData.trackFormat.f4631id))) {
                            break loop0;
                        }
                    }
                }
                ...
                if (handler == null) {
                    ...
                    handler.post(new Runnable() { // from class: androidx.media3.exoplayer.source.ads.g
                        ...
                        public final void run() {
                            ServerSideAdInsertionMediaSource.a(this.f5145b, immutableMap, timeline);
                        }
                    });
                }
            } catch (Throwable th2) {
