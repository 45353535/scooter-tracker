...
public abstract class CompositeMediaSource<T> extends BaseMediaSource {
    ...
    private final class ForwardingEventListener implements MediaSourceEventListener, DrmSessionEventListener {
        ...
        private boolean maybeUpdateEventDispatcher(int i10, @Nullable MediaSource.MediaPeriodId mediaPeriodId) {
            ...
            if (mediaPeriodId != null) {
                mediaPeriodIdForChildMediaPeriodId = CompositeMediaSource.this.getMediaPeriodIdForChildMediaPeriodId(this.f5129id, mediaPeriodId);
            ...
            int windowIndexForChildWindowIndex = CompositeMediaSource.this.getWindowIndexForChildWindowIndex(this.f5129id, i10);
        ...
        private MediaLoadData maybeUpdateMediaLoadData(MediaLoadData mediaLoadData, @Nullable MediaSource.MediaPeriodId mediaPeriodId) {
            long mediaTimeForChildMediaTime = CompositeMediaSource.this.getMediaTimeForChildMediaTime(this.f5129id, mediaLoadData.mediaStartTimeMs, mediaPeriodId);
            long mediaTimeForChildMediaTime2 = CompositeMediaSource.this.getMediaTimeForChildMediaTime(this.f5129id, mediaLoadData.mediaEndTimeMs, mediaPeriodId);
    ...
    protected long getMediaTimeForChildMediaTime(@UnknownNull T t10, long j10, @Nullable MediaSource.MediaPeriodId mediaPeriodId) {
        return j10;
    }
    ...
    public final void prepareChildSource(@UnknownNull final T t10, MediaSource mediaSource) {
        ...
        MediaSource.MediaSourceCaller mediaSourceCaller = new MediaSource.MediaSourceCaller() { // from class: androidx.media3.exoplayer.source.b
            ...
            public final void onSourceInfoRefreshed(MediaSource mediaSource2, Timeline timeline) {
                this.f5148b.onChildSourceInfoRefreshed(t10, mediaSource2, timeline);
            }
        };
