    ...
    public void onPrepared(MediaPeriod mediaPeriod) {
        ...
        while (true) {
            ...
            while (i14 < i13) {
                ...
                TrackGroup trackGroup2 = new TrackGroup(i11 + StringUtils.PROCESS_POSTFIX_DELIMITER + trackGroup.f4636id, formatArr);
    ...
    public long selectTracks(ExoTrackSelection[] exoTrackSelectionArr, boolean[] zArr, SampleStream[] sampleStreamArr, boolean[] zArr2, long j10) {
        ...
        for (int i11 = 0; i11 < exoTrackSelectionArr.length; i11++) {
            ...
            if (exoTrackSelection != null) {
                String str = exoTrackSelection.getTrackGroup().f4636id;
        ...
        this.compositeSequenceableLoader = this.compositeSequenceableLoaderFactory.create(arrayList, Lists.transform(arrayList, new Function() { // from class: androidx.media3.exoplayer.source.y
