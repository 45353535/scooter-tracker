...
public final class FrameworkMediaDrm implements ExoMediaDrm {
    ...
    public static /* synthetic */ void a(FrameworkMediaDrm frameworkMediaDrm, ExoMediaDrm.OnExpirationUpdateListener onExpirationUpdateListener, MediaDrm mediaDrm, byte[] bArr, long j10) {
    ...
    private String adjustLicenseServerUrl(String str) {
        ...
        if (Util.SDK_INT >= 33 && "https://default.url".equals(str)) {
            ...
            if (Objects.equals(propertyString, POBCoreNativeConstants.NATIVE_DEFAULT_VERSION) || Objects.equals(propertyString, "aidl-1")) {
                return "";
            }
        }
        return str;
    ...
    */
    ...
    public static /* synthetic */ void d(FrameworkMediaDrm frameworkMediaDrm, ExoMediaDrm.OnKeyStatusChangeListener onKeyStatusChangeListener, MediaDrm mediaDrm, byte[] bArr, List list, boolean z10) {
        frameworkMediaDrm.getClass();
    ...
    public void setOnEventListener(@Nullable final ExoMediaDrm.OnEventListener onEventListener) {
        this.mediaDrm.setOnEventListener(onEventListener == null ? null : new MediaDrm.OnEventListener() { // from class: androidx.media3.exoplayer.drm.z
            ...
            public final void onEvent(MediaDrm mediaDrm, byte[] bArr, int i10, int i11, byte[] bArr2) {
                FrameworkMediaDrm.c(this.f5018a, onEventListener, mediaDrm, bArr, i10, i11, bArr2);
            }
        });
    }
    ...
    public void setOnExpirationUpdateListener(@Nullable final ExoMediaDrm.OnExpirationUpdateListener onExpirationUpdateListener) {
        ...
        this.mediaDrm.setOnExpirationUpdateListener(onExpirationUpdateListener == null ? null : new MediaDrm.OnExpirationUpdateListener() { // from class: androidx.media3.exoplayer.drm.y
            ...
            public final void onExpirationUpdate(MediaDrm mediaDrm, byte[] bArr, long j10) {
                FrameworkMediaDrm.a(this.f5016a, onExpirationUpdateListener, mediaDrm, bArr, j10);
            }
        }, (Handler) null);
    }
    ...
    public void setOnKeyStatusChangeListener(@Nullable final ExoMediaDrm.OnKeyStatusChangeListener onKeyStatusChangeListener) {
        ...
        this.mediaDrm.setOnKeyStatusChangeListener(onKeyStatusChangeListener == null ? null : new MediaDrm.OnKeyStatusChangeListener() { // from class: androidx.media3.exoplayer.drm.a0
            ...
            public final void onKeyStatusChange(MediaDrm mediaDrm, byte[] bArr, List list, boolean z10) {
                FrameworkMediaDrm.d(this.f4979a, onKeyStatusChangeListener, mediaDrm, bArr, list, z10);
            }
        }, (Handler) null);
    }
