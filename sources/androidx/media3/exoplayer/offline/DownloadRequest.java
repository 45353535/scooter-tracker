...
public final class DownloadRequest implements Parcelable {
    ...
    public DownloadRequest copyWithKeySetId(@Nullable byte[] bArr) {
        return new DownloadRequest(this.f5091id, this.uri, this.mimeType, this.streamKeys, bArr, this.customCacheKey, this.data);
    }

    public DownloadRequest copyWithMergedRequest(DownloadRequest downloadRequest) {
        List arrayList;
        Assertions.checkArgument(this.f5091id.equals(downloadRequest.f5091id));
        ...
        return new DownloadRequest(this.f5091id, downloadRequest.uri, downloadRequest.mimeType, arrayList, downloadRequest.keySetId, downloadRequest.customCacheKey, downloadRequest.data);
    }
    ...
    public MediaItem toMediaItem() {
        return new MediaItem.Builder().setMediaId(this.f5091id).setUri(this.uri).setCustomCacheKey(this.customCacheKey).setMimeType(this.mimeType).setStreamKeys(this.streamKeys).build();
    }

    public String toString() {
        return this.mimeType + StringUtils.PROCESS_POSTFIX_DELIMITER + this.f5091id;
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel parcel, int i10) {
        parcel.writeString(this.f5091id);
    ...
    DownloadRequest(Parcel parcel) {
        this.f5091id = (String) Util.castNonNull(parcel.readString());
