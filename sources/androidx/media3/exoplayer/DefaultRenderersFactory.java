...
public class DefaultRenderersFactory implements RenderersFactory {
    ...
    @Nullable
    protected AudioSink buildAudioSink(Context context, boolean z10, boolean z11) {
    ...
    protected void buildVideoRenderers(Context context, int i10, MediaCodecSelector mediaCodecSelector, boolean z10, Handler handler, VideoRendererEventListener videoRendererEventListener, long j10, ArrayList<Renderer> arrayList) {
        ...
        try {
            try {
                i13 = i12 + 1;
                try {
                    arrayList.add(i12, (Renderer) Class.forName("androidx.media3.decoder.av1.Libgav1VideoRenderer").getConstructor(cls2, Handler.class, VideoRendererEventListener.class, cls).newInstance(Long.valueOf(j10), handler, videoRendererEventListener, Integer.valueOf(i11)));
        ...
        try {
            arrayList.add(i13, (Renderer) Class.forName("androidx.media3.decoder.ffmpeg.ExperimentalFfmpegVideoRenderer").getConstructor(cls2, Handler.class, VideoRendererEventListener.class, cls).newInstance(Long.valueOf(j10), handler, videoRendererEventListener, Integer.valueOf(i11)));
