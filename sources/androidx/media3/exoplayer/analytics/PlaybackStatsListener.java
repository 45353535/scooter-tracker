...
public final class PlaybackStatsListener implements AnalyticsListener, PlaybackSessionManager.Listener {
    ...
    private static final class PlaybackStatsTracker {
        ...
        public PlaybackStatsTracker(boolean z10, AnalyticsListener.EventTime eventTime) {
            ...
            this.playbackStateHistory = z10 ? new ArrayList<>() : Collections.EMPTY_LIST;
            this.mediaTimeHistory = z10 ? new ArrayList<>() : Collections.EMPTY_LIST;
            this.videoFormatHistory = z10 ? new ArrayList<>() : Collections.EMPTY_LIST;
            this.audioFormatHistory = z10 ? new ArrayList<>() : Collections.EMPTY_LIST;
            this.fatalErrorHistory = z10 ? new ArrayList<>() : Collections.EMPTY_LIST;
            this.nonFatalErrorHistory = z10 ? new ArrayList<>() : Collections.EMPTY_LIST;
            boolean z11 = false;
        ...
        public PlaybackStats build(boolean z10) {
            ...
            return new PlaybackStats(1, jArr, arrayList4, list, j11, z11 ? 1 : 0, i13, z12 ? 1 : 0, i12, j10, i14, i15, i16, i17, i18, j12, z13 ? 1 : 0, arrayList2, arrayList3, j13, j14, j15, j16, j17, j18, i20, i21, i19, j19, i22, j20, j21, j22, j23, j24, i23 > 0 ? 1 : 0, i23, this.nonFatalErrorCount, this.fatalErrorHistory, this.nonFatalErrorHistory);
        }
    ...
    public void onEvents(Player player, AnalyticsListener.Events events) {
        ...
        while (it.hasNext()) {
            ...
            boolean z10 = hasEvent(events, next, 1003) || hasEvent(events, next, 1024);
    ...
    public /* synthetic */ void onSurfaceSizeChanged(AnalyticsListener.EventTime eventTime, int i10, int i11) {
        a.h0(this, eventTime, i10, i11);
    }

    @Override // androidx.media3.exoplayer.analytics.AnalyticsListener
    public /* synthetic */ void onTimelineChanged(AnalyticsListener.EventTime eventTime, int i10) {
        a.i0(this, eventTime, i10);
    }
    ...
    public /* synthetic */ void onVideoSizeChanged(AnalyticsListener.EventTime eventTime, int i10, int i11, int i12, float f10) {
        a.u0(this, eventTime, i10, i11, i12, f10);
    }

    @Override // androidx.media3.exoplayer.analytics.AnalyticsListener
    public /* synthetic */ void onVolumeChanged(AnalyticsListener.EventTime eventTime, float f10) {
        a.w0(this, eventTime, f10);
    }
