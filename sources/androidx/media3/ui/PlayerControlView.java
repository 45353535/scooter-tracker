        ...
        public void onBindViewHolderAtZeroPosition(SubSettingViewHolder subSettingViewHolder) {
            ...
            subSettingViewHolder.itemView.setOnClickListener(new View.OnClickListener() { // from class: androidx.media3.ui.i
                ...
                public final void onClick(View view) {
                    PlayerControlView.AudioTrackSelectionAdapter.b(this.f5334b, view);
                }
            });
        }
    ...
    final class PlaybackSpeedAdapter extends RecyclerView.Adapter<SubSettingViewHolder> {
        ...
        public static /* synthetic */ void a(PlaybackSpeedAdapter playbackSpeedAdapter, int i10, View view) {
            if (i10 != playbackSpeedAdapter.selectedIndex) {
                PlayerControlView.this.setPlaybackSpeed(playbackSpeedAdapter.playbackSpeeds[i10]);
            }
            PlayerControlView.this.settingsWindow.dismiss();
        }
        ...
        public void onBindViewHolder(SubSettingViewHolder subSettingViewHolder, final int i10) {
            ...
            subSettingViewHolder.itemView.setOnClickListener(new View.OnClickListener() { // from class: androidx.media3.ui.j
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    PlayerControlView.PlaybackSpeedAdapter.a(this.f5335b, i10, view);
                }
            });
        }
        ...
        public SettingViewHolder(View view) {
            ...
            view.setOnClickListener(new View.OnClickListener() { // from class: androidx.media3.ui.k
                ...
                public final void onClick(View view2) {
                    PlayerControlView.SettingViewHolder settingViewHolder = this.f5337b;
    ...
    final class TextTrackSelectionAdapter extends TrackSelectionAdapter {
        ...
        public void onBindViewHolderAtZeroPosition(SubSettingViewHolder subSettingViewHolder) {
            ...
            subSettingViewHolder.itemView.setOnClickListener(new View.OnClickListener() { // from class: androidx.media3.ui.l
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    PlayerControlView.TextTrackSelectionAdapter.b(this.f5338b, view);
                }
            });
        }
    ...
    abstract class TrackSelectionAdapter extends RecyclerView.Adapter<SubSettingViewHolder> {
        ...
        public void onBindViewHolder(SubSettingViewHolder subSettingViewHolder, int i10) {
            ...
            subSettingViewHolder.itemView.setOnClickListener(new View.OnClickListener() { // from class: androidx.media3.ui.m
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    PlayerControlView.TrackSelectionAdapter.a(this.f5339b, player, mediaTrackGroup, trackInformation, view);
                }
            });
        }
    ...
    */
    ...
    public PlayerControlView(Context context, @Nullable AttributeSet attributeSet, int i10, @Nullable AttributeSet attributeSet2) throws Throwable {
        ...
        if (attributeSet2 != null) {
            ...
            try {
                resourceId = typedArrayObtainStyledAttributes.getResourceId(R.styleable.PlayerControlView_controller_layout_id, i32);
                resourceId2 = typedArrayObtainStyledAttributes.getResourceId(R.styleable.PlayerControlView_play_icon, i33);
                resourceId3 = typedArrayObtainStyledAttributes.getResourceId(R.styleable.PlayerControlView_pause_icon, i34);
                resourceId4 = typedArrayObtainStyledAttributes.getResourceId(R.styleable.PlayerControlView_next_icon, i35);
                resourceId5 = typedArrayObtainStyledAttributes.getResourceId(R.styleable.PlayerControlView_fastforward_icon, i36);
                resourceId6 = typedArrayObtainStyledAttributes.getResourceId(R.styleable.PlayerControlView_previous_icon, i37);
                resourceId7 = typedArrayObtainStyledAttributes.getResourceId(R.styleable.PlayerControlView_rewind_icon, i38);
                resourceId8 = typedArrayObtainStyledAttributes.getResourceId(R.styleable.PlayerControlView_fullscreen_exit_icon, i39);
                resourceId9 = typedArrayObtainStyledAttributes.getResourceId(R.styleable.PlayerControlView_fullscreen_enter_icon, i40);
                resourceId10 = typedArrayObtainStyledAttributes.getResourceId(R.styleable.PlayerControlView_repeat_off_icon, i41);
                resourceId11 = typedArrayObtainStyledAttributes.getResourceId(R.styleable.PlayerControlView_repeat_one_icon, i42);
                resourceId12 = typedArrayObtainStyledAttributes.getResourceId(R.styleable.PlayerControlView_repeat_all_icon, i43);
                resourceId13 = typedArrayObtainStyledAttributes.getResourceId(R.styleable.PlayerControlView_shuffle_on_icon, i44);
                resourceId14 = typedArrayObtainStyledAttributes.getResourceId(R.styleable.PlayerControlView_shuffle_off_icon, i45);
                resourceId15 = typedArrayObtainStyledAttributes.getResourceId(R.styleable.PlayerControlView_subtitle_on_icon, i46);
                resourceId16 = typedArrayObtainStyledAttributes.getResourceId(R.styleable.PlayerControlView_subtitle_off_icon, i47);
                resourceId17 = typedArrayObtainStyledAttributes.getResourceId(R.styleable.PlayerControlView_vr_icon, i48);
            ...
            try {
                ...
                boolean z23 = typedArrayObtainStyledAttributes.getBoolean(R.styleable.PlayerControlView_show_rewind_button, true);
                boolean z24 = typedArrayObtainStyledAttributes.getBoolean(R.styleable.PlayerControlView_show_fastforward_button, true);
                boolean z25 = typedArrayObtainStyledAttributes.getBoolean(R.styleable.PlayerControlView_show_previous_button, true);
                boolean z26 = typedArrayObtainStyledAttributes.getBoolean(R.styleable.PlayerControlView_show_next_button, true);
                boolean z27 = typedArrayObtainStyledAttributes.getBoolean(R.styleable.PlayerControlView_show_shuffle_button, false);
                boolean z28 = typedArrayObtainStyledAttributes.getBoolean(R.styleable.PlayerControlView_show_subtitle_button, false);
                boolean z29 = typedArrayObtainStyledAttributes.getBoolean(R.styleable.PlayerControlView_show_vr_button, false);
                ...
                boolean z30 = typedArrayObtainStyledAttributes.getBoolean(R.styleable.PlayerControlView_animation_enabled, true);
        ...
        initializeFullScreenButton(imageView2, new View.OnClickListener() { // from class: androidx.media3.ui.g
            @Override // android.view.View.OnClickListener
            public final void onClick(View view) {
                this.f5331b.onFullScreenButtonClicked(view);
            }
        });
        ...
        if (imageView5 != null) {
            imageView5.setImageDrawable(Util.getDrawable(context2, resources, i23));
        ...
        if (imageView6 != null) {
            imageView6.setImageDrawable(Util.getDrawable(context2, resources, i19));
        ...
        if (imageView7 != null) {
            imageView7.setImageDrawable(Util.getDrawable(context2, resources, i31));
        ...
        if (imageView11 != null) {
            imageView11.setImageDrawable(Util.getDrawable(context2, resources, i12));
        ...
        playerControlView2.subtitleOnButtonDrawable = Util.getDrawable(context2, playerControlView2.resources, i14);
        playerControlView2.subtitleOffButtonDrawable = Util.getDrawable(context2, playerControlView2.resources, i21);
        ...
        playerControlView2.playButtonDrawable = Util.getDrawable(context2, playerControlView2.resources, i11);
        playerControlView2.pauseButtonDrawable = Util.getDrawable(context2, playerControlView2.resources, i26);
        playerControlView2.fullScreenExitDrawable = Util.getDrawable(context2, playerControlView2.resources, i30);
        playerControlView2.fullScreenEnterDrawable = Util.getDrawable(context2, playerControlView2.resources, i29);
        playerControlView2.repeatOffButtonDrawable = Util.getDrawable(context2, playerControlView2.resources, i28);
        playerControlView2.repeatOneButtonDrawable = Util.getDrawable(context2, playerControlView2.resources, i16);
        playerControlView2.repeatAllButtonDrawable = Util.getDrawable(context2, playerControlView2.resources, i17);
        playerControlView2.shuffleOnButtonDrawable = Util.getDrawable(context2, playerControlView2.resources, i18);
        playerControlView2.shuffleOffButtonDrawable = Util.getDrawable(context2, playerControlView2.resources, i20);
        ...
        playerControlView2.controlViewLayoutManager.setShowButton(playerControlView2.fastForwardButton, z18);
        playerControlView2.controlViewLayoutManager.setShowButton(playerControlView2.rewindButton, z20);
        playerControlView2.controlViewLayoutManager.setShowButton(playerControlView2.previousButton, z21);
        playerControlView2.controlViewLayoutManager.setShowButton(playerControlView2.nextButton, z19);
        playerControlView2.controlViewLayoutManager.setShowButton(playerControlView2.shuffleButton, z12);
        playerControlView2.controlViewLayoutManager.setShowButton(playerControlView2.subtitleButton, z13);
        playerControlView2.controlViewLayoutManager.setShowButton(playerControlView2.vrButton, z14);
        playerControlView2.controlViewLayoutManager.setShowButton(playerControlView2.repeatToggleButton, playerControlView2.repeatToggleModes != 0 ? true : z22);
        playerControlView2.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: androidx.media3.ui.h
            ...
            public final void onLayoutChange(View view3, int i52, int i53, int i54, int i55, int i56, int i57, int i58, int i59) {
                this.f5332b.onLayoutChange(view3, i52, i53, i54, i55, i56, i57, i58, i59);
            }
        });
    }
}
