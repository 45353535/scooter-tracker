...
final class SubtitleViewUtils {
    ...
    public static void removeAllEmbeddedStyling(Cue.Builder builder) {
        ...
        if (builder.getText() instanceof Spanned) {
            ...
            removeSpansIf((Spannable) Assertions.checkNotNull(builder.getText()), new Predicate() { // from class: androidx.media3.ui.s0
    ...
    public static void removeEmbeddedFontSizes(Cue.Builder builder) {
        ...
        if (builder.getText() instanceof Spanned) {
            ...
            removeSpansIf((Spannable) Assertions.checkNotNull(builder.getText()), new Predicate() { // from class: androidx.media3.ui.t0
                @Override // com.google.common.base.Predicate
                public final boolean apply(Object obj) {
