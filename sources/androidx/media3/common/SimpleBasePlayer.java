...
public abstract class SimpleBasePlayer extends BasePlayer {
    ...
    protected interface PositionSupplier {
        public static final PositionSupplier ZERO = g2.a(0);
    ...
    protected static final class State {
        ...
        public static final class Builder {
            ...
            public Builder() {
                ...
                this.contentPositionMsSupplier = g2.a(-9223372036854775807L);
                this.adPositionMs = null;
                PositionSupplier positionSupplier = PositionSupplier.ZERO;
                this.adPositionMsSupplier = positionSupplier;
                this.contentBufferedPositionMsSupplier = g2.a(-9223372036854775807L);
                this.adBufferedPositionMsSupplier = positionSupplier;
                this.totalBufferedDurationMsSupplier = positionSupplier;
                this.hasPositionDiscontinuity = false;
        ...
        private State(Builder builder) {
            ...
            PositionSupplier positionSupplierB = builder.contentPositionMs != null ? (builder.currentAdGroupIndex == -1 && builder.playWhenReady && builder.playbackState == 3 && builder.playbackSuppressionReason == 0 && builder.contentPositionMs.longValue() != -9223372036854775807L) ? g2.b(builder.contentPositionMs.longValue(), builder.playbackParameters.speed) : g2.a(builder.contentPositionMs.longValue()) : builder.contentPositionMsSupplier;
            PositionSupplier positionSupplierB2 = builder.adPositionMs != null ? (builder.currentAdGroupIndex != -1 && builder.playWhenReady && builder.playbackState == 3 && builder.playbackSuppressionReason == 0) ? g2.b(builder.adPositionMs.longValue(), 1.0f) : g2.a(builder.adPositionMs.longValue()) : builder.adPositionMsSupplier;
    ...
    public static /* synthetic */ void C(State state, Player.Listener listener) {
        listener.onLoadingChanged(state.isLoading);
        listener.onIsLoadingChanged(state.isLoading);
    }

    public static /* synthetic */ State E(SimpleBasePlayer simpleBasePlayer, State state, List list, int i10) {
    ...
    public static /* synthetic */ void H(int i10, Player.PositionInfo positionInfo, Player.PositionInfo positionInfo2, Player.Listener listener) {
    ...
    public static /* synthetic */ State P(boolean z10, State state, int i10, long j10) {
    ...
    public static /* synthetic */ State a(SimpleBasePlayer simpleBasePlayer, List list, State state, int i10, long j10) {
        simpleBasePlayer.getClass();
    ...
    private static State buildStateForNewPosition(State.Builder builder, State state, long j10, List<MediaItemData> list, int i10, long j11, boolean z10) {
        ...
        if (z12 || z11 || j11 < positionOrDefaultInMediaItem) {
            builder.setCurrentMediaItemIndex(i10).setCurrentAd(-1, -1).setContentPositionMs(j11).setContentBufferedPositionMs(g2.a(j11)).setTotalBufferedDurationMs(PositionSupplier.ZERO);
        } else if (j11 == positionOrDefaultInMediaItem) {
            builder.setCurrentMediaItemIndex(i10);
            if (state.currentAdGroupIndex == -1 || !z10) {
                builder.setCurrentAd(-1, -1).setTotalBufferedDurationMs(g2.a(getContentBufferedPositionMsInternal(state) - positionOrDefaultInMediaItem));
            } else {
                builder.setTotalBufferedDurationMs(g2.a(state.adBufferedPositionMsSupplier.get() - state.adPositionMsSupplier.get()));
            }
        } else {
            builder.setCurrentMediaItemIndex(i10).setCurrentAd(-1, -1).setContentPositionMs(j11).setContentBufferedPositionMs(g2.a(Math.max(getContentBufferedPositionMsInternal(state), j11))).setTotalBufferedDurationMs(g2.a(Math.max(0L, state.totalBufferedDurationMsSupplier.get() - (j11 - positionOrDefaultInMediaItem))));
        }
        return builder.build();
    }

    public static /* synthetic */ State c(SimpleBasePlayer simpleBasePlayer, State state, int i10, int i11) {
        simpleBasePlayer.getClass();
        ArrayList arrayList = new ArrayList(state.playlist);
    ...
    private void clearVideoOutput(@Nullable Object obj) {
        ...
        if (shouldHandleCommand(27)) {
            updateStateForPendingOperation(handleClearVideoOutput(obj), new Supplier() { // from class: androidx.media3.common.m1
    ...
    public static /* synthetic */ State o(SimpleBasePlayer simpleBasePlayer, State state, List list, int i10, int i11) {
        simpleBasePlayer.getClass();
        ArrayList arrayList = new ArrayList(state.playlist);
        for (int i12 = 0; i12 < list.size(); i12++) {
            arrayList.add(i12 + i10, simpleBasePlayer.getPlaceholderMediaItemData((MediaItem) list.get(i12)));
        }
    ...
    public static /* synthetic */ void p(SimpleBasePlayer simpleBasePlayer, ListenableFuture listenableFuture) {
    ...
    public static /* synthetic */ ListenableFuture r(ListenableFuture listenableFuture, Object obj) {
    ...
    private void setMediaItemsInternal(final List<MediaItem> list, final int i10, final long j10) {
        ...
        if (shouldHandleCommand(20) || (list.size() == 1 && shouldHandleCommand(31))) {
            updateStateForPendingOperation(handleSetMediaItems(list, i10, j10), new Supplier() { // from class: androidx.media3.common.t0
                @Override // com.google.common.base.Supplier
                public final Object get() {
                    return SimpleBasePlayer.a(this.f4712b, list, state, i10, j10);
                }
            });
        }
    }
    ...
    private void updateStateAndInformListeners(final State state, boolean z10, boolean z11) {
        ...
        if (positionDiscontinuityReason != -1) {
            ...
            this.listeners.queueEvent(11, new ListenerSet.Event() { // from class: androidx.media3.common.w
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
                    SimpleBasePlayer.H(positionDiscontinuityReason, positionInfo, positionInfo2, (Player.Listener) obj);
                }
            });
        }
        ...
        if (state2.isLoading != state.isLoading) {
            this.listeners.queueEvent(3, new ListenerSet.Event() { // from class: androidx.media3.common.q0
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
                    SimpleBasePlayer.C(state, (Player.Listener) obj);
                }
            });
        }
        if (z12 || z13) {
        ...
        if (state2.playbackSuppressionReason != state.playbackSuppressionReason) {
            this.listeners.queueEvent(6, new ListenerSet.Event() { // from class: androidx.media3.common.a2
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (isPlaying(state2) != isPlaying(state)) {
            this.listeners.queueEvent(7, new ListenerSet.Event() { // from class: androidx.media3.common.b2
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!state2.playbackParameters.equals(state.playbackParameters)) {
            this.listeners.queueEvent(12, new ListenerSet.Event() { // from class: androidx.media3.common.c2
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (state2.repeatMode != state.repeatMode) {
            this.listeners.queueEvent(8, new ListenerSet.Event() { // from class: androidx.media3.common.d2
                @Override // androidx.media3.common.util.ListenerSet.Event
                public final void invoke(Object obj) {
    ...
    public final void addMediaItems(int i10, final List<MediaItem> list) {
        ...
        updateStateForPendingOperation(handleAddMediaItems(iMin, list), new Supplier() { // from class: androidx.media3.common.z0
            @Override // com.google.common.base.Supplier
            public final Object get() {
                return SimpleBasePlayer.E(this.f4756b, state, list, iMin);
            }
        });
    }
    ...
    public final void decreaseDeviceVolume() {
        ...
        if (shouldHandleCommand(26)) {
            updateStateForPendingOperation(handleDecreaseDeviceVolume(1), new Supplier() { // from class: androidx.media3.common.c1
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    @ForOverride
    protected ListenableFuture<?> handleDecreaseDeviceVolume(int i10) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_ADJUST_DEVICE_VOLUME or COMMAND_ADJUST_DEVICE_VOLUME_WITH_FLAGS");
    }

    @ForOverride
    protected ListenableFuture<?> handleIncreaseDeviceVolume(int i10) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_ADJUST_DEVICE_VOLUME or COMMAND_ADJUST_DEVICE_VOLUME_WITH_FLAGS");
    }
    ...
    @ForOverride
    protected ListenableFuture<?> handleReplaceMediaItems(int i10, int i11, List<MediaItem> list) {
        ListenableFuture<?> listenableFutureHandleAddMediaItems = handleAddMediaItems(i11, list);
        final ListenableFuture<?> listenableFutureHandleRemoveMediaItems = handleRemoveMediaItems(i10, i11);
        return Util.transformFutureAsync(listenableFutureHandleAddMediaItems, new AsyncFunction() { // from class: androidx.media3.common.s1
            @Override // com.google.common.util.concurrent.AsyncFunction
            public final ListenableFuture apply(Object obj) {
                return SimpleBasePlayer.r(listenableFutureHandleRemoveMediaItems, obj);
            }
        });
    }
    ...
    @ForOverride
    protected ListenableFuture<?> handleSetAudioAttributes(AudioAttributes audioAttributes, boolean z10) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_SET_AUDIO_ATTRIBUTES");
    }

    @ForOverride
    protected ListenableFuture<?> handleSetDeviceMuted(boolean z10, int i10) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_ADJUST_DEVICE_VOLUME or COMMAND_ADJUST_DEVICE_VOLUME_WITH_FLAGS");
    }

    @ForOverride
    protected ListenableFuture<?> handleSetDeviceVolume(@IntRange(from = 0) int i10, int i11) {
    ...
    public final void increaseDeviceVolume() {
        ...
        final State state = this.state;
        if (shouldHandleCommand(26)) {
            updateStateForPendingOperation(handleIncreaseDeviceVolume(1), new Supplier() { // from class: androidx.media3.common.o1
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    public final void moveMediaItems(final int i10, int i11, int i12) {
        ...
        if (shouldHandleCommand(20) && size != 0 && i10 < size) {
            ...
            if (i10 != iMin && iMin2 != i10) {
                updateStateForPendingOperation(handleMoveMediaItems(i10, iMin, iMin2), new Supplier() { // from class: androidx.media3.common.n1
                    @Override // com.google.common.base.Supplier
                    public final Object get() {
                        return SimpleBasePlayer.K(this.f4682b, state, i10, iMin, iMin2);
                    }
                });
            }
        }
    ...
    public final void prepare() {
        ...
        if (shouldHandleCommand(2)) {
            updateStateForPendingOperation(handlePrepare(), new Supplier() { // from class: androidx.media3.common.v1
                @Override // com.google.common.base.Supplier
                public final Object get() {
                    SimpleBasePlayer.State state2 = state;
    ...
    public final void release() {
        ...
        if (shouldHandleCommand(32)) {
            updateStateForPendingOperation(handleRelease(), new Supplier() { // from class: androidx.media3.common.i1
                @Override // com.google.common.base.Supplier
                public final Object get() {
                    return SimpleBasePlayer.l0(state);
                }
            });
            this.released = true;
            this.listeners.release();
            this.state = this.state.buildUpon().setPlaybackState(1).setTotalBufferedDurationMs(PositionSupplier.ZERO).setContentBufferedPositionMs(g2.a(getContentPositionMsInternal(state))).setAdBufferedPositionMs(state.adPositionMsSupplier).setIsLoading(false).build();
        }
    }
    ...
    public final void removeMediaItems(final int i10, int i11) {
        ...
        updateStateForPendingOperation(handleRemoveMediaItems(i10, iMin), new Supplier() { // from class: androidx.media3.common.r1
            @Override // com.google.common.base.Supplier
            public final Object get() {
                return SimpleBasePlayer.c(this.f4700b, state, i10, iMin);
            }
        });
    }
    ...
    public final void replaceMediaItems(final int i10, int i11, final List<MediaItem> list) {
        ...
        final int iMin = Math.min(i11, size);
        updateStateForPendingOperation(handleReplaceMediaItems(i10, iMin, list), new Supplier() { // from class: androidx.media3.common.s0
            @Override // com.google.common.base.Supplier
            public final Object get() {
                return SimpleBasePlayer.o(this.f4705b, state, list, iMin, i10);
            }
        });
    }
    ...
    public final void seekTo(final int i10, final long j10, int i11, boolean z10) {
        ...
        if (shouldHandleCommand(i11)) {
            final boolean z11 = i10 == -1 || isPlayingAd() || (!state.playlist.isEmpty() && i10 >= state.playlist.size());
            updateStateForPendingOperation(handleSeek(i10, j10, i11), new Supplier() { // from class: androidx.media3.common.q1
                @Override // com.google.common.base.Supplier
                public final Object get() {
                    return SimpleBasePlayer.P(z11, state, i10, j10);
                }
            }, !z11, z10);
        }
    }
    ...
    public final void setAudioAttributes(final AudioAttributes audioAttributes, boolean z10) {
        ...
        if (shouldHandleCommand(35)) {
            updateStateForPendingOperation(handleSetAudioAttributes(audioAttributes, z10), new Supplier() { // from class: androidx.media3.common.p1
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    public final void setDeviceMuted(final boolean z10) {
        ...
        final State state = this.state;
        if (shouldHandleCommand(26)) {
            updateStateForPendingOperation(handleSetDeviceMuted(z10, 1), new Supplier() { // from class: androidx.media3.common.l1
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    public final void setDeviceVolume(final int i10) {
        ...
        if (shouldHandleCommand(25)) {
            updateStateForPendingOperation(handleSetDeviceVolume(i10, 1), new Supplier() { // from class: androidx.media3.common.c0
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    public final void setPlayWhenReady(final boolean z10) {
        ...
        if (shouldHandleCommand(1)) {
            updateStateForPendingOperation(handleSetPlayWhenReady(z10), new Supplier() { // from class: androidx.media3.common.q
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    public final void setPlaybackParameters(final PlaybackParameters playbackParameters) {
        ...
        if (shouldHandleCommand(13)) {
            updateStateForPendingOperation(handleSetPlaybackParameters(playbackParameters), new Supplier() { // from class: androidx.media3.common.x1
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    public final void setPlaylistMetadata(final MediaMetadata mediaMetadata) {
        ...
        if (shouldHandleCommand(19)) {
            updateStateForPendingOperation(handleSetPlaylistMetadata(mediaMetadata), new Supplier() { // from class: androidx.media3.common.e1
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    public final void setRepeatMode(final int i10) {
        ...
        if (shouldHandleCommand(15)) {
            updateStateForPendingOperation(handleSetRepeatMode(i10), new Supplier() { // from class: androidx.media3.common.f1
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    public final void setShuffleModeEnabled(final boolean z10) {
        ...
        if (shouldHandleCommand(14)) {
            updateStateForPendingOperation(handleSetShuffleModeEnabled(z10), new Supplier() { // from class: androidx.media3.common.a1
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    public final void setTrackSelectionParameters(final TrackSelectionParameters trackSelectionParameters) {
        ...
        if (shouldHandleCommand(29)) {
            updateStateForPendingOperation(handleSetTrackSelectionParameters(trackSelectionParameters), new Supplier() { // from class: androidx.media3.common.z1
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    public final void setVideoSurface(@Nullable Surface surface) {
        ...
        if (shouldHandleCommand(27)) {
            if (surface == null) {
                ...
                updateStateForPendingOperation(handleSetVideoOutput(surface), new Supplier() { // from class: androidx.media3.common.u0
                    @Override // com.google.common.base.Supplier
                    public final Object get() {
    ...
    public final void setVideoSurfaceHolder(@Nullable final SurfaceHolder surfaceHolder) {
        ...
        if (shouldHandleCommand(27)) {
            if (surfaceHolder == null) {
                ...
                updateStateForPendingOperation(handleSetVideoOutput(surfaceHolder), new Supplier() { // from class: androidx.media3.common.h1
                    @Override // com.google.common.base.Supplier
                    public final Object get() {
    ...
    public final void setVideoSurfaceView(@Nullable final SurfaceView surfaceView) {
        ...
        if (shouldHandleCommand(27)) {
            if (surfaceView == null) {
                ...
                updateStateForPendingOperation(handleSetVideoOutput(surfaceView), new Supplier() { // from class: androidx.media3.common.k1
                    @Override // com.google.common.base.Supplier
                    public final Object get() {
    ...
    public final void setVideoTextureView(@Nullable TextureView textureView) {
        ...
        if (shouldHandleCommand(27)) {
            if (textureView == null) {
                ...
                updateStateForPendingOperation(handleSetVideoOutput(textureView), new Supplier() { // from class: androidx.media3.common.n0
                    @Override // com.google.common.base.Supplier
                    public final Object get() {
    ...
    public final void setVolume(final float f10) {
        ...
        if (shouldHandleCommand(24)) {
            updateStateForPendingOperation(handleSetVolume(f10), new Supplier() { // from class: androidx.media3.common.g1
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    public final void stop() {
        ...
        if (shouldHandleCommand(3)) {
            updateStateForPendingOperation(handleStop(), new Supplier() { // from class: androidx.media3.common.t1
                @Override // com.google.common.base.Supplier
                public final Object get() {
                    SimpleBasePlayer.State state2 = state;
                    return state2.buildUpon().setPlaybackState(1).setTotalBufferedDurationMs(SimpleBasePlayer.PositionSupplier.ZERO).setContentBufferedPositionMs(g2.a(SimpleBasePlayer.getContentPositionMsInternal(state2))).setAdBufferedPositionMs(state2.adPositionMsSupplier).setIsLoading(false).build();
                }
            });
        }
    }
    ...
    protected SimpleBasePlayer(Looper looper, Clock clock) {
        ...
        this.listeners = new ListenerSet<>(looper, clock, new ListenerSet.IterationFinishedEvent() { // from class: androidx.media3.common.d1
            @Override // androidx.media3.common.util.ListenerSet.IterationFinishedEvent
            public final void invoke(Object obj, FlagSet flagSet) {
                SimpleBasePlayer.s(this.f4649a, (Player.Listener) obj, flagSet);
            }
        });
    }
    ...
    private void updateStateForPendingOperation(final ListenableFuture<?> listenableFuture, Supplier<State> supplier, boolean z10, boolean z11) {
        ...
        listenableFuture.addListener(new Runnable() { // from class: androidx.media3.common.v0
            ...
            public final void run() {
                SimpleBasePlayer.p(this.f4738b, listenableFuture);
            }
        }, new Executor() { // from class: androidx.media3.common.w0
            @Override // java.util.concurrent.Executor
            public final void execute(Runnable runnable) {
                this.f4744b.postOrRunOnApplicationHandler(runnable);
            }
        });
    }
    ...
    public final void decreaseDeviceVolume(int i10) {
        ...
        if (shouldHandleCommand(34)) {
            updateStateForPendingOperation(handleDecreaseDeviceVolume(i10), new Supplier() { // from class: androidx.media3.common.w1
                @Override // com.google.common.base.Supplier
                public final Object get() {
                    return state.buildUpon().setDeviceVolume(Math.max(0, r0.deviceVolume - 1)).build();
                }
    ...
    public final void increaseDeviceVolume(int i10) {
        ...
        final State state = this.state;
        if (shouldHandleCommand(34)) {
            updateStateForPendingOperation(handleIncreaseDeviceVolume(i10), new Supplier() { // from class: androidx.media3.common.x0
                @Override // com.google.common.base.Supplier
                public final Object get() {
                    SimpleBasePlayer.State state2 = state;
                    return state2.buildUpon().setDeviceVolume(state2.deviceVolume + 1).build();
    ...
    public final void setDeviceMuted(final boolean z10, int i10) {
        ...
        final State state = this.state;
        if (shouldHandleCommand(34)) {
            updateStateForPendingOperation(handleSetDeviceMuted(z10, i10), new Supplier() { // from class: androidx.media3.common.y1
                @Override // com.google.common.base.Supplier
                public final Object get() {
                    return state.buildUpon().setIsDeviceMuted(z10).build();
                }
    ...
    public final void setDeviceVolume(final int i10, int i11) {
        ...
        if (shouldHandleCommand(33)) {
            updateStateForPendingOperation(handleSetDeviceVolume(i10, i11), new Supplier() { // from class: androidx.media3.common.b1
                @Override // com.google.common.base.Supplier
                public final Object get() {
                    return state.buildUpon().setDeviceVolume(i10).build();
                }
