...
public abstract class Timeline {
    ...
    public static final class Period {
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            if (obj != null && Period.class.equals(obj.getClass())) {
                ...
                if (Util.areEqual(this.f4635id, period.f4635id) && Util.areEqual(this.uid, period.uid) && this.windowIndex == period.windowIndex && this.durationUs == period.durationUs && this.positionInWindowUs == period.positionInWindowUs && this.isPlaceholder == period.isPlaceholder && Util.areEqual(this.adPlaybackState, period.adPlaybackState)) {
                    return true;
                }
            }
            return false;
    ...
    public static final class RemotableTimeline extends Timeline {
        ...
        public Period getPeriod(int i10, Period period, boolean z10) {
            ...
            period.set(period2.f4635id, period2.uid, period2.windowIndex, period2.durationUs, period2.positionInWindowUs, period2.adPlaybackState, period2.isPlaceholder);
            return period;
        }
    ...
    public static Timeline fromBundle(Bundle bundle) {
        ImmutableList immutableListFromBundleListRetriever = fromBundleListRetriever(new Function() { // from class: androidx.media3.common.h2
            @Override // com.google.common.base.Function
            public final Object apply(Object obj) {
                return Timeline.Window.fromBundle((Bundle) obj);
            }
        }, bundle.getBinder(FIELD_WINDOWS));
        ImmutableList immutableListFromBundleListRetriever2 = fromBundleListRetriever(new Function() { // from class: androidx.media3.common.i2
            @Override // com.google.common.base.Function
            public final Object apply(Object obj) {
