...
public class TrackSelectionParameters {
    ...
    public Bundle toBundle() {
        ...
        bundle.putParcelableArrayList(FIELD_SELECTION_OVERRIDES, BundleCollectionUtil.toBundleArrayList(this.overrides.values(), new Function() { // from class: androidx.media3.common.k2
    ...
    public static class Builder {
        ...
        protected Builder(Bundle bundle) {
            ...
            if (parcelableArrayList == null) {
                ...
                immutableListFromBundleList = BundleCollectionUtil.fromBundleList(new Function() { // from class: androidx.media3.common.l2
                    @Override // com.google.common.base.Function
                    public final Object apply(Object obj) {
            ...
            this.overrides = new HashMap<>();
            for (int i10 = 0; i10 < immutableListFromBundleList.size(); i10++) {
                TrackSelectionOverride trackSelectionOverride = (TrackSelectionOverride) immutableListFromBundleList.get(i10);
                this.overrides.put(trackSelectionOverride.mediaTrackGroup, trackSelectionOverride);
            }
