...
final class CachedContent {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj != null && CachedContent.class == obj.getClass()) {
            ...
            if (this.f4763id == cachedContent.f4763id && this.key.equals(cachedContent.key) && this.cachedSpans.equals(cachedContent.cachedSpans) && this.metadata.equals(cachedContent.metadata)) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        return (((this.f4763id * 31) + this.key.hashCode()) * 31) + this.metadata.hashCode();
    }
    ...
    public SimpleCacheSpan setLastTouchTimestamp(SimpleCacheSpan simpleCacheSpan, long j10, boolean z10) {
        ...
        if (z10) {
            j11 = j10;
            File cacheFile = SimpleCacheSpan.getCacheFile((File) Assertions.checkNotNull(file.getParentFile()), this.f4763id, simpleCacheSpan.position, j11);
