    ...
    public static long getContentLength(@Nullable String str, @Nullable String str2) {
        ...
        if (TextUtils.isEmpty(str)) {
            ...
            try {
                ...
                Log.e(TAG, "Unexpected Content-Length [" + str + C4240b4.j.f42674e);
                j10 = -1;
            }
        }
        ...
        try {
            ...
            Log.w(TAG, "Inconsistent headers [" + str + "] [" + str2 + C4240b4.j.f42674e);
            return Math.max(j10, j11);
        } catch (NumberFormatException unused2) {
            Log.e(TAG, "Unexpected Content-Range [" + str2 + C4240b4.j.f42674e);
            return j10;
        }
    }
