...
public final class MdtaMetadataEntry implements Metadata.Entry {
    ...
    public String toString() {
        ...
        return "mdta: key=" + this.key + ", value=" + (i10 != 1 ? i10 != 23 ? i10 != 67 ? Util.toHexString(this.value) : String.valueOf(Ints.fromByteArray(this.value)) : String.valueOf(Float.intBitsToFloat(Ints.fromByteArray(this.value))) : Util.fromUtf8Bytes(this.value));
    }
