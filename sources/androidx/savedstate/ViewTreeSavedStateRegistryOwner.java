...
public final class ViewTreeSavedStateRegistryOwner {
    ...
    public static final SavedStateRegistryOwner get(@NotNull View view) {
        ...
        return (SavedStateRegistryOwner) k.I(k.R(k.q(view, new Function1<View, View>() { // from class: androidx.savedstate.ViewTreeSavedStateRegistryOwner$findViewTreeSavedStateRegistryOwner$1
