...
public final class ViewTreeLifecycleOwner {
    ...
    public static final LifecycleOwner get(@NotNull View view) {
        ...
        return (LifecycleOwner) kotlin.sequences.k.I(kotlin.sequences.k.R(kotlin.sequences.k.q(view, new Function1<View, View>() { // from class: androidx.lifecycle.ViewTreeLifecycleOwner$findViewTreeLifecycleOwner$1
