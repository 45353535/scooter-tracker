...
public final class ViewTreeViewModelStoreOwner {
    ...
    public static final ViewModelStoreOwner get(@NotNull View view) {
        ...
        return (ViewModelStoreOwner) kotlin.sequences.k.I(kotlin.sequences.k.R(kotlin.sequences.k.q(view, new Function1<View, View>() { // from class: androidx.lifecycle.ViewTreeViewModelStoreOwner$findViewTreeViewModelStoreOwner$1
