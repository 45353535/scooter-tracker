...
class RoundRectDrawableWithShadow extends Drawable {
    ...
    RoundRectDrawableWithShadow(Resources resources, ColorStateList colorStateList, float f10, float f11, float f12) {
    ...
    static float calculateHorizontalPadding(float f10, float f11, boolean z10) {
        return z10 ? (float) (((double) f10) + ((1.0d - COS_45) * ((double) f11))) : f10;
    }

    static float calculateVerticalPadding(float f10, float f11, boolean z10) {
        return z10 ? (float) (((double) (f10 * SHADOW_MULTIPLIER)) + ((1.0d - COS_45) * ((double) f11))) : f10 * SHADOW_MULTIPLIER;
    }
    ...
    private void drawShadow(Canvas canvas) {
        ...
        if (z10) {
            canvas2 = canvas;
            canvas2.drawRect(0.0f, f11, this.mCardBounds.width() - f13, -this.mCornerRadius, this.mEdgeShadowPaint);
        } else {
            canvas2 = canvas;
        }
        ...
        if (z10) {
            canvas2.drawRect(0.0f, f11, this.mCardBounds.width() - f13, (-this.mCornerRadius) + this.mShadowSize, this.mEdgeShadowPaint);
        }
        ...
        canvas2.drawPath(this.mCornerShadowPath, this.mCornerShadowPaint);
        if (z11) {
            canvas2.drawRect(0.0f, f11, this.mCardBounds.height() - f13, -this.mCornerRadius, this.mEdgeShadowPaint);
        }
    ...
    void setAddPaddingForCorners(boolean z10) {
    ...
    void setMaxShadowSize(float f10) {
        setShadowSize(this.mRawShadowSize, f10);
    }

    void setShadowSize(float f10) {
