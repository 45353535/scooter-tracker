...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        int i10 = staggeredGridLayoutManager.mLayoutState.mInfinite ? layoutState.mLayoutDirection == 1 ? Integer.MAX_VALUE : Integer.MIN_VALUE : layoutState.mLayoutDirection == 1 ? layoutState.mEndLine + layoutState.mAvailable : layoutState.mStartLine - layoutState.mAvailable;
        staggeredGridLayoutManager.updateAllRemainingSpans(layoutState.mLayoutDirection, i10);
        ...
        while (layoutState.hasMore(state) && (r03.mLayoutState.mInfinite || !r03.mRemainingSpans.isEmpty())) {
            ...
            if (r03.isLayoutRTL() && r03.mOrientation == 1) {
                ...
                startAfterPadding = layoutParams.mFullSpan ? r03.mSecondaryOrientation.getStartAfterPadding() : (span2.mIndex * r03.mSizePerSpan) + r03.mSecondaryOrientation.getStartAfterPadding();
                decoratedMeasurement2 = r03.mSecondaryOrientation.getDecoratedMeasurement(next) + startAfterPadding;
            }
            int i11 = decoratedMeasurement2;
            int i12 = startAfterPadding;
            if (r03.mOrientation == 1) {
                r03.layoutDecoratedWithMargins(next, i12, decoratedMeasurement, i11, minStart);
                r02 = this;
            } else {
                r03.layoutDecoratedWithMargins(next, decoratedMeasurement, i12, minStart, i11);
                r02 = r03;
            }
            if (layoutParams.mFullSpan) {
                r02.updateAllRemainingSpans(r02.mLayoutState.mLayoutDirection, i10);
            } else {
                r02.updateRemainingSpans(span2, r02.mLayoutState.mLayoutDirection, i10);
            }
