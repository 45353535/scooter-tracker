...
public final class SpringForce implements Force {
    ...
    DynamicAnimation.MassState updateValues(double d10, double d11, long j10) {
        double dPow;
        double dCos;
        init();
        ...
        if (d14 > 1.0d) {
            ...
            dPow = Math.pow(2.718281828459045d, (-d14) * d26 * d12) * ((Math.cos(this.mDampedFreq * d12) * d13) + (Math.sin(this.mDampedFreq * d12) * d27));
