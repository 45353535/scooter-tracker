...
public class UserAgentMetadataInternal {
    ...
    @NonNull
    static Map<String, Object> convertUserAgentMetadataToMap(@NonNull UserAgentMetadata userAgentMetadata) {
    ...
    @NonNull
    static UserAgentMetadata getUserAgentMetadataFromMap(@NonNull Map<String, Object> map) {
