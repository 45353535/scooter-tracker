    ...
    public static class AlertParams {
        ...
        private void createListView(AlertController alertController) {
            ...
            if (!this.mIsMultiChoice) {
                ...
                int i10 = alertParams.mIsSingleChoice ? alertController2.mSingleChoiceItemLayout : alertController2.mListItemLayout;
                if (alertParams.mCursor != null) {
                    checkedItemAdapter = new SimpleCursorAdapter(alertParams.mContext, i10, alertParams.mCursor, new String[]{alertParams.mLabelColumn}, new int[]{R.id.text1});
                } else {
                    checkedItemAdapter = alertParams.mAdapter;
                    if (checkedItemAdapter == null) {
                        checkedItemAdapter = new CheckedItemAdapter(alertParams.mContext, i10, R.id.text1, alertParams.mItems);
                    }
                }
            ...
            if (alertParams.mOnClickListener != null) {
                recycleListView.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: androidx.appcompat.app.AlertController.AlertParams.3
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i11, long j10) {
                        AlertParams.this.mOnClickListener.onClick(alertController2.mDialog, i11);
                ...
                recycleListView.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: androidx.appcompat.app.AlertController.AlertParams.4
                    ...
                    public void onItemClick(AdapterView<?> adapterView, View view, int i11, long j10) {
                        ...
                        AlertParams.this.mOnCheckboxClickListener.onClick(alertController2.mDialog, i11, recycleListView.isItemChecked(i11));
                    }
                });
            }
