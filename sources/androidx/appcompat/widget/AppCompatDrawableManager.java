...
public final class AppCompatDrawableManager {
    ...
    synchronized ColorStateList getTintList(@NonNull Context context, @DrawableRes int i10) {
    ...
    synchronized Drawable getDrawable(@NonNull Context context, @DrawableRes int i10, boolean z10) {
