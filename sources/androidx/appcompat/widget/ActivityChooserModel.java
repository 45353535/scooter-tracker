...
class ActivityChooserModel extends DataSetObservable {
    ...
    public static final class ActivityResolveInfo implements Comparable<ActivityResolveInfo> {
        ...
        public String toString() {
            return C4240b4.j.f42672d + "resolveInfo:" + this.resolveInfo.toString() + "; weight:" + new BigDecimal(this.weight) + C4240b4.j.f42674e;
        }
    ...
    public static final class HistoricalRecord {
        ...
        public String toString() {
            return C4240b4.j.f42672d + "; activity:" + this.activity + "; time:" + this.time + "; weight:" + new BigDecimal(this.weight) + C4240b4.j.f42674e;
        }
