...
public final class ViewTreeOnBackPressedDispatcherOwner {
    ...
    public static final OnBackPressedDispatcherOwner get(@NotNull View view) {
        ...
        return (OnBackPressedDispatcherOwner) kotlin.sequences.k.I(kotlin.sequences.k.R(kotlin.sequences.k.q(view, new Function1<View, View>() { // from class: androidx.activity.ViewTreeOnBackPressedDispatcherOwner$findViewTreeOnBackPressedDispatcherOwner$1
