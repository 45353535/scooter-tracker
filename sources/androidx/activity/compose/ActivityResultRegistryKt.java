...
public final class ActivityResultRegistryKt {
    ...
    public static final <I, O> ManagedActivityResultLauncher<I, O> rememberLauncherForActivityResult(@NotNull ActivityResultContract<I, O> activityResultContract, @NotNull Function1<? super O, Unit> function1, @Nullable Composer composer, int i10) {
        ...
        State stateRememberUpdatedState2 = SnapshotStateKt.rememberUpdatedState(function1, composer, (i10 >> 3) & 14);
        String str2 = (String) RememberSaveableKt.m1261rememberSaveable(new Object[0], (Saver) null, (String) null, (Function0) new Function0<String>() { // from class: androidx.activity.compose.ActivityResultRegistryKt$rememberLauncherForActivityResult$key$1
        ...
        if (zChanged || objRememberedValue3 == companion.getEmpty()) {
            ...
            Object activityResultRegistryKt$rememberLauncherForActivityResult$1$1 = new ActivityResultRegistryKt$rememberLauncherForActivityResult$1$1(activityResultLauncherHolder, activityResultRegistry, str2, activityResultContract, stateRememberUpdatedState2);
            str = str2;
        ...
        EffectsKt.DisposableEffect(activityResultRegistry3, str, activityResultContract, (Function1) objRememberedValue3, composer, (i10 << 6) & 896);
        composer.endReplaceableGroup();
