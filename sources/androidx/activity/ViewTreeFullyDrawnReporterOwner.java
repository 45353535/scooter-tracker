...
public final class ViewTreeFullyDrawnReporterOwner {
    ...
    public static final FullyDrawnReporterOwner get(@NotNull View view) {
        ...
        return (FullyDrawnReporterOwner) kotlin.sequences.k.I(kotlin.sequences.k.R(kotlin.sequences.k.q(view, new Function1<View, View>() { // from class: androidx.activity.ViewTreeFullyDrawnReporterOwner$findViewTreeFullyDrawnReporterOwner$1
