...
public final class FrameworkSQLiteDatabase implements SupportSQLiteDatabase, AutoCloseable {
    ...
    static {
        l lVar = l.f94210c;
        getThreadSessionMethod$delegate = i.b(lVar, new Function0() { // from class: androidx.sqlite.db.framework.d
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return FrameworkSQLiteDatabase.getThreadSessionMethod_delegate$lambda$7();
            }
        });
        beginTransactionMethod$delegate = i.b(lVar, new Function0() { // from class: androidx.sqlite.db.framework.e
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
    ...
    @Override // androidx.sqlite.db.SupportSQLiteDatabase
    public void beginTransactionWithListenerReadOnly(@NotNull SQLiteTransactionListener transactionListener) throws IllegalAccessException, InvocationTargetException {
        Intrinsics.checkNotNullParameter(transactionListener, "transactionListener");
    ...
    public void m4255setMaximumSize(long j10) {
    ...
    public Cursor query(@NotNull final SupportSQLiteQuery query) {
        ...
        Cursor cursorRawQueryWithFactory = this.delegate.rawQueryWithFactory(new SQLiteDatabase.CursorFactory() { // from class: androidx.sqlite.db.framework.c
