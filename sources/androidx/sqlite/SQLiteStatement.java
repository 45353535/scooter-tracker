...
public interface SQLiteStatement extends AutoCloseable {
    ...
    void mo4249bindBlob(@IntRange(from = 1) int index, @NotNull byte[] value);

    void bindBoolean(@IntRange(from = 1) int index, boolean value);

    /* JADX INFO: renamed from: bindDouble */
    void mo4250bindDouble(@IntRange(from = 1) int index, double value);
    ...
    void mo4251bindLong(@IntRange(from = 1) int index, long value);

    /* JADX INFO: renamed from: bindNull */
    void mo4252bindNull(@IntRange(from = 1) int index);

    /* JADX INFO: renamed from: bindText */
    void mo4253bindText(@IntRange(from = 1) int index, @NotNull String value);

    /* JADX INFO: renamed from: clearBindings */
    void mo4254clearBindings();
