...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    void setAllowCaching(boolean z10) {
    ...
    private static class VPathRenderer {
        ...
        private void drawGroupTree(VGroup vGroup, Matrix matrix, Canvas canvas, int i10, int i11, ColorFilter colorFilter) {
            ...
            canvas.save();
            int i12 = 0;
            while (i12 < vGroup2.mChildren.size()) {
                VObject vObject = vGroup2.mChildren.get(i12);
                if (vObject instanceof VGroup) {
                    drawGroupTree((VGroup) vObject, vGroup2.mStackedMatrix, canvas, i10, i11, colorFilter);
                } else if (vObject instanceof VPath) {
                    drawPath(vGroup2, (VPath) vObject, canvas, i10, i11, colorFilter);
                }
                i12++;
                vGroup2 = vGroup;
            }
