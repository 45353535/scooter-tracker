...
public final class CubicKt {
    @NotNull
    public static final Cubic Cubic(float f10, float f11, float f12, float f13, float f14, float f15, float f16, float f17) {
        return new Cubic(new float[]{f10, f11, f12, f13, f14, f15, f16, f17});
    }
}
