...
@e(c = "androidx.compose.foundation.lazy.LazyListItemPlacementAnimator$startAnimationsIfNeeded$1$1", f = "LazyListItemPlacementAnimator.kt", l = {297}, m = "invokeSuspend")
final class LazyListItemPlacementAnimator$startAnimationsIfNeeded$1$1 extends k implements Function2<CoroutineScope, Continuation, Object> {
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        try {
            if (i10 == 0) {
                ...
                try {
                    if (Animatable.animateTo$default(animatedOffset, intOffsetM4060boximpl, animationSpec2, null, null, lazyListItemPlacementAnimator$startAnimationsIfNeeded$1$1, 12, null) == objG) {
                        return objG;
                    }
    ...
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation continuation) {
        return ((LazyListItemPlacementAnimator$startAnimationsIfNeeded$1$1) create(coroutineScope, continuation)).invokeSuspend(Unit.f93236a);
    }
}
