...
final class LazyListItemProviderImpl implements LazyListItemProvider, LazyLayoutItemProvider {
    ...
    public LazyListItemProviderImpl(@NotNull IntervalList<LazyListIntervalContent> intervals, @NotNull IntRange nearestItemsRange, @NotNull List<Integer> headerIndexes, @NotNull final LazyItemScopeImpl itemScope, @NotNull final LazyListState state) {
        ...
        this.$$delegate_0 = LazyLayoutItemProviderKt.LazyLayoutItemProvider(intervals, nearestItemsRange, ComposableLambdaKt.composableLambdaInstance(2070454083, true, new Function4<IntervalList.Interval<? extends LazyListIntervalContent>, Integer, Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.LazyListItemProviderImpl.1
            ...
            @Composable
            public final void invoke(@NotNull final IntervalList.Interval<LazyListIntervalContent> interval, int i10, @Nullable Composer composer, int i11) {
                int i12;
                ...
                LazyLayoutPinnableItemKt.LazyLayoutPinnableItem(objInvoke, i10, pinnedItems, ComposableLambdaKt.composableLambda(composer, 1210565839, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.LazyListItemProviderImpl.1.1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(2);
                    }
                    ...
                    public final void invoke(@Nullable Composer composer2, int i13) {
                        ...
                        if (ComposerKt.isTraceInProgress()) {
                            ComposerKt.traceEventStart(1210565839, i13, -1, "androidx.compose.foundation.lazy.LazyListItemProviderImpl.$$delegate_0.<anonymous>.<anonymous> (LazyListItemProvider.kt:87)");
                        }
    ...
    public void Item(final int i10, @Nullable Composer composer, final int i11) {
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.foundation.lazy.LazyListItemProviderImpl.Item.1
            ...
            public final void invoke(@Nullable Composer composer2, int i13) {
                LazyListItemProviderImpl.this.Item(i10, composer2, RecomposeScopeImplKt.updateChangedFlags(i11 | 1));
            }
        });
    }
