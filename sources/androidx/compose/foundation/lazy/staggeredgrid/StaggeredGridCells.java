...
public interface StaggeredGridCells {
    ...
    public static final class Adaptive implements StaggeredGridCells {
        ...
        public List<Integer> calculateCrossAxisCellSizes(@NotNull Density density, int i10, int i11) {
            ...
            return LazyStaggeredGridCellsKt.calculateCellsCrossAxisSizeImpl(i10, Math.max((i10 + i11) / (density.mo302roundToPx0680j_4(this.minSize) + i11), 1), i11);
        }

        public boolean equals(@Nullable Object other) {
            return (other instanceof Adaptive) && Dp.m3956equalsimpl0(this.minSize, ((Adaptive) other).minSize);
        }

        public int hashCode() {
            return Dp.m3957hashCodeimpl(this.minSize);
        }
