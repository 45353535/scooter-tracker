...
public final class LazyGridMeasureResult implements LazyGridLayoutInfo, MeasureResult {
    ...
    public LazyGridMeasureResult(@Nullable LazyGridMeasuredLine lazyGridMeasuredLine, int i10, boolean z10, float f10, @NotNull MeasureResult measureResult, @NotNull List<? extends LazyGridItemInfo> visibleItemsInfo, int i11, int i12, int i13, boolean z11, @NotNull Orientation orientation, int i14, int i15) {
    ...
    public long mo541getViewportSizeYbymL2g() {
