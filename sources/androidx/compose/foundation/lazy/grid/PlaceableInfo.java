...
final class PlaceableInfo {
    ...
    public final void m612setTargetOffsetgyyYBs(long j10) {
        this.targetOffset = j10;
    }

    private PlaceableInfo(long j10, int i10) {
        this.mainAxisSize = i10;
        this.animatedOffset = new Animatable<>(IntOffset.m4060boximpl(j10), VectorConvertersKt.getVectorConverter(IntOffset.INSTANCE), null, 4, null);
        this.targetOffset = j10;
