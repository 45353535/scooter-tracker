...
public final class LazySemanticsKt {
    @Composable
    @NotNull
    public static final LazyLayoutSemanticState rememberLazyGridSemanticState(@NotNull final LazyGridState state, boolean z10, @Nullable Composer composer, int i10) {
        ...
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = new LazyLayoutSemanticState() { // from class: androidx.compose.foundation.lazy.grid.LazySemanticsKt$rememberLazyGridSemanticState$1$1
                ...
                public Object scrollToItem(int i11, @NotNull Continuation continuation) {
                    Object objScrollToItem$default = LazyGridState.scrollToItem$default(state, i11, 0, continuation, 2, null);
