...
public final class LazyLayoutPrefetcher implements RememberObserver, LazyLayoutPrefetchState.Prefetcher, Runnable, Choreographer.FrameCallback {
    ...
    @Metadata(d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\t\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bH\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006\t"}, d2 = {"Landroidx/compose/foundation/lazy/layout/LazyLayoutPrefetcher$Companion;", "", "()V", "frameIntervalNs", "", "calculateFrameIntervalIfNeeded", "", MBridgeConstans.DYNAMIC_VIEW_KEY_VIEW, "Landroid/view/View;", "foundation_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    ...
    private final long calculateAverageTime(long j10, long current) {
        ...
        long j11 = 4;
        return ((current / j11) * ((long) 3)) + (j10 / j11);
    }
                        ...
                        try {
                            ...
                            if (enoughTimeLeft(jNanoTime2, nanos, this.averagePremeasureTimeNs)) {
                                ...
                                for (int i10 = 0; i10 < placeablesCount; i10++) {
                                    precomposeHandle.mo3023premeasure0kLqBqw(i10, prefetchRequest.getConstraints());
                                }
    ...
    public LazyLayoutPrefetchState.PrefetchHandle mo621schedulePrefetch0kLqBqw(int index, long constraints) {
