...
public final class LazyListMeasureResult implements LazyListLayoutInfo, MeasureResult {
    ...
    public LazyListMeasureResult(@Nullable LazyMeasuredItem lazyMeasuredItem, int i10, boolean z10, float f10, @NotNull MeasureResult measureResult, @NotNull List<? extends LazyListItemInfo> visibleItemsInfo, int i11, int i12, int i13, boolean z11, @NotNull Orientation orientation, int i14, int i15) {
    ...
    public long mo517getViewportSizeYbymL2g() {
