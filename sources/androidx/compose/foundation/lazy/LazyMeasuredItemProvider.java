...
public final class LazyMeasuredItemProvider {
    ...
    public final LazyMeasuredItem m537getAndMeasureZjPyQlc(int index) {
        return this.measuredItemFactory.mo524createItemHK0c1C0(index, this.itemProvider.getKey(index), this.measureScope.mo619measure0kLqBqw(index, this.childConstraints));
    }
    ...
    private LazyMeasuredItemProvider(long j10, boolean z10, LazyListItemProvider lazyListItemProvider, LazyLayoutMeasureScope lazyLayoutMeasureScope, MeasuredItemFactory measuredItemFactory) {
        ...
        this.childConstraints = ConstraintsKt.Constraints$default(0, z10 ? Constraints.m3919getMaxWidthimpl(j10) : Integer.MAX_VALUE, 0, z10 ? Integer.MAX_VALUE : Constraints.m3918getMaxHeightimpl(j10), 5, null);
    }
}
