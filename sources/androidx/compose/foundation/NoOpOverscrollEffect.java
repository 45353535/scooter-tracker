...
public final class NoOpOverscrollEffect implements OverscrollEffect {
    ...
    public Object mo164applyToFlingBMRW4eQ(long j10, @NotNull Function2<? super Velocity, ? super Continuation, ? extends Object> function2, @NotNull Continuation continuation) {
        Object objInvoke = function2.invoke(Velocity.m4167boximpl(j10), continuation);
        return objInvoke == pf.b.g() ? objInvoke : Unit.f93236a;
    }

    @Override // androidx.compose.foundation.OverscrollEffect
    /* JADX INFO: renamed from: applyToScroll-Rhakbz0 */
    public long mo165applyToScrollRhakbz0(long delta, int source, @NotNull Function1<? super Offset, Offset> performScroll) {
        Intrinsics.checkNotNullParameter(performScroll, "performScroll");
        return performScroll.invoke(Offset.m1360boximpl(delta)).getPackedValue();
    }
