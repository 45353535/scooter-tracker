...
public final class OverscrollConfiguration {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Color.m1605equalsimpl0(this.glowColor, overscrollConfiguration.glowColor) && Intrinsics.areEqual(this.drawPadding, overscrollConfiguration.drawPadding);
    }
    ...
    public int hashCode() {
        return (Color.m1611hashCodeimpl(this.glowColor) * 31) + this.drawPadding.hashCode();
    }

    @NotNull
    public String toString() {
        return "OverscrollConfiguration(glowColor=" + ((Object) Color.m1612toStringimpl(this.glowColor)) + ", drawPadding=" + this.drawPadding + ')';
    }
    ...
    public /* synthetic */ OverscrollConfiguration(long j10, PaddingValues paddingValues, int i10, DefaultConstructorMarker defaultConstructorMarker) {
        this((i10 & 1) != 0 ? ColorKt.Color(4284900966L) : j10, (i10 & 2) != 0 ? PaddingKt.m413PaddingValuesYgX7TsA$default(0.0f, 0.0f, 3, null) : paddingValues, null);
    }
}
