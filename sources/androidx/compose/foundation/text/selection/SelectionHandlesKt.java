...
public final class SelectionHandlesKt {
    ...
    static {
        float f10 = 25;
        HandleWidth = Dp.m3951constructorimpl(f10);
        HandleHeight = Dp.m3951constructorimpl(f10);
    }

    /* JADX INFO: renamed from: getAdjustedCoordinates-k-4lQ0M, reason: not valid java name */
    public static final long m826getAdjustedCoordinatesk4lQ0M(long j10) {
        return OffsetKt.Offset(Offset.m1371getXimpl(j10), Offset.m1372getYimpl(j10) - 1.0f);
    }
