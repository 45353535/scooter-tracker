    ...
    */
    private final int jumpByPagesOffset(androidx.compose.foundation.text.TextLayoutResultProxy r6, int r7) {
        ...
        L1b:
            ...
            int r1 = androidx.compose.ui.text.TextRange.m3498getEndimpl(r3)
            ...
            float r1 = r0.getLeft()
            float r0 = r0.getTop()
            long r2 = r2.m1404getSizeNHjbRc()
            float r2 = androidx.compose.ui.geometry.Size.m1437getHeightimpl(r2)
            float r7 = (float) r7
            float r2 = r2 * r7
            float r0 = r0 + r2
            ...
            int r6 = r6.m3475getOffsetForPositionk4lQ0M(r0)
    ...
    public final List<EditCommand> deleteIfSelectedOr(@NotNull Function1<? super TextFieldPreparedSelection, ? extends EditCommand> or) {
        ...
        if (!TextRange.m3497getCollapsedimpl(getSelection())) {
            return CollectionsKt.listOf((Object[]) new EditCommand[]{new CommitTextCommand("", 0), new SetSelectionCommand(TextRange.m3501getMinimpl(getSelection()), TextRange.m3501getMinimpl(getSelection()))});
        }
    ...
    public final TextFieldValue getValue() {
        return TextFieldValue.m3704copy3r_uNRQ$default(this.currentValue, getAnnotatedString(), getSelection(), (TextRange) null, 4, (Object) null);
    }
