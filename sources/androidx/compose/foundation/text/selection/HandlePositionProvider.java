...
public final class HandlePositionProvider implements PopupPositionProvider {
    ...
    public long mo807calculatePositionllwVHH4(@NotNull IntRect anchorBounds, long windowSize, @NotNull LayoutDirection layoutDirection, long popupContentSize) {
        ...
        if (i10 == 1) {
            return IntOffsetKt.IntOffset(anchorBounds.getLeft() + IntOffset.m4069getXimpl(this.offset), anchorBounds.getTop() + IntOffset.m4070getYimpl(this.offset));
        }
        if (i10 == 2) {
            return IntOffsetKt.IntOffset((anchorBounds.getLeft() + IntOffset.m4069getXimpl(this.offset)) - IntSize.m4111getWidthimpl(popupContentSize), anchorBounds.getTop() + IntOffset.m4070getYimpl(this.offset));
        }
        if (i10 == 3) {
            return IntOffsetKt.IntOffset((anchorBounds.getLeft() + IntOffset.m4069getXimpl(this.offset)) - (IntSize.m4111getWidthimpl(popupContentSize) / 2), anchorBounds.getTop() + IntOffset.m4070getYimpl(this.offset));
        }
        throw new m();
    }
