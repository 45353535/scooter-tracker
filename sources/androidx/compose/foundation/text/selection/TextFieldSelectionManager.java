...
public final class TextFieldSelectionManager {
    ...
    public static /* synthetic */ void m872deselect_kEHs6E$foundation_release$default(TextFieldSelectionManager textFieldSelectionManager, Offset offset, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            offset = null;
        }
    ...
    private final Rect getContentRect() {
        ...
        if (textFieldState != null) {
            ...
            if (textFieldState != null) {
                int iOriginalToTransformed = this.offsetMapping.originalToTransformed(TextRange.m3503getStartimpl(getValue$foundation_release().getSelection()));
                int iOriginalToTransformed2 = this.offsetMapping.originalToTransformed(TextRange.m3498getEndimpl(getValue$foundation_release().getSelection()));
                TextFieldState textFieldState2 = this.state;
                long jM1387getZeroF1C5BW0 = (textFieldState2 == null || (layoutCoordinates4 = textFieldState2.getLayoutCoordinates()) == null) ? Offset.INSTANCE.m1387getZeroF1C5BW0() : layoutCoordinates4.mo3017localToRootMKHz9U(m878getHandlePositiontuRUvjQ$foundation_release(true));
                TextFieldState textFieldState3 = this.state;
                long jM1387getZeroF1C5BW02 = (textFieldState3 == null || (layoutCoordinates3 = textFieldState3.getLayoutCoordinates()) == null) ? Offset.INSTANCE.m1387getZeroF1C5BW0() : layoutCoordinates3.mo3017localToRootMKHz9U(m878getHandlePositiontuRUvjQ$foundation_release(false));
                TextFieldState textFieldState4 = this.state;
                float fM1372getYimpl2 = 0.0f;
                if (textFieldState4 == null || (layoutCoordinates2 = textFieldState4.getLayoutCoordinates()) == null) {
                    fM1372getYimpl = 0.0f;
                } else {
                    TextLayoutResultProxy layoutResult = textFieldState.getLayoutResult();
                    fM1372getYimpl = Offset.m1372getYimpl(layoutCoordinates2.mo3017localToRootMKHz9U(OffsetKt.Offset(0.0f, (layoutResult == null || (value2 = layoutResult.getValue()) == null || (cursorRect2 = value2.getCursorRect(iOriginalToTransformed)) == null) ? 0.0f : cursorRect2.getTop())));
                }
                ...
                if (textFieldState5 != null && (layoutCoordinates = textFieldState5.getLayoutCoordinates()) != null) {
                    ...
                    fM1372getYimpl2 = Offset.m1372getYimpl(layoutCoordinates.mo3017localToRootMKHz9U(OffsetKt.Offset(0.0f, (layoutResult2 == null || (value = layoutResult2.getValue()) == null || (cursorRect = value.getCursorRect(iOriginalToTransformed2)) == null) ? 0.0f : cursorRect.getTop())));
                }
                return new Rect(Math.min(Offset.m1371getXimpl(jM1387getZeroF1C5BW0), Offset.m1371getXimpl(jM1387getZeroF1C5BW02)), Math.min(fM1372getYimpl, fM1372getYimpl2), Math.max(Offset.m1371getXimpl(jM1387getZeroF1C5BW0), Offset.m1371getXimpl(jM1387getZeroF1C5BW02)), Math.max(Offset.m1372getYimpl(jM1387getZeroF1C5BW0), Offset.m1372getYimpl(jM1387getZeroF1C5BW02)) + (Dp.m3951constructorimpl(25) * textFieldState.getTextDelegate().getDensity().getDensity()));
            }
        }
    ...
    public final void updateSelection(TextFieldValue value, int transformedStartOffset, int transformedEndOffset, boolean isStartHandle, SelectionAdjustment adjustment) {
        ...
        long jTextRange = TextRangeKt.TextRange(this.offsetMapping.originalToTransformed(TextRange.m3503getStartimpl(value.getSelection())), this.offsetMapping.originalToTransformed(TextRange.m3498getEndimpl(value.getSelection())));
        TextFieldState textFieldState = this.state;
        long jM868getTextFieldSelectionbb3KNj8 = TextFieldSelectionDelegateKt.m868getTextFieldSelectionbb3KNj8((textFieldState == null || (layoutResult = textFieldState.getLayoutResult()) == null) ? null : layoutResult.getValue(), transformedStartOffset, transformedEndOffset, TextRange.m3497getCollapsedimpl(jTextRange) ? null : TextRange.m3491boximpl(jTextRange), isStartHandle, adjustment);
        long jTextRange2 = TextRangeKt.TextRange(this.offsetMapping.transformedToOriginal(TextRange.m3503getStartimpl(jM868getTextFieldSelectionbb3KNj8)), this.offsetMapping.transformedToOriginal(TextRange.m3498getEndimpl(jM868getTextFieldSelectionbb3KNj8)));
        if (TextRange.m3496equalsimpl0(jTextRange2, value.getSelection())) {
            return;
        }
        ...
        this.onValueChange.invoke(m871createTextFieldValueFDrldGo(value.getText(), jTextRange2));
        TextFieldState textFieldState2 = this.state;
    ...
    public final void m874contextMenuOpenAdjustmentk4lQ0M(long position) {
        ...
        int iM792getOffsetForPosition3MmeM6k$default = TextLayoutResultProxy.m792getOffsetForPosition3MmeM6k$default(layoutResult, position, false, 2, null);
        if (TextRange.m3494containsimpl(getValue$foundation_release().getSelection(), iM792getOffsetForPosition3MmeM6k$default)) {
            return;
        }
        updateSelection(getValue$foundation_release(), iM792getOffsetForPosition3MmeM6k$default, iM792getOffsetForPosition3MmeM6k$default, false, SelectionAdjustment.INSTANCE.getWord());
    }

    public final void copy$foundation_release(boolean cancelSelection) {
        if (TextRange.m3497getCollapsedimpl(getValue$foundation_release().getSelection())) {
            return;
        }
        ...
        if (cancelSelection) {
            int iM3500getMaximpl = TextRange.m3500getMaximpl(getValue$foundation_release().getSelection());
            this.onValueChange.invoke(m871createTextFieldValueFDrldGo(getValue$foundation_release().getText(), TextRangeKt.TextRange(iM3500getMaximpl, iM3500getMaximpl)));
    ...
    public final TextDragObserver cursorDragObserver$foundation_release() {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$cursorDragObserver$1
            ...
            public void mo756onDownk4lQ0M(long point) {
                ...
                textFieldSelectionManager.m873setCurrentDragPosition_kEHs6E(Offset.m1360boximpl(SelectionHandlesKt.m826getAdjustedCoordinatesk4lQ0M(textFieldSelectionManager.m878getHandlePositiontuRUvjQ$foundation_release(true))));
            }
            ...
            public void mo757onDragk4lQ0M(long delta) {
                ...
                TextLayoutResult value;
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                textFieldSelectionManager.dragTotalDistance = Offset.m1376plusMKHz9U(textFieldSelectionManager.dragTotalDistance, delta);
                ...
                textFieldSelectionManager2.m873setCurrentDragPosition_kEHs6E(Offset.m1360boximpl(Offset.m1376plusMKHz9U(textFieldSelectionManager2.dragBeginPosition, textFieldSelectionManager2.dragTotalDistance)));
                OffsetMapping offsetMapping = textFieldSelectionManager2.getOffsetMapping();
                Offset offsetM876getCurrentDragPosition_m7T9E = textFieldSelectionManager2.m876getCurrentDragPosition_m7T9E();
                Intrinsics.checkNotNull(offsetM876getCurrentDragPosition_m7T9E);
                int iTransformedToOriginal = offsetMapping.transformedToOriginal(value.m3475getOffsetForPositionk4lQ0M(offsetM876getCurrentDragPosition_m7T9E.getPackedValue()));
                long jTextRange = TextRangeKt.TextRange(iTransformedToOriginal, iTransformedToOriginal);
                if (TextRange.m3496equalsimpl0(jTextRange, textFieldSelectionManager2.getValue$foundation_release().getSelection())) {
                    return;
                }
                ...
                textFieldSelectionManager2.getOnValueChange$foundation_release().invoke(textFieldSelectionManager2.m871createTextFieldValueFDrldGo(textFieldSelectionManager2.getValue$foundation_release().getText(), jTextRange));
            }
            ...
            public void mo758onStartk4lQ0M(long startPoint) {
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                textFieldSelectionManager.dragBeginPosition = SelectionHandlesKt.m826getAdjustedCoordinatesk4lQ0M(textFieldSelectionManager.m878getHandlePositiontuRUvjQ$foundation_release(true));
                TextFieldSelectionManager textFieldSelectionManager2 = this.this$0;
                textFieldSelectionManager2.m873setCurrentDragPosition_kEHs6E(Offset.m1360boximpl(textFieldSelectionManager2.dragBeginPosition));
                this.this$0.dragTotalDistance = Offset.INSTANCE.m1387getZeroF1C5BW0();
                this.this$0.setDraggingHandle(Handle.Cursor);
            }
            ...
            public void onStop() {
                ...
                this.this$0.m873setCurrentDragPosition_kEHs6E(null);
            }
    ...
    public final void cut$foundation_release() {
        ...
        int iM3501getMinimpl = TextRange.m3501getMinimpl(getValue$foundation_release().getSelection());
        this.onValueChange.invoke(m871createTextFieldValueFDrldGo(annotatedStringPlus, TextRangeKt.TextRange(iM3501getMinimpl, iM3501getMinimpl)));
        setHandleState(HandleState.None);
    ...
    public final void m875deselect_kEHs6E$foundation_release(@Nullable Offset position) {
        if (!TextRange.m3497getCollapsedimpl(getValue$foundation_release().getSelection())) {
            TextFieldState textFieldState = this.state;
            TextLayoutResultProxy layoutResult = textFieldState != null ? textFieldState.getLayoutResult() : null;
            this.onValueChange.invoke(TextFieldValue.m3704copy3r_uNRQ$default(getValue$foundation_release(), (AnnotatedString) null, TextRangeKt.TextRange((position == null || layoutResult == null) ? TextRange.m3500getMaximpl(getValue$foundation_release().getSelection()) : this.offsetMapping.transformedToOriginal(TextLayoutResultProxy.m792getOffsetForPosition3MmeM6k$default(layoutResult, position.getPackedValue(), false, 2, null))), (TextRange) null, 5, (Object) null));
        }
    ...
    public final long m877getCursorPositiontuRUvjQ$foundation_release(@NotNull Density density) {
        ...
        Rect cursorRect = value.getCursorRect(g.n(iOriginalToTransformed, 0, value.getLayoutInput().getText().length()));
        return OffsetKt.Offset(cursorRect.getLeft() + (density.mo308toPx0680j_4(TextFieldCursorKt.getDefaultCursorThickness()) / 2), cursorRect.getBottom());
    }
    ...
    public final long m878getHandlePositiontuRUvjQ$foundation_release(boolean isStartHandle) {
        ...
        int iM3503getStartimpl = isStartHandle ? TextRange.m3503getStartimpl(selection) : TextRange.m3498getEndimpl(selection);
        TextFieldState textFieldState = this.state;
        TextLayoutResultProxy layoutResult = textFieldState != null ? textFieldState.getLayoutResult() : null;
        Intrinsics.checkNotNull(layoutResult);
        return TextSelectionDelegateKt.getSelectionHandleCoordinates(layoutResult.getValue(), this.offsetMapping.originalToTransformed(iM3503getStartimpl), isStartHandle, TextRange.m3502getReversedimpl(getValue$foundation_release().getSelection()));
    }
    ...
    public final TextDragObserver handleDragObserver$foundation_release(final boolean isStartHandle) {
        return new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$handleDragObserver$1
            ...
            public void mo756onDownk4lQ0M(long point) {
                ...
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                textFieldSelectionManager.m873setCurrentDragPosition_kEHs6E(Offset.m1360boximpl(SelectionHandlesKt.m826getAdjustedCoordinatesk4lQ0M(textFieldSelectionManager.m878getHandlePositiontuRUvjQ$foundation_release(isStartHandle))));
            }
            ...
            public void mo757onDragk4lQ0M(long delta) {
                ...
                int iM3475getOffsetForPositionk4lQ0M;
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                textFieldSelectionManager.dragTotalDistance = Offset.m1376plusMKHz9U(textFieldSelectionManager.dragTotalDistance, delta);
                TextFieldState state = this.this$0.getState();
                if (state != null && (layoutResult = state.getLayoutResult()) != null && (value = layoutResult.getValue()) != null) {
                    ...
                    if (z10) {
                        Offset offsetM876getCurrentDragPosition_m7T9E = textFieldSelectionManager2.m876getCurrentDragPosition_m7T9E();
                        Intrinsics.checkNotNull(offsetM876getCurrentDragPosition_m7T9E);
                        iOriginalToTransformed = value.m3475getOffsetForPositionk4lQ0M(offsetM876getCurrentDragPosition_m7T9E.getPackedValue());
                    } else {
                        iOriginalToTransformed = textFieldSelectionManager2.getOffsetMapping().originalToTransformed(TextRange.m3503getStartimpl(textFieldSelectionManager2.getValue$foundation_release().getSelection()));
                    }
                    int i10 = iOriginalToTransformed;
                    if (z10) {
                        iM3475getOffsetForPositionk4lQ0M = textFieldSelectionManager2.getOffsetMapping().originalToTransformed(TextRange.m3498getEndimpl(textFieldSelectionManager2.getValue$foundation_release().getSelection()));
                    } else {
                        Offset offsetM876getCurrentDragPosition_m7T9E2 = textFieldSelectionManager2.m876getCurrentDragPosition_m7T9E();
                        Intrinsics.checkNotNull(offsetM876getCurrentDragPosition_m7T9E2);
                        iM3475getOffsetForPositionk4lQ0M = value.m3475getOffsetForPositionk4lQ0M(offsetM876getCurrentDragPosition_m7T9E2.getPackedValue());
                    }
                    textFieldSelectionManager2.updateSelection(textFieldSelectionManager2.getValue$foundation_release(), i10, iM3475getOffsetForPositionk4lQ0M, z10, SelectionAdjustment.INSTANCE.getCharacter());
                }
            ...
            public void mo758onStartk4lQ0M(long startPoint) {
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                textFieldSelectionManager.dragBeginPosition = SelectionHandlesKt.m826getAdjustedCoordinatesk4lQ0M(textFieldSelectionManager.m878getHandlePositiontuRUvjQ$foundation_release(isStartHandle));
                TextFieldSelectionManager textFieldSelectionManager2 = this.this$0;
                textFieldSelectionManager2.m873setCurrentDragPosition_kEHs6E(Offset.m1360boximpl(textFieldSelectionManager2.dragBeginPosition));
                this.this$0.dragTotalDistance = Offset.INSTANCE.m1387getZeroF1C5BW0();
                this.this$0.setDraggingHandle(isStartHandle ? Handle.SelectionStart : Handle.SelectionEnd);
    ...
    public final void paste$foundation_release() {
        ...
        int iM3501getMinimpl = TextRange.m3501getMinimpl(getValue$foundation_release().getSelection()) + text.length();
        this.onValueChange.invoke(m871createTextFieldValueFDrldGo(annotatedStringPlus, TextRangeKt.TextRange(iM3501getMinimpl, iM3501getMinimpl)));
        setHandleState(HandleState.None);
        UndoManager undoManager = this.undoManager;
        if (undoManager != null) {
    ...
    public final void selectAll$foundation_release() {
        TextFieldValue textFieldValueM871createTextFieldValueFDrldGo = m871createTextFieldValueFDrldGo(getValue$foundation_release().getText(), TextRangeKt.TextRange(0, getValue$foundation_release().getText().length()));
        this.onValueChange.invoke(textFieldValueM871createTextFieldValueFDrldGo);
        this.oldValue = TextFieldValue.m3704copy3r_uNRQ$default(this.oldValue, (AnnotatedString) null, textFieldValueM871createTextFieldValueFDrldGo.getSelection(), (TextRange) null, 5, (Object) null);
        TextFieldState textFieldState = this.state;
        if (textFieldState == null) {
            return;
        }
    ...
    public final void showSelectionToolbar$foundation_release() {
        ...
        boolean z10 = this.visualTransformation instanceof PasswordVisualTransformation;
        Function0<Unit> function0 = (TextRange.m3497getCollapsedimpl(getValue$foundation_release().getSelection()) || z10) ? null : new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$showSelectionToolbar$copy$1
            {
                super(0);
            }
        ...
        Function0<Unit> function02 = (TextRange.m3497getCollapsedimpl(getValue$foundation_release().getSelection()) || !getEditable() || z10) ? null : new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$showSelectionToolbar$cut$1
            {
                super(0);
            }
        ...
        Function0<Unit> function04 = TextRange.m3499getLengthimpl(getValue$foundation_release().getSelection()) != getValue$foundation_release().getText().length() ? new Function0<Unit>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$showSelectionToolbar$selectAll$1
            {
                super(0);
            }
    ...
    public TextFieldSelectionManager(@Nullable UndoManager undoManager) {
        ...
        this.dragBeginPosition = companion.m1387getZeroF1C5BW0();
        ...
        this.touchSelectionObserver = new TextDragObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$touchSelectionObserver$1
            ...
            public void mo757onDragk4lQ0M(long delta) {
                ...
                if (state != null && (layoutResult = state.getLayoutResult()) != null) {
                    ...
                    int iIntValue = num != null ? num.intValue() : layoutResult.m794getOffsetForPosition3MmeM6k(textFieldSelectionManager2.dragBeginPosition, false);
                    Offset offsetM876getCurrentDragPosition_m7T9E = textFieldSelectionManager2.m876getCurrentDragPosition_m7T9E();
                    Intrinsics.checkNotNull(offsetM876getCurrentDragPosition_m7T9E);
                    textFieldSelectionManager2.updateSelection(textFieldSelectionManager2.getValue$foundation_release(), iIntValue, layoutResult.m794getOffsetForPosition3MmeM6k(offsetM876getCurrentDragPosition_m7T9E.getPackedValue(), false), false, SelectionAdjustment.INSTANCE.getWord());
                }
                TextFieldState state2 = this.this$0.getState();
                if (state2 == null) {
                    return;
            ...
            public void mo758onStartk4lQ0M(long startPoint) {
                ...
                this.this$0.hideSelectionToolbar$foundation_release();
                TextFieldState state2 = this.this$0.getState();
                if ((state2 == null || (layoutResult3 = state2.getLayoutResult()) == null || !layoutResult3.m795isPositionOnTextk4lQ0M(startPoint)) && (state = this.this$0.getState()) != null && (layoutResult = state.getLayoutResult()) != null) {
                    TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                    int iTransformedToOriginal = textFieldSelectionManager.getOffsetMapping().transformedToOriginal(TextLayoutResultProxy.getLineEnd$default(layoutResult, layoutResult.getLineForVerticalPosition(Offset.m1372getYimpl(startPoint)), false, 2, null));
                    HapticFeedback hapticFeedBack = textFieldSelectionManager.getHapticFeedBack();
                    if (hapticFeedBack != null) {
                        hapticFeedBack.mo2170performHapticFeedbackCdsT49E(HapticFeedbackType.INSTANCE.m2179getTextHandleMove5zf0vsI());
                    }
                    TextFieldValue textFieldValueM871createTextFieldValueFDrldGo = textFieldSelectionManager.m871createTextFieldValueFDrldGo(textFieldSelectionManager.getValue$foundation_release().getText(), TextRangeKt.TextRange(iTransformedToOriginal, iTransformedToOriginal));
                    textFieldSelectionManager.enterSelectionMode$foundation_release();
                    textFieldSelectionManager.getOnValueChange$foundation_release().invoke(textFieldValueM871createTextFieldValueFDrldGo);
                    return;
                }
                if (this.this$0.getValue$foundation_release().getText().length() == 0) {
                    return;
                ...
                if (state3 != null && (layoutResult2 = state3.getLayoutResult()) != null) {
                    TextFieldSelectionManager textFieldSelectionManager2 = this.this$0;
                    int iM792getOffsetForPosition3MmeM6k$default = TextLayoutResultProxy.m792getOffsetForPosition3MmeM6k$default(layoutResult2, startPoint, false, 2, null);
                    textFieldSelectionManager2.updateSelection(textFieldSelectionManager2.getValue$foundation_release(), iM792getOffsetForPosition3MmeM6k$default, iM792getOffsetForPosition3MmeM6k$default, false, SelectionAdjustment.INSTANCE.getWord());
                    textFieldSelectionManager2.dragBeginOffsetInText = Integer.valueOf(iM792getOffsetForPosition3MmeM6k$default);
                }
                this.this$0.dragBeginPosition = startPoint;
                TextFieldSelectionManager textFieldSelectionManager3 = this.this$0;
                textFieldSelectionManager3.m873setCurrentDragPosition_kEHs6E(Offset.m1360boximpl(textFieldSelectionManager3.dragBeginPosition));
                this.this$0.dragTotalDistance = Offset.INSTANCE.m1387getZeroF1C5BW0();
            }
        ...
        this.mouseSelectionObserver = new MouseSelectionObserver() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager$mouseSelectionObserver$1
            ...
            public boolean mo759onDrag3MmeM6k(long dragPosition, @NotNull SelectionAdjustment adjustment) {
                ...
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                int iM794getOffsetForPosition3MmeM6k = layoutResult.m794getOffsetForPosition3MmeM6k(dragPosition, false);
                ...
                textFieldSelectionManager.updateSelection(value$foundation_release, num.intValue(), iM794getOffsetForPosition3MmeM6k, false, adjustment);
                return true;
            }
            ...
            public boolean mo762onStart3MmeM6k(long downPosition, @NotNull SelectionAdjustment adjustment) {
                ...
                TextFieldSelectionManager textFieldSelectionManager = this.this$0;
                textFieldSelectionManager.dragBeginOffsetInText = Integer.valueOf(TextLayoutResultProxy.m792getOffsetForPosition3MmeM6k$default(layoutResult, downPosition, false, 2, null));
                int iM792getOffsetForPosition3MmeM6k$default = TextLayoutResultProxy.m792getOffsetForPosition3MmeM6k$default(layoutResult, textFieldSelectionManager.dragBeginPosition, false, 2, null);
                textFieldSelectionManager.updateSelection(textFieldSelectionManager.getValue$foundation_release(), iM792getOffsetForPosition3MmeM6k$default, iM792getOffsetForPosition3MmeM6k$default, false, adjustment);
                return true;
            }
        };
    }
