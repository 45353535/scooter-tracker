...
public final class SelectionManagerKt {
    ...
    public static final long m858calculateSelectionMagnifierCenterAndroidO0kMr_c(@NotNull SelectionManager manager, long j10) {
    ...
    private static final long calculateSelectionMagnifierCenterAndroid_O0kMr_c$getMagnifierCenter(SelectionManager selectionManager, long j10, Selection.AnchorInfo anchorInfo, boolean z10) {
        ...
        Offset offsetM847getCurrentDragPosition_m7T9E = selectionManager.m847getCurrentDragPosition_m7T9E();
        Intrinsics.checkNotNull(offsetM847getCurrentDragPosition_m7T9E);
        float fM1371getXimpl = Offset.m1371getXimpl(layoutCoordinates.mo3016localPositionOfR5De75A(containerLayoutCoordinates, offsetM847getCurrentDragPosition_m7T9E.getPackedValue()));
        long jMo809getRangeOfLineContainingjx7JFs = anchorSelectable$foundation_release.mo809getRangeOfLineContainingjx7JFs(offset);
        Rect boundingBox = anchorSelectable$foundation_release.getBoundingBox(TextRange.m3501getMinimpl(jMo809getRangeOfLineContainingjx7JFs));
        Rect boundingBox2 = anchorSelectable$foundation_release.getBoundingBox(g.e(TextRange.m3500getMaximpl(jMo809getRangeOfLineContainingjx7JFs) - 1, TextRange.m3501getMinimpl(jMo809getRangeOfLineContainingjx7JFs)));
        float fM = g.m(fM1371getXimpl, Math.min(boundingBox.getLeft(), boundingBox2.getLeft()), Math.max(boundingBox.getRight(), boundingBox2.getRight()));
        return Math.abs(fM1371getXimpl - fM) > ((float) (IntSize.m4111getWidthimpl(j10) / 2)) ? Offset.INSTANCE.m1386getUnspecifiedF1C5BW0() : containerLayoutCoordinates.mo3016localPositionOfR5De75A(layoutCoordinates, OffsetKt.Offset(fM, Offset.m1372getYimpl(anchorSelectable$foundation_release.getBoundingBox(offset).m1401getCenterF1C5BW0())));
    }

    /* JADX INFO: renamed from: containsInclusive-Uv8p0NA, reason: not valid java name */
    public static final boolean m859containsInclusiveUv8p0NA(@NotNull Rect containsInclusive, long j10) {
    ...
    public static final Rect visibleBounds(@NotNull LayoutCoordinates layoutCoordinates) {
        ...
        return RectKt.m1409Rect0a9Yr6o(layoutCoordinates.mo3020windowToLocalMKHz9U(rectBoundsInWindow.m1406getTopLeftF1C5BW0()), layoutCoordinates.mo3020windowToLocalMKHz9U(rectBoundsInWindow.m1400getBottomRightF1C5BW0()));
    }
}
