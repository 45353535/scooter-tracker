...
public interface Selectable {
    ...
    long mo808getHandlePositiondBAh8RU(@NotNull Selection selection, boolean isStartHandle);
    ...
    long mo809getRangeOfLineContainingjx7JFs(int offset);
    ...
    Pair<Selection, Boolean> mo810updateSelectionqCDeeow(long startHandlePosition, long endHandlePosition, @Nullable Offset previousHandlePosition, boolean isStartHandle, @NotNull LayoutCoordinates containerLayoutCoordinates, @NotNull SelectionAdjustment adjustment, @Nullable Selection previousSelection);
}
