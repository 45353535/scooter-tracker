...
public final class TextFieldSelectionDelegateKt {
    ...
    public static final long m868getTextFieldSelectionbb3KNj8(@Nullable TextLayoutResult textLayoutResult, int i10, int i11, @Nullable TextRange textRange, boolean z10, @NotNull SelectionAdjustment adjustment) {
        Intrinsics.checkNotNullParameter(adjustment, "adjustment");
        if (textLayoutResult == null) {
            return TextRangeKt.TextRange(0, 0);
        }
        long jTextRange = TextRangeKt.TextRange(i10, i11);
        return (textRange == null && Intrinsics.areEqual(adjustment, SelectionAdjustment.INSTANCE.getCharacter())) ? jTextRange : adjustment.mo817adjustZXO7KMw(textLayoutResult, jTextRange, -1, z10, textRange);
    }
}
