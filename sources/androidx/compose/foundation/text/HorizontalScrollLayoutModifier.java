...
final /* data */ class HorizontalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult mo43measure3p2s80s(@NotNull final MeasureScope measure, @NotNull Measurable measurable, long j10) {
        ...
        if (measurable.maxIntrinsicWidth(Constraints.m3918getMaxHeightimpl(j10)) < Constraints.m3919getMaxWidthimpl(j10)) {
            j11 = j10;
        } else {
            j11 = j10;
            j10 = Constraints.m3910copyZbe2FdA$default(j11, 0, Integer.MAX_VALUE, 0, 0, 13, null);
        }
        final Placeable placeableMo3011measureBRTryo0 = measurable.mo3011measureBRTryo0(j10);
        final int iMin = Math.min(placeableMo3011measureBRTryo0.getWidth(), Constraints.m3919getMaxWidthimpl(j11));
        return MeasureScope.CC.p(measure, iMin, placeableMo3011measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.HorizontalScrollLayoutModifier$measure$1
            ...
            public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                ...
                this.getScrollerPosition().update(Orientation.Horizontal, TextFieldScrollKt.getCursorRectInScroller(measureScope, cursorOffset, transformedText, textLayoutResultProxyInvoke != null ? textLayoutResultProxyInvoke.getValue() : null, measure.getLayoutDirection() == LayoutDirection.Rtl, placeableMo3011measureBRTryo0.getWidth()), iMin, placeableMo3011measureBRTryo0.getWidth());
                Placeable.PlacementScope.placeRelative$default(layout, placeableMo3011measureBRTryo0, a.d(-this.getScrollerPosition().getOffset()), 0, 0.0f, 4, null);
            }
        }, 4, null);
    }
