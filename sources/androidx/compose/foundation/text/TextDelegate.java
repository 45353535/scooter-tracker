...
public final class TextDelegate {
    ...
    public static /* synthetic */ TextLayoutResult m763layoutNN6EwU$default(TextDelegate textDelegate, long j10, LayoutDirection layoutDirection, TextLayoutResult textLayoutResult, int i10, Object obj) {
        if ((i10 & 4) != 0) {
            textLayoutResult = null;
        }
        return textDelegate.m766layoutNN6EwU(j10, layoutDirection, textLayoutResult);
    }

    /* JADX INFO: renamed from: layoutText-K40F9xA, reason: not valid java name */
    private final MultiParagraph m764layoutTextK40F9xA(long constraints, LayoutDirection layoutDirection) {
        layoutIntrinsics(layoutDirection);
        int iM3921getMinWidthimpl = Constraints.m3921getMinWidthimpl(constraints);
        int iM3919getMaxWidthimpl = ((this.softWrap || TextOverflow.m3897equalsimpl0(this.overflow, TextOverflow.INSTANCE.m3905getEllipsisgIe3tQ8())) && Constraints.m3915getHasBoundedWidthimpl(constraints)) ? Constraints.m3919getMaxWidthimpl(constraints) : Integer.MAX_VALUE;
        int i10 = (this.softWrap || !TextOverflow.m3897equalsimpl0(this.overflow, TextOverflow.INSTANCE.m3905getEllipsisgIe3tQ8())) ? this.maxLines : 1;
        if (iM3921getMinWidthimpl != iM3919getMaxWidthimpl) {
            iM3919getMaxWidthimpl = g.n(getMaxIntrinsicWidth(), iM3921getMinWidthimpl, iM3919getMaxWidthimpl);
        }
        return new MultiParagraph(getNonNullIntrinsics(), ConstraintsKt.Constraints$default(0, iM3919getMaxWidthimpl, 0, Constraints.m3918getMaxHeightimpl(constraints), 5, null), i10, TextOverflow.m3897equalsimpl0(this.overflow, TextOverflow.INSTANCE.m3905getEllipsisgIe3tQ8()), null);
    }
    ...
    public final TextLayoutResult m766layoutNN6EwU(long constraints, @NotNull LayoutDirection layoutDirection, @Nullable TextLayoutResult prevResult) {
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        if (prevResult != null && TextLayoutHelperKt.m790canReuse7_7YC6M(prevResult, this.text, this.style, this.placeholders, this.maxLines, this.softWrap, this.overflow, this.density, layoutDirection, this.fontFamilyResolver, constraints)) {
            return prevResult.m3474copyO0kMr_c(new TextLayoutInput(prevResult.getLayoutInput().getText(), this.style, prevResult.getLayoutInput().getPlaceholders(), prevResult.getLayoutInput().getMaxLines(), prevResult.getLayoutInput().getSoftWrap(), prevResult.getLayoutInput().getOverflow(), prevResult.getLayoutInput().getDensity(), prevResult.getLayoutInput().getLayoutDirection(), prevResult.getLayoutInput().getFontFamilyResolver(), constraints, (DefaultConstructorMarker) null), ConstraintsKt.m3930constrain4WqzIAM(constraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(prevResult.getMultiParagraph().getWidth()), TextDelegateKt.ceilToIntPx(prevResult.getMultiParagraph().getHeight()))));
        }
        MultiParagraph multiParagraphM764layoutTextK40F9xA = m764layoutTextK40F9xA(constraints, layoutDirection);
        return new TextLayoutResult(new TextLayoutInput(this.text, this.style, this.placeholders, this.maxLines, this.softWrap, this.overflow, this.density, layoutDirection, this.fontFamilyResolver, constraints, (DefaultConstructorMarker) null), multiParagraphM764layoutTextK40F9xA, ConstraintsKt.m3930constrain4WqzIAM(constraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(multiParagraphM764layoutTextK40F9xA.getWidth()), TextDelegateKt.ceilToIntPx(multiParagraphM764layoutTextK40F9xA.getHeight()))), null);
    }
    ...
    private TextDelegate(AnnotatedString annotatedString, TextStyle textStyle, int i10, int i11, boolean z10, int i12, Density density, FontFamily.Resolver resolver, List<AnnotatedString.Range<Placeholder>> list) {
    ...
    public /* synthetic */ TextDelegate(AnnotatedString annotatedString, TextStyle textStyle, int i10, int i11, boolean z10, int i12, Density density, FontFamily.Resolver resolver, List list, int i13, DefaultConstructorMarker defaultConstructorMarker) {
        this(annotatedString, textStyle, (i13 & 4) != 0 ? Integer.MAX_VALUE : i10, (i13 & 8) != 0 ? 1 : i11, (i13 & 16) != 0 ? true : z10, (i13 & 32) != 0 ? TextOverflow.INSTANCE.m3904getClipgIe3tQ8() : i12, density, resolver, (i13 & 256) != 0 ? CollectionsKt.emptyList() : list, null);
    }
}
