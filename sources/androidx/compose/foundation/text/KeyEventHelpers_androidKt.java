...
public final class KeyEventHelpers_androidKt {
    ...
    public static final boolean m717cancelsTextSelectionZmokQxo(@NotNull KeyEvent cancelsTextSelection) {
        Intrinsics.checkNotNullParameter(cancelsTextSelection, "$this$cancelsTextSelection");
        return cancelsTextSelection.getKeyCode() == 4 && KeyEventType.m2785equalsimpl0(KeyEvent_androidKt.m2793getTypeZmokQxo(cancelsTextSelection), KeyEventType.INSTANCE.m2790getKeyUpCS__XNY());
    }
