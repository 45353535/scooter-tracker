...
public final class TextFieldState {
    ...
    public TextFieldState(@NotNull TextDelegate textDelegate, @NotNull RecomposeScope recomposeScope) {
        ...
        this.minHeightForSingleLineField = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Dp.m3949boximpl(Dp.m3951constructorimpl(0)), null, 2, null);
        ...
        this.onImeActionPerformed = new Function1<ImeAction, Unit>() { // from class: androidx.compose.foundation.text.TextFieldState$onImeActionPerformed$1
            ...
            public /* bridge */ /* synthetic */ Unit invoke(ImeAction imeAction) {
                m789invokeKlQnJC8(imeAction.getValue());
                return Unit.f93236a;
            }

            /* JADX INFO: renamed from: invoke-KlQnJC8, reason: not valid java name */
            public final void m789invokeKlQnJC8(int i10) {
                this.this$0.keyboardActionRunner.m720runActionKlQnJC8(i10);
            }
        };
    ...
    public final float m786getMinHeightForSingleLineFieldD9Ej5fM() {
        return ((Dp) this.minHeightForSingleLineField.getValue()).m3965unboximpl();
    }
    ...
    public final void m787setMinHeightForSingleLineField0680j_4(float f10) {
        this.minHeightForSingleLineField.setValue(Dp.m3949boximpl(f10));
    }
    ...
    public final void m788updatefnh65Uc(@NotNull AnnotatedString untransformedText, @NotNull AnnotatedString visualText, @NotNull TextStyle textStyle, boolean softWrap, @NotNull Density density, @NotNull FontFamily.Resolver fontFamilyResolver, @NotNull Function1<? super TextFieldValue, Unit> onValueChange, @NotNull KeyboardActions keyboardActions, @NotNull FocusManager focusManager, long selectionBackgroundColor) {
        ...
        this.selectionPaint.mo1492setColor8_81llA(selectionBackgroundColor);
        ...
        TextDelegate textDelegateM713updateTextDelegaterm0N8CA$default = CoreTextKt.m713updateTextDelegaterm0N8CA$default(this.textDelegate, visualText, textStyle, density, fontFamilyResolver, softWrap, 0, 0, 0, CollectionsKt.emptyList(), 448, null);
        if (this.textDelegate != textDelegateM713updateTextDelegaterm0N8CA$default) {
            this.isLayoutResultStale = true;
        }
        this.textDelegate = textDelegateM713updateTextDelegaterm0N8CA$default;
    }
}
