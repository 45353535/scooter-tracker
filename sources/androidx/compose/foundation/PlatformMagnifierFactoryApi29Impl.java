...
public final class PlatformMagnifierFactoryApi29Impl implements PlatformMagnifierFactory {
    ...
    public static final class PlatformMagnifierImpl extends PlatformMagnifierFactoryApi28Impl.PlatformMagnifierImpl {
        ...
        public void mo235updateWko1d7g(long sourceCenter, long magnifierCenter, float zoom) {
            ...
            if (OffsetKt.m1390isSpecifiedk4lQ0M(magnifierCenter)) {
                getMagnifier().show(Offset.m1371getXimpl(sourceCenter), Offset.m1372getYimpl(sourceCenter), Offset.m1371getXimpl(magnifierCenter), Offset.m1372getYimpl(magnifierCenter));
            } else {
                getMagnifier().show(Offset.m1371getXimpl(sourceCenter), Offset.m1372getYimpl(sourceCenter));
            }
        }
    }
    ...
    public PlatformMagnifierImpl create(@NotNull MagnifierStyle style, @NotNull View view, @NotNull Density density, float initialZoom) {
        ...
        long jMo309toSizeXkaWNTQ = density.mo309toSizeXkaWNTQ(style.getSize());
        float fMo308toPx0680j_4 = density.mo308toPx0680j_4(style.getCornerRadius());
        float fMo308toPx0680j_42 = density.mo308toPx0680j_4(style.getElevation());
        Magnifier.Builder builder = new Magnifier.Builder(view);
        if (jMo309toSizeXkaWNTQ != Size.INSTANCE.m1448getUnspecifiedNHjbRc()) {
            builder.setSize(zf.a.d(Size.m1440getWidthimpl(jMo309toSizeXkaWNTQ)), zf.a.d(Size.m1437getHeightimpl(jMo309toSizeXkaWNTQ)));
        }
        if (!Float.isNaN(fMo308toPx0680j_4)) {
            builder.setCornerRadius(fMo308toPx0680j_4);
        }
        if (!Float.isNaN(fMo308toPx0680j_42)) {
            builder.setElevation(fMo308toPx0680j_42);
        }
