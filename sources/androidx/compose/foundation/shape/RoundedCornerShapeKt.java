...
public final class RoundedCornerShapeKt {
    ...
    public static final RoundedCornerShape m690RoundedCornerShape0680j_4(float f10) {
        return RoundedCornerShape(CornerSizeKt.m682CornerSize0680j_4(f10));
    }

    @NotNull
    /* JADX INFO: renamed from: RoundedCornerShape-a9UjIt4, reason: not valid java name */
    public static final RoundedCornerShape m691RoundedCornerShapea9UjIt4(float f10, float f11, float f12, float f13) {
        return new RoundedCornerShape(CornerSizeKt.m682CornerSize0680j_4(f10), CornerSizeKt.m682CornerSize0680j_4(f11), CornerSizeKt.m682CornerSize0680j_4(f12), CornerSizeKt.m682CornerSize0680j_4(f13));
    }

    /* JADX INFO: renamed from: RoundedCornerShape-a9UjIt4$default, reason: not valid java name */
    public static /* synthetic */ RoundedCornerShape m692RoundedCornerShapea9UjIt4$default(float f10, float f11, float f12, float f13, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return m691RoundedCornerShapea9UjIt4(f10, f11, f12, f13);
    }
