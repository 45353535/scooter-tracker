...
public final class CutCornerShape extends CornerBasedShape {
    ...
    public Outline mo673createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, @NotNull LayoutDirection layoutDirection) {
        ...
        Path.lineTo(Size.m1440getWidthimpl(size) - topStart, 0.0f);
        Path.lineTo(Size.m1440getWidthimpl(size), topStart);
        float f11 = layoutDirection == layoutDirection2 ? bottomEnd : bottomStart;
        Path.lineTo(Size.m1440getWidthimpl(size), Size.m1437getHeightimpl(size) - f11);
        Path.lineTo(Size.m1440getWidthimpl(size) - f11, Size.m1437getHeightimpl(size));
        if (layoutDirection == layoutDirection2) {
            bottomEnd = bottomStart;
        }
        Path.lineTo(bottomEnd, Size.m1437getHeightimpl(size));
        Path.lineTo(0.0f, Size.m1437getHeightimpl(size) - bottomEnd);
        Path.close();
