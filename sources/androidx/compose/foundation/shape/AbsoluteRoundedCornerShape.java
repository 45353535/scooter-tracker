...
public final class AbsoluteRoundedCornerShape extends CornerBasedShape {
    ...
    private final long m677toRadiusBz7bX_o(float f10) {
    ...
    public Outline mo673createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, @NotNull LayoutDirection layoutDirection) {
        ...
        return ((topStart + topEnd) + bottomEnd) + bottomStart == 0.0f ? new Outline.Rectangle(SizeKt.m1461toRectuvyYCjk(size)) : new Outline.Rounded(RoundRectKt.m1423RoundRectZAM2FJo(SizeKt.m1461toRectuvyYCjk(size), CornerRadiusKt.CornerRadius$default(topStart, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(topEnd, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(bottomEnd, 0.0f, 2, null), CornerRadiusKt.CornerRadius$default(bottomStart, 0.0f, 2, null)));
    }
