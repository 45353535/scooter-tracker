...
public final class BorderStroke {
    ...
    public static /* synthetic */ BorderStroke m186copyD5KLDUw$default(BorderStroke borderStroke, float f10, Brush brush, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return borderStroke.m187copyD5KLDUw(f10, brush);
    }

    @NotNull
    /* JADX INFO: renamed from: copy-D5KLDUw, reason: not valid java name */
    public final BorderStroke m187copyD5KLDUw(float width, @NotNull Brush brush) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Dp.m3956equalsimpl0(this.width, borderStroke.width) && Intrinsics.areEqual(this.brush, borderStroke.brush);
    }
    ...
    public int hashCode() {
        return (Dp.m3957hashCodeimpl(this.width) * 31) + this.brush.hashCode();
    }

    @NotNull
    public String toString() {
        return "BorderStroke(width=" + ((Object) Dp.m3962toStringimpl(this.width)) + ", brush=" + this.brush + ')';
    }
