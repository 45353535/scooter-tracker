    ...
    private static final class DefaultDebugIndicationInstance implements IndicationInstance {
        ...
        public void drawIndication(@NotNull ContentDrawScope contentDrawScope) {
            ...
            if (this.isPressed.getValue().booleanValue()) {
                androidx.compose.ui.graphics.drawscope.b.K(contentDrawScope, Color.m1603copywmQWz5c$default(Color.INSTANCE.m1630getBlack0d7_KjU(), 0.3f, 0.0f, 0.0f, 0.0f, 14, null), 0L, contentDrawScope.mo2040getSizeNHjbRc(), 0.0f, null, null, 0, 122, null);
            } else if (this.isHovered.getValue().booleanValue() || this.isFocused.getValue().booleanValue()) {
                androidx.compose.ui.graphics.drawscope.b.K(contentDrawScope, Color.m1603copywmQWz5c$default(Color.INSTANCE.m1630getBlack0d7_KjU(), 0.1f, 0.0f, 0.0f, 0.0f, 14, null), 0L, contentDrawScope.mo2040getSizeNHjbRc(), 0.0f, null, null, 0, 122, null);
            }
        }
    }
