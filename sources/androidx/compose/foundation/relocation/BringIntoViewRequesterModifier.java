...
final class BringIntoViewRequesterModifier extends BringIntoViewChildModifier {
    ...
    @Nullable
    public final Object bringIntoView(@Nullable final Rect rect, @NotNull Continuation continuation) {
        BringIntoViewParent parent = getParent();
        LayoutCoordinates layoutCoordinates = getLayoutCoordinates();
        if (layoutCoordinates == null) {
            return Unit.f93236a;
        }
        Object objBringChildIntoView = parent.bringChildIntoView(layoutCoordinates, new Function0<Rect>() { // from class: androidx.compose.foundation.relocation.BringIntoViewRequesterModifier.bringIntoView.2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
            ...
            public final Rect invoke() {
                ...
                if (layoutCoordinates2 != null) {
                    return SizeKt.m1461toRectuvyYCjk(IntSizeKt.m4121toSizeozmzZPI(layoutCoordinates2.mo3015getSizeYbymL2g()));
                }
                return null;
            }
        }, continuation);
        return objBringChildIntoView == b.g() ? objBringChildIntoView : Unit.f93236a;
    }
}
