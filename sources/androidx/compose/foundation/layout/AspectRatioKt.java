...
public final class AspectRatioKt {
    ...
    public static final Modifier aspectRatio(@NotNull Modifier modifier, final float f10, final boolean z10) {
        ...
        return modifier.then(new AspectRatioModifier(f10, z10, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.AspectRatioKt$aspectRatio$$inlined$debugInspectorInfo$1
