...
final class ExcludeInsets implements WindowInsets {
    ...
    public int getBottom(@NotNull Density density) {
        ...
        return kotlin.ranges.g.e(this.included.getBottom(density) - this.excluded.getBottom(density), 0);
    }
    ...
    public int getLeft(@NotNull Density density, @NotNull LayoutDirection layoutDirection) {
        ...
        return kotlin.ranges.g.e(this.included.getLeft(density, layoutDirection) - this.excluded.getLeft(density, layoutDirection), 0);
    }
    ...
    public int getRight(@NotNull Density density, @NotNull LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        return kotlin.ranges.g.e(this.included.getRight(density, layoutDirection) - this.excluded.getRight(density, layoutDirection), 0);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getTop(@NotNull Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        return kotlin.ranges.g.e(this.included.getTop(density) - this.excluded.getTop(density), 0);
    }
