...
final class PaddingValues implements WindowInsets {
    ...
    public int getBottom(@NotNull Density density) {
        ...
        return density.mo302roundToPx0680j_4(this.paddingValues.getBottom());
    }
    ...
    public int getLeft(@NotNull Density density, @NotNull LayoutDirection layoutDirection) {
        ...
        return density.mo302roundToPx0680j_4(this.paddingValues.mo399calculateLeftPaddingu2uoSUM(layoutDirection));
    }
    ...
    public int getRight(@NotNull Density density, @NotNull LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        return density.mo302roundToPx0680j_4(this.paddingValues.mo400calculateRightPaddingu2uoSUM(layoutDirection));
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getTop(@NotNull Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        return density.mo302roundToPx0680j_4(this.paddingValues.getTop());
    }
    ...
    public String toString() {
        ...
        return "PaddingValues(" + ((Object) Dp.m3962toStringimpl(this.paddingValues.mo399calculateLeftPaddingu2uoSUM(layoutDirection))) + ", " + ((Object) Dp.m3962toStringimpl(this.paddingValues.getTop())) + ", " + ((Object) Dp.m3962toStringimpl(this.paddingValues.mo400calculateRightPaddingu2uoSUM(layoutDirection))) + ", " + ((Object) Dp.m3962toStringimpl(this.paddingValues.getBottom())) + ')';
    }
}
