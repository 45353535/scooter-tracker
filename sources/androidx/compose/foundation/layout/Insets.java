...
final class Insets implements WindowInsets {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Dp.m3956equalsimpl0(this.left, insets.left) && Dp.m3956equalsimpl0(this.top, insets.top) && Dp.m3956equalsimpl0(this.right, insets.right) && Dp.m3956equalsimpl0(this.bottom, insets.bottom);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getBottom(@NotNull Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        return density.mo302roundToPx0680j_4(this.bottom);
    }
    ...
    public int getLeft(@NotNull Density density, @NotNull LayoutDirection layoutDirection) {
        ...
        return density.mo302roundToPx0680j_4(this.left);
    }
    ...
    public int getRight(@NotNull Density density, @NotNull LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        return density.mo302roundToPx0680j_4(this.right);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getTop(@NotNull Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        return density.mo302roundToPx0680j_4(this.top);
    }
    ...
    public String toString() {
        return "Insets(left=" + ((Object) Dp.m3962toStringimpl(this.left)) + ", top=" + ((Object) Dp.m3962toStringimpl(this.top)) + ", right=" + ((Object) Dp.m3962toStringimpl(this.right)) + ", bottom=" + ((Object) Dp.m3962toStringimpl(this.bottom)) + ')';
    }
