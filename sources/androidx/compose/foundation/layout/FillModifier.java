...
final class FillModifier extends InspectorValueInfo implements LayoutModifier {
    ...
    public MeasureResult mo43measure3p2s80s(@NotNull MeasureScope measure, @NotNull Measurable measurable, long j10) {
        ...
        int iM3919getMaxWidthimpl;
        int iM3918getMaxHeightimpl;
        int iN;
        Intrinsics.checkNotNullParameter(measure, "$this$measure");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        if (!Constraints.m3915getHasBoundedWidthimpl(j10) || this.direction == Direction.Vertical) {
            iM3921getMinWidthimpl = Constraints.m3921getMinWidthimpl(j10);
            iM3919getMaxWidthimpl = Constraints.m3919getMaxWidthimpl(j10);
        } else {
            iM3921getMinWidthimpl = kotlin.ranges.g.n(zf.a.d(Constraints.m3919getMaxWidthimpl(j10) * this.fraction), Constraints.m3921getMinWidthimpl(j10), Constraints.m3919getMaxWidthimpl(j10));
            iM3919getMaxWidthimpl = iM3921getMinWidthimpl;
        }
        if (!Constraints.m3914getHasBoundedHeightimpl(j10) || this.direction == Direction.Horizontal) {
            ...
            iN = iM3920getMinHeightimpl;
        } else {
            iN = kotlin.ranges.g.n(zf.a.d(Constraints.m3918getMaxHeightimpl(j10) * this.fraction), Constraints.m3920getMinHeightimpl(j10), Constraints.m3918getMaxHeightimpl(j10));
            iM3918getMaxHeightimpl = iN;
        }
        final Placeable placeableMo3011measureBRTryo0 = measurable.mo3011measureBRTryo0(ConstraintsKt.Constraints(iM3921getMinWidthimpl, iM3919getMaxWidthimpl, iN, iM3918getMaxHeightimpl));
        return MeasureScope.CC.p(measure, placeableMo3011measureBRTryo0.getWidth(), placeableMo3011measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.FillModifier$measure$1
            {
                super(1);
            }
