...
final class DerivedWidthModifier extends InspectorValueInfo implements LayoutModifier, ModifierLocalConsumer {
    ...
    public DerivedWidthModifier(@NotNull WindowInsets insets, @NotNull Function1<? super InspectorInfo, Unit> inspectorInfo, @NotNull Function3<? super WindowInsets, ? super LayoutDirection, ? super Density, Integer> widthCalc) {
        super(inspectorInfo);
    ...
    public MeasureResult mo43measure3p2s80s(@NotNull MeasureScope measure, @NotNull Measurable measurable, long j10) {
        ...
        if (iIntValue == 0) {
            return MeasureScope.CC.p(measure, 0, 0, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.DerivedWidthModifier$measure$1
        ...
        final Placeable placeableMo3011measureBRTryo0 = measurable.mo3011measureBRTryo0(Constraints.m3910copyZbe2FdA$default(j10, iIntValue, iIntValue, 0, 0, 12, null));
        return MeasureScope.CC.p(measure, iIntValue, placeableMo3011measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.DerivedWidthModifier$measure$2
            {
                super(1);
            }
