...
public final class ColumnScopeInstance implements ColumnScope {
    ...
    public Modifier weight(@NotNull Modifier modifier, final float f10, final boolean z10) {
        Intrinsics.checkNotNullParameter(modifier, "<this>");
        if (f10 > 0.0d) {
            return modifier.then(new LayoutWeightImpl(f10, z10, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.ColumnScopeInstance$weight$$inlined$debugInspectorInfo$1
