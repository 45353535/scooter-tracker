...
public final class WindowInsetsConnection_androidKt {
    ...
    public static final Modifier imeNestedScroll(@NotNull Modifier modifier) {
        ...
        return ComposedModifierKt.composed(modifier, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.layout.WindowInsetsConnection_androidKt$imeNestedScroll$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(@NotNull Modifier composed, @Nullable Composer composer, int i10) {
                ...
                Modifier modifierNestedScroll$default = NestedScrollModifierKt.nestedScroll$default(composed, WindowInsetsConnection_androidKt.m475rememberWindowInsetsConnectionVRgvIgI(WindowInsetsHolder.INSTANCE.current(composer, 8).getIme(), WindowInsetsSides.INSTANCE.m496getBottomJoeWqyM(), composer, 48), null, 2, null);
                if (ComposerKt.isTraceInProgress()) {
    ...
    public static final NestedScrollConnection m475rememberWindowInsetsConnectionVRgvIgI(@NotNull AndroidWindowInsets windowInsets, int i10, @Nullable Composer composer, int i11) {
        ...
        SideCalculator sideCalculatorM444chooseCalculatorni1skBw = SideCalculator.INSTANCE.m444chooseCalculatorni1skBw(i10, (LayoutDirection) composer.consume(CompositionLocalsKt.getLocalLayoutDirection()));
        View view = (View) composer.consume(AndroidCompositionLocals_androidKt.getLocalView());
        Density density = (Density) composer.consume(CompositionLocalsKt.getLocalDensity());
        Object[] objArr = {windowInsets, view, sideCalculatorM444chooseCalculatorni1skBw, density};
        ...
        if (zChanged || objRememberedValue == Composer.INSTANCE.getEmpty()) {
            objRememberedValue = new WindowInsetsNestedScrollConnection(windowInsets, view, sideCalculatorM444chooseCalculatorni1skBw, density);
