...
final class SpacerMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo30measure3p2s80s(@NotNull MeasureScope measure, @NotNull List<? extends Measurable> measurables, long j10) {
        ...
        return MeasureScope.CC.p(measure, Constraints.m3917getHasFixedWidthimpl(j10) ? Constraints.m3919getMaxWidthimpl(j10) : 0, Constraints.m3916getHasFixedHeightimpl(j10) ? Constraints.m3918getMaxHeightimpl(j10) : 0, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.SpacerMeasurePolicy$measure$1$1
