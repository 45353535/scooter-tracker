...
final class MinIntrinsicHeightModifier implements IntrinsicSizeModifier {
    ...
    public long mo402calculateContentConstraintsl58MMJ0(@NotNull MeasureScope calculateContentConstraints, @NotNull Measurable measurable, long j10) {
        Intrinsics.checkNotNullParameter(calculateContentConstraints, "$this$calculateContentConstraints");
        Intrinsics.checkNotNullParameter(measurable, "measurable");
        return Constraints.INSTANCE.m3928fixedHeightOenEA2s(measurable.minIntrinsicHeight(Constraints.m3919getMaxWidthimpl(j10)));
    }
    ...
    public /* synthetic */ MeasureResult mo43measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j10) {
