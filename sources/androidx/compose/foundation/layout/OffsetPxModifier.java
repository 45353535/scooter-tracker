...
final class OffsetPxModifier extends InspectorValueInfo implements LayoutModifier {
    ...
    public int hashCode() {
        return (this.offset.hashCode() * 31) + androidx.compose.foundation.c.a(this.rtlAware);
    }
    ...
    public MeasureResult mo43measure3p2s80s(@NotNull final MeasureScope measure, @NotNull Measurable measurable, long j10) {
        ...
        return MeasureScope.CC.p(measure, placeableMo3011measureBRTryo0.getWidth(), placeableMo3011measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.OffsetPxModifier$measure$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                ...
                if (this.this$0.getRtlAware()) {
                    Placeable.PlacementScope.placeRelativeWithLayer$default(layout, placeableMo3011measureBRTryo0, IntOffset.m4069getXimpl(packedValue), IntOffset.m4070getYimpl(packedValue), 0.0f, null, 12, null);
                } else {
                    Placeable.PlacementScope.placeWithLayer$default(layout, placeableMo3011measureBRTryo0, IntOffset.m4069getXimpl(packedValue), IntOffset.m4070getYimpl(packedValue), 0.0f, null, 12, null);
                }
            }
        }, 4, null);
    }
