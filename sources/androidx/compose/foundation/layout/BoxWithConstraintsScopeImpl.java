...
final /* data */ class BoxWithConstraintsScopeImpl implements BoxWithConstraintsScope, BoxScope {
    ...
    public static /* synthetic */ BoxWithConstraintsScopeImpl m394copy0kLqBqw$default(BoxWithConstraintsScopeImpl boxWithConstraintsScopeImpl, Density density, long j10, int i10, Object obj) {
        if ((i10 & 1) != 0) {
        ...
        return boxWithConstraintsScopeImpl.m396copy0kLqBqw(density, j10);
    }
    ...
    public final long m395component2msEJaDk() {
        return getConstraints();
    }

    @NotNull
    /* JADX INFO: renamed from: copy-0kLqBqw, reason: not valid java name */
    public final BoxWithConstraintsScopeImpl m396copy0kLqBqw(@NotNull Density density, long constraints) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Intrinsics.areEqual(this.density, boxWithConstraintsScopeImpl.density) && Constraints.m3912equalsimpl0(getConstraints(), boxWithConstraintsScopeImpl.getConstraints());
    }
    ...
    public float mo390getMaxHeightD9Ej5fM() {
        return Constraints.m3914getHasBoundedHeightimpl(getConstraints()) ? this.density.mo305toDpu2uoSUM(Constraints.m3918getMaxHeightimpl(getConstraints())) : Dp.INSTANCE.m3970getInfinityD9Ej5fM();
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* JADX INFO: renamed from: getMaxWidth-D9Ej5fM */
    public float mo391getMaxWidthD9Ej5fM() {
        return Constraints.m3915getHasBoundedWidthimpl(getConstraints()) ? this.density.mo305toDpu2uoSUM(Constraints.m3919getMaxWidthimpl(getConstraints())) : Dp.INSTANCE.m3970getInfinityD9Ej5fM();
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* JADX INFO: renamed from: getMinHeight-D9Ej5fM */
    public float mo392getMinHeightD9Ej5fM() {
        return this.density.mo305toDpu2uoSUM(Constraints.m3920getMinHeightimpl(getConstraints()));
    }

    @Override // androidx.compose.foundation.layout.BoxWithConstraintsScope
    /* JADX INFO: renamed from: getMinWidth-D9Ej5fM */
    public float mo393getMinWidthD9Ej5fM() {
        return this.density.mo305toDpu2uoSUM(Constraints.m3921getMinWidthimpl(getConstraints()));
    }

    public int hashCode() {
        return (this.density.hashCode() * 31) + Constraints.m3922hashCodeimpl(getConstraints());
    }
    ...
    public String toString() {
        return "BoxWithConstraintsScopeImpl(density=" + this.density + ", constraints=" + ((Object) Constraints.m3924toStringimpl(getConstraints())) + ')';
    }
