...
final class LimitInsets implements WindowInsets {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Intrinsics.areEqual(this.insets, limitInsets.insets) && WindowInsetsSides.m485equalsimpl0(this.sides, limitInsets.sides);
    }

    @Override // androidx.compose.foundation.layout.WindowInsets
    public int getBottom(@NotNull Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        if (WindowInsetsSides.m486hasAnybkgdKaI$foundation_layout_release(this.sides, WindowInsetsSides.INSTANCE.m496getBottomJoeWqyM())) {
    ...
    public int getLeft(@NotNull Density density, @NotNull LayoutDirection layoutDirection) {
        ...
        if (WindowInsetsSides.m486hasAnybkgdKaI$foundation_layout_release(this.sides, layoutDirection == LayoutDirection.Ltr ? WindowInsetsSides.INSTANCE.m492getAllowLeftInLtrJoeWqyM$foundation_layout_release() : WindowInsetsSides.INSTANCE.m493getAllowLeftInRtlJoeWqyM$foundation_layout_release())) {
    ...
    public int getRight(@NotNull Density density, @NotNull LayoutDirection layoutDirection) {
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        if (WindowInsetsSides.m486hasAnybkgdKaI$foundation_layout_release(this.sides, layoutDirection == LayoutDirection.Ltr ? WindowInsetsSides.INSTANCE.m494getAllowRightInLtrJoeWqyM$foundation_layout_release() : WindowInsetsSides.INSTANCE.m495getAllowRightInRtlJoeWqyM$foundation_layout_release())) {
    ...
    public int getTop(@NotNull Density density) {
        Intrinsics.checkNotNullParameter(density, "density");
        if (WindowInsetsSides.m486hasAnybkgdKaI$foundation_layout_release(this.sides, WindowInsetsSides.INSTANCE.m502getTopJoeWqyM())) {
    ...
    public int hashCode() {
        return (this.insets.hashCode() * 31) + WindowInsetsSides.m487hashCodeimpl(this.sides);
    }

    @NotNull
    public String toString() {
        return '(' + this.insets + " only " + ((Object) WindowInsetsSides.m489toStringimpl(this.sides)) + ')';
    }
