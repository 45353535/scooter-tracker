...
public interface PointerDirectionConfig {
    ...
    float mo269crossAxisDeltak4lQ0M(long offset);

    /* JADX INFO: renamed from: mainAxisDelta-k-4lQ0M */
    float mo270mainAxisDeltak4lQ0M(long offset);

    /* JADX INFO: renamed from: offsetFromChanges-dBAh8RU */
    long mo271offsetFromChangesdBAh8RU(float mainChange, float crossChange);
}
