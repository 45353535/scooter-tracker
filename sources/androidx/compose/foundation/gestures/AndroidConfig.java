...
final class AndroidConfig implements ScrollConfig {
    ...
    public long mo236calculateMouseWheelScroll8xgXZGE(@NotNull Density calculateMouseWheelScroll, @NotNull PointerEvent event, long j10) {
        Intrinsics.checkNotNullParameter(calculateMouseWheelScroll, "$this$calculateMouseWheelScroll");
        Intrinsics.checkNotNullParameter(event, "event");
        List<PointerInputChange> changes = event.getChanges();
        Offset offsetM1360boximpl = Offset.m1360boximpl(Offset.INSTANCE.m1387getZeroF1C5BW0());
        int size = changes.size();
        for (int i10 = 0; i10 < size; i10++) {
            offsetM1360boximpl = Offset.m1360boximpl(Offset.m1376plusMKHz9U(offsetM1360boximpl.getPackedValue(), changes.get(i10).getScrollDelta()));
        }
        return Offset.m1378timestuRUvjQ(offsetM1360boximpl.getPackedValue(), -calculateMouseWheelScroll.mo308toPx0680j_4(Dp.m3951constructorimpl(64)));
    }
}
