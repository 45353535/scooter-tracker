...
public final class BackgroundKt {
    ...
    public static final Modifier background(@NotNull Modifier modifier, @NotNull final Brush brush, @NotNull final Shape shape, final float f10) {
        ...
        return modifier.then(new Background(null, brush, f10, shape, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.BackgroundKt$background$$inlined$debugInspectorInfo$1
            ...
            public final void invoke2(@NotNull InspectorInfo inspectorInfo) {
                ...
                inspectorInfo.setName(H2.f75840g);
    ...
    public static final Modifier m169backgroundbw27NRU(@NotNull Modifier background, final long j10, @NotNull final Shape shape) {
        Intrinsics.checkNotNullParameter(background, "$this$background");
        Intrinsics.checkNotNullParameter(shape, "shape");
        return background.then(new Background(Color.m1594boximpl(j10), null, 0.0f, shape, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.BackgroundKt$background-bw27NRU$$inlined$debugInspectorInfo$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(@NotNull InspectorInfo inspectorInfo) {
                Intrinsics.checkNotNullParameter(inspectorInfo, "$this$null");
                inspectorInfo.setName(H2.f75840g);
                inspectorInfo.setValue(Color.m1594boximpl(j10));
                inspectorInfo.getProperties().set("color", Color.m1594boximpl(j10));
                inspectorInfo.getProperties().set("shape", shape);
            }
    ...
    public static /* synthetic */ Modifier m170backgroundbw27NRU$default(Modifier modifier, long j10, Shape shape, int i10, Object obj) {
        if ((i10 & 2) != 0) {
            shape = RectangleShapeKt.getRectangleShape();
        }
        return m169backgroundbw27NRU(modifier, j10, shape);
    }
}
