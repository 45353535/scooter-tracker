...
public final class MutatorMutex {
    ...
    @Metadata(d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\b\u0002\u0018\u00002\u00020\u0001B\u0015\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006J\u000e\u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\u0000J\u0006\u0010\u000e\u001a\u00020\u000fR\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\bR\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\n¨\u0006\u0010"}, d2 = {"Landroidx/compose/foundation/MutatorMutex$Mutator;", "", HandleInvocationsFromAdViewer.KEY_DOWNLOAD_PRIORITY, "Landroidx/compose/foundation/MutatePriority;", "job", "Lkotlinx/coroutines/Job;", "(Landroidx/compose/foundation/MutatePriority;Lkotlinx/coroutines/Job;)V", "getJob", "()Lkotlinx/coroutines/Job;", "getPriority", "()Landroidx/compose/foundation/MutatePriority;", "canInterrupt", "", "other", MenuActionType.CANCEL, "", "foundation_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    ...
    @e(c = "androidx.compose.foundation.MutatorMutex$mutate$2", f = "MutatorMutex.kt", l = {TTAdConstant.IMAGE_MODE_VERTICAL_IMG_173, 119}, m = "invokeSuspend")
            ...
            try {
                try {
                    ...
                    if (r12 != 1) {
                        ...
                        try {
                            d.b(obj);
                            androidx.compose.animation.core.c.a(mutatorMutex2.currentMutator, mutator2, null);
                            mutex2.unlock(null);
                            return obj;
                        } catch (Throwable th3) {
                            th2 = th3;
    ...
    @e(c = "androidx.compose.foundation.MutatorMutex$mutateWith$2", f = "MutatorMutex.kt", l = {TTAdConstant.IMAGE_MODE_VERTICAL_IMG_173, 160}, m = "invokeSuspend")
    static final class C13922 extends k implements Function2<CoroutineScope, Continuation, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C13922(MutatePriority mutatePriority, MutatorMutex mutatorMutex, Function2<? super T, ? super Continuation, ? extends Object> function2, T t10, Continuation continuation) {
            super(2, continuation);
            this.$priority = mutatePriority;
            this.this$0 = mutatorMutex;
        ...
        @NotNull
        public final Continuation create(@Nullable Object obj, @NotNull Continuation continuation) {
            C13922 c13922 = new C13922(this.$priority, this.this$0, this.$block, this.$receiver, continuation);
            c13922.L$0 = obj;
            return c13922;
        }
        ...
        @Nullable
        public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation continuation) {
            return ((C13922) create(coroutineScope, continuation)).invokeSuspend(Unit.f93236a);
        }
    }
    ...
    public final void tryMutateOrCancel(Mutator mutator) {
        ...
        } while (!androidx.compose.animation.core.c.a(this.currentMutator, mutator2, mutator));
        if (mutator2 != null) {
            mutator2.cancel();
        }
    }
    ...
    public final <T, R> Object mutateWith(T t10, @NotNull MutatePriority mutatePriority, @NotNull Function2<? super T, ? super Continuation, ? extends Object> function2, @NotNull Continuation continuation) {
        return i.g(new C13922(mutatePriority, this, function2, t10, null), continuation);
    }
}
