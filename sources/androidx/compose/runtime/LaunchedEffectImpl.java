...
public final class LaunchedEffectImpl implements RememberObserver {
    ...
    @NotNull
    private final Function2<CoroutineScope, Continuation, Object> task;

    /* JADX WARN: Multi-variable type inference failed */
    public LaunchedEffectImpl(@NotNull CoroutineContext parentCoroutineContext, @NotNull Function2<? super CoroutineScope, ? super Continuation, ? extends Object> task) {
        Intrinsics.checkNotNullParameter(parentCoroutineContext, "parentCoroutineContext");
        Intrinsics.checkNotNullParameter(task, "task");
        this.task = task;
        this.scope = i.a(parentCoroutineContext);
    }
    ...
    public void onRemembered() {
        Job job = this.job;
        if (job != null) {
            a0.f(job, "Old job was still running!", null, 2, null);
        }
        this.job = eg.i.d(this.scope, null, null, this.task, 3, null);
    }
}
