...
final class Pending {
    ...
    public Pending(@NotNull List<KeyInfo> keyInfos, int i10) {
        ...
        this.groupInfos = map;
        this.keyMap = i.a(new Function0<HashMap<Object, LinkedHashSet<KeyInfo>>>() { // from class: androidx.compose.runtime.Pending$keyMap$2
            {
                super(0);
            }
