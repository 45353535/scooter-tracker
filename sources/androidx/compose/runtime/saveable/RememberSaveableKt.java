...
public final class RememberSaveableKt {
    ...
    public static final <T> T m1261rememberSaveable(@NotNull Object[] inputs, @Nullable Saver<T, ? extends Object> saver, @Nullable final String str, @NotNull Function0<? extends T> init, @Nullable Composer composer, int i10, int i11) {
    ...
    @Composable
    @NotNull
    public static final <T> MutableState<T> rememberSaveable(@NotNull Object[] inputs, @NotNull Saver<T, ? extends Object> stateSaver, @Nullable String str, @NotNull Function0<? extends MutableState<T>> init, @Nullable Composer composer, int i10, int i11) {
        Intrinsics.checkNotNullParameter(inputs, "inputs");
        ...
        MutableState<T> mutableState = (MutableState) m1261rememberSaveable(Arrays.copyOf(inputs, inputs.length), mutableStateSaver(stateSaver), str2, (Function0) init, composer, (i10 & 896) | 8 | (i10 & 7168), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
