...
public final class PersistentVector<E> extends AbstractPersistentList<E> implements PersistentList<E> {
    ...
    public PersistentVector(@NotNull Object[] root, @NotNull Object[] tail, int i10, int i11) {
        ...
        this.rootShift = i11;
        if (size() > 32) {
            CommonFunctionsKt.m1260assert(size() - UtilsKt.rootSize(size()) <= g.j(tail.length, 32));
            return;
        }
    ...
    private final Object[] insertIntoRoot(Object[] root, int shift, int index, Object element, ObjectRef elementCarry) {
        ...
        while (true) {
            ...
            objArrCopyOf2[iIndexSegment] = insertIntoRoot((Object[]) obj2, i10, 0, elementCarry.getValue(), elementCarry);
        }
