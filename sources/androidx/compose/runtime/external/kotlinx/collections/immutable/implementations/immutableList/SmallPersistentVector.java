...
public final class SmallPersistentVector<E> extends AbstractPersistentList<E> implements ImmutableList<E> {
    ...
    public SmallPersistentVector(@NotNull Object[] buffer) {
        ...
        this.buffer = buffer;
        CommonFunctionsKt.m1260assert(buffer.length <= 32);
    }
    ...
    public PersistentList<E> addAll(int index, @NotNull Collection<? extends E> c10) {
        ...
        if (size() + c10.size() <= 32) {
            ...
            int i10 = index;
            ArraysKt.copyInto$default(this.buffer, objArrBufferOfSize, 0, 0, i10, 6, (Object) null);
            ArraysKt.copyInto(this.buffer, objArrBufferOfSize, c10.size() + i10, i10, size());
