...
public final class TransparentObserverSnapshot extends Snapshot {
    ...
    public TransparentObserverSnapshot(@Nullable Snapshot snapshot, @Nullable Function1<Object, Unit> function1, boolean z10, boolean z11) {
        ...
        this.readObserver = SnapshotKt.mergedReadObserver(function1, (snapshot == null || (readObserver$runtime_release = snapshot.getReadObserver$runtime_release()) == null) ? ((GlobalSnapshot) SnapshotKt.currentGlobalSnapshot.get()).getReadObserver$runtime_release() : readObserver$runtime_release, z10);
        this.root = this;
    }
