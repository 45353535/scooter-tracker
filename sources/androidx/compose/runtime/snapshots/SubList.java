...
final class SubList<T> implements List<T>, d {
    ...
    public static final class AnonymousClass1 implements ListIterator<T>, yf.a {
        final /* synthetic */ t0 $current;
        final /* synthetic */ SubList<T> this$0;

        AnonymousClass1(t0 t0Var, SubList<T> subList) {
            this.$current = t0Var;
            this.this$0 = subList;
        }
        ...
        public boolean hasNext() {
            return this.$current.f93331b < this.this$0.size() - 1;
        }

        @Override // java.util.ListIterator
        public boolean hasPrevious() {
            return this.$current.f93331b >= 0;
        }

        @Override // java.util.ListIterator, java.util.Iterator
        public T next() {
            int i10 = this.$current.f93331b + 1;
            SnapshotStateListKt.validateRange(i10, this.this$0.size());
            this.$current.f93331b = i10;
            return this.this$0.get(i10);
        }

        @Override // java.util.ListIterator
        public int nextIndex() {
            return this.$current.f93331b + 1;
        }

        @Override // java.util.ListIterator
        public T previous() {
            int i10 = this.$current.f93331b;
            SnapshotStateListKt.validateRange(i10, this.this$0.size());
            this.$current.f93331b = i10 - 1;
            return this.this$0.get(i10);
        }

        @Override // java.util.ListIterator
        public int previousIndex() {
            return this.$current.f93331b;
        }
    ...
    public int indexOf(Object element) {
        validateModification();
        int i10 = this.offset;
        Iterator<T> it = kotlin.ranges.g.v(i10, size() + i10).iterator();
        while (it.hasNext()) {
    ...
    public ListIterator<T> listIterator(int index) {
        validateModification();
        t0 t0Var = new t0();
        t0Var.f93331b = index - 1;
        return new AnonymousClass1(t0Var, this);
    }
