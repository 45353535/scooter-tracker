...
@Stable
@Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0005\bg\u0018\u0000 \t2\u00020\u0001:\u0001\tJ%\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u00052\u0006\u0010\u0006\u001a\u00020\u0005H&ø\u0001\u0000ø\u0001\u0001¢\u0006\u0004\b\u0007\u0010\bø\u0001\u0002\u0082\u0002\u0011\n\u0005\b¡\u001e0\u0001\n\u0002\b\u0019\n\u0004\b!0\u0001¨\u0006\nÀ\u0006\u0001"}, d2 = {"Landroidx/compose/ui/layout/ContentScale;", "", "computeScaleFactor", "Landroidx/compose/ui/layout/ScaleFactor;", "srcSize", "Landroidx/compose/ui/geometry/Size;", "dstSize", "computeScaleFactor-H7hwNQA", "(JJ)J", y.f66058y, "ui_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
public interface ContentScale {
    ...
    public static final class Companion {
        ...
        private static final ContentScale Crop = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Crop$1
            ...
            public long mo3002computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM3008computeFillMaxDimensioniLBOSCw = ContentScaleKt.m3008computeFillMaxDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(fM3008computeFillMaxDimensioniLBOSCw, fM3008computeFillMaxDimensioniLBOSCw);
            }
        };
        ...
        private static final ContentScale Fit = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Fit$1
            ...
            /* JADX INFO: renamed from: computeScaleFactor-H7hwNQA */
            public long mo3002computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM3009computeFillMinDimensioniLBOSCw = ContentScaleKt.m3009computeFillMinDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(fM3009computeFillMinDimensioniLBOSCw, fM3009computeFillMinDimensioniLBOSCw);
            }
        };
        ...
        private static final ContentScale FillHeight = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillHeight$1
            ...
            /* JADX INFO: renamed from: computeScaleFactor-H7hwNQA */
            public long mo3002computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM3007computeFillHeightiLBOSCw = ContentScaleKt.m3007computeFillHeightiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(fM3007computeFillHeightiLBOSCw, fM3007computeFillHeightiLBOSCw);
            }
        };
        ...
        private static final ContentScale FillWidth = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillWidth$1
            ...
            /* JADX INFO: renamed from: computeScaleFactor-H7hwNQA */
            public long mo3002computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM3010computeFillWidthiLBOSCw = ContentScaleKt.m3010computeFillWidthiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(fM3010computeFillWidthiLBOSCw, fM3010computeFillWidthiLBOSCw);
            }
        };
        ...
        private static final ContentScale Inside = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Inside$1
            ...
            /* JADX INFO: renamed from: computeScaleFactor-H7hwNQA */
            public long mo3002computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                if (Size.m1440getWidthimpl(srcSize) <= Size.m1440getWidthimpl(dstSize) && Size.m1437getHeightimpl(srcSize) <= Size.m1437getHeightimpl(dstSize)) {
        ...
        private static final ContentScale FillBounds = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillBounds$1
            ...
            /* JADX INFO: renamed from: computeScaleFactor-H7hwNQA */
            public long mo3002computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                return ScaleFactorKt.ScaleFactor(ContentScaleKt.m3010computeFillWidthiLBOSCw(srcSize, dstSize), ContentScaleKt.m3007computeFillHeightiLBOSCw(srcSize, dstSize));
            }
        };
    ...
    long mo3002computeScaleFactorH7hwNQA(long srcSize, long dstSize);
}
