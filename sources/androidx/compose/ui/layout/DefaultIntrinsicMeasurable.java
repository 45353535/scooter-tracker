...
public final class DefaultIntrinsicMeasurable implements Measurable {
    ...
    public Placeable mo3011measureBRTryo0(long constraints) {
        if (this.widthHeight == IntrinsicWidthHeight.Width) {
            return new FixedSizeIntrinsicsPlaceable(this.minMax == IntrinsicMinMax.Max ? this.measurable.maxIntrinsicWidth(Constraints.m3918getMaxHeightimpl(constraints)) : this.measurable.minIntrinsicWidth(Constraints.m3918getMaxHeightimpl(constraints)), Constraints.m3918getMaxHeightimpl(constraints));
        }
        return new FixedSizeIntrinsicsPlaceable(Constraints.m3919getMaxWidthimpl(constraints), this.minMax == IntrinsicMinMax.Max ? this.measurable.maxIntrinsicHeight(Constraints.m3919getMaxWidthimpl(constraints)) : this.measurable.minIntrinsicHeight(Constraints.m3919getMaxWidthimpl(constraints)));
    }
