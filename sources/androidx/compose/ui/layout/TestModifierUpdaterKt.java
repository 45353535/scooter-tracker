...
public final class TestModifierUpdaterKt {
    ...
    public static final void TestModifierUpdaterLayout(@NotNull final Function1<? super TestModifierUpdater, Unit> onAttached, @Nullable Composer composer, final int i10) {
        ...
        if ((i10 & 14) == 0) {
            i11 = (composerStartRestartGroup.changedInstance(onAttached) ? 4 : 2) | i10;
        } else {
            i11 = i10;
        }
        if ((i11 & 11) == 2 && composerStartRestartGroup.getSkipping()) {
            ...
            TestModifierUpdaterKt$TestModifierUpdaterLayout$measurePolicy$1 testModifierUpdaterKt$TestModifierUpdaterLayout$measurePolicy$1 = new MeasurePolicy() { // from class: androidx.compose.ui.layout.TestModifierUpdaterKt$TestModifierUpdaterLayout$measurePolicy$1
                ...
                public final MeasureResult mo30measure3p2s80s(@NotNull MeasureScope MeasurePolicy, @NotNull List<? extends Measurable> list, long j10) {
                    ...
                    return MeasureScope.CC.p(MeasurePolicy, Constraints.m3919getMaxWidthimpl(j10), Constraints.m3918getMaxHeightimpl(j10), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.layout.TestModifierUpdaterKt$TestModifierUpdaterLayout$measurePolicy$1$measure$1
            ...
            Updater.m1255setimpl(composerM1248constructorimpl, testModifierUpdaterKt$TestModifierUpdaterLayout$measurePolicy$1, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
            Updater.m1252initimpl(composerM1248constructorimpl, new Function1<LayoutNode, Unit>() { // from class: androidx.compose.ui.layout.TestModifierUpdaterKt$TestModifierUpdaterLayout$1$1
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.layout.TestModifierUpdaterKt.TestModifierUpdaterLayout.2
            ...
            public final void invoke(@Nullable Composer composer2, int i12) {
                TestModifierUpdaterKt.TestModifierUpdaterLayout(onAttached, composer2, RecomposeScopeImplKt.updateChangedFlags(i10 | 1));
            }
        });
    }
}
