...
final /* data */ class LayoutIdModifierElement extends ModifierNodeElement<LayoutIdModifier> {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return (other instanceof LayoutIdModifierElement) && Intrinsics.areEqual(this.layoutId, ((LayoutIdModifierElement) other).layoutId);
    }
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    @NotNull
    public LayoutIdModifier update(@NotNull LayoutIdModifier node) {
