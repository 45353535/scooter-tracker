...
public final class RelocationRequester {
    ...
    public static /* synthetic */ Object bringIntoView$default(RelocationRequester relocationRequester, Rect rect, Continuation continuation, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            rect = null;
        }
    ...
    @Nullable
    public final Object bringIntoView(@Nullable Rect rect, @NotNull Continuation continuation) {
        return Unit.f93236a;
    }
}
