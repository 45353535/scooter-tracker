...
public interface BeyondBoundsLayout {
    ...
    @Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b\u0006\n\u0002\u0010\u000e\n\u0002\b\u0004\b\u0087@\u0018\u0000 \u00112\u00020\u0001:\u0001\u0011B\u0014\b\u0000\u0012\u0006\u0010\u0002\u001a\u00020\u0003ø\u0001\u0000¢\u0006\u0004\b\u0004\u0010\u0005J\u001a\u0010\u0006\u001a\u00020\u00072\b\u0010\b\u001a\u0004\u0018\u00010\u0001HÖ\u0003¢\u0006\u0004\b\t\u0010\nJ\u0010\u0010\u000b\u001a\u00020\u0003HÖ\u0001¢\u0006\u0004\b\f\u0010\u0005J\u000f\u0010\r\u001a\u00020\u000eH\u0016¢\u0006\u0004\b\u000f\u0010\u0010R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000\u0088\u0001\u0002\u0092\u0001\u00020\u0003ø\u0001\u0000\u0082\u0002\u0004\n\u0002\b\u0019¨\u0006\u0012"}, d2 = {"Landroidx/compose/ui/layout/BeyondBoundsLayout$LayoutDirection;", "", "value", "", "constructor-impl", "(I)I", "equals", "", "other", "equals-impl", "(ILjava/lang/Object;)Z", "hashCode", "hashCode-impl", "toString", "", "toString-impl", "(I)Ljava/lang/String;", y.f66058y, "ui_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    public static final class LayoutDirection {
        ...
        private static final int Before = m2989constructorimpl(1);
        private static final int After = m2989constructorimpl(2);
        private static final int Left = m2989constructorimpl(3);
        private static final int Right = m2989constructorimpl(4);
        private static final int Above = m2989constructorimpl(5);
        private static final int Below = m2989constructorimpl(6);
        ...
        public static final /* synthetic */ LayoutDirection m2988boximpl(int i10) {
            return new LayoutDirection(i10);
        }

        /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
        public static int m2989constructorimpl(int i10) {
            return i10;
        }
        ...
        public static String m2993toStringimpl(int i10) {
            return m2991equalsimpl0(i10, Before) ? "Before" : m2991equalsimpl0(i10, After) ? "After" : m2991equalsimpl0(i10, Left) ? "Left" : m2991equalsimpl0(i10, Right) ? "Right" : m2991equalsimpl0(i10, Above) ? "Above" : m2991equalsimpl0(i10, Below) ? "Below" : "invalid LayoutDirection";
        }
    ...
    <T> T mo617layouto7g1Pn8(int direction, @NotNull Function1<? super BeyondBoundsScope, ? extends T> block);
}
