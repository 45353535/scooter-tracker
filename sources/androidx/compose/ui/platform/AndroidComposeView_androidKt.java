...
public final class AndroidComposeView_androidKt {
    ...
    private static final float m3275dotp89u6pk(float[] fArr, int i10, float[] fArr2, int i11) {
        int i12 = i10 * 4;
    ...
    public static final void m3276preTransformJiSxe2E(float[] fArr, float[] fArr2) {
        float fM3275dotp89u6pk = m3275dotp89u6pk(fArr2, 0, fArr, 0);
        float fM3275dotp89u6pk2 = m3275dotp89u6pk(fArr2, 0, fArr, 1);
        float fM3275dotp89u6pk3 = m3275dotp89u6pk(fArr2, 0, fArr, 2);
        float fM3275dotp89u6pk4 = m3275dotp89u6pk(fArr2, 0, fArr, 3);
        float fM3275dotp89u6pk5 = m3275dotp89u6pk(fArr2, 1, fArr, 0);
        float fM3275dotp89u6pk6 = m3275dotp89u6pk(fArr2, 1, fArr, 1);
        float fM3275dotp89u6pk7 = m3275dotp89u6pk(fArr2, 1, fArr, 2);
        float fM3275dotp89u6pk8 = m3275dotp89u6pk(fArr2, 1, fArr, 3);
        float fM3275dotp89u6pk9 = m3275dotp89u6pk(fArr2, 2, fArr, 0);
        float fM3275dotp89u6pk10 = m3275dotp89u6pk(fArr2, 2, fArr, 1);
        float fM3275dotp89u6pk11 = m3275dotp89u6pk(fArr2, 2, fArr, 2);
        float fM3275dotp89u6pk12 = m3275dotp89u6pk(fArr2, 2, fArr, 3);
        float fM3275dotp89u6pk13 = m3275dotp89u6pk(fArr2, 3, fArr, 0);
        float fM3275dotp89u6pk14 = m3275dotp89u6pk(fArr2, 3, fArr, 1);
        float fM3275dotp89u6pk15 = m3275dotp89u6pk(fArr2, 3, fArr, 2);
        float fM3275dotp89u6pk16 = m3275dotp89u6pk(fArr2, 3, fArr, 3);
        fArr[0] = fM3275dotp89u6pk;
        fArr[1] = fM3275dotp89u6pk2;
        fArr[2] = fM3275dotp89u6pk3;
        fArr[3] = fM3275dotp89u6pk4;
        fArr[4] = fM3275dotp89u6pk5;
        fArr[5] = fM3275dotp89u6pk6;
        fArr[6] = fM3275dotp89u6pk7;
        fArr[7] = fM3275dotp89u6pk8;
        fArr[8] = fM3275dotp89u6pk9;
        fArr[9] = fM3275dotp89u6pk10;
        fArr[10] = fM3275dotp89u6pk11;
        fArr[11] = fM3275dotp89u6pk12;
        fArr[12] = fM3275dotp89u6pk13;
        fArr[13] = fM3275dotp89u6pk14;
        fArr[14] = fM3275dotp89u6pk15;
        fArr[15] = fM3275dotp89u6pk16;
    }
