...
public final class RenderNodeApi23 implements DeviceRenderNode {
    ...
    public RenderNodeApi23(@NotNull AndroidComposeView ownerView) {
        ...
        this.internalCompositingStrategy = CompositingStrategy.INSTANCE.m1688getAutoNrFUSI();
    ...
    public final int getLayerType$ui_release() {
        return CompositingStrategy.m1684equalsimpl0(this.internalCompositingStrategy, CompositingStrategy.INSTANCE.m1690getOffscreenNrFUSI()) ? 2 : 0;
    }
    ...
    @Override // androidx.compose.ui.platform.DeviceRenderNode
    public void record(@NotNull CanvasHolder canvasHolder, @Nullable Path clipPath, @NotNull Function1<? super androidx.compose.ui.graphics.Canvas, Unit> drawBlock) {
        ...
        if (clipPath != null) {
            androidCanvas.save();
            androidx.compose.ui.graphics.c1.m(androidCanvas, clipPath, 0, 2, null);
        }
    ...
    public void mo3289setCompositingStrategyaDBOjCE(int i10) {
        CompositingStrategy.Companion companion = CompositingStrategy.INSTANCE;
        if (CompositingStrategy.m1684equalsimpl0(i10, companion.m1690getOffscreenNrFUSI())) {
            this.renderNode.setLayerType(2);
            this.renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m1684equalsimpl0(i10, companion.m1689getModulateAlphaNrFUSI())) {
