...
public final class RenderNodeLayer implements OwnedLayer, GraphicLayerInfo {
    ...
    @RequiresApi(29)
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\t\n\u0000\n\u0002\u0018\u0002\n\u0000\bÃ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0010\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u0006H\u0007¨\u0006\u0007"}, d2 = {"Landroidx/compose/ui/platform/RenderNodeLayer$UniqueDrawingIdApi29;", "", "()V", "getUniqueDrawingId", "", MBridgeConstans.DYNAMIC_VIEW_KEY_VIEW, "Landroid/view/View;", "ui_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    ...
    public RenderNodeLayer(@NotNull AndroidComposeView ownerView, @NotNull Function1<? super Canvas, Unit> drawBlock, @NotNull Function0<Unit> invalidateParentLayer) {
        ...
        this.transformOrigin = TransformOrigin.INSTANCE.m1965getCenterSzJe1aQ();
    ...
    public void drawLayer(@NotNull Canvas canvas) {
        ...
        canvas.mo1468concat58bKbWc(this.matrixCache.m3304calculateMatrixGrdbGEg(this.renderNode));
    ...
    public void mo3240inverseTransform58bKbWc(@NotNull float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        float[] fArrM3303calculateInverseMatrixbWbORWo = this.matrixCache.m3303calculateInverseMatrixbWbORWo(this.renderNode);
    ...
    public boolean mo3241isInLayerk4lQ0M(long position) {
        ...
        if (this.renderNode.getClipToBounds()) {
            return 0.0f <= fM1371getXimpl && fM1371getXimpl < ((float) this.renderNode.getWidth()) && 0.0f <= fM1372getYimpl && fM1372getYimpl < ((float) this.renderNode.getHeight());
        }
    ...
    public void mapBounds(@NotNull MutableRect rect, boolean inverse) {
        ...
        if (!inverse) {
            androidx.compose.ui.graphics.Matrix.m1817mapimpl(this.matrixCache.m3304calculateMatrixGrdbGEg(this.renderNode), rect);
            return;
        }
        float[] fArrM3303calculateInverseMatrixbWbORWo = this.matrixCache.m3303calculateInverseMatrixbWbORWo(this.renderNode);
        if (fArrM3303calculateInverseMatrixbWbORWo == null) {
    ...
    public long mo3242mapOffset8S9VItk(long point, boolean inverse) {
        if (!inverse) {
            return androidx.compose.ui.graphics.Matrix.m1815mapMKHz9U(this.matrixCache.m3304calculateMatrixGrdbGEg(this.renderNode), point);
        }
        float[] fArrM3303calculateInverseMatrixbWbORWo = this.matrixCache.m3303calculateInverseMatrixbWbORWo(this.renderNode);
    ...
    public void mo3243movegyyYBs(long position) {
        ...
        if (left == iM4069getXimpl && top == iM4070getYimpl) {
            return;
        }
        this.renderNode.offsetLeftAndRight(iM4069getXimpl - left);
        this.renderNode.offsetTopAndBottom(iM4070getYimpl - top);
        triggerRepaint();
    ...
    public void mo3244resizeozmzZPI(long size) {
        ...
        this.renderNode.setPivotX(TransformOrigin.m1960getPivotFractionXimpl(this.transformOrigin) * f10);
        float f11 = iM4110getHeightimpl;
        this.renderNode.setPivotY(TransformOrigin.m1961getPivotFractionYimpl(this.transformOrigin) * f11);
        DeviceRenderNode deviceRenderNode = this.renderNode;
        if (deviceRenderNode.setPosition(deviceRenderNode.getLeft(), this.renderNode.getTop(), this.renderNode.getLeft() + iM4111getWidthimpl, this.renderNode.getTop() + iM4110getHeightimpl)) {
    ...
    public void mo3245transform58bKbWc(@NotNull float[] matrix) {
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        androidx.compose.ui.graphics.Matrix.m1826timesAssign58bKbWc(matrix, this.matrixCache.m3304calculateMatrixGrdbGEg(this.renderNode));
    }
    ...
    public void mo3246updateLayerPropertiesdDxrwY(float scaleX, float scaleY, float alpha, float translationX, float translationY, float shadowElevation, float rotationX, float rotationY, float rotationZ, float cameraDistance, long transformOrigin, @NotNull Shape shape, boolean clip, @Nullable RenderEffect renderEffect, long ambientShadowColor, long spotShadowColor, int compositingStrategy, @NotNull LayoutDirection layoutDirection, @NotNull Density density) {
        ...
        this.renderNode.setAmbientShadowColor(ColorKt.m1658toArgb8_81llA(ambientShadowColor));
        this.renderNode.setSpotShadowColor(ColorKt.m1658toArgb8_81llA(spotShadowColor));
        ...
        this.renderNode.setPivotX(TransformOrigin.m1960getPivotFractionXimpl(transformOrigin) * this.renderNode.getWidth());
        this.renderNode.setPivotY(TransformOrigin.m1961getPivotFractionYimpl(transformOrigin) * this.renderNode.getHeight());
        ...
        this.renderNode.mo3289setCompositingStrategyaDBOjCE(compositingStrategy);
