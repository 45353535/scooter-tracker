...
final class CalculateMatrixToWindowApi21 implements CalculateMatrixToWindow {
    ...
    @NotNull
    private final float[] tmpMatrix = Matrix.m1809constructorimpl$default(null, 1, null);

    /* JADX INFO: renamed from: preConcat-tU-YjHk, reason: not valid java name */
    private final void m3278preConcattUYjHk(float[] fArr, android.graphics.Matrix matrix) {
        AndroidMatrixConversions_androidKt.m1484setFromtUYjHk(this.tmpMatrix, matrix);
        AndroidComposeView_androidKt.m3276preTransformJiSxe2E(fArr, this.tmpMatrix);
    }

    /* JADX INFO: renamed from: preTranslate-3XD1CNM, reason: not valid java name */
    private final void m3279preTranslate3XD1CNM(float[] fArr, float f10, float f11) {
        Matrix.m1818resetimpl(this.tmpMatrix);
        Matrix.m1829translateimpl$default(this.tmpMatrix, f10, f11, 0.0f, 4, null);
        AndroidComposeView_androidKt.m3276preTransformJiSxe2E(fArr, this.tmpMatrix);
    }

    /* JADX INFO: renamed from: transformMatrixToWindow-EL8BTi8, reason: not valid java name */
    private final void m3280transformMatrixToWindowEL8BTi8(View view, float[] matrix) {
        Object parent = view.getParent();
        if (parent instanceof View) {
            m3280transformMatrixToWindowEL8BTi8((View) parent, matrix);
            m3279preTranslate3XD1CNM(matrix, -view.getScrollX(), -view.getScrollY());
            m3279preTranslate3XD1CNM(matrix, view.getLeft(), view.getTop());
        } else {
            view.getLocationInWindow(this.tmpLocation);
            m3279preTranslate3XD1CNM(matrix, -view.getScrollX(), -view.getScrollY());
            m3279preTranslate3XD1CNM(matrix, r0[0], r0[1]);
        }
        ...
        m3278preConcattUYjHk(matrix, viewMatrix);
    }

    @Override // androidx.compose.ui.platform.CalculateMatrixToWindow
    /* JADX INFO: renamed from: calculateMatrixToWindow-EL8BTi8 */
    public void mo3277calculateMatrixToWindowEL8BTi8(@NotNull View view, @NotNull float[] matrix) {
        Intrinsics.checkNotNullParameter(view, "view");
        Intrinsics.checkNotNullParameter(matrix, "matrix");
        Matrix.m1818resetimpl(matrix);
        m3280transformMatrixToWindowEL8BTi8(view, matrix);
    }
}
