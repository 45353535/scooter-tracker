...
public final class WindowInfoImpl implements WindowInfo {
    ...
    @NotNull
    private static final MutableState<PointerKeyboardModifiers> GlobalKeyboardModifiers = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(PointerKeyboardModifiers.m2954boximpl(PointerEvent_androidKt.EmptyPointerKeyboardModifiers()), null, 2, null);
    ...
    public static /* synthetic */ void m3331getKeyboardModifiersk7X9c1A$annotations() {
    }

    @Override // androidx.compose.ui.platform.WindowInfo
    @ExperimentalComposeUiApi
    /* JADX INFO: renamed from: getKeyboardModifiers-k7X9c1A */
    public int mo3330getKeyboardModifiersk7X9c1A() {
    ...
    public void m3332setKeyboardModifiers5xRPYO0(int i10) {
        GlobalKeyboardModifiers.setValue(PointerKeyboardModifiers.m2954boximpl(i10));
    }
