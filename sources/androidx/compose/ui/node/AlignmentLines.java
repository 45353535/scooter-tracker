...
public abstract class AlignmentLines {
    ...
    public final void addAlignmentLine(AlignmentLine alignmentLine, int initialPosition, NodeCoordinator initialCoordinator) {
        ...
        while (true) {
            jOffset = mo3083calculatePositionInParentR5De75A(initialCoordinator, jOffset);
        ...
        int iD = alignmentLine instanceof HorizontalAlignmentLine ? zf.a.d(Offset.m1372getYimpl(jOffset)) : zf.a.d(Offset.m1371getXimpl(jOffset));
        Map<AlignmentLine, Integer> map = this.alignmentLineMap;
        if (map.containsKey(alignmentLine)) {
            iD = AlignmentLineKt.merge(alignmentLine, ((Number) MapsKt.getValue(this.alignmentLineMap, alignmentLine)).intValue(), iD);
        }
    ...
    protected abstract long mo3083calculatePositionInParentR5De75A(@NotNull NodeCoordinator nodeCoordinator, long j10);
