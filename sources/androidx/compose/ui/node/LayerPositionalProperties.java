...
final class LayerPositionalProperties {
    ...
    public final boolean hasSameValuesAs(@NotNull LayerPositionalProperties other) {
        Intrinsics.checkNotNullParameter(other, "other");
        return this.scaleX == other.scaleX && this.scaleY == other.scaleY && this.translationX == other.translationX && this.translationY == other.translationY && this.rotationX == other.rotationX && this.rotationY == other.rotationY && this.rotationZ == other.rotationZ && this.cameraDistance == other.cameraDistance && TransformOrigin.m1959equalsimpl0(this.transformOrigin, other.transformOrigin);
    }
    ...
    public final void copyFrom(@NotNull GraphicsLayerScope scope) {
        ...
        this.transformOrigin = scope.mo1769getTransformOriginSzJe1aQ();
    }
}
