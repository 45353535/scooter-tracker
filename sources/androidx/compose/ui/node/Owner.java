...
public interface Owner {
    ...
    long mo3247calculateLocalPositionMKHz9U(long positionInWindow);

    /* JADX INFO: renamed from: calculatePositionInWindow-MK-Hz9U, reason: not valid java name */
    long mo3248calculatePositionInWindowMKHz9U(long localPosition);
    ...
    FocusDirection mo3249getFocusDirectionP8AzH3I(@NotNull KeyEvent keyEvent);
    ...
    void mo3250measureAndLayout0kLqBqw(@NotNull LayoutNode layoutNode, long constraints);
    ...
    void onRequestMeasure(@NotNull LayoutNode layoutNode, boolean affectsLookahead, boolean forceRequest);

    void onRequestRelayout(@NotNull LayoutNode layoutNode, boolean affectsLookahead, boolean forceRequest);

    void onSemanticsChange();

    void registerOnEndApplyChangesListener(@NotNull Function0<Unit> listener);

    void registerOnLayoutCompletedListener(@NotNull OnLayoutCompletedListener listener);
