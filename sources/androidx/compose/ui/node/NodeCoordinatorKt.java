...
public final class NodeCoordinatorKt {
    ...
    public static final <T> T m3197nextUncheckedUntilhw7D004(DelegatableNode delegatableNode, int i10, int i11) {
        Modifier.Node node = (T) delegatableNode.getNode().getChild();
        if (node == null) {
            return null;
        }
        int aggregateChildKindSet = node.getAggregateChildKindSet() & i10;
