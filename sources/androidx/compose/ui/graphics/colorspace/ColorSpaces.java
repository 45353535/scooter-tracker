...
public final class ColorSpaces {
    ...
    static {
        ...
        Rgb rgb3 = new Rgb("scRGB-nl IEC 61966-2-2:2003", fArr, illuminant.getD65(), null, new DoubleFunction() { // from class: androidx.compose.ui.graphics.colorspace.a
            ...
            public final double invoke(double d10) {
                return ColorSpaces.ExtendedSrgb$lambda$0(d10);
            }
        }, new DoubleFunction() { // from class: androidx.compose.ui.graphics.colorspace.b
            @Override // androidx.compose.ui.graphics.colorspace.DoubleFunction
            public final double invoke(double d10) {
                return ColorSpaces.ExtendedSrgb$lambda$1(d10);
            }
    ...
    public static final double ExtendedSrgb$lambda$0(double d10) {
        return ColorSpaceKt.absRcpResponse(d10, 0.9478672985781991d, 0.05213270142180095d, 0.07739938080495357d, 0.04045d, 2.4d);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final double ExtendedSrgb$lambda$1(double d10) {
        return ColorSpaceKt.absResponse(d10, 0.9478672985781991d, 0.05213270142180095d, 0.07739938080495357d, 0.04045d, 2.4d);
    }
