...
public final class GroupComponent extends VNode {
    ...
    private final void updateMatrix() {
        float[] fArrM1809constructorimpl$default = this.groupMatrix;
        if (fArrM1809constructorimpl$default == null) {
            fArrM1809constructorimpl$default = Matrix.m1809constructorimpl$default(null, 1, null);
            this.groupMatrix = fArrM1809constructorimpl$default;
        } else {
            Matrix.m1818resetimpl(fArrM1809constructorimpl$default);
        }
        float[] fArr = fArrM1809constructorimpl$default;
        Matrix.m1829translateimpl$default(fArr, this.pivotX + this.translationX, this.pivotY + this.translationY, 0.0f, 4, null);
        Matrix.m1821rotateZimpl(fArr, this.rotation);
        Matrix.m1822scaleimpl(fArr, this.scaleX, this.scaleY, 1.0f);
        Matrix.m1829translateimpl$default(fArr, -this.pivotX, -this.pivotY, 0.0f, 4, null);
    }
    ...
    public void draw(@NotNull DrawScope drawScope) {
        ...
        if (fArr != null) {
            transform.mo2054transform58bKbWc(Matrix.m1807boximpl(fArr).m1830unboximpl());
        }
        Path path = this.clipPath;
