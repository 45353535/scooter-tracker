...
public final class AndroidPaint implements Paint {
    ...
    public AndroidPaint(@NotNull android.graphics.Paint internalPaint) {
        ...
        this._blendMode = BlendMode.INSTANCE.m1554getSrcOver0nO6VwU();
    }
    ...
    public long mo1486getColor0d7_KjU() {
    ...
    public int mo1487getFilterQualityfv9h1I() {
    ...
    public int mo1488getStrokeCapKaPHkGw() {
    ...
    public int mo1489getStrokeJoinLxFBmk8() {
    ...
    public int mo1490getStyleTiuSbCo() {
    ...
    public void mo1491setBlendModes9anfk8(int i10) {
        if (BlendMode.m1523equalsimpl0(this._blendMode, i10)) {
            return;
        }
        this._blendMode = i10;
        AndroidPaint_androidKt.m1497setNativeBlendModeGB0RdKg(this.internalPaint, i10);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* JADX INFO: renamed from: setColor-8_81llA, reason: not valid java name */
    public void mo1492setColor8_81llA(long j10) {
        AndroidPaint_androidKt.m1498setNativeColor4WTKRHQ(this.internalPaint, j10);
    }
    ...
    public void mo1493setFilterQualityvDHp3xo(int i10) {
        AndroidPaint_androidKt.m1499setNativeFilterQuality50PEsBU(this.internalPaint, i10);
    }
    ...
    public void mo1494setStrokeCapBeK7IIE(int i10) {
        AndroidPaint_androidKt.m1500setNativeStrokeCapCSYIeUk(this.internalPaint, i10);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* JADX INFO: renamed from: setStrokeJoin-Ww9F2mQ, reason: not valid java name */
    public void mo1495setStrokeJoinWw9F2mQ(int i10) {
        AndroidPaint_androidKt.m1501setNativeStrokeJoinkLtJ_vA(this.internalPaint, i10);
    }
    ...
    public void mo1496setStylek9PVt8s(int i10) {
        AndroidPaint_androidKt.m1502setNativeStyle5YerkU(this.internalPaint, i10);
    }
