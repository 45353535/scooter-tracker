...
public interface Path {
    ...
    public static final class Companion {
        ...
        public final Path m1847combinexh6zSI8(int operation, @NotNull Path path1, @NotNull Path path2) {
            Intrinsics.checkNotNullParameter(path1, "path1");
            Intrinsics.checkNotNullParameter(path2, "path2");
            Path Path = AndroidPath_androidKt.Path();
            if (Path.mo1505opN5in7k0(path1, path2, operation)) {
                return Path;
            }
    ...
    void mo1503addPathUv8p0NA(@NotNull Path path, long offset);
    ...
    void arcToRad(@NotNull Rect rect, float startAngleRadians, float sweepAngleRadians, boolean forceMoveTo);
    ...
    void lineTo(float x10, float y10);

    void moveTo(float x10, float y10);

    /* JADX INFO: renamed from: op-N5in7k0 */
    boolean mo1505opN5in7k0(@NotNull Path path1, @NotNull Path path2, int operation);
    ...
    void mo1506setFillTypeoQ8Xj4U(int i10);

    /* JADX INFO: renamed from: translate-k-4lQ0M */
    void mo1507translatek4lQ0M(long offset);
}
