...
public final class AndroidPath implements Path {
    ...
    public void mo1503addPathUv8p0NA(@NotNull Path path, long offset) {
        Intrinsics.checkNotNullParameter(path, "path");
        android.graphics.Path path2 = this.internalPath;
        if (!(path instanceof AndroidPath)) {
            throw new UnsupportedOperationException("Unable to obtain android.graphics.Path");
        }
        path2.addPath(((AndroidPath) path).getInternalPath(), Offset.m1371getXimpl(offset), Offset.m1372getYimpl(offset));
    }
    ...
    public void addRoundRect(@NotNull RoundRect roundRect) {
        ...
        this.radii[0] = CornerRadius.m1346getXimpl(roundRect.m1421getTopLeftCornerRadiuskKHJgLs());
        this.radii[1] = CornerRadius.m1347getYimpl(roundRect.m1421getTopLeftCornerRadiuskKHJgLs());
        this.radii[2] = CornerRadius.m1346getXimpl(roundRect.m1422getTopRightCornerRadiuskKHJgLs());
        this.radii[3] = CornerRadius.m1347getYimpl(roundRect.m1422getTopRightCornerRadiuskKHJgLs());
        this.radii[4] = CornerRadius.m1346getXimpl(roundRect.m1420getBottomRightCornerRadiuskKHJgLs());
        this.radii[5] = CornerRadius.m1347getYimpl(roundRect.m1420getBottomRightCornerRadiuskKHJgLs());
        this.radii[6] = CornerRadius.m1346getXimpl(roundRect.m1419getBottomLeftCornerRadiuskKHJgLs());
        this.radii[7] = CornerRadius.m1347getYimpl(roundRect.m1419getBottomLeftCornerRadiuskKHJgLs());
    ...
    public int mo1504getFillTypeRgk1Os() {
        return this.internalPath.getFillType() == Path.FillType.EVEN_ODD ? PathFillType.INSTANCE.m1857getEvenOddRgk1Os() : PathFillType.INSTANCE.m1858getNonZeroRgk1Os();
    }
    ...
    public boolean mo1505opN5in7k0(@NotNull Path path1, @NotNull Path path2, int operation) {
        Intrinsics.checkNotNullParameter(path1, "path1");
        Intrinsics.checkNotNullParameter(path2, "path2");
        PathOperation.Companion companion = PathOperation.INSTANCE;
        Path.Op op = PathOperation.m1862equalsimpl0(operation, companion.m1866getDifferenceb3I0S0c()) ? Path.Op.DIFFERENCE : PathOperation.m1862equalsimpl0(operation, companion.m1867getIntersectb3I0S0c()) ? Path.Op.INTERSECT : PathOperation.m1862equalsimpl0(operation, companion.m1868getReverseDifferenceb3I0S0c()) ? Path.Op.REVERSE_DIFFERENCE : PathOperation.m1862equalsimpl0(operation, companion.m1869getUnionb3I0S0c()) ? Path.Op.UNION : Path.Op.XOR;
    ...
    public void mo1506setFillTypeoQ8Xj4U(int i10) {
        this.internalPath.setFillType(PathFillType.m1853equalsimpl0(i10, PathFillType.INSTANCE.m1857getEvenOddRgk1Os()) ? Path.FillType.EVEN_ODD : Path.FillType.WINDING);
    }

    @Override // androidx.compose.ui.graphics.Path
    /* JADX INFO: renamed from: translate-k-4lQ0M, reason: not valid java name */
    public void mo1507translatek4lQ0M(long offset) {
        this.mMatrix.reset();
        this.mMatrix.setTranslate(Offset.m1371getXimpl(offset), Offset.m1372getYimpl(offset));
