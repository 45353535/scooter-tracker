...
public final class AndroidPathEffect_androidKt {
    ...
    public static final PathEffect m1508actualStampedPathEffect7aD1DOk(@NotNull Path shape, float f10, float f11, int i10) {
        Intrinsics.checkNotNullParameter(shape, "shape");
        if (shape instanceof AndroidPath) {
            return new AndroidPathEffect(new PathDashPathEffect(((AndroidPath) shape).getInternalPath(), f10, f11, m1509toAndroidPathDashPathEffectStyleoQv6xUo(i10)));
        }
    ...
    public static final PathDashPathEffect.Style m1509toAndroidPathDashPathEffectStyleoQv6xUo(int i10) {
        StampedPathEffectStyle.Companion companion = StampedPathEffectStyle.INSTANCE;
        return StampedPathEffectStyle.m1913equalsimpl0(i10, companion.m1917getMorphYpspkwk()) ? PathDashPathEffect.Style.MORPH : StampedPathEffectStyle.m1913equalsimpl0(i10, companion.m1918getRotateYpspkwk()) ? PathDashPathEffect.Style.ROTATE : StampedPathEffectStyle.m1913equalsimpl0(i10, companion.m1919getTranslateYpspkwk()) ? PathDashPathEffect.Style.TRANSLATE : PathDashPathEffect.Style.TRANSLATE;
    }
