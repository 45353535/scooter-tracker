...
public final class AndroidColorFilter_androidKt {
    ...
    public static final ColorFilter m1477actualColorMatrixColorFilterjHGOpc(@NotNull float[] colorMatrix) {
    ...
    public static final ColorFilter m1478actualLightingColorFilterOWjLjI(long j10, long j11) {
        return new ColorFilter(new LightingColorFilter(ColorKt.m1658toArgb8_81llA(j10), ColorKt.m1658toArgb8_81llA(j11)));
    }

    @NotNull
    /* JADX INFO: renamed from: actualTintColorFilter-xETnrds, reason: not valid java name */
    public static final ColorFilter m1479actualTintColorFilterxETnrds(long j10, int i10) {
        return new ColorFilter(Build.VERSION.SDK_INT >= 29 ? BlendModeColorFilterHelper.INSTANCE.m1556BlendModeColorFilterxETnrds(j10, i10) : new PorterDuffColorFilter(ColorKt.m1658toArgb8_81llA(j10), AndroidBlendMode_androidKt.m1464toPorterDuffModes9anfk8(i10)));
    }
