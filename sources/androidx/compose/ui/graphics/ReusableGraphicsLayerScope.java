...
public final class ReusableGraphicsLayerScope implements GraphicsLayerScope {
    ...
    private long transformOrigin = TransformOrigin.INSTANCE.m1965getCenterSzJe1aQ();

    @NotNull
    private Shape shape = RectangleShapeKt.getRectangleShape();
    private int compositingStrategy = CompositingStrategy.INSTANCE.m1688getAutoNrFUSI();
    private long size = Size.INSTANCE.m1448getUnspecifiedNHjbRc();
    ...
    public final void reset() {
        ...
        mo1770setAmbientShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        mo1772setSpotShadowColor8_81llA(GraphicsLayerScopeKt.getDefaultShadowColor());
        setRotationX(0.0f);
        setRotationY(0.0f);
        setRotationZ(0.0f);
        setCameraDistance(8.0f);
        mo1773setTransformOrigin__ExYCQ(TransformOrigin.INSTANCE.m1965getCenterSzJe1aQ());
        setShape(RectangleShapeKt.getRectangleShape());
        setClip(false);
        setRenderEffect(null);
        mo1771setCompositingStrategyaDBOjCE(CompositingStrategy.INSTANCE.m1688getAutoNrFUSI());
        m1886setSizeuvyYCjk(Size.INSTANCE.m1448getUnspecifiedNHjbRc());
    }
    ...
    public void mo1770setAmbientShadowColor8_81llA(long j10) {
    ...
    public void mo1771setCompositingStrategyaDBOjCE(int i10) {
    ...
    public void m1886setSizeuvyYCjk(long j10) {
        this.size = j10;
    }

    @Override // androidx.compose.ui.graphics.GraphicsLayerScope
    /* JADX INFO: renamed from: setSpotShadowColor-8_81llA */
    public void mo1772setSpotShadowColor8_81llA(long j10) {
        this.spotShadowColor = j10;
    }

    @Override // androidx.compose.ui.graphics.GraphicsLayerScope
    /* JADX INFO: renamed from: setTransformOrigin-__ExYCQ */
    public void mo1773setTransformOrigin__ExYCQ(long j10) {
