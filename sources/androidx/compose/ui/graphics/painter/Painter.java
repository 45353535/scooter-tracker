...
public abstract class Painter {
    ...
    public static /* synthetic */ void m2138drawx_KDEd0$default(Painter painter, DrawScope drawScope, long j10, float f10, ColorFilter colorFilter, int i10, Object obj) {
        if (obj != null) {
        ...
        painter.m2139drawx_KDEd0(drawScope, j10, f11, colorFilter);
    }
    ...
    public final void m2139drawx_KDEd0(@NotNull DrawScope draw, long j10, float f10, @Nullable ColorFilter colorFilter) {
        Intrinsics.checkNotNullParameter(draw, "$this$draw");
        configureAlpha(f10);
        configureColorFilter(colorFilter);
        configureLayoutDirection(draw.getLayoutDirection());
        float fM1440getWidthimpl = Size.m1440getWidthimpl(draw.mo2040getSizeNHjbRc()) - Size.m1440getWidthimpl(j10);
        float fM1437getHeightimpl = Size.m1437getHeightimpl(draw.mo2040getSizeNHjbRc()) - Size.m1437getHeightimpl(j10);
        draw.getDrawContext().getTransform().inset(0.0f, 0.0f, fM1440getWidthimpl, fM1437getHeightimpl);
        if (f10 > 0.0f && Size.m1440getWidthimpl(j10) > 0.0f && Size.m1437getHeightimpl(j10) > 0.0f) {
            if (this.useLayer) {
                Rect rectM1411Recttz77jQw = RectKt.m1411Recttz77jQw(Offset.INSTANCE.m1387getZeroF1C5BW0(), SizeKt.Size(Size.m1440getWidthimpl(j10), Size.m1437getHeightimpl(j10)));
                Canvas canvas = draw.getDrawContext().getCanvas();
                try {
                    canvas.saveLayer(rectM1411Recttz77jQw, obtainPaint());
                    onDraw(draw);
                } finally {
                    canvas.restore();
                }
    ...
    public abstract long mo2133getIntrinsicSizeNHjbRc();
