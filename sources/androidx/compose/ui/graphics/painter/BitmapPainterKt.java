...
public final class BitmapPainterKt {
    ...
    public static final BitmapPainter m2135BitmapPainterQZhYCtY(@NotNull ImageBitmap image, long j10, long j11, int i10) {
        Intrinsics.checkNotNullParameter(image, "image");
        BitmapPainter bitmapPainter = new BitmapPainter(image, j10, j11, null);
        bitmapPainter.m2134setFilterQualityvDHp3xo$ui_graphics_release(i10);
        return bitmapPainter;
    }

    /* JADX INFO: renamed from: BitmapPainter-QZhYCtY$default, reason: not valid java name */
    public static /* synthetic */ BitmapPainter m2136BitmapPainterQZhYCtY$default(ImageBitmap imageBitmap, long j10, long j11, int i10, int i11, Object obj) {
        if ((i11 & 2) != 0) {
            j10 = IntOffset.INSTANCE.m4079getZeronOccac();
        }
        long j12 = j10;
        if ((i11 & 4) != 0) {
        ...
        long j13 = j11;
        if ((i11 & 8) != 0) {
            i10 = FilterQuality.INSTANCE.m1699getLowfv9h1I();
        }
        return m2135BitmapPainterQZhYCtY(imageBitmap, j12, j13, i10);
    }
}
