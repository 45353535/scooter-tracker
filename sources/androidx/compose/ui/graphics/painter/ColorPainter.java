...
public final class ColorPainter extends Painter {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return (other instanceof ColorPainter) && Color.m1605equalsimpl0(this.color, ((ColorPainter) other).color);
    }
    ...
    public int hashCode() {
        return Color.m1611hashCodeimpl(this.color);
    }
    ...
    public String toString() {
        return "ColorPainter(color=" + ((Object) Color.m1612toStringimpl(this.color)) + ')';
    }
