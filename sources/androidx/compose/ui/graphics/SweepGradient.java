...
public final class SweepGradient extends ShaderBrush {
    ...
    public Shader mo1579createShaderuvyYCjk(long size) {
        ...
        if (OffsetKt.m1392isUnspecifiedk4lQ0M(this.center)) {
            jOffset = SizeKt.m1450getCenteruvyYCjk(size);
        } else {
            jOffset = OffsetKt.Offset(Offset.m1371getXimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m1440getWidthimpl(size) : Offset.m1371getXimpl(this.center), Offset.m1372getYimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m1437getHeightimpl(size) : Offset.m1372getYimpl(this.center));
        }
        return ShaderKt.m1893SweepGradientShader9KIMszo(jOffset, this.colors, this.stops);
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Offset.m1368equalsimpl0(this.center, sweepGradient.center) && Intrinsics.areEqual(this.colors, sweepGradient.colors) && Intrinsics.areEqual(this.stops, sweepGradient.stops);
    }

    public int hashCode() {
        int iM1373hashCodeimpl = ((Offset.m1373hashCodeimpl(this.center) * 31) + this.colors.hashCode()) * 31;
        List<Float> list = this.stops;
        return iM1373hashCodeimpl + (list != null ? list.hashCode() : 0);
    }
