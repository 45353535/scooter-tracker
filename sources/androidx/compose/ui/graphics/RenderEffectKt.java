...
public final class RenderEffectKt {
    ...
    public static final BlurEffect m1882BlurEffect3YTHUZs(float f10, float f11, int i10) {
        return new BlurEffect(null, f10, f11, i10, null);
    }

    /* JADX INFO: renamed from: BlurEffect-3YTHUZs$default, reason: not valid java name */
    public static /* synthetic */ BlurEffect m1883BlurEffect3YTHUZs$default(float f10, float f11, int i10, int i11, Object obj) {
        if ((i11 & 4) != 0) {
            i10 = TileMode.INSTANCE.m1947getClamp3opZhB0();
        }
        return m1882BlurEffect3YTHUZs(f10, f11, i10);
    }
