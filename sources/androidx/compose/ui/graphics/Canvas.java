...
public interface Canvas {
    ...
    public static final class DefaultImpls {
        ...
        public static void m1582clipRectmtrdDE(@NotNull Canvas canvas, @NotNull Rect rect, int i10) {
            Intrinsics.checkNotNullParameter(rect, "rect");
            c1.a(canvas, rect, i10);
        }
        ...
        public static void drawArc(@NotNull Canvas canvas, @NotNull Rect rect, float f10, float f11, boolean z10, @NotNull Paint paint) {
            ...
            c1.b(canvas, rect, f10, f11, z10, paint);
        }
        ...
        public static void drawArcRad(@NotNull Canvas canvas, @NotNull Rect rect, float f10, float f11, boolean z10, @NotNull Paint paint) {
            Intrinsics.checkNotNullParameter(rect, "rect");
            Intrinsics.checkNotNullParameter(paint, "paint");
            c1.c(canvas, rect, f10, f11, z10, paint);
        }
    ...
    void mo1465clipPathmtrdDE(@NotNull Path path, int clipOp);

    /* JADX INFO: renamed from: clipRect-N_I0leg */
    void mo1466clipRectN_I0leg(float left, float top, float right, float bottom, int clipOp);

    /* JADX INFO: renamed from: clipRect-mtrdD-E */
    void mo1467clipRectmtrdDE(@NotNull Rect rect, int clipOp);

    /* JADX INFO: renamed from: concat-58bKbWc */
    void mo1468concat58bKbWc(@NotNull float[] matrix);
    ...
    void mo1469drawCircle9KIMszo(long center, float radius, @NotNull Paint paint);

    /* JADX INFO: renamed from: drawImage-d-4ec7I */
    void mo1470drawImaged4ec7I(@NotNull ImageBitmap image, long topLeftOffset, @NotNull Paint paint);

    /* JADX INFO: renamed from: drawImageRect-HPBpro0 */
    void mo1471drawImageRectHPBpro0(@NotNull ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, @NotNull Paint paint);

    /* JADX INFO: renamed from: drawLine-Wko1d7g */
    void mo1472drawLineWko1d7g(long p12, long p22, @NotNull Paint paint);
    ...
    void mo1473drawPointsO7TthRY(int pointMode, @NotNull List<Offset> points, @NotNull Paint paint);

    /* JADX INFO: renamed from: drawRawPoints-O7TthRY */
    void mo1474drawRawPointsO7TthRY(int pointMode, @NotNull float[] points, @NotNull Paint paint);
    ...
    void mo1475drawVerticesTPEHhCM(@NotNull Vertices vertices, int blendMode, @NotNull Paint paint);
