...
public final class ImageBitmapKt {
    ...
    public static final ImageBitmap m1805ImageBitmapx__hDU(int i10, int i11, int i12, boolean z10, @NotNull ColorSpace colorSpace) {
        Intrinsics.checkNotNullParameter(colorSpace, "colorSpace");
        return AndroidImageBitmap_androidKt.m1481ActualImageBitmapx__hDU(i10, i11, i12, z10, colorSpace);
    }

    /* JADX INFO: renamed from: ImageBitmap-x__-hDU$default, reason: not valid java name */
    public static /* synthetic */ ImageBitmap m1806ImageBitmapx__hDU$default(int i10, int i11, int i12, boolean z10, ColorSpace colorSpace, int i13, Object obj) {
        if ((i13 & 4) != 0) {
            i12 = ImageBitmapConfig.INSTANCE.m1801getArgb8888_sVssgQ();
        }
        if ((i13 & 8) != 0) {
            z10 = true;
        }
        ...
        return m1805ImageBitmapx__hDU(i10, i11, i12, z10, colorSpace);
    }
