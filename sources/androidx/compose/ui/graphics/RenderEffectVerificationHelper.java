...
final class RenderEffectVerificationHelper {
    ...
    public final android.graphics.RenderEffect m1884createBlurEffect8A3gB4(@Nullable RenderEffect inputRenderEffect, float radiusX, float radiusY, int edgeTreatment) {
        if (inputRenderEffect == null) {
            android.graphics.RenderEffect renderEffectCreateBlurEffect = android.graphics.RenderEffect.createBlurEffect(radiusX, radiusY, AndroidTileMode_androidKt.m1517toAndroidTileMode0vamqd0(edgeTreatment));
            Intrinsics.checkNotNullExpressionValue(renderEffectCreateBlurEffect, "{\n            android.gr…)\n            )\n        }");
            return renderEffectCreateBlurEffect;
        }
        android.graphics.RenderEffect renderEffectCreateBlurEffect2 = android.graphics.RenderEffect.createBlurEffect(radiusX, radiusY, inputRenderEffect.asAndroidRenderEffect(), AndroidTileMode_androidKt.m1517toAndroidTileMode0vamqd0(edgeTreatment));
    ...
    public final android.graphics.RenderEffect m1885createOffsetEffectUv8p0NA(@Nullable RenderEffect inputRenderEffect, long offset) {
        if (inputRenderEffect == null) {
            android.graphics.RenderEffect renderEffectCreateOffsetEffect = android.graphics.RenderEffect.createOffsetEffect(Offset.m1371getXimpl(offset), Offset.m1372getYimpl(offset));
            Intrinsics.checkNotNullExpressionValue(renderEffectCreateOffsetEffect, "{\n            android.gr…et.x, offset.y)\n        }");
            return renderEffectCreateOffsetEffect;
        }
        android.graphics.RenderEffect renderEffectCreateOffsetEffect2 = android.graphics.RenderEffect.createOffsetEffect(Offset.m1371getXimpl(offset), Offset.m1372getYimpl(offset), inputRenderEffect.asAndroidRenderEffect());
