...
final /* data */ class DrawWithContentElement extends ModifierNodeElement<DrawWithContentModifier> {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    public static /* synthetic */ DrawWithContentElement copy$default(DrawWithContentElement drawWithContentElement, Function1 function1, int i10, Object obj) {
        if ((i10 & 1) != 0) {
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    @NotNull
    public DrawWithContentModifier update(@NotNull DrawWithContentModifier node) {
