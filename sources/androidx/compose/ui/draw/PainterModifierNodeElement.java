...
final /* data */ class PainterModifierNodeElement extends ModifierNodeElement<PainterModifier> {
    ...
    public static /* synthetic */ PainterModifierNodeElement copy$default(PainterModifierNodeElement painterModifierNodeElement, Painter painter, boolean z10, Alignment alignment, ContentScale contentScale, float f10, ColorFilter colorFilter, int i10, Object obj) {
        ...
        return painterModifierNodeElement.copy(painter, z10, alignment, contentScale, f11, colorFilter2);
    }
    ...
    @NotNull
    public final PainterModifierNodeElement copy(@NotNull Painter painter, boolean sizeToIntrinsics, @NotNull Alignment alignment, @NotNull ContentScale contentScale, float alpha, @Nullable ColorFilter colorFilter) {
        Intrinsics.checkNotNullParameter(painter, "painter");
        Intrinsics.checkNotNullParameter(alignment, "alignment");
        Intrinsics.checkNotNullParameter(contentScale, "contentScale");
    ...
    public int hashCode() {
        ...
        int iHashCode2 = (((((((iHashCode + r12) * 31) + this.alignment.hashCode()) * 31) + this.contentScale.hashCode()) * 31) + Float.floatToIntBits(this.alpha)) * 31;
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    @NotNull
    public PainterModifier update(@NotNull PainterModifier node) {
        Intrinsics.checkNotNullParameter(node, "node");
        boolean sizeToIntrinsics = node.getSizeToIntrinsics();
        boolean z10 = this.sizeToIntrinsics;
        boolean z11 = sizeToIntrinsics != z10 || (z10 && !Size.m1436equalsimpl0(node.getPainter().mo2133getIntrinsicSizeNHjbRc(), this.painter.mo2133getIntrinsicSizeNHjbRc()));
