...
final /* data */ class FocusChangedElement extends ModifierNodeElement<FocusChangedModifierNode> {
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    @NotNull
    public FocusChangedModifierNode update(@NotNull FocusChangedModifierNode node) {
