...
final class FocusableChildrenComparator implements Comparator<FocusTargetModifierNode> {
    ...
    public int compare(@Nullable FocusTargetModifierNode focusTarget1, @Nullable FocusTargetModifierNode focusTarget2) {
        ...
        if (iMin >= 0) {
            while (Intrinsics.areEqual(mutableVectorPathFromRoot.getContent()[i10], mutableVectorPathFromRoot2.getContent()[i10])) {
                if (i10 != iMin) {
                    i10++;
                }
            }
            return Intrinsics.compare(mutableVectorPathFromRoot.getContent()[i10].getPlaceOrder(), mutableVectorPathFromRoot2.getContent()[i10].getPlaceOrder());
        }
