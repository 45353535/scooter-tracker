...
final class ZIndexModifier extends InspectorValueInfo implements LayoutModifier {
    ...
    public MeasureResult mo43measure3p2s80s(@NotNull MeasureScope measure, @NotNull Measurable measurable, long j10) {
        ...
        return MeasureScope.CC.p(measure, placeableMo3011measureBRTryo0.getWidth(), placeableMo3011measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.ui.ZIndexModifier$measure$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(1);
            }
            ...
            public final void invoke2(@NotNull Placeable.PlacementScope layout) {
                ...
                layout.place(placeableMo3011measureBRTryo0, 0, 0, this.zIndex);
            }
        }, 4, null);
    }
