...
public final class AndroidFontUtils_androidKt {
    ...
    public static final int m3543getAndroidTypefaceStyleFO1MlWM(@NotNull FontWeight fontWeight, int i10) {
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        return getAndroidTypefaceStyle(fontWeight.compareTo(getAndroidBold(FontWeight.INSTANCE)) >= 0, FontStyle.m3588equalsimpl0(i10, FontStyle.INSTANCE.m3592getItalic_LCdwA()));
    }
}
