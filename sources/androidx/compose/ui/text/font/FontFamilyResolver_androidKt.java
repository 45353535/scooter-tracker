...
public final class FontFamilyResolver_androidKt {
    ...
    public static final State<android.graphics.Typeface> m3564resolveAsTypefaceWqqsr6A(@NotNull FontFamily.Resolver resolveAsTypeface, @Nullable FontFamily fontFamily, @NotNull FontWeight fontWeight, int i10, int i11) {
        Intrinsics.checkNotNullParameter(resolveAsTypeface, "$this$resolveAsTypeface");
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        State stateMo3563resolveDPcqOEQ = resolveAsTypeface.mo3563resolveDPcqOEQ(fontFamily, fontWeight, i10, i11);
        Intrinsics.checkNotNull(stateMo3563resolveDPcqOEQ, "null cannot be cast to non-null type androidx.compose.runtime.State<android.graphics.Typeface>");
        return stateMo3563resolveDPcqOEQ;
    }

    /* JADX INFO: renamed from: resolveAsTypeface-Wqqsr6A$default, reason: not valid java name */
    public static /* synthetic */ State m3565resolveAsTypefaceWqqsr6A$default(FontFamily.Resolver resolver, FontFamily fontFamily, FontWeight fontWeight, int i10, int i11, int i12, Object obj) {
        if ((i12 & 1) != 0) {
            fontFamily = null;
        }
        if ((i12 & 2) != 0) {
        ...
        if ((i12 & 8) != 0) {
            i11 = FontSynthesis.INSTANCE.m3603getAllGVVA2EU();
        }
        return m3564resolveAsTypefaceWqqsr6A(resolver, fontFamily, fontWeight, i10, i11);
    }
