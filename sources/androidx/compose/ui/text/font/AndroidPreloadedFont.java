...
public abstract class AndroidPreloadedFont extends AndroidFont {
    ...
    public /* synthetic */ AndroidPreloadedFont(FontWeight fontWeight, int i10, FontVariation.Settings settings, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    private AndroidPreloadedFont(FontWeight fontWeight, int i10, FontVariation.Settings settings) {
        super(FontLoadingStrategy.INSTANCE.m3580getBlockingPKNRLFQ(), AndroidPreloadedFontTypefaceLoader.INSTANCE, settings, null);
