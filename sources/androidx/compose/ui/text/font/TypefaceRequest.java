...
public final /* data */ class TypefaceRequest {
    ...
    public static /* synthetic */ TypefaceRequest m3625copye1PVR60$default(TypefaceRequest typefaceRequest, FontFamily fontFamily, FontWeight fontWeight, int i10, int i11, Object obj, int i12, Object obj2) {
        if ((i12 & 1) != 0) {
        ...
        Object obj3 = obj;
        int i13 = i10;
        return typefaceRequest.m3628copye1PVR60(fontFamily, fontWeight, i13, i11, obj3);
    }
    ...
    public final TypefaceRequest m3628copye1PVR60(@Nullable FontFamily fontFamily, @NotNull FontWeight fontWeight, int fontStyle, int fontSynthesis, @Nullable Object resourceLoaderCacheKey) {
    ...
    public final int m3629getFontStyle_LCdwA() {
        return this.fontStyle;
    }

    /* JADX INFO: renamed from: getFontSynthesis-GVVA2EU, reason: not valid java name */
    public final int m3630getFontSynthesisGVVA2EU() {
        return this.fontSynthesis;
    }
    ...
    public int hashCode() {
        ...
        int iHashCode = (((((((fontFamily == null ? 0 : fontFamily.hashCode()) * 31) + this.fontWeight.hashCode()) * 31) + FontStyle.m3589hashCodeimpl(this.fontStyle)) * 31) + FontSynthesis.m3598hashCodeimpl(this.fontSynthesis)) * 31;
    ...
    public String toString() {
        return "TypefaceRequest(fontFamily=" + this.fontFamily + ", fontWeight=" + this.fontWeight + ", fontStyle=" + ((Object) FontStyle.m3590toStringimpl(this.fontStyle)) + ", fontSynthesis=" + ((Object) FontSynthesis.m3601toStringimpl(this.fontSynthesis)) + ", resourceLoaderCacheKey=" + this.resourceLoaderCacheKey + ')';
    }
