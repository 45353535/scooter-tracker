...
public final class PlatformFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public TypefaceResult resolve(@NotNull TypefaceRequest typefaceRequest, @NotNull PlatformFontLoader platformFontLoader, @NotNull Function1<? super TypefaceResult.Immutable, Unit> onAsyncCompletion, @NotNull Function1<? super TypefaceRequest, ? extends Object> createDefaultTypeface) {
        android.graphics.Typeface typefaceMo3712getNativeTypefacePYhJU0U;
        ...
        if (fontFamily == null ? true : fontFamily instanceof DefaultFontFamily) {
            typefaceMo3712getNativeTypefacePYhJU0U = this.platformTypefaceResolver.mo3611createDefaultFO1MlWM(typefaceRequest.getFontWeight(), typefaceRequest.m3629getFontStyle_LCdwA());
        } else if (fontFamily instanceof GenericFontFamily) {
            typefaceMo3712getNativeTypefacePYhJU0U = this.platformTypefaceResolver.mo3612createNamedRetOiIg((GenericFontFamily) typefaceRequest.getFontFamily(), typefaceRequest.getFontWeight(), typefaceRequest.m3629getFontStyle_LCdwA());
        } else {
            ...
            typefaceMo3712getNativeTypefacePYhJU0U = ((AndroidTypeface) typeface).mo3712getNativeTypefacePYhJU0U(typefaceRequest.getFontWeight(), typefaceRequest.m3629getFontStyle_LCdwA(), typefaceRequest.m3630getFontSynthesisGVVA2EU());
        }
        return new TypefaceResult.Immutable(typefaceMo3712getNativeTypefacePYhJU0U, false, 2, null);
    }
}
