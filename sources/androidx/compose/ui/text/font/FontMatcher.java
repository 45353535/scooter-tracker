...
public final class FontMatcher {
    ...
    public final List<Font> m3582matchFontRetOiIg(@NotNull FontFamily fontFamily, @NotNull FontWeight fontWeight, int fontStyle) {
        Intrinsics.checkNotNullParameter(fontFamily, "fontFamily");
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        if (fontFamily instanceof FontListFontFamily) {
            return m3583matchFontRetOiIg((FontListFontFamily) fontFamily, fontWeight, fontStyle);
        }
    ...
    @NotNull
    /* JADX INFO: renamed from: matchFont-RetOiIg, reason: not valid java name */
    public final List<Font> m3583matchFontRetOiIg(@NotNull FontListFontFamily fontFamily, @NotNull FontWeight fontWeight, int fontStyle) {
        Intrinsics.checkNotNullParameter(fontFamily, "fontFamily");
        Intrinsics.checkNotNullParameter(fontWeight, "fontWeight");
        return m3584matchFontRetOiIg(fontFamily.getFonts(), fontWeight, fontStyle);
    }

    @NotNull
    /* JADX INFO: renamed from: matchFont-RetOiIg, reason: not valid java name */
    public final List<Font> m3584matchFontRetOiIg(@NotNull List<? extends Font> fontList, @NotNull FontWeight fontWeight, int fontStyle) {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            ...
            Font font2 = font;
            if (Intrinsics.areEqual(font2.getWeight(), fontWeight) && FontStyle.m3588equalsimpl0(font2.getStyle(), fontStyle)) {
                arrayList.add(font);
            }
        }
        ...
        for (int i12 = 0; i12 < size2; i12++) {
            ...
            if (FontStyle.m3588equalsimpl0(font3.getStyle(), fontStyle)) {
        ...
        if (fontWeight.compareTo(companion.getW400()) < 0) {
            ...
            while (true) {
                ...
                FontWeight weight = list.get(i13).getWeight();
                if (weight.compareTo(fontWeight) < 0) {
        ...
        if (fontWeight.compareTo(companion.getW500()) > 0) {
            ...
            while (true) {
                ...
                FontWeight weight2 = list.get(i14).getWeight();
        ...
        while (true) {
            ...
            FontWeight weight3 = list.get(i15).getWeight();
        ...
        while (true) {
            ...
            FontWeight weight4 = list.get(i17).getWeight();
