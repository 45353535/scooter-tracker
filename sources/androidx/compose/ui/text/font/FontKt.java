...
public final class FontKt {
    ...
    public static final Font m3566FontF3nL8kk(int i10, @NotNull FontWeight weight, int i11, int i12, @NotNull FontVariation.Settings variationSettings) {
    ...
    public static /* synthetic */ Font m3567FontF3nL8kk$default(int i10, FontWeight fontWeight, int i11, int i12, FontVariation.Settings settings, int i13, Object obj) {
        if ((i13 & 2) != 0) {
            fontWeight = FontWeight.INSTANCE.getNormal();
        }
        if ((i13 & 4) != 0) {
            i11 = FontStyle.INSTANCE.m3593getNormal_LCdwA();
        }
        if ((i13 & 8) != 0) {
            i12 = FontLoadingStrategy.INSTANCE.m3580getBlockingPKNRLFQ();
        }
        if ((i13 & 16) != 0) {
            settings = FontVariation.INSTANCE.m3608Settings6EWAqTQ(fontWeight, i11, new FontVariation.Setting[0]);
        }
        return m3566FontF3nL8kk(i10, fontWeight, i11, i12, settings);
    }

    @Stable
    /* JADX INFO: renamed from: Font-RetOiIg, reason: not valid java name */
    public static final /* synthetic */ Font m3568FontRetOiIg(int i10, FontWeight weight, int i11) {
        Intrinsics.checkNotNullParameter(weight, "weight");
        return new ResourceFont(i10, weight, i11, null, FontLoadingStrategy.INSTANCE.m3580getBlockingPKNRLFQ(), 8, null);
    }

    /* JADX INFO: renamed from: Font-RetOiIg$default, reason: not valid java name */
    public static /* synthetic */ Font m3569FontRetOiIg$default(int i10, FontWeight fontWeight, int i11, int i12, Object obj) {
        if ((i12 & 2) != 0) {
            fontWeight = FontWeight.INSTANCE.getNormal();
        }
        if ((i12 & 4) != 0) {
        ...
        return m3568FontRetOiIg(i10, fontWeight, i11);
    }

    @Stable
    @NotNull
    /* JADX INFO: renamed from: Font-YpTlLL0, reason: not valid java name */
    public static final Font m3570FontYpTlLL0(int i10, @NotNull FontWeight weight, int i11, int i12) {
        Intrinsics.checkNotNullParameter(weight, "weight");
        return new ResourceFont(i10, weight, i11, new FontVariation.Settings(new FontVariation.Setting[0]), i12, null);
    }

    /* JADX INFO: renamed from: Font-YpTlLL0$default, reason: not valid java name */
    public static /* synthetic */ Font m3571FontYpTlLL0$default(int i10, FontWeight fontWeight, int i11, int i12, int i13, Object obj) {
        if ((i13 & 2) != 0) {
            fontWeight = FontWeight.INSTANCE.getNormal();
        }
        if ((i13 & 4) != 0) {
        ...
        return m3570FontYpTlLL0(i10, fontWeight, i11, i12);
    }
