...
public final class DeviceFontFamilyNameFontKt {
    ...
    public static final Font m3561Fontvxs03AY(@NotNull String familyName, @NotNull FontWeight weight, int i10, @NotNull FontVariation.Settings variationSettings) {
    ...
    public static /* synthetic */ Font m3562Fontvxs03AY$default(String str, FontWeight fontWeight, int i10, FontVariation.Settings settings, int i11, Object obj) {
        if ((i11 & 2) != 0) {
        ...
        return m3561Fontvxs03AY(str, fontWeight, i10, settings);
    }
}
