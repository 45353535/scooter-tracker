...
public final class InputState_androidKt {
    ...
    public static final ExtractedText toExtractedText(@NotNull TextFieldValue textFieldValue) {
        ...
        extractedText.selectionStart = TextRange.m3501getMinimpl(textFieldValue.getSelection());
        extractedText.selectionEnd = TextRange.m3500getMaximpl(textFieldValue.getSelection());
        extractedText.flags = !StringsKt.f0(textFieldValue.getText(), '\n', false, 2, null) ? 1 : 0;
