...
public class TextInputService {
    ...
    public void stopInput(@NotNull TextInputSession session) {
        ...
        if (androidx.compose.animation.core.c.a(this._currentInputSession, session, null)) {
