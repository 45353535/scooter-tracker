...
public final class TextFieldValueKt {
    ...
    public static final AnnotatedString getSelectedText(@NotNull TextFieldValue textFieldValue) {
        ...
        return textFieldValue.getText().m3383subSequence5zctL8(textFieldValue.getSelection());
    }

    @NotNull
    public static final AnnotatedString getTextAfterSelection(@NotNull TextFieldValue textFieldValue, int i10) {
        Intrinsics.checkNotNullParameter(textFieldValue, "<this>");
        return textFieldValue.getText().subSequence(TextRange.m3500getMaximpl(textFieldValue.getSelection()), Math.min(TextRange.m3500getMaximpl(textFieldValue.getSelection()) + i10, textFieldValue.getText().length()));
    }

    @NotNull
    public static final AnnotatedString getTextBeforeSelection(@NotNull TextFieldValue textFieldValue, int i10) {
        Intrinsics.checkNotNullParameter(textFieldValue, "<this>");
        return textFieldValue.getText().subSequence(Math.max(0, TextRange.m3501getMinimpl(textFieldValue.getSelection()) - i10), TextRange.m3501getMinimpl(textFieldValue.getSelection()));
    }
}
