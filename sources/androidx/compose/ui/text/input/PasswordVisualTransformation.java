...
public final class PasswordVisualTransformation implements VisualTransformation {
    ...
    public TransformedText filter(@NotNull AnnotatedString text) {
        ...
        return new TransformedText(new AnnotatedString(StringsKt.S(String.valueOf(this.mask), text.getText().length()), null, null, 6, null), OffsetMapping.INSTANCE.getIdentity());
    }
