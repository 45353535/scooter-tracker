...
public final class AndroidDefaultTypeface implements AndroidTypeface {
    ...
    public Typeface mo3712getNativeTypefacePYhJU0U(@NotNull FontWeight fontWeight, int fontStyle, int synthesis) {
        ...
        if (Build.VERSION.SDK_INT < 28) {
            Typeface typefaceDefaultFromStyle = Typeface.defaultFromStyle(AndroidFontUtils_androidKt.m3543getAndroidTypefaceStyleFO1MlWM(fontWeight, fontStyle));
        ...
        return typefaceHelperMethodsApi28.create(DEFAULT, fontWeight.getWeight(), FontStyle.m3588equalsimpl0(fontStyle, FontStyle.INSTANCE.m3592getItalic_LCdwA()));
    }
}
