...
public final class ShaderBrushSpan extends CharacterStyle implements UpdateAppearance {
    ...
    public ShaderBrushSpan(@NotNull ShaderBrush shaderBrush, float f10) {
        ...
        this.alpha = f10;
        this.size = Size.INSTANCE.m1448getUnspecifiedNHjbRc();
    }
    ...
    public final void m3745setSizeuvyYCjk(long j10) {
        this.size = j10;
    }
    ...
    public void updateDrawState(@NotNull TextPaint textPaint) {
        ...
        if (this.size == Size.INSTANCE.m1448getUnspecifiedNHjbRc()) {
            return;
        }
        Pair<Size, ? extends Shader> pair = this.cachedShader;
        Shader shaderMo1579createShaderuvyYCjk = (pair == null || !Size.m1436equalsimpl0(pair.getFirst().getPackedValue(), this.size)) ? this.shaderBrush.mo1579createShaderuvyYCjk(this.size) : pair.getSecond();
        textPaint.setShader(shaderMo1579createShaderuvyYCjk);
        this.cachedShader = TuplesKt.to(Size.m1428boximpl(this.size), shaderMo1579createShaderuvyYCjk);
    }
}
