...
public final class DrawStyleSpan extends CharacterStyle implements UpdateAppearance {
    ...
    private final Paint.Cap m3742toAndroidCapBeK7IIE(int i10) {
        StrokeCap.Companion companion = StrokeCap.INSTANCE;
        return StrokeCap.m1923equalsimpl0(i10, companion.m1927getButtKaPHkGw()) ? Paint.Cap.BUTT : StrokeCap.m1923equalsimpl0(i10, companion.m1928getRoundKaPHkGw()) ? Paint.Cap.ROUND : StrokeCap.m1923equalsimpl0(i10, companion.m1929getSquareKaPHkGw()) ? Paint.Cap.SQUARE : Paint.Cap.BUTT;
    }

    /* JADX INFO: renamed from: toAndroidJoin-Ww9F2mQ, reason: not valid java name */
    private final Paint.Join m3743toAndroidJoinWw9F2mQ(int i10) {
        StrokeJoin.Companion companion = StrokeJoin.INSTANCE;
        return StrokeJoin.m1933equalsimpl0(i10, companion.m1938getMiterLxFBmk8()) ? Paint.Join.MITER : StrokeJoin.m1933equalsimpl0(i10, companion.m1939getRoundLxFBmk8()) ? Paint.Join.ROUND : StrokeJoin.m1933equalsimpl0(i10, companion.m1937getBevelLxFBmk8()) ? Paint.Join.BEVEL : Paint.Join.MITER;
    }
    ...
    public void updateDrawState(@Nullable TextPaint textPaint) {
        if (textPaint != null) {
            ...
            if (drawStyle instanceof Stroke) {
                ...
                textPaint.setStrokeJoin(m3743toAndroidJoinWw9F2mQ(((Stroke) this.drawStyle).getJoin()));
                textPaint.setStrokeCap(m3742toAndroidCapBeK7IIE(((Stroke) this.drawStyle).getCap()));
