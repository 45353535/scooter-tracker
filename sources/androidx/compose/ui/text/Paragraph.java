...
public interface Paragraph {
    ...
    int mo3368getOffsetForPositionk4lQ0M(long position);
    ...
    long mo3369getWordBoundaryjx7JFs(int offset);

    boolean isLineEllipsized(int lineIndex);

    @ExperimentalTextApi
    /* JADX INFO: renamed from: paint-LG529CI */
    void mo3370paintLG529CI(@NotNull Canvas canvas, long color, @Nullable Shadow shadow, @Nullable TextDecoration textDecoration, @Nullable DrawStyle drawStyle, int blendMode);

    /* JADX INFO: renamed from: paint-RPmYEkk */
    void mo3371paintRPmYEkk(@NotNull Canvas canvas, long color, @Nullable Shadow shadow, @Nullable TextDecoration textDecoration);

    @ExperimentalTextApi
    /* JADX INFO: renamed from: paint-hn5TExg */
    void mo3372painthn5TExg(@NotNull Canvas canvas, @NotNull Brush brush, float alpha, @Nullable Shadow shadow, @Nullable TextDecoration textDecoration, @Nullable DrawStyle drawStyle, int blendMode);
}
