...
public final class TextLayoutInput {
    ...
    public static /* synthetic */ TextLayoutInput m3469copyhu1Yfo$default(TextLayoutInput textLayoutInput, AnnotatedString annotatedString, TextStyle textStyle, List list, int i10, boolean z10, int i11, Density density, LayoutDirection layoutDirection, Font.ResourceLoader resourceLoader, long j10, int i12, Object obj) {
        if ((i12 & 1) != 0) {
        ...
        boolean z11 = z10;
        List list2 = list;
        return textLayoutInput.m3470copyhu1Yfo(annotatedString, textStyle, list2, i10, z11, i13, density2, layoutDirection2, resourceLoader2, j11);
    }
    ...
    public int hashCode() {
        return (((((((((((((((((this.text.hashCode() * 31) + this.style.hashCode()) * 31) + this.placeholders.hashCode()) * 31) + this.maxLines) * 31) + c.a(this.softWrap)) * 31) + TextOverflow.m3898hashCodeimpl(this.overflow)) * 31) + this.density.hashCode()) * 31) + this.layoutDirection.hashCode()) * 31) + this.fontFamilyResolver.hashCode()) * 31) + Constraints.m3922hashCodeimpl(this.constraints);
    }

    @NotNull
    public String toString() {
        return "TextLayoutInput(text=" + ((Object) this.text) + ", style=" + this.style + ", placeholders=" + this.placeholders + ", maxLines=" + this.maxLines + ", softWrap=" + this.softWrap + ", overflow=" + ((Object) TextOverflow.m3899toStringimpl(this.overflow)) + ", density=" + this.density + ", layoutDirection=" + this.layoutDirection + ", fontFamilyResolver=" + this.fontFamilyResolver + ", constraints=" + ((Object) Constraints.m3924toStringimpl(this.constraints)) + ')';
    }
