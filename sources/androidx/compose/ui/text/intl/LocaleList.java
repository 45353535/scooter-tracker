...
public final class LocaleList implements Collection<Locale>, a, j$.util.Collection {
    ...
    public LocaleList(@NotNull String languageTags) {
        ...
        List listSplit$default = StringsKt.split$default(languageTags, new String[]{StringUtils.COMMA}, false, 0, 6, null);
        ArrayList arrayList = new ArrayList(listSplit$default.size());
        int size = listSplit$default.size();
        for (int i10 = 0; i10 < size; i10++) {
            arrayList.add(StringsKt.v1((String) listSplit$default.get(i10)).toString());
        }
