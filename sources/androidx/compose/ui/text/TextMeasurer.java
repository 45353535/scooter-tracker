...
public final class TextMeasurer {
    ...
    public static final class Companion {
        ...
        public final TextLayoutResult layout(TextLayoutInput textLayoutInput) {
            ...
            int iM3921getMinWidthimpl = Constraints.m3921getMinWidthimpl(textLayoutInput.getConstraints());
            int iM3919getMaxWidthimpl = ((textLayoutInput.getSoftWrap() || TextOverflow.m3897equalsimpl0(textLayoutInput.getOverflow(), TextOverflow.INSTANCE.m3905getEllipsisgIe3tQ8())) && Constraints.m3915getHasBoundedWidthimpl(textLayoutInput.getConstraints())) ? Constraints.m3919getMaxWidthimpl(textLayoutInput.getConstraints()) : Integer.MAX_VALUE;
            int maxLines = (textLayoutInput.getSoftWrap() || !TextOverflow.m3897equalsimpl0(textLayoutInput.getOverflow(), TextOverflow.INSTANCE.m3905getEllipsisgIe3tQ8())) ? textLayoutInput.getMaxLines() : 1;
            if (iM3921getMinWidthimpl != iM3919getMaxWidthimpl) {
                iM3919getMaxWidthimpl = g.n(ParagraphKt.ceilToInt(multiParagraphIntrinsics.getMaxIntrinsicWidth()), iM3921getMinWidthimpl, iM3919getMaxWidthimpl);
            }
            return new TextLayoutResult(textLayoutInput, new MultiParagraph(multiParagraphIntrinsics, ConstraintsKt.Constraints$default(0, iM3919getMaxWidthimpl, 0, Constraints.m3918getMaxHeightimpl(textLayoutInput.getConstraints()), 5, null), maxLines, TextOverflow.m3897equalsimpl0(textLayoutInput.getOverflow(), TextOverflow.INSTANCE.m3905getEllipsisgIe3tQ8()), null), ConstraintsKt.m3930constrain4WqzIAM(textLayoutInput.getConstraints(), IntSizeKt.IntSize((int) Math.ceil(r13.getWidth()), (int) Math.ceil(r13.getHeight()))), null);
        }
    ...
    public TextMeasurer(@NotNull FontFamily.Resolver fallbackFontFamilyResolver, @NotNull Density fallbackDensity, @NotNull LayoutDirection fallbackLayoutDirection, int i10) {
    ...
    public static /* synthetic */ TextLayoutResult m3478measurewNUYSr0$default(TextMeasurer textMeasurer, String str, TextStyle textStyle, int i10, boolean z10, int i11, long j10, LayoutDirection layoutDirection, Density density, FontFamily.Resolver resolver, boolean z11, int i12, Object obj) {
        if ((i12 & 2) != 0) {
        ...
        return textMeasurer.m3480measurewNUYSr0(str, textStyle2, i10, (i12 & 8) != 0 ? true : z10, (i12 & 16) != 0 ? Integer.MAX_VALUE : i11, (i12 & 32) != 0 ? ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null) : j10, (i12 & 64) != 0 ? textMeasurer.fallbackLayoutDirection : layoutDirection, (i12 & 128) != 0 ? textMeasurer.fallbackDensity : density, (i12 & 256) != 0 ? textMeasurer.fallbackFontFamilyResolver : resolver, (i12 & 512) != 0 ? false : z11);
    }

    /* JADX WARN: Multi-variable type inference failed */
    /* JADX INFO: renamed from: measure-xDpz5zY$default, reason: not valid java name */
    public static /* synthetic */ TextLayoutResult m3479measurexDpz5zY$default(TextMeasurer textMeasurer, AnnotatedString annotatedString, TextStyle textStyle, int i10, boolean z10, int i11, List list, long j10, LayoutDirection layoutDirection, Density density, FontFamily.Resolver resolver, boolean z11, int i12, Object obj) {
        if ((i12 & 2) != 0) {
            textStyle = TextStyle.INSTANCE.getDefault();
        }
        return textMeasurer.m3481measurexDpz5zY(annotatedString, textStyle, (i12 & 4) != 0 ? TextOverflow.INSTANCE.m3904getClipgIe3tQ8() : i10, (i12 & 8) != 0 ? true : z10, (i12 & 16) != 0 ? Integer.MAX_VALUE : i11, (i12 & 32) != 0 ? CollectionsKt.emptyList() : list, (i12 & 64) != 0 ? ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, null) : j10, (i12 & 128) != 0 ? textMeasurer.fallbackLayoutDirection : layoutDirection, (i12 & 256) != 0 ? textMeasurer.fallbackDensity : density, (i12 & 512) != 0 ? textMeasurer.fallbackFontFamilyResolver : resolver, (i12 & 1024) != 0 ? false : z11);
    }

    @Stable
    @NotNull
    /* JADX INFO: renamed from: measure-wNUYSr0, reason: not valid java name */
    public final TextLayoutResult m3480measurewNUYSr0(@NotNull String text, @NotNull TextStyle style, int overflow, boolean softWrap, int maxLines, long constraints, @NotNull LayoutDirection layoutDirection, @NotNull Density density, @NotNull FontFamily.Resolver fontFamilyResolver, boolean skipCache) {
        Intrinsics.checkNotNullParameter(text, "text");
        Intrinsics.checkNotNullParameter(style, "style");
        Intrinsics.checkNotNullParameter(layoutDirection, "layoutDirection");
        Intrinsics.checkNotNullParameter(density, "density");
        Intrinsics.checkNotNullParameter(fontFamilyResolver, "fontFamilyResolver");
        return m3479measurexDpz5zY$default(this, new AnnotatedString(text, null, null, 6, null), style, overflow, softWrap, maxLines, null, constraints, layoutDirection, density, fontFamilyResolver, skipCache, 32, null);
    }

    @Stable
    @NotNull
    /* JADX INFO: renamed from: measure-xDpz5zY, reason: not valid java name */
    public final TextLayoutResult m3481measurexDpz5zY(@NotNull AnnotatedString text, @NotNull TextStyle style, int overflow, boolean softWrap, int maxLines, @NotNull List<AnnotatedString.Range<Placeholder>> placeholders, long constraints, @NotNull LayoutDirection layoutDirection, @NotNull Density density, @NotNull FontFamily.Resolver fontFamilyResolver, boolean skipCache) {
        ...
        if (textLayoutResult != null) {
            return textLayoutResult.m3474copyO0kMr_c(textLayoutInput, ConstraintsKt.m3930constrain4WqzIAM(constraints, IntSizeKt.IntSize(ParagraphKt.ceilToInt(textLayoutResult.getMultiParagraph().getWidth()), ParagraphKt.ceilToInt(textLayoutResult.getMultiParagraph().getHeight()))));
        }
