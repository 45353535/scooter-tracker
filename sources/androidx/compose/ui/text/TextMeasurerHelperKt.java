...
public final class TextMeasurerHelperKt {
    ...
    @ExperimentalTextApi
    @NotNull
    public static final TextMeasurer rememberTextMeasurer(int i10, @Nullable Composer composer, int i11, int i12) {
        composer.startReplaceableGroup(1538166871);
        if ((i12 & 1) != 0) {
            i10 = DefaultCacheSize;
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1538166871, i11, -1, "androidx.compose.ui.text.rememberTextMeasurer (TextMeasurerHelper.kt:41)");
        }
