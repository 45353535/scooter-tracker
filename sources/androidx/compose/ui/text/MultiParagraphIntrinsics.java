...
public final class MultiParagraphIntrinsics implements ParagraphIntrinsics {
    ...
    public MultiParagraphIntrinsics(@NotNull AnnotatedString annotatedString, @NotNull TextStyle textStyle, @NotNull List<AnnotatedString.Range<Placeholder>> placeholders, @NotNull Density density, @NotNull FontFamily.Resolver resolver) {
        ...
        l lVar = l.f94211d;
        this.minIntrinsicWidth = i.b(lVar, new Function0<Float>() { // from class: androidx.compose.ui.text.MultiParagraphIntrinsics$minIntrinsicWidth$2
            {
                super(0);
            }
        ...
        this.maxIntrinsicWidth = i.b(lVar, new Function0<Float>() { // from class: androidx.compose.ui.text.MultiParagraphIntrinsics$maxIntrinsicWidth$2
            {
                super(0);
            }
    ...
    public final ParagraphStyle resolveTextDirection(ParagraphStyle style, ParagraphStyle defaultStyle) {
        ...
        if (textDirection == null) {
            return ParagraphStyle.m3409copyciSxzs0$default(style, null, defaultStyle.getTextDirection(), 0L, null, null, null, null, null, 253, null);
        }
