...
public final class TextLayout {
    ...
    public static final class Companion {
        ...
        public final StaticLayout constructStaticLayout(@NotNull CharSequence charSequence, int width, @NotNull TextPaint textPaint, int hyphenationFrequency, int lineBreakStyle, int breakStrategy, int lineBreakWordStyle) {
            ...
            return StaticLayoutFactory.create$default(StaticLayoutFactory.INSTANCE, charSequence, 0, 0, textPaint, width, null, null, 0, null, 0, 0.0f, 0.0f, 0, false, false, breakStrategy, lineBreakStyle, lineBreakWordStyle, hyphenationFrequency, null, null, 1605606, null);
        }
    ...
    public TextLayout(@NotNull CharSequence charSequence, float f10, @NotNull TextPaint textPaint, int i10, @Nullable TextUtils.TruncateAt truncateAt, int i11, float f11, @Px float f12, boolean z10, boolean z11, int i12, int i13, int i14, int i15, int i16, int i17, @Nullable int[] iArr, @Nullable int[] iArr2, @NotNull LayoutIntrinsics layoutIntrinsics) {
        ...
        try {
            ...
            if (boringMetrics == null || layoutIntrinsics.getMaxIntrinsicWidth() > f10 || z14) {
                ...
                z12 = true;
                z13 = false;
                layoutCreate = StaticLayoutFactory.INSTANCE.create(charSequence, 0, charSequence.length(), textPaint, iCeil, textDirectionHeuristic, alignment, i18, truncateAt, iCeil2, f11, f12, i17, z10, z11, i13, i14, i15, i16, iArr, iArr2);
                textPaint2 = textPaint;
            } else {
                this.isBoringLayout = true;
                layoutCreate = BoringLayoutFactory.INSTANCE.create(charSequence, textPaint, iCeil, boringMetrics, alignment, z10, z11, truncateAt, iCeil);
                textPaint2 = textPaint;
                i18 = i12;
                z12 = true;
                textDirectionHeuristic = textDirectionHeuristic2;
            ...
            this.lineCount = iMin;
            this.didExceedMaxLines = (iMin >= i18 && (layoutCreate.getEllipsisCount(iMin + (-1)) > 0 || layoutCreate.getLineEnd(iMin + (-1)) != charSequence.length())) ? z12 : z13;
            ...
            Pair lastLineMetrics = TextLayoutKt.getLastLineMetrics(this, textPaint2, textDirectionHeuristic, lineHeightSpans);
            ...
            this.layoutHelper = lf.i.b(lf.l.f94211d, new Function0<LayoutHelper>() { // from class: androidx.compose.ui.text.android.TextLayout$layoutHelper$2
                {
                    super(0);
                }
    ...
    public final int getLineVisibleEnd(int lineIndex) {
        return this.layout.getEllipsisStart(lineIndex) == 0 ? this.layout.getLineVisibleEnd(lineIndex) : this.layout.getLineStart(lineIndex) + this.layout.getEllipsisStart(lineIndex);
    }
    ...
    public /* synthetic */ TextLayout(CharSequence charSequence, float f10, TextPaint textPaint, int i10, TextUtils.TruncateAt truncateAt, int i11, float f11, float f12, boolean z10, boolean z11, int i12, int i13, int i14, int i15, int i16, int i17, int[] iArr, int[] iArr2, LayoutIntrinsics layoutIntrinsics, int i18, DefaultConstructorMarker defaultConstructorMarker) {
        ...
        float f14 = (i18 & 64) != 0 ? 1.0f : f11;
        float f15 = (i18 & 128) != 0 ? 0.0f : f12;
        ...
        this(charSequence2, f13, textPaint2, i19, truncateAt2, i20, f14, f15, z12, z13, i21, i22, i23, i24, i25, i26, iArr3, iArr4, layoutIntrinsics2);
    }
}
