...
final /* data */ class ColorStyle implements TextForegroundStyle {
    ...
    public static /* synthetic */ ColorStyle m3761copy8_81llA$default(ColorStyle colorStyle, long j10, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            j10 = colorStyle.value;
        }
        return colorStyle.m3763copy8_81llA(j10);
    }
    ...
    public final ColorStyle m3763copy8_81llA(long value) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return (other instanceof ColorStyle) && Color.m1605equalsimpl0(this.value, ((ColorStyle) other).value);
    }

    @Override // androidx.compose.ui.text.style.TextForegroundStyle
    public float getAlpha() {
        return Color.m1606getAlphaimpl(mo3760getColor0d7_KjU());
    }
    ...
    public final long m3764getValue0d7_KjU() {
        return this.value;
    }

    public int hashCode() {
        return Color.m1611hashCodeimpl(this.value);
    }
    ...
    public String toString() {
        return "ColorStyle(value=" + ((Object) Color.m1612toStringimpl(this.value)) + ')';
    }
