...
public final class InputModeManagerImpl implements InputModeManager {
    ...
    public int mo2191getInputModeaOaMEAU() {
    ...
    public boolean mo2192requestInputModeiuPiT84(int inputMode) {
        return this.onRequestInputModeChange.invoke(InputMode.m2182boximpl(inputMode)).booleanValue();
    }

    /* JADX INFO: renamed from: setInputMode-iuPiT84, reason: not valid java name */
    public void m2193setInputModeiuPiT84(int i10) {
        this.inputMode.setValue(InputMode.m2182boximpl(i10));
    }

    /* JADX WARN: Multi-variable type inference failed */
    private InputModeManagerImpl(int i10, Function1<? super InputMode, Boolean> function1) {
        this.onRequestInputModeChange = function1;
        this.inputMode = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(InputMode.m2182boximpl(i10), null, 2, null);
    }
}
