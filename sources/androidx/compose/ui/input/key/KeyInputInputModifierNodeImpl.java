...
public final class KeyInputInputModifierNodeImpl extends Modifier.Node implements KeyInputModifierNode {
    ...
    public boolean mo2799onKeyEventZmokQxo(@NotNull android.view.KeyEvent event) {
        Intrinsics.checkNotNullParameter(event, "event");
        Function1<? super KeyEvent, Boolean> function1 = this.onEvent;
        if (function1 != null) {
            return function1.invoke(KeyEvent.m2775boximpl(event)).booleanValue();
        }
        return false;
    }
    ...
    public boolean mo2800onPreKeyEventZmokQxo(@NotNull android.view.KeyEvent event) {
        Intrinsics.checkNotNullParameter(event, "event");
