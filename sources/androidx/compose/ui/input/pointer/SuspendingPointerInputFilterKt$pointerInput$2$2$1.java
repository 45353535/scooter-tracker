...
final class SuspendingPointerInputFilterKt$pointerInput$2$2$1 extends k implements Function2<CoroutineScope, Continuation, Object> {
    ...
    SuspendingPointerInputFilterKt$pointerInput$2$2$1(SuspendingPointerInputFilter suspendingPointerInputFilter, Function2<? super PointerInputScope, ? super Continuation, ? extends Object> function2, Continuation continuation) {
    ...
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation continuation) {
        return ((SuspendingPointerInputFilterKt$pointerInput$2$2$1) create(coroutineScope, continuation)).invokeSuspend(Unit.f93236a);
    }
}
