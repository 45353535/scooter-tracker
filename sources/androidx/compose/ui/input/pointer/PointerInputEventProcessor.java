...
public final class PointerInputEventProcessor {
    ...
    public static /* synthetic */ int m2924processBIzXfog$default(PointerInputEventProcessor pointerInputEventProcessor, PointerInputEvent pointerInputEvent, PositionCalculator positionCalculator, boolean z10, int i10, Object obj) {
        if ((i10 & 4) != 0) {
            z10 = true;
        }
        return pointerInputEventProcessor.m2925processBIzXfog(pointerInputEvent, positionCalculator, z10);
    }
    ...
    public final int m2925processBIzXfog(@NotNull PointerInputEvent pointerEvent, @NotNull PositionCalculator positionCalculator, boolean isInBounds) {
        boolean z10;
        ...
        try {
            ...
            for (PointerInputChange pointerInputChange2 : internalPointerEventProduce.getChanges().values()) {
                if (z10 || PointerEventKt.changedToDownIgnoreConsumed(pointerInputChange2)) {
                    LayoutNode.m3122hitTestM_7yMNQ$ui_release$default(this.root, pointerInputChange2.getPosition(), this.hitResult, PointerType.m2964equalsimpl0(pointerInputChange2.getType(), PointerType.INSTANCE.m2971getTouchT8wyACA()), false, 8, null);
                    if (!this.hitResult.isEmpty()) {
                        this.hitPathTracker.m2837addHitPathKNwqfcY(pointerInputChange2.getId(), this.hitResult);
            ...
            int iProcessResult = PointerInputEventProcessorKt.ProcessResult(zDispatchChanges, z11);
