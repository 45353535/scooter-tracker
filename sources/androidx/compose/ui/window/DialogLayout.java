...
final class DialogLayout extends AbstractComposeView implements DialogWindowProvider {
    ...
    public DialogLayout(@NotNull Context context, @NotNull Window window) {
        ...
        this.window = window;
        this.content = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(ComposableSingletons$AndroidDialog_androidKt.INSTANCE.m4192getLambda1$ui_release(), null, 2, null);
    }
    ...
    public void Content(@Nullable Composer composer, final int i10) {
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.ui.window.DialogLayout.Content.4
            ...
            public final void invoke(@Nullable Composer composer2, int i11) {
                DialogLayout.this.Content(composer2, RecomposeScopeImplKt.updateChangedFlags(i10 | 1));
            }
        });
    }
