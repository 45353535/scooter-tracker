...
public final class AlignmentOffsetPositionProvider implements PopupPositionProvider {
    ...
    public long mo807calculatePositionllwVHH4(@NotNull IntRect anchorBounds, long windowSize, @NotNull LayoutDirection layoutDirection, long popupContentSize) {
        ...
        long jMo1265alignKFBX0sM = alignment.mo1265alignKFBX0sM(companion.m4116getZeroYbymL2g(), IntSizeKt.IntSize(anchorBounds.getWidth(), anchorBounds.getHeight()), layoutDirection);
        long jMo1265alignKFBX0sM2 = this.alignment.mo1265alignKFBX0sM(companion.m4116getZeroYbymL2g(), IntSizeKt.IntSize(IntSize.m4111getWidthimpl(popupContentSize), IntSize.m4110getHeightimpl(popupContentSize)), layoutDirection);
        long jIntOffset2 = IntOffsetKt.IntOffset(anchorBounds.getLeft(), anchorBounds.getTop());
        long jIntOffset3 = IntOffsetKt.IntOffset(IntOffset.m4069getXimpl(jIntOffset) + IntOffset.m4069getXimpl(jIntOffset2), IntOffset.m4070getYimpl(jIntOffset) + IntOffset.m4070getYimpl(jIntOffset2));
        long jIntOffset4 = IntOffsetKt.IntOffset(IntOffset.m4069getXimpl(jIntOffset3) + IntOffset.m4069getXimpl(jMo1265alignKFBX0sM), IntOffset.m4070getYimpl(jIntOffset3) + IntOffset.m4070getYimpl(jMo1265alignKFBX0sM));
        long jIntOffset5 = IntOffsetKt.IntOffset(IntOffset.m4069getXimpl(jMo1265alignKFBX0sM2), IntOffset.m4070getYimpl(jMo1265alignKFBX0sM2));
        ...
        long jIntOffset7 = IntOffsetKt.IntOffset(IntOffset.m4069getXimpl(this.offset) * (layoutDirection == LayoutDirection.Ltr ? 1 : -1), IntOffset.m4070getYimpl(this.offset));
        return IntOffsetKt.IntOffset(IntOffset.m4069getXimpl(jIntOffset6) + IntOffset.m4069getXimpl(jIntOffset7), IntOffset.m4070getYimpl(jIntOffset6) + IntOffset.m4070getYimpl(jIntOffset7));
    }
