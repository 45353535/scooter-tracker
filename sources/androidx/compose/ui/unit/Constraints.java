...
@Immutable
@Metadata(d1 = {"\u0000*\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\t\n\u0002\b\u0003\n\u0002\u0010\b\n\u0002\b\u0003\n\u0002\u0010\u000b\n\u0002\b!\n\u0002\u0010\u000e\n\u0002\b\u0004\b\u0087@\u0018\u0000 02\u00020\u0001:\u00010B\u0012\u0012\u0006\u0010\u0002\u001a\u00020\u0003ø\u0001\u0000¢\u0006\u0004\b\u0004\u0010\u0005J>\u0010#\u001a\u00020\u00002\b\b\u0002\u0010 \u001a\u00020\u00072\b\b\u0002\u0010\u001c\u001a\u00020\u00072\b\b\u0002\u0010\u001e\u001a\u00020\u00072\b\b\u0002\u0010\u001a\u001a\u00020\u0007ø\u0001\u0001ø\u0001\u0002ø\u0001\u0000¢\u0006\u0004\b$\u0010%J\u001a\u0010&\u001a\u00020\u000b2\b\u0010'\u001a\u0004\u0018\u00010\u0001HÖ\u0003¢\u0006\u0004\b(\u0010)J\u0010\u0010*\u001a\u00020\u0007HÖ\u0001¢\u0006\u0004\b+\u0010\tJ\u000f\u0010,\u001a\u00020-H\u0016¢\u0006\u0004\b.\u0010/R\u0014\u0010\u0006\u001a\u00020\u00078BX\u0082\u0004¢\u0006\u0006\u001a\u0004\b\b\u0010\tR\u0011\u0010\n\u001a\u00020\u000b8F¢\u0006\u0006\u001a\u0004\b\f\u0010\rR\u0011\u0010\u000e\u001a\u00020\u000b8F¢\u0006\u0006\u001a\u0004\b\u000f\u0010\rR\u001a\u0010\u0010\u001a\u00020\u000b8FX\u0087\u0004¢\u0006\f\u0012\u0004\b\u0011\u0010\u0012\u001a\u0004\b\u0013\u0010\rR\u001a\u0010\u0014\u001a\u00020\u000b8FX\u0087\u0004¢\u0006\f\u0012\u0004\b\u0015\u0010\u0012\u001a\u0004\b\u0016\u0010\rR\u001a\u0010\u0017\u001a\u00020\u000b8FX\u0087\u0004¢\u0006\f\u0012\u0004\b\u0018\u0010\u0012\u001a\u0004\b\u0019\u0010\rR\u0011\u0010\u001a\u001a\u00020\u00078F¢\u0006\u0006\u001a\u0004\b\u001b\u0010\tR\u0011\u0010\u001c\u001a\u00020\u00078F¢\u0006\u0006\u001a\u0004\b\u001d\u0010\tR\u0011\u0010\u001e\u001a\u00020\u00078F¢\u0006\u0006\u001a\u0004\b\u001f\u0010\tR\u0011\u0010 \u001a\u00020\u00078F¢\u0006\u0006\u001a\u0004\b!\u0010\tR\u0016\u0010\u0002\u001a\u00020\u00038\u0000X\u0081\u0004¢\u0006\b\n\u0000\u0012\u0004\b\"\u0010\u0012\u0088\u0001\u0002\u0092\u0001\u00020\u0003ø\u0001\u0000\u0082\u0002\u000f\n\u0002\b\u0019\n\u0002\b!\n\u0005\b¡\u001e0\u0001¨\u00061"}, d2 = {"Landroidx/compose/ui/unit/Constraints;", "", "value", "", "constructor-impl", "(J)J", "focusIndex", "", "getFocusIndex-impl", "(J)I", "hasBoundedHeight", "", "getHasBoundedHeight-impl", "(J)Z", "hasBoundedWidth", "getHasBoundedWidth-impl", "hasFixedHeight", "getHasFixedHeight$annotations", "()V", "getHasFixedHeight-impl", "hasFixedWidth", "getHasFixedWidth$annotations", "getHasFixedWidth-impl", "isZero", "isZero$annotations", "isZero-impl", "maxHeight", "getMaxHeight-impl", "maxWidth", "getMaxWidth-impl", "minHeight", "getMinHeight-impl", "minWidth", "getMinWidth-impl", "getValue$annotations", MenuActionType.COPY, "copy-Zbe2FdA", "(JIIII)J", "equals", "other", "equals-impl", "(JLjava/lang/Object;)Z", "hashCode", "hashCode-impl", "toString", "", "toString-impl", "(J)Ljava/lang/String;", y.f66058y, "ui-unit_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
public final class Constraints {
    ...
    public static final class Companion {
        ...
        public final long m3926createConstraintsZbe2FdA$ui_unit_release(int minWidth, int maxWidth, int minHeight, int maxHeight) {
            long j10;
            ...
            return Constraints.m3908constructorimpl((((long) i12) << 33) | j10 | (((long) minWidth) << 2) | (((long) minHeight) << i14) | (((long) i13) << (i14 + 31)));
        }

        @Stable
        /* JADX INFO: renamed from: fixed-JhjzzOo, reason: not valid java name */
        public final long m3927fixedJhjzzOo(int width, int height) {
            if (width >= 0 && height >= 0) {
                return m3926createConstraintsZbe2FdA$ui_unit_release(width, width, height, height);
            }
        ...
        public final long m3928fixedHeightOenEA2s(int height) {
            if (height >= 0) {
                return m3926createConstraintsZbe2FdA$ui_unit_release(0, Integer.MAX_VALUE, height, height);
            }
        ...
        public final long m3929fixedWidthOenEA2s(int width) {
            if (width >= 0) {
                return m3926createConstraintsZbe2FdA$ui_unit_release(width, width, 0, Integer.MAX_VALUE);
            }
    ...
    public static final /* synthetic */ Constraints m3907boximpl(long j10) {
        return new Constraints(j10);
    }

    /* JADX INFO: renamed from: constructor-impl, reason: not valid java name */
    public static long m3908constructorimpl(long j10) {
        return j10;
    }

    /* JADX INFO: renamed from: copy-Zbe2FdA, reason: not valid java name */
    public static final long m3909copyZbe2FdA(long j10, int i10, int i11, int i12, int i13) {
        if (i12 < 0 || i10 < 0) {
        ...
        if (i13 >= i12 || i13 == Integer.MAX_VALUE) {
            return INSTANCE.m3926createConstraintsZbe2FdA$ui_unit_release(i10, i11, i12, i13);
        }
    ...
    public static /* synthetic */ long m3910copyZbe2FdA$default(long j10, int i10, int i11, int i12, int i13, int i14, Object obj) {
        if ((i14 & 1) != 0) {
            i10 = m3921getMinWidthimpl(j10);
        }
        int i15 = i10;
        if ((i14 & 2) != 0) {
            i11 = m3919getMaxWidthimpl(j10);
        }
        int i16 = i11;
        if ((i14 & 4) != 0) {
            i12 = m3920getMinHeightimpl(j10);
        }
        int i17 = i12;
        if ((i14 & 8) != 0) {
            i13 = m3918getMaxHeightimpl(j10);
        }
        return m3909copyZbe2FdA(j10, i15, i16, i17, i13);
    }

    /* JADX INFO: renamed from: equals-impl, reason: not valid java name */
    public static boolean m3911equalsimpl(long j10, Object obj) {
        return (obj instanceof Constraints) && j10 == ((Constraints) obj).getValue();
    }

    /* JADX INFO: renamed from: equals-impl0, reason: not valid java name */
    public static final boolean m3912equalsimpl0(long j10, long j11) {
        return j10 == j11;
    }

    /* JADX INFO: renamed from: getFocusIndex-impl, reason: not valid java name */
    private static final int m3913getFocusIndeximpl(long j10) {
        return (int) (j10 & 3);
    }

    /* JADX INFO: renamed from: getHasBoundedHeight-impl, reason: not valid java name */
    public static final boolean m3914getHasBoundedHeightimpl(long j10) {
        int iM3913getFocusIndeximpl = m3913getFocusIndeximpl(j10);
        return (((int) (j10 >> (MinHeightOffsets[iM3913getFocusIndeximpl] + 31))) & HeightMask[iM3913getFocusIndeximpl]) != 0;
    }

    /* JADX INFO: renamed from: getHasBoundedWidth-impl, reason: not valid java name */
    public static final boolean m3915getHasBoundedWidthimpl(long j10) {
        return (((int) (j10 >> 33)) & WidthMask[m3913getFocusIndeximpl(j10)]) != 0;
    }
    ...
    public static final boolean m3916getHasFixedHeightimpl(long j10) {
        return m3918getMaxHeightimpl(j10) == m3920getMinHeightimpl(j10);
    }
    ...
    public static final boolean m3917getHasFixedWidthimpl(long j10) {
        return m3919getMaxWidthimpl(j10) == m3921getMinWidthimpl(j10);
    }

    /* JADX INFO: renamed from: getMaxHeight-impl, reason: not valid java name */
    public static final int m3918getMaxHeightimpl(long j10) {
        int iM3913getFocusIndeximpl = m3913getFocusIndeximpl(j10);
        int i10 = ((int) (j10 >> (MinHeightOffsets[iM3913getFocusIndeximpl] + 31))) & HeightMask[iM3913getFocusIndeximpl];
        if (i10 == 0) {
    ...
    public static final int m3919getMaxWidthimpl(long j10) {
        int i10 = ((int) (j10 >> 33)) & WidthMask[m3913getFocusIndeximpl(j10)];
        if (i10 == 0) {
            return Integer.MAX_VALUE;
        }
        return i10 - 1;
    ...
    public static final int m3920getMinHeightimpl(long j10) {
        int iM3913getFocusIndeximpl = m3913getFocusIndeximpl(j10);
        return ((int) (j10 >> MinHeightOffsets[iM3913getFocusIndeximpl])) & HeightMask[iM3913getFocusIndeximpl];
    }

    /* JADX INFO: renamed from: getMinWidth-impl, reason: not valid java name */
    public static final int m3921getMinWidthimpl(long j10) {
        return ((int) (j10 >> 2)) & WidthMask[m3913getFocusIndeximpl(j10)];
    }
    ...
    public static int m3922hashCodeimpl(long j10) {
        return b.a(j10);
    }
    ...
    public static final boolean m3923isZeroimpl(long j10) {
        return m3919getMaxWidthimpl(j10) == 0 || m3918getMaxHeightimpl(j10) == 0;
    }

    @NotNull
    /* JADX INFO: renamed from: toString-impl, reason: not valid java name */
    public static String m3924toStringimpl(long j10) {
        int iM3919getMaxWidthimpl = m3919getMaxWidthimpl(j10);
        String strValueOf = iM3919getMaxWidthimpl == Integer.MAX_VALUE ? "Infinity" : String.valueOf(iM3919getMaxWidthimpl);
        int iM3918getMaxHeightimpl = m3918getMaxHeightimpl(j10);
        return "Constraints(minWidth = " + m3921getMinWidthimpl(j10) + ", maxWidth = " + strValueOf + ", minHeight = " + m3920getMinHeightimpl(j10) + ", maxHeight = " + (iM3918getMaxHeightimpl != Integer.MAX_VALUE ? String.valueOf(iM3918getMaxHeightimpl) : "Infinity") + ')';
    }
