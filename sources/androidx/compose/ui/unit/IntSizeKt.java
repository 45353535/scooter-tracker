...
public final class IntSizeKt {
    ...
    public static final long IntSize(int i10, int i11) {
        return IntSize.m4106constructorimpl((((long) i11) & 4294967295L) | (((long) i10) << 32));
    }

    /* JADX INFO: renamed from: getCenter-ozmzZPI, reason: not valid java name */
    public static final long m4117getCenterozmzZPI(long j10) {
        return IntOffsetKt.IntOffset(IntSize.m4111getWidthimpl(j10) / 2, IntSize.m4110getHeightimpl(j10) / 2);
    }

    @Stable
    /* JADX INFO: renamed from: getCenter-ozmzZPI$annotations, reason: not valid java name */
    public static /* synthetic */ void m4118getCenterozmzZPI$annotations(long j10) {
    }

    @Stable
    /* JADX INFO: renamed from: times-O0kMr_c, reason: not valid java name */
    public static final long m4119timesO0kMr_c(int i10, long j10) {
        return IntSize.m4113timesYEO4UFw(j10, i10);
    }

    @Stable
    @NotNull
    /* JADX INFO: renamed from: toIntRect-ozmzZPI, reason: not valid java name */
    public static final IntRect m4120toIntRectozmzZPI(long j10) {
        return IntRectKt.m4101IntRectVbeCjmY(IntOffset.INSTANCE.m4079getZeronOccac(), j10);
    }

    @Stable
    /* JADX INFO: renamed from: toSize-ozmzZPI, reason: not valid java name */
    public static final long m4121toSizeozmzZPI(long j10) {
        return SizeKt.Size(IntSize.m4111getWidthimpl(j10), IntSize.m4110getHeightimpl(j10));
    }
}
