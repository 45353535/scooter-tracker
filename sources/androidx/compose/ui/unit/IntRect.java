...
public final /* data */ class IntRect {
    ...
    public static /* synthetic */ void m4087getSizeYbymL2g$annotations() {
    }
    ...
    public final boolean m4088containsgyyYBs(long offset) {
        return IntOffset.m4069getXimpl(offset) >= this.left && IntOffset.m4069getXimpl(offset) < this.right && IntOffset.m4070getYimpl(offset) >= this.top && IntOffset.m4070getYimpl(offset) < this.bottom;
    }
    ...
    public final long m4089getBottomCenternOccac() {
    ...
    public final long m4090getBottomLeftnOccac() {
    ...
    public final long m4093getCenterLeftnOccac() {
    ...
    public final long m4094getCenterRightnOccac() {
    ...
    public final long m4095getSizeYbymL2g() {
    ...
    public final long m4096getTopCenternOccac() {
    ...
    public final IntRect m4099translategyyYBs(long offset) {
        return new IntRect(this.left + IntOffset.m4069getXimpl(offset), this.top + IntOffset.m4070getYimpl(offset), this.right + IntOffset.m4069getXimpl(offset), this.bottom + IntOffset.m4070getYimpl(offset));
    }
}
