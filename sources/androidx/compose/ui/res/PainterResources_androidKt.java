...
public final class PainterResources_androidKt {
    ...
    public static final ImageBitmap loadImageBitmapResource(Resources resources, int i10) {
        return ImageResources_androidKt.imageResource(ImageBitmap.INSTANCE, resources, i10);
    }

    @Composable
    private static final ImageVector loadVectorResource(Resources.Theme theme, Resources resources, int i10, int i11, Composer composer, int i12) throws XmlPullParserException {
        composer.startReplaceableGroup(21855625);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(21855625, i12, -1, "androidx.compose.ui.res.loadVectorResource (PainterResources.android.kt:81)");
        }
    ...
    public static final Painter painterResource(@DrawableRes int i10, @Nullable Composer composer, int i11) {
        ...
        if (charSequence == null || !StringsKt.m0(charSequence, ".xml", false, 2, null)) {
            ...
            painterRememberVectorPainter = VectorPainterKt.rememberVectorPainter(loadVectorResource(theme2, resources, i10, typedValue.changingConfigurations, composer, ((i11 << 6) & 896) | 72), composer, 0);
            composer.endReplaceableGroup();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
