...
public final class SemanticsNodeKt {
    ...
    public static final SemanticsModifierNode getOuterMergingSemantics(@NotNull LayoutNode layoutNode) {
        ...
        int iM3199constructorimpl = NodeKind.m3199constructorimpl(8);
        if ((nodes.getAggregateChildKindSet() & iM3199constructorimpl) != 0) {
            head = nodes.getHead();
            while (head != 0) {
                if ((head.getKindSet() & iM3199constructorimpl) == 0 || !(head instanceof SemanticsModifierNode) || !((SemanticsModifierNode) head).getSemanticsConfiguration().getIsMergingSemanticsOfDescendants()) {
    ...
    public static final SemanticsModifierNode getOuterSemantics(@NotNull LayoutNode layoutNode) {
        ...
        if ((nodes.getAggregateChildKindSet() & iM3199constructorimpl) != 0) {
            head = nodes.getHead();
            while (head != 0) {
                if ((head.getKindSet() & iM3199constructorimpl) != 0 && (head instanceof SemanticsModifierNode)) {
                    break;
                }
                if ((head.getAggregateChildKindSet() & iM3199constructorimpl) == 0) {
                    break;
