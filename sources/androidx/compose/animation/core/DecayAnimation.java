...
public final class DecayAnimation<T, V extends AnimationVector> implements Animation<T, V> {
    ...
    public DecayAnimation(@NotNull VectorizedDecayAnimationSpec<V> animationSpec, @NotNull TwoWayConverter<T, V> typeConverter, T t10, @NotNull V initialVelocityVector) {
        ...
        for (int i10 = 0; i10 < size; i10++) {
            ...
            v11.set$animation_core_release(i10, kotlin.ranges.g.m(v11.get$animation_core_release(i10), -this.animationSpec.getAbsVelocityThreshold(), this.animationSpec.getAbsVelocityThreshold()));
        }
    }
