...
public final class KeyframesSpec<T> implements DurationBasedAnimationSpec<T> {
    ...
    public static final class KeyframesSpecConfig<T> {
        ...
        public final KeyframeEntity<T> atFraction(T t10, float f10) {
            return at(t10, zf.a.d(this.durationMillis * f10));
        }
        ...
        public boolean equals(@Nullable Object other) {
            ...
            return this.delayMillis == keyframesSpecConfig.delayMillis && this.durationMillis == keyframesSpecConfig.durationMillis && Intrinsics.areEqual(this.keyframes, keyframesSpecConfig.keyframes);
        }
