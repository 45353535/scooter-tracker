...
public final class Transition<S> {
    ...
    public final class TransitionAnimationState<T, V extends AnimationVector> implements State<T> {
        ...
        public TransitionAnimationState(Transition transition, @NotNull T t10, @NotNull V initialVelocityVector, @NotNull TwoWayConverter<T, V> typeConverter, String label) {
            ...
            this.animation = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(new TargetBasedAnimation(getAnimationSpec(), typeConverter, t10, getTargetValue(), initialVelocityVector), null, 2, null);
        ...
        if ((i11 & 91) == 18 && composerStartRestartGroup.getSkipping()) {
            ...
            if (!isSeeking()) {
                ...
                if (!Intrinsics.areEqual(s10, getCurrentState()) || isRunning() || getUpdateChildrenNeeded$animation_core_release()) {
                    ...
                    EffectsKt.LaunchedEffect(this, (Function2<? super CoroutineScope, ? super Continuation, ? extends Object>) objRememberedValue, composerStartRestartGroup, i12 | 64);
                }
            }
            if (ComposerKt.isTraceInProgress()) {
    ...
    public final void updateTarget$animation_core_release(final S s10, @Nullable Composer composer, final int i10) {
        ...
        if ((i11 & 91) == 18 && composerStartRestartGroup.getSkipping()) {
            ...
            if (!isSeeking() && !Intrinsics.areEqual(getTargetState(), s10)) {
