...
public final /* data */ class Scale {
    ...
    public static /* synthetic */ Scale m81copybnNdC4k$default(Scale scale, float f10, long j10, FiniteAnimationSpec finiteAnimationSpec, int i10, Object obj) {
        if ((i10 & 1) != 0) {
            f10 = scale.scale;
        }
        if ((i10 & 2) != 0) {
        ...
        return scale.m83copybnNdC4k(f10, j10, finiteAnimationSpec);
    }
    ...
    public final Scale m83copybnNdC4k(float scale, long transformOrigin, @NotNull FiniteAnimationSpec<Float> animationSpec) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Float.compare(this.scale, scale.scale) == 0 && TransformOrigin.m1959equalsimpl0(this.transformOrigin, scale.transformOrigin) && Intrinsics.areEqual(this.animationSpec, scale.animationSpec);
    }
    ...
    public int hashCode() {
        return (((Float.floatToIntBits(this.scale) * 31) + TransformOrigin.m1962hashCodeimpl(this.transformOrigin)) * 31) + this.animationSpec.hashCode();
    }

    @NotNull
    public String toString() {
        return "Scale(scale=" + this.scale + ", transformOrigin=" + ((Object) TransformOrigin.m1963toStringimpl(this.transformOrigin)) + ", animationSpec=" + this.animationSpec + ')';
    }
