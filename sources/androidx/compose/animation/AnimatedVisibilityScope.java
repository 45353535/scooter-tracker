...
public interface AnimatedVisibilityScope {
    ...
    public abstract /* synthetic */ class CC {
        public static Modifier a(final AnimatedVisibilityScope animatedVisibilityScope, Modifier modifier, final EnterTransition enter, final ExitTransition exit, final String label) {
            ...
            return ComposedModifierKt.composed(modifier, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.animation.AnimatedVisibilityScope$animateEnterExit$$inlined$debugInspectorInfo$1
                ...
                public final Modifier invoke(@NotNull Modifier composed, @Nullable Composer composer, int i10) {
                    ...
                    if (ComposerKt.isTraceInProgress()) {
                        ComposerKt.traceEventStart(1840112047, i10, -1, "androidx.compose.animation.AnimatedVisibilityScope.animateEnterExit.<anonymous> (AnimatedVisibility.kt:671)");
                    }
