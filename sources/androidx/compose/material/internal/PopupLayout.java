...
final class PopupLayout extends AbstractComposeView implements ViewRootForInspector, ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public PopupLayout(@Nullable Function0<Unit> function0, @NotNull String testTag, @NotNull View composeView, @NotNull Density density, @NotNull PopupPositionProvider initialPositionProvider, @NotNull UUID popupId) {
        ...
        this.canCalculatePosition = SnapshotStateKt.derivedStateOf(new Function0<Boolean>() { // from class: androidx.compose.material.internal.PopupLayout$canCalculatePosition$2
            ...
            public final Boolean invoke() {
                return Boolean.valueOf((this.this$0.getParentBounds() == null || this.this$0.m1197getPopupContentSizebOM6tXw() == null) ? false : true);
            }
        });
        float fM3951constructorimpl = Dp.m3951constructorimpl(8);
        this.maxSupportedElevation = fM3951constructorimpl;
        ...
        this.dismissOnOutsideClick = new Function2<Offset, IntRect, Boolean>() { // from class: androidx.compose.material.internal.PopupLayout$dismissOnOutsideClick$1
            ...
            public final Boolean invoke(@Nullable Offset offset, @NotNull IntRect bounds) {
                ...
                boolean z10 = false;
                if (offset != null && (Offset.m1371getXimpl(offset.getPackedValue()) < bounds.getLeft() || Offset.m1371getXimpl(offset.getPackedValue()) > bounds.getRight() || Offset.m1372getYimpl(offset.getPackedValue()) < bounds.getTop() || Offset.m1372getYimpl(offset.getPackedValue()) > bounds.getBottom())) {
                    z10 = true;
                }
        ...
        setElevation(density.mo308toPx0680j_4(fM3951constructorimpl));
        ...
        this.content = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(ComposableSingletons$ExposedDropdownMenuPopupKt.INSTANCE.m1195getLambda1$material_release(), null, 2, null);
    }
    ...
    public void Content(@Nullable Composer composer, final int i10) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1288867704, i10, -1, "androidx.compose.material.internal.PopupLayout.Content (ExposedDropdownMenuPopup.kt:301)");
        }
        ...
        scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material.internal.PopupLayout.Content.4
            ...
            public final void invoke(@Nullable Composer composer2, int i11) {
                PopupLayout.this.Content(composer2, RecomposeScopeImplKt.updateChangedFlags(i10 | 1));
            }
        });
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:26:0x007f, code lost:
        ...
        if (r5.dismissOnOutsideClick.invoke((r6.getX() == 0.0f && r6.getY() == 0.0f) ? null : androidx.compose.ui.geometry.Offset.m1360boximpl(androidx.compose.ui.geometry.OffsetKt.Offset(r5.params.x + r6.getX(), r5.params.y + r6.getY())), r0).booleanValue() != false) goto L27;
     */
    ...
    */
    public boolean onTouchEvent(@org.jetbrains.annotations.Nullable android.view.MotionEvent r6) {
        ...
        L59:
            ...
            androidx.compose.ui.geometry.Offset r1 = androidx.compose.ui.geometry.Offset.m1360boximpl(r3)
        L75:
    ...
    public final void m1198setPopupContentSizefhxjrPA(@Nullable IntSize intSize) {
    ...
    public final void updatePosition() {
        IntSize intSizeM1197getPopupContentSizebOM6tXw;
        IntRect parentBounds = getParentBounds();
        if (parentBounds == null || (intSizeM1197getPopupContentSizebOM6tXw = m1197getPopupContentSizebOM6tXw()) == null) {
            return;
        }
        long packedValue = intSizeM1197getPopupContentSizebOM6tXw.getPackedValue();
        Rect rect = this.previousWindowVisibleFrame;
        this.composeView.getWindowVisibleDisplayFrame(rect);
        IntRect intBounds = toIntBounds(rect);
        long jMo807calculatePositionllwVHH4 = this.positionProvider.mo807calculatePositionllwVHH4(parentBounds, IntSizeKt.IntSize(intBounds.getWidth(), intBounds.getHeight()), this.parentLayoutDirection, packedValue);
        this.params.x = IntOffset.m4069getXimpl(jMo807calculatePositionllwVHH4);
        this.params.y = IntOffset.m4070getYimpl(jMo807calculatePositionllwVHH4);
