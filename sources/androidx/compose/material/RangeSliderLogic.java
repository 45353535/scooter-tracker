...
final class RangeSliderLogic {
    ...
    @e(c = "androidx.compose.material.RangeSliderLogic$captureThumb$1", f = "Slider.kt", l = {1066}, m = "invokeSuspend")
    static final class AnonymousClass1 extends k implements Function2<CoroutineScope, Continuation, Object> {
        ...
        AnonymousClass1(boolean z10, Interaction interaction, Continuation continuation) {
    ...
    public final void captureThumb(boolean draggingStart, float posX, @NotNull Interaction interaction, @NotNull CoroutineScope scope) {
        ...
        i.d(scope, null, null, new AnonymousClass1(draggingStart, interaction, null), 3, null);
    }
