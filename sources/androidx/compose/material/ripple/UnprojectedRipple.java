...
final class UnprojectedRipple extends RippleDrawable {
    ...
    private final long m1220calculateRippleColor5vOe2sY(long color, float alpha) {
        if (Build.VERSION.SDK_INT < 28) {
            alpha *= 2;
        }
        return Color.m1603copywmQWz5c$default(color, g.i(alpha, 1.0f), 0.0f, 0.0f, 0.0f, 14, null);
    }
    ...
    public final void m1221setColorDxMtmZc(long color, float alpha) {
        long jM1220calculateRippleColor5vOe2sY = m1220calculateRippleColor5vOe2sY(color, alpha);
        Color color2 = this.rippleColor;
        if (color2 == null ? false : Color.m1605equalsimpl0(color2.m1614unboximpl(), jM1220calculateRippleColor5vOe2sY)) {
            return;
        }
        this.rippleColor = Color.m1594boximpl(jM1220calculateRippleColor5vOe2sY);
        setColor(ColorStateList.valueOf(ColorKt.m1658toArgb8_81llA(jM1220calculateRippleColor5vOe2sY)));
    }
