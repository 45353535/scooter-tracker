...
public final class AndroidRippleIndicationInstance extends RippleIndicationInstance implements RememberObserver {
    ...
    public void addRipple(@NotNull PressInteraction.Press interaction, @NotNull CoroutineScope scope) {
        ...
        rippleHostView.m1213addRippleKOepWvA(interaction, this.bounded, this.rippleSize, this.rippleRadius, this.color.getValue().m1614unboximpl(), this.rippleAlpha.getValue().getPressedAlpha(), this.onInvalidateRipple);
    ...
    public void drawIndication(@NotNull ContentDrawScope contentDrawScope) {
        ...
        this.rippleSize = contentDrawScope.mo2040getSizeNHjbRc();
        this.rippleRadius = Float.isNaN(this.radius) ? zf.a.d(RippleAnimationKt.m1211getRippleEndRadiuscSwnlzA(contentDrawScope, this.bounded, contentDrawScope.mo2040getSizeNHjbRc())) : contentDrawScope.mo302roundToPx0680j_4(this.radius);
        ...
        if (rippleHostView != null) {
            rippleHostView.m1214updateRipplePropertiesbiQXAtU(contentDrawScope.mo2040getSizeNHjbRc(), this.rippleRadius, jM1614unboximpl, pressedAlpha);
    ...
    private AndroidRippleIndicationInstance(boolean z10, float f10, State<Color> state, State<RippleAlpha> state2, RippleContainer rippleContainer) {
        ...
        this.rippleSize = Size.INSTANCE.m1449getZeroNHjbRc();
        this.rippleRadius = -1;
