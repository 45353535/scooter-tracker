...
public final class RippleAnimationKt {
    private static final float BoundedRippleExtraRadius = Dp.m3951constructorimpl(10);
    ...
    public static final float m1211getRippleEndRadiuscSwnlzA(@NotNull Density getRippleEndRadius, boolean z10, long j10) {
        Intrinsics.checkNotNullParameter(getRippleEndRadius, "$this$getRippleEndRadius");
        float fM1369getDistanceimpl = Offset.m1369getDistanceimpl(OffsetKt.Offset(Size.m1440getWidthimpl(j10), Size.m1437getHeightimpl(j10))) / 2.0f;
        return z10 ? fM1369getDistanceimpl + getRippleEndRadius.mo308toPx0680j_4(BoundedRippleExtraRadius) : fM1369getDistanceimpl;
    }

    /* JADX INFO: renamed from: getRippleStartRadius-uvyYCjk, reason: not valid java name */
    public static final float m1212getRippleStartRadiusuvyYCjk(long j10) {
        return Math.max(Size.m1440getWidthimpl(j10), Size.m1437getHeightimpl(j10)) * 0.3f;
    }
}
