...
public final class RippleKt {
    ...
    public static final AnimationSpec<Float> outgoingStateLayerAnimationSpecFor(Interaction interaction) {
        return interaction instanceof HoverInteraction.Enter ? DefaultTweenSpec : interaction instanceof FocusInteraction.Focus ? DefaultTweenSpec : interaction instanceof DragInteraction.Start ? new TweenSpec(TextFieldImplKt.AnimationDuration, 0, EasingKt.getLinearEasing(), 2, null) : DefaultTweenSpec;
    }

    @Composable
    @NotNull
    /* JADX INFO: renamed from: rememberRipple-9IZ8Weo, reason: not valid java name */
    public static final Indication m1216rememberRipple9IZ8Weo(boolean z10, float f10, long j10, @Nullable Composer composer, int i10, int i11) {
        ...
        State stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m1594boximpl(j10), composer, (i10 >> 6) & 14);
        Boolean boolValueOf = Boolean.valueOf(z10);
        Dp dpM3949boximpl = Dp.m3949boximpl(f10);
        composer.startReplaceableGroup(511388516);
        boolean zChanged = composer.changed(boolValueOf) | composer.changed(dpM3949boximpl);
