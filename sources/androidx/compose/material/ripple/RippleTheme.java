...
public interface RippleTheme {
    ...
    public static final class Companion {
        ...
        public final RippleAlpha m1217defaultRippleAlphaDxMtmZc(long contentColor, boolean lightTheme) {
            return lightTheme ? ((double) ColorKt.m1656luminance8_81llA(contentColor)) > 0.5d ? RippleThemeKt.LightThemeHighContrastRippleAlpha : RippleThemeKt.LightThemeLowContrastRippleAlpha : RippleThemeKt.DarkThemeRippleAlpha;
        }

        /* JADX INFO: renamed from: defaultRippleColor-5vOe2sY, reason: not valid java name */
        public final long m1218defaultRippleColor5vOe2sY(long contentColor, boolean lightTheme) {
            return (lightTheme || ((double) ColorKt.m1656luminance8_81llA(contentColor)) >= 0.5d) ? contentColor : Color.INSTANCE.m1641getWhite0d7_KjU();
        }
    }

    @Composable
    /* JADX INFO: renamed from: defaultColor-WaAFU9c */
    long mo1047defaultColorWaAFU9c(@Nullable Composer composer, int i10);
