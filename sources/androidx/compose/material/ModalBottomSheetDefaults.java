...
public final class ModalBottomSheetDefaults {
    ...
    private static final float Elevation = Dp.m3951constructorimpl(16);
    ...
    public final long getScrimColor(@Nullable Composer composer, int i10) {
        ...
        long jM1603copywmQWz5c$default = Color.m1603copywmQWz5c$default(MaterialTheme.INSTANCE.getColors(composer, 6).m961getOnSurface0d7_KjU(), 0.32f, 0.0f, 0.0f, 0.0f, 14, null);
        if (ComposerKt.isTraceInProgress()) {
