...
public final class TabPosition {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Dp.m3956equalsimpl0(this.left, tabPosition.left) && Dp.m3956equalsimpl0(this.width, tabPosition.width);
    }
    ...
    public final float m1152getRightD9Ej5fM() {
        return Dp.m3951constructorimpl(this.left + this.width);
    }
    ...
    public int hashCode() {
        return (Dp.m3957hashCodeimpl(this.left) * 31) + Dp.m3957hashCodeimpl(this.width);
    }

    @NotNull
    public String toString() {
        return "TabPosition(left=" + ((Object) Dp.m3962toStringimpl(this.left)) + ", right=" + ((Object) Dp.m3962toStringimpl(m1152getRightD9Ej5fM())) + ", width=" + ((Object) Dp.m3962toStringimpl(this.width)) + ')';
    }
