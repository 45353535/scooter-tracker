...
final class DefaultSliderColors implements SliderColors {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Color.m1605equalsimpl0(this.thumbColor, defaultSliderColors.thumbColor) && Color.m1605equalsimpl0(this.disabledThumbColor, defaultSliderColors.disabledThumbColor) && Color.m1605equalsimpl0(this.activeTrackColor, defaultSliderColors.activeTrackColor) && Color.m1605equalsimpl0(this.inactiveTrackColor, defaultSliderColors.inactiveTrackColor) && Color.m1605equalsimpl0(this.disabledActiveTrackColor, defaultSliderColors.disabledActiveTrackColor) && Color.m1605equalsimpl0(this.disabledInactiveTrackColor, defaultSliderColors.disabledInactiveTrackColor) && Color.m1605equalsimpl0(this.activeTickColor, defaultSliderColors.activeTickColor) && Color.m1605equalsimpl0(this.inactiveTickColor, defaultSliderColors.inactiveTickColor) && Color.m1605equalsimpl0(this.disabledActiveTickColor, defaultSliderColors.disabledActiveTickColor) && Color.m1605equalsimpl0(this.disabledInactiveTickColor, defaultSliderColors.disabledInactiveTickColor);
    }

    public int hashCode() {
        return (((((((((((((((((Color.m1611hashCodeimpl(this.thumbColor) * 31) + Color.m1611hashCodeimpl(this.disabledThumbColor)) * 31) + Color.m1611hashCodeimpl(this.activeTrackColor)) * 31) + Color.m1611hashCodeimpl(this.inactiveTrackColor)) * 31) + Color.m1611hashCodeimpl(this.disabledActiveTrackColor)) * 31) + Color.m1611hashCodeimpl(this.disabledInactiveTrackColor)) * 31) + Color.m1611hashCodeimpl(this.activeTickColor)) * 31) + Color.m1611hashCodeimpl(this.inactiveTickColor)) * 31) + Color.m1611hashCodeimpl(this.disabledActiveTickColor)) * 31) + Color.m1611hashCodeimpl(this.disabledInactiveTickColor);
    }
    ...
    public State<Color> thumbColor(boolean z10, @Nullable Composer composer, int i10) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m1594boximpl(z10 ? this.thumbColor : this.disabledThumbColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public State<Color> tickColor(boolean z10, boolean z11, @Nullable Composer composer, int i10) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m1594boximpl(z10 ? z11 ? this.activeTickColor : this.inactiveTickColor : z11 ? this.disabledActiveTickColor : this.disabledInactiveTickColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
    ...
    public State<Color> trackColor(boolean z10, boolean z11, @Nullable Composer composer, int i10) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m1594boximpl(z10 ? z11 ? this.activeTrackColor : this.inactiveTrackColor : z11 ? this.disabledActiveTrackColor : this.disabledInactiveTrackColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
