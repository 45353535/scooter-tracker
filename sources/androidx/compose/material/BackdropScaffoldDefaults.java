...
public final class BackdropScaffoldDefaults {
    ...
    private static final float PeekHeight = Dp.m3951constructorimpl(56);
    private static final float HeaderHeight = Dp.m3951constructorimpl(48);
    private static final float FrontLayerElevation = Dp.m3951constructorimpl(1);
    ...
    public final long getFrontLayerScrimColor(@Nullable Composer composer, int i10) {
        ...
        long jM1603copywmQWz5c$default = Color.m1603copywmQWz5c$default(MaterialTheme.INSTANCE.getColors(composer, 6).m966getSurface0d7_KjU(), 0.6f, 0.0f, 0.0f, 0.0f, 14, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return jM1603copywmQWz5c$default;
    }
    ...
    public final Shape getFrontLayerShape(@Nullable Composer composer, int i10) {
        ...
        float f10 = 16;
        CornerBasedShape cornerBasedShapeCopy$default = CornerBasedShape.copy$default(MaterialTheme.INSTANCE.getShapes(composer, 6).getLarge(), CornerSizeKt.m682CornerSize0680j_4(Dp.m3951constructorimpl(f10)), CornerSizeKt.m682CornerSize0680j_4(Dp.m3951constructorimpl(f10)), null, null, 12, null);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
