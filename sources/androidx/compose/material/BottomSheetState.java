...
public final class BottomSheetState {
    ...
    @Nullable
    public final Object animateTo$material_release(@NotNull BottomSheetValue bottomSheetValue, float f10, @NotNull Continuation continuation) throws Throwable {
        Object objAnimateTo = this.swipeableState.animateTo(bottomSheetValue, f10, continuation);
        return objAnimateTo == b.g() ? objAnimateTo : Unit.f93236a;
    }

    @Nullable
    public final Object collapse(@NotNull Continuation continuation) {
    ...
    @Nullable
    public final Object expand(@NotNull Continuation continuation) {
    ...
    @Nullable
    public final Object snapTo$material_release(@NotNull BottomSheetValue bottomSheetValue, @NotNull Continuation continuation) throws Throwable {
