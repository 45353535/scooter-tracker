...
public final class AppBarDefaults {
    ...
    private static final float TopAppBarElevation = Dp.m3951constructorimpl(4);
    private static final float BottomAppBarElevation = Dp.m3951constructorimpl(8);

    @NotNull
    private static final PaddingValues ContentPadding = PaddingKt.m415PaddingValuesa9UjIt4$default(AppBarKt.AppBarHorizontalPadding, 0.0f, AppBarKt.AppBarHorizontalPadding, 0.0f, 10, null);
