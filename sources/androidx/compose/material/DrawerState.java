...
public final class DrawerState {
    ...
    @ExperimentalMaterialApi
    @Nullable
    public final Object animateTo(@NotNull DrawerValue drawerValue, @NotNull AnimationSpec<Float> animationSpec, @NotNull Continuation continuation) {
    ...
    @Nullable
    public final Object close(@NotNull Continuation continuation) {
    ...
    @Nullable
    public final Object open(@NotNull Continuation continuation) {
    ...
    @Nullable
    public final Object snapTo(@NotNull DrawerValue drawerValue, @NotNull Continuation continuation) throws Throwable {
