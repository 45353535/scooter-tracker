...
public final class ElevationKt {
    ...
    public static final Object m1018animateElevationrAjV9yQ(@NotNull Animatable<Dp, ?> animatable, float f10, @Nullable Interaction interaction, @Nullable Interaction interaction2, @NotNull Continuation continuation) {
        ...
        if (animationSpecIncomingAnimationSpecForInteraction != null) {
            Object objAnimateTo$default = Animatable.animateTo$default(animatable, Dp.m3949boximpl(f10), animationSpecIncomingAnimationSpecForInteraction, null, null, continuation, 12, null);
            return objAnimateTo$default == b.g() ? objAnimateTo$default : Unit.f93236a;
        }
        Object objSnapTo = animatable.snapTo(Dp.m3949boximpl(f10), continuation);
    ...
    public static /* synthetic */ Object m1019animateElevationrAjV9yQ$default(Animatable animatable, float f10, Interaction interaction, Interaction interaction2, Continuation continuation, int i10, Object obj) {
        if ((i10 & 2) != 0) {
            interaction = null;
        }
        if ((i10 & 4) != 0) {
        ...
        return m1018animateElevationrAjV9yQ(animatable, f10, interaction, interaction2, continuation);
    }
}
