...
public final class DismissState extends SwipeableState<DismissValue> {
    ...
    @Nullable
    public final Object dismiss(@NotNull DismissDirection dismissDirection, @NotNull Continuation continuation) {
    ...
    @Nullable
    public final Object reset(@NotNull Continuation continuation) {
