...
public final class SnackbarDefaults {
    ...
    public final long getBackgroundColor(@Nullable Composer composer, int i10) {
        ...
        long jM1649compositeOverOWjLjI = ColorKt.m1649compositeOverOWjLjI(Color.m1603copywmQWz5c$default(materialTheme.getColors(composer, 6).m961getOnSurface0d7_KjU(), SnackbarOverlayAlpha, 0.0f, 0.0f, 0.0f, 14, null), materialTheme.getColors(composer, 6).m966getSurface0d7_KjU());
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return jM1649compositeOverOWjLjI;
    }

    @Composable
    public final long getPrimaryActionColor(@Nullable Composer composer, int i10) {
        long jM963getPrimaryVariant0d7_KjU;
        ...
        if (colors.isLight()) {
            jM963getPrimaryVariant0d7_KjU = ColorKt.m1649compositeOverOWjLjI(Color.m1603copywmQWz5c$default(colors.m966getSurface0d7_KjU(), 0.6f, 0.0f, 0.0f, 0.0f, 14, null), colors.m962getPrimary0d7_KjU());
        } else {
            jM963getPrimaryVariant0d7_KjU = colors.m963getPrimaryVariant0d7_KjU();
        }
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
        return jM963getPrimaryVariant0d7_KjU;
    }
}
