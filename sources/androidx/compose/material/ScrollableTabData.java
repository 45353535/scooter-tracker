...
final class ScrollableTabData {
    ...
    private final int calculateTabOffset(TabPosition tabPosition, Density density, int i10, List<TabPosition> list) {
        int iMo302roundToPx0680j_4 = density.mo302roundToPx0680j_4(((TabPosition) CollectionsKt.last((List) list)).m1152getRightD9Ej5fM()) + i10;
        int maxValue = iMo302roundToPx0680j_4 - this.scrollState.getMaxValue();
        return g.n(density.mo302roundToPx0680j_4(tabPosition.getLeft()) - ((maxValue / 2) - (density.mo302roundToPx0680j_4(tabPosition.getWidth()) / 2)), 0, g.e(iMo302roundToPx0680j_4 - maxValue, 0));
    }
