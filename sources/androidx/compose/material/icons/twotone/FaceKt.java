...
public final class FaceKt {
    ...
    public static final ImageVector getFace(@NotNull Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.Face", Dp.m3951constructorimpl(24.0f), Dp.m3951constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder2.close();
        ImageVector.Builder.m2145addPathoIyEayM$default(builder, pathBuilder2.getNodes(), defaultFillType2, "", solidColor2, 1.0f, null, 1.0f, 1.0f, iM1927getButtKaPHkGw2, iM1937getBevelLxFBmk82, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
        ...
        pathBuilder3.arcToRelative(1.25f, 1.25f, 0.0f, true, true, -2.5f, 0.0f);
        ImageVector.Builder.m2145addPathoIyEayM$default(builder, pathBuilder3.getNodes(), defaultFillType3, "", solidColor3, 1.0f, null, 1.0f, 1.0f, iM1927getButtKaPHkGw3, iM1937getBevelLxFBmk83, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
