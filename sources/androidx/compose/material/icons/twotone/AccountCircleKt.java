...
public final class AccountCircleKt {
    ...
    public static final ImageVector getAccountCircle(@NotNull Icons.TwoTone twoTone) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("TwoTone.AccountCircle", Dp.m3951constructorimpl(24.0f), Dp.m3951constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder3.close();
        ImageVector imageVectorBuild = ImageVector.Builder.m2145addPathoIyEayM$default(builder, pathBuilder3.getNodes(), defaultFillType3, "", solidColor3, 1.0f, null, 1.0f, 1.0f, iM1927getButtKaPHkGw3, iM1937getBevelLxFBmk83, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null).build();
