...
public final class AccountCircleKt {
    ...
    public static final ImageVector getAccountCircle(@NotNull Icons.Outlined outlined) {
        ...
        ImageVector.Builder builder = new ImageVector.Builder("Outlined.AccountCircle", Dp.m3951constructorimpl(24.0f), Dp.m3951constructorimpl(24.0f), 24.0f, 24.0f, 0L, 0, false, 224, null);
        ...
        pathBuilder.close();
        ImageVector.Builder.m2145addPathoIyEayM$default(builder, pathBuilder.getNodes(), defaultFillType, "", solidColor, 1.0f, null, 1.0f, 1.0f, iM1927getButtKaPHkGw, iM1937getBevelLxFBmk8, 1.0f, 0.0f, 0.0f, 0.0f, 14336, null);
