...
final class DefaultSwitchColors implements SwitchColors {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return Color.m1605equalsimpl0(this.checkedThumbColor, defaultSwitchColors.checkedThumbColor) && Color.m1605equalsimpl0(this.checkedTrackColor, defaultSwitchColors.checkedTrackColor) && Color.m1605equalsimpl0(this.uncheckedThumbColor, defaultSwitchColors.uncheckedThumbColor) && Color.m1605equalsimpl0(this.uncheckedTrackColor, defaultSwitchColors.uncheckedTrackColor) && Color.m1605equalsimpl0(this.disabledCheckedThumbColor, defaultSwitchColors.disabledCheckedThumbColor) && Color.m1605equalsimpl0(this.disabledCheckedTrackColor, defaultSwitchColors.disabledCheckedTrackColor) && Color.m1605equalsimpl0(this.disabledUncheckedThumbColor, defaultSwitchColors.disabledUncheckedThumbColor) && Color.m1605equalsimpl0(this.disabledUncheckedTrackColor, defaultSwitchColors.disabledUncheckedTrackColor);
    }

    public int hashCode() {
        return (((((((((((((Color.m1611hashCodeimpl(this.checkedThumbColor) * 31) + Color.m1611hashCodeimpl(this.checkedTrackColor)) * 31) + Color.m1611hashCodeimpl(this.uncheckedThumbColor)) * 31) + Color.m1611hashCodeimpl(this.uncheckedTrackColor)) * 31) + Color.m1611hashCodeimpl(this.disabledCheckedThumbColor)) * 31) + Color.m1611hashCodeimpl(this.disabledCheckedTrackColor)) * 31) + Color.m1611hashCodeimpl(this.disabledUncheckedThumbColor)) * 31) + Color.m1611hashCodeimpl(this.disabledUncheckedTrackColor);
    }
    ...
    public State<Color> thumbColor(boolean z10, boolean z11, @Nullable Composer composer, int i10) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m1594boximpl(z10 ? z11 ? this.checkedThumbColor : this.uncheckedThumbColor : z11 ? this.disabledCheckedThumbColor : this.disabledUncheckedThumbColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public State<Color> trackColor(boolean z10, boolean z11, @Nullable Composer composer, int i10) {
        ...
        State<Color> stateRememberUpdatedState = SnapshotStateKt.rememberUpdatedState(Color.m1594boximpl(z10 ? z11 ? this.checkedTrackColor : this.uncheckedTrackColor : z11 ? this.disabledCheckedTrackColor : this.disabledUncheckedTrackColor), composer, 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
