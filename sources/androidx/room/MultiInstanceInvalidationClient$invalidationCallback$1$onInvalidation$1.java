...
final class MultiInstanceInvalidationClient$invalidationCallback$1$onInvalidation$1 extends kotlin.coroutines.jvm.internal.k implements Function2<CoroutineScope, Continuation, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i10 == 0) {
            ...
            Set<String> of2 = SetsKt.setOf(Arrays.copyOf(strArr, strArr.length));
            MutableSharedFlow mutableSharedFlow = this.this$0.invalidatedTables;
            this.L$0 = of2;
            this.label = 1;
            if (mutableSharedFlow.emit(of2, this) == objG) {
                return objG;
            }
            set = of2;
        } else {
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation continuation) {
        return ((MultiInstanceInvalidationClient$invalidationCallback$1$onInvalidation$1) create(coroutineScope, continuation)).invokeSuspend(Unit.f93236a);
    }
}
