...
public final class EntityUpsertAdapter<T> {
    ...
    private final void checkUniquenessException(SQLException ex) {
        ...
        if (!StringsKt.e0(message, ErrorMsg, true) && !StringsKt.g0(message, SQLITE_CONSTRAINT_UNIQUE, false, 2, null) && !StringsKt.g0(message, SQLITE_CONSTRAINT_PRIMARYKEY, false, 2, null)) {
            throw ex;
        }
    }

    public final void upsert(@NotNull SQLiteConnection connection, @Nullable T entity) throws Exception {
    ...
    public final long upsertAndReturnId(@NotNull SQLiteConnection connection, @Nullable T entity) throws Exception {
        Intrinsics.checkNotNullParameter(connection, "connection");
        try {
    ...
    @NotNull
    public final long[] upsertAndReturnIdsArray(@NotNull SQLiteConnection connection, @Nullable T[] entities) throws Exception {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            try {
                jInsertAndReturnId = this.entityInsertAdapter.insertAndReturnId(connection, entities[i10]);
            } catch (SQLException e10) {
                checkUniquenessException(e10);
    ...
    @NotNull
    public final Long[] upsertAndReturnIdsArrayBox(@NotNull SQLiteConnection connection, @Nullable T[] entities) throws Exception {
        long jInsertAndReturnId;
        Intrinsics.checkNotNullParameter(connection, "connection");
        if (entities == null) {
            return new Long[0];
    ...
    @NotNull
    public final List<Long> upsertAndReturnIdsList(@NotNull SQLiteConnection connection, @Nullable T[] entities) throws Exception {
        Intrinsics.checkNotNullParameter(connection, "connection");
        if (entities == null) {
        ...
        for (T t10 : entities) {
            try {
                listCreateListBuilder.add(Long.valueOf(this.entityInsertAdapter.insertAndReturnId(connection, t10)));
            } catch (SQLException e10) {
                checkUniquenessException(e10);
    ...
    public final void upsert(@NotNull SQLiteConnection connection, @Nullable T[] entities) throws Exception {
        Intrinsics.checkNotNullParameter(connection, "connection");
        if (entities == null) {
            return;
        }
        for (T t10 : entities) {
            try {
                this.entityInsertAdapter.insert(connection, t10);
            } catch (SQLException e10) {
                checkUniquenessException(e10);
                this.updateAdapter.handle(connection, t10);
            }
    ...
    @NotNull
    public final long[] upsertAndReturnIdsArray(@NotNull SQLiteConnection connection, @Nullable Collection<? extends T> entities) throws Exception {
        long jInsertAndReturnId;
        Intrinsics.checkNotNullParameter(connection, "connection");
        if (entities == null) {
            return new long[0];
        ...
        for (int i10 = 0; i10 < size; i10++) {
            try {
                jInsertAndReturnId = this.entityInsertAdapter.insertAndReturnId(connection, (T) CollectionsKt.elementAt(entities, i10));
            } catch (SQLException e10) {
                checkUniquenessException(e10);
                this.updateAdapter.handle(connection, (T) CollectionsKt.elementAt(entities, i10));
                jInsertAndReturnId = -1;
            }
            jArr[i10] = jInsertAndReturnId;
        }
    ...
    @NotNull
    public final Long[] upsertAndReturnIdsArrayBox(@NotNull SQLiteConnection connection, @Nullable Collection<? extends T> entities) throws Exception {
        long jInsertAndReturnId;
        Intrinsics.checkNotNullParameter(connection, "connection");
        if (entities == null) {
            return new Long[0];
    ...
    public final void upsert(@NotNull SQLiteConnection connection, @Nullable Iterable<? extends T> entities) throws Exception {
        Intrinsics.checkNotNullParameter(connection, "connection");
        if (entities == null) {
            return;
        }
    ...
    @NotNull
    public final List<Long> upsertAndReturnIdsList(@NotNull SQLiteConnection connection, @Nullable Collection<? extends T> entities) throws Exception {
        Intrinsics.checkNotNullParameter(connection, "connection");
        if (entities == null) {
            return CollectionsKt.emptyList();
        }
