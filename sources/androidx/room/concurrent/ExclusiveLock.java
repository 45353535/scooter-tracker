...
public final class ExclusiveLock {
    ...
    public ExclusiveLock(@NotNull String filename, boolean z10) {
        ...
        this.fileLock = z10 ? companion.getFileLock(filename) : null;
    }
