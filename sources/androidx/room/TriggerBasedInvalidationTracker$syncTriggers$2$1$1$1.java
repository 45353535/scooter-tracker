...
@kotlin.coroutines.jvm.internal.e(c = "androidx.room.TriggerBasedInvalidationTracker$syncTriggers$2$1$1$1", f = "InvalidationTracker.kt", l = {318, Sdk.SDKError.Reason.SILENT_MODE_MONITOR_ERROR_VALUE}, m = "invokeSuspend")
final class TriggerBasedInvalidationTracker$syncTriggers$2$1$1$1 extends kotlin.coroutines.jvm.internal.k implements Function2<TransactionScope<Unit>, Continuation, Object> {
    ...
    public final Object invoke(TransactionScope<Unit> transactionScope, Continuation continuation) {
        return ((TriggerBasedInvalidationTracker$syncTriggers$2$1$1$1) create(transactionScope, continuation)).invokeSuspend(Unit.f93236a);
    }
