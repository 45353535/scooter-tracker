...
public abstract class EntityDeleteOrUpdateAdapter<T> {
    ...
    public final int handle(@NotNull SQLiteConnection connection, @Nullable T entity) throws Exception {
    ...
    public final int handleMultiple(@NotNull SQLiteConnection connection, @Nullable Iterable<? extends T> entities) throws Exception {
        Intrinsics.checkNotNullParameter(connection, "connection");
    ...
    public final int handleMultiple(@NotNull SQLiteConnection connection, @Nullable T[] entities) throws Exception {
        Intrinsics.checkNotNullParameter(connection, "connection");
        int totalChangedRows = 0;
        if (entities == null) {
            return 0;
