...
public final class Room {
    ...
    public static final <T extends RoomDatabase> RoomDatabase.Builder<T> databaseBuilder(@NotNull Context context, @NotNull Class<T> klass, @Nullable String name) {
        ...
        if (name == null || StringsKt.y0(name)) {
    ...
    public static /* synthetic */ RoomDatabase.Builder databaseBuilder$default(Room room, Context context, String name, Function0 factory, int i10, Object obj) {
        ...
        return new RoomDatabase.Builder(v0.b(RoomDatabase.class), name, factory, context);
    }
    ...
    public static /* synthetic */ RoomDatabase.Builder inMemoryDatabaseBuilder$default(Room room, Context context, Function0 factory, int i10, Object obj) {
        ...
        Intrinsics.checkNotNullParameter(factory, "factory");
        Intrinsics.reifiedOperationMarker(4, "T");
        return new RoomDatabase.Builder(v0.b(RoomDatabase.class), null, factory, context);
    }
