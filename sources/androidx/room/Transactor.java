...
public interface Transactor extends PooledConnection {
    ...
    public static final class SQLiteTransactionType {
        ...
        static {
            ...
            $ENTRIES = qf.a.a(sQLiteTransactionTypeArr$values);
        }
    ...
    @Nullable
    Object inTransaction(@NotNull Continuation continuation);

    @Nullable
    <R> Object withTransaction(@NotNull SQLiteTransactionType sQLiteTransactionType, @NotNull Function2<? super TransactionScope<R>, ? super Continuation, ? extends Object> function2, @NotNull Continuation continuation);
}
