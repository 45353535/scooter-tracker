...
public final class DBUtil {
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    @Nullable
    public static final <R> Object performInTransactionSuspending(@NotNull RoomDatabase roomDatabase, @NotNull Function1<? super Continuation, ? extends Object> function1, @NotNull Continuation continuation) {
        return DBUtil__DBUtil_androidKt.performInTransactionSuspending(roomDatabase, function1, continuation);
    }

    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    @Nullable
    public static final <R> Object performSuspending(@NotNull RoomDatabase roomDatabase, boolean z10, boolean z11, @NotNull Function1<? super SQLiteConnection, ? extends R> function1, @NotNull Continuation continuation) {
