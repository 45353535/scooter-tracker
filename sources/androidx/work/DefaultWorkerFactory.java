...
public final class DefaultWorkerFactory extends WorkerFactory {
    ...
    public Void m4257createWorker(@NotNull Context appContext, @NotNull String workerClassName, @NotNull WorkerParameters workerParameters) {
    ...
    public /* bridge */ /* synthetic */ ListenableWorker createWorker(Context context, String str, WorkerParameters workerParameters) {
        return (ListenableWorker) m4257createWorker(context, str, workerParameters);
    }
}
