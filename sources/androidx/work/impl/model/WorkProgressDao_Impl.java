...
@Metadata(d1 = {"\u00002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0004\u0018\u0000 \u00122\u00020\u0001:\u0001\u0012B\u000f\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0004\b\u0004\u0010\u0005J\u0010\u0010\t\u001a\u00020\n2\u0006\u0010\u000b\u001a\u00020\bH\u0016J\u0012\u0010\f\u001a\u0004\u0018\u00010\r2\u0006\u0010\u000e\u001a\u00020\u000fH\u0016J\u0010\u0010\u0010\u001a\u00020\n2\u0006\u0010\u000e\u001a\u00020\u000fH\u0016J\b\u0010\u0011\u001a\u00020\nH\u0016R\u000e\u0010\u0002\u001a\u00020\u0003X\u0082\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\u0006\u001a\b\u0012\u0004\u0012\u00020\b0\u0007X\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0013"}, d2 = {"Landroidx/work/impl/model/WorkProgressDao_Impl;", "Landroidx/work/impl/model/WorkProgressDao;", "__db", "Landroidx/room/RoomDatabase;", "<init>", "(Landroidx/room/RoomDatabase;)V", "__insertAdapterOfWorkProgress", "Landroidx/room/EntityInsertAdapter;", "Landroidx/work/impl/model/WorkProgress;", "insert", "", "progress", "getProgressForWorkSpecId", "Landroidx/work/Data;", "workSpecId", "", "delete", "deleteAll", com.taurusx.tax.f.y.f66058y, "work-runtime_release"}, k = 1, mv = {2, 1, 0}, xi = 48)
public final class WorkProgressDao_Impl implements WorkProgressDao {
    ...
    public WorkProgressDao_Impl(@NotNull RoomDatabase __db) {
        ...
        this.__insertAdapterOfWorkProgress = new EntityInsertAdapter<WorkProgress>() { // from class: androidx.work.impl.model.WorkProgressDao_Impl.1
            ...
            public void bind(SQLiteStatement statement, WorkProgress entity) {
                ...
                statement.mo4249bindBlob(2, Data.INSTANCE.toByteArrayInternalV1(entity.getProgress()));
            }
        };
    }
    ...
    public void delete(@NotNull final String workSpecId) {
        Intrinsics.checkNotNullParameter(workSpecId, "workSpecId");
        final String str = "DELETE from WorkProgress where work_spec_id=?";
        DBUtil.performBlocking(this.__db, false, true, new Function1() { // from class: androidx.work.impl.model.y
    ...
    public void deleteAll() {
        ...
        DBUtil.performBlocking(this.__db, false, true, new Function1() { // from class: androidx.work.impl.model.x
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
    ...
    @Override // androidx.work.impl.model.WorkProgressDao
    @Nullable
    public Data getProgressForWorkSpecId(@NotNull final String workSpecId) {
        Intrinsics.checkNotNullParameter(workSpecId, "workSpecId");
        final String str = "SELECT progress FROM WorkProgress WHERE work_spec_id=?";
        return (Data) DBUtil.performBlocking(this.__db, true, false, new Function1() { // from class: androidx.work.impl.model.w
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
    ...
    @Override // androidx.work.impl.model.WorkProgressDao
    public void insert(@NotNull final WorkProgress progress) {
        Intrinsics.checkNotNullParameter(progress, "progress");
        DBUtil.performBlocking(this.__db, false, true, new Function1() { // from class: androidx.work.impl.model.z
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return WorkProgressDao_Impl.insert$lambda$0(this.f5708b, progress, (SQLiteConnection) obj);
            }
        });
    }
}
