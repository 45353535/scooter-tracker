...
public final class WorkNameDao_Impl implements WorkNameDao {
    ...
    public WorkNameDao_Impl(@NotNull RoomDatabase __db) {
        ...
        this.__insertAdapterOfWorkName = new EntityInsertAdapter<WorkName>() { // from class: androidx.work.impl.model.WorkNameDao_Impl.1
            ...
            public void bind(SQLiteStatement statement, WorkName entity) {
                ...
                statement.mo4253bindText(1, entity.getName());
    ...
    @NotNull
    public List<String> getNamesForWorkSpecId(@NotNull final String workSpecId) {
        Intrinsics.checkNotNullParameter(workSpecId, "workSpecId");
        final String str = "SELECT name FROM workname WHERE work_spec_id=?";
        return (List) DBUtil.performBlocking(this.__db, true, false, new Function1() { // from class: androidx.work.impl.model.u
    ...
    @Override // androidx.work.impl.model.WorkNameDao
    @NotNull
    public List<String> getWorkSpecIdsWithName(@NotNull final String name) {
        Intrinsics.checkNotNullParameter(name, "name");
        final String str = "SELECT work_spec_id FROM workname WHERE name=?";
        return (List) DBUtil.performBlocking(this.__db, true, false, new Function1() { // from class: androidx.work.impl.model.t
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
    ...
    public void insert(@NotNull final WorkName workName) {
        ...
        DBUtil.performBlocking(this.__db, false, true, new Function1() { // from class: androidx.work.impl.model.v
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return WorkNameDao_Impl.insert$lambda$0(this.f5687b, workName, (SQLiteConnection) obj);
            }
        });
    }
}
