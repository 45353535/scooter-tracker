...
public final class SystemIdInfoDao_Impl implements SystemIdInfoDao {
    ...
    public SystemIdInfoDao_Impl(@NotNull RoomDatabase __db) {
        ...
        this.__insertAdapterOfSystemIdInfo = new EntityInsertAdapter<SystemIdInfo>() { // from class: androidx.work.impl.model.SystemIdInfoDao_Impl.1
            ...
            public void bind(SQLiteStatement statement, SystemIdInfo entity) {
                ...
                statement.mo4253bindText(1, entity.workSpecId);
                statement.mo4251bindLong(2, entity.getGeneration());
                statement.mo4251bindLong(3, entity.systemId);
            }
        };
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final SystemIdInfo getSystemIdInfo$lambda$1(String str, String str2, int i10, SQLiteConnection _connection) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final Unit removeSystemIdInfo$lambda$3(String str, String str2, int i10, SQLiteConnection _connection) {
        Intrinsics.checkNotNullParameter(_connection, "_connection");
        SQLiteStatement sQLiteStatementPrepare = _connection.prepare(str);
        try {
            sQLiteStatementPrepare.mo4253bindText(1, str2);
    ...
    public /* synthetic */ SystemIdInfo getSystemIdInfo(WorkGenerationalId workGenerationalId) {
        return n.a(this, workGenerationalId);
    }
    ...
    public List<String> getWorkSpecIds() {
        ...
        return (List) DBUtil.performBlocking(this.__db, true, false, new Function1() { // from class: androidx.work.impl.model.p
    ...
    public void insertSystemIdInfo(@NotNull final SystemIdInfo systemIdInfo) {
        ...
        DBUtil.performBlocking(this.__db, false, true, new Function1() { // from class: androidx.work.impl.model.o
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return SystemIdInfoDao_Impl.insertSystemIdInfo$lambda$0(this.f5640b, systemIdInfo, (SQLiteConnection) obj);
            }
        });
    }
    ...
    public /* synthetic */ void removeSystemIdInfo(WorkGenerationalId workGenerationalId) {
        n.b(this, workGenerationalId);
    }

    @Override // androidx.work.impl.model.SystemIdInfoDao
    @Nullable
    public SystemIdInfo getSystemIdInfo(@NotNull final String workSpecId, final int generation) {
        Intrinsics.checkNotNullParameter(workSpecId, "workSpecId");
        final String str = "SELECT * FROM SystemIdInfo WHERE work_spec_id=? AND generation=?";
        return (SystemIdInfo) DBUtil.performBlocking(this.__db, true, false, new Function1() { // from class: androidx.work.impl.model.r
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
    ...
    @Override // androidx.work.impl.model.SystemIdInfoDao
    public void removeSystemIdInfo(@NotNull final String workSpecId, final int generation) {
        Intrinsics.checkNotNullParameter(workSpecId, "workSpecId");
        final String str = "DELETE FROM SystemIdInfo where work_spec_id=? AND generation=?";
        DBUtil.performBlocking(this.__db, false, true, new Function1() { // from class: androidx.work.impl.model.q
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
    ...
    @Override // androidx.work.impl.model.SystemIdInfoDao
    public void removeSystemIdInfo(@NotNull final String workSpecId) {
        Intrinsics.checkNotNullParameter(workSpecId, "workSpecId");
        final String str = "DELETE FROM SystemIdInfo where work_spec_id=?";
        DBUtil.performBlocking(this.__db, false, true, new Function1() { // from class: androidx.work.impl.model.s
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
