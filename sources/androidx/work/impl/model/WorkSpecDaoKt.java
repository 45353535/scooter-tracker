...
@Metadata(d1 = {"\u00002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\b\u0005\u001a\u001a\u0010\u0000\u001a\n\u0012\u0006\u0012\u0004\u0018\u00010\u00020\u0001*\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005\u001a&\u0010\u0006\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00020\u00070\u0001*\u00020\u00032\u0006\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u000b\u001a&\u0010\f\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00020\u00070\u0001*\u00020\u00032\u0006\u0010\b\u001a\u00020\t2\u0006\u0010\r\u001a\u00020\u000b\u001a,\u0010\u000e\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u00020\u00070\u0001*\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u000f0\u00070\u00012\u0006\u0010\b\u001a\u00020\tH\u0000\"\u000e\u0010\u0010\u001a\u00020\u000bX\u0082T¢\u0006\u0002\n\u0000\"\u0010\u0010\u0011\u001a\u00020\u000b8\u0002X\u0083T¢\u0006\u0002\n\u0000\"\u0010\u0010\u0012\u001a\u00020\u000b8\u0002X\u0083T¢\u0006\u0002\n\u0000\"\u0010\u0010\u0013\u001a\u00020\u000b8\u0002X\u0083T¢\u0006\u0002\n\u0000¨\u0006\u0014"}, d2 = {"getWorkStatusPojoFlowDataForIds", "Lkotlinx/coroutines/flow/Flow;", "Landroidx/work/WorkInfo;", "Landroidx/work/impl/model/WorkSpecDao;", "id", "Ljava/util/UUID;", "getWorkStatusPojoFlowForName", "", "dispatcher", "Lkotlinx/coroutines/CoroutineDispatcher;", "name", "", "getWorkStatusPojoFlowForTag", s.z.f67720z, "dedup", "Landroidx/work/impl/model/WorkSpec$WorkInfoPojo;", "WORK_INFO_COLUMNS", "WORK_INFO_BY_IDS", "WORK_INFO_BY_TAG", "WORK_INFO_BY_NAME", "work-runtime_release"}, k = 2, mv = {2, 1, 0}, xi = 48)
public final class WorkSpecDaoKt {
    ...
    @NotNull
    public static final Flow dedup(@NotNull final Flow flow, @NotNull CoroutineDispatcher dispatcher) {
        Intrinsics.checkNotNullParameter(flow, "<this>");
        Intrinsics.checkNotNullParameter(dispatcher, "dispatcher");
        return hg.i.E(hg.i.p(new Flow() { // from class: androidx.work.impl.model.WorkSpecDaoKt$dedup$$inlined$map$1
            ...
            public static final class AnonymousClass2<T> implements FlowCollector {
                ...
                @Metadata(k = 3, mv = {2, 1, 0}, xi = 48)
                @kotlin.coroutines.jvm.internal.e(c = "androidx.work.impl.model.WorkSpecDaoKt$dedup$$inlined$map$1$2", f = "WorkSpecDao.kt", l = {50}, m = "emit")
    ...
    @NotNull
    public static final Flow getWorkStatusPojoFlowDataForIds(@NotNull WorkSpecDao workSpecDao, @NotNull UUID id2) {
        Intrinsics.checkNotNullParameter(workSpecDao, "<this>");
        Intrinsics.checkNotNullParameter(id2, "id");
        final Flow workStatusPojoFlowDataForIds = workSpecDao.getWorkStatusPojoFlowDataForIds(CollectionsKt.listOf(String.valueOf(id2)));
        return hg.i.p(new Flow() { // from class: androidx.work.impl.model.WorkSpecDaoKt$getWorkStatusPojoFlowDataForIds$$inlined$map$1
            ...
            public static final class AnonymousClass2<T> implements FlowCollector {
                ...
                @Metadata(k = 3, mv = {2, 1, 0}, xi = 48)
                @kotlin.coroutines.jvm.internal.e(c = "androidx.work.impl.model.WorkSpecDaoKt$getWorkStatusPojoFlowDataForIds$$inlined$map$1$2", f = "WorkSpecDao.kt", l = {50}, m = "emit")
                public static final class AnonymousClass1 extends kotlin.coroutines.jvm.internal.d {
                    Object L$0;
                    int label;
                    /* synthetic */ Object result;
    ...
    @NotNull
    public static final Flow getWorkStatusPojoFlowForName(@NotNull WorkSpecDao workSpecDao, @NotNull CoroutineDispatcher dispatcher, @NotNull String name) {
        Intrinsics.checkNotNullParameter(workSpecDao, "<this>");
        Intrinsics.checkNotNullParameter(dispatcher, "dispatcher");
    ...
    @NotNull
    public static final Flow getWorkStatusPojoFlowForTag(@NotNull WorkSpecDao workSpecDao, @NotNull CoroutineDispatcher dispatcher, @NotNull String tag) {
        Intrinsics.checkNotNullParameter(workSpecDao, "<this>");
        Intrinsics.checkNotNullParameter(dispatcher, "dispatcher");
