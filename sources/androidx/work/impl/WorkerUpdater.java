...
public final class WorkerUpdater {
    ...
    public static final Operation enqueueUniquelyNamedPeriodic(@NotNull final WorkManagerImpl workManagerImpl, @NotNull final String name, @NotNull final WorkRequest workRequest) {
        ...
        return OperationKt.launchOperation(tracer, str, serialTaskExecutor, new Function0() { // from class: androidx.work.impl.a0
    ...
    public static final Unit enqueueUniquelyNamedPeriodic$lambda$6(final WorkManagerImpl workManagerImpl, final String str, final WorkRequest workRequest) {
        Function0 function0 = new Function0() { // from class: androidx.work.impl.y
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
    ...
    private static final WorkManager.UpdateResult updateWorkImpl(Processor processor, final WorkDatabase workDatabase, Configuration configuration, final List<? extends Scheduler> list, final WorkSpec workSpec, final Set<String> set) {
        ...
        if (workSpec2.isPeriodic() ^ workSpec.isPeriodic()) {
            Function1 function1 = new Function1() { // from class: androidx.work.impl.w
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void updateWorkImpl$lambda$3(WorkDatabase workDatabase, WorkSpec workSpec, WorkSpec workSpec2, List list, String str, Set set, boolean z10) {
    ...
    public static final ListenableFuture<WorkManager.UpdateResult> updateWorkImpl(@NotNull final WorkManagerImpl workManagerImpl, @NotNull final WorkRequest workRequest) {
        ...
        SerialExecutor serialTaskExecutor = workManagerImpl.getWorkTaskExecutor().getSerialTaskExecutor();
        Intrinsics.checkNotNullExpressionValue(serialTaskExecutor, "getSerialTaskExecutor(...)");
        return ListenableFutureKt.executeAsync(serialTaskExecutor, "updateWorkImpl", new Function0() { // from class: androidx.work.impl.z
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
