...
public class WorkManagerImpl extends WorkManager {
    ...
    public static /* synthetic */ Unit a(WorkManagerImpl workManagerImpl) {
    ...
    public ListenableFuture<Long> getLastCancelAllTimeMillis() {
        ...
        return ListenableFutureKt.executeAsync(serialTaskExecutor, "getLastCancelAllTimeMillis", new Function0() { // from class: androidx.work.impl.s
    ...
    @Override // androidx.work.WorkManager
    public Flow getWorkInfoByIdFlow(UUID uuid) {
    ...
    @Override // androidx.work.WorkManager
    public Flow getWorkInfosByTagFlow(String str) {
    ...
    @Override // androidx.work.WorkManager
    public Flow getWorkInfosFlow(WorkQuery workQuery) {
    ...
    public void rescheduleEligibleWork() {
        TracerKt.traced(getConfiguration().getTracer(), "ReschedulingWork", new Function0() { // from class: androidx.work.impl.t
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return WorkManagerImpl.a(this.f5721b);
            }
        });
    }
