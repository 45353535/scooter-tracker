...
@Metadata(d1 = {"\u0000*\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0007\u001a\u0018\u0010\u0000\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H\u0002\u001a\u0010\u0010\u0006\u001a\u00020\u00012\u0006\u0010\u0002\u001a\u00020\u0003H\u0002\u001a\u0018\u0010\u0007\u001a\u00020\u00012\u0006\u0010\b\u001a\u00020\t2\u0006\u0010\u0004\u001a\u00020\u0005H\u0002\u001a\u0016\u0010\n\u001a\u00020\u000b2\u0006\u0010\f\u001a\u00020\r2\u0006\u0010\u0002\u001a\u00020\u0003\u001a\u0016\u0010\u000e\u001a\u00020\u000b2\u0006\u0010\u000f\u001a\u00020\u00052\u0006\u0010\u0002\u001a\u00020\u0003\u001a\u0016\u0010\u0010\u001a\u00020\u000b2\u0006\u0010\u0011\u001a\u00020\u00052\u0006\u0010\u0002\u001a\u00020\u0003\u001a\u0016\u0010\u0012\u001a\u00020\u00012\u0006\u0010\u0011\u001a\u00020\u00052\u0006\u0010\u0002\u001a\u00020\u0003\u001a\u000e\u0010\u0013\u001a\u00020\u000b2\u0006\u0010\u0002\u001a\u00020\u0003¨\u0006\u0014"}, d2 = {MenuActionType.CANCEL, "", "workManagerImpl", "Landroidx/work/impl/WorkManagerImpl;", "workSpecId", "", "reschedulePendingWorkers", "iterativelyCancelWorkAndDependents", "workDatabase", "Landroidx/work/impl/WorkDatabase;", "forId", "Landroidx/work/Operation;", "id", "Ljava/util/UUID;", "forTag", s.z.f67720z, "forName", "name", "forNameInline", "forAll", "work-runtime_release"}, k = 2, mv = {2, 1, 0}, xi = 48)
public final class CancelWorkRunnable {
    ...
    public static final Operation forAll(@NotNull final WorkManagerImpl workManagerImpl) {
        ...
        return OperationKt.launchOperation(tracer, "CancelAllWork", serialTaskExecutor, new Function0() { // from class: androidx.work.impl.utils.f
    ...
    public static final Unit forAll$lambda$7(final WorkManagerImpl workManagerImpl) {
        ...
        Intrinsics.checkNotNullExpressionValue(workDatabase, "getWorkDatabase(...)");
        workDatabase.runInTransaction(new Runnable() { // from class: androidx.work.impl.utils.h
    ...
    @NotNull
    public static final Operation forId(@NotNull final UUID id2, @NotNull final WorkManagerImpl workManagerImpl) {
        Intrinsics.checkNotNullParameter(id2, "id");
        Intrinsics.checkNotNullParameter(workManagerImpl, "workManagerImpl");
        Tracer tracer = workManagerImpl.getConfiguration().getTracer();
        SerialExecutor serialTaskExecutor = workManagerImpl.getWorkTaskExecutor().getSerialTaskExecutor();
        Intrinsics.checkNotNullExpressionValue(serialTaskExecutor, "getSerialTaskExecutor(...)");
        return OperationKt.launchOperation(tracer, "CancelWorkById", serialTaskExecutor, new Function0() { // from class: androidx.work.impl.utils.g
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return CancelWorkRunnable.forId$lambda$1(workManagerImpl, id2);
            }
        });
    }
    ...
    public static final Operation forName(@NotNull final String name, @NotNull final WorkManagerImpl workManagerImpl) {
        ...
        SerialExecutor serialTaskExecutor = workManagerImpl.getWorkTaskExecutor().getSerialTaskExecutor();
        Intrinsics.checkNotNullExpressionValue(serialTaskExecutor, "getSerialTaskExecutor(...)");
        return OperationKt.launchOperation(tracer, str, serialTaskExecutor, new Function0() { // from class: androidx.work.impl.utils.d
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
    ...
    public static final void forNameInline(@NotNull final String name, @NotNull final WorkManagerImpl workManagerImpl) {
        Intrinsics.checkNotNullParameter(name, "name");
        Intrinsics.checkNotNullParameter(workManagerImpl, "workManagerImpl");
        final WorkDatabase workDatabase = workManagerImpl.getWorkDatabase();
        Intrinsics.checkNotNullExpressionValue(workDatabase, "getWorkDatabase(...)");
    ...
    @NotNull
    public static final Operation forTag(@NotNull final String tag, @NotNull final WorkManagerImpl workManagerImpl) {
        ...
        SerialExecutor serialTaskExecutor = workManagerImpl.getWorkTaskExecutor().getSerialTaskExecutor();
        Intrinsics.checkNotNullExpressionValue(serialTaskExecutor, "getSerialTaskExecutor(...)");
        return OperationKt.launchOperation(tracer, str, serialTaskExecutor, new Function0() { // from class: androidx.work.impl.utils.c
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
