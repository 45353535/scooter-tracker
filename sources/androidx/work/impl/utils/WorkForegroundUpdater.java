...
public class WorkForegroundUpdater implements ForegroundUpdater {
    ...
    public ListenableFuture<Void> setForegroundAsync(final Context context, final UUID uuid, final ForegroundInfo foregroundInfo) {
        return ListenableFutureKt.executeAsync(this.mTaskExecutor.getSerialTaskExecutor(), "setForegroundAsync", new Function0() { // from class: androidx.work.impl.utils.b0
            @Override // kotlin.jvm.functions.Function0
            public final Object invoke() {
                return WorkForegroundUpdater.a(this.f5729b, uuid, foregroundInfo, context);
            }
        });
    }
}
