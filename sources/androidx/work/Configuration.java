...
public final class Configuration {
    ...
    public Configuration(@NotNull Builder builder) {
        ...
        this.workerCoroutineContext = workerContext == null ? builder.getExecutor() != null ? w0.b(executor) : o0.a() : workerContext;
    ...
    @IntRange(from = 20, to = io.appmetrica.analytics.location.impl.m.f78710e)
    ...
    public static final class Builder {
        ...
        @NotNull
        public final Builder setRemoteSessionTimeoutMillis(@IntRange(from = 0, to = RemoteWorkManager.MAX_SESSION_TIMEOUT_MILLIS) long timeoutMillis) {
            if (timeoutMillis < 0) {
                throw new IllegalArgumentException("The remote session timeout must not be negative.");
            }
            this.remoteSessionTimeoutMillis = kotlin.ranges.g.k(timeoutMillis, RemoteWorkManager.MAX_SESSION_TIMEOUT_MILLIS);
            return this;
        }
