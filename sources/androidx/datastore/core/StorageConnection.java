...
public interface StorageConnection<T> extends Closeable {
    ...
    @Nullable
    <R> Object readScope(@NotNull Function3<? super ReadScope<T>, ? super Boolean, ? super Continuation, ? extends Object> function3, @NotNull Continuation continuation);

    @Nullable
    Object writeScope(@NotNull Function2<? super WriteScope<T>, ? super Continuation, ? extends Object> function2, @NotNull Continuation continuation);
}
