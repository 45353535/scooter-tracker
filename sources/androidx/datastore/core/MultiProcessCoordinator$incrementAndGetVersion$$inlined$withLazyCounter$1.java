...
public final class MultiProcessCoordinator$incrementAndGetVersion$$inlined$withLazyCounter$1 extends k implements Function2<CoroutineScope, Continuation, Object> {
    int label;
    ...
    public final Object invokeSuspend(@NotNull Object obj) {
        ...
        d.b(obj);
        return kotlin.coroutines.jvm.internal.b.d(this.this$0.getSharedCounter().incrementAndGetValue());
    }

    @Override // kotlin.jvm.functions.Function2
    @Nullable
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation continuation) {
        return ((MultiProcessCoordinator$incrementAndGetVersion$$inlined$withLazyCounter$1) create(coroutineScope, continuation)).invokeSuspend(Unit.f93236a);
    }
}
