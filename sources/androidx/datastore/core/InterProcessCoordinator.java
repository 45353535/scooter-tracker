...
public interface InterProcessCoordinator {
    ...
    @Nullable
    <T> Object lock(@NotNull Function1<? super Continuation, ? extends Object> function1, @NotNull Continuation continuation);

    @Nullable
    <T> Object tryLock(@NotNull Function2<? super Boolean, ? super Continuation, ? extends Object> function2, @NotNull Continuation continuation);
}
