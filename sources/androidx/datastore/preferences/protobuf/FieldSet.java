...
final class FieldSet<T extends FieldDescriptorLite<T>> {
    ...
    public static <T extends FieldDescriptorLite<T>> SmallSortedMap<T, Object> cloneAllFieldsMap(SmallSortedMap<T, Object> smallSortedMap, boolean z10, boolean z11) {
        ...
        int numArrayEntries = smallSortedMap.getNumArrayEntries();
        for (int i10 = 0; i10 < numArrayEntries; i10++) {
            cloneFieldEntry(smallSortedMapNewFieldMap, smallSortedMap.getArrayEntryAt(i10), z10, z11);
        }
        Iterator it = smallSortedMap.getOverflowEntries().iterator();
        while (it.hasNext()) {
            cloneFieldEntry(smallSortedMapNewFieldMap, (Map.Entry) it.next(), z10, z11);
        }
    ...
    static int getWireFormatForFieldType(WireFormat.FieldType fieldType, boolean z10) {
        if (z10) {
            return 2;
        }
