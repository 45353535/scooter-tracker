...
final class SchemaUtil {
    ...
    static int computeSizeMessage(int i10, Object obj, Schema schema) {
    ...
    static <UT, UB> UB filterUnknownEnumList(Object obj, int i10, List<Integer> list, Internal.EnumLiteMap<?> enumLiteMap, UB ub2, UnknownFieldSchema<UT, UB> unknownFieldSchema) {
        if (enumLiteMap == null) {
            return ub2;
        }
    ...
    static <T, FT extends FieldSet.FieldDescriptorLite<FT>> void mergeExtensions(ExtensionSchema<FT> extensionSchema, T t10, T t11) {
    ...
    static <T> void mergeMap(MapFieldSchema mapFieldSchema, T t10, T t11, long j10) {
        UnsafeUtil.putObject(t10, j10, mapFieldSchema.mergeFrom(UnsafeUtil.getObject(t10, j10), UnsafeUtil.getObject(t11, j10)));
    }

    static <T, UT, UB> void mergeUnknownFields(UnknownFieldSchema<UT, UB> unknownFieldSchema, T t10, T t11) {
    ...
    @CanIgnoreReturnValue
    static <UT, UB> UB storeUnknownEnum(Object obj, int i10, int i11, UB ub2, UnknownFieldSchema<UT, UB> unknownFieldSchema) {
        if (ub2 == null) {
    ...
    static int computeSizeGroupList(int i10, List<MessageLite> list, Schema schema) {
        int size = list.size();
        if (size == 0) {
            return 0;
        }
    ...
    static int computeSizeMessageList(int i10, List<?> list, Schema schema) {
    ...
    @CanIgnoreReturnValue
    static <UT, UB> UB filterUnknownEnumList(Object obj, int i10, List<Integer> list, Internal.EnumVerifier enumVerifier, UB ub2, UnknownFieldSchema<UT, UB> unknownFieldSchema) {
