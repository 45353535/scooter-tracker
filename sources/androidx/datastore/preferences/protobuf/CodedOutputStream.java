...
public abstract class CodedOutputStream extends ByteOutput {
    ...
    private static abstract class AbstractBufferedEncoder extends CodedOutputStream {
        ...
        final void bufferUInt32NoTag(int i10) {
            ...
            while ((i10 & WorkInfo.STOP_REASON_FOREGROUND_SERVICE_TIMEOUT) != 0) {
                ...
                this.position = i13 + 1;
                UnsafeUtil.putByte(bArr3, i13, (byte) ((i10 | 128) & 255));
                i10 >>>= 7;
            }
        ...
        final void bufferUInt64NoTag(long j10) {
            ...
            while ((j10 & (-128)) != 0) {
                ...
                int i12 = this.position;
                this.position = i12 + 1;
                UnsafeUtil.putByte(bArr3, i12, (byte) ((((int) j10) | 128) & 255));
                j10 >>>= 7;
            }
            byte[] bArr4 = this.buffer;
            int i13 = this.position;
    ...
    abstract void writeMessage(int i10, MessageLite messageLite, Schema schema) throws IOException;
    ...
    @Deprecated
    static int computeGroupSize(int i10, MessageLite messageLite, Schema schema) {
    ...
    static int computeMessageSize(int i10, MessageLite messageLite, Schema schema) {
    ...
    @Deprecated
    final void writeGroup(int i10, MessageLite messageLite, Schema schema) throws IOException {
        writeTag(i10, 3);
