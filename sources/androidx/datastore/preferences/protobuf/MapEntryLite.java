...
public class MapEntryLite<K, V> {
    ...
    static <K, V> int computeSerializedSize(Metadata<K, V> metadata, K k10, V v10) {
    ...
    static <K, V> void writeTo(CodedOutputStream codedOutputStream, Metadata<K, V> metadata, K k10, V v10) throws IOException {
