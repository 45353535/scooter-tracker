...
public final class SharedPreferencesMigrationKt {
    ...
    static final class AnonymousClass1 extends k implements Function3<SharedPreferencesView, Preferences, Continuation, Object> {
        ...
        @Nullable
        public final Object invoke(@NotNull SharedPreferencesView sharedPreferencesView, @NotNull Preferences preferences, @Nullable Continuation continuation) {
    ...
    static final class C16441 extends k implements Function2<Preferences, Continuation, Object> {
        final /* synthetic */ Set<String> $keysToMigrate;
        /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C16441(Set<String> set, Continuation continuation) {
        ...
        public final Continuation create(@Nullable Object obj, @NotNull Continuation continuation) {
            C16441 c16441 = new C16441(this.$keysToMigrate, continuation);
            c16441.L$0 = obj;
            return c16441;
        }
        ...
        public final Object invoke(@NotNull Preferences preferences, @Nullable Continuation continuation) {
            return ((C16441) create(preferences, continuation)).invokeSuspend(Unit.f93236a);
        }
    ...
    private static final Function3<SharedPreferencesView, Preferences, Continuation, Object> getMigrationFunction() {
        return new AnonymousClass1(null);
    }

    private static final Function2<Preferences, Continuation, Object> getShouldRunMigration(Set<String> set) {
        return new C16441(set, null);
    }
