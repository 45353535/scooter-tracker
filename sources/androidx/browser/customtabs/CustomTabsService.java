...
public abstract class CustomTabsService extends Service {
    ...
    class AnonymousClass1 extends b.a {
        ...
        @Override // android.support.customtabs.b
        public boolean receiveFile(@NonNull android.support.customtabs.a aVar, @NonNull Uri uri, int i10, @Nullable Bundle bundle) {
            return CustomTabsService.this.receiveFile(new CustomTabsSessionToken(aVar, getSessionIdFromBundle(bundle)), uri, i10, bundle);
        }
        ...
        @Override // android.support.customtabs.b
        public boolean validateRelationship(@NonNull android.support.customtabs.a aVar, int i10, @NonNull Uri uri, @Nullable Bundle bundle) {
            return CustomTabsService.this.validateRelationship(new CustomTabsSessionToken(aVar, getSessionIdFromBundle(bundle)), i10, uri, bundle);
        }
