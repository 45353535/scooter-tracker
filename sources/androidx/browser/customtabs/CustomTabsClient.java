...
public class CustomTabsClient {
    ...
    private a.AbstractBinderC0006a createCallbackWrapper(@Nullable final CustomTabsCallback customTabsCallback) {
        return new a.AbstractBinderC0006a() { // from class: androidx.browser.customtabs.CustomTabsClient.2
    ...
    private CustomTabsSession newSessionInternal(@Nullable CustomTabsCallback customTabsCallback, @Nullable PendingIntent pendingIntent) {
        boolean zNewSession;
        a.AbstractBinderC0006a abstractBinderC0006aCreateCallbackWrapper = createCallbackWrapper(customTabsCallback);
        try {
            if (pendingIntent != null) {
                Bundle bundle = new Bundle();
                bundle.putParcelable(CustomTabsIntent.EXTRA_SESSION_ID, pendingIntent);
                zNewSession = this.mService.newSessionWithExtras(abstractBinderC0006aCreateCallbackWrapper, bundle);
            } else {
                zNewSession = this.mService.newSession(abstractBinderC0006aCreateCallbackWrapper);
            }
            if (zNewSession) {
                return new CustomTabsSession(this.mService, abstractBinderC0006aCreateCallbackWrapper, this.mServiceComponentName, pendingIntent);
            }
            return null;
