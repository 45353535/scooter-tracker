...
public class CustomTabsSessionToken {
    ...
    static class MockCallback extends a.AbstractBinderC0006a {
        MockCallback() {
        }

        @Override // android.support.customtabs.a.AbstractBinderC0006a, android.os.IInterface
    ...
    public static CustomTabsSessionToken getSessionTokenFromIntent(@NonNull Intent intent) {
        ...
        return new CustomTabsSessionToken(binder != null ? a.AbstractBinderC0006a.asInterface(binder) : null, pendingIntent);
    }
