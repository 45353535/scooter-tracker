...
class ConnectionHolder implements ServiceConnection {
    ...
    public static /* synthetic */ Object d(ConnectionHolder connectionHolder, CallbackToFutureAdapter.Completer completer) throws Exception {
        int i10 = connectionHolder.mState;
        if (i10 == 0) {
    ...
    public ListenableFuture<TrustedWebActivityServiceConnection> getServiceWrapper() {
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.browser.trusted.a
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return ConnectionHolder.d(this.f4350a, completer);
            }
        });
    }
