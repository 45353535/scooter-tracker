...
public final class TestDirCalculator {
    ...
    @NotNull
    private final Lazy outputDir = i.a(new Function0<File>() { // from class: androidx.test.platform.io.TestDirCalculator$outputDir$2
        {
            super(0);
        }
    ...
    @NotNull
    private final Lazy inputDir = i.a(new Function0<File>() { // from class: androidx.test.platform.io.TestDirCalculator$inputDir$2
        {
            super(0);
        }
