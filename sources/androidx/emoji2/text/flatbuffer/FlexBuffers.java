...
public class FlexBuffers {
    ...
    public static class Blob extends Sized {
        ...
        public ByteBuffer data() {
            ByteBuffer byteBufferWrap = ByteBuffer.wrap(this.f4570bb.data());
        ...
        public byte get(int i10) {
            return this.f4570bb.get(this.end + i10);
        }
        ...
        public byte[] getBytes() {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                bArr[i10] = this.f4570bb.get(this.end + i10);
            }
            return bArr;
        }
        ...
        public String toString() {
            return this.f4570bb.getString(this.end, size());
        }

        @Override // androidx.emoji2.text.flatbuffer.FlexBuffers.Object
        public StringBuilder toString(StringBuilder sb2) {
            sb2.append('\"');
            sb2.append(this.f4570bb.getString(this.end, size()));
            sb2.append('\"');
            return sb2;
        }
    }
    ...
    public static class Key extends Object {
        ...
        public String toString() {
            int i10 = this.end;
            while (this.f4570bb.get(i10) != 0) {
                i10++;
            }
            int i11 = this.end;
            return this.f4570bb.getString(i11, i10 - i11);
        }
    }
    ...
    public static class KeyVector {
        ...
        public Key get(int i10) {
            ...
            ReadBuf readBuf = typedVector2.f4570bb;
    ...
    public static class Map extends Vector {
        ...
        public Vector values() {
            return new Vector(this.f4570bb, this.end, this.byteWidth);
        }
    ...
    public static class Reference {
        ...
        public Blob asBlob() {
            ...
            ReadBuf readBuf = this.f4571bb;
            return new Blob(readBuf, FlexBuffers.indirect(readBuf, this.end, this.parentWidth), this.byteWidth);
        }

        public boolean asBoolean() {
            return isBoolean() ? this.f4571bb.get(this.end) != 0 : asUInt() != 0;
        }

        public double asFloat() {
            int i10 = this.type;
            if (i10 == 3) {
                return FlexBuffers.readDouble(this.f4571bb, this.end, this.parentWidth);
            }
            if (i10 == 1) {
                return FlexBuffers.readInt(this.f4571bb, this.end, this.parentWidth);
            }
            if (i10 != 2) {
                if (i10 == 5) {
            ...
            return FlexBuffers.readUInt(this.f4571bb, this.end, this.parentWidth);
        }
        ...
        public int asInt() {
            ...
            if (i10 == 2) {
                return (int) FlexBuffers.readUInt(this.f4571bb, this.end, this.parentWidth);
            }
            if (i10 == 3) {
                return (int) FlexBuffers.readDouble(this.f4571bb, this.end, this.parentWidth);
            }
            if (i10 == 5) {
        ...
        public long asLong() {
            int i10 = this.type;
            if (i10 == 1) {
                return FlexBuffers.readLong(this.f4571bb, this.end, this.parentWidth);
            }
            if (i10 == 2) {
                return FlexBuffers.readUInt(this.f4571bb, this.end, this.parentWidth);
            }
            if (i10 == 3) {
                return (long) FlexBuffers.readDouble(this.f4571bb, this.end, this.parentWidth);
            }
            if (i10 == 5) {
                try {
        ...
        public String asString() {
            if (isString()) {
                int iIndirect = FlexBuffers.indirect(this.f4571bb, this.end, this.parentWidth);
                ReadBuf readBuf = this.f4571bb;
                int i10 = this.byteWidth;
                return this.f4571bb.getString(iIndirect, (int) FlexBuffers.readUInt(readBuf, iIndirect - i10, i10));
            }
            if (!isKey()) {
                return "";
            }
            int iIndirect2 = FlexBuffers.indirect(this.f4571bb, this.end, this.byteWidth);
            int i11 = iIndirect2;
            while (this.f4571bb.get(i11) != 0) {
                i11++;
            }
            return this.f4571bb.getString(iIndirect2, i11 - iIndirect2);
        }
    ...
    private static abstract class Sized extends Object {
        ...
        Sized(ReadBuf readBuf, int i10, int i11) {
            super(readBuf, i10, i11);
            this.size = FlexBuffers.readInt(this.f4570bb, i10 - i11, i11);
        }
    ...
    public static class TypedVector extends Vector {
        ...
        public Reference get(int i10) {
            ...
            return new Reference(this.f4570bb, this.end + (i10 * this.byteWidth), this.byteWidth, 1, this.elemType);
        }
    ...
    static class Unsigned {
        ...
        static int byteToUnsignedInt(byte b10) {
            return b10 & 255;
        }

        static long intToUnsignedLong(int i10) {
            return ((long) i10) & 4294967295L;
        }

        static int shortToUnsignedInt(short s10) {
            return s10 & 65535;
        }
    }
    ...
    public static class Vector extends Sized {
        ...
        public Reference get(int i10) {
            ...
            return new Reference(this.f4570bb, this.end + (i10 * this.byteWidth), this.byteWidth, Unsigned.byteToUnsignedInt(this.f4570bb.get((int) (((long) this.end) + (size * ((long) this.byteWidth)) + j10))));
        }
