...
public class NotificationCompat {
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            public WearableExtender m4201clone() {
    ...
    public static class Builder {
        ...
        public RemoteViews createHeadsUpContentView() {
            ...
            Notification notificationBuild = notificationCompatBuilder.build();
            return i10 >= 24 ? Api24Impl.createHeadsUpContentView(Api24Impl.recoverBuilder(this.mContext, notificationBuild)) : notificationBuild.headsUpContentView;
        }
    ...
    public static final class WearableExtender implements Extender {
        ...
        @NonNull
        /* JADX INFO: renamed from: clone, reason: merged with bridge method [inline-methods] */
        public WearableExtender m4202clone() {
            WearableExtender wearableExtender = new WearableExtender();
    ...
    static Action getActionCompatFromAction(@NonNull Notification.Action action) {
        ...
        boolean z10 = i12 >= 24 ? Api20Impl.getExtras(action).getBoolean("android.support.allowGeneratedReplies") || Api24Impl.getAllowGeneratedReplies(action) : Api20Impl.getExtras(action).getBoolean("android.support.allowGeneratedReplies");
    ...
    public static class MessagingStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            int i10 = Build.VERSION.SDK_INT;
            if (i10 >= 24) {
                Notification.MessagingStyle messagingStyleCreateMessagingStyle = i10 >= 28 ? Api28Impl.createMessagingStyle(this.mUser.toAndroidPerson()) : Api24Impl.createMessagingStyle(this.mUser.getName());
                Iterator<Message> it = this.mMessages.iterator();
                while (it.hasNext()) {
                    Api24Impl.addMessage(l.a(messagingStyleCreateMessagingStyle), it.next().toAndroidMessage());
                }
                if (Build.VERSION.SDK_INT >= 26) {
                    Iterator<Message> it2 = this.mHistoricMessages.iterator();
                    while (it2.hasNext()) {
                        Api26Impl.addHistoricMessage(l.a(messagingStyleCreateMessagingStyle), it2.next().toAndroidMessage());
                    }
                }
                if (this.mIsGroupConversation.booleanValue() || Build.VERSION.SDK_INT >= 28) {
                    Api24Impl.setConversationTitle(l.a(messagingStyleCreateMessagingStyle), this.mConversationTitle);
                }
                if (Build.VERSION.SDK_INT >= 28) {
                    Api28Impl.setGroupConversation(l.a(messagingStyleCreateMessagingStyle), this.mIsGroupConversation.booleanValue());
                }
            ...
            for (int size = this.mMessages.size() - 1; size >= 0; size--) {
                Message message = this.mMessages.get(size);
                CharSequence charSequenceMakeMessageLine = z10 ? makeMessageLine(message) : message.getText();
