...
public final class InputConnectionCompat {
    ...
    public static /* synthetic */ boolean a(View view, InputContentInfoCompat inputContentInfoCompat, int i10, Bundle bundle) {
    ...
    private static OnCommitContentListener createOnCommitContentListenerUsingPerformReceiveContent(@NonNull final View view) {
        ...
        return new OnCommitContentListener() { // from class: androidx.core.view.inputmethod.d
            ...
            public final boolean onCommitContent(InputContentInfoCompat inputContentInfoCompat, int i10, Bundle bundle) {
                return InputConnectionCompat.a(view, inputContentInfoCompat, i10, bundle);
            }
        };
    }
    ...
    static boolean handlePerformPrivateCommand(@Nullable String str, @Nullable Bundle bundle, @NonNull OnCommitContentListener onCommitContentListener) throws Throwable {
        boolean z10;
