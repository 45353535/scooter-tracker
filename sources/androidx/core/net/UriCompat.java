...
public final class UriCompat {
    ...
    public static String toSafeString(@NonNull Uri uri) {
        ...
        if (scheme != null) {
            if (scheme.equalsIgnoreCase(MRAIDNativeFeature.TEL) || scheme.equalsIgnoreCase("sip") || scheme.equalsIgnoreCase(MRAIDNativeFeature.SMS) || scheme.equalsIgnoreCase("smsto") || scheme.equalsIgnoreCase("mailto") || scheme.equalsIgnoreCase("nfc")) {
