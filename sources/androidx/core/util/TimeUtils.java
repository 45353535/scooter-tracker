...
public final class TimeUtils {
    ...
    private static int formatDurationLocked(long j10, int i10) {
        ...
        if (i10 != 0) {
            ...
            i14 = 0;
            for (int iAccumField5 = iAccumField4 + accumField(i16, 2, true, iAccumField4 > 0 ? 3 : 0) + 1; iAccumField5 < i10; iAccumField5++) {
                cArr[i14] = ' ';
                i14++;
            }
        } else {
        ...
        int iPrintField2 = printField(cArr, i12, 'h', iPrintField, iPrintField != i18, z10 ? 2 : 0);
        int iPrintField3 = printField(cArr, i13, 'm', iPrintField2, iPrintField2 != i18, z10 ? 2 : 0);
        int iPrintField4 = printField(cArr, iFloor, 's', iPrintField3, iPrintField3 != i18, z10 ? 2 : 0);
        int iPrintField5 = printField(cArr, i16, 'm', iPrintField4, true, (!z10 || iPrintField4 == i18) ? 0 : 3);
        cArr[iPrintField5] = 's';
