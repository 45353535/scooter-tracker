...
public final class AdRequestOuterClass {
    ...
    public static final class AdRequest extends GeneratedMessageLite<AdRequest, Builder> implements AdRequestOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<AdRequest, Builder> implements AdRequestOrBuilder {
            ...
            public Map<String, String> getExtrasMap() {
                return DesugarCollections.unmodifiableMap(((AdRequest) this.instance).getExtrasMap());
            }
        ...
        private static final class a {
            ...
            static final MapEntryLite f72579a;

            static {
                WireFormat.FieldType fieldType = WireFormat.FieldType.STRING;
                f72579a = MapEntryLite.newDefaultInstance(fieldType, "", fieldType, "");
            }
        }
        ...
        protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            a aVar = null;
            switch (a.f72581a[methodToInvoke.ordinal()]) {
                case 1:
                    return new AdRequest();
                case 2:
                    return new Builder(aVar);
                case 3:
                    return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0010\u0000\u0001\u0001\u0010\u0010\u0001\u0000\u0000\u0001ဉ\u0000\u0002ဉ\u0001\u0003ဉ\u0002\u0004ဉ\u0003\u0005\n\u0006Ȉ\u0007\u0007\b\n\tင\u0004\nည\u0005\u000bဌ\u0006\fဉ\u0007\rဌ\b\u000eለ\t\u000f2\u0010ဉ\n", new Object[]{"bitField0_", "sessionCounters_", "staticDeviceInfo_", "dynamicDeviceInfo_", "campaignState_", "impressionOpportunityId_", "placementId_", "requestImpressionConfiguration_", "scarSignal_", "webviewVersion_", "tcf_", "adRequestType_", "bannerSize_", "adFormat_", "mediationAdUnitId_", "extras_", a.f72579a, "mediationInfo_"});
                case 4:
                    return DEFAULT_INSTANCE;
                case 5:
        ...
        @Override // gatewayprotocol.v1.AdRequestOuterClass.AdRequestOrBuilder
        public Map<String, String> getExtrasMap() {
            return DesugarCollections.unmodifiableMap(internalGetExtras());
        }
    ...
    public enum AdRequestType implements Internal.EnumLite {
        ...
        private static final class b implements Internal.EnumVerifier {
            ...
            /* JADX INFO: renamed from: a, reason: collision with root package name */
            static final Internal.EnumVerifier f72580a = new b();
    ...
    static /* synthetic */ class a {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        static final /* synthetic */ int[] f72581a;
        ...
        static {
            ...
            try {
                f72581a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f72581a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f72581a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f72581a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f72581a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f72581a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
