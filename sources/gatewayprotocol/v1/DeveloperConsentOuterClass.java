...
public final class DeveloperConsentOuterClass {
    ...
    public static final class DeveloperConsent extends GeneratedMessageLite<DeveloperConsent, Builder> implements DeveloperConsentOrBuilder {
        ...
        protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            a aVar = null;
            switch (a.f72592a[methodToInvoke.ordinal()]) {
                case 1:
    ...
    public enum DeveloperConsentChoice implements Internal.EnumLite {
        ...
        private static final class b implements Internal.EnumVerifier {
            ...
            static final Internal.EnumVerifier f72590a = new b();
    ...
    public enum DeveloperConsentType implements Internal.EnumLite {
        ...
        private static final class b implements Internal.EnumVerifier {
            ...
            /* JADX INFO: renamed from: a, reason: collision with root package name */
            static final Internal.EnumVerifier f72591a = new b();
    ...
    static /* synthetic */ class a {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        static final /* synthetic */ int[] f72592a;
        ...
        static {
            ...
            try {
                f72592a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f72592a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f72592a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f72592a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f72592a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f72592a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
