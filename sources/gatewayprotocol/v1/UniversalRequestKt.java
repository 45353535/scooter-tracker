...
public final class UniversalRequestKt {
    ...
    public final UniversalRequestOuterClass.UniversalRequest.Payload m7739initializepayload(@NotNull Function1<? super PayloadKt.Dsl, Unit> block) {
    ...
    public final UniversalRequestOuterClass.UniversalRequest.SharedData m7740initializesharedData(@NotNull Function1<? super SharedDataKt.Dsl, Unit> block) {
        Intrinsics.checkNotNullParameter(block, "block");
