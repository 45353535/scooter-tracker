...
public final class DynamicDeviceInfoOuterClass {
    ...
    public enum ConnectionType implements Internal.EnumLite {
        ...
        private static final class b implements Internal.EnumVerifier {
            ...
            static final Internal.EnumVerifier f72600a = new b();
    ...
    public static final class DynamicDeviceInfo extends GeneratedMessageLite<DynamicDeviceInfo, Builder> implements DynamicDeviceInfoOrBuilder {
        ...
        public static final class Android extends GeneratedMessageLite<Android, Builder> implements AndroidOrBuilder {
            ...
            protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
                ...
                a aVar = null;
                switch (a.f72601a[methodToInvoke.ordinal()]) {
                    case 1:
                        return new Android();
                    case 2:
    ...
    static /* synthetic */ class a {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        static final /* synthetic */ int[] f72601a;
        ...
        static {
            ...
            try {
                f72601a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f72601a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f72601a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f72601a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f72601a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f72601a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
