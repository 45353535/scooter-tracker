...
public final class AdPlayerConfigRequestOuterClass {
    ...
    public static final class AdPlayerConfigRequest extends GeneratedMessageLite<AdPlayerConfigRequest, Builder> implements AdPlayerConfigRequestOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<AdPlayerConfigRequest, Builder> implements AdPlayerConfigRequestOrBuilder {
            ...
            public Map<String, String> getExtrasMap() {
                return DesugarCollections.unmodifiableMap(((AdPlayerConfigRequest) this.instance).getExtrasMap());
            }
        ...
        private static final class a {
            ...
            static final MapEntryLite f72576a;

            static {
                WireFormat.FieldType fieldType = WireFormat.FieldType.STRING;
                f72576a = MapEntryLite.newDefaultInstance(fieldType, "", fieldType, "");
            }
        }
        ...
        protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            a aVar = null;
            switch (a.f72577a[methodToInvoke.ordinal()]) {
                case 1:
                    return new AdPlayerConfigRequest();
                case 2:
                    return new Builder(aVar);
                case 3:
                    return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\b\u0000\u0001\u0001\t\b\u0001\u0000\u0000\u0001\n\u0002Ȉ\u0004\n\u0005ဌ\u0001\u0006ለ\u0002\u00072\bဉ\u0003\tင\u0000", new Object[]{"bitField0_", "configurationToken_", "placementId_", "impressionOpportunityId_", "adFormat_", "mediationAdUnitId_", "extras_", a.f72576a, "mediationInfo_", "webviewVersion_"});
                case 4:
                    return DEFAULT_INSTANCE;
                case 5:
    ...
    static /* synthetic */ class a {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        static final /* synthetic */ int[] f72577a;
        ...
        static {
            ...
            try {
                f72577a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f72577a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f72577a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f72577a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f72577a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f72577a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
