...
public final class h implements AdSource.Rewarded, AdEventFlow, StatisticsCollector {
    ...
    private final /* synthetic */ AdEventFlowImpl f97312a = new AdEventFlowImpl();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final /* synthetic */ StatisticsCollectorImpl f97313b = new StatisticsCollectorImpl();

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private InMobiInterstitial f97314c;

    public static final class a extends InterstitialAdEventListener {

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        final /* synthetic */ d f97316b;
        ...
        public void onAdDisplayFailed(InMobiInterstitial interstitial) {
            Intrinsics.checkNotNullParameter(interstitial, "interstitial");
            BidonError.Unspecified unspecified = new BidonError.Unspecified(h.this.getDemandId(), null, null, 6, null);
            LogExtKt.logError("InmobiRewardedImpl", "onAdDisplayFailed. " + this, unspecified);
            h.this.emitEvent(new AdEvent.ShowFailed(unspecified));
        }
        ...
        public void onAdDisplayed(InMobiInterstitial interstitial, AdMetaInfo adMetaInfo) {
            ...
            h.this.emitEvent(new AdEvent.PaidRevenue(ad2, new AdValue(this.f97316b.getPrice() / 1000.0d, "USD", Precision.Precise)));
        ...
        public void onAdLoadFailed(InMobiInterstitial interstitial, InMobiAdRequestStatus status) {
            ...
            h.this.emitEvent(new AdEvent.LoadFailed(org.bidon.inmobi.ext.a.a(status)));
        }
    ...
    public void addAuctionConfigurationId(long j10) {
        this.f97313b.addAuctionConfigurationId(j10);
    }

    @Override // org.bidon.sdk.stats.StatisticsCollector
    public void addAuctionConfigurationUid(String auctionConfigurationUid) {
        Intrinsics.checkNotNullParameter(auctionConfigurationUid, "auctionConfigurationUid");
        this.f97313b.addAuctionConfigurationUid(auctionConfigurationUid);
    }

    @Override // org.bidon.sdk.stats.StatisticsCollector
    public void addDemandId(DemandId demandId) {
        Intrinsics.checkNotNullParameter(demandId, "demandId");
        this.f97313b.addDemandId(demandId);
    }

    @Override // org.bidon.sdk.stats.StatisticsCollector
    public void addExternalWinNotificationsEnabled(boolean z10) {
        this.f97313b.addExternalWinNotificationsEnabled(z10);
    }
    ...
    public void addRoundInfo(String auctionId, DemandAd demandAd, double d10) {
        ...
        this.f97313b.addRoundInfo(auctionId, demandAd, d10);
    }

    @Override // org.bidon.sdk.stats.StatisticsCollector
    public boolean canSendWinLoseNotifications() {
        return this.f97313b.canSendWinLoseNotifications();
    }
    ...
    public void load(d adParams) {
        ...
        this.f97314c = inMobiInterstitial;
    ...
    public void emitEvent(AdEvent event) {
        ...
        this.f97312a.emitEvent(event);
    }

    @Override // org.bidon.sdk.stats.StatisticsCollector
    public Ad getAd() {
        return this.f97313b.getAd();
    }

    @Override // org.bidon.sdk.adapter.impl.AdEventFlow
    public SharedFlow getAdEvent() {
        return this.f97312a.getAdEvent();
    }

    @Override // org.bidon.sdk.stats.StatisticsCollector
    public String getAuctionId() {
        return this.f97313b.getAuctionId();
    }
    ...
    public Object mo4425getAuctionParamIoAF18A(AdAuctionParamSource auctionParamsScope) {
        ...
        return auctionParamsScope.m8670invokeIoAF18A(new Function1() { // from class: org.bidon.inmobi.impl.g
            @Override // kotlin.jvm.functions.Function1
            public final Object invoke(Object obj) {
                return h.c((AdAuctionParamSource) obj);
            }
        });
    }
    ...
    public DemandAd getDemandAd() {
        return this.f97313b.getDemandAd();
    }

    @Override // org.bidon.sdk.stats.StatisticsCollector
    public DemandId getDemandId() {
        return this.f97313b.getDemandId();
    }

    @Override // org.bidon.sdk.stats.StatisticsCollector
    /* JADX INFO: renamed from: getStats */
    public BidStat getStat() {
        return this.f97313b.getStat();
    }

    @Override // org.bidon.sdk.adapter.AdSource
    /* JADX INFO: renamed from: isAdReadyToShow */
    public boolean getIsAdReadyToShow() {
        InMobiInterstitial inMobiInterstitial = this.f97314c;
        return inMobiInterstitial != null && inMobiInterstitial.isReady();
    }

    @Override // org.bidon.sdk.stats.StatisticsCollector
    public void markBelowPricefloor() {
        this.f97313b.markBelowPricefloor();
    }

    @Override // org.bidon.sdk.stats.StatisticsCollector
    public void markFillFinished(RoundStatus roundStatus, Double d10) {
        Intrinsics.checkNotNullParameter(roundStatus, "roundStatus");
        this.f97313b.markFillFinished(roundStatus, d10);
    }

    @Override // org.bidon.sdk.stats.StatisticsCollector
    public void markFillStarted(AdUnit adUnit, Double d10) {
        Intrinsics.checkNotNullParameter(adUnit, "adUnit");
        this.f97313b.markFillStarted(adUnit, d10);
    }

    @Override // org.bidon.sdk.stats.StatisticsCollector
    public void markLoss() {
        this.f97313b.markLoss();
    }

    @Override // org.bidon.sdk.stats.StatisticsCollector
    public void markWin() {
        this.f97313b.markWin();
    }

    @Override // org.bidon.sdk.stats.StatisticsCollector
    public void markWinLoseNotificationsSent() {
        this.f97313b.markWinLoseNotificationsSent();
    }

    @Override // org.bidon.sdk.stats.StatisticsCollector
    public void sendClickImpression() {
        this.f97313b.sendClickImpression();
    }

    @Override // org.bidon.sdk.stats.StatisticsCollector
    public void sendLoss(String winnerDemandId, double d10) {
        Intrinsics.checkNotNullParameter(winnerDemandId, "winnerDemandId");
        this.f97313b.sendLoss(winnerDemandId, d10);
    }

    @Override // org.bidon.sdk.stats.StatisticsCollector
    public void sendRewardImpression() {
        this.f97313b.sendRewardImpression();
    }

    @Override // org.bidon.sdk.stats.StatisticsCollector
    public void sendShowImpression() {
        this.f97313b.sendShowImpression();
    }

    @Override // org.bidon.sdk.stats.StatisticsCollector
    public void sendWin() {
        this.f97313b.sendWin();
    }

    @Override // org.bidon.sdk.stats.StatisticsCollector
    public void setDsp(String str) {
        this.f97313b.setDsp(str);
    }

    @Override // org.bidon.sdk.stats.StatisticsCollector
    public void setPrice(double d10) {
        this.f97313b.setPrice(d10);
    }

    @Override // org.bidon.sdk.stats.StatisticsCollector
    public void setStatisticAdType(StatisticsCollector.AdType adType) {
        Intrinsics.checkNotNullParameter(adType, "adType");
        this.f97313b.setStatisticAdType(adType);
    }

    @Override // org.bidon.sdk.stats.StatisticsCollector
    public void setTokenInfo(TokenInfo tokenInfo) {
        Intrinsics.checkNotNullParameter(tokenInfo, "tokenInfo");
        this.f97313b.setTokenInfo(tokenInfo);
    }
