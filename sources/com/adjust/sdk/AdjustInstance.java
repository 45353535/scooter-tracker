...
public class AdjustInstance {
    ...
    private void setSendingReferrersAsNotSent(final Context context) {
        new SingleThreadCachedScheduler("AdjustInstance").submit(new Runnable() { // from class: com.adjust.sdk.c1
    ...
    public void onPause() {
        if (checkActivityHandler(C4240b4.i.f42653t0)) {
            this.activityHandler.onPause();
        }
    }

    public void onResume() {
        if (checkActivityHandler(C4240b4.i.f42655u0)) {
    ...
    public void trackThirdPartySharing(final AdjustThirdPartySharing adjustThirdPartySharing) {
        if (checkActivityHandler("third party sharing", true)) {
            ...
            this.preLaunchActions.preLaunchActionsArray.add(new IRunActivityHandler() { // from class: com.adjust.sdk.b1
                @Override // com.adjust.sdk.IRunActivityHandler
                public final void run(ActivityHandler activityHandler) {
