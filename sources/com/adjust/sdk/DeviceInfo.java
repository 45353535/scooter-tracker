    ...
    private String getFacebookAttributionId(Context context) {
        ...
        try {
            if (Build.VERSION.SDK_INT >= 28) {
                SigningInfo signingInfo = context.getPackageManager().getPackageInfo(FbValidationUtils.FB_PACKAGE, 134217728).signingInfo;
                apkContentsSigners = signingInfo != null ? signingInfo.getApkContentsSigners() : null;
            } else {
                apkContentsSigners = context.getPackageManager().getPackageInfo(FbValidationUtils.FB_PACKAGE, 64).signatures;
            }
