...
public class PackageBuilder {
    ...
    public static class ActivityStateCopy {
        ...
        public ActivityStateCopy(ActivityState activityState) {
            ...
            this.f7074a = activityState.eventCount;
            this.f7075b = activityState.sessionCount;
            this.f7076c = activityState.subsessionCount;
            this.f7077d = activityState.timeSpent;
            this.f7078e = activityState.sessionLength;
            this.f7079f = activityState.uuid;
            this.f7080g = activityState.pushToken;
        }
    }

    public PackageBuilder(AdjustConfig adjustConfig, DeviceInfo deviceInfo, ActivityState activityState, GlobalParameters globalParameters, FirstSessionDelayManager firstSessionDelayManager, long j10) {
        this.createdAt = j10;
    ...
    private Map<String, String> getAdRevenueParameters(AdjustAdRevenue adjustAdRevenue) {
        ...
        addString(map, "android_uuid", this.activityStateCopy.f7079f);
        ...
        addString(map, ADJPConstants.KEY_ENVIRONMENT, this.adjustConfig.environment);
        ...
        addString(map, "push_token", this.activityStateCopy.f7080g);
        ...
        addLong(map, "session_count", this.activityStateCopy.f7075b);
        addDuration(map, "session_length", this.activityStateCopy.f7078e);
        addLong(map, "subsession_count", this.activityStateCopy.f7076c);
        addDuration(map, "time_spent", this.activityStateCopy.f7077d);
    ...
    private Map<String, String> getMeasurementConsentParameters(boolean z10) {
        ...
        addString(map, "measurement", z10 ? com.ironsource.mediationsdk.metadata.a.f44111j : "disable");
        this.deviceInfo.reloadPlayIds(this.adjustConfig);
        addString(map, "android_uuid", this.activityStateCopy.f7079f);
        addString(map, "gps_adid", this.deviceInfo.playAdId);
        addLong(map, "gps_adid_attempt", this.deviceInfo.playAdIdAttempt);
    ...
    private Map<String, String> getThirdPartySharingParameters(AdjustThirdPartySharing adjustThirdPartySharing) {
        ...
        if (bool != null) {
            addString(map, "sharing", bool.booleanValue() ? com.ironsource.mediationsdk.metadata.a.f44111j : "disable");
        }
    ...
    public ActivityPackage buildAttributionPackage(String str) {
        ...
        defaultActivityPackage.setPath(C4257c4.f42799c);
        defaultActivityPackage.setSuffix("");
    ...
    public Map<String, String> getEventParameters(AdjustEvent adjustEvent) {
        ...
        addLong(map, "event_count", this.activityStateCopy.f7074a);
