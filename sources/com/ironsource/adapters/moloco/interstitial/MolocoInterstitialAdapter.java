...
@Metadata(d1 = {"\u0000N\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\t\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u000f\u0012\u0006\u0010\u0003\u001a\u00020\u0002¢\u0006\u0004\b\u0004\u0010\u0005J,\u0010\u000e\u001a\u00020\u000f2\b\u0010\u0010\u001a\u0004\u0018\u00010\u00112\b\u0010\u0012\u001a\u0004\u0018\u00010\u00112\u0006\u0010\u0013\u001a\u00020\u00142\u0006\u0010\u0015\u001a\u00020\u0007H\u0016J\b\u0010\u0016\u001a\u00020\u000fH\u0016J\u0012\u0010\u0017\u001a\u00020\u000f2\b\u0010\u0018\u001a\u0004\u0018\u00010\u0011H\u0016J,\u0010\u0019\u001a\u00020\u000f2\u0006\u0010\u0013\u001a\u00020\u00142\b\u0010\u001a\u001a\u0004\u0018\u00010\u00142\b\u0010\u001b\u001a\u0004\u0018\u00010\u00112\u0006\u0010\u0015\u001a\u00020\u0007H\u0016J\u0018\u0010\u001c\u001a\u00020\u000f2\u0006\u0010\u0013\u001a\u00020\u00142\u0006\u0010\u0015\u001a\u00020\u0007H\u0016J\u0010\u0010\u001d\u001a\u00020\u001e2\u0006\u0010\u0013\u001a\u00020\u0014H\u0016J\"\u0010\u001f\u001a\u00020\u000f2\u0006\u0010\u0013\u001a\u00020\u00142\b\u0010\u001a\u001a\u0004\u0018\u00010\u00142\u0006\u0010 \u001a\u00020!H\u0016J\r\u0010\"\u001a\u00020\u000fH\u0000¢\u0006\u0002\b#R\u0010\u0010\u0006\u001a\u0004\u0018\u00010\u0007X\u0082\u000e¢\u0006\u0002\n\u0000R\u0010\u0010\b\u001a\u0004\u0018\u00010\tX\u0082\u000e¢\u0006\u0002\n\u0000R\u0010\u0010\n\u001a\u0004\u0018\u00010\u000bX\u0082\u000e¢\u0006\u0002\n\u0000R\u0010\u0010\f\u001a\u0004\u0018\u00010\rX\u0082\u000e¢\u0006\u0002\n\u0000¨\u0006$"}, d2 = {"Lcom/ironsource/adapters/moloco/interstitial/MolocoInterstitialAdapter;", "Lcom/ironsource/mediationsdk/adapter/AbstractInterstitialAdapter;", "Lcom/ironsource/adapters/moloco/MolocoAdapter;", N6.G1, "<init>", "(Lcom/ironsource/adapters/moloco/MolocoAdapter;)V", "mListener", "Lcom/ironsource/mediationsdk/sdk/InterstitialSmashListener;", "mAdLoadListener", "Lcom/ironsource/adapters/moloco/interstitial/MolocoInterstitialAdLoadListener;", "mAdShowListener", "Lcom/ironsource/adapters/moloco/interstitial/MolocoInterstitialAdShowListener;", "mAd", "Lcom/moloco/sdk/publisher/InterstitialAd;", "initInterstitialForBidding", "", "appKey", "", "userId", "config", "Lorg/json/JSONObject;", ServiceSpecificExtraArgs.CastExtraArgs.LISTENER, "onNetworkInitCallbackSuccess", "onNetworkInitCallbackFailed", "error", "loadInterstitialForBidding", "adData", C4424m2.f43620s, C4240b4.h.H, "isInterstitialReady", "", "collectInterstitialBiddingData", "biddingDataCallback", "Lcom/ironsource/mediationsdk/bidding/BiddingDataCallback;", "destroyInterstitialAd", "destroyInterstitialAd$molocoadapter_release", "molocoadapter_release"}, k = 1, mv = {2, 0, 0}, xi = 48)
public final class MolocoInterstitialAdapter extends AbstractInterstitialAdapter<MolocoAdapter> {
    ...
    public MolocoInterstitialAdapter(@NotNull MolocoAdapter adapter) {
        super(adapter);
    ...
    */
    public static final kotlin.Unit loadInterstitialForBidding$lambda$2(com.ironsource.adapters.moloco.interstitial.MolocoInterstitialAdapter r0, java.lang.String r1, com.ironsource.mediationsdk.sdk.InterstitialSmashListener r2, com.moloco.sdk.publisher.InterstitialAd r3, com.moloco.sdk.publisher.MolocoAdError.AdCreateError r4) {
        /*
            if (r4 == 0) goto L17
            com.ironsource.mediationsdk.sdk.InterstitialSmashListener r0 = r0.mListener
            if (r0 == 0) goto L2d
            ...
            r1.<init>(r2, r3)
            r0.onInterstitialAdLoadFailed(r1)
            goto L2d
        L17:
            if (r3 == 0) goto L24
            r0.mAd = r3
            com.ironsource.adapters.moloco.interstitial.MolocoInterstitialAdLoadListener r0 = r0.mAdLoadListener
            r3.load(r1, r0)
        ...
        L24:
            ...
            r2.onInterstitialAdLoadFailed(r0)
        L2d:
            kotlin.Unit r0 = kotlin.Unit.f93236a
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.ironsource.adapters.moloco.interstitial.MolocoInterstitialAdapter.loadInterstitialForBidding$lambda$2(com.ironsource.adapters.moloco.interstitial.MolocoInterstitialAdapter, java.lang.String, com.ironsource.mediationsdk.sdk.InterstitialSmashListener, com.moloco.sdk.publisher.InterstitialAd, com.moloco.sdk.publisher.MolocoAdError$AdCreateError):kotlin.Unit");
    }
    ...
    public void initInterstitialForBidding(@Nullable String appKey, @Nullable String userId, @NotNull JSONObject config, @NotNull InterstitialSmashListener listener) {
        ...
        if (configStringValueFromKey.length() == 0) {
            ...
            listener.onInterstitialInitFailed(ErrorBuilder.buildInitFailedError(getAdUnitIdMissingErrorString(configStringValueFromKey), "Interstitial"));
            return;
        }
        if (configStringValueFromKey2.length() == 0) {
            IronLog.INTERNAL.error(getAdUnitIdMissingErrorString(configStringValueFromKey2));
            listener.onInterstitialInitFailed(ErrorBuilder.buildInitFailedError(getAdUnitIdMissingErrorString(configStringValueFromKey2), "Interstitial"));
            return;
        }
        ...
        if (i10 == 2) {
            listener.onInterstitialInitFailed(ErrorBuilder.buildInitFailedError("Moloco sdk init failed", "Interstitial"));
        } else {
            if (i10 != 3 && i10 != 4) {
                throw new m();
            }
    ...
    public void loadInterstitialForBidding(@NotNull JSONObject config, @Nullable JSONObject adData, @Nullable final String serverData, @NotNull final InterstitialSmashListener listener) {
        ...
        if (serverData == null || serverData.length() == 0) {
            ...
            this.mAdLoadListener = new MolocoInterstitialAdLoadListener(listener, new WeakReference(this));
            MolocoAdapter.Companion companion = MolocoAdapter.INSTANCE;
            Moloco.createInterstitial$default(companion.getMediationInfo(), getConfigStringValueFromKey(config, companion.getAdUnitIdKey()), null, new Function2() { // from class: f4.a
                @Override // kotlin.jvm.functions.Function2
                public final Object invoke(Object obj, Object obj2) {
                    return MolocoInterstitialAdapter.loadInterstitialForBidding$lambda$2(this.f71935b, serverData, listener, (InterstitialAd) obj, (MolocoAdError.AdCreateError) obj2);
                }
            }, 4, null);
        }
    }
    ...
    public void showInterstitial(@NotNull JSONObject config, @NotNull InterstitialSmashListener listener) {
        ...
        MolocoInterstitialAdShowListener molocoInterstitialAdShowListener = new MolocoInterstitialAdShowListener(listener, new WeakReference(this));
