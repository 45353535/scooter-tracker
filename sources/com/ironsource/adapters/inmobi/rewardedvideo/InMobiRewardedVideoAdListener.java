...
public final class InMobiRewardedVideoAdListener extends InterstitialAdEventListener {
    ...
    public InMobiRewardedVideoAdListener(@NotNull RewardedVideoSmashListener listener, @NotNull String placementId) {
    ...
    public void onAdLoadFailed(@NotNull InMobiInterstitial inMobiInterstitial, @NotNull InMobiAdRequestStatus inMobiAdRequestStatus) {
        ...
        IronSourceError ironSourceError = inMobiAdRequestStatus.getStatusCode() == InMobiAdRequestStatus.StatusCode.NO_FILL ? new IronSourceError(1058, str) : ErrorBuilder.buildLoadFailedError(str);
    ...
    public void onAdLoadSucceeded(@NotNull InMobiInterstitial inMobiInterstitial, @NotNull AdMetaInfo adMetaInfo) {
        ...
        if (creativeID == null || creativeID.length() == 0) {
            ...
            this.listener.onRewardedVideoAvailabilityChanged(true, MapsKt.mapOf(TuplesKt.to("creativeId", creativeID)));
        }
    }
}
