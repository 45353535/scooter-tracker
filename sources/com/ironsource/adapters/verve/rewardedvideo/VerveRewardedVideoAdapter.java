...
public final class VerveRewardedVideoAdapter extends AbstractRewardedVideoAdapter<VerveAdapter> {
    ...
    public VerveRewardedVideoAdapter(@NotNull VerveAdapter adapter) {
        super(adapter);
    ...
    public void loadRewardedVideoForBidding(@NotNull JSONObject config, @Nullable JSONObject adData, @Nullable String serverData, @NotNull RewardedVideoSmashListener listener) {
        ...
        String configStringValueFromKey = getConfigStringValueFromKey(config, VerveAdapter.INSTANCE.getZoneIdKey());
        ...
        hyBidRewardedAd.prepareAd(serverData);
