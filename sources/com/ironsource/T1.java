...
public final class T1 implements C0 {
    ...
    public T1(@NotNull C4373j2 auctionData) {
        Intrinsics.checkNotNullParameter(auctionData, "auctionData");
        this.f41771a = auctionData;
    }

    private final boolean b(A0 a02) {
        switch (a.f41772a[a02.ordinal()]) {
            case 1:
            case 2:
            case 3:
            case 4:
    ...
    public Map<String, Object> a(@NotNull A0 event) {
        ...
        JSONObject jSONObjectH = this.f41771a.h();
        if (jSONObjectH != null && jSONObjectH.length() > 0) {
            map.put("genericParams", jSONObjectH);
        }
        if (b(event)) {
            map.put(IronSourceConstants.AUCTION_TRIALS, Integer.valueOf(this.f41771a.i()));
            if (!TextUtils.isEmpty(this.f41771a.f())) {
                map.put(IronSourceConstants.AUCTION_FALLBACK, this.f41771a.f());
            }
        }
        if (!TextUtils.isEmpty(this.f41771a.g())) {
            map.put("auctionId", this.f41771a.g());
        }
        return map;
    }
}
