...
public class MetaDataUtils {
    ...
    public static MetaData.MetaDataValueTypes getValueTypeForKey(String str) {
        return (str.equalsIgnoreCase("do_not_sell") || str.equalsIgnoreCase("is_child_directed") || str.equalsIgnoreCase(a.f44104c) || str.equalsIgnoreCase(a.f44105d)) ? MetaData.MetaDataValueTypes.META_DATA_VALUE_BOOLEAN : MetaData.MetaDataValueTypes.META_DATA_VALUE_STRING;
    }

    public static boolean isKnownKey(String str) {
        return a.f44114m.contains(str.toLowerCase(Locale.getDefault()));
    }

    public static boolean isMediationKeysBeforeInit(String str) {
        return a.f44113l.contains(str.toLowerCase(Locale.getDefault()));
    }

    public static boolean isMediationOnlyKey(String str) {
        return a.f44112k.contains(str.toLowerCase(Locale.getDefault()));
    }
