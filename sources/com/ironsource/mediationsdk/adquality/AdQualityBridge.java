...
public final class AdQualityBridge {
    ...
    public static final class Companion {
        ...
        public final boolean isGetVersionMethodExist() throws JSONException {
            try {
                ...
                C4462o4.d().a(th2);
                logEvent$default(this, A5.TROUBLESHOOTING_AD_QUALITY_SDK_NOT_EXIST, null, null, 6, null);
                return false;
            }
        }
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public final void logEvent(A5 a52, Integer num, String str) throws JSONException {
            JSONObject jSONObjectB = IronSourceUtils.b(false);
            if (num != null) {
                jSONObjectB.put("errorCode", num.intValue());
            }
            if (str != null) {
                jSONObjectB.put("reason", str);
            }
            jSONObjectB.put(IronSourceConstants.EVENTS_EXT1, a.f43760a.a().b());
            Ib.f41088s.d().q().a(new C4649z5(a52, jSONObjectB));
        }

        static /* synthetic */ void logEvent$default(Companion companion, A5 a52, Integer num, String str, int i10, Object obj) throws JSONException {
            if ((i10 & 2) != 0) {
                num = null;
            }
            if ((i10 & 4) != 0) {
            ...
            companion.logEvent(a52, num, str);
        }
    ...
    public AdQualityBridge(@NotNull Context context, @NotNull String appKey, @Nullable String str, @NotNull C4338h0 adQualityDataProvider, int i10) throws JSONException {
        ...
        ISAdQualityConfig.Builder deviceIdType = new ISAdQualityConfig.Builder().setInitializationSource("LevelPlay").setLogLevel(convertToAdQualityLogLevel(i10)).setAdQualityInitListener(new ISAdQualityInitListener() { // from class: com.ironsource.mediationsdk.adquality.AdQualityBridge$configBuilder$1
            ...
            public void adQualitySdkInitFailed(@NotNull ISAdQualityInitError isAdQualityInitError, @NotNull String message) throws JSONException {
                Intrinsics.checkNotNullParameter(isAdQualityInitError, "isAdQualityInitError");
                Intrinsics.checkNotNullParameter(message, "message");
                A5 a52 = A5.TROUBLESHOOTING_AD_QUALITY_SDK_FAILED_TO_INITIALIZE_EVENT;
                if (isAdQualityInitError == ISAdQualityInitError.AD_QUALITY_ALREADY_INITIALIZED) {
                    a52 = A5.TROUBLESHOOTING_AD_QUALITY_SDK_WAS_ALREADY_INITIALIZED_EVENT;
                }
                AdQualityBridge.Companion.logEvent(a52, Integer.valueOf(isAdQualityInitError.getValue()), message);
            ...
            public void adQualitySdkInitSuccess() throws JSONException {
                AdQualityBridge.Companion.logEvent$default(AdQualityBridge.Companion, A5.TROUBLESHOOTING_AD_QUALITY_SDK_INITIALIZED_SUCCESSFULLY_EVENT, null, null, 6, null);
            }
        ...
        Companion.logEvent$default(companion, A5.TROUBLESHOOTING_INITIALIZING_AD_QUALITY_SDK_EVENT, null, null, 6, null);
    ...
    private final boolean getCoppaValue() {
        String strA = K6.a().a("is_coppa");
        return strA != null && Boolean.parseBoolean(strA);
    }

    private final ISAdQualityDeviceIdType getDeviceIdType() {
        return !TextUtils.isEmpty(K6.a().a(L6.N)) ? ISAdQualityDeviceIdType.NONE : ISAdQualityDeviceIdType.GAID;
    }
    ...
    private static final void logEvent(A5 a52, Integer num, String str) throws JSONException {
        Companion.logEvent(a52, num, str);
    }
    ...
    public final void setSegment(@NotNull C4246ba segment) {
        ...
        for (Pair<String, String> pair : segment.f()) {
            String key = (String) pair.first;
            String str = (String) pair.second;
            Intrinsics.checkNotNullExpressionValue(key, "key");
            if (StringsKt.a0(key, "custom_", false, 2, null)) {
                builder.setCustomData(StringsKt.P0(key, "custom_"), str);
            }
        }
