...
public final class a {
    ...
    private static String f7943a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static Class<?> f7944b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static Field f7945c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static Field f7946d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private static boolean f7947e;
    ...
    public static String c(Context context) {
        ...
        if (f7945c == null && clsE != null) {
            try {
                f7945c = clsE.getDeclaredField("VERSION_NAME");
    ...
    public static int d(Context context) {
        Class<?> clsE = e(context);
        if (f7946d == null && clsE != null) {
            try {
                f7946d = clsE.getDeclaredField("VERSION_CODE");
            } catch (NoSuchFieldException unused) {
            }
        }
        Field field = f7946d;
    ...
    private static Class<?> e(Context context) {
        if (f7944b == null && !f7947e) {
            try {
                f7944b = Class.forName(context.getPackageName() + ".BuildConfig");
    ...
    public static void a(Context context, JSONObject jSONObject) {
        try {
            ...
            if (activityManager != null) {
                ...
                jSONObject3.put(N6.f41431w, memoryInfo2.availMem);
