...
public final class a implements Thread.UncaughtExceptionHandler {
    ...
    private static volatile boolean f7809i;

    /* JADX INFO: renamed from: j, reason: collision with root package name */
    private static volatile ThreadLocal<Boolean> f7810j = new ThreadLocal<>();

    /* JADX INFO: renamed from: l, reason: collision with root package name */
    private static volatile long f7811l = 10000;

    /* JADX INFO: renamed from: m, reason: collision with root package name */
    private static ArrayList<b> f7812m = new ArrayList<>();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private Thread.UncaughtExceptionHandler f7813b;
    ...
    private volatile int f7816e = 0;

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private volatile int f7817f = 0;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    private ConcurrentHashMap<String, Object> f7818g = new ConcurrentHashMap<>();

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    private ConcurrentHashMap<String, Object> f7819h = new ConcurrentHashMap<>();

    /* JADX INFO: renamed from: k, reason: collision with root package name */
    private JSONArray f7820k;

    private a() {
        Thread.UncaughtExceptionHandler defaultUncaughtExceptionHandler = Thread.getDefaultUncaughtExceptionHandler();
        if (defaultUncaughtExceptionHandler != this) {
            this.f7813b = defaultUncaughtExceptionHandler;
    ...
    private void c(Thread thread, Throwable th2) {
        Thread.UncaughtExceptionHandler uncaughtExceptionHandler = this.f7813b;
    ...
    private void d() {
        ...
        while (this.f7817f != 0 && SystemClock.uptimeMillis() - jUptimeMillis < f7811l) {
    ...
    private static void e() {
        ...
        long jUptimeMillis = SystemClock.uptimeMillis();
        while (!h.a() && SystemClock.uptimeMillis() - jUptimeMillis < f7811l) {
            try {
    ...
    private static int f() {
        int iA = 0;
        for (int i10 = 0; i10 < f7812m.size(); i10++) {
            try {
                try {
                    iA |= f7812m.get(i10).a();
                } catch (Throwable th2) {
    ...
    public final boolean b(String str) {
        return this.f7818g.containsKey(str);
    }
  ...
  0x0065: PHI (r0v52 boolean) = (r0v9 boolean), (r0v53 boolean), (r0v53 boolean), (r0v53 boolean) binds: [B:24:0x0064, B:20:0x005a, B:142:0x0065, B:22:0x0060] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    private String a(File file, Throwable th2, Thread thread, boolean z10) {
        ...
        this.f7819h.put(file.getName(), file);
        try {
        ...
        if (z10) {
            ...
            if (iH > 0) {
                try {
                    ...
                    NativeImpl.a(iH, IOUtils.LINE_SEPARATOR_UNIX);
            ...
            try {
                ...
                try {
                    ...
                    fileOutputStream.write((th2.getMessage() + IOUtils.LINE_SEPARATOR_UNIX).getBytes());
                ...
                try {
                    strA = com.apm.insight.l.m.a(th2, new PrintStream(fileOutputStream), Looper.getMainLooper() == Looper.myLooper() ? new e.a() { // from class: com.apm.insight.g.a.1
                        ...
                        public final boolean a(String str) {
                            if (!this.f7821a && str.contains("android.os.Looper.loop")) {
                                this.f7821a = true;
                            }
                            return !this.f7821a;
                        }
                    ...
                    try {
                        ...
                        try {
                            ...
                            fileOutputStream.write((th4 + IOUtils.LINE_SEPARATOR_UNIX).getBytes());
        ...
        for (ICrashCallback iCrashCallback : listC) {
            ...
            try {
                if (iCrashCallback instanceof com.apm.insight.b) {
                    ((com.apm.insight.b) iCrashCallback).a(crashType, com.apm.insight.l.m.a(th2), thread, this.f7820k);
                } else {
        ...
        for (IOOMCallback iOOMCallback : listA) {
            try {
                if (iOOMCallback instanceof com.apm.insight.b) {
                    ...
                    j11 = j10;
                    try {
                        ((com.apm.insight.b) iOOMCallback).a(crashType, th3, thread2, j11, this.f7820k);
                    } catch (Throwable th4) {
                        th = th4;
    ...
    public final void a(String str) {
        this.f7818g.put(str, new Object());
    }
