...
public final class e {
    ...
    public static final class a {
        ...
        private static a f7908c = new a("NONE", 0, 0);

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public static final a f7906a = new a("GZIP", 1, 1);

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        public static final a f7907b = new a("DEFLATER", 2, 2);
    ...
    private static String c(String str, String str2) {
        try {
            ...
            } else if (!str.endsWith(C4240b4.j.f42670c)) {
                str = str + C4240b4.j.f42670c;
            }
            return str + str2;
    ...
    private static com.apm.insight.l.f a(String str, byte[] bArr, a aVar, String str2) throws IOException {
        ...
        if (a.f7906a == aVar && length > 128) {
            bArr = a(bArr);
            str3 = "gzip";
        } else if (a.f7907b != aVar || length <= 128) {
            str3 = null;
        } else {
    ...
    private static com.apm.insight.l.f d(String str, String str2) {
        try {
            if (!TextUtils.isEmpty(str2) && !TextUtils.isEmpty(str)) {
                return a(str, str2.getBytes(), a.f7906a, "application/json; charset=utf-8");
            }
            return new com.apm.insight.l.f(201);
        } catch (Throwable th2) {
    ...
    private static com.apm.insight.l.f b(String str, String str2, File... fileArr) {
        ...
        try {
            ...
            iVar.b("json", str2);
            iVar.a(C4240b4.i.f42616b, fileArr);
            try {
    ...
    public static byte[] a(String str, byte[] bArr) {
        try {
            ...
            return a(str, bArr, a.f7906a, "application/json; charset=utf-8").b();
        } catch (IOException e10) {
            e10.printStackTrace();
            return null;
        }
