...
public final class g {
    ...
    private static final ConcurrentHashMap<Object, ConcurrentLinkedQueue<com.apm.insight.entity.c>> f7923a = new ConcurrentHashMap<>();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final HashMap<Object, HashMap<String, ConcurrentLinkedQueue<com.apm.insight.entity.c>>> f7924b = new HashMap<>();

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static volatile g f7925c;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private volatile boolean f7927e = false;

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private Runnable f7928f = new Runnable() { // from class: com.apm.insight.k.g.1
        @Override // java.lang.Runnable
        public final void run() {
            if (Npth.isStopUpload()) {
                return;
            }
            if (!g.f7924b.isEmpty() && l.e()) {
                g.f();
            }
            g.this.c();
            g.this.f7926d.a(g.this.f7928f, 30000L);
        }
    };

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private final p f7926d = m.a();
    ...
    private static void c(Object obj, com.apm.insight.entity.c cVar) {
        ...
        try {
            ...
            HashMap<Object, HashMap<String, ConcurrentLinkedQueue<com.apm.insight.entity.c>>> map = f7924b;
            synchronized (map) {
                try {
    ...
    public static void f() {
        HashMap map;
        HashMap<Object, HashMap<String, ConcurrentLinkedQueue<com.apm.insight.entity.c>>> map2 = f7924b;
        synchronized (map2) {
    ...
    public final void b() {
        if (f7923a.isEmpty()) {
            this.f7926d.a(this.f7928f, 30000L);
        } else {
            this.f7926d.a(this.f7928f);
        }
    }
    ...
    public final void c() {
        synchronized (this.f7926d) {
            try {
                ...
                for (Map.Entry<Object, ConcurrentLinkedQueue<com.apm.insight.entity.c>> entry : f7923a.entrySet()) {
