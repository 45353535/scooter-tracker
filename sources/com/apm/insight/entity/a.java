...
public class a {
    ...
    public final a b(Map<Integer, String> map) {
        if (map != null && map.size() > 0) {
            ...
            try {
                this.f7776a.put("sdk_info", jSONObject);
    ...
    public final a c(Map<? extends String, ? extends String> map) {
        ...
        if (map != null) {
            Object objOpt = this.f7776a.opt("data");
            if (objOpt instanceof JSONArray) {
                jSONObjectOptJSONObject = ((JSONArray) objOpt).optJSONObject(0);
            } else {
                jSONObjectOptJSONObject = this.f7776a;
            }
    ...
    public final a a(Map<String, Integer> map) {
        ...
        if (map == null) {
            this.f7776a.put("plugin_info", jSONArray);
            return this;
        }
    ...
    public final a b(String str, String str2) {
        ...
        a(this.f7776a, "custom", str, str2);
        return this;
    }

    public final a a(int i10, String str) {
        try {
            this.f7776a.put("miniapp_id", i10);
            this.f7776a.put("miniapp_version", str);
            return this;
        } catch (JSONException e10) {
            e10.printStackTrace();
            return this;
    ...
    public static void a(JSONObject jSONObject, JSONObject jSONObject2) {
        ...
        String str2;
        try {
            jSONObject.put(C4240b4.a.f42506k, jSONObject2);
        } catch (Throwable unused) {
        }
    ...
    public final boolean a() {
        Object objOpt = this.f7776a.opt("data");
        return objOpt instanceof JSONArray ? !com.apm.insight.a.a(((JSONArray) objOpt).optJSONObject(0), "logcat") : !com.apm.insight.a.a(this.f7776a, "logcat");
    }

    private a a(String str, JSONArray jSONArray) {
        JSONObject jSONObjectOptJSONObject = this.f7776a.optJSONObject("custom_long");
        if (jSONObjectOptJSONObject == null) {
            jSONObjectOptJSONObject = new JSONObject();
    ...
    public final a a(String str, String str2) {
        ...
        a(this.f7776a, "filters", str, str2);
        return this;
    }
}
