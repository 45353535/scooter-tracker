...
public abstract class c {
    ...
    protected CrashType f8057a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    protected Context f8058b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private ICommonParams f8059c = com.apm.insight.e.a().c();
    ...
    private com.apm.insight.entity.a b(com.apm.insight.entity.a aVar) {
        ...
        try {
            aVar.a(this.f8059c.getPluginInfo());
        } catch (Throwable th2) {
            try {
    ...
    private com.apm.insight.entity.a c(com.apm.insight.entity.a aVar) {
        ...
        if (b() && (bVar = this.f8060d) != null) {
            aVar.a(bVar);
        }
        try {
            aVar.a(this.f8059c.getPatchInfo());
        } catch (Throwable th2) {
            try {
    ...
    public com.apm.insight.entity.a a(int i10, com.apm.insight.entity.a aVar) {
        ...
        if (i10 == 1) {
            c(aVar);
            List<AttachUserData> listA = com.apm.insight.e.b().a(this.f8057a);
            HashMap map = new HashMap();
            ...
            if (listA != null) {
                for (int i11 = 0; i11 < listA.size(); i11++) {
                    try {
                        ...
                        long jUptimeMillis = SystemClock.uptimeMillis();
                        com.apm.insight.entity.a.a(jSONObjectOptJSONObject, attachUserData.getUserData(this.f8057a));
            ...
            List<AttachUserData> listB = com.apm.insight.e.b().b(this.f8057a);
            if (listB != null) {
                ...
                while (i < listB.size()) {
                    try {
                        ...
                        com.apm.insight.entity.a.a(jSONObjectOptJSONObject2, attachUserData2.getUserData(this.f8057a));
