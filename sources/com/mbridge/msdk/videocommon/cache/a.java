...
public class a {
    ...
    private static final String f53170b = "com.mbridge.msdk.videocommon.cache.a";

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static a f53171c;
    ...
    class RunnableC0601a implements Runnable {
        ...
        /* JADX INFO: renamed from: b, reason: collision with root package name */
        final /* synthetic */ CampaignEx f53174b;

        RunnableC0601a(String str, CampaignEx campaignEx) {
            this.f53173a = str;
            this.f53174b = campaignEx;
        }

        @Override // java.lang.Runnable
        public void run() {
            a.this.a(this.f53173a, this.f53174b);
        }
    }
    ...
    private a() {
        try {
            ...
            if (contextD != null) {
                this.f53172a = e.a(g.a(contextD));
            } else {
                q0.b(f53170b, "RewardCampaignCache get Context is null");
            }
        } catch (Exception e10) {
            e10.printStackTrace();
        }
    ...
    public void b(String str, String str2) {
        if (this.f53172a == null || TextUtils.isEmpty(str)) {
            return;
        }
        this.f53172a.a(str, str2);
    }
    ...
    public CopyOnWriteArrayList<CampaignEx> c(String str, int i10) {
        ...
        try {
            if (TextUtils.isEmpty(str) || (listA = this.f53172a.a(str, 0, 0, i10)) == null) {
                return null;
            }
    ...
    public CopyOnWriteArrayList<CampaignEx> b(String str, int i10, boolean z10, String str2) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(str)) {
                if (z10) {
                    listA = this.f53172a.a(str, 0, 0, i10, str2);
                } else {
                    listA = this.f53172a.a(str, 0, 0, i10, false);
                }
    ...
    public void a(String str, List<CampaignEx> list, String str2, int i10) {
        e eVar;
        if (TextUtils.isEmpty(str) || list == null || list.size() <= 0 || TextUtils.isEmpty(str2) || (eVar = this.f53172a) == null) {
            return;
        }
    ...
    public void a(String str, List<CampaignEx> list) {
        e eVar;
        if (TextUtils.isEmpty(str) || list == null || list.size() <= 0 || (eVar = this.f53172a) == null) {
            return;
        }
        eVar.b(str, list);
    }
    ...
    public void b(String str, CampaignEx campaignEx) {
        com.mbridge.msdk.foundation.same.threadpool.a.b().execute(new RunnableC0601a(str, campaignEx));
    }

    public void b(String str) {
        ConcurrentHashMap<String, com.mbridge.msdk.foundation.entity.c> concurrentHashMapF;
        try {
            if (TextUtils.isEmpty(str) || (concurrentHashMapF = this.f53172a.f(str)) == null || concurrentHashMapF.size() <= 0) {
                return;
            }
            com.mbridge.msdk.setting.g gVarD = h.b().d(c.n().b());
            if (gVarD == null) {
    ...
    public synchronized void b(String str, int i10) {
        try {
            try {
                ...
                List<CampaignEx> listB = this.f53172a.b(str, i10, iF == 2);
    ...
    public List<CampaignEx> a(String str, int i10, boolean z10) {
        try {
            ...
            return this.f53172a.a(str, 0, 0, i10, z10);
        } catch (Exception e10) {
            q0.b(f53170b, e10.getLocalizedMessage());
            return null;
        }
    }
        ...
        if (campaignEx != null) {
            try {
                ...
                if (!TextUtils.isEmpty(localRequestId)) {
                    ...
                    if (z10) {
                        this.f53172a.a(str, localRequestId, localRequestId + "label_second");
                        return;
                    }
                    this.f53172a.a(campaignEx.getId(), str, campaignEx.isBidCampaign(), campaignEx.getRequestId());
                    return;
                }
                this.f53172a.a(campaignEx.getId(), str, campaignEx.isBidCampaign(), campaignEx.getRequestId());
            } catch (Exception e10) {
    ...
    public void a(CampaignEx campaignEx) {
        if (campaignEx != null) {
            try {
                ...
                this.f53172a.d(campaignEx.getId(), campaignEx.getRequestId());
            } catch (Exception e10) {
                e10.printStackTrace();
            }
        }
    ...
    public void a(String str, String str2) {
        try {
            ...
            List<com.mbridge.msdk.foundation.entity.c> listD = this.f53172a.d(str);
    ...
    public void a(String str, String str2, List<CampaignEx> list) {
        try {
            ...
            this.f53172a.a(list, str, str2, 0);
        } catch (Exception e10) {
            e10.printStackTrace();
        }
    }
