...
public class a extends WebChromeClient {
    ...
    private CopyOnWriteArrayList<WebChromeClient> f49756a = new CopyOnWriteArrayList<>();

    public void a(WebChromeClient webChromeClient) {
        this.f49756a.add(webChromeClient);
    }

    public void b(WebChromeClient webChromeClient) {
        this.f49756a.remove(webChromeClient);
    }
    ...
    public void onCloseWindow(WebView webView) {
        Iterator<WebChromeClient> it = this.f49756a.iterator();
        while (it.hasNext()) {
