...
public class a {
    ...
    public a(String str, boolean z10) {
        try {
            this.f50340a = b.a().b(str, com.mbridge.msdk.videocommon.setting.b.b().a(c.n().b(), str, z10).B());
        } catch (Exception e10) {
            e10.printStackTrace();
        }
    }
    ...
    public void a(List<CampaignEx> list, String str, com.mbridge.msdk.reward.adapter.c cVar, String str2) {
        try {
            if (this.f50340a == null || TextUtils.isEmpty(str)) {
                return;
            }
            this.f50340a.a(com.mbridge.msdk.foundation.cache.a.f48224f, 2, list, this.f50340a.a(list, str) > 0, "", "", -1, str2);
            d dVar = this.f50340a;
            JSONObject jSONObjectC = dVar.c(dVar.d(str));
            if (jSONObjectC == null || this.f50340a.b(str) <= 0.0d) {
                return;
            }
            a(this.f50340a.a(jSONObjectC.optInt("max_usage_limit", 10), 0L), jSONObjectC, jSONObjectC.optInt("max_cache_num", 20), -1.0d, cVar, new com.mbridge.msdk.foundation.same.report.metrics.c(), str, false, 0);
        } catch (Exception e10) {
            e10.printStackTrace();
        }
    }
    ...
    private com.mbridge.msdk.foundation.cache.c a(String str, com.mbridge.msdk.foundation.same.report.metrics.c cVar, String str2, com.mbridge.msdk.foundation.error.b bVar, int i10, com.mbridge.msdk.reward.adapter.c cVar2) {
        ...
        if (cVarA.g() > com.mbridge.msdk.foundation.cache.c.f48243j) {
            return cVarA;
        }
        ...
        this.f50340a.a(cVarA2.c(), cVar, str2, i11, str4, i10, d10);
        return cVarA2;
    }
    ...
    private com.mbridge.msdk.foundation.cache.c a(double d10, String str, com.mbridge.msdk.reward.adapter.c cVar, com.mbridge.msdk.foundation.same.report.metrics.c cVar2, String str2, int i10) {
        com.mbridge.msdk.foundation.cache.c cVarA = this.f50340a.a();
        try {
            if (cVarA.g() > 0) {
                return cVarA;
            }
            JSONObject jSONObjectC = this.f50340a.c(str);
            try {
                if (jSONObjectC != null) {
                    ...
                    if (iOptInt2 > 0) {
                        ...
                        List<com.mbridge.msdk.foundation.cache.b> listA = this.f50340a.a(iOptInt, System.currentTimeMillis() - (j10 * 1000));
                        if (listA != null && listA.size() > 0) {
                            return a(listA, jSONObjectC, iOptInt2, d10, cVar, cVar2, str2, true, i10);
                        }
                        cVarA.d("no cache");
                        cVarA.a(com.mbridge.msdk.foundation.cache.c.f48244k);
    ...
    private com.mbridge.msdk.foundation.cache.c a(List<com.mbridge.msdk.foundation.cache.b> list, JSONObject jSONObject, int i10, double d10, com.mbridge.msdk.reward.adapter.c cVar, com.mbridge.msdk.foundation.same.report.metrics.c cVar2, String str, boolean z10, int i11) {
        ...
        if (listA != null && listA.size() != 0) {
            ...
            if (listA != null && listA.size() > 0) {
                ...
                if (bVar2 != null) {
                    cVar3.a(bVar2.a());
                    cVar3.a(com.mbridge.msdk.foundation.cache.c.f48245l);
                } else {
    ...
    public void a(com.mbridge.msdk.foundation.same.report.metrics.c cVar, String str, com.mbridge.msdk.foundation.cache.c cVar2, List<a.b> list, JSONObject jSONObject, int i10) {
        ...
        try {
            ...
            if (cVar2 != null) {
                if (cVar2.g() == com.mbridge.msdk.foundation.cache.c.f48245l) {
                    eVar.a("result", 1);
                } else {
                    eVar.a("result", 2);
