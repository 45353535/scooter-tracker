...
public class MBShakeView extends LinearLayout {
    ...
    private Animation f50636a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private ImageView f50637b;
    ...
    public void initView(String str, boolean z10) {
        ...
        this.f50637b = new ImageView(getContext());
        ...
        this.f50637b.setLayoutParams(layoutParams);
        this.f50637b.setImageResource(getResources().getIdentifier("mbridge_cm_btn_shake", "drawable", c.n().i()));
        FrameLayout frameLayout = new FrameLayout(getContext());
        frameLayout.setLayoutParams(new LinearLayout.LayoutParams(-2, -2));
        frameLayout.addView(imageView);
        frameLayout.addView(this.f50637b);
    ...
    private void a() {
        ...
        this.f50636a = rotateAnimation;
        rotateAnimation.setDuration(100L);
        this.f50636a.setRepeatMode(2);
        this.f50636a.setRepeatCount(-1);
        this.f50637b.startAnimation(this.f50636a);
    }
}
