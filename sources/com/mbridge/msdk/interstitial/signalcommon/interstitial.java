...
public class interstitial extends AbsFeedBackForH5 {
    ...
    private static final String f49212h = "com.mbridge.msdk.interstitial.signalcommon.interstitial";

    /* JADX INFO: renamed from: i, reason: collision with root package name */
    public static final /* synthetic */ int f49213i = 0;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    private Object f49214g;

    class a implements Runnable {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ List f49215a;
        ...
        public void run() {
            ...
            if (aVarA != null) {
                aVarA.a(this.f49215a, this.f49216b);
            }
        }
    }
    ...
    class b implements Runnable {
        ...
        @Override // java.lang.Runnable
        public void run() {
            for (int i10 = 0; i10 < this.f49218a.size(); i10++) {
                CampaignEx campaignEx = (CampaignEx) this.f49218a.get(i10);
                if (campaignEx != null) {
                    j.a(g.a(((com.mbridge.msdk.mbsignalcommon.windvane.g) interstitial.this).f49831a)).b(campaignEx.getId());
                }
            }
        }
    }
    ...
    private void b() {
        try {
            Context context = this.f49831a;
            if (context != null && a(context) == 1) {
                try {
                    MBInterstitialActivity mBInterstitialActivity = (MBInterstitialActivity) this.f49831a;
    ...
    private void d() {
        ...
        try {
            Context context = this.f49831a;
            if (context == null || a(context) != 1 || (mBInterstitialActivity = (MBInterstitialActivity) this.f49831a) == null) {
                return;
            }
    ...
    public List<String> getExcludeIdList(String str) {
        ...
        try {
            ...
            String strOptString = new JSONObject(str).optString(e.f48761h);
    ...
    public void openURL(Object obj, String str) {
        ...
        try {
            ...
            if (iOptInt == 1) {
                c.c(this.f49831a, strOptString);
            } else if (iOptInt == 2) {
                c.e(this.f49831a, strOptString);
            }
        } catch (JSONException e10) {
            q0.b(f49212h, e10.getMessage());
        } catch (Throwable th2) {
            q0.b(f49212h, th2.getMessage());
        }
    }
