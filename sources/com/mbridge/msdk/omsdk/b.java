...
public class b {
    ...
    public static final String f50005a = DomainNameUtils.VERIFICATION_URL;
    ...
    class a extends com.mbridge.msdk.foundation.same.net.handler.a {
        ...
        public void a(String str) {
            ...
            new h(this.f50006b).a("", "", "", "", "fetch OM failed, request failed");
        }
    ...
    class RunnableC0546b implements Runnable {
        ...
        public void run() throws Throwable {
            try {
                ...
                o0.a(this.f50007a.getBytes(), file);
            } catch (Exception e10) {
    ...
    class c extends com.mbridge.msdk.foundation.same.net.handler.a {
        ...
        /* JADX INFO: renamed from: b, reason: collision with root package name */
        final /* synthetic */ Context f50008b;
        ...
        public void a(String str) {
            ...
            new h(this.f50008b).a("", "", "", "", "fetch OM H5 failed, request failed");
        }
    ...
    class d implements Runnable {
        ...
        public void run() throws Throwable {
            try {
                ...
                o0.a(this.f50009a.getBytes(), file);
            } catch (Exception e10) {
                q0.a(POBOMSDKUtil.TAG, e10.getMessage());
            }
        }
    ...
    public static void c(Context context) {
        if (TextUtils.isEmpty(MBridgeConstans.OMID_JS_H5_URL)) {
            ...
            try {
                ...
                q0.b(POBOMSDKUtil.TAG, e10.getMessage());
            }
        }
    }
    ...
    public static void b(String str) {
        new Thread(new RunnableC0546b(str)).start();
    }
    ...
    private static List<VerificationScriptResource> a(String str, Context context, String str2, String str3, String str4, String str5) {
        ...
        try {
            ...
            try {
                ...
                str8 = str2;
                str9 = str5;
                q0.b(POBOMSDKUtil.TAG, illegalArgumentException.getMessage());
                ...
                str6 = str2;
                str7 = str5;
                q0.b(POBOMSDKUtil.TAG, malformedURLException.getMessage());
            ...
            q0.b(POBOMSDKUtil.TAG, e14.getMessage());
    ...
    public static String a(String str) {
        ...
        return TextUtils.isEmpty(str) ? str : str.replace("/*OMSDK_INSERT_HERE*/", MBridgeConstans.OMID_JS_H5_CONTENT).replace("[INSERT RESOURCE URL]", f50005a);
    }
}
