...
public class h extends com.mbridge.msdk.tracker.network.toolbox.a {
    ...
    private final SSLSocketFactory f51961a;

    static class a extends FilterInputStream implements AutoCloseable {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final HttpURLConnection f51962a;

        a(HttpURLConnection httpURLConnection) {
            super(h.b(httpURLConnection));
            this.f51962a = httpURLConnection;
        }

        @Override // java.io.FilterInputStream, java.io.InputStream, java.io.Closeable, java.lang.AutoCloseable
        public void close() throws IOException {
            super.close();
            this.f51962a.disconnect();
        }
    }
    ...
    private HttpsURLConnection a(URL url, t<?> tVar) throws IOException {
        ...
        if ("https".equals(url.getProtocol()) && (sSLSocketFactory = this.f51961a) != null) {
