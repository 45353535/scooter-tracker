...
public class m extends a {
    ...
    public g a(t<?> tVar, Map<String, String> map) throws IOException {
        ...
        if (this.f51978a != null) {
            ...
            v.b bVarA = this.f51978a.s().a(arrayList).a(new MBridgeHostnameVerifier(strA));
            long j11 = iQ;
            TimeUnit timeUnit = TimeUnit.MILLISECONDS;
            v.b bVarA2 = bVarA.d(j11, timeUnit).b(j11, timeUnit).a(pVarH == null ? com.mbridge.msdk.thrid.okhttp.n.f51595a : new j(pVarH.H(), pVarH.b(), pVarH)).e(j11, timeUnit).a(Math.max(jR, 0L), timeUnit);
            a(pVarH, bVarA2);
            y.a aVar = new y.a();
    ...
    private int a(b0 b0Var) {
        ...
        if (b0Var.k() > SieveCacheKt.NodeLinkMask) {
            return -1;
        }
        return (int) b0Var.k();
    }
