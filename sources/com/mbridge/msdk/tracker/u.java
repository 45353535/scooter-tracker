...
public class u {
    ...
    private static volatile u f52029g;
    ...
    private volatile boolean f52032c = false;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private int f52033d = 30000;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private final HashMap<String, String> f52034e = new HashMap<>();

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    Handler f52035f = new a(Looper.getMainLooper());
    ...
    class a extends Handler {
        ...
        public void handleMessage(Message message) {
            ...
            try {
                u.this.b();
                u.this.f52035f.removeMessages(1);
                u.this.d();
            } catch (Exception e10) {
                e10.printStackTrace();
            }
    ...
    public void d() {
        try {
            this.f52035f.sendEmptyMessageDelayed(1, this.f52033d);
        } catch (Exception e10) {
            e10.printStackTrace();
        }
    }
    ...
    */
    public void b() {
        ...
        L2f:
            ...
            java.util.HashMap<java.lang.String, java.lang.String> r4 = r14.f52034e     // Catch: java.lang.Exception -> L59
        ...
        L5b:
            ...
            com.mbridge.msdk.tracker.m r4 = r14.f52030a     // Catch: java.lang.Exception -> L59
            if (r4 == 0) goto Laa
            ...
            r4.a(r7)     // Catch: java.lang.Exception -> La6
            com.mbridge.msdk.tracker.m r5 = r14.f52030a     // Catch: java.lang.Exception -> La6
