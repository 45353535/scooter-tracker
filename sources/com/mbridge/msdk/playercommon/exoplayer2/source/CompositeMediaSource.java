...
public abstract class CompositeMediaSource<T> extends BaseMediaSource {
    ...
    private final class ForwardingEventListener implements MediaSourceEventListener {
        ...
        private boolean maybeUpdateEventDispatcher(int i10, @Nullable MediaSource.MediaPeriodId mediaPeriodId) {
            ...
            if (mediaPeriodId != null) {
                mediaPeriodIdForChildMediaPeriodId = CompositeMediaSource.this.getMediaPeriodIdForChildMediaPeriodId(this.f50063id, mediaPeriodId);
            ...
            int windowIndexForChildWindowIndex = CompositeMediaSource.this.getWindowIndexForChildWindowIndex(this.f50063id, i10);
        ...
        private MediaSourceEventListener.MediaLoadData maybeUpdateMediaLoadData(MediaSourceEventListener.MediaLoadData mediaLoadData) {
            long mediaTimeForChildMediaTime = CompositeMediaSource.this.getMediaTimeForChildMediaTime(this.f50063id, mediaLoadData.mediaStartTimeMs);
            long mediaTimeForChildMediaTime2 = CompositeMediaSource.this.getMediaTimeForChildMediaTime(this.f50063id, mediaLoadData.mediaEndTimeMs);
    ...
    protected final void prepareChildSource(@Nullable final T t10, MediaSource mediaSource) {
    ...
    protected final void releaseChildSource(@Nullable T t10) {
