...
public abstract class MediaCodecRenderer extends BaseRenderer {
    ...
    protected MediaCodecInfo getDecoderInfo(MediaCodecSelector mediaCodecSelector, Format format, boolean z10) throws MediaCodecUtil.DecoderQueryException {
    ...
    protected final void maybeInitCodec() throws ExoPlaybackException {
        ...
        if (this.codec == null && (format = this.format) != null) {
            ...
            if (shouldInitCodec(this.codecInfo)) {
                ...
                mediaCodecRenderer.codecHotswapDeadlineMs = getState() == 2 ? SystemClock.elapsedRealtime() + 1000 : -9223372036854775807L;
                resetInputBuffer();
                resetOutputBuffer();
    ...
    */
    protected void onInputFormatChanged(com.mbridge.msdk.playercommon.exoplayer2.Format r5) throws com.mbridge.msdk.playercommon.exoplayer2.ExoPlaybackException {
        /*
            r4 = this;
