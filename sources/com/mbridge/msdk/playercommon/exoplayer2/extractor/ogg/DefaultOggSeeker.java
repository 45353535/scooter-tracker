...
final class DefaultOggSeeker implements OggSeeker {
    ...
    public long getNextSeekPosition(long j10, ExtractorInput extractorInput) throws InterruptedException, IOException {
        ...
        if (j13 < 0) {
            ...
            if ((this.end - position2) + j14 < SilenceSkippingAudioProcessor.DEFAULT_MINIMUM_SILENCE_DURATION_US) {
                extractorInput.skipFully(i10);
                return -(this.startGranule + 2);
            }
        }
    ...
    long skipToPageOfGranule(ExtractorInput extractorInput, long j10, long j11) throws InterruptedException, IOException {
        this.pageHeader.populate(extractorInput, false);
        while (true) {
            OggPageHeader oggPageHeader = this.pageHeader;
    ...
    boolean skipToNextPage(ExtractorInput extractorInput, long j10) throws InterruptedException, IOException {
        int i10;
