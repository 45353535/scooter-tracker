...
public final class FragmentedMp4Extractor implements Extractor {
    ...
    private void onMoovContainerAtomRead(Atom.ContainerAtom containerAtom) throws ParserException {
        ...
        for (int i13 = 0; i13 < size2; i13++) {
            ...
            if (containerAtom2.type == Atom.TYPE_trak) {
                ...
                if (trak != null) {
                    sparseArray2.put(trak.f50058id, trak);
                }
            }
        }
        ...
        if (this.trackBundles.size() != 0) {
            ...
            while (i10 < size3) {
                ...
                this.trackBundles.get(track.f50058id).init(track, getDefaultSampleValues(sparseArray, track.f50058id));
                i10++;
            }
            return;
        }
        while (i10 < size3) {
            ...
            trackBundle.init(track2, getDefaultSampleValues(sparseArray, track2.f50058id));
            this.trackBundles.put(track2.f50058id, trackBundle);
    ...
    private static int parseTrun(TrackBundle trackBundle, int i10, long j10, int i11, ParsableByteArray parsableByteArray, int i12) {
        ...
        jArr[i10] = j12;
        if ((fullAtomFlags & 1) != 0) {
            jArr[i10] = j12 + ((long) parsableByteArray.readInt());
        }
        boolean z10 = (fullAtomFlags & 4) != 0;
        int unsignedIntToInt = defaultSampleValues.flags;
        if (z10) {
            unsignedIntToInt = parsableByteArray.readUnsignedIntToInt();
        }
        boolean z11 = (fullAtomFlags & 256) != 0;
        boolean z12 = (fullAtomFlags & 512) != 0;
        boolean z13 = (fullAtomFlags & 1024) != 0;
        boolean z14 = (fullAtomFlags & 2048) != 0;
        ...
        boolean z15 = z14;
        int i21 = (track.type != 2 || (i11 & 1) == 0) ? i13 : i20;
        int i22 = i12 + trackFragment.trunLength[i10];
        boolean z16 = z10;
        ...
        while (i15 < i22) {
            int unsignedIntToInt2 = z11 ? parsableByteArray.readUnsignedIntToInt() : defaultSampleValues.duration;
            int unsignedIntToInt3 = z12 ? parsableByteArray.readUnsignedIntToInt() : defaultSampleValues.size;
            if (i15 == 0 && z16) {
                i16 = i21;
                i17 = unsignedIntToInt;
            } else if (z13) {
                i16 = i21;
            ...
            if (z15) {
                i18 = i17;
                i19 = i22;
                iArr2[i15] = (int) ((((long) parsableByteArray.readInt()) * 1000) / j13);
            } else {
                i18 = i17;
                i19 = i22;
                iArr2[i15] = i13;
            ...
            long j14 = j11;
            jArr3[i15] = Util.scaleLargeTimestamp(j11, 1000L, j13) - jScaleLargeTimestamp;
            iArr[i15] = unsignedIntToInt3;
            zArr[i15] = (((i18 >> 16) & 1) == 0 && (i16 == 0 || i15 == 0)) ? i20 : i13;
            j11 = j14 + ((long) unsignedIntToInt2);
            i15++;
            i21 = i16;
            i22 = i19;
        }
    ...
    private boolean readSample(ExtractorInput extractorInput) throws InterruptedException, IOException {
        ...
        r10.sampleMetadata(samplePresentationTime, r12 == true ? 1 : 0, this.sampleSize, 0, cryptoData);
