...
final class AtomParsers {
    ...
    private static void parseAudioSampleEntry(ParsableByteArray parsableByteArray, int i10, int i11, int i12, int i13, String str, boolean z10, DrmInitData drmInitData, StsdData stsdData, int i14) throws ParserException {
        ...
        int i22 = unsignedFixedPoint1616;
        ...
        byte[] bArr = null;
        while (i24 - i19 < i20) {
            parsableByteArray.setPosition(i24);
            int i25 = parsableByteArray.readInt();
            Assertions.checkArgument(i25 > 0 ? z12 : false, "childAtomSize should be positive");
            int i26 = parsableByteArray.readInt();
            int i27 = Atom.TYPE_esds;
            if (i26 == i27 || (z10 && i26 == Atom.TYPE_wave)) {
                i15 = i24;
                ...
                z11 = true;
                i18 = i23;
                int iFindEsdsPosition = i26 == i27 ? i15 : findEsdsPosition(parsableByteArray, i15, i16);
        ...
        stsdData.format = Format.createAudioSampleFormat(Integer.toString(i13), str5, null, -1, -1, iIntValue2, i29, str6.equals(str5) ? i28 : -1, bArr != null ? Collections.singletonList(bArr) : null, drmInitData4, 0, str);
    }
    ...
    */
    ...
    public static Track parseTrak(Atom.ContainerAtom containerAtom, Atom.LeafAtom leafAtom, long j10, DrmInitData drmInitData, boolean z10, boolean z11) throws ParserException {
        ...
        StsdData stsd = parseStsd(containerAtomOfType2.getLeafAtomOfType(Atom.TYPE_stsd).data, tkhd.f50057id, tkhd.rotationDegrees, (String) mdhd.second, drmInitData, z11);
        if (z10) {
            jArr = null;
            jArr2 = null;
        } else {
        ...
        return new Track(tkhd.f50057id, hdlr, ((Long) mdhd.first).longValue(), mvhd, jScaleLargeTimestamp, stsd.format, stsd.requiredSampleTransformation, stsd.trackEncryptionBoxes, stsd.nalUnitLengthFieldLength, jArr, jArr2);
    }
