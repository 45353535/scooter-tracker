...
public final class EventMessage implements Metadata.Entry {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj != null && EventMessage.class == obj.getClass()) {
            ...
            if (this.presentationTimeUs == eventMessage.presentationTimeUs && this.durationMs == eventMessage.durationMs && this.f50060id == eventMessage.f50060id && Util.areEqual(this.schemeIdUri, eventMessage.schemeIdUri) && Util.areEqual(this.value, eventMessage.value) && Arrays.equals(this.messageData, eventMessage.messageData)) {
                return true;
            }
        }
        return false;
    ...
    public String toString() {
        return "EMSG: scheme=" + this.schemeIdUri + ", id=" + this.f50060id + ", value=" + this.value;
    }
    ...
    public void writeToParcel(Parcel parcel, int i10) {
        ...
        parcel.writeLong(this.f50060id);
