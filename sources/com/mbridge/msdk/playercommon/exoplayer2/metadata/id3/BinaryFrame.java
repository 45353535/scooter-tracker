...
public final class BinaryFrame extends Id3Frame {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj != null && BinaryFrame.class == obj.getClass()) {
            ...
            if (this.f50061id.equals(binaryFrame.f50061id) && Arrays.equals(this.data, binaryFrame.data)) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        return ((this.f50061id.hashCode() + IronSourceError.ERROR_NON_EXISTENT_INSTANCE) * 31) + Arrays.hashCode(this.data);
    }
