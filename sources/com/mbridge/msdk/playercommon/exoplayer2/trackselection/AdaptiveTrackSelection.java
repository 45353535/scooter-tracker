...
public class AdaptiveTrackSelection extends BaseTrackSelection {
    ...
    public AdaptiveTrackSelection(TrackGroup trackGroup, int[] iArr, BandwidthMeter bandwidthMeter) {
        this(trackGroup, iArr, bandwidthMeter, 10000L, U2.f41836h, U2.f41836h, 0.75f, 0.75f, 2000L, Clock.DEFAULT);
    }
    ...
    private long minDurationForQualityIncreaseUs(long j10) {
        return (j10 == -9223372036854775807L || j10 > this.minDurationForQualityIncreaseUs) ? this.minDurationForQualityIncreaseUs : (long) (j10 * this.bufferedFractionToLiveEdgeForQualityIncrease);
    }
