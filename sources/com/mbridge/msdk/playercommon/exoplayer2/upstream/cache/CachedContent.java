...
final class CachedContent {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj != null && CachedContent.class == obj.getClass()) {
            ...
            if (this.f50071id == cachedContent.f50071id && this.key.equals(cachedContent.key) && this.cachedSpans.equals(cachedContent.cachedSpans) && this.metadata.equals(cachedContent.metadata)) {
                return true;
            }
        }
        return false;
    ...
    public int headerHashCode(int i10) {
        int i11;
        int iHashCode;
        int iHashCode2 = (this.f50071id * 31) + this.key.hashCode();
        if (i10 < 2) {
    ...
    public SimpleCacheSpan touch(SimpleCacheSpan simpleCacheSpan) throws Cache.CacheException {
        ...
        SimpleCacheSpan simpleCacheSpanCopyWithUpdatedLastAccessTime = simpleCacheSpan.copyWithUpdatedLastAccessTime(this.f50071id);
    ...
    public void writeToStream(DataOutputStream dataOutputStream) throws IOException {
        dataOutputStream.writeInt(this.f50071id);
