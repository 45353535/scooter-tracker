...
final class TtmlNode {
    ...
    public boolean isActive(long j10) {
        ...
        if (j11 == -9223372036854775807L && this.endTimeUs == -9223372036854775807L) {
            return true;
        }
        if (j11 <= j10 && this.endTimeUs == -9223372036854775807L) {
            return true;
        }
        if (j11 != -9223372036854775807L || j10 >= this.endTimeUs) {
