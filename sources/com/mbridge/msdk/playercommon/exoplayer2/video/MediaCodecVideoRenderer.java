...
public class MediaCodecVideoRenderer extends MediaCodecRenderer {
    ...
    */
    ...
    protected void onStreamChanged(Format[] formatArr, long j10) throws ExoPlaybackException {
    ...
    protected int supportsFormat(MediaCodecSelector mediaCodecSelector, DrmSessionManager<FrameworkMediaCrypto> drmSessionManager, Format format) throws MediaCodecUtil.DecoderQueryException {
        ...
        if (zIsCodecSupported && (i10 = format.width) > 0 && (i11 = format.height) > 0) {
            if (Util.SDK_INT >= 21) {
                ...
                if (!z11) {
                    Log.d(TAG, "FalseCheck [legacyFrameSize, " + format.width + "x" + format.height + "] [" + Util.DEVICE_DEBUG_INFO + C4240b4.j.f42674e);
                }
