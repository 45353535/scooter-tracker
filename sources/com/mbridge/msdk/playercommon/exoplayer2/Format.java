...
public final class Format implements Parcelable {
    ...
    public Format copyWithMaxInputSize(int i10) {
        return new Format(this.f50054id, this.containerMimeType, this.sampleMimeType, this.codecs, this.bitrate, i10, this.width, this.height, this.frameRate, this.rotationDegrees, this.pixelWidthHeightRatio, this.projectionData, this.stereoMode, this.colorInfo, this.channelCount, this.sampleRate, this.pcmEncoding, this.encoderDelay, this.encoderPadding, this.selectionFlags, this.language, this.accessibilityChannel, this.subsampleOffsetUs, this.initializationData, this.drmInitData, this.metadata);
    }
    ...
    public String toString() {
        return "Format(" + this.f50054id + ", " + this.containerMimeType + ", " + this.sampleMimeType + ", " + this.bitrate + ", " + this.language + ", [" + this.width + ", " + this.height + ", " + this.frameRate + "], [" + this.channelCount + ", " + this.sampleRate + "])";
    }

    @Override // android.os.Parcelable
    public void writeToParcel(Parcel parcel, int i10) {
        parcel.writeString(this.f50054id);
    ...
    Format(Parcel parcel) {
        this.f50054id = parcel.readString();
