...
public class PlayerView extends LinearLayout {
    ...
    private class MySurfaceHoldeCallback implements SurfaceHolder.Callback {
        ...
        public void surfaceChanged(SurfaceHolder surfaceHolder, int i10, int i11, int i12) {
            try {
                ...
                if (PlayerView.this.mIsSurfaceHolderDestoryed && !PlayerView.this.mIsCovered && !PlayerView.this.isComplete() && !PlayerView.this.isBTVideo && !b.f48549f) {
    ...
    public JSONObject buildH5JsonObject(int i10) {
        ...
        try {
            ...
            try {
                jSONObject2.put(a.f48596h, v0.b(c.n().d(), this.xInScreen));
                jSONObject2.put(a.f48597i, v0.b(c.n().d(), this.yInScreen));
                ...
                jSONObject2.put(a.f48599k, this.orientation);
