...
public class BaseRewardSignalH5 extends a {
    ...
    public void getEndScreenInfo(Object obj, String str) {
        ...
        try {
            IJSFactory iJSFactory = this.f52801a;
            if (iJSFactory != null) {
    ...
    public void handlerPlayableException(Object obj, String str) {
        try {
            if (this.f52801a == null || TextUtils.isEmpty(str)) {
                return;
            }
            ...
            this.f52801a.getIJSRewardVideoV1().handlerPlayableException(strOptString);
        } catch (Throwable th2) {
    ...
    public void initialize(Context context, WindVaneWebView windVaneWebView) {
        if (context instanceof IJSFactory) {
            this.f52801a = (IJSFactory) context;
        }
    }
    ...
    public void install(Object obj, String str) {
        try {
            if (this.f52801a != null) {
                ...
                if (this.f52801a.getJSContainerModule().endCardShowing()) {
                    this.f52801a.getJSCommon().click(3, str);
                } else {
                    this.f52801a.getJSCommon().click(1, str);
                }
            }
        } catch (Throwable th2) {
    ...
    public void notifyCloseBtn(Object obj, String str) {
        try {
            ...
            this.f52801a.getIJSRewardVideoV1().notifyCloseBtn(iOptInt);
        } catch (Throwable th2) {
    ...
    public void setOrientation(Object obj, String str) {
        try {
            ...
            this.f52801a.getIJSRewardVideoV1().a(strOptString);
        } catch (Throwable th2) {
            q0.b("JS-Reward-Communication", "setOrientation", th2);
        }
    }
    ...
    public void toggleCloseBtn(Object obj, String str) {
        try {
            ...
            this.f52801a.getIJSRewardVideoV1().toggleCloseBtn(iOptInt);
        } catch (Throwable th2) {
    ...
    public void triggerCloseBtn(Object obj, String str) {
        try {
            ...
            f.a().b(obj, a(0));
            this.f52801a.getIJSRewardVideoV1().triggerCloseBtn(new JSONObject(str).optString("state"));
