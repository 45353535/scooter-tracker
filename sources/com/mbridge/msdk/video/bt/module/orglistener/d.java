...
public class d extends b {
    ...
    private com.mbridge.msdk.videocommon.setting.c f52255d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private String f52256e;

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private String f52257f;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    private boolean f52258g;

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    private Context f52259h;

    /* JADX INFO: renamed from: i, reason: collision with root package name */
    private boolean f52260i = false;

    /* JADX INFO: renamed from: j, reason: collision with root package name */
    private boolean f52261j = false;

    /* JADX INFO: renamed from: k, reason: collision with root package name */
    private boolean f52262k = false;
    ...
    */
    ...
    public void a(com.mbridge.msdk.foundation.same.report.metrics.c cVar) {
        super.a(cVar);
        if (this.f52254c == null || this.f52260i) {
            return;
        }
        this.f52260i = true;
        b();
        this.f52254c.a(cVar);
        this.f52254c.a(2, this.f52257f, this.f52256e);
    }
    ...
    public void a(com.mbridge.msdk.foundation.same.report.metrics.c cVar, boolean z10, com.mbridge.msdk.videocommon.entity.c cVar2) {
        ...
        h hVar = this.f52254c;
        if (hVar == null || this.f52262k) {
            return;
        }
        this.f52262k = true;
        hVar.a(7, this.f52257f, this.f52256e);
        this.f52254c.a(cVar, z10, cVar2);
    }
    ...
    public void a(com.mbridge.msdk.foundation.same.report.metrics.c cVar, String str) {
        super.a(cVar, str);
        if (this.f52254c == null || this.f52261j) {
            return;
        }
        this.f52261j = true;
        a();
        this.f52254c.a(cVar, str);
        this.f52254c.a(4, this.f52257f, this.f52256e);
    }
