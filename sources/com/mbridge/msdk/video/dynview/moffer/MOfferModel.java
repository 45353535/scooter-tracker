...
public class MOfferModel implements NoProGuard {
    ...
    class g implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            try {
                if (MOfferModel.this.mCampaignUnit == null || MOfferModel.this.mCampaignUnit.ads == null || MOfferModel.this.mCampaignUnit.ads.size() <= 0 || (campaignEx = MOfferModel.this.mCampaignUnit.ads.get(this.f52328a)) == null) {
                    return;
                }
                ...
                com.mbridge.msdk.video.dynview.request.a.a(com.mbridge.msdk.foundation.controller.c.n().d(), campaignEx, MOfferModel.this.mUnitId, this.f52329b);
            } catch (Exception e10) {
                q0.b(MOfferModel.TAG, e10.getMessage());
            }
        }
    ...
    class h implements com.mbridge.msdk.foundation.same.image.c {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ RoundImageView f52331a;

        h(RoundImageView roundImageView) {
            this.f52331a = roundImageView;
        }
        ...
        public void onSuccessLoad(Bitmap bitmap, String str) {
            try {
                if (this.f52331a != null && bitmap != null && !bitmap.isRecycled()) {
                    this.f52331a.setBorderRadius(13);
                    this.f52331a.setImageBitmap(bitmap);
                }
    ...
    private void buildRequestParams(CampaignEx campaignEx) {
        ...
        com.mbridge.msdk.foundation.same.net.utils.b.a(this.mParam, EidRequestBuilder.REQUEST_FIELD_EMAIL, Arrays.toString(new String[]{id2}));
