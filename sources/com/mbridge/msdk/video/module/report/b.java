...
public class b {
    ...
    public static HashMap<String, ArrayList<String>> f52799a = new HashMap<>();
    ...
    public static void a(Context context, CampaignEx campaignEx) {
        ...
        ArrayList<String> arrayList = f52799a.get(campaignUnitId);
        if (arrayList == null) {
            arrayList = new ArrayList<>();
            f52799a.put(campaignUnitId, arrayList);
        }
    ...
    private static String a(String str, com.mbridge.msdk.foundation.same.net.wrapper.e eVar) {
        ...
        if (!str.endsWith("?") && !str.endsWith(C4240b4.j.f42670c)) {
            StringBuilder sb2 = new StringBuilder();
            sb2.append(str);
            sb2.append(str.contains("?") ? C4240b4.j.f42670c : "?");
            str = sb2.toString();
        }
        return str + strTrim;
    }
