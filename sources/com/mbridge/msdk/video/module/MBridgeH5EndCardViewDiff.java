...
public abstract class MBridgeH5EndCardViewDiff extends MBridgeBaseView implements h, b, j {
    ...
    public void open(String str) {
        try {
            String clickURL = this.f52527b.getClickURL();
            if (!TextUtils.isEmpty(str)) {
                this.f52527b.setClickURL(str);
                reportOpen(str);
            }
            this.f52527b.setClickTempSource(2);
            this.f52527b.setClickType(2);
            this.f52527b.setTriggerClickSource(2);
            a aVar = new a(getContext(), this.unitId);
            aVar.a(this);
            aVar.a(this.f52527b);
            this.f52527b.setClickURL(clickURL);
