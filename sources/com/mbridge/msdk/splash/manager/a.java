...
public class a {
    ...
    class C0568a implements com.mbridge.msdk.foundation.feedback.a {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ com.mbridge.msdk.splash.middle.a f50692a;

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        final /* synthetic */ int f50693b;

        C0568a(com.mbridge.msdk.splash.middle.a aVar, int i10) {
            this.f50692a = aVar;
            this.f50693b = i10;
        }
    ...
    protected void a(com.mbridge.msdk.splash.middle.a aVar, CampaignEx campaignEx, com.mbridge.msdk.dycreator.viewdata.base.a aVar2) {
        if (campaignEx != null) {
            ...
            if (aVarB != null) {
                aVarB.a(campaignEx);
                com.mbridge.msdk.foundation.feedback.b.b().a(campaignUnitId + "_" + requestId, new C0568a(aVar, currentCountDown));
                aVarB.p();
            }
        }
    }
