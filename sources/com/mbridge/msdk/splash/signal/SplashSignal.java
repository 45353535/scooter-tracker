...
public class SplashSignal extends AbsFeedBackForH5 {
    ...
    private static String f50883h = "SplashSignal";

    /* JADX INFO: renamed from: i, reason: collision with root package name */
    public static final /* synthetic */ int f50884i = 0;
    ...
    public void handlerH5Exception(Object obj, String str) {
        if (obj != null) {
            try {
                ...
                q0.b(f50883h, "handlerH5Exception", th2);
            }
        }
    }
    ...
    public void init(Object obj, String str) {
        q0.b(f50883h, MobileAdsBridgeBase.initializeMethodName + str);
        b bVar = this.f50885g;
        if (bVar != null) {
            bVar.init(obj, str);
        }
    ...
    public void initialize(Context context, WindVaneWebView windVaneWebView) {
        ...
        try {
            ...
            this.f50885g = (b) windVaneWebView.getObject();
        } catch (Throwable th2) {
            q0.b(f50883h, MobileAdsBridgeBase.initializeMethodName, th2);
        }
    }
    ...
    public void onSignalCommunication(Object obj, String str) {
        try {
            q0.b(f50883h, "onSignalCommunication");
            b bVar = this.f50885g;
            if (bVar != null) {
                bVar.c(obj, str);
            }
        } catch (Throwable th2) {
            q0.b(f50883h, "onSignalCommunication", th2);
        }
    }

    public void openURL(Object obj, String str) {
        q0.b(f50883h, "openURL" + str);
        b bVar = this.f50885g;
        if (bVar != null) {
    ...
    public void pauseCountDown(Object obj, String str) {
        try {
            q0.b(f50883h, "pauseCountDown");
            b bVar = this.f50885g;
            if (bVar != null) {
                bVar.e(obj, str);
            }
        } catch (Throwable th2) {
            q0.b(f50883h, "pauseCountDown", th2);
        }
    }
    ...
    public void reportUrls(Object obj, String str) {
        try {
            q0.b(f50883h, "reportUrls");
            b bVar = this.f50885g;
            if (bVar != null) {
                bVar.reportUrls(obj, str);
            }
        } catch (Throwable th2) {
            q0.b(f50883h, "reportUrls", th2);
        }
    }

    public void resetCountdown(Object obj, String str) {
        q0.b(f50883h, "resetCountdown" + str);
        b bVar = this.f50885g;
        if (bVar != null) {
            bVar.a(obj, str);
        }
    ...
    public void resumeCountDown(Object obj, String str) {
        try {
            q0.b(f50883h, "resumeCountDown");
            b bVar = this.f50885g;
            if (bVar != null) {
                bVar.f(obj, str);
            }
        } catch (Throwable th2) {
            q0.b(f50883h, "resumeCountDown", th2);
        }
    }

    public void sendImpressions(Object obj, String str) {
        try {
            q0.b(f50883h, "sendImpressions");
            b bVar = this.f50885g;
            if (bVar != null) {
                bVar.d(obj, str);
            }
        } catch (Throwable th2) {
            q0.b(f50883h, "sendImpressions", th2);
        }
    }

    public void toggleCloseBtn(Object obj, String str) {
        q0.b(f50883h, "toggleCloseBtn" + str);
        b bVar = this.f50885g;
        if (bVar != null) {
    ...
    public void triggerCloseBtn(Object obj, String str) {
        q0.b(f50883h, "triggerCloseBtn" + str);
        b bVar = this.f50885g;
        if (bVar != null) {
