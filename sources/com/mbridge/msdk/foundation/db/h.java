...
public class h extends a<Campaign> {
    ...
    private static final String f48358a = "com.mbridge.msdk.foundation.db.h";

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static h f48359b;
    ...
    private synchronized void c(String str) {
        try {
            ...
            q0.c(f48358a, "resetTimeAndTimestamp error");
        }
    }

    /* JADX WARN: Removed duplicated region for block: B:42:0x00b0 A[EXC_TOP_SPLITTER, PHI: r1
    ...
    */
    ...
    public boolean a(String str, int i10) {
        ...
        try {
            ...
            try {
                q0.c(f48358a, "isOverCap is error" + th2);
                if (cursorRawQuery != null) {
                }
                return z10;
            } catch (Throwable th3) {
