...
public class e extends com.mbridge.msdk.foundation.db.a<Campaign> {
    ...
    private final String f48344j;

    /* JADX INFO: renamed from: k, reason: collision with root package name */
    private final String f48345k;
    ...
    private final String f48348n;

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    private final String f48349o;

    /* JADX INFO: renamed from: p, reason: collision with root package name */
    private final String f48350p;

    /* JADX INFO: renamed from: q, reason: collision with root package name */
    private final String f48351q;

    class a implements Runnable {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ List f48352a;
        ...
        public void run() {
            ...
            while (it.hasNext()) {
                e.this.a((CampaignEx) it.next(), this.f48353b, 0);
            }
        }
    }
    ...
    protected e(f fVar) {
        ...
        this.f48336b = "lrid";
        this.f48337c = "cid";
        this.f48338d = CampaignEx.JSON_KEY_PLCT;
        this.f48339e = CampaignEx.JSON_KEY_PLCTB;
        this.f48340f = "timestamp";
        this.f48341g = "ridCount";
        this.f48342h = " WHERE ";
        this.f48343i = " AND ";
        this.f48344j = "SELECT ";
        this.f48345k = ProxyConfig.MATCH_ALL_SCHEMES;
        this.f48346l = " FROM ";
        this.f48347m = " AND readyState = '0'";
        this.f48348n = " AND is_bid_campaign = 1";
        this.f48349o = " order by ts ASC";
        this.f48350p = " group by request_id";
        this.f48351q = " group by bid_token";
    }
    ...
    /* JADX WARN: Removed duplicated region for block: B:34:0x00f0 A[PHI: r2
    ...
    */
    public synchronized int a(java.lang.String r11, long r12) throws java.lang.Throwable {
        ...
        L21:
            ...
            goto L6c
        L25:
            long r2 = r0.b0()     // Catch: java.lang.Throwable -> L66 java.lang.Exception -> L69
