...
public class a {
    ...
    private static String f48366a = "FrequencyDaoMiddle";

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static a f48367b = null;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static String f48368c = "FrequencyDaoMiddle";

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static JSONArray f48369d = new JSONArray();
    ...
    private void c() {
        try {
            String str = (String) y0.a(c.n().d(), f48368c, f48369d.toString());
            if (TextUtils.isEmpty(str)) {
                return;
            }
            f48369d = new JSONArray(str);
        } catch (Exception e10) {
            q0.b(f48366a, e10.getMessage());
        }
    }
    ...
    private void d() {
        try {
            if (f48369d != null) {
                y0.b(c.n().d(), f48368c, f48369d.toString());
            }
        } catch (Exception e10) {
            q0.b(f48366a, e10.getMessage());
        }
    ...
    public void a(g gVar) {
        ...
        if (f48369d == null) {
            f48369d = new JSONArray();
        }
        f48369d.put(jSONObjectA);
        d();
    }
    ...
    public void a(String str) {
        if (f48369d != null) {
            ...
            for (int i10 = 0; i10 < f48369d.length(); i10++) {
                try {
                    JSONObject jSONObject = f48369d.getJSONObject(i10);
                    if (jSONObject != null) {
