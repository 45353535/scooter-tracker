...
public class d {
    ...
    private static final class a implements com.mbridge.msdk.foundation.same.report.crashreport.a {
        ...
        class RunnableC0519a implements Runnable {
            ...
            final /* synthetic */ StackTraceElement[] f48795b;

            RunnableC0519a(String str, StackTraceElement[] stackTraceElementArr) {
                this.f48794a = str;
                this.f48795b = stackTraceElementArr;
            }

            @Override // java.lang.Runnable
            public void run() {
                a.c(this.f48794a, this.f48795b);
            }
        }
        ...
        public void a(String str, StackTraceElement[] stackTraceElementArr) {
            ...
            long unused = d.f48793a = System.currentTimeMillis();
            com.mbridge.msdk.foundation.same.threadpool.a.e().execute(new RunnableC0519a(str, stackTraceElementArr));
        }
    }
