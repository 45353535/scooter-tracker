...
public class m extends com.mbridge.msdk.tracker.network.toolbox.a {
    ...
    private static final AtomicInteger f48831b = new AtomicInteger(1);

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private final byte f48832a;
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        byteBufferWrap.put(this.f48832a);
                        byte[] bArrB = tVar.b();
                        ...
                        byteBufferWrap.putShort((short) f48831b.getAndIncrement());
                        if (bArrB == null || bArrB.length == 0) {
