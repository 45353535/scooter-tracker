...
public class d {
    ...
    private static d f48882e;

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private volatile m f48883a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private Map<String, e> f48884b = new HashMap();

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private LinkedHashMap<String, c> f48885c = new LinkedHashMap<>();

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private Map<String, e> f48886d = new HashMap();

    private d() {
        if (this.f48883a == null) {
            this.f48883a = m.b("metrics_sdk", com.mbridge.msdk.foundation.controller.c.n().d(), a());
        }
        JSONObject jSONObjectB = com.mbridge.msdk.foundation.same.report.c.b();
        if (this.f48883a != null) {
            this.f48883a.a(jSONObjectB);
            this.f48883a.h();
        }
    }
    ...
    public e c(String str) {
        ...
        e eVar = new e();
        try {
            if (!TextUtils.isEmpty(str) && (map = this.f48884b) != null && map.containsKey(str)) {
                return this.f48884b.get(str);
            }
        } catch (Exception e10) {
            if (MBridgeConstans.DEBUG) {
                e10.printStackTrace();
    ...
    public void e(String str) {
        try {
            ...
            if (jSONObjectA != null && jSONObjectA.length() != 0) {
                String strOptString = jSONObjectA.optString(C4240b4.i.W);
    ...
    public void b(String str, String str2) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(str3) && (linkedHashMap = this.f48885c) != null && linkedHashMap.containsKey(str3)) {
                this.f48885c.remove(str3);
            }
        } catch (Exception e10) {
            if (MBridgeConstans.DEBUG) {
                e10.printStackTrace();
    ...
    private p a(int i10) {
        if (i10 == 1) {
            return new p(new com.mbridge.msdk.foundation.same.report.m((byte) 2), com.mbridge.msdk.foundation.same.net.utils.d.h().f48737j, com.mbridge.msdk.foundation.same.net.utils.d.h().f48741n);
        }
        return new p(new h(), com.mbridge.msdk.foundation.same.net.utils.d.h().f48728d, 0);
    }
    ...
    public void a(String str, CampaignEx campaignEx, e eVar) {
        ...
        if (cVar != null) {
            if (Arrays.asList(b.f48848h).contains(str)) {
                cVar = a(cVar);
            }
        } else {
            cVar = new c();
    ...
    public void a(String str, c cVar) {
        try {
            ...
            if (map != null && map.containsKey(str) && cVar != null) {
                cVar.a(str, this.f48886d.get(str));
            }
    ...
    private void a(String str, c cVar, com.mbridge.msdk.foundation.same.report.metrics.callback.a aVar) {
        try {
            if (Arrays.asList(b.f48843c).contains(str)) {
                cVar.d(str);
            }
            Map<String, e> map = this.f48886d;
