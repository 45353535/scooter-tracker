...
public class FastKV {
    ...
    private final c logger = c0.f48959b;
    ...
    private static class d implements Comparable<d> {
        ...
        public int compareTo(d dVar) {
            return this.f48913b - dVar.f48913b;
        }
    }
    ...
    private void addOrUpdate(String str, Object obj, byte[] bArr, r rVar, byte b10) {
        ...
        } else if (rVar.f49053b || rVar.f49056e != bArr.length) {
            updateObject(str, obj, bArr, rVar);
        } else {
            updateBytes(rVar.f49010a, bArr);
            rVar.f49055d = obj;
        }
        checkIfCommit();
    }
    ...
    private void clearData() {
        ...
        if (b0Var == null || b0Var.f48943a.length != PAGE_SIZE) {
    ...
    private void ensureSize(int i10) {
        int length = this.fastBuffer.f48943a.length;
        ...
        if (i11 >= length) {
            ...
            System.arraycopy(this.fastBuffer.f48943a, 0, bArr, 0, this.dataEnd);
            this.fastBuffer.f48943a = bArr;
    ...
    private void fastPutString(String str, String str2, q qVar) {
        ...
        if (qVar == null) {
            ...
            int i12 = qVar.f49010a;
            int i13 = i12 - qVar.f49054c;
            int i14 = qVar.f49056e;
            boolean z10 = false;
            if (i14 == iB) {
                this.checksum = this.fastBuffer.a(i12, i14) ^ this.checksum;
                if (iB == str2.length()) {
                    str2.getBytes(0, iB, this.fastBuffer.f48943a, qVar.f49010a);
                } else {
                    b0 b0Var = this.fastBuffer;
                    b0Var.f48944b = qVar.f49010a;
                    b0Var.c(str2);
                }
                this.updateStart = qVar.f49010a;
                this.updateSize = iB;
            } else {
                ...
                byte[] bArr = b0Var2.f48943a;
                System.arraycopy(bArr, qVar.f49054c + 1, bArr, b0Var2.f48944b, i15);
                this.fastBuffer.f48944b += i15;
                putStringValue(str2, iB);
                remove((byte) 6, qVar.f49054c, qVar.f49010a + qVar.f49056e);
                str = qVar.f49053b ? (String) qVar.f49055d : null;
                qVar.f49053b = false;
                int i16 = this.updateStart;
                qVar.f49054c = i16;
                qVar.f49010a = i16 + i13;
                qVar.f49056e = iB;
                z10 = true;
            }
            qVar.f49055d = str2;
    ...
    private byte[] getArrayFromFile(i iVar) {
        try {
            byte[] bArrC = d1.c(new File(this.path + this.name, (String) iVar.f49055d));
    ...
    private Object getObjectFromFile(p pVar) {
        try {
            byte[] bArrC = d1.c(new File(this.path + this.name, (String) pVar.f49055d));
            if (bArrC == null) {
    ...
    private String getStringFromFile(q qVar) {
        try {
            byte[] bArrC = d1.c(new File(this.path + this.name, (String) qVar.f49055d));
    ...
    private boolean isABFileEqual() {
        ...
        this.bBuffer.rewind();
        this.bBuffer.get(b0Var.f48943a, 0, this.dataEnd);
        byte[] bArr = this.fastBuffer.f48943a;
        byte[] bArr2 = b0Var.f48943a;
            ...
            if (d1.d(file) && d1.d(file2)) {
                ...
                try {
                    ...
                    if (i10 < 0) {
                        ...
                        this.aBuffer.rewind();
                        j10 = 12;
                        this.aBuffer.get(this.fastBuffer.f48943a, 0, this.dataEnd);
                    ...
                    if (i11 >= 0 && i11 <= length2 - j10) {
                        ...
                        clearInvalid();
                        this.dataEnd = i11 + 12;
                        if (this.fastBuffer.f48943a.length != this.bBuffer.capacity()) {
                            this.fastBuffer = new b0(this.bBuffer.capacity());
                        }
                        this.bBuffer.rewind();
                        this.bBuffer.get(this.fastBuffer.f48943a, 0, this.dataEnd);
    ...
    private boolean loadWithBlockingIO(File file) throws IOException {
        ...
        if (length != 0 && length <= 536870912) {
            ...
            b0 b0Var = this.fastBuffer;
            if (b0Var == null || b0Var.f48943a.length != newCapacity) {
                b0Var = new b0(new byte[newCapacity]);
                this.fastBuffer = b0Var;
            } else {
                b0Var.f48944b = 0;
            }
            d1.a(file, b0Var.f48943a, i10);
            int iD = b0Var.d();
            long jE = b0Var.e();
            this.dataEnd = iD + 12;
    ...
    private void mergeInvalids() {
        ...
        while (size > 0) {
            ...
            if (dVar.f48913b == dVar2.f48912a) {
                dVar2.f48912a = dVar.f48912a;
    ...
    */
    ...
    private void putKey(String str, int i10) {
        ...
        b0 b0Var = this.fastBuffer;
        str.getBytes(0, i10, b0Var.f48943a, b0Var.f48944b);
        this.fastBuffer.f48944b += i10;
    }
    ...
    private int saveArray(String str, byte[] bArr, byte b10) {
        ...
        return wrapArray(str, bArr2, (byte) (b10 | SignedBytes.MAX_POWER_OF_TWO));
    }
    ...
    private void syncABBuffer(MappedByteBuffer mappedByteBuffer) {
        ...
        if (i10 != 0) {
            mappedByteBuffer.put(i10, this.fastBuffer.f48943a[i10]);
        }
        if (this.updateSize != 0) {
            mappedByteBuffer.position(this.updateStart);
            mappedByteBuffer.put(this.fastBuffer.f48943a, this.updateStart, this.updateSize);
        }
    }
    ...
    private void updateBoolean(byte b10, int i10) {
        ...
        this.fastBuffer.f48943a[i10] = b10;
    }
    ...
    private void updateObject(String str, Object obj, byte[] bArr, r rVar) {
        ...
        if (iSaveArray != 0) {
            String str2 = rVar.f49053b ? (String) rVar.f49055d : null;
            remove(rVar.a(), rVar.f49054c, rVar.f49010a + rVar.f49056e);
            String str3 = this.tempExternalName;
            boolean z10 = str3 != null;
            rVar.f49054c = this.updateStart;
            rVar.f49010a = iSaveArray;
            rVar.f49053b = z10;
            if (z10) {
                rVar.f49055d = str3;
                rVar.f49056e = 32;
    ...
    private boolean writeToABFile(b0 b0Var) {
        int length = b0Var.f48943a.length;
        File file = new File(this.path, this.name + A_SUFFIX);
        File file2 = new File(this.path, this.name + B_SUFFIX);
        try {
            if (!d1.d(file) || !d1.d(file2)) {
            ...
            this.bBuffer = map2;
            map2.order(byteOrder);
            this.aBuffer.put(b0Var.f48943a, 0, this.dataEnd);
            this.bBuffer.put(b0Var.f48943a, 0, this.dataEnd);
            return true;
        } catch (Exception e10) {
            error(e10);
            return false;
        ...
        try {
            try {
                ...
                if (d1.d(file)) {
                    ...
                    randomAccessFile.write(this.fastBuffer.f48943a, 0, this.dataEnd);
    ...
    void gc(int i10) {
        ...
        int i17 = size - 1;
        int i18 = this.dataEnd - this.invalids.get(i17).f48912a;
        int[] iArr = new int[(i18 > 0 ? size : i17) << 1];
        int i19 = dVar.f48913b;
        int i20 = dVar.f48912a;
        int i21 = 1;
        while (i21 < size) {
            d dVar2 = this.invalids.get(i21);
            boolean z12 = z10;
            int i22 = dVar2.f48913b - i20;
            byte[] bArr = this.fastBuffer.f48943a;
        ...
        if (i18 > 0) {
            byte[] bArr2 = this.fastBuffer.f48943a;
        ...
        if (this.writingMode == 0) {
            ...
            this.aBuffer.put(this.fastBuffer.f48943a, i11, i15);
            this.aBuffer.putInt(0, i14);
            this.bBuffer.putInt(0, i14);
            this.bBuffer.putLong(4, this.checksum);
            this.bBuffer.position(i11);
            this.bBuffer.put(this.fastBuffer.f48943a, i11, i15);
        } else {
        ...
        int i25 = i13 + i10;
        if (this.fastBuffer.f48943a.length - i25 > TRUNCATE_THRESHOLD) {
            truncate(i25);
        }
        info(GC_FINISH);
    }
    ...
    public synchronized Map<String, Object> getAll() {
        ...
        for (Map.Entry<String, j> entry : this.data.entrySet()) {
            ...
            switch (value.a()) {
                case 1:
                    objValueOf = Boolean.valueOf(((k) value).f49013b);
                    break;
                case 2:
                    objValueOf = Integer.valueOf(((n) value).f49040b);
                    break;
                case 3:
                    objValueOf = Float.valueOf(((m) value).f49019b);
                    break;
                case 4:
                    objValueOf = Long.valueOf(((o) value).f49044b);
                    break;
                case 5:
                    objValueOf = Double.valueOf(((l) value).f49018b);
                    break;
                case 6:
                    q qVar = (q) value;
                    objValueOf = qVar.f49053b ? getStringFromFile(qVar) : qVar.f49055d;
                    break;
                case 7:
                    i iVar = (i) value;
                    objValueOf = iVar.f49053b ? getArrayFromFile(iVar) : iVar.f49055d;
                    break;
                case 8:
                    p pVar = (p) value;
                    objValueOf = pVar.f49053b ? getObjectFromFile(pVar) : pVar.f49055d;
                    break;
                default:
                    objValueOf = null;
                    break;
    ...
    public synchronized long getLong(String str) {
        ...
        return oVar == null ? 0L : oVar.f49044b;
    }
    ...
    public synchronized <T> T getObject(String str) {
        try {
            ...
            if (pVar != null) {
                return pVar.f49053b ? (T) getObjectFromFile(pVar) : (T) pVar.f49055d;
            }
            return null;
        } catch (Throwable th2) {
            throw th2;
    ...
    public synchronized void putBoolean(String str, boolean z10) {
        try {
            ...
            if (kVar == null) {
                ...
                checkIfCommit();
            } else if (kVar.f49013b != z10) {
                kVar.f49013b = z10;
                updateBoolean(z10 ? (byte) 1 : (byte) 0, kVar.f49010a);
                checkIfCommit();
            }
        } catch (Throwable th2) {
            throw th2;
            ...
            try {
                ...
                if (lVar != null) {
                    if (lVar.f49018b != d10) {
                        ...
                        long jDoubleToRawLongBits2 = Double.doubleToRawLongBits(lVar.f49018b) ^ jDoubleToRawLongBits;
                        lVar.f49018b = d10;
                        updateInt64(jDoubleToRawLongBits, jDoubleToRawLongBits2, lVar.f49010a);
                        checkIfCommit();
                    }
                }
                try {
    ...
    public synchronized void putFloat(String str, float f10) {
        try {
            ...
            if (mVar == null) {
                ...
                checkIfCommit();
            } else if (mVar.f49019b != f10) {
                int iFloatToRawIntBits = Float.floatToRawIntBits(f10);
                long jFloatToRawIntBits = ((long) (Float.floatToRawIntBits(mVar.f49019b) ^ iFloatToRawIntBits)) & 4294967295L;
                mVar.f49019b = f10;
                updateInt32(iFloatToRawIntBits, jFloatToRawIntBits, mVar.f49010a);
                checkIfCommit();
            }
        } catch (Throwable th2) {
            throw th2;
    ...
    public synchronized void putInt(String str, int i10) {
        try {
            ...
            if (nVar == null) {
                ...
                b0 b0Var = this.fastBuffer;
                int i11 = b0Var.f48944b;
                b0Var.g(i10);
                updateChange();
                this.data.put(str, new n(i11, i10));
                checkIfCommit();
            } else {
                int i12 = nVar.f49040b;
                if (i12 != i10) {
                    nVar.f49040b = i10;
                    updateInt32(i10, ((long) (i12 ^ i10)) & 4294967295L, nVar.f49010a);
                    checkIfCommit();
                }
            }
        } catch (Throwable th2) {
    ...
    public synchronized void putLong(String str, long j10) throws Throwable {
        ...
        try {
            try {
                ...
                if (oVar != null) {
                    long j11 = oVar.f49044b;
                    if (j11 != j10) {
                        long j12 = j10 ^ j11;
                        oVar.f49044b = j10;
                        updateInt64(j10, j12, oVar.f49010a);
                        checkIfCommit();
                    }
                }
                try {
        ...
        try {
            try {
                ...
                try {
                    ...
                    b0Var.c(strA);
                    b0Var.a(bArrA);
                    addOrUpdate(str, t10, b0Var.f48943a, (p) this.data.get(str), (byte) 8);
                } catch (Throwable th3) {
                    th2 = th3;
                    throw th2;
                }
    ...
    public synchronized void remove(String str) {
        try {
            ...
            if (jVar != null) {
                ...
                if (bA <= 5) {
                    int iB = b0.b(str);
                    int i10 = jVar.f49010a;
                    remove(bA, i10 - (iB + 2), i10 + TYPE_SIZE[bA]);
                } else {
                    r rVar = (r) jVar;
                    remove(bA, rVar.f49054c, rVar.f49010a + rVar.f49056e);
                    if (rVar.f49053b) {
                        str2 = (String) rVar.f49055d;
                    }
                }
                byte b10 = (byte) (bA | UnsignedBytes.MAX_POWER_OF_TWO);
                if (this.writingMode == 0) {
                    this.aBuffer.putLong(4, this.checksum);
    ...
    public synchronized byte[] getArray(String str, byte[] bArr) {
        try {
            ...
            if (iVar != null) {
                return iVar.f49053b ? getArrayFromFile(iVar) : (byte[]) iVar.f49055d;
            }
            return bArr;
        } catch (Throwable th2) {
            throw th2;
    ...
    public synchronized String getString(String str, String str2) {
        try {
            q qVar = (q) this.data.get(str);
            if (qVar != null) {
                return qVar.f49053b ? getStringFromFile(qVar) : (String) qVar.f49055d;
            }
            return str2;
        } catch (Throwable th2) {
            throw th2;
