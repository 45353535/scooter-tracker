...
public class v0 extends y {
    ...
    private static int f49084a = 1;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static volatile Boolean f49085b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final Pattern f49086c = Pattern.compile("[一-龥]");

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static Map<String, String> f49087d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private static Map<String, String> f49088e;

    class a implements View.OnClickListener {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ ImageView f49089a;

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        final /* synthetic */ CampaignEx f49090b;

        /* JADX INFO: renamed from: c, reason: collision with root package name */
        final /* synthetic */ com.mbridge.msdk.foundation.feedback.a f49091c;

        /* JADX INFO: renamed from: d, reason: collision with root package name */
        final /* synthetic */ int f49092d;

        a(ImageView imageView, CampaignEx campaignEx, com.mbridge.msdk.foundation.feedback.a aVar, int i10) {
            this.f49089a = imageView;
            this.f49090b = campaignEx;
            this.f49091c = aVar;
            this.f49092d = i10;
        }
        ...
        public void onClick(View view) {
            try {
                v0.a(this.f49090b, this.f49091c, this.f49092d, (String) this.f49089a.getTag());
            } catch (Exception e10) {
    ...
    public static boolean n(Context context) {
        try {
            NetworkInfo activeNetworkInfo = ((ConnectivityManager) context.getSystemService("connectivity")).getActiveNetworkInfo();
            if (activeNetworkInfo != null) {
                return X3.f42018b.equals(activeNetworkInfo.getTypeName().toLowerCase(Locale.US));
            }
            return false;
        } catch (Exception e10) {
            e10.printStackTrace();
    ...
    public static synchronized String d(String str) {
        ...
        Map<String, String> map = f49088e;
        if (map == null || !map.containsKey(str2)) {
            return null;
        }
        return f49088e.get(str2);
    }
    ...
    */
    ...
    public static final synchronized String e(String str) {
        ...
        if (zI0 && iMax != 0) {
            if (zB0 && (map = f49087d) != null && map.containsKey(str2)) {
                return f49087d.get(str2);
            }
            ...
            if (stackTrace != null && stackTrace.length > 0) {
                ...
                if (jSONObject != null && jSONObject.length() > 0) {
                    ...
                    if (zB0 && !TextUtils.isEmpty(strB)) {
                        if (f49087d == null) {
                            f49087d = new HashMap();
                        }
                        f49087d.put(str2, strB);
                    }
                    return strB;
                }
                return "";
    ...
    */
    ...
    public static synchronized void c(String str, String str2) {
        try {
            ...
            f49088e.put(com.mbridge.msdk.foundation.controller.c.n().b() + "_" + str, str2);
        } catch (Throwable th2) {
            throw th2;
        }
    }
    ...
    public static String a(CampaignEx campaignEx) {
        ...
        return TextUtils.isEmpty(privacyUrl) ? com.mbridge.msdk.foundation.same.net.utils.d.h().f48734g : privacyUrl;
    }
    ...
    public static String b(String str, String str2, String str3) {
        if (!TextUtils.isEmpty(str) && !TextUtils.isEmpty(str2) && !TextUtils.isEmpty(str3)) {
            try {
                ...
                JSONObject jSONObject2 = jSONObject.getJSONObject(C4240b4.i.G);
                if (jSONObject2 != null) {
    ...
    public static final int a() {
        if (f49085b == null) {
            try {
                f49085b = MIMManager.b().e();
            } catch (Exception e10) {
                q0.b("SameTools", e10.getMessage());
            }
        }
        if (f49085b != null) {
            return f49085b.booleanValue() ? 1 : 0;
        }
        return -1;
    }
