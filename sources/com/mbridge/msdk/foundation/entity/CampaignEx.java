...
public class CampaignEx extends DomainCampaignEx {
    ...
    private String f48380q;

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    private String f48381r;
    ...
    private int vst = -2;
    private int wtick = 0;
    private int showIndex = com.mbridge.msdk.foundation.same.report.metrics.a.f48833a;
    private int showType = com.mbridge.msdk.foundation.same.report.metrics.a.f48835c;
    ...
    public static final class a implements Serializable {
        ...
        private int f48387f = 0;

        /* JADX INFO: renamed from: g, reason: collision with root package name */
        private int f48388g = 0;

        /* JADX INFO: renamed from: h, reason: collision with root package name */
        private String f48389h = "";

        /* JADX INFO: renamed from: i, reason: collision with root package name */
        private String f48390i = "";

        /* JADX INFO: renamed from: j, reason: collision with root package name */
        private String f48391j = "";
    ...
    public static final class b implements Serializable {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public Map<Integer, String> f48393a;

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        public boolean f48394b = false;
        ...
        /* JADX INFO: renamed from: h, reason: collision with root package name */
        public boolean f48400h = false;

        /* JADX INFO: renamed from: i, reason: collision with root package name */
        public boolean f48401i = false;

        /* JADX INFO: renamed from: j, reason: collision with root package name */
        public boolean f48402j = false;

        /* JADX INFO: renamed from: k, reason: collision with root package name */
        public boolean f48403k = false;
    ...
    public static final class c implements Serializable {
        ...
        public static final class a implements Serializable {
            ...
            /* JADX INFO: renamed from: a, reason: collision with root package name */
            public List<String> f48411a = new ArrayList();
    ...
    public static j TrackingStr2Object(String str) {
        try {
            if (!TextUtils.isEmpty(str)) {
                ...
                jVar.j(processNativeVideoTrackingArray(jSONObject.optJSONArray("first_quartile")));
                jVar.l(processNativeVideoTrackingArray(jSONObject.optJSONArray("midpoint")));
                jVar.q(processNativeVideoTrackingArray(jSONObject.optJSONArray("third_quartile")));
                ...
                jVar.o(processNativeVideoTrackingArray(jSONObject.optJSONArray("resume")));
        ...
        try {
            ...
            try {
                ...
                if (jSONArrayOptJSONArray2 != null) {
                    ...
                    campaignEx2.setOmid(jSONObject.optString("omid"));
                }
    ...
    public void setendcard_url(String str) {
        ...
        if (TextUtils.isEmpty(this.mof_template_url) && (((cVar = this.rewardTemplateMode) == null || TextUtils.isEmpty(cVar.f48409e)) && !TextUtils.isEmpty(str) && str.contains(KEY_IS_CMPT_ENTRY))) {
            setCMPTEntryUrl(str);
        }
        ...
        try {
            ...
            try {
                ...
                if (!TextUtils.isEmpty(jSONObjectDealV5Temp.optString("rating"))) {
                    campaignEx2.setRating(Double.parseDouble(jSONObjectDealV5Temp.optString("rating", "0")));
                }
                ...
                campaignEx2.setCreativeId(jSONObjectDealV5Temp.optLong("creative_id"));
                ...
                JSONArray jSONArrayOptJSONArray2 = jSONObjectDealV5Temp.optJSONArray("omid");
                if (jSONArrayOptJSONArray2 != null) {
                    campaignEx2.setOmid(jSONArrayOptJSONArray2.toString());
                } else if (TextUtils.isEmpty(jSONObjectDealV5Temp.optString("omid"))) {
                    campaignEx2.setOmid(campaignEx);
                } else {
                    campaignEx2.setOmid(jSONObjectDealV5Temp.optString("omid"));
                }
                try {
