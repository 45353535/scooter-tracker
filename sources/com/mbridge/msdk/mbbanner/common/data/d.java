...
public class d {
    ...
    private static final String f49320a = c.class.getSimpleName();
    ...
    public static e a(Context context, String str, String str2, int i10, a aVar) {
        ...
        com.mbridge.msdk.foundation.same.net.utils.b.a(eVar, e.f48761h, strA);
        com.mbridge.msdk.foundation.same.net.utils.b.a(eVar, CampaignEx.JSON_KEY_AD_SOURCE_ID, "1");
        com.mbridge.msdk.foundation.same.net.utils.b.a(eVar, e.f48762i, str2);
        ...
        com.mbridge.msdk.foundation.same.net.utils.b.a(eVar, e.f48760g, strA2);
