...
public class BannerUtils {
    ...
    public static final /* synthetic */ int f49417a = 0;
    ...
    public static String getCloseIds(String str) {
        ...
        try {
            Map<String, List<com.mbridge.msdk.foundation.same.metadata.a>> map = b.f48621b;
        ...
        try {
            ...
            if (!TextUtils.isEmpty(str)) {
                ...
                if (jSONObjectOptJSONObject != null) {
                    strValueOf = String.valueOf(v0.a(c.n().d(), Integer.valueOf(jSONObjectOptJSONObject.getString(com.mbridge.msdk.foundation.same.a.f48596h)).intValue()));
                    strValueOf2 = String.valueOf(v0.a(c.n().d(), Integer.valueOf(jSONObjectOptJSONObject.getString(com.mbridge.msdk.foundation.same.a.f48597i)).intValue()));
                } else {
                    strValueOf = "-999";
                    strValueOf2 = "-999";
                }
