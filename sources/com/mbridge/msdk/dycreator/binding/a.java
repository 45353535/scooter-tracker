...
public class a implements View.OnClickListener {
    ...
    private com.mbridge.msdk.dycreator.viewdata.base.a f47992a;
    ...
    public void onClick(View view) {
        ...
        if (!(view instanceof MBCountDownView) || (aVar = this.f47992a) == null || aVar.getEffectData() == null || this.f47992a.getEffectData().isCanSkip()) {
            com.mbridge.msdk.dycreator.viewdata.base.a aVar2 = this.f47992a;
            if (aVar2 != null && (view instanceof MBRelativeLayout) && d.a(view, aVar2)) {
                com.mbridge.msdk.dycreator.viewdata.base.a aVar3 = this.f47992a;
                if (aVar3 instanceof MBSplashData) {
                    ...
                    ((MBSplashData) this.f47992a).setyInScreen(mBRelativeLayout.getyInScreen());
                    ((MBSplashData) this.f47992a).setClickType(1);
                }
            }
            com.mbridge.msdk.dycreator.viewdata.base.a aVar4 = this.f47992a;
            if (aVar4 != null && (view instanceof MBLinearLayout) && d.a(view, aVar4)) {
                com.mbridge.msdk.dycreator.viewdata.base.a aVar5 = this.f47992a;
                if (aVar5 instanceof MBSplashData) {
                    ...
                    ((MBSplashData) this.f47992a).setyInScreen(mBLinearLayout.getyInScreen());
                    ((MBSplashData) this.f47992a).setClickType(0);
                }
            }
            ...
            baseStrategyA.bindClickData(view, this.f47992a);
        }
    }
}
