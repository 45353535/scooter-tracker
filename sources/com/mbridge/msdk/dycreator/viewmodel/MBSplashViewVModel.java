...
public class MBSplashViewVModel implements BaseViewModel {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f48179a[EAction.CLOSE.ordinal()] = 2;
    ...
    public void setDynamicViewBackListener(DynamicViewBackListener dynamicViewBackListener) {
        if (dynamicViewBackListener != null) {
            this.f48177e = dynamicViewBackListener;
        }
    }
    ...
    public void setModelDataAndBind() {
        MBSplashData mBSplashData = new MBSplashData(this.f48178f);
        Context contextD = com.mbridge.msdk.foundation.controller.c.n().d();
        if (contextD != null) {
            DyOption dyOption = this.f48178f;
            if (dyOption != null) {
                CampaignEx campaignEx = dyOption.getCampaignEx();
                if (campaignEx != null) {
                    mBSplashData.setAdClickText(campaignEx.getAdCall());
                }
                mBSplashData.setCountDownText(contextD.getResources().getString(i0.a(contextD, this.f48178f.isCanSkip() ? "mbridge_splash_count_time_can_skip" : "mbridge_splash_count_time_can_skip_not", TypedValues.Custom.S_STRING)));
            }
    ...
    private void a(SplashResData splashResData) {
        if (this.f48177e == null || splashResData == null) {
            return;
        }
        int i10 = AnonymousClass1.f48179a[splashResData.geteAction().ordinal()];
        if (i10 == 1 || i10 == 2) {
            b(splashResData);
        }
        this.f48177e.viewClicked(splashResData);
    }
