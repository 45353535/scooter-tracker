...
public class b {
    ...
    private static volatile b f48086g;

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private SoftReference<HashMap<String, c>> f48087a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private SoftReference<HashMap<String, String>> f48088b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private SoftReference<HashMap<String, c>> f48089c;
    ...
    public HashMap b() {
        SoftReference<HashMap<String, c>> softReference = this.f48087a;
        if (softReference == null || softReference.get() == null) {
            ...
            map.put(H2.f75840g, c.background);
            ...
            this.f48087a = new SoftReference<>(map);
        }
        return this.f48087a.get();
    }

    public HashMap<String, c> c() {
        SoftReference<HashMap<String, c>> softReference = this.f48089c;
        if (softReference == null || softReference.get() == null) {
            ...
            this.f48089c = new SoftReference<>(map);
        }
        return this.f48089c.get();
    }
    ...
    public String f(String str) {
        ...
        SoftReference<HashMap<String, String>> softReference = this.f48088b;
        if (softReference == null || softReference.get() == null) {
            this.f48088b = new SoftReference<>(d());
        }
        String strSubstring = str.substring(8);
        if (this.f48088b.get() == null || this.f48088b.get().size() <= 0) {
            return null;
        }
        String str2 = this.f48088b.get().get(strSubstring);
    ...
    public void a(Context context, String str) {
        try {
            if (g.f48159a) {
                this.f48090d = context.getFilesDir().toString();
            } else {
                this.f48090d = str;
            }
            if (e.a(context).heightPixels <= 320 || g.f48159a) {
                this.f48091e = "/drawable-mdpi/";
            } else {
                this.f48091e = "/drawable-hdpi/";
            }
            this.f48092f = context;
            com.mbridge.msdk.dycreator.utils.b.f48156a = a().d();
        } catch (Exception e10) {
            q0.b("MBResource", e10.getMessage());
        }
    }
    ...
    public HashMap<String, String> d() {
        ...
        try {
            inputStreamOpen = this.f48092f.getAssets().open("rv_binddatas.xml");
        ...
        try {
            xmlPullParserNewPullParser.setInput(inputStreamOpen, D5.N);
    ...
    public void a(String str, ImageView imageView) {
        Context context;
        if (str == null || !str.startsWith("@drawable/") || (context = this.f48092f) == null) {
            return;
        }
        try {
            ...
            if (TextUtils.isEmpty(strI)) {
                strI = this.f48092f.getPackageName();
            }
