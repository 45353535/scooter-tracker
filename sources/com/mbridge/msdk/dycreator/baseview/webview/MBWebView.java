...
public class MBWebView extends WebView implements InterBase {
    ...
    private Map<String, String> f47982b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private MBWebViewClient f47983c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private MBWebChromeClient f47984d;
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f47986a[c.fadingEdge.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f47986a[c.visibility.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f47986a[c.background.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f47986a[c.contentDescription.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f47986a[c.tag.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f47986a[c.padding.ordinal()] = 7;
            } catch (NoSuchFieldError unused7) {
            }
            try {
                f47986a[c.paddingTop.ordinal()] = 8;
            } catch (NoSuchFieldError unused8) {
            }
            try {
                f47986a[c.paddingBottom.ordinal()] = 9;
            } catch (NoSuchFieldError unused9) {
            }
            try {
                f47986a[c.paddingLeft.ordinal()] = 10;
            } catch (NoSuchFieldError unused10) {
            }
            try {
                f47986a[c.paddingRight.ordinal()] = 11;
            } catch (NoSuchFieldError unused11) {
            }
            try {
                f47986a[c.paddingStart.ordinal()] = 12;
            } catch (NoSuchFieldError unused12) {
            }
            try {
                f47986a[c.paddingEnd.ordinal()] = 13;
            } catch (NoSuchFieldError unused13) {
            }
            try {
                f47986a[c.layout_width.ordinal()] = 14;
            } catch (NoSuchFieldError unused14) {
            }
            try {
                f47986a[c.layout_height.ordinal()] = 15;
    ...
    public ViewGroup.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            ...
            for (int i10 = 0; i10 < attributeCount; i10++) {
                ...
                if (cVar != null) {
                    int i11 = AnonymousClass1.f47986a[cVar.ordinal()];
                    if (i11 == 14) {
    ...
    public void setAttributeSet(AttributeSet attributeSet) {
        ...
        for (int i10 = 0; i10 < attributeCount; i10++) {
            ...
            if (cVar != null) {
                switch (AnonymousClass1.f47986a[cVar.ordinal()]) {
                    case 1:
                        String attributeValue = attributeSet.getAttributeValue(i10);
                    ...
                    case 4:
                        ...
                        if (attributeValue3.startsWith("#")) {
                            try {
                                strArrSplit = attributeValue3.split(TokenBuilder.TOKEN_DELIMITER);
                    ...
                    case 5:
                        ...
                        if (!TextUtils.isEmpty(attributeValue4)) {
                            CharSequence charSequence = (String) com.mbridge.msdk.dycreator.utils.b.f48156a.get(attributeValue4.substring(8));
                    ...
                    case 6:
                        ...
                        if (!TextUtils.isEmpty(attributeValue5)) {
                            String str = com.mbridge.msdk.dycreator.utils.b.f48156a.get(attributeValue5.substring(8));
    ...
    public void setCommunicator(WebCommunicator webCommunicator) {
        MBWebChromeClient mBWebChromeClient = this.f47984d;
    ...
    public void setWebViewEventListener(WebViewEventListener webViewEventListener) {
        MBWebViewClient mBWebViewClient = this.f47983c;
    ...
    public MBWebView(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        this.f47981a = "MBWebView";
        try {
            this.f47982b = com.mbridge.msdk.dycreator.utils.c.a(context, attributeSet);
            setAttributeSet(attributeSet);
            setLayoutParams(generateLayoutParams(attributeSet));
            com.mbridge.msdk.dycreator.utils.c.a(this.f47982b, this);
        } catch (Exception e10) {
