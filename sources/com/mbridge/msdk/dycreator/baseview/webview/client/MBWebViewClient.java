...
public class MBWebViewClient extends WebViewClient {
    ...
    private final String f47990a = "MBWebViewClient";

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private WebViewEventListener f47991b;

    @Override // android.webkit.WebViewClient
    public void onPageFinished(WebView webView, String str) {
        super.onPageFinished(webView, str);
        WebViewEventListener webViewEventListener = this.f47991b;
    ...
    public void setWebViewEventListener(WebViewEventListener webViewEventListener) {
        this.f47991b = webViewEventListener;
    }
        ...
        try {
            if (!TextUtils.isEmpty(str)) {
                ...
                if (!TextUtils.isEmpty(imageMimeType) && (bitmapB = b.a(c.n().d()).b(str)) != null && !bitmapB.isRecycled()) {
                    return new WebResourceResponse(imageMimeType, D5.N, a.a(bitmapB));
                }
            }
        } catch (Throwable th2) {
            q0.b("MBWebViewClient", th2.getMessage());
