...
public class MBInduceClickView extends FrameLayout implements InterBase, InterEffect {
    ...
    private Map<String, String> f47722a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private Map<String, Boolean> f47723b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private String f47724c;
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                f47725a[c.layout_height.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f47725a[c.layout_gravity.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f47725a[c.layout_marginLeft.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f47725a[c.layout_margin.ordinal()] = 5;
    ...
    public String getActionDes() {
        Map<String, String> map = this.f47722a;
        return (map == null || !map.containsKey("mbridgeAction")) ? "" : this.f47722a.get("mbridgeAction");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getBindDataDes() {
        Map<String, String> map = this.f47722a;
        return (map == null || !map.containsKey("mbridgeData")) ? "" : this.f47722a.get("mbridgeData");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getEffectDes() {
        Map<String, String> map = this.f47722a;
        return (map == null || !map.containsKey("mbridgeEffect")) ? "" : this.f47722a.get("mbridgeEffect");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getReportDes() {
        Map<String, String> map = this.f47722a;
        return (map == null || !map.containsKey("mbridgeReport")) ? "" : this.f47722a.get("mbridgeReport");
    }

    @Override // com.mbridge.msdk.dycreator.baseview.inter.InterBase
    public String getStrategyDes() {
        Map<String, String> map = this.f47722a;
        return (map == null || !map.containsKey("mbridgeStrategy")) ? "" : this.f47722a.get("mbridgeStrategy");
    }

    @Override // android.view.ViewGroup, android.view.View
    protected void onAttachedToWindow() {
        super.onAttachedToWindow();
        Map<String, Boolean> map = this.f47723b;
        if (map != null && map.containsKey("mbridgeAttached") && this.f47723b.get("mbridgeAttached").booleanValue()) {
            new l.b("mbridgeAttached").a().b(this.f47724c);
        }
    }
    ...
    protected void onDetachedFromWindow() {
        ...
        Map<String, Boolean> map = this.f47723b;
        if (map != null && map.containsKey("mbridgeDetached") && this.f47723b.get("mbridgeDetached").booleanValue()) {
            new l.b("mbridgeDetached").a().b(this.f47724c);
        }
    }
    ...
    public void setDynamicReport(String str, CampaignEx campaignEx) {
        this.f47723b = com.mbridge.msdk.dycreator.utils.c.a(str);
        if (campaignEx != null) {
            this.f47724c = campaignEx.getCampaignUnitId();
        }
    }
    ...
    public FrameLayout.LayoutParams generateLayoutParams(AttributeSet attributeSet) {
        ...
        for (int i10 = 0; i10 < attributeCount; i10++) {
            ...
            if (cVar != null) {
                int i11 = AnonymousClass1.f47725a[cVar.ordinal()];
                if (i11 == 1) {
    ...
    public MBInduceClickView(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        if (context != null && attributeSet != null) {
            try {
                this.f47722a = com.mbridge.msdk.dycreator.utils.c.a(context, attributeSet);
            } catch (Exception e10) {
        ...
        com.mbridge.msdk.dycreator.utils.c.a(this.f47722a, this);
    }
