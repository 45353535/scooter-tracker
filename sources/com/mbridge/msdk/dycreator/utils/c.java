            ...
            for (int i10 = 0; i10 < attributeCount; i10++) {
                ...
                if (!TextUtils.isEmpty(attributeName)) {
                    if (attributeName.equals("mbridge_data")) {
                        try {
                            map.put("mbridgeData", b.f48156a.get(attributeSet.getAttributeValue(i10).substring(8)));
                        } catch (Exception e10) {
                            e10.printStackTrace();
                        }
                    }
                    if (attributeName.equals("mbridge_click")) {
                        try {
                            map.put("mbridgeAction", b.f48156a.get(attributeSet.getAttributeValue(i10).substring(8)));
                        } catch (Exception e11) {
                            e11.printStackTrace();
                        }
                    }
                    if (attributeName.equals("mbridge_strategy")) {
                        try {
                            map.put("mbridgeStrategy", b.f48156a.get(attributeSet.getAttributeValue(i10).substring(8)));
                        } catch (Exception e12) {
                            e12.printStackTrace();
                        }
                    }
                    if (attributeName.equals("mbridge_effect")) {
                        try {
                            map.put("mbridgeEffect", b.f48156a.get(attributeSet.getAttributeValue(i10).substring(8)));
                        } catch (Exception e13) {
                            e13.printStackTrace();
                        }
                    }
