...
public class a {
    ...
    private static volatile a f50621c;
    ...
    class C0565a extends com.mbridge.msdk.foundation.same.net.handler.a {
    ...
    class b implements Runnable {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ String f50625a;
        ...
        public void run() throws Throwable {
            try {
                ...
                o0.a(this.f50625a.getBytes(), file);
                com.mbridge.msdk.foundation.buffer.sharedperference.a.b().a("MraidJSController", this.f50626b);
            } catch (Exception e10) {
    ...
    public String b() {
        try {
            if (TextUtils.isEmpty(this.f50622a)) {
                this.f50622a = c();
            }
            if (!TextUtils.isEmpty(this.f50622a)) {
                return this.f50622a;
    ...
    public void a(Context context, String str) {
        ...
        if (TextUtils.isEmpty(strA) || !strA.equals(str)) {
            try {
                new com.mbridge.msdk.setting.net.a(context).get(0, str, (com.mbridge.msdk.foundation.same.net.wrapper.e) null, new C0565a(str), "mraid_js", 60000L);
            } catch (Exception e10) {
