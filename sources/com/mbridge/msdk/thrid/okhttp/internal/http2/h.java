...
final class h implements Closeable, AutoCloseable {
    ...
    static final Logger f51466e = Logger.getLogger(e.class.getName());

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private final com.mbridge.msdk.thrid.okio.e f51467a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final a f51468b;
    ...
    h(com.mbridge.msdk.thrid.okio.e eVar, boolean z10) {
        ...
        a aVar = new a(eVar);
        this.f51468b = aVar;
        this.f51470d = new d.a(4096, aVar);
    }
    ...
    private void b(b bVar, int i10, byte b10, int i11) throws IOException {
        ...
        int i12 = this.f51467a.readInt();
        int i13 = this.f51467a.readInt();
        int i14 = i10 - 8;
        ...
        com.mbridge.msdk.thrid.okio.f fVarB = com.mbridge.msdk.thrid.okio.f.f51736e;
        if (i14 > 0) {
            fVarB = this.f51467a.b(i14);
        }
    ...
    private void c(b bVar, int i10, byte b10, int i11) throws IOException {
        ...
        boolean z10 = (b10 & 1) != 0;
        short s10 = (b10 & 8) != 0 ? (short) (this.f51467a.readByte() & 255) : (short) 0;
        if ((b10 & 32) != 0) {
            a(bVar, i11);
            i10 -= 5;
        }
    ...
    private void d(b bVar, int i10, byte b10, int i11) throws IOException {
        ...
        bVar.a((b10 & 1) != 0, this.f51467a.readInt(), this.f51467a.readInt());
    }
    ...
    private void f(b bVar, int i10, byte b10, int i11) throws IOException {
        ...
        short s10 = (b10 & 8) != 0 ? (short) (this.f51467a.readByte() & 255) : (short) 0;
        bVar.a(i11, this.f51467a.readInt() & Integer.MAX_VALUE, a(a(i10 - 4, b10, s10), s10, b10, i11));
    }
    ...
    private void h(b bVar, int i10, byte b10, int i11) throws IOException {
        ...
        for (int i12 = 0; i12 < i10; i12 += 6) {
            int i13 = this.f51467a.readShort() & 65535;
            int i14 = this.f51467a.readInt();
            if (i13 == 2) {
                if (i14 != 0 && i14 != 1) {
    ...
    private void i(b bVar, int i10, byte b10, int i11) throws IOException {
        ...
        long j10 = ((long) this.f51467a.readInt()) & SieveCacheKt.NodeLinkMask;
        if (j10 == 0) {
    ...
    public void a(b bVar) throws IOException {
        ...
        com.mbridge.msdk.thrid.okio.e eVar = this.f51467a;
        com.mbridge.msdk.thrid.okio.f fVar = e.f51382a;
        com.mbridge.msdk.thrid.okio.f fVarB = eVar.b(fVar.j());
        Logger logger = f51466e;
    ...
    static final class a implements s, AutoCloseable {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private final com.mbridge.msdk.thrid.okio.e f51471a;
        ...
        private void d() throws IOException {
            ...
            int iA = h.a(this.f51471a);
            this.f51475e = iA;
            this.f51472b = iA;
            byte b10 = (byte) (this.f51471a.readByte() & 255);
            this.f51473c = (byte) (this.f51471a.readByte() & 255);
            Logger logger = h.f51466e;
            if (logger.isLoggable(Level.FINE)) {
                logger.fine(e.a(true, this.f51474d, this.f51472b, b10, this.f51473c));
            }
            int i11 = this.f51471a.readInt() & Integer.MAX_VALUE;
            this.f51474d = i11;
            if (b10 != 9) {
        ...
        public long b(com.mbridge.msdk.thrid.okio.c cVar, long j10) throws IOException {
            while (true) {
                ...
                if (i10 != 0) {
                    long jB = this.f51471a.b(cVar, Math.min(j10, i10));
                    if (jB == -1) {
                        return -1L;
                    }
                    this.f51475e = (int) (((long) this.f51475e) - jB);
                    return jB;
                }
                this.f51471a.skip(this.f51476f);
                this.f51476f = (short) 0;
                if ((this.f51473c & 4) != 0) {
                    return -1L;
                }
                d();
    ...
    public boolean a(boolean z10, b bVar) throws IOException {
        try {
            this.f51467a.e(9L);
            int iA = a(this.f51467a);
            if (iA < 0 || iA > 16384) {
                throw e.b("FRAME_SIZE_ERROR: %s", Integer.valueOf(iA));
            }
            byte b10 = (byte) (this.f51467a.readByte() & 255);
            if (z10 && b10 != 4) {
                throw e.b("Expected a SETTINGS frame but was %s", Byte.valueOf(b10));
            }
            byte b11 = (byte) (this.f51467a.readByte() & 255);
            int i10 = this.f51467a.readInt() & Integer.MAX_VALUE;
            Logger logger = f51466e;
            if (logger.isLoggable(Level.FINE)) {
    ...
    private void a(b bVar, int i10, byte b10, int i11) throws IOException {
        ...
        if ((b10 & 32) == 0) {
            short s10 = (b10 & 8) != 0 ? (short) (this.f51467a.readByte() & 255) : (short) 0;
            bVar.a(z10, i11, this.f51467a, a(i10, b10, s10));
            this.f51467a.skip(s10);
            return;
        }
    ...
    private void a(b bVar, int i10) throws IOException {
        int i11 = this.f51467a.readInt();
        bVar.a(i10, i11 & Integer.MAX_VALUE, (this.f51467a.readByte() & 255) + 1, (Integer.MIN_VALUE & i11) != 0);
    }
