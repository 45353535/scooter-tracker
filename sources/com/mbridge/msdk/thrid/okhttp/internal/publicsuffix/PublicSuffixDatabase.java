...
public final class PublicSuffixDatabase {
    ...
    private static final byte[] f51548e = {42};

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private static final String[] f51549f = new String[0];

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    private static final String[] f51550g = {ProxyConfig.MATCH_ALL_SCHEMES};

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    private static final PublicSuffixDatabase f51551h = new PublicSuffixDatabase();

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private final AtomicBoolean f51552a = new AtomicBoolean(false);

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final CountDownLatch f51553b = new CountDownLatch(1);

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private byte[] f51554c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private byte[] f51555d;
    ...
    private String[] a(String[] strArr) {
        ...
        String strA2;
        int i10 = 0;
        if (!this.f51552a.get() && this.f51552a.compareAndSet(false, true)) {
            c();
        } else {
            try {
                this.f51553b.await();
        ...
        for (int i11 = 0; i11 < strArr.length; i11++) {
            bArr[i11] = strArr[i11].getBytes(c.f51210j);
        }
        int i12 = 0;
        while (true) {
            str = null;
        ...
        if (length > 1) {
            ...
            for (int i13 = 0; i13 < bArr2.length - 1; i13++) {
                bArr2[i13] = f51548e;
                strA2 = a(this.f51554c, bArr2, i13);
                if (strA2 != null) {
                    break;
                }
            }
        ...
        if (strA2 != null) {
            while (true) {
                ...
                String strA3 = a(this.f51555d, bArr, i10);
                if (strA3 != null) {
                    str = strA3;
                    break;
                }
        ...
        String[] strArrSplit = strA != null ? strA.split("\\.") : f51549f;
        String[] strArrSplit2 = strA2 != null ? strA2.split("\\.") : f51549f;
        ...
        while (i14 < length) {
            ...
            if (i13 >= 0) {
                if (i13 <= 0) {
                    ...
                    if (length2 >= i22) {
                        if (length2 <= i22) {
                            return new String(bArr, i16, i18, c.f51210j);
                        }
                    }
                }
                i14 = i11 + 1;
