...
public final class a implements t {
    ...
    public a0 a(t.a aVar) throws IOException {
        ...
        y yVar = bVarC.f51222a;
        a0 a0Var = bVarC.f51223b;
        if (yVar == null && a0Var == null) {
            return new a0.a().a(aVar.d()).a(w.HTTP_1_1).a(504).a("Unsatisfiable Request (only-if-cached)").a(com.mbridge.msdk.thrid.okhttp.internal.c.f51203c).b(-1L).a(System.currentTimeMillis()).a();
        }
        if (yVar == null) {
    ...
    private static r a(r rVar, r rVar2) {
        ...
        for (int i11 = 0; i11 < iB2; i11++) {
            ...
            if (!a(strA2) && b(strA2)) {
                com.mbridge.msdk.thrid.okhttp.internal.a.f51199a.a(aVar, strA2, rVar2.b(i11));
            }
        }
        return aVar.a();
    }
