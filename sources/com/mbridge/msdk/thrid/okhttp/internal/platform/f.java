...
class f<T> {
    ...
    private final Class<?> f51543a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final String f51544b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private final Class[] f51545c;
    ...
    public Object a(T t10, Object... objArr) throws InvocationTargetException {
        Method methodA = a(t10.getClass());
        if (methodA == null) {
            throw new AssertionError("Method " + this.f51544b + " not supported for object " + t10);
        }
        try {
            return methodA.invoke(t10, objArr);
    ...
    private Method a(Class<?> cls) {
        ...
        Method methodA = a(cls, str, this.f51545c);
        if (methodA == null || (cls2 = this.f51543a) == null || cls2.isAssignableFrom(methodA.getReturnType())) {
            return methodA;
        }
        return null;
    }
