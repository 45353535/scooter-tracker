...
public class g {
    ...
    private static final g f51546a = c();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final Logger f51547b = Logger.getLogger(v.class.getName());
    ...
    public void a(int i10, String str, Throwable th2) {
        f51547b.log(i10 == 5 ? Level.WARNING : Level.INFO, str, th2);
    }

    public Object a(String str) {
        if (f51547b.isLoggable(Level.FINE)) {
