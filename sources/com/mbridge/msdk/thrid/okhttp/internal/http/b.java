...
public final class b implements t {
    ...
    public a0 a(t.a aVar) throws IOException {
        ...
        if (f.a(yVarD.e()) && yVarD.a() != null) {
            if ("100-continue".equalsIgnoreCase(yVarD.a(HttpHeaders.EXPECT))) {
                cVarH.b();
            ...
            if (aVarA == null) {
                ...
                yVarD.a().a(dVarA);
                dVarA.close();
                gVar.g().requestBodyEnd(gVar.e(), aVar2.f51286b);
            } else if (!cVar.f()) {
                gVarI.e();
            }
        }
        ...
        a0 a0VarA2 = (this.f51285a && iK == 101) ? a0VarA.p().a(com.mbridge.msdk.thrid.okhttp.internal.c.f51203c).a() : a0VarA.p().a(cVarH.a(a0VarA)).a();
