...
public class b extends WebViewClient {
    ...
    private final String f47562a = "MBWebViewClient";

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private com.mbridge.msdk.config.dynamic.baseview.webview.listener.a f47563b;
    ...
    public void onPageFinished(WebView webView, String str) {
        ...
        com.mbridge.msdk.config.dynamic.baseview.webview.listener.a aVar = this.f47563b;
        if (aVar != null) {
