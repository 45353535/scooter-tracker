...
public final class DoubleValue extends h0 implements q {
    private static final DoubleValue DEFAULT_INSTANCE = new DoubleValue();
    private static final p1 PARSER = new b() { // from class: com.explorestack.protobuf.DoubleValue.1
        @Override // com.explorestack.protobuf.p1
        public DoubleValue parsePartialFrom(l lVar, w wVar) throws InvalidProtocolBufferException {
            return new DoubleValue(lVar, wVar);
        }
    };
    ...
    public static DoubleValue parseDelimitedFrom(InputStream inputStream) throws IOException {
        return (DoubleValue) h0.parseDelimitedWithIOException(PARSER, inputStream);
    }
    ...
    public int getSerializedSize() {
        ...
        int iJ = (d10 != 0.0d ? n.j(1, d10) : 0) + this.unknownFields.getSerializedSize();
        this.memoizedSize = iJ;
        return iJ;
    }
    ...
    public int hashCode() {
        ...
        int iHashCode = ((((((779 + getDescriptor().hashCode()) * 37) + 1) * 53) + j0.i(Double.doubleToLongBits(getValue()))) * 29) + this.unknownFields.hashCode();
    ...
    protected h0.f internalGetFieldAccessorTable() {
        return a3.f18785b.d(DoubleValue.class, Builder.class);
    }
    ...
    public static final class Builder extends h0.b implements q {
        private double value_;
        ...
        */
        public com.explorestack.protobuf.DoubleValue.Builder mergeFrom(com.explorestack.protobuf.l r3, com.explorestack.protobuf.w r4) throws java.lang.Throwable {
            /*
                r2 = this;
                r0 = 0
                com.explorestack.protobuf.p1 r1 = com.explorestack.protobuf.DoubleValue.access$400()     // Catch: java.lang.Throwable -> L11 com.explorestack.protobuf.InvalidProtocolBufferException -> L13
            ...
            L26:
                throw r3
            */
            throw new UnsupportedOperationException("Method not decompiled: com.explorestack.protobuf.DoubleValue.Builder.mergeFrom(com.explorestack.protobuf.l, com.explorestack.protobuf.w):com.explorestack.protobuf.DoubleValue$Builder");
        }
    }
    ...
    public static DoubleValue parseFrom(ByteBuffer byteBuffer, w wVar) throws InvalidProtocolBufferException {
        return (DoubleValue) PARSER.parseFrom(byteBuffer, wVar);
    }

    private DoubleValue(h0.b bVar) {
        super(bVar);
        this.memoizedIsInitialized = (byte) -1;
    }

    public static DoubleValue parseDelimitedFrom(InputStream inputStream, w wVar) throws IOException {
        return (DoubleValue) h0.parseDelimitedWithIOException(PARSER, inputStream, wVar);
    }
    ...
    public static DoubleValue parseFrom(ByteString byteString, w wVar) throws InvalidProtocolBufferException {
        return (DoubleValue) PARSER.parseFrom(byteString, wVar);
    }
    ...
    public static DoubleValue parseFrom(byte[] bArr, w wVar) throws InvalidProtocolBufferException {
        return (DoubleValue) PARSER.parseFrom(bArr, wVar);
    }

    private DoubleValue(l lVar, w wVar) throws InvalidProtocolBufferException {
        this();
        wVar.getClass();
        r2.b bVarG = r2.g();
        boolean z10 = false;
    ...
    public static DoubleValue parseFrom(InputStream inputStream) throws IOException {
        return (DoubleValue) h0.parseWithIOException(PARSER, inputStream);
    }

    public static DoubleValue parseFrom(InputStream inputStream, w wVar) throws IOException {
        return (DoubleValue) h0.parseWithIOException(PARSER, inputStream, wVar);
    }

    public static DoubleValue parseFrom(l lVar) throws IOException {
        return (DoubleValue) h0.parseWithIOException(PARSER, lVar);
    }

    public static DoubleValue parseFrom(l lVar, w wVar) throws IOException {
        return (DoubleValue) h0.parseWithIOException(PARSER, lVar, wVar);
    }
}
