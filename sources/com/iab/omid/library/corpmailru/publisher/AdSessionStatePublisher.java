...
public abstract class AdSessionStatePublisher {
    ...
    private com.iab.omid.library.corpmailru.e.b f34939a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private AdEvents f34940b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private MediaEvents f34941c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private a f34942d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private long f34943e;
    ...
    public AdSessionStatePublisher() {
        i();
        this.f34939a = new com.iab.omid.library.corpmailru.e.b(null);
    }
    ...
    void a(WebView webView) {
        this.f34939a = new com.iab.omid.library.corpmailru.e.b(webView);
    }

    public void a(AdEvents adEvents) {
        this.f34940b = adEvents;
    }
    ...
    protected void a(com.iab.omid.library.corpmailru.adsession.a aVar, AdSessionContext adSessionContext, JSONObject jSONObject) {
        ...
        com.iab.omid.library.corpmailru.d.b.a(jSONObject2, ADJPConstants.KEY_ENVIRONMENT, "app");
        ...
        com.iab.omid.library.corpmailru.d.b.a(jSONObject4, RemoteConfigConstants.RequestFieldKey.APP_ID, com.iab.omid.library.corpmailru.b.d.a().b().getApplicationContext().getPackageName());
    ...
    public void a(String str, long j10) {
        if (j10 >= this.f34943e) {
            this.f34942d = a.AD_STATE_VISIBLE;
            e.a().b(getWebView(), str);
        }
    }
