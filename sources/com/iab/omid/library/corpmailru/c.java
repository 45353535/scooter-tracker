...
class c {
    ...
    private static final Pattern f34923a = Pattern.compile("<(head)( [^>]*)?>", 2);

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final Pattern f34924b = Pattern.compile("<(head)( [^>]*)?/>", 2);

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final Pattern f34925c = Pattern.compile("<(body)( [^>]*?)?>", 2);

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static final Pattern f34926d = Pattern.compile("<(body)( [^>]*?)?/>", 2);

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private static final Pattern f34927e = Pattern.compile("<(html)( [^>]*?)?>", 2);

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private static final Pattern f34928f = Pattern.compile("<(html)( [^>]*?)?/>", 2);

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    private static final Pattern f34929g = Pattern.compile("<!DOCTYPE [^>]*>", 2);
    ...
    static String b(String str, String str2) {
        ...
        if (!b(str, sb2, f34924b, str2, iArrA) && !a(str, sb2, f34923a, str2, iArrA) && !b(str, sb2, f34926d, str2, iArrA) && !a(str, sb2, f34925c, str2, iArrA) && !b(str, sb2, f34928f, str2, iArrA) && !a(str, sb2, f34927e, str2, iArrA) && !a(str, sb2, f34929g, str2, iArrA)) {
            return str2 + str;
        }
        return sb2.toString();
    }
