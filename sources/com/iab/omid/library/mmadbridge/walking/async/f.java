...
public class f extends a {
    public f(b.InterfaceC0408b interfaceC0408b, HashSet<String> hashSet, JSONObject jSONObject, long j10) {
    ...
    private void b(String str) {
        ...
        if (cVarC != null) {
            for (com.iab.omid.library.mmadbridge.adsession.a aVar : cVarC.b()) {
                if (this.f35523c.contains(aVar.getAdSessionId())) {
                    aVar.getAdSessionStatePublisher().b(str, this.f35525e);
                }
            }
        }
    }
    ...
    public String doInBackground(Object... objArr) {
        if (com.iab.omid.library.mmadbridge.utils.c.h(this.f35524d, this.f35527b.a())) {
            return null;
        }
        this.f35527b.a(this.f35524d);
        return this.f35524d.toString();
    }
