...
public class c {
    ...
    private static WindowManager f35490a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static String[] f35491b = {"x", "y", "width", "height"};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    static float f35492c = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f35494a);
            jSONObject.put("height", bVarA.f35495b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f35490a != null) {
            ...
            f35490a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f35492c = context.getResources().getDisplayMetrics().density;
            f35490a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0407a c0407a) {
        com.iab.omid.library.mmadbridge.internal.e eVarA = c0407a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0407a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f35493a[outputDeviceStatus.ordinal()] == 1;
    }
