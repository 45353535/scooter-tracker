...
public class c {
    ...
    private static WindowManager f34169a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static String[] f34170b = {"x", "y", "width", "height"};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    static float f34171c = Resources.getSystem().getDisplayMetrics().density;

    static /* synthetic */ class a {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        static final /* synthetic */ int[] f34172a;
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f34173a);
            jSONObject.put("height", bVarA.f34174b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f34169a != null) {
            ...
            f34169a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f34171c = context.getResources().getDisplayMetrics().density;
            f34169a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0367a c0367a) {
        com.iab.omid.library.amazon.internal.e eVarA = c0367a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0367a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f34172a[outputDeviceStatus.ordinal()] == 1;
    }
