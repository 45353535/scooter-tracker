...
public abstract class AdSessionStatePublisher {
    ...
    private com.iab.omid.library.amazon.weakreference.b f34152b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private AdEvents f34153c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private MediaEvents f34154d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private a f34155e;

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private long f34156f;
    ...
    public AdSessionStatePublisher(String str) {
        a();
        this.f34151a = str;
        this.f34152b = new com.iab.omid.library.amazon.weakreference.b(null);
    }

    public void a() {
        this.f34156f = f.b();
        this.f34155e = a.AD_STATE_IDLE;
    }
    ...
    public boolean e() {
        return this.f34152b.get() != null;
    }

    public void f() {
        h.a().a(getWebView(), this.f34151a);
    }

    public void g() {
        h.a().b(getWebView(), this.f34151a);
    }
    ...
    public void a(float f10) {
        h.a().a(getWebView(), this.f34151a, f10);
    }

    public void b(String str, long j10) {
        if (j10 >= this.f34156f) {
            this.f34155e = a.AD_STATE_VISIBLE;
            h.a().a(getWebView(), this.f34151a, str);
        }
    }

    void a(WebView webView) {
        this.f34152b = new com.iab.omid.library.amazon.weakreference.b(webView);
    }

    public void a(AdEvents adEvents) {
        this.f34153c = adEvents;
    }

    public void a(AdSessionConfiguration adSessionConfiguration) {
        h.a().a(getWebView(), this.f34151a, adSessionConfiguration.toJsonObject());
    }

    public void a(ErrorType errorType, String str) {
        h.a().a(getWebView(), this.f34151a, errorType, str);
    }
    ...
    public void a(String str, @Nullable JSONObject jSONObject) {
        h.a().a(getWebView(), this.f34151a, str, jSONObject);
    }
    ...
    public void a(@Nullable JSONObject jSONObject) {
        h.a().b(getWebView(), this.f34151a, jSONObject);
    }

    public void a(boolean z10) {
        if (e()) {
            h.a().b(getWebView(), this.f34151a, z10 ? "foregrounded" : "backgrounded");
        }
    }
}
