...
public class c {
    ...
    private static WindowManager f36031a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static String[] f36032b = {"x", "y", "width", "height"};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    static float f36033c = Resources.getSystem().getDisplayMetrics().density;

    static /* synthetic */ class a {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        static final /* synthetic */ int[] f36034a;
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f36035a);
            jSONObject.put("height", bVarA.f36036b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f36031a != null) {
            ...
            f36031a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f36033c = context.getResources().getDisplayMetrics().density;
            f36031a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0424a c0424a) {
        com.iab.omid.library.startio.internal.e eVarA = c0424a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0424a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f36034a[outputDeviceStatus.ordinal()] == 1;
    }
