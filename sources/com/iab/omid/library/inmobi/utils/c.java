...
public class c {
    ...
    private static WindowManager f35220a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static String[] f35221b = {"x", "y", "width", "height"};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    static float f35222c = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f35224a);
            jSONObject.put("height", bVarA.f35225b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f35220a != null) {
            ...
            f35220a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f35222c = context.getResources().getDisplayMetrics().density;
            f35220a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0399a c0399a) {
        com.iab.omid.library.inmobi.internal.e eVarA = c0399a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0399a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f35223a[outputDeviceStatus.ordinal()] == 1;
    }
