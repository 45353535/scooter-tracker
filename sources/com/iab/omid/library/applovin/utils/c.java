...
public class c {
    ...
    private static WindowManager f34303a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static String[] f34304b = {"x", "y", "width", "height"};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    static float f34305c = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f34307a);
            jSONObject.put("height", bVarA.f34308b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f34303a != null) {
            ...
            f34303a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f34305c = context.getResources().getDisplayMetrics().density;
            f34303a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0371a c0371a) {
        com.iab.omid.library.applovin.internal.e eVarA = c0371a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0371a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f34306a[outputDeviceStatus.ordinal()] == 1;
    }
