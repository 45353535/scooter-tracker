...
public class b {
    ...
    private static WindowManager f34552b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static String[] f34553c = {"x", "y", "width", "height"};

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    static float f34551a = Resources.getSystem().getDisplayMetrics().density;
    ...
    private static a b(JSONObject jSONObject) {
        ...
        if (f34552b != null) {
            ...
            f34552b.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f34551a = context.getResources().getDisplayMetrics().density;
            f34552b = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", aVarB.f34554a);
            jSONObject.put("height", aVarB.f34555b);
        } catch (JSONException unused) {
        }
    }

    public static void a(JSONObject jSONObject, a.C0378a c0378a) {
        com.iab.omid.library.bigosg.b.c cVarA = c0378a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0378a.b().iterator();
        while (it.hasNext()) {
