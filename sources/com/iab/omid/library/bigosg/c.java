...
class c {
    ...
    private static final Pattern f34540a = Pattern.compile("<(head)( [^>]*)?>", 2);

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final Pattern f34541b = Pattern.compile("<(head)( [^>]*)?/>", 2);

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final Pattern f34542c = Pattern.compile("<(body)( [^>]*?)?>", 2);

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static final Pattern f34543d = Pattern.compile("<(body)( [^>]*?)?/>", 2);

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private static final Pattern f34544e = Pattern.compile("<(html)( [^>]*?)?>", 2);

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private static final Pattern f34545f = Pattern.compile("<(html)( [^>]*?)?/>", 2);

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    private static final Pattern f34546g = Pattern.compile("<!DOCTYPE [^>]*>", 2);
    ...
    static String b(String str, String str2) {
        ...
        if (!b(str, sb2, f34541b, str2, iArrA) && !a(str, sb2, f34540a, str2, iArrA) && !b(str, sb2, f34543d, str2, iArrA) && !a(str, sb2, f34542c, str2, iArrA) && !b(str, sb2, f34545f, str2, iArrA) && !a(str, sb2, f34544e, str2, iArrA) && !a(str, sb2, f34546g, str2, iArrA)) {
            return str2 + str;
        }
        return sb2.toString();
    }
