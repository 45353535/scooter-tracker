...
public abstract class AdSessionStatePublisher {
    ...
    private com.iab.omid.library.bigosg.e.b f34556a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private AdEvents f34557b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private MediaEvents f34558c;
    ...
    public AdSessionStatePublisher() {
        i();
        this.f34556a = new com.iab.omid.library.bigosg.e.b(null);
    }
    ...
    void a(WebView webView) {
        this.f34556a = new com.iab.omid.library.bigosg.e.b(webView);
    }

    public void a(AdEvents adEvents) {
        this.f34557b = adEvents;
    }
    ...
    protected void a(com.iab.omid.library.bigosg.adsession.a aVar, AdSessionContext adSessionContext, JSONObject jSONObject) {
        ...
        com.iab.omid.library.bigosg.d.b.a(jSONObject2, ADJPConstants.KEY_ENVIRONMENT, "app");
    ...
    public void a(String str, long j10) {
        if (j10 >= this.f34560e) {
            this.f34559d = a.AD_STATE_VISIBLE;
            e.a().b(getWebView(), str);
        }
    }
