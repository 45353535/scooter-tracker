...
public class f extends a {
    public f(b.InterfaceC0433b interfaceC0433b, HashSet<String> hashSet, JSONObject jSONObject, long j10) {
        ...
        if (cVarC != null) {
            for (com.iab.omid.library.unity3d.adsession.a aVar : cVarC.b()) {
                if (this.f36319c.contains(aVar.getAdSessionId())) {
                    aVar.getAdSessionStatePublisher().b(str, this.f36321e);
                }
            }
        }
    }
    ...
    public String doInBackground(Object... objArr) {
        if (com.iab.omid.library.unity3d.utils.c.h(this.f36320d, this.f36323b.a())) {
            return null;
        }
        this.f36323b.a(this.f36320d);
