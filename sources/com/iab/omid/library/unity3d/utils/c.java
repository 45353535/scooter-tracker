...
public class c {
    ...
    private static WindowManager f36287a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static String[] f36288b = {"x", "y", "width", "height"};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    static float f36289c = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f36291a);
            jSONObject.put("height", bVarA.f36292b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f36287a != null) {
            ...
            f36287a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f36289c = context.getResources().getDisplayMetrics().density;
            f36287a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0432a c0432a) {
        com.iab.omid.library.unity3d.internal.e eVarA = c0432a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0432a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f36290a[outputDeviceStatus.ordinal()] == 1;
    }
