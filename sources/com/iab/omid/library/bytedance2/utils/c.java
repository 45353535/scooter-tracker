...
public class c {
    ...
    private static WindowManager f34690a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static String[] f34691b = {"x", "y", "width", "height"};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    static float f34692c = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f34694a);
            jSONObject.put("height", bVarA.f34695b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f34690a != null) {
            ...
            f34690a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f34692c = context.getResources().getDisplayMetrics().density;
            f34690a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0382a c0382a) {
        com.iab.omid.library.bytedance2.internal.e eVarA = c0382a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0382a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f34693a[outputDeviceStatus.ordinal()] == 1;
    }
