...
public class c {
    ...
    private static WindowManager f35355a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static String[] f35356b = {"x", "y", "width", "height"};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    static float f35357c = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f35359a);
            jSONObject.put("height", bVarA.f35360b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f35355a != null) {
            ...
            f35355a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f35357c = context.getResources().getDisplayMetrics().density;
            f35355a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0403a c0403a) {
        com.iab.omid.library.ironsrc.internal.e eVarA = c0403a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0403a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f35358a[outputDeviceStatus.ordinal()] == 1;
    }
