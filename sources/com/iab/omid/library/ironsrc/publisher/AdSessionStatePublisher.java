...
public abstract class AdSessionStatePublisher {
    ...
    private com.iab.omid.library.ironsrc.weakreference.b f35338b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private AdEvents f35339c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private MediaEvents f35340d;
    ...
    public AdSessionStatePublisher(String str) {
        a();
        this.f35337a = str;
        this.f35338b = new com.iab.omid.library.ironsrc.weakreference.b(null);
    }

    public void a() {
        this.f35342f = f.b();
        this.f35341e = a.AD_STATE_IDLE;
    }
    ...
    public boolean e() {
        return this.f35338b.get() != null;
    }

    public void f() {
        h.a().a(getWebView(), this.f35337a);
    }

    public void g() {
        h.a().b(getWebView(), this.f35337a);
    }

    public WebView getWebView() {
        return this.f35338b.get();
    }
    ...
    public void a(float f10) {
        h.a().a(getWebView(), this.f35337a, f10);
    }

    public void b(String str, long j10) {
        if (j10 >= this.f35342f) {
            this.f35341e = a.AD_STATE_VISIBLE;
            h.a().b(getWebView(), this.f35337a, str);
        }
    }

    void a(WebView webView) {
        this.f35338b = new com.iab.omid.library.ironsrc.weakreference.b(webView);
    }

    public void b(boolean z10) {
        if (e()) {
            h.a().a(getWebView(), this.f35337a, z10 ? "locked" : "unlocked");
        }
    }

    public void a(AdEvents adEvents) {
        this.f35339c = adEvents;
    }

    public void a(AdSessionConfiguration adSessionConfiguration) {
        h.a().a(getWebView(), this.f35337a, adSessionConfiguration.toJsonObject());
    }

    public void a(ErrorType errorType, String str) {
        h.a().a(getWebView(), this.f35337a, errorType, str);
    }
    ...
    public void a(String str, @Nullable JSONObject jSONObject) {
        h.a().a(getWebView(), this.f35337a, str, jSONObject);
    }
    ...
    public void a(@Nullable JSONObject jSONObject) {
        h.a().b(getWebView(), this.f35337a, jSONObject);
    }

    public void a(boolean z10) {
        if (e()) {
            h.a().c(getWebView(), this.f35337a, z10 ? "foregrounded" : "backgrounded");
        }
    }
}
