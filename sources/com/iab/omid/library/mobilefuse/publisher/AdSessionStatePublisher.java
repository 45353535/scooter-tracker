...
public abstract class AdSessionStatePublisher {
    ...
    private com.iab.omid.library.mobilefuse.weakreference.b f35608b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private AdEvents f35609c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private MediaEvents f35610d;
    ...
    public AdSessionStatePublisher(String str) {
        a();
        this.f35607a = str;
        this.f35608b = new com.iab.omid.library.mobilefuse.weakreference.b(null);
    }

    public void a() {
        this.f35612f = f.b();
        this.f35611e = a.AD_STATE_IDLE;
    }
    ...
    public boolean e() {
        return this.f35608b.get() != null;
    }

    public void f() {
        h.a().a(getWebView(), this.f35607a);
    }

    public void g() {
        h.a().b(getWebView(), this.f35607a);
    }

    public WebView getWebView() {
        return this.f35608b.get();
    }
    ...
    public void a(float f10) {
        h.a().a(getWebView(), this.f35607a, f10);
    }

    public void b(String str, long j10) {
        if (j10 >= this.f35612f) {
            this.f35611e = a.AD_STATE_VISIBLE;
            h.a().b(getWebView(), this.f35607a, str);
        }
    }

    void a(WebView webView) {
        this.f35608b = new com.iab.omid.library.mobilefuse.weakreference.b(webView);
    }

    public void b(boolean z10) {
        if (e()) {
            h.a().a(getWebView(), this.f35607a, z10 ? "locked" : "unlocked");
        }
    }

    public void a(AdEvents adEvents) {
        this.f35609c = adEvents;
    }

    public void a(AdSessionConfiguration adSessionConfiguration) {
        h.a().a(getWebView(), this.f35607a, adSessionConfiguration.toJsonObject());
    }

    public void a(ErrorType errorType, String str) {
        h.a().a(getWebView(), this.f35607a, errorType, str);
    }
    ...
    protected void a(com.iab.omid.library.mobilefuse.adsession.a aVar, AdSessionContext adSessionContext, JSONObject jSONObject) {
        ...
        c.a(jSONObject2, "deviceInfo", com.iab.omid.library.mobilefuse.utils.b.d());
        ...
        c.a(jSONObject4, "libraryVersion", "1.4.13-Mobilefuse");
    ...
    public void a(String str, @Nullable JSONObject jSONObject) {
        h.a().a(getWebView(), this.f35607a, str, jSONObject);
    }
    ...
    public void a(@Nullable JSONObject jSONObject) {
        h.a().b(getWebView(), this.f35607a, jSONObject);
    }

    public void a(boolean z10) {
        if (e()) {
            h.a().c(getWebView(), this.f35607a, z10 ? "foregrounded" : "backgrounded");
        }
    }
}
