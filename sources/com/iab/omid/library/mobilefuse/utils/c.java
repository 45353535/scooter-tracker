...
public class c {
    ...
    private static WindowManager f35625a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static String[] f35626b = {"x", "y", "width", "height"};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    static float f35627c = Resources.getSystem().getDisplayMetrics().density;

    static /* synthetic */ class a {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        static final /* synthetic */ int[] f35628a;
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f35629a);
            jSONObject.put("height", bVarA.f35630b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f35625a != null) {
            ...
            f35625a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f35627c = context.getResources().getDisplayMetrics().density;
            f35625a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0411a c0411a) {
        com.iab.omid.library.mobilefuse.internal.e eVarA = c0411a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0411a.b().iterator();
        while (it.hasNext()) {
    ...
    public static void a(JSONObject jSONObject, String str, Object obj) {
        try {
            ...
            d.a("JSONException during JSONObject.put for name [" + str + C4240b4.j.f42674e, e10);
        }
    }
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f35628a[outputDeviceStatus.ordinal()] == 1;
    }
