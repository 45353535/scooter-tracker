...
public class c {
    ...
    private static WindowManager f34830a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static String[] f34831b = {"x", "y", "width", "height"};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    static float f34832c = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f34834a);
            jSONObject.put("height", bVarA.f34835b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f34830a != null) {
            ...
            f34830a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f34832c = context.getResources().getDisplayMetrics().density;
            f34830a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0387a c0387a) {
        com.iab.omid.library.chartboost.internal.e eVarA = c0387a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0387a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f34833a[outputDeviceStatus.ordinal()] == 1;
    }
