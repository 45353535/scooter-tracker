...
public abstract class AdSessionStatePublisher {
    ...
    private com.iab.omid.library.chartboost.weakreference.b f34813b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private AdEvents f34814c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private MediaEvents f34815d;
    ...
    public AdSessionStatePublisher(String str) {
        a();
        this.f34812a = str;
        this.f34813b = new com.iab.omid.library.chartboost.weakreference.b(null);
    }

    public void a() {
        this.f34817f = f.b();
        this.f34816e = a.AD_STATE_IDLE;
    }
    ...
    public boolean e() {
        return this.f34813b.get() != null;
    }

    public void f() {
        h.a().a(getWebView(), this.f34812a);
    }

    public void g() {
        h.a().b(getWebView(), this.f34812a);
    }
    ...
    public void a(float f10) {
        h.a().a(getWebView(), this.f34812a, f10);
    }

    public void b(String str, long j10) {
        if (j10 >= this.f34817f) {
            this.f34816e = a.AD_STATE_VISIBLE;
            h.a().b(getWebView(), this.f34812a, str);
        }
    }

    void a(WebView webView) {
        this.f34813b = new com.iab.omid.library.chartboost.weakreference.b(webView);
    }

    public void b(boolean z10) {
        if (e()) {
            h.a().a(getWebView(), this.f34812a, z10 ? "locked" : "unlocked");
        }
    }

    public void a(AdEvents adEvents) {
        this.f34814c = adEvents;
    }

    public void a(AdSessionConfiguration adSessionConfiguration) {
        h.a().a(getWebView(), this.f34812a, adSessionConfiguration.toJsonObject());
    }

    public void a(ErrorType errorType, String str) {
        h.a().a(getWebView(), this.f34812a, errorType, str);
    }
    ...
    public void a(String str, @Nullable JSONObject jSONObject) {
        h.a().a(getWebView(), this.f34812a, str, jSONObject);
    }
    ...
    public void a(@Nullable JSONObject jSONObject) {
        h.a().b(getWebView(), this.f34812a, jSONObject);
    }

    public void a(boolean z10) {
        if (e()) {
            h.a().c(getWebView(), this.f34812a, z10 ? "foregrounded" : "backgrounded");
        }
    }
}
