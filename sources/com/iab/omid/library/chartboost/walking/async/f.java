...
public class f extends a {
    public f(b.InterfaceC0388b interfaceC0388b, HashSet<String> hashSet, JSONObject jSONObject, long j10) {
        super(interfaceC0388b, hashSet, jSONObject, j10);
    }
    ...
    private void b(String str) {
        ...
        if (cVarC != null) {
            for (com.iab.omid.library.chartboost.adsession.a aVar : cVarC.b()) {
                if (this.f34863c.contains(aVar.c())) {
                    aVar.d().b(str, this.f34865e);
                }
            }
        }
    }
    ...
    public String doInBackground(Object... objArr) {
        if (com.iab.omid.library.chartboost.utils.c.h(this.f34864d, this.f34867b.a())) {
            return null;
        }
        this.f34867b.a(this.f34864d);
        return this.f34864d.toString();
    }
