...
public class c {
    ...
    private static WindowManager f35079a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static String[] f35080b = {"x", "y", "width", "height"};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    static float f35081c = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f35083a);
            jSONObject.put("height", bVarA.f35084b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f35079a != null) {
            ...
            f35079a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f35081c = context.getResources().getDisplayMetrics().density;
            f35079a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0394a c0394a) {
        com.iab.omid.library.fyber.internal.e eVarA = c0394a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0394a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f35082a[outputDeviceStatus.ordinal()] == 1;
    }
