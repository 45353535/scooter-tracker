...
public class c {
    ...
    private static WindowManager f36159a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static String[] f36160b = {"x", "y", "width", "height"};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    static float f36161c = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f36163a);
            jSONObject.put("height", bVarA.f36164b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f36159a != null) {
            ...
            f36159a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f36161c = context.getResources().getDisplayMetrics().density;
            f36159a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0428a c0428a) {
        com.iab.omid.library.taurusx.internal.e eVarA = c0428a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0428a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f36162a[outputDeviceStatus.ordinal()] == 1;
    }
