...
public class c {
    ...
    private static WindowManager f36427a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static String[] f36428b = {"x", "y", "width", "height"};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    static float f36429c = Resources.getSystem().getDisplayMetrics().density;

    static /* synthetic */ class a {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        static final /* synthetic */ int[] f36430a;
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f36431a);
            jSONObject.put("height", bVarA.f36432b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f36427a != null) {
            ...
            f36427a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f36429c = context.getResources().getDisplayMetrics().density;
            f36427a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0437a c0437a) {
        com.iab.omid.library.vungle.internal.e eVarA = c0437a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0437a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f36430a[outputDeviceStatus.ordinal()] == 1;
    }
