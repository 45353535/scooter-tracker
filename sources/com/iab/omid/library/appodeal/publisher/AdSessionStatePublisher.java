...
public abstract class AdSessionStatePublisher {
    ...
    private com.iab.omid.library.appodeal.weakreference.b f34422b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private AdEvents f34423c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private MediaEvents f34424d;
    ...
    public AdSessionStatePublisher(String str) {
        a();
        this.f34421a = str;
        this.f34422b = new com.iab.omid.library.appodeal.weakreference.b(null);
    }

    public void a() {
        this.f34426f = f.b();
        this.f34425e = a.AD_STATE_IDLE;
    }
    ...
    public boolean e() {
        return this.f34422b.get() != null;
    }

    public void f() {
        h.a().a(getWebView(), this.f34421a);
    }

    public void g() {
        h.a().b(getWebView(), this.f34421a);
    }

    public WebView getWebView() {
        return this.f34422b.get();
    }
    ...
    public void a(float f10) {
        h.a().a(getWebView(), this.f34421a, f10);
    }

    public void b(String str, long j10) {
        if (j10 >= this.f34426f) {
            this.f34425e = a.AD_STATE_VISIBLE;
            h.a().b(getWebView(), this.f34421a, str);
        }
    }

    void a(WebView webView) {
        this.f34422b = new com.iab.omid.library.appodeal.weakreference.b(webView);
    }

    public void b(boolean z10) {
        if (e()) {
            h.a().a(getWebView(), this.f34421a, z10 ? "locked" : "unlocked");
        }
    }

    public void a(AdEvents adEvents) {
        this.f34423c = adEvents;
    }

    public void a(AdSessionConfiguration adSessionConfiguration) {
        h.a().a(getWebView(), this.f34421a, adSessionConfiguration.toJsonObject());
    }

    public void a(ErrorType errorType, String str) {
        h.a().a(getWebView(), this.f34421a, errorType, str);
    }
    ...
    public void a(String str, @Nullable JSONObject jSONObject) {
        h.a().a(getWebView(), this.f34421a, str, jSONObject);
    }
    ...
    public void a(@Nullable JSONObject jSONObject) {
        h.a().b(getWebView(), this.f34421a, jSONObject);
    }

    public void a(boolean z10) {
        if (e()) {
            h.a().c(getWebView(), this.f34421a, z10 ? "foregrounded" : "backgrounded");
        }
    }
}
