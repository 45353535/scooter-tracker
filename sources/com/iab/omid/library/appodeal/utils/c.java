...
public class c {
    ...
    private static WindowManager f34439a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static String[] f34440b = {"x", "y", "width", "height"};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    static float f34441c = Resources.getSystem().getDisplayMetrics().density;

    static /* synthetic */ class a {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        static final /* synthetic */ int[] f34442a;
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f34443a);
            jSONObject.put("height", bVarA.f34444b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f34439a != null) {
            ...
            f34439a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f34441c = context.getResources().getDisplayMetrics().density;
            f34439a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0375a c0375a) {
        com.iab.omid.library.appodeal.internal.e eVarA = c0375a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0375a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f34442a[outputDeviceStatus.ordinal()] == 1;
    }
