...
public final class VastProperties {
    ...
    private final Position f34366d;

    private VastProperties(boolean z10, Float f10, boolean z11, Position position) {
        this.f34363a = z10;
        this.f34364b = f10;
        this.f34365c = z11;
        this.f34366d = position;
    }
    ...
    public JSONObject a() {
        ...
        try {
            jSONObject.put("skippable", this.f34363a);
            if (this.f34363a) {
                jSONObject.put("skipOffset", this.f34364b);
            }
            jSONObject.put("autoPlay", this.f34365c);
            jSONObject.put(C4240b4.i.L, this.f34366d);
            return jSONObject;
