...
public class c {
    ...
    private static WindowManager f35901a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static String[] f35902b = {"x", "y", "width", "height"};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    static float f35903c = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f35905a);
            jSONObject.put("height", bVarA.f35906b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f35901a != null) {
            ...
            f35901a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f35903c = context.getResources().getDisplayMetrics().density;
            f35901a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0420a c0420a) {
        com.iab.omid.library.pubnativenet.internal.e eVarA = c0420a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0420a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f35904a[outputDeviceStatus.ordinal()] == 1;
    }
