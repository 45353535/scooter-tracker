...
public class f extends a {
    ...
    private void b(String str) {
        ...
        if (cVarC != null) {
            for (com.iab.omid.library.pubnativenet.adsession.a aVar : cVarC.b()) {
                if (this.f35934c.contains(aVar.getAdSessionId())) {
                    aVar.getAdSessionStatePublisher().b(str, this.f35936e);
                }
            }
        }
    }
    ...
    public String doInBackground(Object... objArr) {
        if (com.iab.omid.library.pubnativenet.utils.c.h(this.f35935d, this.f35938b.a())) {
            return null;
        }
        this.f35938b.a(this.f35935d);
        return this.f35935d.toString();
    }
