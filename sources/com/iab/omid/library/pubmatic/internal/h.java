...
public class h {
    ...
    private static h f35729a = new h();

    class a implements Runnable {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ WebView f35730a;

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        final /* synthetic */ String f35731b;

        a(WebView webView, String str) {
            this.f35730a = webView;
            this.f35731b = str;
        }

        @Override // java.lang.Runnable
        public void run() {
            h.this.c(this.f35730a, this.f35731b);
        }
    }
    ...
    public boolean c(WebView webView, String str) {
        if (webView != null && !TextUtils.isEmpty(str)) {
            try {
                ...
                com.iab.omid.library.pubmatic.utils.d.b("Unable to inject javascript: " + e10.getMessage());
            }
        }
        return false;
    }
