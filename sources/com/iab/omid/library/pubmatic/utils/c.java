...
public class c {
    ...
    private static WindowManager f35766a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static String[] f35767b = {"x", "y", "width", "height"};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    static float f35768c = Resources.getSystem().getDisplayMetrics().density;
    ...
    public static void b(JSONObject jSONObject) {
        ...
        try {
            jSONObject.put("width", bVarA.f35770a);
            jSONObject.put("height", bVarA.f35771b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f35766a != null) {
            ...
            f35766a.getDefaultDisplay().getRealSize(point);
            fA = a(point.x);
            fA2 = a(point.y);
        } else {
            fA = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            f35768c = context.getResources().getDisplayMetrics().density;
            f35766a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0416a c0416a) {
        com.iab.omid.library.pubmatic.internal.e eVarA = c0416a.a();
        JSONArray jSONArray = new JSONArray();
        Iterator<String> it = c0416a.b().iterator();
        while (it.hasNext()) {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f35769a[outputDeviceStatus.ordinal()] == 1;
    }
