...
public class RatingBar extends LinearLayout {
    ...
    private static final Map f65707a = new HashMap<String, String>() { // from class: com.startapp.sdk.json.RatingBar.1
        {
    ...
    private void a(String str) throws Throwable {
        try {
            int iA = li.a(getContext(), 2);
            int iA2 = li.a(getContext(), 5);
            ...
            if (bitmapB == null) {
                bitmapB = l2.a((String) ((HashMap) f65707a).get(str));
            }
            imageView.setImageBitmap(Bitmap.createScaledBitmap(bitmapB, li.a(getContext(), 15), li.a(getContext(), 15), true));
            imageView.setPadding(iA, 0, 0, iA2);
            addView(imageView);
        } catch (NullPointerException unused) {
        }
    }

    public void setRating(float f10) throws Throwable {
        removeAllViews();
        float fRound = Math.round(f10 * 2.0f) / 2.0f;
        int iFloor = (int) Math.floor(fRound);
        int i10 = fRound - ((float) iFloor) == 0.5f ? 1 : 0;
        int i11 = (5 - iFloor) - i10;
