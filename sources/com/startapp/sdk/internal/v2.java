...
public abstract /* synthetic */ class v2 {
    ...
    static {
        ...
        try {
            f65368a[AdPreferences.Placement.INAPP_OFFER_WALL.ordinal()] = 2;
        } catch (NoSuchFieldError unused2) {
        }
        try {
            f65368a[AdPreferences.Placement.INAPP_RETURN.ordinal()] = 3;
        } catch (NoSuchFieldError unused3) {
        }
        try {
            f65368a[AdPreferences.Placement.INAPP_SPLASH.ordinal()] = 4;
