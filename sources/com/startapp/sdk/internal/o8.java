...
public abstract class o8 extends Ad {
    ...
    public boolean f65001f;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    public String[] f65002g;

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    public boolean[] f65003h;

    /* JADX INFO: renamed from: i, reason: collision with root package name */
    public String[] f65004i;
    ...
    public o8(Context context, AdPreferences.Placement placement, lb lbVar, lb lbVar2, lb lbVar3, lb lbVar4, lb lbVar5, lb lbVar6, lb lbVar7, lb lbVar8, lb lbVar9) {
        ...
        this.f64996a = new String[]{""};
        this.f64997b = "";
        this.f65000e = 0;
        this.f65001f = true;
        this.f65002g = new String[]{""};
        this.f65003h = new boolean[]{false};
        this.f65004i = new String[]{""};
        this.f65007l = 0;
        this.f65008m = false;
        this.f65009n = new String[]{""};
        this.f65010o = null;
        this.f65011p = new boolean[]{true};
        if (f64995q == null) {
            f64995q = vi.a(getContext());
        }
    }

    public final String a() {
        p pVar = (p) this.adCacheManager.a();
        return (String) pVar.f65058b.get(this.f64997b);
    }
    ...
    public void d(String str) {
        ...
        pVar.f65058b.put(string, str);
        this.f64997b = string;
        String strA = vi.a(str, "@smartRedirect@", "@smartRedirect@");
        if (strA != null) {
            String[] strArrSplit = strA.split(StringUtils.COMMA);
            this.f65003h = new boolean[strArrSplit.length];
            for (int i10 = 0; i10 < strArrSplit.length; i10++) {
                if (strArrSplit[i10].compareTo("true") == 0) {
                    this.f65003h[i10] = true;
                } else {
                    this.f65003h[i10] = false;
                }
            }
        }
        String strA2 = vi.a(str, "@trackingClickUrl@", "@trackingClickUrl@");
        if (strA2 != null) {
            this.f65002g = strA2.split(StringUtils.COMMA);
        }
        String strA3 = vi.a(str, "@closeUrl@", "@closeUrl@");
        if (strA3 != null) {
            this.f65009n = strA3.split(StringUtils.COMMA);
        }
        String strA4 = vi.a(str, "@tracking@", "@tracking@");
        if (strA4 != null) {
            this.f65004i = strA4.split(StringUtils.COMMA);
        }
        String strA5 = vi.a(str, "@packageName@", "@packageName@");
        if (strA5 != null) {
            this.f64996a = strA5.split(StringUtils.COMMA);
        }
        String strA6 = vi.a(str, "@startappBrowserEnabled@", "@startappBrowserEnabled@");
        if (strA6 != null) {
            String[] strArrSplit2 = strA6.split(StringUtils.COMMA);
            this.f65011p = new boolean[strArrSplit2.length];
            for (int i11 = 0; i11 < strArrSplit2.length; i11++) {
                if (strArrSplit2[i11].compareTo("false") == 0) {
                    this.f65011p[i11] = false;
                } else {
                    this.f65011p[i11] = true;
                }
            }
        }
        String strA7 = vi.a(str, "@orientation@", "@orientation@");
        if (strA7 != null) {
        ...
        String strA8 = vi.a(str, "@shouldLockOrientation@", "@shouldLockOrientation@");
        if (strA8 != null) {
            try {
                this.f65001f = Boolean.parseBoolean(strA8);
            } catch (Throwable th3) {
                g9.a(th3);
            }
        }
        String strA9 = vi.a(str, "@adInfoEnable@", "@adInfoEnable@");
        if (strA9 != null) {
            getAdInfoOverride().a(Boolean.parseBoolean(strA9));
        }
        String strA10 = vi.a(str, "@adInfoPosition@", "@adInfoPosition@");
        if (strA10 != null) {
            getAdInfoOverride().a(AdInformationPositions.Position.getByName(strA10));
        }
        String strA11 = vi.a(str, "@ttl@", "@ttl@");
        if (strA11 != null) {
            c(strA11);
        }
        String strA12 = vi.a(str, "@belowMinCPM@", "@belowMinCPM@");
        if (strA12 != null) {
            if (Arrays.asList(strA12.split(StringUtils.COMMA)).contains("false")) {
                this.belowMinCPM = false;
            } else {
                this.belowMinCPM = true;
            }
        }
        String strA13 = vi.a(str, "@delayCloseInterval@", "@delayCloseInterval@");
        if (strA13 != null && strA13.length() > 0) {
            try {
                this.f65006k = Long.valueOf(Long.parseLong(strA13));
            } catch (NumberFormatException unused) {
            }
        }
        String strA14 = vi.a(str, "@delayImpressionInSeconds@", "@delayImpressionInSeconds@");
        if (strA14 != null && strA14.length() > 0) {
            try {
                this.f65005j = Long.valueOf(Long.parseLong(strA14));
            } catch (NumberFormatException unused2) {
            }
        }
        String strA15 = vi.a(str, "@rewardDuration@", "@rewardDuration@");
        if (strA15 != null) {
            try {
                this.f65007l = Integer.parseInt(strA15);
            } catch (Throwable th4) {
                g9.a(th4);
            }
        }
        String strA16 = vi.a(str, "@rewardedHideTimer@", "@rewardedHideTimer@");
        if (strA16 != null) {
            try {
                this.f65008m = Boolean.parseBoolean(strA16);
            } catch (Throwable th5) {
                g9.a(th5);
            }
        }
        String strA17 = vi.a(str, "@sendRedirectHops@", "@sendRedirectHops@");
        if (strA17 != null && !strA17.equals("")) {
            String[] strArrSplit3 = strA17.split(StringUtils.COMMA);
            this.f65010o = new Boolean[strArrSplit3.length];
            for (int i12 = 0; i12 < strArrSplit3.length; i12++) {
                if (strArrSplit3[i12].compareTo("true") == 0) {
                    this.f65010o[i12] = Boolean.TRUE;
                } else if (strArrSplit3[i12].compareTo("false") == 0) {
                    this.f65010o[i12] = Boolean.FALSE;
                } else {
                    this.f65010o[i12] = null;
                }
            }
        }
        ConsentData consentData = new ConsentData();
        this.consentData = consentData;
        consentData.b(vi.a(str, "@infoDparam@", "@infoDparam@"));
        this.consentData.c(vi.a(str, "@infoImpUrl@", "@infoImpUrl@"));
        this.consentData.a(vi.a(str, "@infoClickUrl@", "@infoClickUrl@"));
        try {
            String strA18 = vi.a(str, "@ct@", "@ct@");
        ...
        try {
            String strA19 = vi.a(str, "@tsc@", "@tsc@");
        ...
        try {
            String strA20 = vi.a(str, "@apc@", "@apc@");
        ...
        int length = this.f65003h.length;
        String[] strArr = this.f65004i;
        if (length < strArr.length) {
            boolean[] zArr = new boolean[strArr.length];
            int i13 = 0;
            while (true) {
                boolean[] zArr2 = this.f65003h;
                if (i13 >= zArr2.length) {
                    break;
                }
                zArr[i13] = zArr2[i13];
            ...
            while (i13 < this.f65004i.length) {
                zArr[i13] = false;
                i13++;
            }
            this.f65003h = zArr;
        }
        String strA21 = vi.a(str, "@erid@", "@erid@");
        if (strA21 != null) {
            setErid(strA21);
        }
        String strA22 = vi.a(str, "@eridUrl@", "@eridUrl@");
        if (strA22 != null) {
            setEridUrl(strA22);
        }
    }
    ...
    public final String getAdId() {
        return vi.a(a(), "@adId@", "@adId@");
    }

    @Override // com.startapp.sdk.adsbase.Ad
    public final String getDParam() {
        String[] strArr = this.f65002g;
        String[] strArr2 = this.f65004i;
        String str = null;
