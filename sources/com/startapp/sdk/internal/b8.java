...
public final class b8 {
    ...
    public final LinkedHashSet f64309a = new LinkedHashSet();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final LinkedHashSet f64310b = new LinkedHashSet();

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public GetBluetoothAsync$startUnsafe$1 f64311c;

    public final synchronized JSONObject a() {
        JSONObject jSONObject;
        try {
            if (this.f64309a.size() > 0) {
                JSONArray jSONArray = new JSONArray();
                for (BluetoothDevice bluetoothDevice : this.f64309a) {
                    int i10 = com.startapp.sdk.adsbase.periodic.a.f64120i;
            ...
            for (BluetoothDevice bluetoothDevice2 : this.f64310b) {
                int i11 = com.startapp.sdk.adsbase.periodic.a.f64120i;
