...
public final class VunglePrivacySettings {
    ...
    public static final void setGDPRStatus(boolean optIn, @Nullable String consentMessageVersion) {
        PrivacyManager.INSTANCE.updateGdprConsent(optIn ? PrivacyConsent.OPT_IN.getValue() : PrivacyConsent.OPT_OUT.getValue(), Fb.f40908b, consentMessageVersion);
    }
}
