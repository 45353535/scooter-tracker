...
public abstract class BaseAd implements Ad {
    ...
    public BaseAd(@NotNull final Context context, @NotNull String placementId, @NotNull AdConfig adConfig) {
        ...
        this.adInternal = i.a(new Function0<AdInternal>() { // from class: com.vungle.ads.BaseAd$adInternal$2
            {
                super(0);
            }
        ...
        this.signalManager = i.b(l.f94209b, new Function0<SignalManager>() { // from class: com.vungle.ads.BaseAd$special$$inlined$inject$1
    ...
    @Override // com.vungle.ads.Ad
    public void load(@Nullable final String adMarkup) throws Throwable {
    ...
    public void onLoadFailure$vungle_ads_release(@NotNull BaseAd baseAd, @NotNull final VungleError vungleError) throws Throwable {
    ...
    public void onLoadSuccess$vungle_ads_release(@NotNull BaseAd baseAd, @Nullable String adMarkup) throws Throwable {
        Intrinsics.checkNotNullParameter(baseAd, "baseAd");
        onLoadEnd();
