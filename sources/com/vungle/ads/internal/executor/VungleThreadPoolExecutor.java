...
public final class VungleThreadPoolExecutor extends ThreadPoolExecutor {
    ...
    @Metadata(d1 = {"\u00000\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J0\u0010\u0005\u001a\b\u0012\u0004\u0012\u0002H\u00070\u0006\"\u0004\b\u0000\u0010\u00072\f\u0010\b\u001a\b\u0012\u0004\u0012\u0002H\u00070\u00062\f\u0010\t\u001a\b\u0012\u0004\u0012\u00020\u000b0\nH\u0002J\u0018\u0010\f\u001a\u00020\r2\u0006\u0010\b\u001a\u00020\u000e2\u0006\u0010\u000f\u001a\u00020\u000eH\u0002J\u0018\u0010\u0010\u001a\u00020\u000b2\u0006\u0010\b\u001a\u00020\u000e2\u0006\u0010\u000f\u001a\u00020\u000eH\u0002R\u000e\u0010\u0003\u001a\u00020\u0004X\u0082T¢\u0006\u0002\n\u0000¨\u0006\u0011"}, d2 = {"Lcom/vungle/ads/internal/executor/VungleThreadPoolExecutor$Companion;", "", "()V", "TAG", "", "getWrappedCallableWithFallback", "Ljava/util/concurrent/Callable;", "T", f.b.f45113g, "failFallback", "Lkotlin/Function0;", "", "getWrappedRunnableWithFail", "Lcom/vungle/ads/internal/executor/VungleThreadPoolExecutor$ComparableRunnable;", "Ljava/lang/Runnable;", C4240b4.g.f42582e, "wrapRunnableWithFail", "vungle-ads_release"}, k = 1, mv = {1, 7, 1}, xi = 48)
    public static final class Companion {
        ...
        public final <T> Callable<T> getWrappedCallableWithFallback(final Callable<T> command, final Function0<Unit> failFallback) {
            return new Callable() { // from class: com.vungle.ads.internal.executor.d
                ...
                public final Object call() {
                    return VungleThreadPoolExecutor.Companion.m7527getWrappedCallableWithFallback$lambda0(command, failFallback);
                }
            };
        }
        ...
        public static final Object m7527getWrappedCallableWithFallback$lambda0(Callable command, Function0 failFallback) {
    ...
    public static final void m7524execute$lambda0(VungleThreadPoolExecutor this$0) {
    ...
    public static final void m7525submit$lambda1(VungleThreadPoolExecutor this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    public static final void m7526submit$lambda2(VungleThreadPoolExecutor this$0) {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
        ...
        try {
            super.execute(INSTANCE.getWrappedRunnableWithFail(command, new Runnable() { // from class: com.vungle.ads.internal.executor.b
                ...
                public final void run() {
                    VungleThreadPoolExecutor.m7524execute$lambda0(this.f68019b);
                }
            }));
        } catch (Exception e10) {
    ...
    public Future<?> submit(@NotNull Runnable task) {
        ...
        try {
            Future<?> futureSubmit = super.submit(INSTANCE.getWrappedRunnableWithFail(task, new Runnable() { // from class: com.vungle.ads.internal.executor.c
                @Override // java.lang.Runnable
                public final void run() {
                    VungleThreadPoolExecutor.m7525submit$lambda1(this.f68020b);
                }
            }));
    ...
    public <T> Future<T> submit(@NotNull Runnable task, T result) {
        Intrinsics.checkNotNullParameter(task, "task");
        try {
            Future<T> futureSubmit = super.submit(INSTANCE.getWrappedRunnableWithFail(task, new Runnable() { // from class: com.vungle.ads.internal.executor.a
                @Override // java.lang.Runnable
                public final void run() {
                    VungleThreadPoolExecutor.m7526submit$lambda2(this.f68018b);
                }
            }), result);
            Intrinsics.checkNotNullExpressionValue(futureSubmit, "{\n            super.subm…     }, result)\n        }");
            return futureSubmit;
