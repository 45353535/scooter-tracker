...
public abstract class AdInternal implements AdLoaderCallback {
    ...
    @NotNull
    private static final kotlinx.serialization.json.b json = v.b(null, new Function1<e, Unit>() { // from class: com.vungle.ads.internal.AdInternal$Companion$json$1
    ...
    @Metadata(d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0010\u000e\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003R\u001a\u0010\u0005\u001a\u00020\u00048\u0002X\u0082\u0004¢\u0006\f\n\u0004\b\u0005\u0010\u0006\u0012\u0004\b\u0007\u0010\u0003R\u0014\u0010\t\u001a\u00020\b8\u0002X\u0082T¢\u0006\u0006\n\u0004\b\t\u0010\nR\u0014\u0010\f\u001a\u00020\u000b8\u0002X\u0082D¢\u0006\u0006\n\u0004\b\f\u0010\r¨\u0006\u000e"}, d2 = {"Lcom/vungle/ads/internal/AdInternal$Companion;", "", "<init>", "()V", "Lkotlinx/serialization/json/b;", "json", "Lkotlinx/serialization/json/b;", "getJson$annotations", "", "TAG", "Ljava/lang/String;", "", "THROW_ON_ILLEGAL_TRANSITION", "Z", "vungle-ads_release"}, k = 1, mv = {1, 7, 1}, xi = 48)
    ...
    public AdInternal(@NotNull final Context context) {
        ...
        this.vungleApiClient = i.b(l.f94209b, new Function0<VungleApiClient>() { // from class: com.vungle.ads.internal.AdInternal$special$$inlined$inject$1
    ...
    private static final JobRunner m7499_set_adState_$lambda1$lambda0(Lazy lazy) {
    ...
    public final void loadAd(@NotNull String placementId, @Nullable String adMarkup, @NotNull AdLoaderCallback adLoaderCallback) throws Throwable {
        ...
        if (adMarkup != null && adMarkup.length() != 0) {
            try {
                ...
                KSerializer kSerializerB = ug.v.b(bVar.a(), v0.o(BidPayload.class));
                ...
                this.bidPayload = (BidPayload) bVar.c(kSerializerB, adMarkup);
        ...
        l lVar = l.f94209b;
        Lazy lazyB = i.b(lVar, new Function0<OMInjector>() { // from class: com.vungle.ads.internal.AdInternal$loadAd$$inlined$inject$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
        ...
        Lazy lazyB2 = i.b(lVar, new Function0<SDKExecutors>() { // from class: com.vungle.ads.internal.AdInternal$loadAd$$inlined$inject$2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
        ...
        Lazy lazyB3 = i.b(lVar, new Function0<PathProvider>() { // from class: com.vungle.ads.internal.AdInternal$loadAd$$inlined$inject$3
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
        ...
        Lazy lazyB4 = i.b(lVar, new Function0<Downloader>() { // from class: com.vungle.ads.internal.AdInternal$loadAd$$inlined$inject$4
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
        ...
        if (adMarkup == null || adMarkup.length() == 0) {
            this.baseAdLoader = new DefaultAdLoader(this.context, getVungleApiClient(), m7501loadAd$lambda3(lazyB2), m7500loadAd$lambda2(lazyB), m7503loadAd$lambda5(lazyB4), m7502loadAd$lambda4(lazyB3), new AdRequest(placement, null, adSizeForAdRequest));
        } else {
            this.baseAdLoader = new RealtimeAdLoader(this.context, getVungleApiClient(), m7501loadAd$lambda3(lazyB2), m7500loadAd$lambda2(lazyB), m7503loadAd$lambda5(lazyB4), m7502loadAd$lambda4(lazyB3), new AdRequest(placement, this.bidPayload, adSizeForAdRequest));
        }
        BaseAdLoader baseAdLoader = this.baseAdLoader;
        if (baseAdLoader != null) {
    ...
    @Override // com.vungle.ads.internal.load.AdLoaderCallback
    public void onSuccess(@NotNull AdPayload advertisement) throws Throwable {
        Intrinsics.checkNotNullParameter(advertisement, "advertisement");
        ...
        if (timeIntervalMetric2 != null) {
            ...
            ServiceLocator.Companion companion = ServiceLocator.INSTANCE;
            final Context context = this.context;
            Lazy lazyB = i.b(l.f94209b, new Function0<TpatSender>() { // from class: com.vungle.ads.internal.AdInternal$onSuccess$lambda-11$$inlined$inject$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(0);
                }
            ...
            if (tpatUrls$default != null) {
                ...
                while (it.hasNext()) {
                    TpatSender.sendTpat$default(m7504onSuccess$lambda11$lambda9(lazyB), new TpatRequest.Builder((String) it.next()).tpatKey(Constants.AD_LOAD_DURATION).withLogEntry(this.logEntry).build(), false, 2, null);
                }
            }
        }
    }

    public final void play(@Nullable Context context, @NotNull final AdPlayCallback adPlayCallback) throws Throwable {
    ...
    public void renderAd$vungle_ads_release(@Nullable final AdPlayCallback listener, @NotNull AdPayload advertisement) throws Throwable {
        Context context;
        Intrinsics.checkNotNullParameter(advertisement, "advertisement");
    ...
    public final void setAdState(@NotNull AdState value) {
        ...
        if (value.isTerminalState() && (adPayload = this.advertisement) != null && (strEventId = adPayload.eventId()) != null) {
            ServiceLocator.Companion companion = ServiceLocator.INSTANCE;
            final Context context = this.context;
            m7499_set_adState_$lambda1$lambda0(i.b(l.f94209b, new Function0<JobRunner>() { // from class: com.vungle.ads.internal.AdInternal$_set_adState_$lambda-1$$inlined$inject$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(0);
                }
