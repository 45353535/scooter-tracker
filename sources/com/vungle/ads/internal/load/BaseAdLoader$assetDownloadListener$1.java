...
public final class BaseAdLoader$assetDownloadListener$1 implements AssetDownloadListener {
    ...
    public static final void m7531onError$lambda1(DownloadRequest downloadRequest, BaseAdLoader this$0, BaseAdLoader$assetDownloadListener$1 this$1, AssetDownloadListener.DownloadError downloadError) {
    ...
    public static final void m7532onProgress$lambda0(BaseAdLoader this$0, AdAsset adAsset) throws Throwable {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
    ...
    public static final void m7533onSuccess$lambda2(File file, BaseAdLoader$assetDownloadListener$1 this$0, DownloadRequest downloadRequest, BaseAdLoader this$1) throws Throwable {
    ...
    public void onError(@Nullable final AssetDownloadListener.DownloadError error, @NotNull final DownloadRequest downloadRequest) {
        ...
        background_executor.execute(new Runnable() { // from class: com.vungle.ads.internal.load.d
            ...
            public final void run() {
                BaseAdLoader$assetDownloadListener$1.m7531onError$lambda1(downloadRequest, baseAdLoader, this, error);
            }
        });
    }
    ...
    public void onProgress(@NotNull AssetDownloadListener.Progress progress, @NotNull DownloadRequest downloadRequest) throws Throwable {
        ...
        background_executor.execute(new Runnable() { // from class: com.vungle.ads.internal.load.b
            ...
            public final void run() throws Throwable {
                BaseAdLoader$assetDownloadListener$1.m7532onProgress$lambda0(baseAdLoader, asset);
            }
        });
    }
    ...
    public void onSuccess(@NotNull final File file, @NotNull final DownloadRequest downloadRequest) {
        ...
        background_executor.execute(new Runnable() { // from class: com.vungle.ads.internal.load.c
            @Override // java.lang.Runnable
            public final void run() throws Throwable {
                BaseAdLoader$assetDownloadListener$1.m7533onSuccess$lambda2(file, this, downloadRequest, baseAdLoader);
            }
        });
    }
}
