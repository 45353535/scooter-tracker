...
public final class RealtimeAdLoader extends BaseAdLoader {
    ...
    private static final VungleApiClient m7536requestAd$lambda0(Lazy lazy) {
    ...
    private final void sendWinNotification(List<String> notifications) {
        if (notifications == null || !notifications.isEmpty()) {
            ...
            Lazy lazyB = i.b(l.f94209b, new Function0<TpatSender>() { // from class: com.vungle.ads.internal.load.RealtimeAdLoader$sendWinNotification$$inlined$inject$1
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(0);
                }
            ...
            if (notifications != null) {
                ...
                while (it.hasNext()) {
                    TpatSender.sendTpat$default(m7537sendWinNotification$lambda2(lazyB), new TpatRequest.Builder((String) it.next()).tpatKey(Constants.WIN_NOTIFICATION).withLogEntry(getLogEntry()).build(), false, 2, null);
                }
            }
        }
    }
    ...
    private static final TpatSender m7537sendWinNotification$lambda2(Lazy lazy) {
    ...
    protected void requestAd() {
        ...
        if (ConfigManager.INSTANCE.rtaDebuggingEnabled()) {
            try {
                ...
                ServiceLocator.Companion companion = ServiceLocator.INSTANCE;
                final Context context = getContext();
                Lazy lazyB = i.b(l.f94209b, new Function0<VungleApiClient>() { // from class: com.vungle.ads.internal.load.RealtimeAdLoader$requestAd$$inlined$inject$1
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(0);
                    }
                ...
                if (decodedAdsResponse != null) {
                    new RTADebugger(m7536requestAd$lambda0(lazyB)).reportAdMarkup(decodedAdsResponse);
                }
