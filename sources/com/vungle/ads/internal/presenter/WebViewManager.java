        ...
        try {
            ...
            if (!linkedHashMap.containsKey(strEventId)) {
                ThreadUtil.INSTANCE.runOnUiThread(new Function0<Unit>() { // from class: com.vungle.ads.internal.presenter.WebViewManager$preloadWebView$1$1
                    ...
                    private static final Executors m7553invoke$lambda3$lambda1(Lazy lazy) {
                        return (Executors) lazy.getValue();
                    }

                    /* JADX INFO: renamed from: invoke$lambda-3$lambda-2, reason: not valid java name */
                    private static final Platform m7554invoke$lambda3$lambda2(Lazy lazy) {
                    ...
                    public final void invoke2() {
                        ...
                        try {
                            ...
                            l lVar = l.f94209b;
                            VungleWebClient vungleWebClient = new VungleWebClient(adPayload, placement2, m7553invoke$lambda3$lambda1(i.b(lVar, new Function0<Executors>() { // from class: com.vungle.ads.internal.presenter.WebViewManager$preloadWebView$1$1$invoke$lambda-3$$inlined$inject$1
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                {
                                    super(0);
                                }
                            ...
                            })).getOFFLOAD_EXECUTOR(), m7554invoke$lambda3$lambda2(i.b(lVar, new Function0<Platform>() { // from class: com.vungle.ads.internal.presenter.WebViewManager$preloadWebView$1$1$invoke$lambda-3$$inlined$inject$2
                                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                {
                                    super(0);
                                }
                            ...
                            objB = Result.b(Integer.valueOf(Logger.INSTANCE.d("WebViewManager", "Preload complete. Cache size: " + WebViewManager.webViewCache.size())));
                        } catch (Throwable th2) {
                        ...
                        if (thG != null) {
                            Logger.INSTANCE.e("WebViewManager", "Preload webview failed", thG);
