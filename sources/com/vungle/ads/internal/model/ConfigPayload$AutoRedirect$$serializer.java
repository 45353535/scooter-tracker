...
public final class ConfigPayload$AutoRedirect$$serializer implements o0 {
    ...
    static {
        ...
        i2 i2Var = new i2("com.vungle.ads.internal.model.ConfigPayload.AutoRedirect", configPayload$AutoRedirect$$serializer, 2);
        i2Var.n("allow_auto_redirect", true);
        i2Var.n("after_click_ms", true);
        descriptor = i2Var;
    }
    ...
    public KSerializer[] childSerializers() {
        return new KSerializer[]{a.t(i.f118983a), a.t(i1.f118988a)};
    }
    ...
    public ConfigPayload.AutoRedirect deserialize(@NotNull Decoder decoder) {
        ...
        if (dVarB.j()) {
            ...
            while (z10) {
                ...
                if (iX == -1) {
                    ...
                    objP3 = dVarB.p(descriptor2, 1, i1.f118988a, objP3);
                    i11 |= 2;
                }
            }
            objP2 = objP3;
        ...
        dVarB.c(descriptor2);
        return new ConfigPayload.AutoRedirect(i10, (Boolean) objP, (Long) objP2, (t2) null);
    }
    ...
    public void serialize(@NotNull Encoder encoder, @NotNull ConfigPayload.AutoRedirect value) {
        ...
        ConfigPayload.AutoRedirect.write$Self(value, fVarB, descriptor2);
        fVarB.c(descriptor2);
    }
