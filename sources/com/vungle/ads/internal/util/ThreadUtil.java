...
public final class ThreadUtil {
    ...
    public static final void m7584runOnUiThread$lambda0(Function0 tmp0) {
    ...
    public static final void m7585runOnUiThread$lambda1(Function0 tmp0) {
        Intrinsics.checkNotNullParameter(tmp0, "$tmp0");
        tmp0.invoke();
    }
        ...
        if (executor == null) {
            UI_HANDLER.post(new Runnable() { // from class: com.vungle.ads.internal.util.d
                ...
                public final void run() {
                    ThreadUtil.m7585runOnUiThread$lambda1(block);
                }
            });
            ...
            executor.execute(new Runnable() { // from class: com.vungle.ads.internal.util.c
                @Override // java.lang.Runnable
                public final void run() {
                    ThreadUtil.m7584runOnUiThread$lambda0(block);
                }
            });
        }
    }
