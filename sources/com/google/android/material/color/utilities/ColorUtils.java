...
public class ColorUtils {
    ...
    static final double[][] f26120a = {new double[]{0.41233895d, 0.35762064d, 0.18051042d}, new double[]{0.2126d, 0.7152d, 0.0722d}, new double[]{0.01932141d, 0.11916382d, 0.95034478d}};

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    static final double[][] f26121b = {new double[]{3.2413774792388685d, -1.5376652402851851d, -0.49885366846268053d}, new double[]{-0.9691452513005321d, 1.8758853451067872d, 0.04156585616912061d}, new double[]{0.05562093689691305d, -0.20395524564742123d, 1.0571799111220335d}};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    static final double[] f26122c = {95.047d, 100.0d, 108.883d};
    ...
    public static int argbFromLab(double d10, double d11, double d12) {
        ...
        return argbFromXyz(b((d11 / 500.0d) + d13) * dArr[0], b(d13) * dArr[1], b(d14) * dArr[2]);
    }
    ...
    public static double[] labFromArgb(int i10) {
        ...
        double[][] dArr = f26120a;
        double[] dArr2 = dArr[0];
        double d10 = (dArr2[0] * dLinearized) + (dArr2[1] * dLinearized2) + (dArr2[2] * dLinearized3);
        double[] dArr3 = dArr[1];
        double d11 = (dArr3[0] * dLinearized) + (dArr3[1] * dLinearized2) + (dArr3[2] * dLinearized3);
        double[] dArr4 = dArr[2];
        double d12 = (dArr4[0] * dLinearized) + (dArr4[1] * dLinearized2) + (dArr4[2] * dLinearized3);
        double[] dArr5 = f26122c;
    ...
    public static double[] xyzFromArgb(int i10) {
        return MathUtils.matrixMultiply(new double[]{linearized(redFromArgb(i10)), linearized(greenFromArgb(i10)), linearized(blueFromArgb(i10))}, f26120a);
    }
