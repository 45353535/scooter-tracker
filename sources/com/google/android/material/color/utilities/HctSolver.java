...
public class HctSolver {
        ...
        for (int i10 = 0; i10 < 3; i10++) {
            ...
            if (d12 != d13) {
                ...
                for (int i13 = 0; i13 < 8 && Math.abs(i12 - i11) > 1; i13++) {
                    ...
                    double[] dArrP = p(dArr, f26140d[iFloor], dArr2, i10);
                    double dH2 = h(dArrP);
                    if (a(d15, d11, dH2)) {
                        i12 = iFloor;
                        dArr2 = dArrP;
    ...
    static int g(double d10, double d11, double d12) {
        ...
        double d15 = 2.0d;
        double dCos = (Math.cos(d10 + 2.0d) + 3.8d) * 0.25d * 3846.153846153846d * viewingConditions.c() * viewingConditions.d();
        double dSin = Math.sin(d10);
        double dCos2 = Math.cos(d10);
        int i10 = 0;
        while (i10 < 5) {
            double d16 = d13;
            double d17 = dSqrt / 100.0d;
            double d18 = d14;
            double d19 = d15;
            double dPow2 = Math.pow(((d11 == 0.0d || dSqrt == 0.0d) ? 0.0d : d11 / Math.sqrt(d17)) * dPow, 1.1111111111111112d);
            double d20 = dSqrt;
            double aw = (viewingConditions.getAw() * Math.pow(d17, (d18 / viewingConditions.a()) / viewingConditions.e())) / viewingConditions.getNbb();
            double d21 = (((0.305d + aw) * 23.0d) * dPow2) / (((23.0d * dCos) + ((dPow2 * d16) * dCos2)) + ((dPow2 * 108.0d) * dSin));
            double d22 = d21 * dCos2;
            double d23 = d21 * dSin;
            double d24 = aw * 460.0d;
            double[] dArrMatrixMultiply = MathUtils.matrixMultiply(new double[]{j((((451.0d * d22) + d24) + (288.0d * d23)) / 1403.0d), j(((d24 - (891.0d * d22)) - (261.0d * d23)) / 1403.0d), j(((d24 - (d22 * 220.0d)) - (d23 * 6300.0d)) / 1403.0d)}, f26138b);
            double d25 = dArrMatrixMultiply[0];
            if (d25 < 0.0d) {
                break;
            }
            double d26 = dArrMatrixMultiply[1];
            if (d26 < 0.0d) {
                break;
            }
            double d27 = dArrMatrixMultiply[2];
            if (d27 < 0.0d) {
                break;
            }
            double[] dArr = f26139c;
    ...
    static double h(double[] dArr) {
        double[] dArrMatrixMultiply = MathUtils.matrixMultiply(dArr, f26137a);
        double d10 = d(dArrMatrixMultiply[0]);
        double d11 = d(dArrMatrixMultiply[1]);
        double d12 = d(dArrMatrixMultiply[2]);
    ...
    static double j(double d10) {
        ...
        return ((double) MathUtils.signum(d10)) * Math.pow(Math.max(0.0d, (27.13d * dAbs) / (400.0d - dAbs)), 2.380952380952381d);
    }
    ...
    public static int solveToInt(double d10, double d11, double d12) {
        ...
        int iG = g(dSanitizeDegreesDouble, d11, dYFromLstar);
        return iG != 0 ? iG : ColorUtils.argbFromLinrgb(b(dYFromLstar, dSanitizeDegreesDouble));
    }
}
