...
public class DockedToolbarLayout extends FrameLayout {
    ...
    private static final int f26501d = R.style.Widget_Material3_DockedToolbar;
    ...
    public DockedToolbarLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i10) {
        this(context, attributeSet, i10, f26501d);
    }
    ...
    public DockedToolbarLayout(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i10, @StyleRes int i11) {
        ...
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(i13)) {
            this.f26502b = Boolean.valueOf(tintTypedArrayObtainTintedStyledAttributes.getBoolean(i13, true));
        }
        ...
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(i14)) {
            this.f26503c = Boolean.valueOf(tintTypedArrayObtainTintedStyledAttributes.getBoolean(i14, true));
        }
        ViewUtils.doOnApplyWindowInsets(this, new ViewUtils.OnApplyWindowInsetsListener() { // from class: com.google.android.material.dockedtoolbar.DockedToolbarLayout.1
            ...
            public WindowInsetsCompat onApplyWindowInsets(View view, @NonNull WindowInsetsCompat windowInsetsCompat, @NonNull ViewUtils.RelativePadding relativePadding) {
                if (DockedToolbarLayout.this.f26502b != null && DockedToolbarLayout.this.f26503c != null && !DockedToolbarLayout.this.f26502b.booleanValue() && !DockedToolbarLayout.this.f26503c.booleanValue()) {
                ...
                int i17 = (DockedToolbarLayout.this.d(layoutParams, 48) && DockedToolbarLayout.this.f26502b == null && DockedToolbarLayout.this.getFitsSystemWindows()) ? i16 : 0;
                int i18 = (DockedToolbarLayout.this.d(layoutParams, 80) && DockedToolbarLayout.this.f26503c == null && DockedToolbarLayout.this.getFitsSystemWindows()) ? i15 : 0;
                if (DockedToolbarLayout.this.f26503c != null) {
                    if (!DockedToolbarLayout.this.f26503c.booleanValue()) {
                        i15 = 0;
                    }
                    i18 = i15;
                }
                if (DockedToolbarLayout.this.f26502b != null) {
                    if (!DockedToolbarLayout.this.f26502b.booleanValue()) {
                        i16 = 0;
                    }
                    i17 = i16;
                }
