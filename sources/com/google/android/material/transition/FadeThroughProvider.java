...
public final class FadeThroughProvider implements VisibilityAnimatorProvider {
    ...
    private static Animator a(final View view, final float f10, final float f11, final float f12, final float f13, final float f14) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.transition.FadeThroughProvider.1
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                view.setAlpha(TransitionUtils.l(f10, f11, f12, f13, ((Float) valueAnimator.getAnimatedValue()).floatValue()));
            }
        });
    ...
    public Animator createAppear(@NonNull ViewGroup viewGroup, @NonNull View view) {
        ...
        return a(view, 0.0f, alpha, this.f28316a, 1.0f, alpha);
    }
    ...
    public Animator createDisappear(@NonNull ViewGroup viewGroup, @NonNull View view) {
        float alpha = view.getAlpha() == 0.0f ? 1.0f : view.getAlpha();
        return a(view, alpha, 0.0f, 0.0f, this.f28316a, alpha);
    }
