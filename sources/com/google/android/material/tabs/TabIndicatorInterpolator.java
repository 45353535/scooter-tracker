...
class TabIndicatorInterpolator {
    ...
    void d(TabLayout tabLayout, View view, View view2, float f10, Drawable drawable) {
        ...
        drawable.setBounds(AnimationUtils.lerp((int) rectFA.left, (int) rectFA2.left, f10), drawable.getBounds().top, AnimationUtils.lerp((int) rectFA.right, (int) rectFA2.right, f10), drawable.getBounds().bottom);
    }
}
