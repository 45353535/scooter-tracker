...
public class MaterialResources {
    ...
    static int b(TypedArray typedArray, int i10, int i11) {
    ...
    public static int getUnscaledLineHeight(@NonNull Context context, @StyleRes int i10, int i11) {
        if (i10 != 0) {
            ...
            typedArrayObtainStyledAttributes.recycle();
            if (value) {
                return a(typedValue) == 2 ? Math.round(TypedValue.complexToFloat(typedValue.data) * context.getResources().getDisplayMetrics().density) : TypedValue.complexToDimensionPixelSize(typedValue.data, context.getResources().getDisplayMetrics());
            }
        }
        return i11;
    }
