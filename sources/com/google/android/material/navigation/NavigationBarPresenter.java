...
public class NavigationBarPresenter implements MenuPresenter {
    ...
    private NavigationBarMenuView f27052b;
    ...
    static class SavedState implements Parcelable {
        ...
        public void writeToParcel(@NonNull Parcel parcel, int i10) {
            ...
            parcel.writeParcelable(this.f27056c, 0);
        }

        SavedState(Parcel parcel) {
            this.f27055b = parcel.readInt();
            this.f27056c = (ParcelableSparseArray) parcel.readParcelable(getClass().getClassLoader());
        }
    }
    ...
    public void initForMenu(@NonNull Context context, @NonNull MenuBuilder menuBuilder) {
        this.f27052b.initialize(menuBuilder);
    }
    ...
    public void onRestoreInstanceState(@NonNull Parcelable parcelable) {
        if (parcelable instanceof SavedState) {
            ...
            this.f27052b.n(savedState.f27055b);
            this.f27052b.m(BadgeUtils.createBadgeDrawablesFromSavedStates(this.f27052b.getContext(), savedState.f27056c));
        }
    }
    ...
    public Parcelable onSaveInstanceState() {
        ...
        savedState.f27055b = this.f27052b.getSelectedItemId();
        savedState.f27056c = BadgeUtils.createParcelableBadgeStates(this.f27052b.getBadgeDrawables());
        return savedState;
    }
    ...
    public void setMenuView(@NonNull NavigationBarMenuView navigationBarMenuView) {
        this.f27052b = navigationBarMenuView;
    }
    ...
    public void updateMenuView(boolean z10) {
        ...
        if (z10) {
            this.f27052b.buildMenuView();
        } else {
            this.f27052b.updateMenuView();
        }
    }
}
