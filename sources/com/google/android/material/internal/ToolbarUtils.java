...
public class ToolbarUtils {
    ...
    private static final Comparator f26872a = new Comparator<View>() { // from class: com.google.android.material.internal.ToolbarUtils.1
    ...
    private static List b(Toolbar toolbar, CharSequence charSequence) {
    ...
    public static TextView getSubtitleTextView(@NonNull Toolbar toolbar) {
        List listB = b(toolbar, toolbar.getSubtitle());
        if (listB.isEmpty()) {
            return null;
        }
        return (TextView) Collections.max(listB, f26872a);
    }

    @Nullable
    public static TextView getTitleTextView(@NonNull Toolbar toolbar) {
        List listB = b(toolbar, toolbar.getTitle());
        if (listB.isEmpty()) {
            return null;
        }
        return (TextView) Collections.min(listB, f26872a);
    }
}
