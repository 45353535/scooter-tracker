...
public interface CircularRevealWidget extends CircularRevealHelper.Delegate {
    ...
    public static class CircularRevealEvaluator implements TypeEvaluator<RevealInfo> {
        ...
        private final RevealInfo f26012a = new RevealInfo();

        @Override // android.animation.TypeEvaluator
        @NonNull
        public RevealInfo evaluate(float f10, @NonNull RevealInfo revealInfo, @NonNull RevealInfo revealInfo2) {
            this.f26012a.set(MathUtils.lerp(revealInfo.centerX, revealInfo2.centerX, f10), MathUtils.lerp(revealInfo.centerY, revealInfo2.centerY, f10), MathUtils.lerp(revealInfo.radius, revealInfo2.radius, f10));
            return this.f26012a;
        }
    }
