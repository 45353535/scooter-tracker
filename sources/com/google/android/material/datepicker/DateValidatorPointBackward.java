...
public class DateValidatorPointBackward implements CalendarConstraints.DateValidator {
    ...
    public static DateValidatorPointBackward now() {
        return before(UtcDates.q().getTimeInMillis());
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof DateValidatorPointBackward) && this.f26310b == ((DateValidatorPointBackward) obj).f26310b;
    }

    public int hashCode() {
        return Arrays.hashCode(new Object[]{Long.valueOf(this.f26310b)});
    }

    @Override // com.google.android.material.datepicker.CalendarConstraints.DateValidator
    public boolean isValid(long j10) {
        return j10 <= this.f26310b;
    }

    @Override // android.os.Parcelable
    public void writeToParcel(@NonNull Parcel parcel, int i10) {
        parcel.writeLong(this.f26310b);
    }
