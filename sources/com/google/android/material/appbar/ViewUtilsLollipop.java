...
class ViewUtilsLollipop {
    ...
    private static final int[] f25413a = {R.attr.stateListAnimator};
    ...
    static void c(View view, AttributeSet attributeSet, int i10, int i11) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, f25413a, i10, i11, new int[0]);
        try {
