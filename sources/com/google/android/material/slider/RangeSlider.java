...
public class RangeSlider extends BaseSlider<RangeSlider, OnChangeListener, OnSliderTouchListener> {
    ...
    private float f27757d1;

    /* JADX INFO: renamed from: e1, reason: collision with root package name */
    private int f27758e1;
    ...
    static class RangeSliderState extends AbsSavedState {
        ...
        public void writeToParcel(Parcel parcel, int i10) {
            ...
            parcel.writeFloat(this.f27759b);
    ...
    private static List k1(TypedArray typedArray) {
    ...
    protected void onRestoreInstanceState(Parcelable parcelable) {
        ...
        this.f27757d1 = rangeSliderState.f27759b;
        int i10 = rangeSliderState.f27760c;
        this.f27758e1 = i10;
    ...
    public Parcelable onSaveInstanceState() {
        ...
        rangeSliderState.f27759b = this.f27757d1;
        rangeSliderState.f27760c = this.f27758e1;
    ...
    public RangeSlider(@NonNull Context context, @Nullable AttributeSet attributeSet, int i10) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, R.styleable.RangeSlider, i10, BaseSlider.Y0, new int[0]);
        int i11 = R.styleable.RangeSlider_values;
        if (typedArrayObtainStyledAttributes.hasValue(i11)) {
            setValues(k1(typedArrayObtainStyledAttributes.getResources().obtainTypedArray(typedArrayObtainStyledAttributes.getResourceId(i11, 0))));
        }
        this.f27757d1 = typedArrayObtainStyledAttributes.getDimension(R.styleable.RangeSlider_minSeparation, 0.0f);
