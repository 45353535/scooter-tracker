...
public class SideSheetDialog extends SheetDialog<SideSheetCallback> {
    ...
    private static final int f27679l = R.attr.sideSheetDialogTheme;

    /* JADX INFO: renamed from: m, reason: collision with root package name */
    private static final int f27680m = R.style.Theme_Material3_Light_SideSheetDialog;
    ...
    @Override // com.google.android.material.sidesheet.SheetDialog
    Sheet e(FrameLayout frameLayout) {
    ...
    public SideSheetDialog(@NonNull Context context, @StyleRes int i10) {
        super(context, i10, f27679l, f27680m);
    }
