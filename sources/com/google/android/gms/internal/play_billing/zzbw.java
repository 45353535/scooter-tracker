...
public abstract class zzbw extends zzbt implements List, RandomAccess, j$.util.List {
    ...
    static zzbw zzi(Object[] objArr, int i10) {
        return i10 == 0 ? zzcd.zza : new zzcd(objArr, i10);
    }
    ...
    public zzbw subList(int i10, int i11) {
        ...
        int i12 = i11 - i10;
        return i12 == size() ? this : i12 == 0 ? zzcd.zza : new zzbv(this, i10, i12);
    }
    ...
    public final zzcl listIterator(int i10) {
        ...
        return isEmpty() ? zza : new zzbu(this, i10);
    }
}
