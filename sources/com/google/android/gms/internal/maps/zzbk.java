...
public abstract class zzbk extends zzbh implements List, RandomAccess, j$.util.List {
    ...
    static zzbk zzg(Object[] objArr, int i10) {
    ...
    public final zzca listIterator(int i10) {
        zzbc.zzb(i10, size(), FirebaseAnalytics.Param.INDEX);
