...
public final class zzccf implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private final void zzb(String str, int i10) {
        Context context;
        boolean z10 = true;
        if (!((Boolean) com.google.android.gms.ads.internal.client.zzbd.zzc().zzd(zzbhe.zzbf)).booleanValue() ? !(str.isEmpty() || str.charAt(0) != '1') : !(i10 == 0 || str.isEmpty() || (str.charAt(0) != '1' && !str.equals(X1.f42014f)))) {
            z10 = false;
        }
        this.zzc.zzw(z10);
    ...
    */
    public final void onSharedPreferenceChanged(android.content.SharedPreferences r9, java.lang.String r10) {
        ...
        L36:
            ...
            boolean r0 = j$.util.Objects.equals(r9, r0)     // Catch: java.lang.Throwable -> L2f
            if (r0 != 0) goto L51
            r8.zzc()     // Catch: java.lang.Throwable -> L2f
        L51:
    ...
    final void zza() {
        ...
        if (((Boolean) com.google.android.gms.ads.internal.client.zzbd.zzc().zzd(zzbhe.zzbh)).booleanValue()) {
            ...
            onSharedPreferenceChanged(sharedPreferences, com.taurusx.tax.g.q.f66283m);
        }
    }
}
