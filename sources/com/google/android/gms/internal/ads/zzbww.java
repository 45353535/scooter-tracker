...
public final class zzbww extends zzbwx implements zzboh {
    ...
    public final /* synthetic */ void zza(Object obj, Map map) {
        ...
        try {
            jSONObjectPut = new JSONObject().put(MRAIDNativeFeature.SMS, zZzf).put(MRAIDNativeFeature.TEL, zZzg).put(MRAIDNativeFeature.CALENDAR, zZzh).put(MRAIDNativeFeature.STORE_PICTURE, zZzi).put(MRAIDNativeFeature.INLINE_VIDEO, zzbwvVar.zzj());
