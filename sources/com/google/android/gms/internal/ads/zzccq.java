...
public final class zzccq {
    ...
    private final boolean zzx(Context context, String str, AtomicReference atomicReference, boolean z10) {
        if (atomicReference.get() == null) {
            try {
                androidx.compose.animation.core.c.a(atomicReference, null, context.getClassLoader().loadClass(str).getDeclaredMethod(Constants.GET_INSTANCE, Context.class).invoke(null, context));
            } catch (Exception unused) {
    ...
    */
    ...
    public final String zzi(final Context context) {
        ...
        if (atomicReference.get() == null) {
            ...
            androidx.compose.animation.core.c.a(atomicReference, null, threadPoolExecutor);
        }
        try {
