...
public final class zzgrc {
    ...
    public static int zzm(int i10, int i11, String str) {
        ...
        if (i10 < 0) {
            strZzd = zzgrt.zzd("%s (%s) must not be negative", FirebaseAnalytics.Param.INDEX, Integer.valueOf(i10));
        } else {
            if (i11 < 0) {
            ...
            strZzd = zzgrt.zzd("%s (%s) must be less than size (%s)", FirebaseAnalytics.Param.INDEX, Integer.valueOf(i10), Integer.valueOf(i11));
        }
