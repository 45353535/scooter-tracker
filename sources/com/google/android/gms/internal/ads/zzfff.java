...
public final class zzfff implements zzesf {
    ...
    public final boolean zza(com.google.android.gms.ads.internal.client.zzm zzmVar, String str, @Nullable zzesd zzesdVar, zzese zzeseVar) throws RemoteException {
        ...
        if (!zzb()) {
            ...
            zzfoe zzfoeVarB = u0.b(context, zzfon.zzg(zzfjkVarZzA), 3, zzmVar);
            ...
            if (!((Boolean) zzbjk.zze.zze()).booleanValue() || !zzfjjVar.zzf().zzk) {
                ...
                ListenableFuture listenableFutureZzc = zzcxjVarZzc.zzc(zzcxjVarZzc.zzb());
                this.zzl = listenableFutureZzc;
                zzgzo.zzr(listenableFutureZzc, new zzffb(this, zzfooVarZze, zzfoeVarB, zzcvcVarZza), this.zzb);
                return true;
            }
