...
public final class zzelg implements zzekg {
    ...
    final /* synthetic */ ListenableFuture zzc(zzfjc zzfjcVar, zzfir zzfirVar, Object obj) throws zzcka {
        ...
        zzctyVarZzf.zzj();
        ListenableFuture listenableFutureZzj = zzduu.zzj(zzcjlVarZza, zzfiwVar.zzb, strZza, zzdxtVar.zze(), zzcvcVar.zze());
        if (zzfirVar.zzM) {
            listenableFutureZzj.addListener(new Runnable() { // from class: com.google.android.gms.internal.ads.zzela
        ...
        listenableFutureZzj.addListener(new Runnable() { // from class: com.google.android.gms.internal.ads.zzeld
            @Override // java.lang.Runnable
            public final /* synthetic */ void run() {
                this.zza.zzd(zzcjlVarZza);
            }
        }, this.zze);
        return zzgzo.zzk(listenableFutureZzj, new zzgqt() { // from class: com.google.android.gms.internal.ads.zzele
