...
public final class zzazh {
    ...
    private final Uri zzf(Uri uri, String str) throws zzazi {
        try {
            ...
            try {
                if (uri.getHost().equals(this.zza)) {
                    if (uri.getPath().contains(";")) {
                        ...
                        if (iIndexOf != -1) {
                            int i10 = iIndexOf + 1;
                            return Uri.parse(string.substring(0, i10) + "dc_ms" + C4240b4.j.f42668b + str + ";" + string.substring(i10));
                        }
                        String encodedPath = uri.getEncodedPath();
                        int iIndexOf2 = string.indexOf(encodedPath);
                        return Uri.parse(string.substring(0, encodedPath.length() + iIndexOf2) + ";dc_ms" + C4240b4.j.f42668b + str + ";" + string.substring(iIndexOf2 + encodedPath.length()));
                    }
                }
            ...
            int i11 = iIndexOf3 + 1;
            return Uri.parse(string2.substring(0, i11) + "ms" + C4240b4.j.f42668b + str + C4240b4.j.f42670c + string2.substring(i11));
