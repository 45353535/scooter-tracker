...
public final class zzenb {
    ...
    public final void zzb(@Nullable zzfir zzfirVar) {
        ListenableFuture listenableFutureZzd = zzd(zzfirVar);
        this.zzd.zze(this.zzi, zzfirVar, listenableFutureZzd, this.zze);
        zzgzo.zzr(listenableFutureZzd, new zzena(this, zzfirVar), this.zza);
    }
