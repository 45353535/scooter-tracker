...
final class zzaqt extends zzaqr {
    ...
    public zzaqt(@NonNull Context context) {
        ...
        String packageName = (BuildCompat.isAtLeastU() && SdkExtensions.getExtensionVersion(34) >= 8 && Process.isSdkSandbox()) ? s.a(context.getSystemService(r.a())).getClientPackageName() : context.getPackageName();
