...
public final class zzfqk {
    ...
    public final void zzb(final String str, @Nullable com.google.android.gms.ads.internal.util.client.zzv zzvVar, @Nullable zzfoo zzfooVar, @Nullable zzddu zzdduVar) {
        ...
        if (zzfor.zza() && ((Boolean) zzbix.zzd.zze()).booleanValue()) {
            zzfoeVarA = u0.a(this.zza, 14);
            zzfoeVarA.zza();
        }
        if (zzvVar != null) {
            listenableFutureZzc = new zzfqb(zzvVar.zza(), this.zzd, this.zzc, this.zze, this.zzg).zza(str);
        } else {
            listenableFutureZzc = this.zzc.zzc(new Callable() { // from class: com.google.android.gms.internal.ads.zzfqj
        ...
        zzgzo.zzr(listenableFutureZzc, new zzfqi(this, zzfoeVarA, zzfooVar, zzdduVar), this.zzb);
    }
