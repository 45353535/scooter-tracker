...
public abstract class zzlh implements Iterable, Serializable {
    ...
    public final String toString() {
        return String.format(Locale.ROOT, "<ByteString@%s size=%d contents=\"%s\">", Integer.toHexString(System.identityHashCode(this)), Integer.valueOf(zzc()), zzc() <= 50 ? zzog.zza(this) : zzog.zza(zze(0, 47)).concat(APSSharedUtil.TRUNCATE_SEPARATOR));
    }
