...
final class zzkx {
    ...
    static int zza(byte[] bArr, int i10, zzkw zzkwVar) {
        int i11 = i10 + 1;
        byte b10 = bArr[i10];
        if (b10 < 0) {
    ...
    static int zzb(int i10, byte[] bArr, int i11, zzkw zzkwVar) {
        byte b10 = bArr[i11];
        int i12 = i11 + 1;
        int i13 = i10 & 127;
        if (b10 >= 0) {
    ...
    static int zzc(byte[] bArr, int i10, zzkw zzkwVar) {
        long j10 = bArr[i10];
        int i11 = i10 + 1;
        if (j10 >= 0) {
            zzkwVar.zzb = j10;
    ...
    static int zzf(byte[] bArr, int i10, zzkw zzkwVar) throws zzmr {
        int i11;
    ...
    static int zzg(byte[] bArr, int i10, zzkw zzkwVar) throws zzmr {
        int iZza = zza(bArr, i10, zzkwVar);
        int i11 = zzkwVar.zza;
        if (i11 < 0) {
            throw new zzmr("CodedInputStream encountered an embedded string or message which claimed to have negative size.");
    ...
    static int zzh(zznx zznxVar, byte[] bArr, int i10, int i11, zzkw zzkwVar) throws IOException {
    ...
    static int zzi(zznx zznxVar, byte[] bArr, int i10, int i11, int i12, zzkw zzkwVar) throws IOException {
        Object objZza = zznxVar.zza();
    ...
    static int zzj(Object obj, zznx zznxVar, byte[] bArr, int i10, int i11, zzkw zzkwVar) throws IOException {
        int iZzb = i10 + 1;
        int i12 = bArr[i10];
        if (i12 < 0) {
    ...
    static int zzk(Object obj, zznx zznxVar, byte[] bArr, int i10, int i11, int i12, zzkw zzkwVar) throws IOException {
    ...
    static int zzl(int i10, byte[] bArr, int i11, int i12, zzmo zzmoVar, zzkw zzkwVar) {
    ...
    static int zzm(byte[] bArr, int i10, zzmo zzmoVar, zzkw zzkwVar) throws IOException {
        zzmg zzmgVar = (zzmg) zzmoVar;
        int iZza = zza(bArr, i10, zzkwVar);
    ...
    static int zzn(zznx zznxVar, int i10, byte[] bArr, int i11, int i12, zzmo zzmoVar, zzkw zzkwVar) throws IOException {
    ...
    static int zzo(int i10, byte[] bArr, int i11, int i12, zzoj zzojVar, zzkw zzkwVar) throws zzmr {
        if ((i10 >>> 3) == 0) {
    ...
    static int zzp(int i10, byte[] bArr, int i11, int i12, zzkw zzkwVar) throws zzmr {
        if ((i10 >>> 3) == 0) {
            throw new zzmr("Protocol message contained an invalid tag (zero).");
        }
        int i13 = i10 & 7;
