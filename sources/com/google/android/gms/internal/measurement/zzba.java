...
public final class zzba {
    ...
    public static zzao zza(String str, zzae zzaeVar, zzg zzgVar, List list) {
        ...
        switch (str.hashCode()) {
            case -1776922004:
                b10 = str.equals("toString") ? Ascii.DC2 : (byte) -1;
                break;
            case -1354795244:
                b10 = str.equals("concat") ? (byte) 0 : (byte) -1;
                break;
            case -1274492040:
                b10 = str.equals("filter") ? (byte) 2 : (byte) -1;
                break;
            case -934873754:
                b10 = str.equals("reduce") ? (byte) 10 : (byte) -1;
                break;
            case -895859076:
                b10 = str.equals("splice") ? (byte) 17 : (byte) -1;
                break;
            case -678635926:
                b10 = str.equals("forEach") ? (byte) 3 : (byte) -1;
                break;
            case -467511597:
                b10 = str.equals("lastIndexOf") ? (byte) 6 : (byte) -1;
                break;
            case -277637751:
                b10 = str.equals("unshift") ? (byte) 19 : (byte) -1;
                break;
            case 107868:
                b10 = str.equals("map") ? (byte) 7 : (byte) -1;
                break;
            case 111185:
                b10 = str.equals("pop") ? (byte) 8 : (byte) -1;
                break;
            case 3267882:
                b10 = str.equals("join") ? (byte) 5 : (byte) -1;
                break;
            case 3452698:
                b10 = str.equals(Constants.PUSH) ? (byte) 9 : (byte) -1;
                break;
            case 3536116:
                b10 = str.equals("some") ? Ascii.SI : (byte) -1;
                break;
            case 3536286:
                b10 = str.equals("sort") ? Ascii.DLE : (byte) -1;
                break;
            case 96891675:
                b10 = str.equals("every") ? (byte) 1 : (byte) -1;
                break;
            case 109407362:
                b10 = str.equals("shift") ? (byte) 13 : (byte) -1;
                break;
            case 109526418:
                b10 = str.equals("slice") ? Ascii.SO : (byte) -1;
                break;
            case 965561430:
                b10 = str.equals("reduceRight") ? Ascii.VT : (byte) -1;
                break;
            case 1099846370:
                b10 = str.equals("reverse") ? Ascii.FF : (byte) -1;
                break;
            case 1943291465:
                b10 = str.equals("indexOf") ? (byte) 4 : (byte) -1;
                break;
            default:
                b10 = -1;
                break;
        ...
        switch (b10) {
            ...
            case 12:
                ...
                if (iZzh4 != 0) {
                    for (int i11 = 0; i11 < iZzh4 / 2; i11++) {
                        if (zzaeVar2.zzo(i11)) {
                            zzao zzaoVarZzl2 = zzaeVar2.zzl(i11);
                            zzaeVar2.zzn(i11, null);
                            int i12 = (iZzh4 - 1) - i11;
                            if (zzaeVar2.zzo(i12)) {
                                zzaeVar2.zzn(i11, zzaeVar2.zzl(i12));
                            }
                            zzaeVar2.zzn(i12, zzaoVarZzl2);
                        }
                    }
                }
                return zzaeVar2;
            ...
            case 14:
                ...
                for (int i13 = (int) dMax; i13 < dZzh2; i13++) {
                    zzaeVar8.zzn(zzaeVar8.zzh(), zzaeVar.zzl(i13));
                }
                return zzaeVar8;
            case 15:
                zzh.zza("some", 1, list);
            ...
            case 17:
                ...
                if (list.size() > 1) {
                    ...
                    if (iMax > 0) {
                        for (int i15 = iZzi; i15 < Math.min(iZzh5, iZzi + iMax); i15++) {
                    ...
                    if (list.size() > 2) {
                        for (int i16 = 2; i16 < list.size(); i16++) {
                            zzao zzaoVarZza12 = zzgVar.zza((zzao) list.get(i16));
                            if (zzaoVarZza12 instanceof zzag) {
                                throw new IllegalArgumentException("Failed to parse elements to add");
                            }
                            zzaeVar.zzq((iZzi + i16) - 2, zzaoVarZza12);
                        }
                    }
                } else {
                    while (iZzi < iZzh5) {
