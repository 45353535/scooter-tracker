...
public abstract class zzlm extends zzkz {
    ...
    @Deprecated
    static int zzG(int i10, zznm zznmVar, zznx zznxVar) {
        int iZzz = zzz(i10 << 3);
    ...
    abstract void zzk(byte[] bArr, int i10, int i11) throws IOException;

    abstract void zzl(int i10, zznm zznmVar, zznx zznxVar) throws IOException;
