...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    @Nullable
    final Dialog zaa(@NonNull Context context, int i10, @Nullable zag zagVar, @Nullable DialogInterface.OnCancelListener onCancelListener, @Nullable DialogInterface.OnClickListener onClickListener) {
        if (i10 == 0) {
            return null;
        }
