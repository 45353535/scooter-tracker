...
public class StreetViewPanorama {
    ...
    public void animateTo(@NonNull StreetViewPanoramaCamera streetViewPanoramaCamera, long j10) {
    ...
    public void setStreetNamesEnabled(boolean z10) {
        try {
            this.zza.enableStreetNames(z10);
        } catch (RemoteException e10) {
            throw new RuntimeRemoteException(e10);
        }
    }
    ...
    public void setUserNavigationEnabled(boolean z10) {
        try {
            this.zza.enableUserNavigation(z10);
        } catch (RemoteException e10) {
            throw new RuntimeRemoteException(e10);
        }
    }
    ...
    public void setZoomGesturesEnabled(boolean z10) {
        try {
            this.zza.enableZoom(z10);
        } catch (RemoteException e10) {
            throw new RuntimeRemoteException(e10);
        }
    }

    public void setPosition(@NonNull LatLng latLng, int i10) {
        try {
            this.zza.setPositionWithRadius(latLng, i10);
        } catch (RemoteException e10) {
            throw new RuntimeRemoteException(e10);
        }
    }

    public void setPosition(@NonNull LatLng latLng, int i10, @Nullable StreetViewSource streetViewSource) {
        try {
            this.zza.setPositionWithRadiusAndSource(latLng, i10, streetViewSource);
        } catch (RemoteException e10) {
            throw new RuntimeRemoteException(e10);
        }
    }
