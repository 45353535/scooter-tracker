...
public class GoogleMap {
    ...
    public void setMapColorScheme(@MapColorScheme int i10) {
        try {
            this.zza.setMapColorScheme(i10);
        } catch (RemoteException e10) {
            throw new RuntimeRemoteException(e10);
        }
    }
    ...
    public final void animateCamera(@NonNull CameraUpdate cameraUpdate, int i10, @Nullable CancelableCallback cancelableCallback) {
        try {
            Preconditions.checkNotNull(cameraUpdate, "CameraUpdate must not be null.");
            this.zza.animateCameraWithDurationAndCallback(cameraUpdate.zza(), i10, cancelableCallback == null ? null : new zzab(cancelableCallback));
        } catch (RemoteException e10) {
            throw new RuntimeRemoteException(e10);
        }
    }
