...
public interface IStreetViewPanoramaDelegate extends IInterface {
    void animateTo(@NonNull StreetViewPanoramaCamera streetViewPanoramaCamera, long j10) throws RemoteException;
    ...
    void setPositionWithRadius(@NonNull LatLng latLng, int i10) throws RemoteException;

    void setPositionWithRadiusAndSource(@NonNull LatLng latLng, int i10, @Nullable StreetViewSource streetViewSource) throws RemoteException;
