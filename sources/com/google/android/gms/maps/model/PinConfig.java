...
public class PinConfig extends AbstractSafeParcelable {
    ...
    public static class Builder {
        ...
        @NonNull
        public Builder setBorderColor(@ColorInt int i10) {
            this.zzb = i10;
            return this;
        }
    ...
    public static class Glyph extends AbstractSafeParcelable {
        ...
        Glyph(@SafeParcelable.Param(id = 2) String str, @SafeParcelable.Param(id = 3) IBinder iBinder, @SafeParcelable.Param(id = 4) int i10, @SafeParcelable.Param(id = 5) int i11) {
            this.zzc = PinConfig.DEFAULT_PIN_GLYPH_COLOR;
            this.zzd = ViewCompat.MEASURED_STATE_MASK;
            this.zza = str;
    ...
    @SafeParcelable.Constructor
    PinConfig(@SafeParcelable.Param(id = 2) @ColorInt int i10, @SafeParcelable.Param(id = 3) @ColorInt int i11, @SafeParcelable.Param(id = 4) Glyph glyph) {
        this.zza = i10;
        this.zzb = i11;
        this.zzc = glyph;
    }
