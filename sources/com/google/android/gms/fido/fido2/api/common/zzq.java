...
public final class zzq extends AbstractSafeParcelable {
    ...
    zzq(@SafeParcelable.Param(id = 1) long j10, @NonNull @SafeParcelable.Param(id = 2) byte[] bArr, @NonNull @SafeParcelable.Param(id = 3) byte[] bArr2, @NonNull @SafeParcelable.Param(id = 4) byte[] bArr3) {
        this.zza = j10;
