...
public final class zzof {
    ...
    @VisibleForTesting
    static final boolean zzc(com.google.android.gms.internal.measurement.zzkp zzkpVar, ImmutableMap immutableMap, ImmutableMap immutableMap2, ImmutableSet immutableSet, char[] cArr, int i10, int i11, int i12, int i13, int i14, String str, String str2, String str3, boolean z10, boolean z11, boolean z12) {
        int i15;
        int i16;
        ...
        zzoe zzoeVar;
        char c10;
        int iZze = zze(zzkpVar, immutableMap, immutableMap2, immutableSet, cArr, i10, i11, i12, i13, i14, str, str2, str3, z10, z11, true);
        if (iZze > 0) {
            i16 = i12;
            if (i16 == 1) {
                i15 = i11;
        ...
        if (zzi(zzkpVar, immutableMap, immutableMap2, immutableSet, cArr, i10, i15, i16, i13, i14, str, str2, str3, z10, z11, true) == com.google.android.gms.internal.measurement.zzkq.PURPOSE_RESTRICTION_NOT_ALLOWED) {
            c10 = '3';
        } else {
            int i17 = i14;
            ...
            if (immutableMap.containsKey(zzkpVar) && (zzoeVar = (zzoe) immutableMap.get(zzkpVar)) != null) {
                ...
                if (iOrdinal != 0) {
                    if (iOrdinal != 1) {
                        if (iOrdinal == 2) {
                            return zzi(zzkpVar, immutableMap, immutableMap2, immutableSet, cArr, i10, i15, i16, i13, i17, str, str2, str3, z10, z11, true) == com.google.android.gms.internal.measurement.zzkq.PURPOSE_RESTRICTION_REQUIRE_LEGITIMATE_INTEREST ? zzh(zzkpVar, immutableMap, immutableMap2, immutableSet, cArr, i10, i15, i16, i13, i17, str, str2, str3, z10, z11, true) : zzg(zzkpVar, immutableMap, immutableMap2, immutableSet, cArr, i10, i15, i16, i13, i17, str, str2, str3, z10, z11, true);
                        }
                        if (iOrdinal == 3) {
                            return zzi(zzkpVar, immutableMap, immutableMap2, immutableSet2, cArr, i10, i15, i16, i13, i17, str4, str2, str3, z10, z11, true) == com.google.android.gms.internal.measurement.zzkq.PURPOSE_RESTRICTION_REQUIRE_CONSENT ? zzg(zzkpVar, immutableMap, immutableMap2, immutableSet, cArr, i10, i15, i16, i13, i17, str, str2, str3, z10, z11, true) : zzh(zzkpVar, immutableMap, immutableMap2, immutableSet, cArr, i10, i15, i16, i13, i17, str, str2, str3, z10, z11, true);
                        }
                        c10 = '0';
                    } else if (zzi(zzkpVar, immutableMap, immutableMap2, immutableSet, cArr, i10, i15, i16, i13, i17, str, str2, str3, z10, z11, true) != com.google.android.gms.internal.measurement.zzkq.PURPOSE_RESTRICTION_REQUIRE_CONSENT) {
                        return zzh(zzkpVar, immutableMap, immutableMap2, immutableSet, cArr, i10, i15, i16, i13, i17, str, str2, str3, z10, z11, true);
                    }
                } else if (zzi(zzkpVar, immutableMap, immutableMap2, immutableSet, cArr, i10, i15, i16, i13, i17, str, str2, str3, z10, z11, true) != com.google.android.gms.internal.measurement.zzkq.PURPOSE_RESTRICTION_REQUIRE_LEGITIMATE_INTEREST) {
                    return zzg(zzkpVar, immutableMap, immutableMap2, immutableSet, cArr, i10, i15, i16, i13, i17, str, str2, str3, z10, z11, true);
                }
                c10 = '8';
            } else {
                c10 = '0';
