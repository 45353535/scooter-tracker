...
final class zzav extends zzos {
    ...
    */
        ...
        try {
            ...
            if (str3 != null) {
                ...
                while (true) {
                    ...
                    String[] strArrSplit2 = str4.split(C4240b4.j.f42668b, 2);
    ...
    public final long zzA(String str, com.google.android.gms.internal.measurement.zzib zzibVar, String str2, Map map, zzls zzlsVar, Long l10) {
        ...
        contentValues.put("upload_headers", uc.a(IOUtils.LINE_SEPARATOR_WINDOWS, arrayList));
    ...
    */
    ...
    final void zzJ(List list) {
        ...
        if (zzag()) {
            String strJoin = TextUtils.join(StringUtils.COMMA, list);
    ...
    */
    ...
    final boolean zzV(String str, long j10) {
        try {
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:76:0x023b, code lost:
        ...
        r7.put("filter_id", r0);
        r7.put(com.taurusx.tax.w.s.s.I, r12.zzc());
     */
    ...
    */
    ...
    final /* synthetic */ long zzah(String str, String[] strArr, long j10) {
    ...
    public final List zzn(String str) {
        ...
        try {
            try {
                zzic zzicVar = this.zzu;
                zzicVar.zzc();
                cursorQuery = zze().query("user_attributes", new String[]{"name", "origin", "set_timestamp", "value"}, "app_id=?", new String[]{str}, null, null, "rowid", s.f67513s);
                try {
                    if (cursorQuery.moveToFirst()) {
                        while (true) {
                            String string = cursorQuery.getString(0);
    ...
    */
    ...
    public final void zzv(zzh zzhVar, boolean z10, boolean z11) {
        ...
        contentValues.put(StoreType.APP_STORE, zzhVar.zzv());
        ...
        if (listZzag != null) {
            if (listZzag.isEmpty()) {
                ...
                contentValues.put("safelisted_events", TextUtils.join(StringUtils.COMMA, listZzag));
            }
        }
        zzpr.zza();
