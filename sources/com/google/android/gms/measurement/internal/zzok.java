...
public final class zzok extends zzos {
    ...
    public final void zzc(long j10) {
        ...
        long jElapsedRealtime = zzicVar.zzaZ().elapsedRealtime() + j10;
        zzicVar.zzc();
        ...
        if (Build.VERSION.SDK_INT < 24) {
            ...
            if (alarmManager != null) {
                zzicVar.zzc();
                alarmManager.setInexactRepeating(2, jElapsedRealtime, Math.max(((Long) zzfy.zzG.zzb(null)).longValue(), j10), zzj());
                return;
            }
            return;
        }
