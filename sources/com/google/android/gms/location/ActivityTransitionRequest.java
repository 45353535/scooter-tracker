...
public class ActivityTransitionRequest extends AbstractSafeParcelable {
    ...
    public String toString() {
        return "ActivityTransitionRequest [mTransitions=" + String.valueOf(this.zza) + ", mTag='" + this.zzb + "', mClients=" + String.valueOf(this.zzc) + ", mAttributionTag=" + this.zzd + C4240b4.j.f42674e;
    }
