...
public final class zzs extends zzbz {
    ...
    static {
        ...
        arrayMap.put(C4240b4.i.f42652t, FastJsonResponse.Field.forStrings(C4240b4.i.f42652t, 5));
    ...
    zzs(@SafeParcelable.Param(id = 1) int i10, @Nullable @SafeParcelable.Param(id = 2) List list, @Nullable @SafeParcelable.Param(id = 3) List list2, @Nullable @SafeParcelable.Param(id = 4) List list3, @Nullable @SafeParcelable.Param(id = 5) List list4, @Nullable @SafeParcelable.Param(id = 6) List list5) {
        this.zza = i10;
        this.zzc = list;
        this.zzd = list2;
        this.zze = list3;
