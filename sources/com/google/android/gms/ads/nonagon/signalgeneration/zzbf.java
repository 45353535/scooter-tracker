...
public final class zzbf implements zzikg {
    ...
    public final /* bridge */ /* synthetic */ Object zzb() {
        ...
        if (zzbjVarZzb != null) {
            ...
            listenableFutureZzi = zzgzo.zza(zzbjVarZzb);
        } else {
            listenableFutureZzi = zzfnuVar.zza(zzfno.GENERATE_SIGNALS, zzdajVarZzb.zzb()).zzc(zzbhVarZzb).zzh(((Integer) com.google.android.gms.ads.internal.client.zzbd.zzc().zzd(zzbhe.zzgC)).intValue(), TimeUnit.SECONDS).zzi();
            zzgzo.zzr(listenableFutureZzi, new zzaw(zzdkbVar), zzcei.zza);
        }
        zziko.zzb(listenableFutureZzi);
