...
public class WorkManagerUtil extends zzbn {
    ...
    public final boolean zzg(IObjectWrapper iObjectWrapper, com.google.android.gms.ads.internal.offline.buffering.zza zzaVar) {
        ...
        try {
            WorkManager.getInstance(context).enqueue(new OneTimeWorkRequest.Builder((Class<? extends ListenableWorker>) OfflineNotificationPoster.class).setConstraints(constraintsBuild).setInputData(new Data.Builder().putString(com.taurusx.tax.o.g.f66428y, zzaVar.zza).putString("gws_query_id", zzaVar.zzb).putString(CampaignEx.JSON_KEY_IMAGE_URL, zzaVar.zzc).build()).addTag("offline_notification_work").build());
            return true;
        } catch (IllegalStateException e10) {
            com.google.android.gms.ads.internal.util.client.zzo.zzj("Failed to instantiate WorkManager.", e10);
            return false;
