...
public final class zzek {
    ...
    public zzek(zzej zzejVar, @Nullable zzfva zzfvaVar) {
        ...
        this.zzc = DesugarCollections.unmodifiableSet(zzejVar.zzr());
        this.zzd = zzejVar.zzs();
        DesugarCollections.unmodifiableMap(zzejVar.zzt());
        this.zze = zzejVar.zzz();
        this.zzf = zzejVar.zzA();
        this.zzg = zzejVar.zzB();
        this.zzh = DesugarCollections.unmodifiableSet(zzejVar.zzu());
        this.zzi = zzejVar.zzv();
        this.zzj = DesugarCollections.unmodifiableSet(zzejVar.zzw());
