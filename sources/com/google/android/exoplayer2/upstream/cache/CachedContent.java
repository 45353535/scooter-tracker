...
final class CachedContent {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj != null && CachedContent.class == obj.getClass()) {
            ...
            if (this.f25200id == cachedContent.f25200id && this.key.equals(cachedContent.key) && this.cachedSpans.equals(cachedContent.cachedSpans) && this.metadata.equals(cachedContent.metadata)) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        return (((this.f25200id * 31) + this.key.hashCode()) * 31) + this.metadata.hashCode();
    }
    ...
    public SimpleCacheSpan setLastTouchTimestamp(SimpleCacheSpan simpleCacheSpan, long j10, boolean z10) {
        ...
        if (z10) {
            j11 = j10;
            File cacheFile = SimpleCacheSpan.getCacheFile((File) Assertions.checkNotNull(file.getParentFile()), this.f25200id, simpleCacheSpan.position, j11);
