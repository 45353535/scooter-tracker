...
public final class SimpleCache implements Cache {
    ...
    private SimpleCacheSpan touchSpan(String str, SimpleCacheSpan simpleCacheSpan) {
        ...
        SimpleCacheSpan lastTouchTimestamp = this.contentIndex.get(str).setLastTouchTimestamp(simpleCacheSpan, jCurrentTimeMillis, z10);
    ...
    public synchronized File startFile(String str, long j10, long j11) throws Throwable {
        ...
        try {
            try {
                ...
                return SimpleCacheSpan.getCacheFile(file, cachedContent.f25200id, j10, System.currentTimeMillis());
            } catch (Throwable th4) {
                th = th4;
                th2 = th;
                throw th2;
