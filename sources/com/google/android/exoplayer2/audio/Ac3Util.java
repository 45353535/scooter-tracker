...
public final class Ac3Util {
    ...
    private static final int[] SYNCFRAME_SIZE_WORDS_BY_HALF_FRMSIZECOD_44_1 = {69, 87, 104, 121, TsExtractor.TS_STREAM_TYPE_DTS_UHD, 174, 208, 243, POBCoreNativeConstants.POB_NATIVE_MAIN_IMG_W, 348, TTAdConstant.DOWNLOAD_URL_AND_PACKAGE_NAME, 487, 557, 696, 835, 975, 1114, 1253, 1393};
    ...
    public static SyncFrameInfo parseAc3SyncframeInfo(ParsableBitArray parsableBitArray) {
        ...
        if (z10) {
            ...
            if (bits2 == 3) {
                ...
                int i20 = BLOCKS_PER_SYNCFRAME_BY_NUMBLKSCOD[bits3];
                i14 = bits3;
                i10 = SAMPLE_RATE_BY_FSCOD[bits2];
                i15 = i20;
            }
            i12 = i15 * 256;
            int iCalculateEac3Bitrate = calculateEac3Bitrate(ac3SyncframeSize, i10, i15);
            ...
            if (i19 == 1 && parsableBitArray.readBit()) {
                parsableBitArray.skipBits(16);
            }
            if (parsableBitArray.readBit()) {
                if (bits4 > 2) {
            ...
            if (i19 == 2 && (i14 == 3 || parsableBitArray.readBit())) {
                i16 = 6;
                parsableBitArray.skipBits(6);
            } else {
                i16 = 6;
            }
            str = (parsableBitArray.readBit() && parsableBitArray.readBits(i16) == 1 && parsableBitArray.readBits(8) == 1) ? "audio/eac3-joc" : "audio/eac3";
            ...
            int i22 = BITRATE_BY_HALF_FRMSIZECOD[bits8 / 2] * 1000;
            ...
            i11 = CHANNEL_COUNT_BY_ACMOD[bits9] + (parsableBitArray.readBit() ? 1 : 0);
            i12 = AC3_SYNCFRAME_AUDIO_SAMPLE_COUNT;
            str = str2;
            i13 = i22;
        }
        return new SyncFrameInfo(str, i19, i11, i10, ac3SyncframeSize, i12, i13);
    }
