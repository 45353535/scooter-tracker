...
final class AudioTrackPositionTracker {
    ...
    private long getPlaybackHeadPosition() {
        ...
        long j10 = this.stopTimestampUs;
        if (j10 != -9223372036854775807L) {
            return Math.min(this.endPlaybackHeadPosition, this.stopPlaybackHeadPosition + ((Util.getMediaDurationForPlayoutDuration((jElapsedRealtime * 1000) - j10, this.audioTrackPlaybackSpeed) * ((long) this.outputSampleRate)) / 1000000));
        }
    ...
    public long getCurrentPositionUs(boolean z10) {
        ...
        if (!this.notifiedPositionIncreasing) {
            ...
            if (playbackHeadPositionUs > j12) {
                ...
                this.listener.onPositionAdvancing(System.currentTimeMillis() - Util.usToMs(Util.getPlayoutDurationForMediaDuration(Util.usToMs(playbackHeadPositionUs - j12), this.audioTrackPlaybackSpeed)));
            }
        }
    ...
    public void setAudioTrack(AudioTrack audioTrack, boolean z10, int i10, int i11, int i12) {
        ...
        this.bufferSizeUs = zIsEncodingLinearPcm ? framesToDurationUs(i12 / i11) : -9223372036854775807L;
