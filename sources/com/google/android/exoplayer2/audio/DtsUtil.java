...
public final class DtsUtil {
    ...
    */
    ...
    public static Format parseDtsFormat(byte[] bArr, @Nullable String str, @Nullable String str2, @Nullable DrmInitData drmInitData) {
        ...
        return new Format.Builder().setId(str).setSampleMimeType("audio/vnd.dts").setAverageBitrate(i12).setChannelCount(i10 + (normalizedFrameHeader.readBits(2) > 0 ? 1 : 0)).setSampleRate(i11).setDrmInitData(drmInitData).setLanguage(str2).build();
    }
