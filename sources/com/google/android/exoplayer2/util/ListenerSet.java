...
public final class ListenerSet<T> {
    ...
    public void queueEvent(final int i10, final Event<T> event) {
        ...
        this.queuedEvents.add(new Runnable() { // from class: com.google.android.exoplayer2.util.c
            ...
            public final void run() {
                ListenerSet.a(copyOnWriteArraySet, i10, event);
            }
        });
    }
    ...
    private ListenerSet(CopyOnWriteArraySet<ListenerHolder<T>> copyOnWriteArraySet, Looper looper, Clock clock, IterationFinishedEvent<T> iterationFinishedEvent) {
        ...
        this.handler = clock.createHandler(looper, new Handler.Callback() { // from class: com.google.android.exoplayer2.util.d
            @Override // android.os.Handler.Callback
            public final boolean handleMessage(Message message) {
                return this.f25205b.handleMessage(message);
            }
        });
