...
public final class ClippingMediaSource extends WrappingMediaSource {
    ...
    private static final class ClippingTimeline extends ForwardingTimeline {
        ...
        public Timeline.Period getPeriod(int i10, Timeline.Period period, boolean z10) {
            ...
            return period.set(period.f24625id, period.uid, 0, j10 != -9223372036854775807L ? j10 - positionInWindowUs : -9223372036854775807L, positionInWindowUs);
        }
    ...
    private void refreshClippedTimeline(Timeline timeline) {
        ...
        try {
            ClippingTimeline clippingTimeline = new ClippingTimeline(timeline, j10, j);
