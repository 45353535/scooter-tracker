...
final class RtspMessageChannel implements Closeable, AutoCloseable {
    ...
    private final class LoaderCallbackImpl implements Loader.Callback<Receiver> {
        ...
        public void onLoadCanceled(Receiver receiver, long j10, long j11, boolean z10) {
        }
        ...
        @Override // com.google.android.exoplayer2.upstream.Loader.Callback
        public Loader.LoadErrorAction onLoadError(Receiver receiver, long j10, long j11, IOException iOException, int i10) {
    ...
    private static final class MessageParser {
        ...
        private static byte[] parseNextLine(byte b10, DataInputStream dataInputStream) throws IOException {
        ...
        public ImmutableList<String> parseNext(byte b10, DataInputStream dataInputStream) throws IOException {
            ImmutableList<String> immutableListAddMessageLine = addMessageLine(parseNextLine(b10, dataInputStream));
            while (immutableListAddMessageLine == null) {
                if (this.state == 3) {
                    ...
                    int iCheckedCast = Ints.checkedCast(j10);
    ...
    private final class Receiver implements Loader.Loadable {
        ...
        private void handleRtspMessage(byte b10) throws IOException {
            if (RtspMessageChannel.this.closed) {
                return;
            }
            RtspMessageChannel.this.messageListener.onRtspMessageReceived(this.messageParser.parseNext(b10, this.dataInputStream));
        }
        ...
        public void load() throws IOException {
            while (!this.loadCanceled) {
                byte b10 = this.dataInputStream.readByte();
                if (b10 == 36) {
                    handleInterleavedBinaryData();
                } else {
                    handleRtspMessage(b10);
                }
            }
        }
    }
    ...
    final class Sender implements Closeable, AutoCloseable {
        ...
        public static /* synthetic */ void c(Sender sender, byte[] bArr, List list) {
            sender.getClass();
            try {
                ...
                RtspMessageChannel.this.messageListener.onSendingFailed(list, e10);
            }
        }
        ...
        public void send(final List<String> list) {
            ...
            this.senderThreadHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.source.rtsp.j
                @Override // java.lang.Runnable
                public final void run() {
                    RtspMessageChannel.Sender.c(this.f25122b, bArrConvertMessageToByteArray, list);
                }
            });
        }
    }
    ...
    public void registerInterleavedBinaryDataListener(int i10, InterleavedBinaryDataListener interleavedBinaryDataListener) {
        this.interleavedBinaryDataListeners.put(Integer.valueOf(i10), interleavedBinaryDataListener);
    }
