...
public final class AdPlaybackState implements Bundleable {
    ...
    public static final class AdGroup implements Bundleable {
        ...
        public static AdGroup fromBundle(Bundle bundle) {
            ...
            return new AdGroup(j10, i10, i11, iArr, uriArr, longArray, j11, z10);
        }
        ...
        public int hashCode() {
            ...
            int iHashCode = (((((((i10 + ((int) (j10 ^ (j10 >>> 32)))) * 31) + Arrays.hashCode(this.uris)) * 31) + Arrays.hashCode(this.states)) * 31) + Arrays.hashCode(this.durationsUs)) * 31;
        ...
        public AdGroup withAdCount(int i10) {
            ...
            return new AdGroup(this.timeUs, i10, this.originalCount, iArrCopyStatesWithSpaceForAdCount, (Uri[]) Arrays.copyOf(this.uris, i10), jArrCopyDurationsUsWithSpaceForAdCount, this.contentResumeOffsetUs, this.isServerSideInserted);
        }
        ...
        public AdGroup withAllAdsReset() {
            ...
            for (int i10 = 0; i10 < length; i10++) {
                ...
                if (i11 == 3 || i11 == 2 || i11 == 4) {
                    iArrCopyOf[i10] = this.uris[i10] == null ? 0 : 1;
                }
            }
    ...
    public static AdPlaybackState fromAdPlaybackState(Object obj, AdPlaybackState adPlaybackState) {
        ...
        for (int i11 = 0; i11 < i10; i11++) {
            ...
            adGroupArr[i11] = new AdGroup(j10, i12, i13, iArrCopyOf, uriArr2, Arrays.copyOf(jArr, jArr.length), adGroup.contentResumeOffsetUs, adGroup.isServerSideInserted);
        }
    ...
    public static AdPlaybackState fromBundle(Bundle bundle) {
        ...
        if (parcelableArrayList == null) {
            ...
            for (int i10 = 0; i10 < parcelableArrayList.size(); i10++) {
                adGroupArr2[i10] = (AdGroup) AdGroup.CREATOR.fromBundle((Bundle) parcelableArrayList.get(i10));
            }
