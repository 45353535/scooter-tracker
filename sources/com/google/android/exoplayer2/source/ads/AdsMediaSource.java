...
public final class AdsMediaSource extends CompositeMediaSource<MediaSource.MediaPeriodId> {
    ...
    private final class AdMediaSourceHolder {
        ...
        private final MediaSource.MediaPeriodId f25054id;
        private Timeline timeline;

        public AdMediaSourceHolder(MediaSource.MediaPeriodId mediaPeriodId) {
            this.f25054id = mediaPeriodId;
        }
        ...
        public void handleSourceInfoRefresh(Timeline timeline) {
            ...
            if (this.timeline == null) {
                ...
                for (int i10 = 0; i10 < this.activeMediaPeriods.size(); i10++) {
                    ...
                    maskingMediaPeriod.createPeriod(new MediaSource.MediaPeriodId(uidOfPeriod, maskingMediaPeriod.f25049id.windowSequenceNumber));
                }
            }
        ...
        public void initializeWithMediaSource(MediaSource mediaSource, Uri uri) {
            ...
            AdsMediaSource.this.prepareChildSource(this.f25054id, mediaSource);
        }
        ...
        public void release() {
            if (hasMediaSource()) {
                AdsMediaSource.this.releaseChildSource(this.f25054id);
            }
        }
    ...
    final class AdPrepareListener implements MaskingMediaPeriod.PrepareListener {
        ...
        public void onPrepareComplete(final MediaSource.MediaPeriodId mediaPeriodId) {
            AdsMediaSource.this.mainHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.source.ads.g
                ...
                public final void run() {
                    AdsMediaSource.AdPrepareListener adPrepareListener = this.f25062b;
        ...
        public void onPrepareError(final MediaSource.MediaPeriodId mediaPeriodId, final IOException iOException) {
            ...
            AdsMediaSource.this.mainHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.source.ads.f
                @Override // java.lang.Runnable
                public final void run() {
                    AdsMediaSource.AdPrepareListener adPrepareListener = this.f25059b;
                    MediaSource.MediaPeriodId mediaPeriodId2 = mediaPeriodId;
    ...
    final class ComponentListener implements AdsLoader.EventListener {
        ...
        public void onAdPlaybackState(final AdPlaybackState adPlaybackState) {
            ...
            this.playerHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.source.ads.h
                @Override // java.lang.Runnable
                public final void run() {
                    AdsMediaSource.ComponentListener.a(this.f25064b, adPlaybackState);
                }
            });
        }
    ...
    protected void prepareSourceInternal(@Nullable TransferListener transferListener) {
        ...
        this.mainHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.source.ads.d
            @Override // java.lang.Runnable
            public final void run() {
                AdsMediaSource adsMediaSource = this.f25055b;
    ...
    public void releasePeriod(MediaPeriod mediaPeriod) {
        ...
        MediaSource.MediaPeriodId mediaPeriodId = maskingMediaPeriod.f25049id;
    ...
    protected void releaseSourceInternal() {
        ...
        this.mainHandler.post(new Runnable() { // from class: com.google.android.exoplayer2.source.ads.e
            @Override // java.lang.Runnable
            public final void run() {
                AdsMediaSource adsMediaSource = this.f25057b;
