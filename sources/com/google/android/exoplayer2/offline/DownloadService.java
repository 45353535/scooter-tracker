...
public abstract class DownloadService extends Service {
            ...
            if (this.downloadManager.isInitialized()) {
                Util.createHandlerForCurrentOrMainLooper().postAtFrontOfQueue(new Runnable() { // from class: com.google.android.exoplayer2.offline.n
                    ...
                    public final void run() {
                        downloadService.notifyDownloads(this.f25012b.downloadManager.getCurrentDownloads());
                    }
                });
            }
        }
    ...
    protected abstract Notification getForegroundNotification(List<Download> list, int i10);
    ...
    public void onCreate() {
        ...
        if (downloadManagerHelper == null) {
            ...
            DownloadManagerHelper downloadManagerHelper2 = new DownloadManagerHelper(getApplicationContext(), downloadManager, z10, scheduler, cls);
