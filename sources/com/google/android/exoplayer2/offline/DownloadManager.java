...
public final class DownloadManager {
    ...
    public DownloadManager(Context context, DatabaseProvider databaseProvider, Cache cache, DataSource.Factory factory) {
        this(context, databaseProvider, cache, factory, new androidx.media3.exoplayer.hls.offline.a());
    }
    ...
    static Download mergeRequest(Download download, DownloadRequest downloadRequest, int i10, long j10) {
        ...
        return new Download(download.request.copyWithMergedRequest(downloadRequest), i12, j11, j10, -1L, i10, 0);
    }
    ...
    public DownloadManager(Context context, WritableDownloadIndex writableDownloadIndex, DownloaderFactory downloaderFactory) {
        ...
        Handler handlerCreateHandlerForCurrentOrMainLooper = Util.createHandlerForCurrentOrMainLooper(new Handler.Callback() { // from class: com.google.android.exoplayer2.offline.j
            ...
            public final boolean handleMessage(Message message) {
                return this.f25010b.handleMainMessage(message);
            }
        });
        ...
        RequirementsWatcher.Listener listener = new RequirementsWatcher.Listener() { // from class: com.google.android.exoplayer2.offline.k
            ...
            public final void onRequirementsStateChanged(RequirementsWatcher requirementsWatcher, int i10) {
                this.f25011a.onRequirementsStateChanged(requirementsWatcher, i10);
            }
        };
    ...
    static final class InternalHandler extends Handler {
        ...
        private void addDownload(DownloadRequest downloadRequest, int i10) {
            Download download = getDownload(downloadRequest.f25001id, true);
        ...
        private int getDownloadIndex(String str) {
            for (int i10 = 0; i10 < this.downloads.size(); i10++) {
                if (this.downloads.get(i10).request.f25001id.equals(str)) {
                    return i10;
                }
            }
            return -1;
        ...
        private void onContentLengthChanged(Task task, long j10) {
            Download download = (Download) Assertions.checkNotNull(getDownload(task.request.f25001id, false));
        ...
        private void onDownloadTaskStopped(Download download, @Nullable Exception exc) {
            ...
            this.downloads.remove(getDownloadIndex(download2.request.f25001id));
            try {
        ...
        private void onRemoveTaskStopped(Download download) {
            if (download.state == 7) {
                ...
                this.downloads.remove(getDownloadIndex(download.request.f25001id));
                try {
                    this.downloadIndex.removeDownload(download.request.f25001id);
        ...
        private void onTaskStopped(Task task) {
            String str = task.request.f25001id;
        ...
        private Download putDownload(Download download) {
            ...
            int downloadIndex = getDownloadIndex(download.request.f25001id);
            if (downloadIndex == -1) {
        ...
        private Task syncQueuedDownload(@Nullable Task task, Download download) {
            ...
            this.activeTasks.put(downloadPutDownloadWithState.request.f25001id, task2);
        ...
        private void syncRemovingDownload(@Nullable Task task, Download download) {
            if (task != null) {
                ...
                this.activeTasks.put(download.request.f25001id, task2);
        ...
        private void syncTasks() {
            ...
            for (int i11 = 0; i11 < this.downloads.size(); i11++) {
                ...
                Task taskSyncQueuedDownload = this.activeTasks.get(download.request.f25001id);
