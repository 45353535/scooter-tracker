...
public abstract class SegmentDownloader<M extends FilterableManifest<M>> implements Downloader {
    ...
    public final void download(@Nullable Downloader.ProgressListener progressListener) throws InterruptedException, IOException {
        ...
        try {
            ...
            for (int size2 = segments.size() - 1; size2 >= 0; size2--) {
                ...
                if (j12 == -1) {
                    long jA = com.google.android.exoplayer2.upstream.cache.c.a(this.cache.getContentMetadata(strBuildCacheKey));
                    if (jA != -1) {
    ...
    */
    ...
    protected final M getManifest(final DataSource dataSource, final DataSpec dataSpec, boolean z10) throws InterruptedException, IOException {
