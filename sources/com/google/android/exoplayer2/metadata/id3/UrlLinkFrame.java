...
public final class UrlLinkFrame extends Id3Frame {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj != null && UrlLinkFrame.class == obj.getClass()) {
            ...
            if (this.f24982id.equals(urlLinkFrame.f24982id) && Util.areEqual(this.description, urlLinkFrame.description) && Util.areEqual(this.url, urlLinkFrame.url)) {
                return true;
            }
        }
        return false;
    ...
    public String toString() {
        return this.f24982id + ": url=" + this.url;
    }
