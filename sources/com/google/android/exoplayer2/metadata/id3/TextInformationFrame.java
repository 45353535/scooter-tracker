...
public final class TextInformationFrame extends Id3Frame {
    ...
    public boolean equals(@Nullable Object obj) {
        ...
        if (obj != null && TextInformationFrame.class == obj.getClass()) {
            ...
            if (Util.areEqual(this.f24982id, textInformationFrame.f24982id) && Util.areEqual(this.description, textInformationFrame.description) && this.values.equals(textInformationFrame.values)) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        int iHashCode = (IronSourceError.ERROR_NON_EXISTENT_INSTANCE + this.f24982id.hashCode()) * 31;
    ...
    public String toString() {
        return this.f24982id + ": description=" + this.description + ": values=" + this.values;
    }
