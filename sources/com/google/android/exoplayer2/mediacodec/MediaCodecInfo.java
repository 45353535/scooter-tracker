...
public final class MediaCodecInfo {
    ...
    private static final class Api29 {
        ...
        public static int areResolutionAndFrameRateCovered(MediaCodecInfo.VideoCapabilities videoCapabilities, int i10, int i11, double d10) {
            ...
            n.a();
            MediaCodecInfo.VideoCapabilities.PerformancePoint performancePointA = m.a(i10, i11, (int) d10);
            for (int i12 = 0; i12 < supportedPerformancePoints.size(); i12++) {
                if (k.a(supportedPerformancePoints.get(i12)).covers(performancePointA)) {
                    return 2;
                }
            }
            return 1;
    ...
    private static int adjustMaxInputChannelCount(String str, String str2, int i10) {
        ...
        Log.w("MediaCodecInfo", "AssumedMaxChannelAdjustment: " + str + ", [" + i10 + " to " + i11 + C4240b4.j.f42674e);
        return i11;
    }
    ...
    private void logAssumedSupport(String str) {
        Log.d("MediaCodecInfo", "AssumedSupport [" + str + "] [" + this.name + ", " + this.mimeType + "] [" + Util.DEVICE_DEBUG_INFO + C4240b4.j.f42674e);
    }

    private void logNoSupport(String str) {
        Log.d("MediaCodecInfo", "NoSupport [" + str + "] [" + this.name + ", " + this.mimeType + "] [" + Util.DEVICE_DEBUG_INFO + C4240b4.j.f42674e);
    }
    ...
    public static MediaCodecInfo newInstance(String str, String str2, String str3, @Nullable MediaCodecInfo.CodecCapabilities codecCapabilities, boolean z10, boolean z11, boolean z12, boolean z13, boolean z14) {
        ...
        boolean z18;
        String str6;
        boolean z19 = (z13 || codecCapabilities == null || !isAdaptive(codecCapabilities) || needsDisableAdaptationWorkaround(str)) ? false : true;
        boolean z20 = codecCapabilities != null && isTunneling(codecCapabilities);
        if (z14 || (codecCapabilities != null && isSecure(codecCapabilities))) {
            z15 = true;
            str4 = str;
            str5 = str3;
        ...
        return new MediaCodecInfo(str4, str6, str5, codecCapabilities2, z16, z17, z18, z19, z20, z15);
    }
    ...
    public DecoderReuseEvaluation canReuseCodec(Format format, Format format2) {
        ...
        return new DecoderReuseEvaluation(this.name, format3, format4, 0, i10);
    }
    ...
    public boolean isFormatSupported(Format format) throws MediaCodecUtil.DecoderQueryException {
        ...
        if (!this.isVideo) {
            return Util.SDK_INT < 21 || (((i10 = format.sampleRate) == -1 || isAudioSampleRateSupportedV21(i10)) && ((i11 = format.channelCount) == -1 || isAudioChannelCountSupportedV21(i11)));
        }
        int i13 = format.width;
        if (i13 <= 0 || (i12 = format.height) <= 0) {
            return true;
        }
        if (Util.SDK_INT >= 21) {
            return isVideoSizeAndRateSupportedV21(i13, i12, format.frameRate);
        }
        boolean z10 = i13 * i12 <= MediaCodecUtil.maxH264DecodableFrameSize();
        if (!z10) {
    ...
    public boolean isVideoSizeAndRateSupportedV21(int i10, int i11, double d10) {
        ...
        if (Util.SDK_INT >= 29) {
            int iAreResolutionAndFrameRateCovered = Api29.areResolutionAndFrameRateCovered(videoCapabilities, i10, i11, d10);
            if (iAreResolutionAndFrameRateCovered == 2) {
                return true;
            }
            if (iAreResolutionAndFrameRateCovered == 1) {
                logNoSupport("sizeAndRate.cover, " + i10 + "x" + i11 + "@" + d10);
                return false;
            }
        }
        if (!areSizeAndRateSupportedV21(videoCapabilities, i10, i11, d10)) {
            if (i10 >= i11 || !needsRotatedVerticalResolutionWorkaround(this.name) || !areSizeAndRateSupportedV21(videoCapabilities, i11, i10, d10)) {
                logNoSupport("sizeAndRate.support, " + i10 + "x" + i11 + "@" + d10);
                return false;
            }
            logAssumedSupport("sizeAndRate.rotated, " + i10 + "x" + i11 + "@" + d10);
        }
        return true;
    }
