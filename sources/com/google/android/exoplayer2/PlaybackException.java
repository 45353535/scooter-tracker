...
public class PlaybackException extends Exception implements Bundleable {
    ...
    public static final Bundleable.Creator<PlaybackException> CREATOR = new Bundleable.Creator() { // from class: com.google.android.exoplayer2.p2
    ...
    protected PlaybackException(@Nullable String str, @Nullable Throwable th2, int i10, long j10) {
        super(str, th2);
        this.errorCode = i10;
