...
public abstract class SimpleBasePlayer extends BasePlayer {
    ...
    protected interface PositionSupplier {
        public static final PositionSupplier ZERO = e5.a(0);
    ...
    protected static final class State {
        ...
        public static final class Builder {
            ...
            public Builder() {
                ...
                this.contentPositionMsSupplier = e5.a(-9223372036854775807L);
                this.adPositionMs = null;
                PositionSupplier positionSupplier = PositionSupplier.ZERO;
                this.adPositionMsSupplier = positionSupplier;
                this.contentBufferedPositionMsSupplier = e5.a(-9223372036854775807L);
                this.adBufferedPositionMsSupplier = positionSupplier;
                this.totalBufferedDurationMsSupplier = positionSupplier;
                this.hasPositionDiscontinuity = false;
        ...
        private State(Builder builder) {
            ...
            PositionSupplier positionSupplierB = builder.contentPositionMs != null ? (builder.currentAdGroupIndex == -1 && builder.playWhenReady && builder.playbackState == 3 && builder.playbackSuppressionReason == 0 && builder.contentPositionMs.longValue() != -9223372036854775807L) ? e5.b(builder.contentPositionMs.longValue(), builder.playbackParameters.speed) : e5.a(builder.contentPositionMs.longValue()) : builder.contentPositionMsSupplier;
            PositionSupplier positionSupplierB2 = builder.adPositionMs != null ? (builder.currentAdGroupIndex != -1 && builder.playWhenReady && builder.playbackState == 3 && builder.playbackSuppressionReason == 0) ? e5.b(builder.adPositionMs.longValue(), 1.0f) : e5.a(builder.adPositionMs.longValue()) : builder.adPositionMsSupplier;
    ...
    public static /* synthetic */ void L(int i10, Player.PositionInfo positionInfo, Player.PositionInfo positionInfo2, Player.Listener listener) {
    ...
    public static /* synthetic */ State U(SimpleBasePlayer simpleBasePlayer, State state, int i10, int i11) {
    ...
    public static /* synthetic */ void V(State state, Player.Listener listener) {
        listener.onCues(state.currentCues.cues);
        listener.onCues(state.currentCues);
    }

    public static /* synthetic */ State Y(SimpleBasePlayer simpleBasePlayer, State state, List list, int i10) {
        simpleBasePlayer.getClass();
        ArrayList arrayList = new ArrayList(state.playlist);
        for (int i11 = 0; i11 < list.size(); i11++) {
            arrayList.add(i11 + i10, simpleBasePlayer.getPlaceholderMediaItemData((MediaItem) list.get(i11)));
        }
        return getStateWithNewPlaylist(state, arrayList, simpleBasePlayer.period);
    }
    ...
    private static State buildStateForNewPosition(State.Builder builder, State state, long j10, List<MediaItemData> list, int i10, long j11, boolean z10) {
        ...
        if (z12 || z11 || j11 < positionOrDefaultInMediaItem) {
            builder.setCurrentMediaItemIndex(i10).setCurrentAd(-1, -1).setContentPositionMs(j11).setContentBufferedPositionMs(e5.a(j11)).setTotalBufferedDurationMs(PositionSupplier.ZERO);
        } else if (j11 == positionOrDefaultInMediaItem) {
            builder.setCurrentMediaItemIndex(i10);
            if (state.currentAdGroupIndex == -1 || !z10) {
                builder.setCurrentAd(-1, -1).setTotalBufferedDurationMs(e5.a(getContentBufferedPositionMsInternal(state) - positionOrDefaultInMediaItem));
            } else {
                builder.setTotalBufferedDurationMs(e5.a(state.adBufferedPositionMsSupplier.get() - state.adPositionMsSupplier.get()));
            }
        } else {
            builder.setCurrentMediaItemIndex(i10).setCurrentAd(-1, -1).setContentPositionMs(j11).setContentBufferedPositionMs(e5.a(Math.max(getContentBufferedPositionMsInternal(state), j11))).setTotalBufferedDurationMs(e5.a(Math.max(0L, state.totalBufferedDurationMsSupplier.get() - (j11 - positionOrDefaultInMediaItem))));
        }
    ...
    private void clearVideoOutput(@Nullable Object obj) {
        ...
        if (shouldHandleCommand(27)) {
            updateStateForPendingOperation(handleClearVideoOutput(obj), new Supplier() { // from class: com.google.android.exoplayer2.n4
    ...
    public static /* synthetic */ void d0(SimpleBasePlayer simpleBasePlayer, Player.Listener listener, FlagSet flagSet) {
        simpleBasePlayer.getClass();
    ...
    private static Player.PositionInfo getPositionInfo(State state, boolean z10, Timeline.Window window, Timeline.Period period) {
        ...
        if (z10) {
            ...
            contentPositionMsInternal = state.currentAdGroupIndex == i10 ? j10 : getContentPositionMsInternal(state);
        } else {
            long contentPositionMsInternal2 = getContentPositionMsInternal(state);
            contentPositionMsInternal = contentPositionMsInternal2;
            j10 = state.currentAdGroupIndex != i10 ? state.adPositionMsSupplier.get() : contentPositionMsInternal2;
        }
        return new Player.PositionInfo(obj2, currentMediaItemIndexInternal, mediaItem, obj, i11, j10, contentPositionMsInternal, state.currentAdGroupIndex, state.currentAdIndexInAdGroup);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static State getStateWithNewPlaylistAndPosition(State state, List<MediaItemData> list, int i10, long j10) {
        State.Builder builderBuildUpon = state.buildUpon();
        builderBuildUpon.setPlaylist(list);
    ...
    public static /* synthetic */ State k(SimpleBasePlayer simpleBasePlayer, State state, int i10, int i11, int i12) {
        simpleBasePlayer.getClass();
        ArrayList arrayList = new ArrayList(state.playlist);
    ...
    private void setMediaItemsInternal(final List<MediaItem> list, final int i10, final long j10) {
        ...
        if (shouldHandleCommand(20) || (list.size() == 1 && shouldHandleCommand(31))) {
            updateStateForPendingOperation(handleSetMediaItems(list, i10, j10), new Supplier() { // from class: com.google.android.exoplayer2.s4
                @Override // com.google.common.base.Supplier
                public final Object get() {
                    return SimpleBasePlayer.v(this.f25041b, list, state, i10, j10);
                }
            });
        }
    }
    ...
    private void updateStateAndInformListeners(final State state, boolean z10, boolean z11) {
        ...
        if (!zEquals) {
            ...
            this.listeners.queueEvent(0, new ListenerSet.Event() { // from class: com.google.android.exoplayer2.y4
        ...
        if (positionDiscontinuityReason != -1) {
            ...
            this.listeners.queueEvent(11, new ListenerSet.Event() { // from class: com.google.android.exoplayer2.f3
                @Override // com.google.android.exoplayer2.util.ListenerSet.Event
                public final void invoke(Object obj) {
                    SimpleBasePlayer.L(positionDiscontinuityReason, positionInfo, positionInfo2, (Player.Listener) obj);
                }
            });
        }
        if (mediaItemTransitionReason != -1) {
            ...
            this.listeners.queueEvent(1, new ListenerSet.Event() { // from class: com.google.android.exoplayer2.q3
                @Override // com.google.android.exoplayer2.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!Util.areEqual(state2.playerError, state.playerError)) {
            this.listeners.queueEvent(10, new ListenerSet.Event() { // from class: com.google.android.exoplayer2.s3
                @Override // com.google.android.exoplayer2.util.ListenerSet.Event
                public final void invoke(Object obj) {
            ...
            if (state.playerError != null) {
                this.listeners.queueEvent(10, new ListenerSet.Event() { // from class: com.google.android.exoplayer2.u3
                    @Override // com.google.android.exoplayer2.util.ListenerSet.Event
                    public final void invoke(Object obj) {
        ...
        if (!state2.trackSelectionParameters.equals(state.trackSelectionParameters)) {
            this.listeners.queueEvent(19, new ListenerSet.Event() { // from class: com.google.android.exoplayer2.v3
                @Override // com.google.android.exoplayer2.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!currentTracksInternal.equals(currentTracksInternal2)) {
            this.listeners.queueEvent(2, new ListenerSet.Event() { // from class: com.google.android.exoplayer2.w3
                @Override // com.google.android.exoplayer2.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!mediaMetadataInternal.equals(mediaMetadataInternal2)) {
            this.listeners.queueEvent(14, new ListenerSet.Event() { // from class: com.google.android.exoplayer2.x3
                @Override // com.google.android.exoplayer2.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (state2.isLoading != state.isLoading) {
            this.listeners.queueEvent(3, new ListenerSet.Event() { // from class: com.google.android.exoplayer2.y3
                @Override // com.google.android.exoplayer2.util.ListenerSet.Event
                public final void invoke(Object obj) {
                    SimpleBasePlayer.t(state, (Player.Listener) obj);
                }
            });
        }
        if (z12 || z13) {
            this.listeners.queueEvent(-1, new ListenerSet.Event() { // from class: com.google.android.exoplayer2.z3
                @Override // com.google.android.exoplayer2.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (z13) {
            this.listeners.queueEvent(4, new ListenerSet.Event() { // from class: com.google.android.exoplayer2.z4
                @Override // com.google.android.exoplayer2.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (z12 || state2.playWhenReadyChangeReason != state.playWhenReadyChangeReason) {
            this.listeners.queueEvent(5, new ListenerSet.Event() { // from class: com.google.android.exoplayer2.a5
                @Override // com.google.android.exoplayer2.util.ListenerSet.Event
                public final void invoke(Object obj) {
                    SimpleBasePlayer.State state3 = state;
        ...
        if (state2.playbackSuppressionReason != state.playbackSuppressionReason) {
            this.listeners.queueEvent(6, new ListenerSet.Event() { // from class: com.google.android.exoplayer2.b5
                @Override // com.google.android.exoplayer2.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (isPlaying(state2) != isPlaying(state)) {
            this.listeners.queueEvent(7, new ListenerSet.Event() { // from class: com.google.android.exoplayer2.y2
                @Override // com.google.android.exoplayer2.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!state2.playbackParameters.equals(state.playbackParameters)) {
            this.listeners.queueEvent(12, new ListenerSet.Event() { // from class: com.google.android.exoplayer2.z2
                @Override // com.google.android.exoplayer2.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (state2.repeatMode != state.repeatMode) {
            this.listeners.queueEvent(8, new ListenerSet.Event() { // from class: com.google.android.exoplayer2.a3
                @Override // com.google.android.exoplayer2.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (state2.shuffleModeEnabled != state.shuffleModeEnabled) {
            this.listeners.queueEvent(9, new ListenerSet.Event() { // from class: com.google.android.exoplayer2.b3
                @Override // com.google.android.exoplayer2.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (state2.seekBackIncrementMs != state.seekBackIncrementMs) {
            this.listeners.queueEvent(16, new ListenerSet.Event() { // from class: com.google.android.exoplayer2.c3
                @Override // com.google.android.exoplayer2.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (state2.seekForwardIncrementMs != state.seekForwardIncrementMs) {
            this.listeners.queueEvent(17, new ListenerSet.Event() { // from class: com.google.android.exoplayer2.d3
                @Override // com.google.android.exoplayer2.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (state2.maxSeekToPreviousPositionMs != state.maxSeekToPreviousPositionMs) {
            this.listeners.queueEvent(18, new ListenerSet.Event() { // from class: com.google.android.exoplayer2.e3
                @Override // com.google.android.exoplayer2.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!state2.audioAttributes.equals(state.audioAttributes)) {
            this.listeners.queueEvent(20, new ListenerSet.Event() { // from class: com.google.android.exoplayer2.g3
                @Override // com.google.android.exoplayer2.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!state2.videoSize.equals(state.videoSize)) {
            this.listeners.queueEvent(25, new ListenerSet.Event() { // from class: com.google.android.exoplayer2.h3
                @Override // com.google.android.exoplayer2.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!state2.deviceInfo.equals(state.deviceInfo)) {
            this.listeners.queueEvent(29, new ListenerSet.Event() { // from class: com.google.android.exoplayer2.j3
                @Override // com.google.android.exoplayer2.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (!state2.playlistMetadata.equals(state.playlistMetadata)) {
            this.listeners.queueEvent(15, new ListenerSet.Event() { // from class: com.google.android.exoplayer2.k3
                @Override // com.google.android.exoplayer2.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (state.newlyRenderedFirstFrame) {
            this.listeners.queueEvent(26, new m1());
        }
        if (!state2.surfaceSize.equals(state.surfaceSize)) {
            this.listeners.queueEvent(24, new ListenerSet.Event() { // from class: com.google.android.exoplayer2.l3
                @Override // com.google.android.exoplayer2.util.ListenerSet.Event
                public final void invoke(Object obj) {
                    SimpleBasePlayer.State state3 = state;
        ...
        if (state2.volume != state.volume) {
            this.listeners.queueEvent(22, new ListenerSet.Event() { // from class: com.google.android.exoplayer2.m3
                @Override // com.google.android.exoplayer2.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (state2.deviceVolume != state.deviceVolume || state2.isDeviceMuted != state.isDeviceMuted) {
            this.listeners.queueEvent(30, new ListenerSet.Event() { // from class: com.google.android.exoplayer2.n3
                @Override // com.google.android.exoplayer2.util.ListenerSet.Event
                public final void invoke(Object obj) {
                    SimpleBasePlayer.State state3 = state;
        ...
        if (!state2.currentCues.equals(state.currentCues)) {
            this.listeners.queueEvent(27, new ListenerSet.Event() { // from class: com.google.android.exoplayer2.o3
                @Override // com.google.android.exoplayer2.util.ListenerSet.Event
                public final void invoke(Object obj) {
                    SimpleBasePlayer.V(state, (Player.Listener) obj);
                }
            });
        }
        if (!state2.timedMetadata.equals(state.timedMetadata) && state.timedMetadata.presentationTimeUs != -9223372036854775807L) {
            this.listeners.queueEvent(28, new ListenerSet.Event() { // from class: com.google.android.exoplayer2.p3
                @Override // com.google.android.exoplayer2.util.ListenerSet.Event
                public final void invoke(Object obj) {
        ...
        if (positionDiscontinuityReason == 1) {
            this.listeners.queueEvent(-1, new g0());
        }
        if (!state2.availableCommands.equals(state.availableCommands)) {
            this.listeners.queueEvent(13, new ListenerSet.Event() { // from class: com.google.android.exoplayer2.r3
                @Override // com.google.android.exoplayer2.util.ListenerSet.Event
                public final void invoke(Object obj) {
    ...
    public static /* synthetic */ State v(SimpleBasePlayer simpleBasePlayer, List list, State state, int i10, long j10) {
        simpleBasePlayer.getClass();
        ArrayList arrayList = new ArrayList();
        for (int i11 = 0; i11 < list.size(); i11++) {
            arrayList.add(simpleBasePlayer.getPlaceholderMediaItemData((MediaItem) list.get(i11)));
        }
    ...
    public static /* synthetic */ void z(SimpleBasePlayer simpleBasePlayer, ListenableFuture listenableFuture) {
    ...
    public final void addMediaItems(int i10, final List<MediaItem> list) {
        ...
        updateStateForPendingOperation(handleAddMediaItems(iMin, list), new Supplier() { // from class: com.google.android.exoplayer2.x2
            @Override // com.google.common.base.Supplier
            public final Object get() {
                return SimpleBasePlayer.Y(this.f25264b, state, list, iMin);
            }
        });
    }
    ...
    public final void decreaseDeviceVolume() {
        ...
        if (shouldHandleCommand(26)) {
            updateStateForPendingOperation(handleDecreaseDeviceVolume(), new Supplier() { // from class: com.google.android.exoplayer2.i4
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    @ForOverride
    protected ListenableFuture<?> handleAddMediaItems(int i10, List<MediaItem> list) {
    ...
    @ForOverride
    protected ListenableFuture<?> handleMoveMediaItems(int i10, int i11, int i12) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_CHANGE_MEDIA_ITEMS");
    }
    ...
    @ForOverride
    protected ListenableFuture<?> handleRemoveMediaItems(int i10, int i11) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_CHANGE_MEDIA_ITEMS");
    }
    ...
    @ForOverride
    protected ListenableFuture<?> handleSetDeviceMuted(boolean z10) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_ADJUST_DEVICE_VOLUME");
    }

    @ForOverride
    protected ListenableFuture<?> handleSetDeviceVolume(@IntRange(from = 0) int i10) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_SET_DEVICE_VOLUME");
    }

    @ForOverride
    protected ListenableFuture<?> handleSetMediaItems(List<MediaItem> list, int i10, long j10) {
    ...
    @ForOverride
    protected ListenableFuture<?> handleSetRepeatMode(int i10) {
        throw new IllegalStateException("Missing implementation to handle COMMAND_SET_REPEAT_MODE");
    }

    @ForOverride
    protected ListenableFuture<?> handleSetShuffleModeEnabled(boolean z10) {
    ...
    @ForOverride
    protected ListenableFuture<?> handleSetVolume(@FloatRange(from = 0.0d, to = 1.0d) float f10) {
    ...
    public final void increaseDeviceVolume() {
        ...
        final State state = this.state;
        if (shouldHandleCommand(26)) {
            updateStateForPendingOperation(handleIncreaseDeviceVolume(), new Supplier() { // from class: com.google.android.exoplayer2.i3
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    public final void moveMediaItems(final int i10, int i11, int i12) {
        ...
        if (shouldHandleCommand(20) && size != 0 && i10 < size) {
            ...
            if (i10 != iMin && iMin2 != i10) {
                updateStateForPendingOperation(handleMoveMediaItems(i10, iMin, iMin2), new Supplier() { // from class: com.google.android.exoplayer2.v4
                    @Override // com.google.common.base.Supplier
                    public final Object get() {
                        return SimpleBasePlayer.k(this.f25220b, state, i10, iMin, iMin2);
                    }
                });
            }
        }
    ...
    public final void prepare() {
        ...
        if (shouldHandleCommand(2)) {
            updateStateForPendingOperation(handlePrepare(), new Supplier() { // from class: com.google.android.exoplayer2.h4
                @Override // com.google.common.base.Supplier
                public final Object get() {
                    SimpleBasePlayer.State state2 = state;
    ...
    public final void release() {
        ...
        updateStateForPendingOperation(handleRelease(), new Supplier() { // from class: com.google.android.exoplayer2.b4
            @Override // com.google.common.base.Supplier
            public final Object get() {
                return SimpleBasePlayer.O(state);
            }
        });
        this.released = true;
        this.listeners.release();
        this.state = this.state.buildUpon().setPlaybackState(1).setTotalBufferedDurationMs(PositionSupplier.ZERO).setContentBufferedPositionMs(e5.a(getContentPositionMsInternal(state))).setAdBufferedPositionMs(state.adPositionMsSupplier).setIsLoading(false).build();
    }
    ...
    public final void removeMediaItems(final int i10, int i11) {
        ...
        updateStateForPendingOperation(handleRemoveMediaItems(i10, iMin), new Supplier() { // from class: com.google.android.exoplayer2.q4
            @Override // com.google.common.base.Supplier
            public final Object get() {
                return SimpleBasePlayer.U(this.f25026b, state, i10, iMin);
            }
        });
    }
    ...
    public final void seekTo(final int i10, final long j10, int i11, boolean z10) {
        ...
        if (state.playlist.isEmpty() || i10 < state.playlist.size()) {
            updateStateForPendingOperation(handleSeek(i10, j10, i11), new Supplier() { // from class: com.google.android.exoplayer2.l4
                @Override // com.google.common.base.Supplier
                public final Object get() {
                    SimpleBasePlayer.State state2 = state;
                    return SimpleBasePlayer.getStateWithNewPlaylistAndPosition(state2, state2.playlist, i10, j10);
                }
            }, true, z10);
        }
    }
    ...
    public final void setDeviceMuted(final boolean z10) {
        ...
        final State state = this.state;
        if (shouldHandleCommand(26)) {
            updateStateForPendingOperation(handleSetDeviceMuted(z10), new Supplier() { // from class: com.google.android.exoplayer2.m4
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    public final void setDeviceVolume(final int i10) {
        ...
        if (shouldHandleCommand(25)) {
            updateStateForPendingOperation(handleSetDeviceVolume(i10), new Supplier() { // from class: com.google.android.exoplayer2.p4
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    public final void setPlayWhenReady(final boolean z10) {
        ...
        if (shouldHandleCommand(1)) {
            updateStateForPendingOperation(handleSetPlayWhenReady(z10), new Supplier() { // from class: com.google.android.exoplayer2.a4
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    public final void setPlaybackParameters(final PlaybackParameters playbackParameters) {
        ...
        if (shouldHandleCommand(13)) {
            updateStateForPendingOperation(handleSetPlaybackParameters(playbackParameters), new Supplier() { // from class: com.google.android.exoplayer2.t4
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    public final void setPlaylistMetadata(final MediaMetadata mediaMetadata) {
        ...
        if (shouldHandleCommand(19)) {
            updateStateForPendingOperation(handleSetPlaylistMetadata(mediaMetadata), new Supplier() { // from class: com.google.android.exoplayer2.o4
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    public final void setRepeatMode(final int i10) {
        ...
        if (shouldHandleCommand(15)) {
            updateStateForPendingOperation(handleSetRepeatMode(i10), new Supplier() { // from class: com.google.android.exoplayer2.f4
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    public final void setShuffleModeEnabled(final boolean z10) {
        ...
        if (shouldHandleCommand(14)) {
            updateStateForPendingOperation(handleSetShuffleModeEnabled(z10), new Supplier() { // from class: com.google.android.exoplayer2.e4
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    public final void setTrackSelectionParameters(final TrackSelectionParameters trackSelectionParameters) {
        ...
        if (shouldHandleCommand(29)) {
            updateStateForPendingOperation(handleSetTrackSelectionParameters(trackSelectionParameters), new Supplier() { // from class: com.google.android.exoplayer2.u4
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    public final void setVideoSurface(@Nullable Surface surface) {
        ...
        if (shouldHandleCommand(27)) {
            if (surface == null) {
                ...
                updateStateForPendingOperation(handleSetVideoOutput(surface), new Supplier() { // from class: com.google.android.exoplayer2.d4
                    @Override // com.google.common.base.Supplier
                    public final Object get() {
    ...
    public final void setVideoSurfaceHolder(@Nullable final SurfaceHolder surfaceHolder) {
        ...
        if (shouldHandleCommand(27)) {
            if (surfaceHolder == null) {
                ...
                updateStateForPendingOperation(handleSetVideoOutput(surfaceHolder), new Supplier() { // from class: com.google.android.exoplayer2.r4
                    @Override // com.google.common.base.Supplier
                    public final Object get() {
    ...
    public final void setVideoSurfaceView(@Nullable final SurfaceView surfaceView) {
        ...
        if (shouldHandleCommand(27)) {
            if (surfaceView == null) {
                ...
                updateStateForPendingOperation(handleSetVideoOutput(surfaceView), new Supplier() { // from class: com.google.android.exoplayer2.t3
                    @Override // com.google.common.base.Supplier
                    public final Object get() {
    ...
    public final void setVideoTextureView(@Nullable TextureView textureView) {
        ...
        if (shouldHandleCommand(27)) {
            if (textureView == null) {
                ...
                updateStateForPendingOperation(handleSetVideoOutput(textureView), new Supplier() { // from class: com.google.android.exoplayer2.x4
                    @Override // com.google.common.base.Supplier
                    public final Object get() {
    ...
    public final void setVolume(final float f10) {
        ...
        if (shouldHandleCommand(24)) {
            updateStateForPendingOperation(handleSetVolume(f10), new Supplier() { // from class: com.google.android.exoplayer2.c4
                @Override // com.google.common.base.Supplier
                public final Object get() {
    ...
    public final void stop() {
        ...
        if (shouldHandleCommand(3)) {
            updateStateForPendingOperation(handleStop(), new Supplier() { // from class: com.google.android.exoplayer2.g4
                @Override // com.google.common.base.Supplier
                public final Object get() {
                    SimpleBasePlayer.State state2 = state;
                    return state2.buildUpon().setPlaybackState(1).setTotalBufferedDurationMs(SimpleBasePlayer.PositionSupplier.ZERO).setContentBufferedPositionMs(e5.a(SimpleBasePlayer.getContentPositionMsInternal(state2))).setAdBufferedPositionMs(state2.adPositionMsSupplier).setIsLoading(false).build();
                }
            });
        }
    }
    ...
    protected SimpleBasePlayer(Looper looper, Clock clock) {
        ...
        this.listeners = new ListenerSet<>(looper, clock, new ListenerSet.IterationFinishedEvent() { // from class: com.google.android.exoplayer2.w4
            @Override // com.google.android.exoplayer2.util.ListenerSet.IterationFinishedEvent
            public final void invoke(Object obj, FlagSet flagSet) {
                SimpleBasePlayer.d0(this.f25261a, (Player.Listener) obj, flagSet);
            }
        });
    }

    private void updateStateForPendingOperation(final ListenableFuture<?> listenableFuture, Supplier<State> supplier, boolean z10, boolean z11) {
        ...
        updateStateAndInformListeners(getPlaceholderState(supplier.get()), z10, z11);
        listenableFuture.addListener(new Runnable() { // from class: com.google.android.exoplayer2.j4
            @Override // java.lang.Runnable
            public final void run() {
                SimpleBasePlayer.z(this.f24942b, listenableFuture);
            }
        }, new Executor() { // from class: com.google.android.exoplayer2.k4
            @Override // java.util.concurrent.Executor
            public final void execute(Runnable runnable) {
                this.f24952b.postOrRunOnApplicationHandler(runnable);
            }
        });
    }
