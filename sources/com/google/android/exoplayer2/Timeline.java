...
public abstract class Timeline implements Bundleable {
    ...
    public static final Bundleable.Creator<Timeline> CREATOR = new Bundleable.Creator() { // from class: com.google.android.exoplayer2.i5
    ...
    public static final class Period implements Bundleable {
        ...
        public static final Bundleable.Creator<Period> CREATOR = new Bundleable.Creator() { // from class: com.google.android.exoplayer2.j5
            @Override // com.google.android.exoplayer2.Bundleable.Creator
            public final Bundleable fromBundle(Bundle bundle) {
        ...
        public static Period fromBundle(Bundle bundle) {
            ...
            period.set(null, null, i10, j10, j11, adPlaybackState, z10);
            return period;
        }
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            if (obj != null && Period.class.equals(obj.getClass())) {
                ...
                if (Util.areEqual(this.f24625id, period.f24625id) && Util.areEqual(this.uid, period.uid) && this.windowIndex == period.windowIndex && this.durationUs == period.durationUs && this.positionInWindowUs == period.positionInWindowUs && this.isPlaceholder == period.isPlaceholder && Util.areEqual(this.adPlaybackState, period.adPlaybackState)) {
                    return true;
                }
            }
            return false;
    ...
    public static final class RemotableTimeline extends Timeline {
        ...
        public Period getPeriod(int i10, Period period, boolean z10) {
            ...
            period.set(period2.f24625id, period2.uid, period2.windowIndex, period2.durationUs, period2.positionInWindowUs, period2.adPlaybackState, period2.isPlaceholder);
            return period;
        }
    ...
    public static final class Window implements Bundleable {
        ...
        public static final Bundleable.Creator<Window> CREATOR = new Bundleable.Creator() { // from class: com.google.android.exoplayer2.k5
            @Override // com.google.android.exoplayer2.Bundleable.Creator
            public final Bundleable fromBundle(Bundle bundle) {
        ...
        public static Window fromBundle(Bundle bundle) {
            ...
            window.set(FAKE_WINDOW_UID, mediaItem, null, j10, j11, j12, z10, z11, liveConfiguration, j13, j14, i10, i11, j15);
    ...
    private static <T extends Bundleable> ImmutableList<T> fromBundleListRetriever(Bundleable.Creator<T> creator, @Nullable IBinder iBinder) {
        ...
        for (int i10 = 0; i10 < list.size(); i10++) {
            builder.add(creator.fromBundle(list.get(i10)));
        }
