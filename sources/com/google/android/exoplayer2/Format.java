...
public final class Format implements Bundleable {
    ...
    public static final Bundleable.Creator<Format> CREATOR = new Bundleable.Creator() { // from class: com.google.android.exoplayer2.t1
    ...
    public static final class Builder {
        ...
        public Builder setId(int i10) {
            this.f24620id = Integer.toString(i10);
            return this;
        }

        private Builder(Format format) {
            this.f24620id = format.f24619id;
    ...
    public String toString() {
        return "Format(" + this.f24619id + ", " + this.label + ", " + this.containerMimeType + ", " + this.sampleMimeType + ", " + this.codecs + ", " + this.bitrate + ", " + this.language + ", [" + this.width + ", " + this.height + ", " + this.frameRate + "], [" + this.channelCount + ", " + this.sampleRate + "])";
    }
    ...
    public Format withManifestFormatInfo(Format format) {
        ...
        return buildUpon().setId(str2).setLabel(str3).setLanguage(str4).setSelectionFlags(this.selectionFlags | format.selectionFlags).setRoleFlags(this.roleFlags | format.roleFlags).setAverageBitrate(i10).setPeakBitrate(i11).setCodecs(str5).setMetadata(metadataCopyWithAppendedEntriesFrom).setDrmInitData(DrmInitData.createSessionCreationData(format.drmInitData, this.drmInitData)).setFrameRate(f10).build();
    }

    private Format(Builder builder) {
        this.f24619id = builder.f24620id;
    ...
    public Bundle toBundle(boolean z10) {
        ...
        bundle.putString(FIELD_ID, this.f24619id);
