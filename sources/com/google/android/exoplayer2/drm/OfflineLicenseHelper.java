...
public final class OfflineLicenseHelper {
    ...
    public static /* synthetic */ void a(OfflineLicenseHelper offlineLicenseHelper, SettableFuture settableFuture, DrmSession drmSession) {
    ...
    private DrmSession acquireFirstSessionOnHandlerThread(final int i10, @Nullable final byte[] bArr, final Format format) throws DrmSession.DrmSessionException {
        ...
        this.handler.post(new Runnable() { // from class: com.google.android.exoplayer2.drm.b0
            @Override // java.lang.Runnable
            public final void run() {
                OfflineLicenseHelper.e(this.f24850b, i10, bArr, settableFutureCreate, format);
            }
        });
        try {
            ...
            this.handler.post(new Runnable() { // from class: com.google.android.exoplayer2.drm.c0
                @Override // java.lang.Runnable
                public final void run() {
                    OfflineLicenseHelper.b(this.f24856b, drmSession, settableFutureCreate2);
                }
            });
            try {
    ...
    private byte[] acquireSessionAndGetOfflineLicenseKeySetIdOnHandlerThread(int i10, @Nullable byte[] bArr, Format format) throws DrmSession.DrmSessionException {
        ...
        final SettableFuture settableFutureCreate = SettableFuture.create();
        this.handler.post(new Runnable() { // from class: com.google.android.exoplayer2.drm.a0
            @Override // java.lang.Runnable
            public final void run() {
                OfflineLicenseHelper.c(this.f24847b, settableFutureCreate, drmSessionAcquireFirstSessionOnHandlerThread);
            }
        });
        try {
            try {
    ...
    public static /* synthetic */ void b(OfflineLicenseHelper offlineLicenseHelper, DrmSession drmSession, SettableFuture settableFuture) {
        offlineLicenseHelper.getClass();
        try {
    ...
    public static /* synthetic */ void d(OfflineLicenseHelper offlineLicenseHelper, SettableFuture settableFuture) {
        offlineLicenseHelper.getClass();
        try {
            offlineLicenseHelper.drmSessionManager.release();
    ...
    public static /* synthetic */ void e(OfflineLicenseHelper offlineLicenseHelper, int i10, byte[] bArr, SettableFuture settableFuture, Format format) {
        offlineLicenseHelper.getClass();
        try {
    ...
    private void releaseManagerOnHandlerThread() {
        final SettableFuture settableFutureCreate = SettableFuture.create();
        this.handler.post(new Runnable() { // from class: com.google.android.exoplayer2.drm.z
            @Override // java.lang.Runnable
            public final void run() {
                OfflineLicenseHelper.d(this.f24886b, settableFutureCreate);
            }
        });
        try {
    ...
    public synchronized Pair<Long, Long> getLicenseDurationRemainingSec(byte[] bArr) throws DrmSession.DrmSessionException {
        ...
        try {
            ...
            this.handler.post(new Runnable() { // from class: com.google.android.exoplayer2.drm.y
                @Override // java.lang.Runnable
                public final void run() {
                    OfflineLicenseHelper.a(this.f24883b, settableFutureCreate, drmSessionAcquireFirstSessionOnHandlerThread);
                }
            });
            try {
                try {
