...
public abstract class NetworkConnectionInfo {
    ...
    public enum MobileSubtype {
        ...
        private static final SparseArray f24275c;
        ...
        public static MobileSubtype forNumber(int i10) {
            return (MobileSubtype) f24275c.get(i10);
        }
    ...
    public enum NetworkType {
        ...
        /* JADX INFO: renamed from: c, reason: collision with root package name */
        private static final SparseArray f24278c;
        ...
        public static NetworkType forNumber(int i10) {
            return (NetworkType) f24278c.get(i10);
        }
