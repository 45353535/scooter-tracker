...
public class AnalyticsConnectorImpl implements AnalyticsConnector {
    ...
    private static volatile AnalyticsConnector f31737c;

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    final AppMeasurementSdk f31738a;
    ...
    AnalyticsConnectorImpl(AppMeasurementSdk appMeasurementSdk) {
        ...
        this.f31738a = appMeasurementSdk;
        this.f31739b = new ConcurrentHashMap();
    }

    static /* synthetic */ void a(Event event) {
        boolean z10 = ((DataCollectionDefaultChange) event.getPayload()).enabled;
        synchronized (AnalyticsConnectorImpl.class) {
            ((AnalyticsConnectorImpl) Preconditions.checkNotNull(f31737c)).f31738a.zza(z10);
        }
    }
    ...
    public void clearConditionalUserProperty(@NonNull @Size(max = 24, min = 1) String str, @NonNull String str2, @NonNull Bundle bundle) {
        if (str2 == null || zzc.zzb(str2, bundle)) {
            this.f31738a.clearConditionalUserProperty(str, str2, bundle);
        }
    }
    ...
    public List<AnalyticsConnector.ConditionalUserProperty> getConditionalUserProperties(@NonNull String str, @NonNull @Size(max = 23, min = 1) String str2) {
        ...
        for (Bundle bundle : this.f31738a.getConditionalUserProperties(str, str2)) {
            int i10 = zzc.zza;
    ...
    public int getMaxUserProperties(@NonNull @Size(min = 1) String str) {
        return this.f31738a.getMaxUserProperties(str);
    }
    ...
    public Map<String, Object> getUserProperties(boolean z10) {
        return this.f31738a.getUserProperties(null, null, z10);
    }
    ...
    public void logEvent(@NonNull String str, @NonNull String str2, @NonNull Bundle bundle) {
        ...
        if (zzc.zza(str) && zzc.zzb(str2, bundle) && zzc.zze(str, str2, bundle)) {
            ...
            this.f31738a.logEvent(str, str2, bundle);
        }
    }
    ...
    public AnalyticsConnector.AnalyticsConnectorHandle registerAnalyticsConnectorListener(@NonNull final String str, @NonNull AnalyticsConnector.AnalyticsConnectorListener analyticsConnectorListener) {
        ...
        if (zzc.zza(str) && !b(str)) {
            AppMeasurementSdk appMeasurementSdk = this.f31738a;
            ...
            if (zzeVar != null) {
                ...
                return new AnalyticsConnector.AnalyticsConnectorHandle(this) { // from class: com.google.firebase.analytics.connector.AnalyticsConnectorImpl.1
                    ...
                    /* JADX INFO: renamed from: b, reason: collision with root package name */
                    final /* synthetic */ AnalyticsConnectorImpl f31741b;
                    ...
                    public void registerEventNames(Set<String> set) {
                        AnalyticsConnectorImpl analyticsConnectorImpl = this.f31741b;
                        String str2 = str;
                        if (!analyticsConnectorImpl.b(str2) || !str2.equals("fiam") || set == null || set.isEmpty()) {
                            return;
                        }
                        ((com.google.firebase.analytics.connector.internal.zza) analyticsConnectorImpl.f31739b.get(str2)).zzb(set);
                    }
                    ...
                    public final void unregister() {
                        AnalyticsConnectorImpl analyticsConnectorImpl = this.f31741b;
                        String str2 = str;
                        if (analyticsConnectorImpl.b(str2)) {
                            Map map = analyticsConnectorImpl.f31739b;
                    ...
                    public void unregisterEventNames() {
                        AnalyticsConnectorImpl analyticsConnectorImpl = this.f31741b;
                        String str2 = str;
                        if (analyticsConnectorImpl.b(str2) && str2.equals("fiam")) {
                            ((com.google.firebase.analytics.connector.internal.zza) analyticsConnectorImpl.f31739b.get(str2)).zzc();
                        }
                    }
                };
            }
    ...
    public void setUserProperty(@NonNull String str, @NonNull String str2, @NonNull Object obj) {
        if (zzc.zza(str) && zzc.zzd(str, str2)) {
            this.f31738a.setUserProperty(str, str2, obj);
        }
    }
                ...
                try {
                    if (f31737c == null) {
                        ...
                        if (firebaseApp.isDefaultApp()) {
                            subscriber.subscribe(DataCollectionDefaultChange.class, zzb.f31759b, zza.f31758a);
                            bundle.putBoolean("dataCollectionDefaultEnabled", firebaseApp.isDataCollectionDefaultEnabled());
                        }
                        f31737c = new AnalyticsConnectorImpl(zzfb.zza(context, bundle).zzb());
                    }
                } finally {
                }
            }
