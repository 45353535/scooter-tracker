...
public final class FirebaseAnalytics {
    ...
    private static volatile FirebaseAnalytics f31731c;

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private final zzfb f31732a;
    ...
    public FirebaseAnalytics(zzfb zzfbVar) {
        ...
        this.f31732a = zzfbVar;
    }

    private final ExecutorService b() throws Throwable {
            ...
            try {
                try {
                    if (this.f31733b == null) {
                        ...
                        firebaseAnalytics.f31733b = new zza(firebaseAnalytics, 0, 1, 30L, TimeUnit.SECONDS, new ArrayBlockingQueue(100));
                    } else {
                        firebaseAnalytics = this;
                    }
                    return firebaseAnalytics.f31733b;
                } catch (Throwable th2) {
                    th = th2;
                    throw th;
                }
    ...
    public static FirebaseAnalytics getInstance(@NonNull Context context) {
        if (f31731c == null) {
            synchronized (FirebaseAnalytics.class) {
                try {
                    if (f31731c == null) {
                        f31731c = new FirebaseAnalytics(zzfb.zza(context, null));
                    }
                } finally {
                }
            }
    ...
    public Task<String> getAppInstanceId() {
        try {
            ...
            this.f31732a.zzD(5, "Failed to schedule task for getAppInstanceId", null, null, null);
    ...
    public Task<Long> getSessionId() {
        try {
            ...
            this.f31732a.zzD(5, "Failed to schedule task for getSessionId", null, null, null);
            return Tasks.forException(e10);
        }
    }

    public void logEvent(@NonNull @Size(max = 40, min = 1) String str, @Nullable Bundle bundle) {
        this.f31732a.zzh(str, bundle);
    }
    ...
    public void setAnalyticsCollectionEnabled(boolean z10) {
        this.f31732a.zzq(Boolean.valueOf(z10));
    }
    ...
    public void setCurrentScreen(@NonNull Activity activity, @Nullable @Size(max = 36, min = 1) String str, @Nullable @Size(max = 36, min = 1) String str2) {
        this.f31732a.zzp(zzdf.zza(activity), str, str2);
    }
