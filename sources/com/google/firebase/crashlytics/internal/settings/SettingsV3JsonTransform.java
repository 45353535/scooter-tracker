...
class SettingsV3JsonTransform implements SettingsJsonTransform {
    ...
    private static Settings.FeatureFlagData a(JSONObject jSONObject) {
    ...
    private static Settings.SessionData b(JSONObject jSONObject) {
        return new Settings.SessionData(jSONObject.optInt("max_custom_exception_events", 8), 4);
    }

    private static long c(CurrentTimeProvider currentTimeProvider, long j10, JSONObject jSONObject) {
    ...
    public Settings buildFromJson(CurrentTimeProvider currentTimeProvider, JSONObject jSONObject) throws JSONException {
        ...
        return new Settings(c(currentTimeProvider, iOptInt2, jSONObject), jSONObject.has(b.f66095s) ? b(jSONObject.getJSONObject(b.f66095s)) : b(new JSONObject()), a(jSONObject.getJSONObject(AdaptiveRenderingConfig.NATIVE_FEATURES_KEY)), iOptInt, iOptInt2, jSONObject.optDouble("on_demand_upload_rate_per_minute", 10.0d), jSONObject.optDouble("on_demand_backoff_base", 1.2d), jSONObject.optInt("on_demand_backoff_step_duration_seconds", 60));
    }
}
