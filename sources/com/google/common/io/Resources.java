...
public final class Resources {
    ...
    private static final class UrlByteSource extends ByteSource {
        ...
        private final URL f30961a;

        @Override // com.google.common.io.ByteSource
        public InputStream openStream() throws IOException {
            return this.f30961a.openStream();
        }

        public String toString() {
            return "Resources.asByteSource(" + this.f30961a + ")";
        }

        private UrlByteSource(URL url) {
            this.f30961a = (URL) Preconditions.checkNotNull(url);
        }
    }
    ...
    public static List<String> readLines(URL url, Charset charset) throws IOException {
        return (List) readLines(url, charset, new LineProcessor<List<String>>() { // from class: com.google.common.io.Resources.1
            ...
            /* JADX INFO: renamed from: a, reason: collision with root package name */
            final List f30960a = Lists.newArrayList();
