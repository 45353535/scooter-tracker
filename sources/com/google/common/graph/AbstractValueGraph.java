...
public abstract class AbstractValueGraph<N, V> extends AbstractBaseGraph<N> implements ValueGraph<N, V> {
    ...
    public static /* synthetic */ Object g(ValueGraph valueGraph, EndpointPair endpointPair) {
    ...
    private static Map h(final ValueGraph valueGraph) {
        return Maps.asMap(valueGraph.edges(), new Function() { // from class: com.google.common.graph.n
            @Override // com.google.common.base.Function
            public final Object apply(Object obj) {
                return AbstractValueGraph.g(valueGraph, (EndpointPair) obj);
            }
        });
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return isDirected() == valueGraph.isDirected() && nodes().equals(valueGraph.nodes()) && h(this).equals(h(valueGraph));
    }
    ...
    public String toString() {
        return "isDirected: " + isDirected() + ", allowsSelfLoops: " + allowsSelfLoops() + ", nodes: " + nodes() + ", edges: " + h(this);
    }
