...
public final class Ints extends IntsMethodsForWeb {
    ...
    private static class IntArrayAsList extends AbstractList<Integer> implements RandomAccess, Serializable {
        ...
        public boolean contains(Object obj) {
            return (obj instanceof Integer) && Ints.d(this.f31113b, ((Integer) obj).intValue(), this.f31114c, this.f31115d) != -1;
        }
        ...
        public boolean equals(Object obj) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                if (this.f31113b[this.f31114c + i10] != intArrayAsList.f31113b[intArrayAsList.f31114c + i10]) {
                    return false;
                }
            }
            return true;
        ...
        int[] g() {
            return Arrays.copyOfRange(this.f31113b, this.f31114c, this.f31115d);
        }

        @Override // java.util.AbstractList, java.util.Collection, java.util.List
        public int hashCode() {
            int iHashCode = 1;
            for (int i10 = this.f31114c; i10 < this.f31115d; i10++) {
                iHashCode = (iHashCode * 31) + Ints.hashCode(this.f31113b[i10]);
            }
            return iHashCode;
        }
        ...
        public int indexOf(Object obj) {
            int iD;
            if (!(obj instanceof Integer) || (iD = Ints.d(this.f31113b, ((Integer) obj).intValue(), this.f31114c, this.f31115d)) < 0) {
                return -1;
            }
            return iD - this.f31114c;
        }
        ...
        public int lastIndexOf(Object obj) {
            int iE;
            if (!(obj instanceof Integer) || (iE = Ints.e(this.f31113b, ((Integer) obj).intValue(), this.f31114c, this.f31115d)) < 0) {
                return -1;
            }
            return iE - this.f31114c;
        }

        @Override // java.util.AbstractCollection, java.util.Collection, java.util.List
        public int size() {
            return this.f31115d - this.f31114c;
        }
        ...
        public List<Integer> subList(int i10, int i11) {
            ...
            int[] iArr = this.f31113b;
            int i12 = this.f31114c;
        ...
        public String toString() {
            ...
            sb2.append('[');
            sb2.append(this.f31113b[this.f31114c]);
        ...
        public Integer get(int i10) {
            ...
            return Integer.valueOf(this.f31113b[this.f31114c + i10]);
        }
    ...
    private static final class IntConverter extends Converter<String, Integer> implements Serializable {
        ...
        /* JADX INFO: renamed from: d, reason: collision with root package name */
        static final Converter f31116d = new IntConverter();
    ...
    public static int lastIndexOf(int[] iArr, int i10) {
        return e(iArr, i10, 0, iArr.length);
    }
    ...
    public static Converter<String, Integer> stringConverter() {
        return IntConverter.f31116d;
    }

    public static int[] toArray(Collection<? extends Number> collection) {
        if (collection instanceof IntArrayAsList) {
            return ((IntArrayAsList) collection).g();
        }
