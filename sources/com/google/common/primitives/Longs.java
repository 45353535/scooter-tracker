...
public final class Longs {
    ...
    static final class AsciiDigits {
        ...
        private static final byte[] f31118a;
    ...
    private static class LongArrayAsList extends AbstractList<Long> implements RandomAccess, Serializable {
        ...
        public boolean contains(Object obj) {
            return (obj instanceof Long) && Longs.d(this.f31120b, ((Long) obj).longValue(), this.f31121c, this.f31122d) != -1;
        }
        ...
        public boolean equals(Object obj) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                if (this.f31120b[this.f31121c + i10] != longArrayAsList.f31120b[longArrayAsList.f31121c + i10]) {
                    return false;
                }
            }
            return true;
        ...
        long[] g() {
            return Arrays.copyOfRange(this.f31120b, this.f31121c, this.f31122d);
        }

        @Override // java.util.AbstractList, java.util.Collection, java.util.List
        public int hashCode() {
            int iHashCode = 1;
            for (int i10 = this.f31121c; i10 < this.f31122d; i10++) {
                iHashCode = (iHashCode * 31) + Longs.hashCode(this.f31120b[i10]);
            }
            return iHashCode;
        }
        ...
        public int indexOf(Object obj) {
            int iD;
            if (!(obj instanceof Long) || (iD = Longs.d(this.f31120b, ((Long) obj).longValue(), this.f31121c, this.f31122d)) < 0) {
                return -1;
            }
            return iD - this.f31121c;
        }
        ...
        public int lastIndexOf(Object obj) {
            int iE;
            if (!(obj instanceof Long) || (iE = Longs.e(this.f31120b, ((Long) obj).longValue(), this.f31121c, this.f31122d)) < 0) {
                return -1;
            }
            return iE - this.f31121c;
        }

        @Override // java.util.AbstractCollection, java.util.Collection, java.util.List
        public int size() {
            return this.f31122d - this.f31121c;
        }
        ...
        public List<Long> subList(int i10, int i11) {
            ...
            long[] jArr = this.f31120b;
            int i12 = this.f31121c;
        ...
        public String toString() {
            ...
            sb2.append('[');
            sb2.append(this.f31120b[this.f31121c]);
        ...
        public Long get(int i10) {
            ...
            return Long.valueOf(this.f31120b[this.f31121c + i10]);
        }
    ...
    private static final class LongConverter extends Converter<String, Long> implements Serializable {
        ...
        /* JADX INFO: renamed from: d, reason: collision with root package name */
        static final Converter f31123d = new LongConverter();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static int e(long[] jArr, long j10, int i10, int i11) {
    ...
    public static int lastIndexOf(long[] jArr, long j10) {
        return e(jArr, j10, 0, jArr.length);
    }
    ...
    public static Converter<String, Long> stringConverter() {
        return LongConverter.f31123d;
    }

    public static long[] toArray(Collection<? extends Number> collection) {
        if (collection instanceof LongArrayAsList) {
            return ((LongArrayAsList) collection).g();
        }
    ...
    */
    ...
    public static Long tryParse(String str, int i10) {
        ...
        int i12 = i11 + 1;
        int iA = AsciiDigits.a(str.charAt(i11));
        if (iA < 0 || iA >= i10) {
            return null;
        }
        long j10 = -iA;
        ...
        while (i12 < str.length()) {
            int i13 = i12 + 1;
            int iA2 = AsciiDigits.a(str.charAt(i12));
