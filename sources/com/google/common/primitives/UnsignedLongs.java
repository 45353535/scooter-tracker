...
public final class UnsignedLongs {
    ...
    private static final class ParseOverflowDetection {
        ...
        static final long[] f31145a = new long[37];

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        static final int[] f31146b = new int[37];

        /* JADX INFO: renamed from: c, reason: collision with root package name */
        static final int[] f31147c = new int[37];

        static {
            BigInteger bigInteger = new BigInteger("10000000000000000", 16);
            for (int i10 = 2; i10 <= 36; i10++) {
                long j10 = i10;
                f31145a[i10] = UnsignedLongs.divide(-1L, j10);
                f31146b[i10] = (int) UnsignedLongs.remainder(-1L, j10);
                f31147c[i10] = bigInteger.toString(i10).length() - 1;
            }
        }
        ...
        static boolean a(long j10, int i10, int i11) {
            ...
            long j11 = f31145a[i11];
            if (j10 < j11) {
                return false;
            }
            return j10 > j11 || i10 > f31146b[i11];
        }
    }
    ...
    public static int compare(long j10, long j11) {
        return Longs.compare(a(j10), a(j11));
    }
    ...
    public static long decode(String str) {
        ...
        try {
            return parseUnsignedLong(parseRequestA.f31124a, parseRequestA.f31125b);
    ...
    public static long parseUnsignedLong(String str, int i10) {
        ...
        int i11 = ParseOverflowDetection.f31147c[i10] - 1;
        long j10 = 0;
        for (int i12 = 0; i12 < str.length(); i12++) {
            ...
            if (i12 > i11 && ParseOverflowDetection.a(j10, iDigit, i10)) {
