...
public final class UnsignedInteger extends Number implements Comparable<UnsignedInteger> {
    ...
    public UnsignedInteger dividedBy(UnsignedInteger unsignedInteger) {
        return fromIntBits(UnsignedInts.divide(this.f31141b, ((UnsignedInteger) Preconditions.checkNotNull(unsignedInteger)).f31141b));
    }
    ...
    public boolean equals(Object obj) {
        return (obj instanceof UnsignedInteger) && this.f31141b == ((UnsignedInteger) obj).f31141b;
    }
    ...
    public long longValue() {
        return UnsignedInts.toLong(this.f31141b);
    }

    public UnsignedInteger minus(UnsignedInteger unsignedInteger) {
        return fromIntBits(this.f31141b - ((UnsignedInteger) Preconditions.checkNotNull(unsignedInteger)).f31141b);
    }

    public UnsignedInteger mod(UnsignedInteger unsignedInteger) {
        return fromIntBits(UnsignedInts.remainder(this.f31141b, ((UnsignedInteger) Preconditions.checkNotNull(unsignedInteger)).f31141b));
    }
    ...
    public int compareTo(UnsignedInteger unsignedInteger) {
        ...
        return UnsignedInts.compare(this.f31141b, unsignedInteger.f31141b);
    }

    public String toString(int i10) {
        return UnsignedInts.toString(this.f31141b, i10);
    }
