...
public final class MutableClassToInstanceMap<B> extends ForwardingMap<Class<? extends B>, B> implements ClassToInstanceMap<B>, Serializable {
    ...
    private static final class SerializedForm<B> implements Serializable {
        ...
        Object readResolve() {
            return MutableClassToInstanceMap.create(this.f30095b);
        }
    }

    private MutableClassToInstanceMap(Map map) {
        this.f30091b = (Map) Preconditions.checkNotNull(map);
    }
    ...
    public static Map.Entry j(final Map.Entry entry) {
        return new ForwardingMapEntry<Class<Object>, Object>() { // from class: com.google.common.collect.MutableClassToInstanceMap.1
            ...
            public Object setValue(@ParametricNullness Object obj) {
                MutableClassToInstanceMap.i(getKey(), obj);
    ...
    public Set<Map.Entry<Class<? extends B>, B>> entrySet() {
        return new ForwardingSet<Map.Entry<Class<? extends B>, B>>() { // from class: com.google.common.collect.MutableClassToInstanceMap.2
            ...
            public Iterator<Map.Entry<Class<? extends B>, B>> iterator() {
                return new TransformedIterator<Map.Entry<Class<? extends B>, B>, Map.Entry<Class<? extends B>, B>>(n().iterator()) { // from class: com.google.common.collect.MutableClassToInstanceMap.2.1
            ...
            public Set n() {
                return MutableClassToInstanceMap.this.n().entrySet();
            }
    ...
    public <T extends B> T putInstance(Class<T> cls, @ParametricNullness T t10) {
        return (T) i(cls, put((Class<? extends T>) cls, t10));
    }
