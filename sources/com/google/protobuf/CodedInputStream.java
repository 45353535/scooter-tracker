...
public abstract class CodedInputStream {
        ...
        public int readRawVarint32() throws IOException {
            ...
            if (this.currentByteBufferLimit != j10) {
                ...
                if (this.currentByteBufferLimit - this.currentByteBufferPos >= 10) {
                    ...
                    if (i11 < 0) {
                        i10 = i11 ^ WorkInfo.STOP_REASON_FOREGROUND_SERVICE_TIMEOUT;
                    } else {
                        long j13 = 3 + j10;
                        int i12 = (UnsafeUtil.getByte(j12) << Ascii.SO) ^ i11;
                        if (i12 >= 0) {
                            i10 = i12 ^ 16256;
                        } else {
                            long j14 = 4 + j10;
                            ...
                            if (i13 < 0) {
                                ...
                                int i14 = (i13 ^ (b11 << Ascii.FS)) ^ 266354560;
                                if (b11 < 0) {
                                    j14 = 6 + j10;
        ...
        public long readRawVarint64() throws IOException {
            ...
            if (this.currentByteBufferLimit != j13) {
                ...
                if (this.currentByteBufferLimit - this.currentByteBufferPos >= 10) {
                    ...
                    if (i10 < 0) {
                        j10 = i10 ^ WorkInfo.STOP_REASON_FOREGROUND_SERVICE_TIMEOUT;
                    } else {
                        long j16 = 3 + j13;
                        int i11 = (UnsafeUtil.getByte(j15) << Ascii.SO) ^ i10;
                        if (i11 >= 0) {
                            j10 = i11 ^ 16256;
                            j15 = j16;
                        } else {
        ...
        public long readRawVarint64() throws IOException {
            ...
            if (this.limit != j13) {
                ...
                if (this.limit - j14 >= 9) {
                    ...
                    if (i11 >= 0) {
                        long j16 = 3 + j13;
                        int i12 = i11 ^ (UnsafeUtil.getByte(j15) << Ascii.SO);
                        if (i12 >= 0) {
                            j10 = i12 ^ 16256;
                            j15 = j16;
                        } else {
    ...
    static CodedInputStream newInstance(byte[] bArr, int i10, int i11, boolean z10) {
    ...
    static CodedInputStream newInstance(ByteBuffer byteBuffer, boolean z10) {
        if (byteBuffer.hasArray()) {
