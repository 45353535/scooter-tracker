...
public final class FieldDefs {
    ...
    private static class BitRangeFieldUtils {
        ...
        public static int calculateRangeLength(BitReader bitReader, int i10) {
    ...
    private interface LengthSupplier extends Function<BitReader, Integer> {
        ...
        /* JADX INFO: renamed from: com.iabtcf.utils.FieldDefs$LengthSupplier$-CC, reason: invalid class name */
        public abstract /* synthetic */ class CC {
            public static LengthSupplier a(final int i10) {
    ...
    private interface OffsetSupplier extends Function<BitReader, Integer> {
        ...
        /* JADX INFO: renamed from: com.iabtcf.utils.FieldDefs$OffsetSupplier$-CC, reason: invalid class name */
        public abstract /* synthetic */ class CC {
            static {
                OffsetSupplier offsetSupplier = OffsetSupplier.NOT_SUPPORTED;
            }

            public static OffsetSupplier a(final int i10) {
            ...
            public static OffsetSupplier b(final FieldDefs fieldDefs) {
            ...
            public static OffsetSupplier c(final FieldDefs fieldDefs) {
    ...
    private static class PublisherRestrictionUtils {
        ...
        public static int calculateBitRangelength(BitReader bitReader, int i10) {
            int bits12 = bitReader.readBits12(i10);
    ...
    static {
        ...
        V1_PPC_CUSTOM_PURPOSES_BITFIELD = new FieldDefs("V1_PPC_CUSTOM_PURPOSES_BITFIELD", 62, new LengthSupplier() { // from class: com.iabtcf.utils.FieldDefs.3
            ...
            @Override // java.util.function.Function
            public Integer apply(BitReader bitReader) {
                return Integer.valueOf(o0.a(bitReader.readBits6(FieldDefs.V1_PPC_NUMBER_CUSTOM_PURPOSES.getOffset(bitReader))));
            }
        });
        $VALUES = $values();
    }
    ...
    private FieldDefs(String str, int i10, int i11, FieldDefs fieldDefs) {
        ...
        this.length = LengthSupplier.CC.a(i11);
        this.offset = OffsetSupplier.CC.b(fieldDefs);
    }
    ...
    private FieldDefs(String str, int i10, int i11, int i12) {
        ...
        this.isDynamicInit = false;
        this.length = LengthSupplier.CC.a(i11);
        this.offset = OffsetSupplier.CC.a(i12);
    }
    ...
    private FieldDefs(String str, int i10, LengthSupplier lengthSupplier) {
        ...
        this.offset = OffsetSupplier.CC.c(this);
    }
