...
class TCStringV2 implements TCString {
    ...
    private int fillPublisherRestrictions(List<PublisherRestriction> list, int i10, BitReader bitReader) {
        ...
        for (int i11 = 0; i11 < bits12; i11++) {
            ...
            length = vendorIdsFromRange(this.bbv, bitSet, length2 + 2, (Optional<FieldDefs>) Optional.empty());
    ...
    static int vendorIdsFromRange(final BitReader bitReader, BitSet bitSet, int i10, Optional<FieldDefs> optional) {
        int bits12 = bitReader.readBits12(i10);
        int length = i10 + FieldDefs.NUM_ENTRIES.getLength(bitReader);
        Integer num = (Integer) optional.map(new Function() { // from class: com.iabtcf.decoder.b
            ...
            public final Object apply(Object obj) {
                return Integer.valueOf(bitReader.readBits16((FieldDefs) obj));
            }
        ...
        for (int i11 = 0; i11 < bits12; i11++) {
            ...
            int length2 = i12 + fieldDefs.getLength(bitReader);
            if (bits1) {
