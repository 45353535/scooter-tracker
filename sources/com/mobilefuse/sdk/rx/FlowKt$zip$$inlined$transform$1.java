...
public final class FlowKt$zip$$inlined$transform$1<R> extends Lambda implements Function1<FlowCollector<? super R>, Unit> {
    final /* synthetic */ Flow $other$inlined;
    final /* synthetic */ Flow $this_transform;
    final /* synthetic */ Function2 $transform$inlined;

    /* JADX INFO: renamed from: com.mobilefuse.sdk.rx.FlowKt$zip$$inlined$transform$1$1, reason: invalid class name */
    ...
    public static final class AnonymousClass1<T> implements FlowCollector {
        ...
        public final void emit(@NotNull Either<? extends Throwable, ? extends T> value) {
            ...
            if (!(value instanceof SuccessResult)) {
                ...
                FlowKt.flow(new Function1<FlowCollector<? super R>, Unit>() { // from class: com.mobilefuse.sdk.rx.FlowKt$zip$$inlined$transform$1$1$lambda$1
                    ...
                    public final void invoke(@NotNull final FlowCollector<? super R> flow2) {
                        ...
                        flow.collect(new FlowCollector() { // from class: com.mobilefuse.sdk.rx.FlowKt$zip$$inlined$transform$1$1$lambda$1.1
                            @Override // com.mobilefuse.sdk.rx.FlowCollector
