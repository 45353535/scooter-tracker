...
public final class AppLifecycleHelper$getActivityLifecycleCallbacks$1$onActivityResumed$$inlined$runnableTry$1 extends Lambda implements Function0<Unit> {
    ...
    public final void invoke2() {
        ...
        try {
            ...
            appLifecycleHelper.callActivityObservers(new Function1<AppLifecycleHelper.ActivityLifecycleObserver, Unit>() { // from class: com.mobilefuse.sdk.AppLifecycleHelper$getActivityLifecycleCallbacks$1$onActivityResumed$$inlined$runnableTry$1$lambda$1
                {
                    super(1);
                }
