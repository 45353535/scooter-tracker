...
public final class C2058Ef extends QC<EY> {
    public int A01;
    public final int A02;
    public final C18676g A05;
    ...
    public final Runnable A08 = new RunnableC2814dF(this);

    public C2058Ef(C2820dL c2820dL, List<String> screenshotUrls, int i10, C18676g c18676g, KE ke2, int i11) {
    ...
    public final EY A0F(ViewGroup viewGroup, int i10) {
        ...
        if (U7.A1C(this.A06)) {
            ew.setOnClickListener(new ViewOnClickListenerC2815dG(this));
        }
        return new EY(ew);
    }
    ...
    @Override // com.facebook.ads.redexgen.core.QC
    public final void A0L(C18676g c18676g) {
        super.A0L(c18676g);
