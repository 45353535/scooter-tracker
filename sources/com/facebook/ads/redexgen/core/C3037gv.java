...
public final class C3037gv implements SN {
    public long A00;
    ...
    public C3037gv(C2820dL c2820dL, InterstitialAd interstitialAd, String str) {
        this(c2820dL, interstitialAd, str, new C3052hB());
    }

    public C3037gv(C2820dL c2820dL, InterstitialAd interstitialAd, String str, TL tl) {
        this.A0A = c2820dL;
        this.A0B = str;
