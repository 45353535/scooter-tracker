...
public final class C2112Gh {
     ...
     */
    public final C2112Gh A0A(List<PictureFrame> list) {
        return new C2112Gh(this.A05, this.A03, this.A06, this.A04, this.A07, this.A02, this.A00, this.A09, this.A0A, A02(new Metadata(list)));
    }

    /* JADX WARN: Failed to parse debug info
    java.lang.ArrayIndexOutOfBoundsException
     */
    public final C2112Gh A0B(List<String> list) {
        return new C2112Gh(this.A05, this.A03, this.A06, this.A04, this.A07, this.A02, this.A00, this.A09, this.A0A, A02(H8.A02(list)));
    }
    ...
    public C2112Gh(int i10, int i11, int i12, int i13, int i14, int i15, int i16, long j10, C2111Gg c2111Gg, Metadata metadata) {
        this.A05 = i10;
        this.A03 = i11;
        this.A06 = i12;
        this.A04 = i13;
    ...
    public C2112Gh(byte[] bArr, int i10) {
    ...
    public final long A07(long j10) {
        long sampleNumber = AbstractC18094a.A0T((((long) this.A07) * j10) / 1000000, 0L, this.A09 - 1);
        return sampleNumber;
    }

    public final C3497or A08(byte[] bArr, Metadata metadata) {
    ...
    public final C2112Gh A09(C2111Gg c2111Gg) {
        return new C2112Gh(this.A05, this.A03, this.A06, this.A04, this.A07, this.A02, this.A00, this.A09, c2111Gg, this.A0B);
    }
}
