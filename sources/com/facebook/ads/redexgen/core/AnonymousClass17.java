...
public final class AnonymousClass17 extends AbstractC19379l {
    ...
    public static void A02() {
        byte[] bArr = {99, 108, 105, 96, 86, 119, 102, 87, 96, 100, 97, 74, 117, 96, 107, 111, 96, 101, 108, 90, 123, 106, 91, 108, 104, 109, 91, 72, 79, 47, 36, 35, 56, 113, 57, 48, 34, 113, 32, 36, 52, 35, 40, 113, 48, Utf8.REPLACEMENT_BYTE, 53, 126, 62, 35, 113, 55, 35, 48, 54, 60, 52, Utf8.REPLACEMENT_BYTE, 37, 125, 113, 38, 57, 56, 50, 57, 113, 48, 35, 52, 113, Utf8.REPLACEMENT_BYTE, 62, 37, 113, 34, 36, 33, 33, 62, 35, 37, 52, 53, Ascii.DEL, 113, Ascii.NAK, 56, 53, 113, 40, 62, 36, 113, 50, 48, 61, 61, 113, 4, 35, 56, Ascii.DEL, 33, 48, 35, 34, 52, 121, 120, 113, 62, Utf8.REPLACEMENT_BYTE, 113, 48, 113, 34, 37, 35, 56, Utf8.REPLACEMENT_BYTE, 54, 113, 50, 62, Utf8.REPLACEMENT_BYTE, 37, 48, 56, Utf8.REPLACEMENT_BYTE, 56, Utf8.REPLACEMENT_BYTE, 54, 113, 118, 110, 118, 113, 62, 35, 113, 118, 114, 118, 110, 113, 4, 34, 52, 113, 4, 35, 56, Ascii.DEL, 55, 35, 62, 60, Ascii.ETB, 56, 61, 52, 121, Utf8.REPLACEMENT_BYTE, 52, 38, 113, Ascii.ETB, 56, 61, 52, 121, 33, 48, 37, 57, 120, 120, 113, 37, 62, 113, 48, 39, 62, 56, 53, 113, 37, 57, 56, 34, Ascii.DEL, 113, 33, 48, 37, 57, 108, 116, 34, 125, 32, 36, 52, 35, 40, 108, 116, 34, 125, 55, 35, 48, 54, 60, 52, Utf8.REPLACEMENT_BYTE, 37, 108, 116, 34};
        String[] strArr = A05;
    ...
    public final long AFy(AnonymousClass56 anonymousClass56) throws C3426nf {
        C4S.A02(A01(0, 15, 71));
        ...
        try {
            try {
                ...
                C4S.A00();
                if (this.A00 < 0) {
                    throw new C3426nf(null, null, 2008);
                }
                this.A03 = true;
    ...
    public static RandomAccessFile A00(Uri uri) throws C3426nf {
        try {
            ...
            if (zIsEmpty && TextUtils.isEmpty(uri.getFragment())) {
                throw new C3426nf(e10, (AbstractC18094a.A02 < 21 || !AnonymousClass58.A00(e10.getCause())) ? 2005 : 2006);
            }
            throw new C3426nf(String.format(A01(30, 192, 19), uri.getPath(), uri.getQuery(), uri.getFragment()), e10, 1004);
        } catch (SecurityException e11) {
            throw new C3426nf(e11, 2006);
        } catch (RuntimeException e12) {
            throw new C3426nf(e12, 2000);
        }
    }
    ...
    */
    public final void close() throws com.facebook.ads.redexgen.core.C3426nf {
        /*
            r6 = this;
            r4 = 0
            r6.A01 = r4
    ...
    @MetaExoPlayerCustomization("FB tracing added in D4783963 for calls to TraceUtil.beginSection and TraceUtil.endSection")
    public final int read(byte[] bArr, int i10, int i11) throws C3426nf {
        if (i11 == 0) {
            return 0;
        }
        try {
            ...
            try {
                ...
                int i12 = ((RandomAccessFile) AbstractC18094a.A0f(this.A02)).read(bArr, i10, (int) Math.min(this.A00, i11));
                if (i12 > 0) {
                    this.A00 -= (long) i12;
                    A0F(i12);
                }
