...
public final class C18786r extends AbstractC3066hQ {
    ...
    public C18786r(C2820dL c2820dL, NT nt) {
        super(c2820dL, nt);
    }

    private C3058hH A00(Runnable runnable) {
        return new C3058hH(this, runnable);
    }

    @Override // com.facebook.ads.redexgen.core.AbstractC3066hQ
    public final void A0P() {
        AbstractC3103iA abstractC3103iA = (AbstractC3103iA) this.A01;
        abstractC3103iA.A00(this.A08.A00);
        abstractC3103iA.A01(this.A08.A01);
        abstractC3103iA.A0J();
    }
    ...
    public final void A0R(MP mp, TE te2, TC tc2, NU nu) {
        C7B c7b = (C7B) mp;
        C3059hJ c3059hJ = new C3059hJ(this, nu, c7b);
        if (U7.A2X(this.A0B)) {
            ...
            strArr2[5] = "";
            strArr2[2] = "";
            handlerA0H.postDelayed(c3059hJ, tfA05.A05());
        }
        c7b.A0K(this.A0B, A00(c3059hJ), nu, this.A08.A06, this.A08.A04, this.A08.A05);
    }

    public final void A0a(RewardData rewardData) {
        if (this.A01 != null) {
            if (this.A01.A8c() == AdPlacementType.REWARDED_VIDEO) {
                AbstractC3103iA rewardedVideoAdapter = (AbstractC3103iA) this.A01;
