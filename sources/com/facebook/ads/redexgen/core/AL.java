...
public final class AL<K, V> extends AbstractC3368mj<K, V> {
    ...
    public static final AbstractC3368mj<Object, Object> A04 = new AL(null, new Object[0], 0);
     ...
     */
    public static <K, V> AL<K, V> A00(int n10, Object[] alternatingKeysAndValues, C3366mh<K, V> builder) {
        Object obj;
        if (n10 == 0) {
            return (AL) A04;
        }
        if (n10 == 1) {
            AbstractC3309ll.A03(Objects.requireNonNull(alternatingKeysAndValues[0]), Objects.requireNonNull(alternatingKeysAndValues[1]));
            return new AL<>(null, alternatingKeysAndValues, 1);
        }
        AbstractC3162jA.A01(n10, alternatingKeysAndValues.length >> 1);
        Object objA02 = A02(alternatingKeysAndValues, n10, AbstractC1963Al.A03(n10), 0);
        if (objA02 instanceof Object[]) {
            Object[] objArr = (Object[]) objA02;
            C3365mg c3365mg = (C3365mg) objArr[2];
            if (builder == null) {
                throw c3365mg.A02();
            }
            builder.A01 = c3365mg;
        ...
        if (size == 1) {
            ...
            if (hashTableObject instanceof byte[]) {
                ...
                if (strArr2[4].charAt(30) != strArr2[2].charAt(30)) {
                    ...
                    int iA00 = AbstractC3353mU.A00(key.hashCode());
                    while (true) {
                        int i10 = iA00 & mask;
                        int i11 = bArr[i10];
                        String[] strArr4 = A03;
                ...
                int iA002 = AbstractC3353mU.A00(key.hashCode());
                while (true) {
                    int i12 = iA002 & mask2;
                ...
                int iA003 = AbstractC3353mU.A00(key.hashCode());
                while (true) {
                    int i13 = iA003 & mask3;
                    int h11 = iArr[i13];
                    if (h11 == -1) {
    ...
    public static Object A02(Object[] alternatingKeysAndValues, int n10, int tableSize, int keyOffset) {
        if (n10 == 1) {
            AbstractC3309ll.A03(Objects.requireNonNull(alternatingKeysAndValues[keyOffset]), Objects.requireNonNull(alternatingKeysAndValues[keyOffset ^ 1]));
            return null;
        }
        int h10 = tableSize - 1;
        C3365mg c3365mg = null;
        int i10 = -1;
        if (tableSize > 128) {
            if (tableSize <= 32768) {
                ...
                for (int i11 = 0; i11 < n10; i11++) {
                    ...
                    AbstractC3309ll.A03(value, objRequireNonNull);
                    int iA00 = AbstractC3353mU.A00(value.hashCode());
                    while (true) {
                        int i13 = iA00 & h10;
                        ...
                        if (i14 == 65535) {
                            ...
                            if (zEquals) {
                                c3365mg = new C3365mg(value, objRequireNonNull, Objects.requireNonNull(alternatingKeysAndValues[i14 ^ 1]));
                ...
                return keyIndex == n10 ? hashTable : new Object[]{hashTable, Integer.valueOf(keyIndex), c3365mg};
            }
            ...
            while (i16 < n10) {
                ...
                AbstractC3309ll.A03(objRequireNonNull2, objRequireNonNull3);
                int outKeyIndex = AbstractC3353mU.A00(objRequireNonNull2.hashCode());
                while (true) {
                    ...
                    if (i19 == i10) {
                        ...
                        if (objRequireNonNull2.equals(alternatingKeysAndValues[i19])) {
                            c3365mg = new C3365mg(objRequireNonNull2, objRequireNonNull3, Objects.requireNonNull(alternatingKeysAndValues[i19 ^ 1]));
            ...
            return i15 == n10 ? hashTable2 : new Object[]{hashTable2, Integer.valueOf(i15), c3365mg};
        }
        ...
        for (int i21 = 0; i21 < n10; i21++) {
            ...
            AbstractC3309ll.A03(objRequireNonNull4, objRequireNonNull5);
            int keyIndex2 = AbstractC3353mU.A00(objRequireNonNull4.hashCode());
            while (true) {
                ...
                if (previousKeyIndex == 255) {
                    ...
                    if (objRequireNonNull4.equals(alternatingKeysAndValues[previousKeyIndex])) {
                        c3365mg = new C3365mg(objRequireNonNull4, objRequireNonNull5, Objects.requireNonNull(alternatingKeysAndValues[previousKeyIndex ^ 1]));
        ...
        return i20 == n10 ? bArr : new Object[]{bArr, Integer.valueOf(i20), c3365mg};
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.AL != com.google.common.collect.RegularImmutableMap<K, V> */
    @Override // com.facebook.ads.redexgen.core.AbstractC3368mj
    public final AbstractC3359ma<V> A0A() {
        return new C1X(this.A00, 1, this.A01);
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.AL != com.google.common.collect.RegularImmutableMap<K, V> */
    @Override // com.facebook.ads.redexgen.core.AbstractC3368mj
    public final AbstractC1963Al<Map.Entry<K, V>> A0D() {
    ...
    @Override // com.facebook.ads.redexgen.core.AbstractC3368mj
    public final AbstractC1963Al<K> A0E() {
        final C1X c1x = new C1X(this.A00, 0, this.A01);
        return new AbstractC1963Al<K>(this, c1x) { // from class: com.facebook.ads.redexgen.X.1Y
            public final transient AbstractC1964Am<K> A00;
            public final transient AbstractC3368mj<K, ?> A01;
            ...
            /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.1Y != com.google.common.collect.RegularImmutableMap$KeySet<K> */
            @Override // com.facebook.ads.redexgen.core.AbstractC1963Al, com.facebook.ads.redexgen.core.AbstractC3359ma
            public final AbstractC1964Am<K> A0J() {
                return this.A00;
            }
            ...
            public final AbstractC3531pg<K> iterator() {
                return A0J().iterator();
            }

            /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.1Y != com.google.common.collect.RegularImmutableMap$KeySet<K> */
            @Override // com.facebook.ads.redexgen.core.AbstractC3359ma, java.util.AbstractCollection, java.util.Collection, java.util.Set
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.AL != com.google.common.collect.RegularImmutableMap<K, V> */
    @Override // com.facebook.ads.redexgen.core.AbstractC3368mj, java.util.Map
    @CheckForNull
