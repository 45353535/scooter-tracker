...
public class C6G extends C2999gH {
    ...
    public final int A0O(View view, int i10) {
        ...
        int iA0N = A0N(qoA08.A0m(view) - qp.leftMargin, qoA08.A0p(view) + qp.rightMargin, qoA08.A0g(), qoA08.A0j() - qoA08.A0h(), i10) + this.A00.A02;
        if (A01[0].length() != 6) {
    ...
    public C6G(C6F c6f, C2820dL c2820dL) {
        super(c2820dL);
        this.A00 = c6f;
    }
