...
public final class C5K extends FrameLayout implements InterfaceC2552Xo, I3 {
    ...
    public R0 A00;
    public R6 A01;
    public InterfaceC2738c0 A02;
    public boolean A03;
    public boolean A04;
    public boolean A05;
    public final AbstractC3095hy A06;
    public final C2820dL A07;
    public final US A08;
    public final C2463Ua A09;
    public final XC A0A;
    public final XH A0B;
    public final InterfaceC2551Xn A0C;
    public final YY A0D;
    public final C2723bl A0E;
    public final C2731bt A0F;
    public final AbstractC2892eW A0G;
    public final C2893eX A0H;
    ...
    public C5K(C2820dL c2820dL, US us, InterfaceC2551Xn interfaceC2551Xn, AbstractC3095hy abstractC3095hy, YY yy, int i10) {
        super(c2820dL);
        this.A01 = new C2164Ii(this);
        this.A0G = new C2163Ih(this);
        this.A03 = true;
        this.A07 = c2820dL;
        this.A08 = us;
        this.A0C = interfaceC2551Xn;
        this.A06 = abstractC3095hy;
        this.A0D = yy;
        C2731bt c2731btA02 = AbstractC2732bu.A02(abstractC3095hy.A17());
        if (c2731btA02 == null) {
            this.A0F = new C2731bt(this.A07, abstractC3095hy, us, i10);
            this.A04 = false;
        } else {
            this.A0F = c2731btA02;
            this.A04 = true;
        ...
        this.A0F.A0c(new C2159Id(this));
        XP.A0E(1003, this.A0F.A0O());
        if (this.A06.A1P()) {
            this.A0E = new C2723bl(this.A07, this.A08, this.A06, new SF(this.A07), this.A09, this.A0C, this.A0D, new C2157Ib(this));
            this.A0E.A0N();
            this.A0F.A0O().setOnTouchListener(new ViewOnTouchListenerC2719bh(this));
            addView(this.A0E, new FrameLayout.LayoutParams(-1, -1));
        } else {
            this.A0E = null;
        }
        ViewGroup mediaView = getMediaView();
        this.A0H = new C2893eX(mediaView, 1, new WeakReference(this.A0G), this.A07);
        ...
        if (U7.A1u(c2820dL)) {
            c2820dL.A0B().AK4(mediaView, abstractC3095hy.A25(), false, false, true);
        }
        try {
            JSONObject jSONObject = new JSONObject();
            boolean zA2C = abstractC3095hy.A2C();
            ...
            } else if (WR.A05(abstractC3095hy.A0u())) {
                jSONObject.put(strA0B4, true);
                jSONObject.put(strA0B3, 2);
            ...
            this.A0F.A0M().A04(AbstractC2433Sv.A15, A0B(0, 26, 113));
        }
    }

    private void A0C() {
        C2771cX c2771cXA0F = new C2769cV(this.A07, this.A06.A20().A0I(), this.A06.A23()).A0A(this.A06.A1z().A01()).A0F();
        addView(c2771cXA0F, new FrameLayout.LayoutParams(-1, -1));
        c2771cXA0F.A04(new IW(this));
    }
    ...
    public final void A9c() {
        ...
        C2817dI serverSideRewardHandler = new C2817dI(this.A07, this.A0D, this.A06.A1A(), this.A0C);
        serverSideRewardHandler.A05();
    }

    @Override // com.facebook.ads.redexgen.core.I3
    public final void AAd() {
        new Handler(Looper.getMainLooper()).post(new C2156Ia(this));
    }
    ...
    public final void onDestroy() {
        ...
        this.A0A.A03();
        this.A08.AAt(this.A06.A25(), new C2605Zp().A02(this.A0B).A03(this.A0H).A05());
        this.A01 = null;
        this.A02 = null;
        this.A00 = null;
        AbstractC2732bu.A04(this.A06.A17());
        C2731bt.A0B().decrementAndGet();
    }
    ...
    public void setRtfActionsJavascriptListener(InterfaceC2738c0 interfaceC2738c0) {
        this.A02 = interfaceC2738c0;
    }
}
