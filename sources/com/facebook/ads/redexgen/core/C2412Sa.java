...
public final class C2412Sa extends SQLiteOpenHelper {
    ...
    public static void A02() {
        A01 = new byte[]{-105, 101, -119, -118, -117, -122, -102, -111, -103, 101, 117, 0, Ascii.VT, 19, 4, 17, -33, 19, 0, 1, Ascii.VT, 4, -33, 36, 53, 36, 45, 51, 50, -33, 0, 3, 3, -33, 2, Ascii.SO, Ascii.VT, Ascii.DC4, Ascii.FF, 13, -33, -122, -87, -119, -90, -71, -90, -89, -90, -72, -86, -115, -86, -79, -75, -86, -73, 101, -88, -90, -77, 101, -77, -76, -71, 101, -89, -86, 101, -77, -70, -79, -79, -16, -2, -5, -4, -52, 0, -19, -18, -8, -15, -52, -11, -14, -52, -15, 4, -11, -1, 0, -1, -52, Ascii.SI, Ascii.RS, 13, Ascii.US, Ascii.DC4, 17, Ascii.US, -10, -8, -25, -19, -13, -25, -58, Ascii.FF, Ascii.NAK, Ascii.CAN, Ascii.VT, Ascii.SI, 13, Ascii.DC4, 5, 17, Ascii.VT, Ascii.US, Ascii.EM, -58, -29, -58, -11, -12, -31, -51, -48, -33, -111, -33, -102, -48, -50};
        if (A02[7].length() == 23) {
    ...
    static {
        A02();
        A03 = C2412Sa.class.getSimpleName();
    }

    public C2412Sa(C2794cu c2794cu, SZ sz) {
        super(c2794cu, A01(c2794cu), (SQLiteDatabase.CursorFactory) null, 4);
        if (sz != null) {
            this.A00 = sz;
            return;
        }
    ...
    public static String A01(C2794cu c2794cu) {
        ...
        String defaultDbName = c2794cu.getPackageName();
        String processName = ProcessUtils.getProcessName(c2794cu);
    ...
    public final void onCreate(SQLiteDatabase sQLiteDatabase) {
        for (AbstractC2415Sd abstractC2415Sd : this.A00.A0M()) {
            abstractC2415Sd.A07(sQLiteDatabase);
        }
    }
    ...
    public final void onDowngrade(SQLiteDatabase sQLiteDatabase, int i10, int i11) {
        for (AbstractC2415Sd abstractC2415Sd : this.A00.A0M()) {
            abstractC2415Sd.A08(sQLiteDatabase);
            abstractC2415Sd.A07(sQLiteDatabase);
        }
    }
