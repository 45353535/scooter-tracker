...
public class C2979fw implements InterfaceC2551Xn {
    ...
    public C2979fw(R0 r02) {
        this.A00 = new WeakReference<>(r02);
    }

    private void A00(R0 r02) {
        C2796cw c2796cwA07 = r02.A07();
        if (c2796cwA07 != null && r02.A04() != null) {
            r02.A04().bringChildToFront(c2796cwA07);
        }
    }
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2551Xn
    public void A4c(String str, C2441Td c2441Td) {
        if (this.A00.get() != null) {
            this.A00.get().A0E(str, c2441Td);
        }
    }
