...
public enum EnumC3096i2 {
    ...
    public static EnumC3096i2[] valuesCustom() {
        EnumC3096i2[] enumC3096i2Arr = (EnumC3096i2[]) values().clone();
        String[] strArr = A01;
        if (strArr[5].charAt(20) == strArr[4].charAt(20)) {
            throw new RuntimeException();
        }
        A01[3] = "UcBpUNe8sR";
        return enumC3096i2Arr;
    }
}
