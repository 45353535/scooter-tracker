...
public final class ZH extends LinearLayout {
    ...
    public static void A0A() {
        byte[] bArr = {-43, -12, -10, -2, -68, -27, -24, -20, -34, 0, 41, 44, 49, Ascii.ESC, 44, Ascii.RS, Ascii.ETB, 56, 45, 54, -24, 54, 41, 60, 49, 62, 45, -24, 42, 58, 55, Utf8.REPLACEMENT_BYTE, 59, 45, 58, 41, 42, 55, 61, 60, 2, 42, 52, 41, 54, 51, 55, 68, 58, 72, 69, Utf8.REPLACEMENT_BYTE, 58, 4, Utf8.REPLACEMENT_BYTE, 68, 74, 59, 68, 74, 4, 55, 57, 74, Utf8.REPLACEMENT_BYTE, 69, 68, 4, 44, Ascii.US, Ascii.ESC, 45, -29, -17, -19, -82, -31, -18, -28, -14, -17, -23, -28, -82, -29, -24, -14, -17, -19, -27, 59, 71, 71, 67, 13, 2, 2, 74, 74, 74, 1, 57, 52, 54, 56, 53, 66, 66, 62, 1, 54, 66, SignedBytes.MAX_POWER_OF_TWO};
        String[] strArr = A0E;
    ...
    static {
        ...
        A0F = (int) (AbstractC2523Wl.A02 * 16.0f);
        A0I = WQ.A00(A06(90, 23, 118));
        A0J = new ZB();
    }

    public ZH(C2820dL c2820dL, WebView webView, boolean z10) {
        super(c2820dL);
        this.A07 = getResources().getDisplayMetrics().density;
        this.A0A = new LR(this);
        this.A08 = webView;
        this.A09 = c2820dL;
        this.A0B = U8.A06(c2820dL);
        this.A0C = z10;
        A08();
        A0C(false);
    }
