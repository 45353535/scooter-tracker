...
public final class JT {
    ...
    public void A02(C4J c4j, int i10) {
        ...
        for (int index = 0; index < i11; index++) {
            ...
            int iA0I3 = c4j.A0I();
            int iA0I4 = c4j.A0I();
            int entryCount = iA0I2 + WorkInfo.STOP_REASON_FOREGROUND_SERVICE_TIMEOUT;
            int i12 = (int) (((double) a10) + (((double) entryCount) * 1.402d));
            int g10 = (int) ((((double) a10) - (((double) (iA0I3 + WorkInfo.STOP_REASON_FOREGROUND_SERVICE_TIMEOUT)) * 0.34414d)) - (((double) (iA0I2 + WorkInfo.STOP_REASON_FOREGROUND_SERVICE_TIMEOUT)) * 0.71414d));
            int entryCount2 = iA0I4 << 24;
            this.A08[iA0I] = entryCount2 | (AbstractC18094a.A07(i12, 0, 255) << 16) | (AbstractC18094a.A07(g10, 0, 255) << 8) | AbstractC18094a.A07((int) (((double) a10) + (((double) (iA0I3 + WorkInfo.STOP_REASON_FOREGROUND_SERVICE_TIMEOUT)) * 1.772d)), 0, 255);
        }
        this.A06 = true;
    }

    public final C3448o2 A06() {
        int iA0I;
