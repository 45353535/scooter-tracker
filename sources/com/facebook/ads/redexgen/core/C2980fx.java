...
public final class C2980fx extends R8 implements AdOptionsViewApi {
    ...
    static {
        A02();
        A08 = (int) (AbstractC2523Wl.A02 * 23.0f);
        A09 = (int) (AbstractC2523Wl.A02 * 4.0f);
    }

    public C2980fx(Context context, NativeAdBase nativeAdBase, NativeAdLayout nativeAdLayout, AdOptionsView.Orientation orientation, int i10, AdOptionsView adOptionsView) {
        this.A02 = false;
        this.A01 = false;
        this.A00 = false;
        ...
        C2363Qc c2363QcA0L = C2363Qc.A0L(nativeAdBase.getInternalNativeAd());
        c2363QcA0L.A1V(nativeAdLayout);
        c2363QcA0L.A1X(this);
        C3116iN c3116iNA0z = c2363QcA0L.A0z();
        if (c3116iNA0z != null && c3116iNA0z.A0R() && !c3116iNA0z.A0P()) {
            linearLayout.setVisibility(8);
        } else {
            linearLayout.setOnClickListener(new ViewOnClickListenerC2384Qx(this, c2363QcA0L, context, linearLayout));
            EnumC2528Wq.A04(this.A05, EnumC2528Wq.A0C);
        }
    }

    public C2980fx(Context context, NativeAdBase nativeAdBase, NativeAdLayout nativeAdLayout, AdOptionsView adOptionsView) {
    ...
    public final void setIconSizeDp(int i10) {
        int iconSize = Math.max(A08, (int) (AbstractC2523Wl.A02 * i10));
