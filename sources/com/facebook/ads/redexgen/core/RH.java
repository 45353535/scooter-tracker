...
public final class RH implements MediaViewVideoRendererApi {
    ...
    public final DP A0C = new DP() { // from class: com.facebook.ads.redexgen.X.6d
        ...
        public final void A03(DQ dq) {
            if (this.A00.A08 != null) {
                C2363Qc.A0L(this.A00.A08.getInternalNativeAd()).A1f(true, true);
            }
    ...
    public final DV A0A = new DV() { // from class: com.facebook.ads.redexgen.X.6T
        ...
        public final void A03(DW dw) {
            if (this.A00.A08 != null) {
                C2363Qc.A0L(this.A00.A08.getInternalNativeAd()).A1f(false, true);
            }
    ...
    public final void A03() {
        ...
        if (this.A08 != null) {
            C2363Qc.A0L(this.A08.getInternalNativeAd()).A1f(false, false);
        }
        this.A08 = null;
        if (this.A04 != null) {
            InterfaceC2475Um interfaceC2475Um = this.A04;
            if (A0H[6].length() != 3) {
                throw new RuntimeException();
            }
            A0H[6] = "qaG";
            interfaceC2475Um.AJn();
        }
    }

    public final void A04(NativeAd nativeAd) {
        this.A08 = nativeAd;
        C2820dL c2820dLA12 = ((C2363Qc) nativeAd.getInternalNativeAd()).A12();
        C2820dL adObjectContext = this.A03;
        adObjectContext.A0L(c2820dLA12);
        RK rk = (RK) nativeAd.getNativeAdApi();
        this.A05.setClientToken(C2363Qc.A0L(nativeAd.getInternalNativeAd()).A1C());
        this.A05.setVideoMPD(rk.A01());
        this.A05.setVideoURI(rk.A02());
        C3116iN c3116iNA0z = C2363Qc.A0L(nativeAd.getInternalNativeAd()).A0z();
        if (c3116iNA0z != null) {
            this.A05.setVideoProgressReportIntervalMs(c3116iNA0z.A0B());
        }
    ...
    public final void A06(InterfaceC2475Um interfaceC2475Um) {
        this.A04 = interfaceC2475Um;
    }
    ...
    public final void engageSeek() {
        if (this.A06) {
            ...
            this.A06 = true;
            this.A07 = EnumC2890eU.A0A.equals(this.A05.getState());
    ...
    public final void initialize(AdViewConstructorParams adViewConstructorParams, MediaViewVideoRenderer mediaViewVideoRenderer) {
        ...
        if (context instanceof C2820dL) {
            c2820dLA03 = (C2820dL) context;
        } else {
            c2820dLA03 = RB.A03(context);
        }
        this.A03 = c2820dLA03;
        switch (adViewConstructorParams.getInitializationType()) {
            case 0:
                this.A05 = new AnonymousClass64(c2820dLA03);
                break;
            case 1:
                this.A05 = new AnonymousClass64(c2820dLA03, adViewConstructorParams.getAttributeSet());
                break;
            case 2:
                this.A05 = new AnonymousClass64(c2820dLA03, adViewConstructorParams.getAttributeSet(), adViewConstructorParams.getDefStyleAttr());
                break;
            case 3:
                this.A05 = new AnonymousClass64(c2820dLA03, adViewConstructorParams.getAttributeSet(), adViewConstructorParams.getDefStyleRes());
                break;
            default:
    ...
    public final boolean shouldAutoplay() {
        if (this.A05 == null || this.A05.getState() == EnumC2890eU.A06) {
            return false;
        }
