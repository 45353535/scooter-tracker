...
public class C9P {
    ...
    public C9P(CopyOnWriteArrayList<DrmSessionEventListener.EventDispatcher.ListenerAndHandler> listenerAndHandlers, int i10, C3344mL c3344mL) {
        this.A02 = listenerAndHandlers;
        this.A00 = i10;
        this.A01 = c3344mL;
    }

    public final C9P A00(int i10, C3344mL c3344mL) {
        return new C9P(this.A02, i10, c3344mL);
    }
}
