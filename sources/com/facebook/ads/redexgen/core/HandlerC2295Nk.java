...
public final class HandlerC2295Nk extends Handler {
    ...
    public InterfaceC2533Wv A01;
    public boolean A02;
    public final ServiceConnection A03;
    public final Handler A04;
    public final Messenger A05;
    public final LH A06;
    public final C2794cu A07;
    public final AbstractRunnableC2507Vt A08;
    ...
    public HandlerC2295Nk(C2794cu c2794cu) {
        super(Looper.getMainLooper());
        this.A04 = new Handler(Looper.getMainLooper());
        this.A03 = new ServiceConnectionC2294Nj(this);
        this.A07 = c2794cu;
        this.A05 = new Messenger(this);
        LL funnelModule = c2794cu.A00(c2794cu);
        if (funnelModule != null) {
            this.A06 = funnelModule.ABn();
        } else {
            this.A06 = new C3156j3();
        }
        this.A08 = new C3031gp(this);
    }
    ...
    public void A07(Messenger messenger) {
        ...
        messageObtain.setData(AbstractC2304Nt.A00(this.A07));
        try {
    ...
    public final void A0A(String str, InterfaceC2533Wv interfaceC2533Wv, int i10) {
        if (this.A02) {
            this.A06.AHd(i10);
            this.A01 = interfaceC2533Wv;
    ...
    public final void A0B(boolean z10) {
        this.A06.AHa();
        this.A02 = C2293Ni.A04(this.A07, z10, this.A03);
        if (this.A02) {
