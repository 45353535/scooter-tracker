...
public final class AnonymousClass95 implements InterfaceC3236kN {
    ...
    public final C18967j A03 = new C18967j();
    public final Deque<AbstractC18957i> A04 = new ArrayDeque();

    public AnonymousClass95() {
        for (int i10 = 0; i10 < 2; i10++) {
            this.A04.addFirst(new AbstractC18957i() { // from class: com.facebook.ads.redexgen.X.10
    ...
    public final C18967j A5j() throws C3235kM {
        C3M.A08(!this.A01);
        if (this.A00 != 0) {
            return null;
        }
    ...
    public final AbstractC18957i A5l() throws C3235kM {
        ...
        AbstractC18957i abstractC18957iRemoveFirst = this.A04.removeFirst();
        if (this.A03.A05()) {
            String[] strArr = A05;
            ...
            abstractC18957iRemoveFirst.A00(4);
        } else {
            abstractC18957iRemoveFirst.A0C(this.A03.A01, new C3331m7(this.A03.A01, this.A02.A02(((ByteBuffer) C3M.A01(this.A03.A02)).array())), 0L);
        }
        this.A03.A0A();
        this.A00 = 0;
        return abstractC18957iRemoveFirst;
    }

    /* JADX INFO: Access modifiers changed from: private */
    @Override // com.facebook.ads.redexgen.core.C5O
    /* JADX INFO: renamed from: A03, reason: merged with bridge method [inline-methods] */
    public final void AGZ(C18967j c18967j) throws C3235kM {
        C3M.A08(!this.A01);
        C3M.A08(this.A00 == 1);
        C3M.A07(this.A03 == c18967j);
        this.A00 = 2;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A04(AbstractC18957i abstractC18957i) {
        C3M.A08(this.A04.size() < 2);
        C3M.A07(!this.A04.contains(abstractC18957i));
        abstractC18957i.A0A();
        this.A04.addFirst(abstractC18957i);
    }
