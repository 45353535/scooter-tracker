...
public final class C3167jF implements L9 {
    ...
    */
    private java.net.HttpURLConnection A02(int r9, int r10) throws java.io.IOException, com.facebook.ads.redexgen.core.C3171jJ {
        /*
            Method dump skipped, instruction units count: 295
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C3167jF.A02(int, int):java.net.HttpURLConnection");
    }

    private void A03() throws C3171jJ {
    ...
    private final void A05(int i10, int i11) throws C3171jJ {
        try {
            ...
            throw new C3171jJ(A01(154, 29, 90) + this.A03 + A01(19, 13, 66) + i10, e10);
        }
    }
    ...
    public final void AFz(int i10) throws C3171jJ {
        A05(i10, this.A00);
    }

    @Override // com.facebook.ads.redexgen.core.L9
    public final void close() throws C3171jJ {
        if (this.A02 != null) {
            try {
                this.A02.disconnect();
            } catch (NullPointerException e10) {
                throw new C3171jJ(A01(92, 37, 89), e10);
            }
        }
    }

    @Override // com.facebook.ads.redexgen.core.L9
    public final synchronized int length() throws C3171jJ {
    ...
    @Override // com.facebook.ads.redexgen.core.L9
    public final int read(byte[] bArr) throws C3171jJ {
        ...
        if (inputStream != null) {
            try {
                ...
                final String str = A01(POBCoreNativeConstants.POB_NATIVE_MAIN_IMG_W, 15, 60) + this.A03 + A01(0, 15, 15);
                throw new C3171jJ(str, e10) { // from class: com.facebook.ads.redexgen.X.7e
                };
            } catch (IOException e11) {
                throw new C3171jJ(strA01 + this.A03, e11);
            }
        }
        throw new C3171jJ(strA01 + this.A03 + A01(51, 23, 42));
    }
