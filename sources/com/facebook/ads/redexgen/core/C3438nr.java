...
public final class C3438nr implements C3T {
    @Override // com.facebook.ads.redexgen.core.C3T
    public final C3436np A5H(Looper looper, Handler.Callback callback) {
        return new C3436np(new Handler(looper, callback));
    }
