...
public final class C18224n extends AbstractC2147Hr {
    ...
    public final C2820dL A0H;
    public final C2463Ua A0I;
    public final AbstractC2550Xm A0J;
    public final AbstractC2611Zv A0K;
    public final KE A0L;
    public final InterfaceC2767cT A0M;
    public final C2804d4 A0N;
    public final EG A0O;
    public final E1 A0P;
    public final C17913i A0Q;
    public final DX A0R;
    public final DV A0S;
    public final DR A0T;
    public final DP A0U;
    ...
    static {
        A0J();
        A0k = (int) (AbstractC2523Wl.A02 * 48.0f);
        A0i = OP.A02(-1, 77);
        ...
        A0g = (int) (AbstractC2523Wl.A03 * 32.0f);
        A0d = (int) (AbstractC2523Wl.A02 * 12.0f);
        A0e = (int) (AbstractC2523Wl.A02 * 16.0f);
        A0f = (int) (AbstractC2523Wl.A02 * 48.0f);
    }

    public C18224n(C2820dL c2820dL, US us, AbstractC3095hy abstractC3095hy, SF sf2, YY yy, int i10, InterfaceC2551Xn interfaceC2551Xn, C2463Ua c2463Ua, AbstractC2550Xm abstractC2550Xm, int i11, int customVideoDurationMs, int i12, boolean z10, int i13, boolean z11, boolean z12, boolean z13, InterfaceC2767cT interfaceC2767cT, int i14, int i15) {
        C2283My c2283MyA00;
        super(c2820dL, yy, us, abstractC3095hy, i10, z12, z13, interfaceC2551Xn, i15);
        ...
        this.A0V = new DN() { // from class: com.facebook.ads.redexgen.X.4y
            ...
            public final void A03(DO r11) {
                ...
                if (this.A00.getAdDataBundle().A1U()) {
                    this.A00.A0H.A0F().AJw(AbstractC2514Wa.A00((float) ((AbstractC2147Hr) this.A00).A06.A0h()), this.A00.getResources().getConfiguration().orientation, true, true, MH.A0C(MI.A00(this.A00.A0H, ((AbstractC2147Hr) this.A00).A08, "", WQ.A00(((AbstractC2147Hr) this.A00).A06.A20().A0J().A05()), new HashMap(), ((AbstractC2147Hr) this.A00).A06.A21())));
                ...
                if (this.A00.getAdDataBundle().A1W()) {
                    ...
                    c18224n.A0Y.setOnClickListener(this.A00.A0L);
                }
            }
        };
        this.A0U = new DP() { // from class: com.facebook.ads.redexgen.X.4x
            ...
            public final void A03(DQ dq) {
                if (!((AbstractC2147Hr) this.A00).A0A.A07()) {
                    this.A00.A1C();
                }
            }
        };
        this.A0T = new DR() { // from class: com.facebook.ads.redexgen.X.4s
            @Override // com.facebook.ads.redexgen.core.AbstractC2443Tf
            public final /* bridge */ /* synthetic */ void A03(C2441Td c2441Td) {
            }
        };
        ...
        this.A0R = new DX() { // from class: com.facebook.ads.redexgen.X.4q
            ...
            public final void A03(C17863d c17863d) {
                ...
                if (this.A00.A00 < ((AbstractC2147Hr) this.A00).A06.A20().A0G()) {
                    C18224n.A01(this.A00, 1.0f);
                    this.A00.A0P.A0h(EnumC2836db.A02, 28);
                    return;
                }
                C18224n c18224n = this.A00;
                String[] strArr = A01;
        ...
        this.A0S = new C18244p(this);
        this.A0H = c2820dL;
        this.A0I = c2463Ua;
        this.A0J = abstractC2550Xm;
        this.A0E = i14;
        int i16 = -1;
        if (!super.A06.A1U()) {
            this.A0G = new D1(this.A0H, c2463Ua);
        } else {
            i16 = i14;
            this.A0G = new D0(this.A0H, c2463Ua);
        }
        this.A0Y = new C2023Cw(this.A0H, i16);
        if (this.A00 < abstractC3095hy.A20().A0G()) {
        ...
        this.A0M = interfaceC2767cT;
        this.A0A = i12;
        this.A0Z = z10;
        this.A0N = new C2804d4(this.A0H, us, super.A06);
        if (customVideoDurationMs == 1) {
            c2283MyA00 = super.A06.A1z().A01();
        } else {
            c2283MyA00 = super.A06.A1z().A00();
        }
        this.A01 = c2283MyA00;
        this.A0P = new E1(this.A0H);
        this.A0P.getEventBus().A03(this.A0V, this.A0U, this.A0T, this.A0W, this.A0R, this.A0S);
        this.A0Q = new C17913i(c2820dL, us, this.A0P, abstractC3095hy.A25(), 0, 0, abstractC3095hy.A20().A0U(), null, null);
        A0I();
        this.A0P.setVideoURI(sf2.A0T(super.A06.A20().A0H().A09()));
        A0H();
        C2518Wg c2518WgA02 = super.A09.A02(abstractC3095hy);
        this.A0H.A0H().A00(c2518WgA02.A01);
        this.A0K = A06();
        if (this.A0K instanceof C2206Jy) {
            new CU(this.A0K, 400, 100, 0).A42(true, false);
        } else {
            this.A0K.setVisibility(8);
        }
        this.A0X = new D9(true, abstractC3095hy.A20().A0U());
        A0K();
        ...
        if (U7.A1v(this.A0H)) {
            this.A0O = new EG(this.A0H, us, this.A0P, super.A06.A25(), abstractC3095hy.A20().A0U(), this.A0Q, null);
        } else {
            this.A0O = null;
        }
    }

    public static /* synthetic */ float A01(C18224n c18224n, float f10) {
        float f11 = c18224n.A00 + f10;
        c18224n.A00 = f11;
        return f11;
    }

    private AbstractC2611Zv A06() {
        String strA0C;
        AbstractC2611Zv c2206Jy;
        ...
        if (getAdDataBundle().A1U()) {
            if (E1.A0T((float) dA0h)) {
                c2206Jy = new C18515q(this.A0H, this.A0L, AbstractC2147Hr.A0G, false, getColors(), strA0C, super.A08, super.A0B, super.A0D, super.A0A, super.A06, this.A0Y, this.A0I, false);
            } else {
                if (A0c[1].charAt(3) != 'F') {
                    throw new RuntimeException();
                }
                ...
                if (E1.A0V((float) dA0h)) {
                    c2206Jy = new C18505p(this.A0H, this.A0L, AbstractC2147Hr.A0G, false, getColors(), strA0C, super.A08, super.A0B, super.A0D, super.A0A, super.A06, this.A0Y, this.A0I, false);
                } else {
                    c2206Jy = new C18525r(this.A0H, this.A0L, AbstractC2147Hr.A0G, false, getColors(), strA0C, super.A08, super.A0B, super.A0D, super.A0A, super.A06, this.A0Y, this.A0I, false);
                }
            }
            ((KL) c2206Jy).setChainedAdInfo(super.A00);
        } else {
            c2206Jy = new C2206Jy(this.A0H, null, A0k, super.A06.A20().A0I().A00() == EnumC2279Mu.A05, getColors(), super.A06.A20().A0J().A06(), strA0C, super.A08, super.A0B, super.A0D, super.A0A, super.A06);
        }
        c2206Jy.getCTAButton().getCtaActionHelper().A08(super.A06);
        c2206Jy.getCTAButton().setCreativeAsCtaLoggingHelper(super.A09);
        XP.A0E(1008, c2206Jy);
        c2206Jy.A0h(this.A0D);
        addView(c2206Jy, adDetailsParams);
        c2206Jy.setInfo(super.A06.A20().A0I(), super.A06.A20().A0J(), super.A06.A25(), super.A06.A23().A01(), null, null);
        return c2206Jy;
    }
    ...
    private void A0E() {
        if (getAdDataBundle().A20().A0K().A03() && !getAdDataBundle().A20().A0K().A02().isEmpty()) {
            ...
            this.A03 = new C2810dA(this.A0H, getAdDataBundle(), super.A0B, this.A0L, this.A0F, this.A0I);
            A0D();
        } else {
            if (getAdDataBundle().A20().A0K().A04() || getAdDataBundle().A20().A0K().A03()) {
                XP.A0Z(this.A0K, this.A0G, this.A0L);
                C2670au c2670au = new C2670au(this.A0H, super.A06, this.A0I, this.A0F, super.A0B);
                c2670au.A0D(false);
                addView(c2670au.A09(this.A0L));
                return;
            }
            Pair<EnumC2803d3, View> pairA03 = this.A0N.A03(this.A0L);
            View endCardView = (View) pairA03.second;
            XP.A0E(EventTypeExtended.EVENT_TYPE_CLICK_BY_SOURCE_VALUE, endCardView);
            A0P((EnumC2803d3) pairA03.first, endCardView);
        }
    }
    ...
    private void A0G() {
        ...
        if (!super.A06.A1U()) {
            ...
            layoutParams.setMargins(0, AbstractC2550Xm.A00, A0l, 0);
    ...
    private void A0I() {
        ...
        if (this.A0G instanceof InterfaceC2837dc) {
            this.A0P.A0i((InterfaceC2837dc) this.A0G);
        }
        if (!TextUtils.isEmpty(super.A06.A20().A0H().A08())) {
            C17722p c17722p = new C17722p(this.A0H);
            this.A0P.A0i(c17722p);
            c17722p.setImage(super.A06.A20().A0H().A08());
        }
    ...
    private final void A0K() {
        ...
        if (expandableLayout != null) {
            ...
            C2283My c2283MyA01 = super.A06.A1z().A01();
            this.A0X.A0L(new CY(this.A0K.getCTAButton(), 300, -1, c2283MyA01.A0A(true)));
            Drawable drawableA08 = XP.A08(A0i, A0j, A0h);
            Drawable endDrawable = XP.A05(c2283MyA01.A09(true), A0h);
            this.A0X.A0L(new C2016Cp(this.A0K.getCTAButton(), 300, drawableA08, endDrawable));
            this.A0X.A0L(new CZ(expandableLayout, TextFieldImplKt.AnimationDuration, false));
            this.A0X.AAm(this.A0P);
            this.A0X.A0K(F9.b.f40893g);
        }
    }
    ...
    private final void A0M(int i10, ViewGroup viewGroup, RelativeLayout relativeLayout) {
        if (this.A0K instanceof KL) {
            boolean z10 = this.A0K instanceof C18525r;
            if (A0c[0].charAt(8) == 'J') {
                throw new RuntimeException();
            }
            String[] strArr = A0c;
            ...
            if (z10 || (this.A0K instanceof C18515q)) {
                XP.A0H(this.A0K);
                RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
    ...
    private void A0P(EnumC2803d3 enumC2803d3, View view) {
        this.A0P.A0k(false);
        this.A0P.setVisibility(8);
        switch (C2745c7.A00[enumC2803d3.ordinal()]) {
            case 1:
                this.A0K.setVisibility(0);
                RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
                layoutParams.setMargins(0, AbstractC2550Xm.A00, 0, 0);
    ...
    public void A0Q(C3Q c3q) {
        if (this.A0P.getState() == EnumC2890eU.A02 && U7.A1Z(this.A0H)) {
    ...
    public final void A1D() {
        ...
        if (this.A0A != 0 || !this.A0Z) {
            ...
            if (this.A0J != null && getAdDataBundle().A20().A0K().A00() > 0) {
                ...
                new Handler(Looper.getMainLooper()).postDelayed(new RunnableC2744c6(this), getAdDataBundle().A20().A0K().A00());
                return;
            }
            this.A07 = true;
            return;
        ...
        this.A02 = new C2517Wd(this.A0C, 100.0f, 100L, new Handler(Looper.getMainLooper()), new HP(this));
        this.A02.A07();
    }
    ...
    public final void A1E() {
        ...
        this.A0P.A0h(EnumC2836db.A02, 20);
        ...
        if (iA02 != 0) {
            ...
            if (iA02 < secondsForNextCta2) {
                if (iA02 > 0) {
                    new C2517Wd(iA02, new HM(this)).A07();
                    return;
                }
                return;
            }
        }
        AbstractC2550Xm abstractC2550Xm = this.A0J;
        if (A0c[6].length() != 13) {
            throw new RuntimeException();
        }
        A0c[6] = "z6ph3MLFkPTln";
        abstractC2550Xm.setToolbarActionMode(8);
    }
    ...
    public final void A1H(boolean z10) {
        ...
        if (this.A06 || this.A0P.getState() == EnumC2890eU.A06 || this.A04 == null) {
            return;
        }
        if (!this.A08 || z10) {
    ...
    public C2765cR getFullScreenAdStyle() {
        return new C2765cR(true, C2765cR.A06, super.A06.A1z().A01(), KE.A05(super.A06), super.A06.A1z().A01().A08(true), super.A06.A20().A0H().A08());
    }
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        ...
        if (!this.A06) {
            ...
            if (configuration.orientation == 1) {
                C2271Ml c2271MlA1z = super.A06.A1z();
                String[] strArr = A0c;
                if (strArr[4].length() != strArr[3].length()) {
                    throw new RuntimeException();
                }
                A0c[1] = "ZWQFADQdeKHmDIXasxpY6pydlWSUwrFV";
                c2283MyA00 = c2271MlA1z.A01();
            } else {
                c2283MyA00 = super.A06.A1z().A00();
            }
            this.A01 = c2283MyA00;
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        ...
        if (!getAdDataBundle().A1U() && (expandableLayout = this.A0K.getExpandableLayout()) != null && z10 && this.A05 == null) {
            this.A05 = new C2015Co(expandableLayout, 300, expandableLayout.getHeight(), 0);
