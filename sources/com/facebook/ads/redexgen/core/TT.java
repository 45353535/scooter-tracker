...
public final class TT {
    ...
    public static synchronized EnumC2520Wi A00(SQ sq) {
        if (A01 == null) {
            A01 = C2521Wj.A00(sq);
        }
        return A01;
    ...
    public static void A07(SQ sq, boolean z10) {
        if (!A05.compareAndSet(0, 1)) {
            return;
        }
        A00(sq);
        try {
            SharedPreferences sharedPreferencesA00 = AbstractC2492Ve.A00(sq);
            T6 t62 = new T6(sq);
    ...
    public static void A08(SQ sq, boolean z10, String str) {
        if (A0A(sq)) {
            A09(sq, z10, str);
        } else {
            A07(sq, z10);
    ...
    public static void A09(SQ sq, boolean z10, String str) {
        if (str == null) {
