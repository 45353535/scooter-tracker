...
public enum EnumC2528Wq {
    ...
    EnumC2528Wq(int i10, NativeAdBase.NativeComponentTag nativeComponentTag) {
        this.A00 = i10;
        this.A01 = nativeComponentTag;
    }

    @Nullable
    public static EnumC2528Wq A00(NativeAdBase.NativeComponentTag nativeComponentTag) {
        for (EnumC2528Wq enumC2528Wq : values()) {
            if (enumC2528Wq.A01 == nativeComponentTag) {
                return enumC2528Wq;
            }
        }
        return null;
    ...
    public static void A03(@Nullable View view, NativeAdBase.NativeComponentTag nativeComponentTag) {
        EnumC2528Wq internalTag = A00(nativeComponentTag);
        if (view != null && internalTag != null) {
            view.setTag(A02, nativeComponentTag);
        }
    }

    public static void A04(@Nullable View view, @Nullable EnumC2528Wq enumC2528Wq) {
        if (view != null && enumC2528Wq != null) {
            view.setTag(A02, enumC2528Wq);
        }
    }
