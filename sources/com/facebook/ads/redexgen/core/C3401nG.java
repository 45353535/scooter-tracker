...
public class C3401nG implements C6W {
    ...
    public long A00;
    public long A01;
    public C3481ob A02 = C3481ob.A06;
    public boolean A03;
    public final C3T A04;

    public C3401nG(C3T c3t) {
        this.A04 = c3t;
    }
    ...
    public long A8h() {
        ...
        if (this.A03) {
            ...
            if (this.A02.A01 == 1.0f) {
                long positionUs2 = AbstractC18094a.A0O(j10);
    ...
    @Override // com.facebook.ads.redexgen.core.C6W
    public void AIt(C3481ob c3481ob) {
        if (this.A03) {
            long jA8h = A8h();
            String[] strArr = A05;
