...
public class C18425h extends AbstractC2173Ir {
    public YM A00;
    public InterfaceC2709bX A01;
    public C2789cp A02;
    public boolean A03;
    public boolean A04;
    public boolean A05;
    ...
    public static final int A0L = (int) (AbstractC2523Wl.A02 * 0.0f);
    public static final int A0M = (int) (AbstractC2523Wl.A02 * 9.0f);
    public static final int A0K = (int) (AbstractC2523Wl.A02 * 9.0f);

    public C18425h(C2658ai c2658ai, boolean z10, String str, FH fh2) {
        super(c2658ai, z10);
        this.A0G = new Path();
        this.A0H = new RectF();
    ...
    public void A00() {
        if (this.A0I.A0F() != null && this.A02 != null) {
            C2023Cw c2023CwA0F = this.A0I.A0F();
            ...
            c2023CwA0F.AAm(simpleVideoView);
    ...
    */
    public void A02() {
        ...
        L5:
            ...
            if (r0 == 0) goto L25
            boolean r3 = r4.A05
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.C18425h.A0J
            r0 = 4
            r1 = r1[r0]
            r0 = 16
            ...
            r0 = 83
            if (r1 == r0) goto L35
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C18425h.A0J
        ...
        L35:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C18425h.A02():void");
    }
    ...
    public void setCTAInfo(C2284Mz c2284Mz, Map<String, String> extraData) {
        getCtaButton().setCta(c2284Mz, this.A0E, extraData);
    }
    ...
    public void setOnAssetsLoadedListener(InterfaceC2709bX interfaceC2709bX) {
        this.A01 = interfaceC2709bX;
    }

    public void setUpImageView(C2820dL c2820dL) {
        this.A00 = new YM(c2820dL);
        if (U7.A1I(c2820dL)) {
            AbstractC2608Zs.A00(this.A00, U7.A1J(c2820dL), new ViewOnClickListenerC2626aC(this));
        }
        A04(this.A00);
    }
    ...
    public void setUpVideoView(C2820dL c2820dL) {
        this.A02 = new C2789cp(c2820dL, new C2463Ua(this.A0E, getAdEventManager()));
        if (U7.A1K(c2820dL)) {
            AbstractC2608Zs.A00(this.A02, U7.A1L(c2820dL), new ViewOnClickListenerC2627aD(this));
        }
        C2789cp c2789cp = this.A02;
        if (A0J[2].charAt(30) != 'G') {
            throw new RuntimeException();
