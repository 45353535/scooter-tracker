...
public final class C2113Gi {
    ...
    public static void A01() {
        A02 = new byte[]{SignedBytes.MAX_POWER_OF_TWO, 62, 69, 46, 51, 39, Ascii.DEL, 51, 120, 95, 51, 88, 67, 101, 38, 99, 62, 54, 69, 46, 51, 39, Ascii.DEL, 51, 120, 95, 51, 88, 67, 101, 38, 99, 55, 62, 54, 69, 46, 51, 39, Ascii.DEL, 51, 120, 95, 51, 88, 67, 101, 38, 99, 55, 40, 36, 38, 101, 42, 59, 59, 39, 46, 101, 34, Ascii.US, 62, 37, 46, 56, 86, 107, 74, 81, 108, 114, 111, 125};
    }
    ...
    private boolean A02(String str) {
        ...
        if (matcher.find()) {
            try {
                int i10 = Integer.parseInt((String) AbstractC18094a.A0f(matcher.group(1)), 16);
                int i11 = Integer.parseInt((String) AbstractC18094a.A0f(matcher.group(2)), 16);
                if (i10 > 0 || i11 > 0) {
                    this.A00 = i10;
                    this.A01 = i11;
                    return true;
    ...
    public final boolean A04(int i10) {
        ...
        int encoderDelay = i10 & Appodeal.ALL;
    ...
    */
    public final boolean A05(com.facebook.ads.androidx.media3.common.Metadata r9) {
        ...
        L59:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2113Gi.A05(com.facebook.ads.androidx.media3.common.Metadata):boolean");
    }
}
