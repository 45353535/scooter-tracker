...
public final class M4 {
    ...
    public final TreeSet<C3143iq> A04;
    ...
    public M4(int i10, String str) {
        this(i10, str, C3145is.A03);
    }

    public M4(int i10, String str, C3145is c3145is) {
        this.A01 = i10;
        this.A02 = str;
        this.A00 = c3145is;
    ...
    public final long A02(long j10, long j11) {
        ...
        C3M.A07(z10);
        C3143iq c3143iqA04 = A04(j10, j11);
        if (c3143iqA04.A03()) {
            return -Math.min(c3143iqA04.A04() ? Long.MAX_VALUE : c3143iqA04.A01, j11);
        }
        long j12 = j10 + j11;
        if (j12 < 0) {
            j12 = Long.MAX_VALUE;
        }
        long currentEndPosition = c3143iqA04.A02 + c3143iqA04.A01;
        if (currentEndPosition < j12) {
            TreeSet<C3143iq> treeSet = this.A04;
            String[] strArr = A06;
            ...
            for (C3143iq c3143iq : treeSet.tailSet(c3143iqA04, false)) {
                if (c3143iq.A02 > currentEndPosition) {
                    break;
                }
                long j13 = c3143iq.A02;
                long queryEndPosition = c3143iq.A01;
    ...
    public final C3145is A03() {
        return this.A00;
    }

    public final C3143iq A04(long j10, long j11) {
        C3143iq c3143iqA03 = C3143iq.A03(this.A02, j10);
        C3143iq c3143iqFloor = this.A04.floor(c3143iqA03);
        if (c3143iqFloor != null && c3143iqFloor.A02 + c3143iqFloor.A01 > j10) {
            return c3143iqFloor;
        }
        C3143iq lookupSpan = this.A04.ceiling(c3143iqA03);
        if (lookupSpan != null) {
        ...
        return C3143iq.A04(this.A02, j10, j11);
    }

    public final C3143iq A05(C3143iq c3143iq, long j10, boolean z10) {
        C3M.A08(this.A04.remove(c3143iq));
        File file = (File) C3M.A01(c3143iq.A03);
        if (z10) {
            File file2 = file.getParentFile();
            File fileA05 = C3143iq.A05((File) C3M.A01(file2), this.A01, c3143iq.A02, j10);
        ...
        C3143iq newCacheSpan = c3143iq.A09(file, j10);
        this.A04.add(newCacheSpan);
        return newCacheSpan;
    }

    public final TreeSet<C3143iq> A06() {
        return this.A04;
    }
    ...
    */
    ...
    public final void A08(C3143iq c3143iq) {
        this.A04.add(c3143iq);
    }
    ...
    */
    ...
    public final boolean A0D(C2257Lx c2257Lx) {
        if (this.A04.remove(c2257Lx)) {
            if (c2257Lx.A03 != null) {
                c2257Lx.A03.delete();
                return true;
            }
    ...
    public final boolean A0E(M9 m92) {
        C3145is c3145is = this.A00;
        C3145is oldMetadata = this.A00;
        this.A00 = oldMetadata.A05(m92);
        C3145is oldMetadata2 = this.A00;
        return !oldMetadata2.equals(c3145is);
    }
