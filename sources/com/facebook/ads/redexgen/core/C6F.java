...
public final class C6F extends C3000gI {
    ...
    public final C2780cg A06;
    public final C2781ch A07;

    public C6F(C2820dL c2820dL, C2781ch c2781ch, C2780cg c2780cg) {
        super(c2820dL);
        this.A02 = 0;
        this.A00 = 50.0f;
        this.A05 = c2820dL;
    ...
    public final void A1L(QW qw, C2364Qd c2364Qd, int i10, int widthMode) {
        int[] iArrA02;
        int mode = View.MeasureSpec.getMode(i10);
        int mode2 = View.MeasureSpec.getMode(widthMode);
        if ((mode == 1073741824 && A28() == 1) || (mode2 == 1073741824 && A28() == 0)) {
            super.A1L(qw, c2364Qd, i10, widthMode);
            return;
        }
    ...
    @Override // com.facebook.ads.redexgen.core.C3000gI, com.facebook.ads.redexgen.core.QO
    public final void A1r(int i10) {
        A2D(i10, this.A02);
    }

    @Override // com.facebook.ads.redexgen.core.C3000gI, com.facebook.ads.redexgen.core.QO
    public final void A1z(C18676g c18676g, C2364Qd c2364Qd, int i10) {
        this.A03.A0A(i10);
        A1N(this.A03);
    }
