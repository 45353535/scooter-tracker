...
public final class C2686bA extends RelativeLayout {
    public final View A00;
    public final C2635aL A01;

    public C2686bA(C2820dL c2820dL, View view) {
        super(c2820dL);
        this.A00 = view;
        this.A01 = new C2635aL(c2820dL);
        XP.A0I(this.A01);
    }
     ...
     */
    public final void A01(C2640aQ c2640aQ, boolean z10) {
        ...
        if (c2640aQ != null) {
            if (z10) {
                ...
                c2640aQ.setAlignment(3);
                layoutParams2.setMargins(AbstractC2654ae.A07 / 2, AbstractC2654ae.A07 / 2, AbstractC2654ae.A07 / 2, AbstractC2654ae.A07 / 2);
                linearLayout.addView(c2640aQ, layoutParams2);
                ...
                insideLayoutParams.setMargins(0, AbstractC2654ae.A07, 0, 0);
                c2640aQ.setAlignment(17);
                addView(c2640aQ, insideLayoutParams);
            }
        }
