...
public abstract class AbstractC2839de {
     ...
     */
    public static WebResourceResponse A00(C2820dL c2820dL, WebResourceRequest webResourceRequest, Uri uri, String str, HashMap<String, String> map) throws IOException {
        String strA02 = A02(85, 5, 1);
        InterfaceC18314w interfaceC18314wA0H = C2879eJ.A06(c2820dL.A02()).A0H(c2820dL);
        SF.A0H(c2820dL, uri.toString());
        try {
            C2840df c2840df = new C2840df(c2820dL.A02(), uri, interfaceC18314wA0H);
            int iAvailable = c2840df.available();
            if (iAvailable <= 0) {
                A05(c2820dL, 1, new Pair[]{new Pair(A02(61, 9, 46), String.valueOf(iAvailable))});
                return null;
            }
            ...
            if (strA03 == null) {
                c2820dL.A0F().A65();
                A06(map, iAvailable);
                return new WebResourceResponse(str, null, 200, A02(44, 2, 122), map, c2840df);
            }
            try {
                C2838dd c2838ddA01 = A01(strA03);
                if (!c2838ddA01.A03) {
                    A05(c2820dL, 0, new Pair[]{new Pair(A02(94, 5, 77), c2838ddA01.A02 != null ? c2838ddA01.A02 : A02(90, 4, 30))});
                    return null;
                }
                int i10 = c2838ddA01.A01;
                int i11 = c2838ddA01.A00 == -1 ? iAvailable - 1 : c2838ddA01.A00;
                A06(map, iAvailable);
                map.put(A02(31, 13, 93), A02(75, 6, 3) + i10 + A02(1, 1, 92) + i11 + A02(2, 1, 88) + iAvailable);
                c2820dL.A0F().A65();
                return new WebResourceResponse(str, null, 206, A02(46, 15, 10), map, c2840df);
            } catch (NumberFormatException e10) {
                A05(c2820dL, 3, new Pair[]{new Pair(strA02, e10.toString())});
                return null;
            }
        } catch (IOException e11) {
            A05(c2820dL, 2, new Pair[]{new Pair(strA02, e11.toString())});
            return null;
        }
    }
    ...
    public static void A05(C2820dL c2820dL, int i10, Pair<String, String>[] pairArr) {
        ...
        c2820dL.A0F().A64(jSONObject.toString());
    }
    ...
    public static C2838dd A01(String str) {
        if (str == null) {
            C2838dd parseResult = new C2838dd();
        ...
        if (strArrSplit.length >= 2) {
            if (A02(70, 5, 5).equals(strArrSplit[0].toLowerCase(Locale.US).trim())) {
                if (strArrSplit[1].trim().split(A02(0, 1, 72)).length != 1) {
                    C2838dd c2838dd = new C2838dd();
                    c2838dd.A03 = false;
                    c2838dd.A02 = str;
                    return c2838dd;
                }
                String[] ranges = strArrSplit[1].trim().split(A02(1, 1, 92));
                C2838dd c2838dd2 = new C2838dd();
                c2838dd2.A03 = true;
                c2838dd2.A02 = str;
                c2838dd2.A01 = TextUtils.isEmpty(ranges[0]) ? 0 : Integer.parseInt(ranges[0]);
                if (ranges.length > 1) {
                    c2838dd2.A00 = TextUtils.isEmpty(ranges[1]) ? -1 : Integer.parseInt(ranges[1]);
                } else {
                    c2838dd2.A00 = -1;
                }
                return c2838dd2;
