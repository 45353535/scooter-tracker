...
public abstract class WX {
    ...
    public static void A05(C2794cu c2794cu, InterfaceC2533Wv interfaceC2533Wv, String str) {
        if (str == null || A03.contains(str)) {
            return;
        }
        boolean isPackageInstalled = A08(c2794cu.getPackageManager(), str);
        if (isPackageInstalled) {
            interfaceC2533Wv.AEQ(str);
            return;
        }
        A03.add(str);
        A02.removeCallbacksAndMessages(null);
        A02.postDelayed(new WW(new int[]{0}, str, c2794cu, interfaceC2533Wv), 1000L);
    }
    ...
    */
    public static void A06(com.facebook.ads.redexgen.core.C2794cu r6, java.lang.String r7) {
        /*
        ...
        L5b:
            return
        L5c:
            com.facebook.ads.redexgen.X.Nk r1 = com.facebook.ads.redexgen.core.AbstractC2296Nl.A00(r6)
            r0 = 5
            r1.A0A(r7, r2, r0)
            goto L5b
        L65:
    ...
    public static void A07(C2794cu c2794cu, String str, InterfaceC2533Wv interfaceC2533Wv) {
        boolean isWithinFB = c2794cu.getPackageName().equals(A01(30, 19, 75)) || c2794cu.getPackageName().equals(A01(49, 22, 66));
        if (isWithinFB) {
            A05(c2794cu, interfaceC2533Wv, str);
        } else {
            AbstractC2296Nl.A00(c2794cu).A0A(str, interfaceC2533Wv, 4);
        }
    }
