...
public final class C3239kQ extends AbstractC2181Iz {
    ...
    public static void A01() {
        A01 = new byte[]{-1, 19, 2, 7, 13, -51, 13, Ascii.SO, 19, 17};
    }
    ...
    public final long A09(C4J c4j) {
        return A06(AbstractC2122Gr.A05(c4j.A0l()));
    }
    ...
    public final boolean A0C(C4J c4j, long j10, C2180Iy c2180Iy) throws C17652i {
        if (A03(c4j, A04)) {
            byte[] headerBytes = Arrays.copyOf(c4j.A0l(), c4j.A0A());
            int iA01 = AbstractC2122Gr.A01(headerBytes);
            List<byte[]> listA06 = AbstractC2122Gr.A06(headerBytes);
            if (c2180Iy.A00 != null) {
                return true;
            }
            c2180Iy.A00 = new C2D().A11(A00(0, 10, 33)).A0b(iA01).A0m(48000).A12(listA06).A14();
            return true;
        }
        if (A03(c4j, A03)) {
            C3M.A02(c2180Iy.A00);
            ...
            c2180Iy.A00 = c2dA07.A0v(metadataA02.A04(c2180Iy.A00.A0P)).A14();
            return true;
        }
        C3M.A02(c2180Iy.A00);
        return false;
