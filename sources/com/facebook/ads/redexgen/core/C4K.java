...
public final class C4K extends AbstractC2147Hr {
    ...
    public final MH A0O;
    public final C2283My A0P;
    public final C2820dL A0Q;
    public final C2463Ua A0R;
    public final AbstractC2550Xm A0S;
    public final KL A0T;
    public final InterfaceC2620a4 A0U;
    public final InterfaceC2767cT A0V;
    public final EG A0W;
    public final E1 A0X;
    public final C17913i A0Y;
    public final DX A0Z;
    public final DV A0a;
    public final DR A0b;
    public final DP A0c;
    ...
    public static void A0U() {
        A0k = new byte[]{33, 46, 43, 33, 41, Ascii.GS, 49, 45, 55, 48, 33, 39, 58, 54, 52, 119, Utf8.REPLACEMENT_BYTE, 56, 58, 60, 59, 54, 54, 50, 119, 56, 61, 42, 119, 48, 55, 45, 60, 43, 42, 45, 48, 45, 48, 56, 53, 119, 58, 53, 48, 58, 50, 60, 61, 33, 54, 36, 50, 33, 55, 54, 55, Ascii.FF, 37, 58, 55, 54, 60, 61, 59, 45, 58, 43, 36, 33, 43, 35, Ascii.ETB, 46, 33, 36, 60, 45, 58, 45, 44, 9};
    }

    static {
        A0U();
        A0m = (int) (AbstractC2523Wl.A02 * 4.0f);
        A0s = (int) (AbstractC2523Wl.A02 * 32.0f);
        A0r = (int) (AbstractC2523Wl.A02 * 8.0f);
        A0n = (int) (AbstractC2523Wl.A02 * 12.0f);
        A0o = (int) (AbstractC2523Wl.A02 * 16.0f);
        A0p = (int) (AbstractC2523Wl.A02 * 48.0f);
        A0q = (int) (AbstractC2523Wl.A02 * 64.0f);
        A0t = OP.A02(-1, 77);
        A0u = (int) (AbstractC2523Wl.A02 * 26.0f);
        A0v = (int) (AbstractC2523Wl.A02 * 12.0f);
    }

    public C4K(C2820dL c2820dL, US us, AbstractC2550Xm abstractC2550Xm, AbstractC3095hy abstractC3095hy, SF sf2, YY yy, int i10, InterfaceC2551Xn interfaceC2551Xn, C2463Ua c2463Ua, int i11, boolean z10, boolean z11, InterfaceC2767cT interfaceC2767cT, int i12, int i13) {
        C2283My c2283MyA00;
        super(c2820dL, yy, us, abstractC3095hy, i10, z10, z11, interfaceC2551Xn, i13);
        this.A0F = false;
        this.A0E = false;
        this.A0D = false;
        this.A01 = 0;
        ...
        this.A0h = new RunnableC2761cN(this);
        this.A0C = false;
        this.A00 = 0.0f;
        this.A0A = true;
        this.A0d = new DN() { // from class: com.facebook.ads.redexgen.X.4X
            ...
            public final void A03(DO r10) {
                if (!this.A00.A0J) {
                    this.A00.A0J = true;
                    this.A00.A0Q.A0F().AJw(AbstractC2514Wa.A00((float) ((AbstractC2147Hr) this.A00).A06.A0h()), this.A00.getResources().getConfiguration().orientation, true, true, MH.A0A());
        ...
        this.A0Z = new DX() { // from class: com.facebook.ads.redexgen.X.4T
            ...
            public final void A03(C17863d c17863d) {
                ...
                this.A00.A0X.A0h(EnumC2836db.A02, 28);
            }
        };
        this.A0a = new C4L(this);
        this.A0U = new G9(this);
        this.A0S = abstractC2550Xm;
        this.A0L = i12;
        this.A0M = new Handler(Looper.getMainLooper());
        this.A0O = MI.A01(c2820dL, us, abstractC3095hy.A25(), WQ.A00(abstractC3095hy.A20().A0J().A05()), new HashMap(), false, true, abstractC3095hy.A21());
        this.A0Q = c2820dL;
        this.A0R = c2463Ua;
        this.A0f = new D0(this.A0Q, this.A0R);
        this.A0g = new C2023Cw(this.A0Q, i12);
        this.A0V = interfaceC2767cT;
        if (i11 == 1) {
        ...
        if (U7.A1u(this.A0Q)) {
            InterfaceC2467Ue interfaceC2467UeA0B = this.A0Q.A0B();
            E1 e12 = this.A0X;
            String videoUrl2 = super.A06.A25();
            interfaceC2467UeA0B.AK2(e12, videoUrl2, true);
        }
        if (U7.A1v(this.A0Q)) {
        ...
        A0a(abstractC3095hy.A20());
        this.A0i = super.A06.A1e();
        this.A0j = super.A06.A1p();
        A0O();
        c2820dL.A0F().ABe(this.A0i, this.A0j, true);
    ...
    private KL A0D() {
        ...
        if (super.A06.A0v().equals(A0I(49, 14, 78))) {
            strA0I = EnumC2842dh.A04.A03();
        } else {
            strA0I = A0I(12, 37, 68);
        }
        if (A0t(this.A0K)) {
            c18525r = new C18515q(this.A0Q, this.A07, AbstractC2147Hr.A0G, false, getColors(), strA0I, super.A08, super.A0B, super.A0D, super.A0A, super.A06, this.A0g, this.A0R, true);
        } else if (A0u(this.A0K)) {
            c18525r = new C18505p(this.A0Q, this.A07, AbstractC2147Hr.A0G, false, getColors(), strA0I, super.A08, super.A0B, super.A0D, super.A0A, super.A06, this.A0g, this.A0R, true);
        } else {
            c18525r = new C18525r(this.A0Q, this.A07, AbstractC2147Hr.A0G, false, getColors(), strA0I, super.A08, super.A0B, super.A0D, super.A0A, super.A06, this.A0g, this.A0R, true);
        }
        ...
        c18525r.setChainedAdInfo(super.A00);
        c18525r.setLayoutParams(adDetailsParams);
        return c18525r;
    }

    private void A0J() {
        this.A08 = new C2670au(this.A0Q, super.A06, this.A0R, this.A0N, super.A0B);
        this.A08.A0D(false);
    ...
    private void A0R() {
        if (super.A06.A1W()) {
            this.A0X.setOnClickListener(new ViewOnClickListenerC2763cP(this));
        }
        XP.A0H(this.A0X);
        XP.A0I(this.A0X);
        addView(this.A0X, new RelativeLayout.LayoutParams(-1, -2));
        this.A07 = new KE(this.A0Q, super.A06, this.A0P, super.A08, super.A0B, super.A0D, super.A0A, (InterfaceC2533Wv) null);
        XP.A0E(1001, this.A07);
        if (U7.A17(this.A0Q)) {
            View.OnClickListener onClickListener = new ViewOnClickListenerC2756cI(this);
            this.A0T.setCTAClickListener(onClickListener);
            if (this.A0S != null) {
                View.OnClickListener onClickListener2 = new ViewOnClickListenerC2757cJ(this);
    ...
    private void A0S() {
        ...
        if (!TextUtils.isEmpty(super.A06.A20().A0H().A08())) {
            C17722p c17722p = new C17722p(this.A0Q, true);
            this.A0X.A0i(c17722p);
    ...
    private void A0W(int i10, ViewGroup viewGroup, RelativeLayout relativeLayout) {
        ...
        XP.A0H(this.A0T);
        if ((this.A0T instanceof C18525r) || (this.A0T instanceof C18515q)) {
        ...
        } else if (this.A0T instanceof C18505p) {
    ...
    private void A0Y(ViewGroup viewGroup, View view, AbstractC2550Xm abstractC2550Xm, int i10) {
        XP.A0Z(this.A03);
        XP.A0H(abstractC2550Xm);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, abstractC2550Xm.getToolbarHeight());
        layoutParams.addRule(10);
    ...
    private void A0Z(ViewGroup viewGroup, View view, AbstractC2550Xm abstractC2550Xm, int i10) {
        XP.A0H(this.A03);
        XP.A0H(abstractC2550Xm);
        XP.A0H(this.A0T);
    ...
    private void A0a(C2274Mp c2274Mp) {
        this.A0T.setInfo(c2274Mp.A0I(), c2274Mp.A0J(), super.A06.A25(), super.A06.A23().A01(), null, this.A0U);
        this.A0T.getCTAButton().setIsInAppBrowser(true);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A0k(C3Q c3q) {
        if (this.A0X.getState() == EnumC2890eU.A02 && U7.A1Z(this.A0Q)) {
    ...
    public final void A1D() {
        ...
        if (this.A0S != null && getAdDataBundle().A20().A0K().A00() > 0) {
            ...
            new Handler(Looper.getMainLooper()).postDelayed(new RunnableC2760cM(this), getAdDataBundle().A20().A0K().A00());
        }
    }
    ...
    public final void A1E() {
        ...
        this.A0X.A0h(EnumC2836db.A02, 20);
        ...
        if (iA02 != 0) {
            ...
            if (iA02 < secondsForNextCta2) {
                ...
                new C2517Wd(iA02, new GW(this)).A07();
                return;
            }
        }
        this.A0S.setToolbarActionMode(8);
    ...
    public final void A1H(boolean z10) {
        if (this.A0X.getState() == EnumC2890eU.A06 || this.A09 == null) {
            return;
        }
        if (!this.A0I || z10) {
            E1 e12 = this.A0X;
            EnumC2836db enumC2836db = this.A09;
            String[] strArr = A0l;
            if (strArr[3].length() != strArr[0].length()) {
                throw new RuntimeException();
            }
    ...
    private KE getRegularCtaForEndCard() {
        KE ke2 = new KE(this.A0Q, super.A06.A0r(), super.A06.A1z().A01(), super.A08, super.A0B, (C2893eX) null, super.A0A, super.A06.A21());
    ...
    private void setUpBrowserControls(LJ lj) {
        ...
        this.A04.setListener(new C2125Gu(this));
