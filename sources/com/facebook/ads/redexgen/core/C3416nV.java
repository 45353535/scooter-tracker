...
public final class C3416nV implements C6S {
    ...
    public C3416nV() {
        this(new C3305lh(true, 65536), 50000, 50000, 2500, 5000, -1, false, 0, false);
    }

    public C3416nV(C3305lh c3305lh, int i10, int i11, int i12, int i13, int i14, boolean z10, int i15, boolean z11) {
        int i16;
        ...
        this.A08 = c3305lh;
        this.A07 = AbstractC18094a.A0O(i10);
        this.A06 = AbstractC18094a.A0O(i11);
        this.A05 = AbstractC18094a.A0O(i12);
        this.A04 = AbstractC18094a.A0O(i13);
        this.A02 = i14;
        if (this.A02 != -1) {
            i16 = this.A02;
        } else {
        ...
        this.A00 = i16;
        this.A09 = z10;
        this.A03 = AbstractC18094a.A0O(i15);
        this.A0A = z11;
    }
    ...
    private final int A01(InterfaceC3307lj[] interfaceC3307ljArr) {
        int iA00 = 0;
        for (InterfaceC3307lj interfaceC3307lj : interfaceC3307ljArr) {
            if (interfaceC3307lj != null) {
                int targetBufferSize = interfaceC3307lj.A9D().A02;
    ...
    public final C3305lh A6n() {
        return this.A08;
    }

    @Override // com.facebook.ads.redexgen.core.C6S
    public final long A6s(C18997m c18997m) {
        return this.A03;
    }

    @Override // com.facebook.ads.redexgen.core.C6S
    public final void AEj(C18997m c18997m) {
        A05(false);
    }

    @Override // com.facebook.ads.redexgen.core.C6S
    public final void AEu(C18997m c18997m) {
        A05(true);
    }

    @Override // com.facebook.ads.redexgen.core.C6S
    public final void AFN(C18997m c18997m) {
        A05(true);
    }

    @Override // com.facebook.ads.redexgen.core.C6S
    public final void AFV(C6R c6r, C3334mA c3334mA, InterfaceC3307lj[] interfaceC3307ljArr) {
        int iA01;
        if (this.A02 == -1) {
            iA01 = A01(interfaceC3307ljArr);
        } else {
            iA01 = this.A02;
        }
        this.A00 = iA01;
    ...
    @Override // com.facebook.ads.redexgen.core.C6S
    public final boolean AI3(C18997m c18997m) {
        return this.A0A;
    }
    ...
    public final boolean AJB(C6R c6r) {
        ...
        long jMin = this.A07;
        if (c6r.A00 > 1.0f) {
            jMin = Math.min(AbstractC18094a.A0Q(jMin, c6r.A00), this.A06);
        }
    ...
    public final boolean AJE(long j10, float f10, boolean z10, boolean z11, long minBufferDurationUs) {
        long jA0R = AbstractC18094a.A0R(j10, f10);
