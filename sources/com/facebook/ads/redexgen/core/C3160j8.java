...
public class C3160j8 implements LH {
    ...
    public C3160j8(C3158j6 c3158j6) {
        this(c3158j6, UUID.randomUUID().toString());
    }

    public C3160j8(C3158j6 c3158j6, String str) {
    ...
    public final void AAw(int code, String message) throws Throwable {
        if (AbstractC2499Vl.A02(this) || code < 11000 || code > 11099) {
            return;
        }
        try {
            A02(code, message);
    ...
    public final void AK6(int code, String message) throws Throwable {
        if (AbstractC2499Vl.A02(this) || code < 12000 || code > 12099) {
            return;
        }
        try {
            A02(code, message);
