...
public final class C3271l8 implements GX {
    ...
    public static final InterfaceC2106Gb A0H = new InterfaceC2106Gb() { // from class: com.facebook.ads.redexgen.X.l9
    ...
    public final C3270l7 A0F = new C3270l7();
    public int A01 = 1;
    ...
    private C4J A01(InterfaceC3286lN interfaceC3286lN) throws IOException {
        ...
        interfaceC3286lN.readFully(this.A0D.A0l(), 0, this.A02);
        return this.A0D;
    }
    ...
    private void A02() {
        if (!this.A0A) {
            this.A06.AIN(new C3281lI(-9223372036854775807L));
            this.A0A = true;
        }
    }

    private void A03(InterfaceC3286lN interfaceC3286lN) throws IOException {
    ...
    @RequiresNonNull({"extractorOutput"})
    private boolean A04(InterfaceC3286lN interfaceC3286lN) throws IOException {
        if (!interfaceC3286lN.AGh(this.A0B.A0l(), 0, 9, true)) {
            return false;
        }
        this.A0B.A0f(0);
        C4J c4j = this.A0B;
        ...
        if (z10 && this.A07 == null) {
            this.A07 = new C3273lA(this.A06.AJh(8, 1));
        }
        if (hasAudio && this.A08 == null) {
            this.A08 = new C3268l5(this.A06.AJh(9, 2));
        }
        this.A06.A6G();
    ...
    */
    private boolean A05(com.facebook.ads.redexgen.core.InterfaceC3286lN r12) throws java.io.IOException {
        /*
            r11 = this;
            r10 = 1
            r9 = 0
        ...
        L23:
            ...
            if (r0 != 0) goto L5b
            long r3 = r11.A05
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C3271l8.A0G
            r0 = 5
            r1 = r2[r0]
            r0 = 0
            r2 = r2[r0]
        ...
        Lb6:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C3271l8.A05(com.facebook.ads.redexgen.X.lN):boolean");
    }

    private boolean A06(InterfaceC3286lN interfaceC3286lN) throws IOException {
        if (!interfaceC3286lN.AGh(this.A0E.A0l(), 0, 11, true)) {
            return false;
        }
        this.A0E.A0f(0);
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final int AGb(com.facebook.ads.redexgen.core.InterfaceC3286lN r6, com.facebook.ads.redexgen.core.C2124Gt r7) throws java.io.IOException {
        /*
            r5 = this;
        ...
        L11:
            ...
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.C3271l8.A0G
            r0 = 6
            r1 = r1[r0]
            r0 = 17
            char r1 = r1.charAt(r0)
        ...
        L79:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C3271l8.AGb(com.facebook.ads.redexgen.X.lN, com.facebook.ads.redexgen.X.Gt):int");
    }
    ...
    public final boolean AJL(InterfaceC3286lN interfaceC3286lN) throws IOException {
        interfaceC3286lN.AG9(this.A0C.A0l(), 0, 3);
        this.A0C.A0f(0);
        if (this.A0C.A0K() != 4607062) {
            return false;
        }
        interfaceC3286lN.AG9(this.A0C.A0l(), 0, 2);
        this.A0C.A0f(0);
        if ((this.A0C.A0M() & 250) != 0) {
            return false;
        }
        interfaceC3286lN.AG9(this.A0C.A0l(), 0, 4);
        this.A0C.A0f(0);
        int dataOffset = this.A0C.A0C();
        interfaceC3286lN.AI1();
        interfaceC3286lN.A3z(dataOffset);
        interfaceC3286lN.AG9(this.A0C.A0l(), 0, 4);
        this.A0C.A0f(0);
