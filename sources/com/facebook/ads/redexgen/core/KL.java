...
public abstract class KL extends AbstractC2611Zv {
    ...
    public final AbstractC3095hy A07;
    public final N9 A08;
    public final O2 A09;
    public final C2463Ua A0A;
    public final InterfaceC2551Xn A0B;
    ...
    public final C2281Mw A0R;
    public final C2283My A0S;
    public final C2820dL A0T;
    public final C2023Cw A0U;
    ...
    public static void A0Y() {
        A0Z = new byte[]{58, Ascii.DC2, 4, 2, Ascii.DC2, 60, 108, 103, 106, 121, 125, 96, 97, 80, 122, Ascii.DEL, Ascii.GS, Ascii.FS, 10, Ascii.SUB, Ascii.VT, Ascii.DLE, 9, 13, Ascii.DLE, Ascii.SYN, Ascii.ETB, 126, 116, 120, 121, Ascii.RS, 2, Ascii.SI, 13, Ascii.VT, 49, 6, 1, 2, 10, Ascii.VT, Ascii.FS, 49, Ascii.SUB, Ascii.VT, Ascii.SYN, Ascii.SUB, 96, 98, Ascii.DEL, 119, 98, 117, 99, 99, 79, 114, 113, 98, 99, 116, 102, 112, 99, 117, 116, 117, 78, 103, 120, 117, 116, 126, 98, Ascii.DEL, 98, 122, 115, 107, 109, 126, 113, 108, 115, 126, 107, 118, 112, 113, 70};
    }
    ...
    static {
        A0Y();
        A0i = (int) (AbstractC2523Wl.A02 * 44.0f);
        A0b = (int) (AbstractC2523Wl.A02 * 52.0f);
        A0s = (int) (AbstractC2523Wl.A02 * 4.0f);
        A0u = (int) (AbstractC2523Wl.A02 * 8.0f);
        A0j = (int) (AbstractC2523Wl.A02 * 12.0f);
        A0k = (int) (AbstractC2523Wl.A02 * 14.0f);
        A0l = (int) (AbstractC2523Wl.A02 * 16.0f);
        A0m = (int) (AbstractC2523Wl.A02 * 18.0f);
        A0n = (int) (AbstractC2523Wl.A02 * 20.0f);
        A0o = (int) (AbstractC2523Wl.A02 * 24.0f);
        A0p = (int) (AbstractC2523Wl.A02 * 26.0f);
        A0q = (int) (AbstractC2523Wl.A02 * 28.0f);
        A0r = (int) (AbstractC2523Wl.A02 * 32.0f);
        A0t = (int) (AbstractC2523Wl.A02 * 40.0f);
        A0f = (int) (AbstractC2523Wl.A02 * 48.0f);
        A0g = (int) (AbstractC2523Wl.A02 * 100.0f);
        A0h = (int) (AbstractC2523Wl.A02 * 112.0f);
        A0c = (int) (AbstractC2523Wl.A02 * 16.0f);
        A0e = OP.A02(-1, 128);
        A0d = OP.A02(-1, 17);
        A0v = (int) (AbstractC2523Wl.A02 * 12.0f);
    }

    public KL(C2820dL c2820dL, KE ke2, int i10, boolean z10, C2283My c2283My, boolean z11, String str, US us, InterfaceC2551Xn interfaceC2551Xn, C2893eX c2893eX, XH xh2, AbstractC3095hy abstractC3095hy, C2023Cw c2023Cw, C2463Ua c2463Ua, boolean z12) {
        super(c2820dL, ke2, i10, c2283My, z11, str, us, interfaceC2551Xn, c2893eX, xh2, abstractC3095hy.A21(), abstractC3095hy.A1c(), abstractC3095hy.A0x());
        this.A0W = new AtomicBoolean(true);
        this.A0V = new RunnableC2612Zw(this);
        this.A0D = new RunnableC2613Zx(this);
        this.A0C = new RunnableC2614Zy(this);
        this.A0A = c2463Ua;
        this.A07 = abstractC3095hy;
        this.A09 = O3.A00(c2820dL.A02());
        this.A0B = interfaceC2551Xn;
        this.A0E = abstractC3095hy.A25();
        this.A08 = abstractC3095hy.A23();
        this.A0S = c2283My;
        this.A0R = abstractC3095hy.A20().A0I();
        this.A0T = c2820dL;
        this.A0X = z10;
        this.A0Y = z12;
        ...
        if (!this.A0Y) {
            ...
            this.A0I.setOnClickListener(AbstractC2645aV.A03(super.A08, A0R(6, 10, 11)));
        }
        ...
        this.A0K = A0J();
        XP.A0I(this.A0K);
        this.A0K.setOnClickListener(new ViewOnClickListenerC2615Zz(this));
        A0p(8);
        ...
        if (this.A07.A0v().equals(A0R(60, 14, 21)) && !abstractC3095hy.A1Z() && this.A06 > 0) {
            this.A04 = A0O();
            XP.A0I(this.A04);
        }
    ...
    private C2023Cw A0Q(C2023Cw c2023Cw) {
        if (c2023Cw == null) {
            c2023Cw = new C2023Cw(this.A0T, -1);
            c2023Cw.setVisibility(8);
        }
        c2023Cw.A08(A0e, A0d, true);
        c2023Cw.setPadding(0, 0, 0, 0);
        RelativeLayout.LayoutParams progressBarLayoutParams = new RelativeLayout.LayoutParams(-1, A0v);
        c2023Cw.setLayoutParams(progressBarLayoutParams);
        return c2023Cw;
    }
    ...
    public final void A0g() {
        super.A09.setOnClickListener(AbstractC2645aV.A03(super.A08, A0R(27, 4, 19)));
        this.A0Q.setOnClickListener(AbstractC2645aV.A03(super.A08, A0R(74, 5, 18)));
        this.A0P.setOnClickListener(AbstractC2645aV.A03(super.A08, A0R(16, 11, 125)));
        this.A0U.setOnClickListener(AbstractC2645aV.A03(super.A08, A0R(48, 12, 20)));
        if (this.A04 != null) {
            this.A04.setOnClickListener(AbstractC2645aV.A03(super.A08, A0R(31, 17, 106)));
        }
    }
    ...
    public C2023Cw getProgressBarAnimation() {
        return this.A0U;
    }
    ...
    public void setPlaceHolderTextForRewardsConversion(String str) {
        if (this.A04 != null) {
            ...
            textView.setOnClickListener(AbstractC2645aV.A03(super.A08, A0R(31, 17, 106)));
        }
    }
}
