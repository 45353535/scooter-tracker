...
public final class VB {
    ...
    public VB(SQ sq, String str, String str2, V6 v62) throws V2 {
        ...
        try {
            ...
            switch (V9.A00[VA.valueOf(jSONObject.getString(strA014).toUpperCase()).ordinal()]) {
                case 1:
                    ...
                    if (!jSONObject.getString(strA012).equals(sq.A05().A9L()) && !ProcessUtils.isRemoteRenderingProcess() && UA.A03(jSONObject) != Boolean.TRUE) {
                        throw new V2(AdErrorType.BID_IMPRESSION_MISMATCH, String.format(Locale.US, A01(0, 54, 122), this.A01, jSONObject.getString(strA012), sq.A05().A9L()));
                    }
            ...
            sq.A08().AAy(A01(238, 3, 5), AbstractC2433Sv.A0P, new C2434Sw(e10));
    ...
    public static void A02() {
        A04 = new byte[]{34, 9, 4, SignedBytes.MAX_POWER_OF_TWO, 69, 4, SignedBytes.MAX_POWER_OF_TWO, 6, Ascii.SI, Ascii.DC2, SignedBytes.MAX_POWER_OF_TWO, 51, 36, 43, SignedBytes.MAX_POWER_OF_TWO, Ascii.SYN, 5, Ascii.DC2, 19, 9, Ascii.SI, Ascii.SO, SignedBytes.MAX_POWER_OF_TWO, 69, 19, SignedBytes.MAX_POWER_OF_TWO, 2, 5, 9, Ascii.SO, 7, SignedBytes.MAX_POWER_OF_TWO, Ascii.NAK, 19, 5, 4, SignedBytes.MAX_POWER_OF_TWO, Ascii.SI, Ascii.SO, SignedBytes.MAX_POWER_OF_TWO, 51, 36, 43, SignedBytes.MAX_POWER_OF_TWO, Ascii.SYN, 5, Ascii.DC2, 19, 9, Ascii.SI, Ascii.SO, SignedBytes.MAX_POWER_OF_TWO, 69, 19, 83, 120, 117, 49, 52, 117, 49, 119, 126, 99, 49, 97, 125, 112, 114, 116, 124, 116, Ascii.DEL, 101, 49, 52, 98, 49, 115, 116, 120, Ascii.DEL, 118, 49, 100, 98, 116, 117, 49, 126, Ascii.DEL, 49, 97, 125, 112, 114, 116, 124, 116, Ascii.DEL, 101, 49, 52, 98, 68, 111, 98, 38, 35, 98, 38, 96, 105, 116, 38, 114, 99, 107, 118, 106, 103, 114, 99, 38, 35, 117, 38, 100, 99, 111, 104, 97, 38, 115, 117, 99, 98, 38, 105, 104, 38, 114, 99, 107, 118, 106, 103, 114, 99, 38, 35, 117, Ascii.VT, 44, 52, 35, 46, 43, 38, 98, 0, 43, 38, Ascii.DC2, 35, 59, 46, 45, 35, 38, 71, 118, 126, 99, Ascii.DEL, 114, 103, 118, 51, 54, 96, 51, 122, 96, 51, 125, 124, 103, 51, 101, 114, Ascii.DEL, 122, 119, 51, 113, 114, 125, 125, 118, 97, 51, 103, 118, 126, 99, Ascii.DEL, 114, 103, 118, Ascii.VT, 48, 45, 43, 46, 46, 49, 44, 42, 59, 58, 126, Ascii.FS, 55, 58, Ascii.SO, Utf8.REPLACEMENT_BYTE, 39, 50, 49, Utf8.REPLACEMENT_BYTE, 58, 126, 42, 39, 46, 59, 126, 126, 111, 118, 7, Ascii.FF, 1, 58, Ascii.FF, 1, Ascii.NAK, Ascii.RS, 19, 40, 3, Ascii.RS, Ascii.SUB, Ascii.DC2, 40, 3, Ascii.CAN, Ascii.FS, Ascii.DC2, Ascii.EM, 38, 39, 52, 43, 33, 39, Ascii.GS, 43, 38, 51, 36, 50, 46, 45, 55, 36, 37, Ascii.RS, 49, 45, 32, 34, 36, 44, 36, 47, 53, Ascii.RS, 40, 37, 83, 68, 75, Ascii.DEL, 86, 69, 82, 83, 73, 79, 78, 75, 90, 82, 79, 83, 94, 75, 90, 72, 69, 76, 89};
    }
