...
public abstract class AbstractC2304Nt {
    ...
    public static Bundle A01(SQ sq) {
        ...
        bundle.putBoolean(A06(54, 13, 2), C2524Wm.A05(sq));
        return bundle;
    }

    public static Bundle A02(String str, C3037gv c3037gv) {
        Bundle bundle = new Bundle();
        A08(bundle, c3037gv.A05());
        bundle.putString(A06(451, 17, 16), c3037gv.A0A());
        bundle.putString(A06(259, 13, 76), str);
        bundle.putString(A06(292, 19, 18), c3037gv.A07());
        bundle.putString(A06(366, 19, 0), c3037gv.A08());
        bundle.putString(A06(404, 22, 98), c3037gv.A09());
        bundle.putString(A06(385, 19, 96), AbstractC2300Np.A01(c3037gv.A0B()));
        RewardData rewardDataA03 = c3037gv.A03();
        if (rewardDataA03 != null) {
            AbstractC2305Nu.A00(bundle, rewardDataA03);
        }
        C2820dL c2820dLA05 = c3037gv.A05();
        if (A01[7].charAt(1) != 'G') {
            throw new RuntimeException();
        }
        String[] strArr = A01;
        ...
        bundle.putBundle(A06(123, 19, 81), A01(c2820dLA05));
        return bundle;
    }

    public static Bundle A03(String str, C3028gm c3028gm) {
        Bundle bundle = new Bundle();
        A08(bundle, c3028gm.A0B);
        bundle.putString(A06(451, 17, 16), c3028gm.A0D);
        bundle.putString(A06(259, 13, 76), str);
        bundle.putString(A06(292, 19, 18), c3028gm.A05);
        bundle.putString(A06(366, 19, 0), c3028gm.A06);
        bundle.putString(A06(404, 22, 98), c3028gm.A07);
        AdExperienceType adExperienceType = c3028gm.A02;
        if (adExperienceType != null) {
            bundle.putString(A06(237, 22, 24), AbstractC2299No.A02(adExperienceType));
        }
        bundle.putBoolean(A06(90, 33, 27), c3028gm.A08);
        RewardData rewardData = c3028gm.A03;
        if (rewardData != null) {
            AbstractC2305Nu.A00(bundle, rewardData);
        }
        bundle.putBundle(A06(123, 19, 81), A01(c3028gm.A0B));
        return bundle;
    }

    public static C3037gv A04(C2820dL c2820dL, Bundle bundle, String str) {
        ...
        C3037gv c3037gv = new C3037gv(c2820dL, null, string, new C3032gq(str, string4, bundle2));
        c3037gv.A0I(string3);
        c3037gv.A0H(string2);
        c3037gv.A0J(sdkVersion);
        String placement6 = A06(385, 19, 96);
        c3037gv.A0K(AbstractC2300Np.A02(bundle.getString(placement6)));
        RewardData rewardDataA01 = AbstractC2305Nu.A01(bundle);
        if (rewardDataA01 != null) {
            c3037gv.A0F(rewardDataA01);
        }
        return c3037gv;
    }

    public static C3028gm A05(C2820dL c2820dL, Bundle bundle, String str) {
        String string = bundle.getString(A06(451, 17, 16));
        ...
        C3028gm c3028gm = new C3028gm(c2820dL, string, null, new C3032gq(str, string4, bundle2));
        c3028gm.A06 = adExperienceType;
        c3028gm.A05 = string2;
        c3028gm.A08 = z10;
        c3028gm.A02 = AbstractC2299No.A00(string3);
        c3028gm.A07 = mediationData;
        RewardData rewardDataA01 = AbstractC2305Nu.A01(bundle);
        if (rewardDataA01 != null) {
            c3028gm.A03 = rewardDataA01;
        }
        return c3028gm;
    }
    ...
    public static void A08(Bundle bundle, SQ sq) {
        ...
        boolean zAAK = false;
        boolean isForcedFunnelLogging = sq instanceof C2820dL;
        if (isForcedFunnelLogging) {
            zAAK = ((C2820dL) sq).A0F().AAK();
        }
        boolean isForcedFunnelLogging2 = C2427Sp.A0I(sq);
