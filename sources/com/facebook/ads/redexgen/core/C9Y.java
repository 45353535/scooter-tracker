...
public final class C9Y extends C3483od {
    ...
    public final AbstractC17592a A05;
    ...
    static {
        ...
        A0E = AbstractC18094a.A0h(1001);
        A0D = AbstractC18094a.A0h(1002);
        A0C = AbstractC18094a.A0h(1003);
        A0A = AbstractC18094a.A0h(1004);
        A0B = AbstractC18094a.A0h(1005);
        A09 = AbstractC18094a.A0h(1006);
    }
    ...
    public C9Y(int i10, Throwable th2, String str, int i11, String str2, int i12, C3497or c3497or, int i13, boolean z10) {
        this(A06(i10, th2, str, str2, i12, c3497or, i13), th2, i11, i10, str2, i12, c3497or, i13, null, SystemClock.elapsedRealtime(), z10);
    }
    ...
    public C9Y(Bundle bundle) {
        ...
        if (bundle2 == null) {
            ...
            c3497or = (C3497or) C3497or.A0b.A6X(bundle2);
        }
        this.A04 = c3497or;
    ...
    public C9Y(String str, Throwable th2, int i10, int i11, String str2, int i12, C3497or c3497or, int i13, AbstractC17592a abstractC17592a, long j10, boolean z10) {
    ...
    public static C9Y A04(Throwable th2, String str, int i10, C3497or c3497or, int i11, boolean z10, int i12) {
        int i13 = i11;
        if (c3497or == null) {
            i13 = 4;
        }
        return new C9Y(1, th2, null, i12, str, i10, c3497or, i13, z10);
    }

    public static String A06(@MetaExoPlayerCustomization(type = {"NEW_METHOD_ARGS"}, value = "Throwable cause - linked with Error reporting") int i10, Throwable th2, String str, String str2, int i11, C3497or c3497or, int i12) {
        String message;
        String strA05;
        if (str == null) {
        ...
        switch (i10) {
            ...
            case 1:
                ...
                StringBuilder sbAppend3 = sbAppend2.append(message3).append(c3497or);
                String message4 = A05(23, 19, 114);
                StringBuilder sbAppend4 = sbAppend3.append(message4);
                String message5 = AbstractC18094a.A0g(i12);
