...
public abstract class AbstractC2801d1 {
    ...
    public static Map<String, String> A01(SQ sq, String str, String str2) {
        ...
        T6 t62 = new T6(sq);
        int i10 = sq.getResources().getDisplayMetrics().widthPixels;
        int i11 = sq.getResources().getDisplayMetrics().heightPixels;
        ...
        map.put(A00(82, 12, 92), String.valueOf((int) (i10 / AbstractC2523Wl.A02)));
        map.put(A00(69, 13, 14), String.valueOf((int) (i11 / AbstractC2523Wl.A02)));
