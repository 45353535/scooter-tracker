...
public class C2238Le implements InterfaceC2516Wc {
    ...
    public C2238Le(C2236Lc c2236Lc) {
        this.A00 = c2236Lc;
    }

    public /* synthetic */ C2238Le(C2236Lc c2236Lc, C2254Lu c2254Lu) {
        this(c2236Lc);
    }
    ...
    public final void AEn(float f10) {
        ...
        if (this.A00.A0Y) {
            if (this.A00.A0E) {
                AbstractC3095hy abstractC3095hy = this.A00.A0I;
                if (A02[6].charAt(27) != 'a') {
                    throw new RuntimeException();
                }
                A02[4] = "3MuDy2E798EtOoHK0e0a3SiH1QgAy5";
                fA04 = 1.0f - (f10 / abstractC3095hy.A20().A0H().A03());
                if (this.A00.A0H || fA04 < 1.0f) {
                    ...
                    this.A00.A0H = true;
                    AbstractC2550Xm abstractC2550Xm = this.A00.A0a;
                    String strA00 = A00(0, 0, 19);
                    if (A02[3].length() != 16) {
                        abstractC2550Xm.setToolbarActionMessage(strA00);
                    } else {
                        String[] strArr = A02;
