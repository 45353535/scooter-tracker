...
public final class VV {
    ...
    private PW A01(C2820dL c2820dL, JSONObject data, long j10) throws JSONException {
        JSONArray placements = data.getJSONArray(A04(190, 10, 45));
        JSONObject jSONObject = placements.getJSONObject(0);
        TF tfA00 = TF.A00(jSONObject.getJSONObject(A04(124, 10, 90)));
        ...
        if (jSONObject.has(strA044)) {
            ...
            while (i10 < jSONArray.length()) {
                ...
                AbstractC2465Uc.A06(c2820dL, jSONObject2, j10, str);
    ...
    */
    public final com.facebook.ads.redexgen.core.VX A07(com.facebook.ads.redexgen.core.C2820dL r8, java.lang.String r9, long r10) throws org.json.JSONException {
        /*
            r7 = this;
