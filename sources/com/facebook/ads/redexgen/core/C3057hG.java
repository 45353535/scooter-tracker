...
public final class C3057hG implements InterfaceC2285Na {
    ...
    public final AbstractC3054hD A03;
    ...
    public C3057hG(C2820dL c2820dL, AbstractC3054hD abstractC3054hD) {
        this.A04 = c2820dL;
        this.A03 = abstractC3054hD;
    }
    ...
    private void A02(NZ nz, NZ nz2) {
        ...
        InterfaceC2432Su interfaceC2432SuA08 = this.A04.A08();
        int i10 = AbstractC2433Sv.A0e;
        C2434Sw c2434Sw = new C2434Sw(strA00, string);
        String errorTitle3 = A00(TsExtractor.TS_STREAM_TYPE_DTS_UHD, 3, 61);
        interfaceC2432SuA08.AAy(errorTitle3, i10, c2434Sw);
    ...
    private void A03(String str, String str2, boolean z10) {
        ...
        if (!z10) {
            Log.e(strA002, str3);
            this.A04.A08().AAy(strA00, AbstractC2433Sv.A0c, new C2434Sw(str3));
        ...
        switch (NY.A00[integrationErrorModeA00.ordinal()]) {
            case 1:
                ...
                throw new C2286Nb(errorMessage);
            case 2:
                this.A03.A08();
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2285Na
