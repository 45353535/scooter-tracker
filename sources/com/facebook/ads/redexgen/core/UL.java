...
public final class UL implements AudienceNetworkExportedActivityApi {
    ...
    private boolean A03(UK uk) {
        ...
        A02(12);
        if (uk.A00 instanceof C3041gz) {
            ((C3041gz) uk.A00).A0F().A0F().AHA();
        }
        if (uk.A00 instanceof C3038gw) {
            LH lhA0F = ((C3038gw) uk.A00).A0H().A0F();
            if (A02[6].charAt(24) == 'N') {
    ...
    public final void onCreate(Bundle bundle) {
        C2820dL c2820dLA05 = RB.A05(this.A00, UUID.randomUUID().toString());
        ...
        InterfaceC2287Nc interfaceC2287Nc = ukA04 != null ? ukA04.A00 : null;
        if (ukA04 != null && (interfaceC2287Nc instanceof C3038gw)) {
            ...
            C3038gw c3038gw = (C3038gw) interfaceC2287Nc;
            c3038gw.A0G().A01().A0J(this.A00);
            c3038gw.A0M(this.A00.getIntent().getIntExtra(A00(0, 26, 101), -1), 0L);
        } else if (ukA04 != null && (interfaceC2287Nc instanceof C3041gz)) {
            if (!A03(ukA04)) {
                return;
            }
            C3041gz c3041gz = (C3041gz) interfaceC2287Nc;
            c3041gz.A0E().A05().A0J(this.A00);
            c3041gz.A0J();
        } else {
            c2820dLA05.A0F().AHY();
            A02(13);
