...
public final class SurfaceHolderCallbackC3403nI implements InterfaceC2093Fo, C8D, InterfaceC2043Dq, B3, SurfaceHolder.Callback, TextureView.SurfaceTextureListener {
    ...
    public final /* synthetic */ void ACT(C3497or c3497or, C18445j c18445j) {
    }
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2093Fo
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2093Fo
    public final /* synthetic */ void AFl(C3497or c3497or, C18445j c18445j) {
    }

    public SurfaceHolderCallbackC3403nI(C9V c9v) {
        this.A00 = c9v;
    }
    ...
    @Override // com.facebook.ads.redexgen.core.C8D
    public final void ACQ(C18415g c18415g) {
        Iterator it = this.A00.A0H.iterator();
        while (it.hasNext()) {
            ((C8D) it.next()).ACQ(c18415g);
        }
        this.A00.A07 = null;
        this.A00.A09 = null;
        this.A00.A01 = 0;
    ...
    @Override // com.facebook.ads.redexgen.core.C8D
    public final void ACR(C18415g c18415g) {
        this.A00.A09 = c18415g;
        Iterator it = this.A00.A0H.iterator();
        while (it.hasNext()) {
            ((C8D) it.next()).ACR(c18415g);
        }
    }

    @Override // com.facebook.ads.redexgen.core.C8D
    public final void ACS(C3497or c3497or) {
        this.A00.A07 = c3497or;
        Iterator it = this.A00.A0H.iterator();
        while (it.hasNext()) {
            ((C8D) it.next()).ACS(c3497or);
        }
    }
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2043Dq
    @MetaExoPlayerCustomization(type = {"TEMPORARY"}, value = "Required until we deprecate and move ComponentListener to ExoPlayerImpl.")
    public final void ACv(C3446o0 c3446o0) {
        Iterator it = this.A00.A0I.iterator();
        while (it.hasNext()) {
            ((InterfaceC17752s) it.next()).ACv(c3446o0);
        }
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC2043Dq
    @MetaExoPlayerCustomization(type = {"TEMPORARY"}, value = "Required until we deprecate and move ComponentListener to ExoPlayerImpl.")
    public final void ACw(List<C3448o2> list) {
        Iterator it = this.A00.A0I.iterator();
        while (it.hasNext()) {
            ((InterfaceC17752s) it.next()).ACw(list);
        }
    }
    ...
    public final void AD7(int i10, long j10) {
        ...
        while (it.hasNext()) {
            ((InterfaceC2093Fo) it.next()).AD7(i10, j10);
        }
    }
    ...
    public final void AEx(Object obj, long j10) {
        ...
        while (it2.hasNext()) {
            ((InterfaceC2093Fo) it2.next()).AEx(obj, j10);
        }
    }
    ...
    public final void AFd(String str, long j10, long j11) {
        Iterator it = this.A00.A0K.iterator();
        while (it.hasNext()) {
            ((InterfaceC2093Fo) it.next()).AFd(str, j10, j11);
        }
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC2093Fo
    public final void AFe(C18415g c18415g) {
        Iterator it = this.A00.A0K.iterator();
        while (it.hasNext()) {
            ((InterfaceC2093Fo) it.next()).AFe(c18415g);
        }
        this.A00.A08 = null;
        this.A00.A0A = null;
    }
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2093Fo
    public final void AFf(C18415g c18415g) {
        this.A00.A0A = c18415g;
        Iterator it = this.A00.A0K.iterator();
        while (true) {
            boolean zHasNext = it.hasNext();
            if (A01[0].length() != 9) {
            ...
            if (zHasNext) {
                ((InterfaceC2093Fo) it.next()).AFf(c18415g);
            } else {
                return;
            }
        }
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2093Fo
    public final void AFk(C3497or c3497or) {
        this.A00.A08 = c3497or;
        Iterator it = this.A00.A0K.iterator();
        while (true) {
            boolean zHasNext = it.hasNext();
            if (A01[1].charAt(3) != 'F') {
            ...
            if (zHasNext) {
                ((InterfaceC2093Fo) it.next()).AFk(c3497or);
            } else {
                return;
            }
        }
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2093Fo
    public final void AFr(C3450o4 c3450o4) {
        Iterator it = this.A00.A0L.iterator();
        while (it.hasNext()) {
            ((InterfaceC18184j) it.next()).AFq(c3450o4.A03, c3450o4.A01, c3450o4.A02, c3450o4.A00);
        }
        for (InterfaceC2093Fo interfaceC2093Fo : this.A00.A0K) {
            String[] strArr = A01;
            if (strArr[4].length() != strArr[5].length()) {
                throw new RuntimeException();
            }
            A01[1] = "q7eFcMKXm9CoB0iVpo1HKrbod3G9GfaY";
            interfaceC2093Fo.AFr(c3450o4);
        }
    }
