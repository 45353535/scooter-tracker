...
public final class C2973fq extends MQ {
    ...
    public C2973fq(C2386Qz c2386Qz) {
        this.A02 = c2386Qz.A09();
        this.A01 = c2386Qz;
    }
    ...
    public final void A0C() {
        this.A02.A0F().A4M();
        AbstractC2498Vk.A00(new C2975fs(this));
    }

    @Override // com.facebook.ads.redexgen.core.MQ
    public final void A0D() {
        this.A02.A0F().A4P();
        AbstractC2498Vk.A00(new C2974fr(this));
    }
    ...
    public final void A0E(View view) {
        if (view != null) {
            ...
            if ((this.A00 instanceof C2216Ki) || (this.A00 instanceof Y9)) {
            ...
            AbstractC2498Vk.A00(new C2976ft(this));
            this.A01.A0B(this.A01.A07(), this.A00);
            if (U7.A1B(this.A01.A07().getContext())) {
                C2602Zm c2602Zm = new C2602Zm();
                this.A01.A0D(c2602Zm);
                c2602Zm.A0C(this.A01.getPlacementId());
                c2602Zm.A0B(this.A01.A07().getContext().getPackageName());
                if (this.A01.A08() != null && this.A01.A08().A0J() != null) {
                    c2602Zm.A09(this.A01.A08().A0J().A0C());
                }
                if (this.A00 instanceof C2216Ki) {
                    c2602Zm.A0A(((C2216Ki) this.A00).getViewabilityChecker());
                }
                this.A00.setOnLongClickListener(new R7(this, c2602Zm));
                this.A00.getOverlay().add(c2602Zm);
                return;
            }
            return;
        }
    ...
    public final void A0G(V1 v12) {
        ...
        AbstractC2498Vk.A00(new C2977fu(this, v12));
    }
}
