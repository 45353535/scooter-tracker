...
public final class C2377Qq extends Thread {
    public static byte[] A07;
    public static final String A08;
    public final int A00;
    public final Handler A01;
    public final C2379Qs A02;
    ...
    static {
        A02();
        A08 = C2377Qq.class.getName();
    }

    public C2377Qq(C2820dL c2820dL, C2379Qs c2379Qs) {
        this(c2820dL, c2379Qs, U7.A08(c2820dL));
    }

    public C2377Qq(C2820dL c2820dL, C2379Qs c2379Qs, int i10) {
        this.A01 = new Handler(Looper.getMainLooper());
        this.A04 = new RunnableC2376Qp(this);
        this.A05 = 0L;
        this.A06 = false;
        setName(A01(0, 15, 68));
        this.A00 = i10;
            ...
            while (!isInterrupted()) {
                ...
                try {
                    ...
                    if (interval2 != 0 && !this.A06 && !Debug.isDebuggerConnected()) {
                        if (this.A02.A05()) {
                            this.A03.A08().AAy(A01(15, 7, 8), AbstractC2433Sv.A1D, new C2434Sw(this.A02.A04()));
                        }
                        this.A06 = true;
                    }
