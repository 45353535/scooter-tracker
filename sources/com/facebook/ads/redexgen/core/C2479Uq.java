...
public final class C2479Uq implements NativeAdRatingApi {
    ...
    public C2479Uq(double d10, double d11) {
        this.A01 = d10;
        this.A00 = d11;
    }

    public static C2479Uq A00(JSONObject jSONObject) {
        if (jSONObject == null) {
            return null;
        }
        ...
        return new C2479Uq(dOptDouble, dOptDouble2);
    }
