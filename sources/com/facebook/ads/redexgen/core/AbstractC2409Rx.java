...
public abstract class AbstractC2409Rx {
     ...
     */
    public static C2402Rp A02(SQ sq) {
        Object objA00;
        Method methodA02;
        Object objA002;
        Method methodA022 = AbstractC2410Ry.A02(A00, A04(257, 29, 2), Context.class);
        if (methodA022 == null || (objA00 = AbstractC2410Ry.A00(null, methodA022, sq)) == null || ((Integer) objA00).intValue() != 0 || (methodA02 = AbstractC2410Ry.A02(A04(65, 57, 83), A04(232, 20, 98), Context.class)) == null || (objA002 = AbstractC2410Ry.A00(null, methodA02, sq)) == null) {
            return null;
        }
        Method methodA01 = AbstractC2410Ry.A01(objA002.getClass(), A04(252, 5, 124), new Class[0]);
        Method methodA012 = AbstractC2410Ry.A01(objA002.getClass(), A04(286, 24, 126), new Class[0]);
        if (methodA01 == null || methodA012 == null) {
            return null;
        }
        String str = (String) AbstractC2410Ry.A00(objA002, methodA01, new Object[0]);
        Boolean bool = (Boolean) AbstractC2410Ry.A00(objA002, methodA012, new Object[0]);
        if (str != null) {
            return new C2402Rp(str, bool != null && bool.booleanValue(), EnumC2401Ro.A06);
        }
        return null;
    }
    ...
    */
    public static com.facebook.ads.redexgen.core.C2402Rp A00(com.facebook.ads.redexgen.core.SQ r5) {
        /*
            ...
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.AbstractC2409Rx.A02
            r0 = 5
            r1 = r1[r0]
            r0 = 3
            ...
            throw r0
        L2c:
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.AbstractC2409Rx.A02
        ...
        L4a:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.AbstractC2409Rx.A00(com.facebook.ads.redexgen.X.SQ):com.facebook.ads.redexgen.X.Rp");
    }

    public static C2402Rp A01(SQ sq) {
        SU adId = sq.A05().A8p();
        if (adId != null) {
            return new C2402Rp(adId.getId(), adId.AAO(), EnumC2401Ro.A02);
        }
        return null;
    }

    /* JADX WARN: Type inference failed for: r0v9, types: [com.facebook.ads.internal.attribution.GmsAttributionProvider$GoogleAdInfo] */
    public static C2402Rp A03(SQ sq) {
        ServiceConnectionC2408Rw serviceConnectionC2408Rw = new ServiceConnectionC2408Rw();
        Intent intent = new Intent(A04(122, 51, 31));
        intent.setPackage(A04(43, 22, 97));
        if (sq.bindService(intent, serviceConnectionC2408Rw, 1)) {
            try {
                final IBinder iBinderA02 = serviceConnectionC2408Rw.A02();
                ...
                return new C2402Rp(r02.A02(), r02.A03(), EnumC2401Ro.A07);
            } catch (Throwable th2) {
                try {
                    sq.A08().AAy(A04(Sdk.SDKError.Reason.AD_LOAD_FAIL_PLACEMENT_ID_MISMATCH_VALUE, 7, 73), AbstractC2433Sv.A1Q, new C2434Sw(th2));
                } finally {
                    sq.unbindService(serviceConnectionC2408Rw);
                }
            }
        }
        return null;
