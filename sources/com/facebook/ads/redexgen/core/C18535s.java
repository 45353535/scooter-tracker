...
public final class C18535s extends FH {
    ...
    public C18535s(C17140h c17140h, int i10, List<C2787cn> list, C2893eX c2893eX, Bundle bundle) {
        super(c17140h, i10, list, c2893eX, bundle);
        c17140h.A1h(this);
    ...
    public final void A0M(C18676g c18676g, int i10, int i11) {
        if (this.A0C.A25() != -1) {
            AbstractC2173Ir curCard = (AbstractC2173Ir) this.A0C.A1o(this.A0C.A25());
    ...
    @Override // com.facebook.ads.redexgen.core.FH
    public final void A0Z(AbstractC2173Ir abstractC2173Ir, boolean z10) {
    ...
    public final void A0c(C2893eX c2893eX) {
        this.A04 = c2893eX;
    }

    public final void A0d(List<C2787cn> list) {
        this.A05 = list;
    }
}
