...
public final class C2Z extends AbstractC2027Da implements View.OnClickListener {
    public final DX A00;
    public final DR A01;
    public final DP A02;
    public final DN A03;
    public final C2860e0 A04;

    public C2Z(C2820dL c2820dL) {
        this(c2820dL, null);
    }

    public C2Z(C2820dL c2820dL, AttributeSet attributeSet) {
        this(c2820dL, attributeSet, 0);
    }

    public C2Z(C2820dL c2820dL, AttributeSet attributeSet, int i10) {
    ...
    public final void onClick(View view) throws Throwable {
        ...
        try {
            ...
            if (videoView.getState() == EnumC2890eU.A07 || videoView.getState() == EnumC2890eU.A05 || videoView.getState() == EnumC2890eU.A06) {
                videoView.A0h(EnumC2836db.A04, 11);
            } else if (videoView.getState() == EnumC2890eU.A0A) {
