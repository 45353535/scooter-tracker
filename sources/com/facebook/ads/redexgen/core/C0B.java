...
public class C0B extends C0E {
    ...
    @Override // com.facebook.ads.redexgen.core.P2
    public final void A0E(View view, InterfaceC2322On interfaceC2322On) {
        if (interfaceC2322On == null) {
            view.setOnApplyWindowInsetsListener(null);
        } else {
            view.setOnApplyWindowInsetsListener(new P1(this, interfaceC2322On));
        }
    }
}
