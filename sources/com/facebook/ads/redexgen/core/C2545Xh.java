...
public final class C2545Xh {
    ...
    static {
        A02();
        A02 = C2545Xh.class.getSimpleName();
    }

    public static Map<String, String> A01(@Nullable C2820dL c2820dL) {
        Window window;
        ...
        try {
            map.put(A00(40, 3, 0), String.valueOf(A04(c2820dL)));
            ...
            InterfaceC2432Su interfaceC2432SuA08 = c2820dL.A08();
            int type3 = AbstractC2433Sv.A2T;
            interfaceC2432SuA08.AAy(A00(43, 5, 77), type3, new C2434Sw(e10));
        }
        return map;
    }

    public static boolean A03(C2820dL c2820dL) {
        return !XQ.A04(A01(c2820dL));
    }

    public static boolean A04(C2820dL c2820dL) {
        KeyguardManager keyguardManager = (KeyguardManager) c2820dL.getSystemService(A00(32, 8, 57));
