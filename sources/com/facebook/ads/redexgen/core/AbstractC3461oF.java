...
public abstract class AbstractC3461oF<K0> {
    ...
    private final AW<K0, Object> A00(final int expectedValuesPerKey) {
        AbstractC3309ll.A00(expectedValuesPerKey, A01(0, 20, 35));
        return new AW<K0, Object>() { // from class: com.facebook.ads.redexgen.X.1c
            @Override // com.facebook.ads.redexgen.core.AW
            public final <K extends K0, V> InterfaceC1959Ah<K, V> A00() {
                return AbstractC3465oJ.A00(this.A01.A04(), new AX(expectedValuesPerKey));
            }
        };
    }
