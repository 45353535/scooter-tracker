...
public final class C2259Lz extends Y3 {
    public C17913i A00;
    public boolean A01;
    public boolean A02;
    ...
    public final D3 A0A;
    public final D1 A0B;
    public final AbstractC2892eW A0C;
    public final C2893eX A0D;

    public C2259Lz(C2820dL c2820dL, US us, SF sf2, C2463Ua c2463Ua, View.OnClickListener onClickListener) {
        ...
        this.A07 = new DX() { // from class: com.facebook.ads.redexgen.X.63
            ...
            public final void A03(C17863d c17863d) {
                ...
                this.A00.A06.A0h(EnumC2836db.A02, 30);
            }
        };
        ...
        this.A0C = A00();
        this.A0D = A07();
        this.A03 = new FrameLayout(c2820dL);
        addView(this.A03, new RelativeLayout.LayoutParams(-1, -1));
        this.A06 = A01(c2463Ua);
        this.A0A = A04();
        this.A09 = A03();
        this.A0B = A06(c2463Ua);
        A0C();
    }
    ...
    private E1 A01(C2463Ua c2463Ua) {
        E1 e12 = new E1(super.A01);
        XP.A0I(e12);
        e12.setFunnelLoggingHandler(c2463Ua);
    ...
    private D1 A06(C2463Ua c2463Ua) {
        D1 d12 = new D1(super.A01, c2463Ua, true);
    ...
    private C2893eX A07() {
        return new C2893eX(this, 50, true, new WeakReference(this.A0C), super.A01);
    }
    ...
    public final C2259Lz A0F(String str, String str2, String str3, String str4, String str5) {
        this.A06.setVideoURI(this.A04.A0T(str2));
        this.A00 = new C17913i(super.A01, this.A05, this.A06, str);
