...
public final class IY {
    ...
    public boolean A06;
    public final H1 A08;
    public final C2170Io A09 = new C2170Io();
    ...
    public final int A04(int i10, int i11) {
        C4J c4j;
        int length;
        C2169In c2169InA07 = A07();
        if (c2169InA07 == null) {
            return 0;
        }
        if (c2169InA07.A00 != 0) {
            c4j = this.A09.A0H;
            length = c2169InA07.A00;
        } else {
            byte[] bArr = (byte[]) AbstractC18094a.A0f(c2169InA07.A04);
    ...
    public IY(H1 h12, C2171Ip c2171Ip, IP ip) {
        this.A08 = h12;
        this.A05 = c2171Ip;
        this.A04 = ip;
        A0C(c2171Ip, ip);
    ...
    public final C2169In A07() {
        C2169In c2169InA00;
        if (!this.A06) {
            return null;
        }
        int i10 = ((IP) AbstractC18094a.A0f(this.A09.A06)).A02;
        if (this.A09.A07 != null) {
            c2169InA00 = this.A09.A07;
        } else {
            c2169InA00 = this.A05.A03.A00(i10);
        }
        if (c2169InA00 == null || !c2169InA00.A03) {
            return null;
        }
        C2169In encryptionBox = c2169InA00;
    ...
    */
    ...
    public final void A0B(DrmInitData drmInitData) {
        C2169In encryptionBox = this.A05.A03.A00(((IP) AbstractC18094a.A0f(this.A09.A06)).A02);
        this.A08.A6W(this.A05.A03.A07.A07().A0u(drmInitData.A01(encryptionBox != null ? encryptionBox.A02 : null)).A14());
    }

    public final void A0C(C2171Ip c2171Ip, IP ip) {
        this.A05 = c2171Ip;
        this.A04 = ip;
        this.A08.A6W(c2171Ip.A03.A07);
        A08();
    }
