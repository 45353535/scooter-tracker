...
public class BG<K, V> extends AbstractC3444ny<K, Collection<V>> {
    public final transient Map<K, Collection<V>> A00;
    public final /* synthetic */ AbstractC17411i A01;
    ...
    public BG(final AbstractC17411i this$0, Map<K, Collection<V>> submap) {
        this.A01 = this$0;
        this.A00 = submap;
    }
    ...
    public final Collection<V> get(@CheckForNull Object key) {
        Collection<V> collection = (Collection) AbstractC3445nz.A05(this.A00, key);
        if (collection == null) {
            return null;
        }
    ...
    public final Collection<V> remove(@CheckForNull Object key) {
        ...
        AbstractC17411i.A03(this.A01, collectionRemove.size());
        collectionRemove.clear();
        return collectionA0D;
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.BG != com.google.common.collect.AbstractMapBasedMultimap<K, V>$AsMap */
    @Override // com.facebook.ads.redexgen.core.AbstractC3444ny
    public final Set<Map.Entry<K, Collection<V>>> A09() {
        return new AbstractC1955Ad<K, Collection<V>>() { // from class: com.facebook.ads.redexgen.X.1m
            ...
            @Override // com.facebook.ads.redexgen.core.AbstractC1955Ad
            ...
            public final boolean contains(@CheckForNull Object o10) {
                return AbstractC3314lq.A03(this.A00.A00.entrySet(), o10);
            }

            /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.1m != com.google.common.collect.AbstractMapBasedMultimap<K, V>$AsMap$AsMapEntries */
            @Override // java.util.AbstractCollection, java.util.Collection, java.lang.Iterable, java.util.Set
            public final Iterator<Map.Entry<K, Collection<V>>> iterator() {
                return new C3226kD(this.A00);
            }
    ...
    public final Map.Entry<K, Collection<V>> A0A(Map.Entry<K, Collection<V>> entry) {
        K key = entry.getKey();
        return AbstractC3445nz.A01(key, this.A01.A0F(key, entry.getValue()));
    }
    ...
    public final void clear() {
        if (this.A00 == this.A01.A01) {
            ...
            AbstractC3406nL.A0A(new C3226kD(this));
        }
    }
    ...
    public final boolean containsKey(@CheckForNull Object key) {
        return AbstractC3445nz.A0C(this.A00, key);
    }
