...
public final class C3214k1 implements GX {
    ...
    public static final InterfaceC2106Gb A04 = new InterfaceC2106Gb() { // from class: com.facebook.ads.redexgen.X.k2
    ...
    public final int AGb(InterfaceC3286lN interfaceC3286lN, C2124Gt c2124Gt) throws IOException {
        int i10 = interfaceC3286lN.read(this.A01.A0l(), 0, 2786);
        if (i10 == -1) {
            return -1;
        }
        this.A01.A0f(0);
    ...
    public final boolean AJL(InterfaceC3286lN interfaceC3286lN) throws IOException {
        ...
        int i10 = 0;
        while (true) {
            interfaceC3286lN.AG9(c4j.A0l(), 0, 10);
            c4j.A0f(0);
            if (c4j.A0K() != 4801587) {
                ...
                int startPosition = 0;
                while (true) {
                    interfaceC3286lN.AG9(c4j.A0l(), 0, 6);
                    c4j.A0f(0);
                    ...
                    if (headerPosition != 2935) {
                        ...
                        interfaceC3286lN.A3z(headerPosition3 - 6);
                    }
                }
            } else {
                c4j.A0g(3);
