...
public abstract class AbstractC2362Qb {
    ...
    public void A04(int i10, int i11) {
        ...
        if (!this.A05 || this.A00 == -1 || c18676g == null) {
            A09();
        }
        this.A04 = false;
        if (this.A01 != null) {
            if (A00(this.A01) == this.A00) {
                A0I(this.A01, c18676g.A0s, this.A06);
                this.A06.A05(c18676g);
                A09();
            } else {
        ...
        if (this.A05) {
            A0H(i10, i11, c18676g.A0s, this.A06);
    ...
    public final void A0D(C18676g c18676g, QO qo) {
        this.A03 = c18676g;
        this.A02 = qo;
        if (this.A00 != -1) {
