...
public final class C3505p0 implements C1S {
    ...
    public static final C3505p0 A08;
    public static final C1R<C3505p0> A09;
    public static final C3506p1 A0A;
    ...
    public final C3506p1[] A05;

    /* JADX WARN: Failed to parse debug info
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static C3505p0 A00(Bundle bundle) {
        C3506p1[] c3506p1Arr;
        ArrayList parcelableArrayList = bundle.getParcelableArrayList(A0B);
        if (parcelableArrayList == null) {
            c3506p1Arr = new C3506p1[0];
        } else {
            c3506p1Arr = new C3506p1[parcelableArrayList.size()];
            for (int i10 = 0; i10 < parcelableArrayList.size(); i10++) {
                c3506p1Arr[i10] = (C3506p1) C3506p1.A09.A6X((Bundle) parcelableArrayList.get(i10));
            }
        }
        return new C3505p0(null, c3506p1Arr, bundle.getLong(A0C, A08.A02), bundle.getLong(A0D, A08.A03), bundle.getInt(A0E, A08.A01));
    }
    ...
    static {
        A03();
        A08 = new C3505p0(null, new C3506p1[0], 0L, -9223372036854775807L, 0);
        A0A = new C3506p1(0L).A06(0);
        A0B = AbstractC18094a.A0h(1);
        A0C = AbstractC18094a.A0h(2);
        A0D = AbstractC18094a.A0h(3);
        A0E = AbstractC18094a.A0h(4);
        A09 = new C1R() { // from class: com.facebook.ads.redexgen.X.p3
            @Override // com.facebook.ads.redexgen.core.C1R
            public final C1S A6X(Bundle bundle) {
                return C3505p0.A00(bundle);
            }
        };
    }

    public C3505p0(Object obj, C3506p1[] c3506p1Arr, long j10, long j11, int i10) {
        this.A04 = obj;
        this.A02 = j10;
        this.A03 = j11;
        this.A00 = c3506p1Arr.length + i10;
        this.A05 = c3506p1Arr;
        this.A01 = i10;
    }
    ...
    public final C3506p1 A07(int i10) {
        if (i10 < this.A01) {
            return A0A;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        C3505p0 c3505p0 = (C3505p0) obj;
        if (AbstractC18094a.A1E(this.A04, c3505p0.A04) && this.A00 == c3505p0.A00 && this.A02 == c3505p0.A02 && this.A03 == c3505p0.A03 && this.A01 == c3505p0.A01) {
            C3506p1[] c3506p1Arr = this.A05;
            String[] strArr = A07;
            if (strArr[5].length() == strArr[1].length()) {
                throw new RuntimeException();
            }
            ...
            if (Arrays.equals(c3506p1Arr, c3505p0.A05)) {
                return true;
            }
        }
        return false;
