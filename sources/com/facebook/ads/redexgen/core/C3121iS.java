...
public final class C3121iS implements MP, NG {
    ...
    public static void A05() {
        A0B = new byte[]{-37, -7, 6, -65, Ascii.FF, -72, Ascii.VT, Ascii.FF, -7, 10, Ascii.FF, -72, -39, 13, -4, 1, -3, 6, -5, -3, -26, -3, Ascii.FF, Ascii.SI, 7, 10, 3, -39, -5, Ascii.FF, 1, Ascii.SO, 1, Ascii.FF, 17, -58, -72, -27, -7, 3, -3, -72, Ascii.VT, 13, 10, -3, -72, Ascii.FF, 0, -7, Ascii.FF, -72, 1, Ascii.FF, -65, Ascii.VT, -72, 1, 6, -72, 17, 7, 13, 10, -72, -39, 6, -4, 10, 7, 1, -4, -27, -7, 6, 1, -2, -3, Ascii.VT, Ascii.FF, -58, Ascii.DLE, 5, 4, -72, -2, 1, 4, -3, -58, -16, -20, -21, Ascii.US, Ascii.SO, 19, Ascii.SI, Ascii.CAN, 13, Ascii.SI, -8, Ascii.SI, Ascii.RS, 33, Ascii.EM, Ascii.FS, Ascii.NAK, -55, -48, -35, -50, -48, -46, -29, -40, -27, -40, -29, -24, -1, -9, -10, -5, -13, 6, -5, 1, 0, -42, -13, 6, -13, Ascii.DLE, Ascii.FF, 1, 3, 5, 13, 5, Ascii.SO, Ascii.DC4, -23, 4, -55, -53, -66, -67, -66, -65, -62, -57, -66, -67, -88, -53, -62, -66, -57, -51, -70, -51, -62, -56, -57, -92, -66, -46, -7, -20, -8, -4, -20, -6, -5, -37, -16, -12, -20, -6, -13, -18, -10, -6, -22, -50, -23, 34, Ascii.NAK, 17, 35, 0, 37, Ascii.FS, 17, Ascii.FF, -2, 3, -7, 4, Ascii.FF};
    }
    ...
    private int A00() {
        ...
        EnumC2609Zt enumC2609ZtA02 = A02();
        if (enumC2609ZtA02 == EnumC2609Zt.A05) {
            String[] strArr = A0C;
            String str = strArr[4];
        ...
        } else if (enumC2609ZtA02 == EnumC2609Zt.A03) {
            switch (rotation) {
                case 2:
                case 3:
    ...
    private final EnumC2490Vb A01() {
        return this.A04.A0E();
    }

    private EnumC2609Zt A02() {
        return this.A04.A0F();
    }
    ...
    private void A06(Intent intent) {
        this.A04.A0I(intent, this.A01, C2817dI.A03(this.A01, this.A0A, this.A06));
    }

    private final void A07(C2820dL c2820dL, InterfaceC2260Ma interfaceC2260Ma, NU nu, EnumSet<CacheFlag> cacheFlags, String str) {
        NH nh2 = new NH(c2820dL, nu, this, str);
        AbstractC2273Mo abstractC2273MoA0D = nh2.A0D();
        if (U7.A0v(c2820dL) && (abstractC2273MoA0D instanceof AbstractC3095hy) && ML.A06(this.A05, ML.A01(c2820dL, nu.A03(), ((AbstractC3095hy) abstractC2273MoA0D).A25()), c2820dL.A0A())) {
            this.A05.A0F().A4u();
            this.A02.ADc(this, AdError.NO_FILL);
        } else {
            this.A04 = nh2;
            A08(nh2.A0E());
            nh2.A0J(c2820dL, cacheFlags);
        }
    }

    private void A08(EnumC2490Vb enumC2490Vb) {
        if (enumC2490Vb.equals(EnumC2490Vb.A04)) {
            this.A05.A0F().AJ9(LT.A05);
            return;
        }
        if (enumC2490Vb.equals(EnumC2490Vb.A0A)) {
            this.A05.A0F().AJ9(LT.A04);
            return;
        }
        if (enumC2490Vb.equals(EnumC2490Vb.A0B)) {
            this.A05.A0F().AJ9(LT.A0B);
            return;
        }
        if (enumC2490Vb.equals(EnumC2490Vb.A0D)) {
            this.A05.A0F().AJ9(LT.A0D);
            return;
        }
        if (enumC2490Vb.equals(EnumC2490Vb.A0C)) {
            this.A05.A0F().AJ9(LT.A0C);
            return;
        }
        if (!enumC2490Vb.equals(EnumC2490Vb.A06)) {
            return;
        }
        if (this.A04.A0K()) {
        ...
        if ((A09() instanceof AbstractC3095hy) && this.A04.A0L((AbstractC3095hy) A09())) {
    ...
    public final AbstractC2273Mo A09() {
        return this.A04.A0D();
    }

    public final void A0A(C2820dL c2820dL, InterfaceC2260Ma interfaceC2260Ma, NU nu, EnumSet<CacheFlag> enumSet, String str, String str2, RewardData rewardData) {
        this.A05 = c2820dL;
        this.A02 = interfaceC2260Ma;
        this.A08 = nu.A02();
        this.A06 = this.A08 != null ? this.A08.split(A03(107, 1, 22))[0] : A03(0, 0, 85);
        this.A00 = nu.A00();
        this.A07 = str2;
        this.A01 = rewardData;
        A07(c2820dL, interfaceC2260Ma, nu, enumSet, str);
    }
    ...
    public final boolean A0B() {
        ...
        EnumC2490Vb enumC2490VbA01 = A01();
        A08(enumC2490VbA01);
        adActivityIntentA05.putExtra(A03(186, 8, 88), enumC2490VbA01);
        if (this.A07 != null) {
        ...
        try {
            ...
            this.A05.A08().AAy(A03(108, 11, 27), AbstractC2433Sv.A0D, new C2434Sw(cause2));
    ...
    public final void AGo() {
        this.A03 = new C2261Mb(this.A05, this.A0A, this, this.A02);
        this.A03.A02();
    }
