...
public final class C2771cX extends LinearLayout {
    public LinearLayout A00;
    public String A01;
    public boolean A02;
    public final int A03;
    public final C2820dL A04;
    public final C2634aK A05;
    public final C2640aQ A06;
    ...
    public static final int A0B = (int) (AbstractC2523Wl.A02 * 32.0f);
    public static final int A0C = (int) (AbstractC2523Wl.A02 * 16.0f);
    public static final int A09 = (int) (AbstractC2523Wl.A02 * 4.0f);
    public static final int A08 = (int) (AbstractC2523Wl.A02 * 72.0f);

    public C2771cX(C2769cV c2769cV) {
        super(c2769cV.A08);
        this.A02 = false;
        this.A01 = "";
        this.A04 = c2769cV.A08;
        this.A05 = new C2634aK(this.A04);
        this.A06 = new C2640aQ(this.A04, c2769cV.A01, true, false, true);
        this.A03 = c2769cV.A00;
        this.A02 = c2769cV.A05;
        this.A01 = c2769cV.A04;
        A03(c2769cV);
    }

    public /* synthetic */ C2771cX(C2769cV c2769cV, C2096Fr c2096Fr) {
        this(c2769cV);
    }
    ...
    private void A02(C2769cV c2769cV) {
        if (!TextUtils.isEmpty(c2769cV.A03)) {
            ...
            textView.setText(c2769cV.A03);
            LinearLayout.LayoutParams layoutParams2 = new LinearLayout.LayoutParams(-2, -2);
            ImageView imageView = new ImageView(getContext());
            new KZ(imageView, this.A04).A04().A07(c2769cV.A02);
            int i13 = A0A;
            int marginTop2 = A0A;
            ...
            if (this.A02) {
                C2628aE c2628aE = new C2628aE(getContext(), 0, -1, XX.PLAYABLE_ICON);
                c2628aE.setLayoutParams(new LinearLayout.LayoutParams(A0B, A0B));
                this.A00.addView(c2628aE);
            } else {
    ...
    private void A03(C2769cV c2769cV) {
        XP.A0K(this.A05, 0);
        this.A05.setRadius(50);
        if (!this.A02) {
            if (c2769cV.A06.A00() == EnumC2279Mu.A05) {
                this.A05.setFullCircleCorners(true);
            } else {
                C2634aK c2634aK = this.A05;
                int i10 = A09;
                String[] strArr = A07;
                ...
                c2634aK.setRadius(i10);
            }
        } else {
            this.A05.setRadius(A09);
        }
        new KZ(this.A05, this.A04).A04().A07(c2769cV.A07.A01());
        this.A06.A04(c2769cV.A06.A0F(), c2769cV.A07.A03(), null, false, true);
        if (!this.A02) {
    ...
    public final void A04(InterfaceC2770cW interfaceC2770cW) {
        A00();
        postDelayed(new C2096Fr(this, interfaceC2770cW), this.A03);
    }
}
