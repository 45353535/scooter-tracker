...
public final class ViewOnAttachStateChangeListenerC2489Va extends AbstractC3542ps implements View.OnAttachStateChangeListener {
    ...
    public ViewOnAttachStateChangeListenerC2489Va(View view, C2794cu c2794cu) {
        ...
        if (A05()) {
            try {
                ...
                this.A01.A08().AAy(A00(Sdk.SDKError.Reason.TPAT_RETRY_FAILED_VALUE, 14, 83), 3600, new C2434Sw(A00(0, 45, 1) + th2.getMessage()));
            }
        }
    }
    ...
    public final void A04() {
        try {
            ...
            this.A01.A08().AAy(A00(Sdk.SDKError.Reason.TPAT_RETRY_FAILED_VALUE, 14, 83), 3600, new C2434Sw(A00(45, 48, 117) + th2.getMessage()));
        }
    }
    ...
    public final void onViewDetachedFromWindow(View view) {
        try {
            ...
            this.A01.A08().AAy(A00(Sdk.SDKError.Reason.TPAT_RETRY_FAILED_VALUE, 14, 83), 3600, new C2434Sw(A00(93, 44, 25) + th2.getMessage()));
        }
    }
}
