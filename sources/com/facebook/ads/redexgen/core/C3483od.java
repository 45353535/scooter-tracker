...
public class C3483od extends Exception implements C1S {
    public final int A00;
    public final long A01;
    public static final String A03 = AbstractC18094a.A0h(0);
    public static final String A04 = AbstractC18094a.A0h(1);
    public static final String A07 = AbstractC18094a.A0h(2);
    public static final String A05 = AbstractC18094a.A0h(3);
    public static final String A06 = AbstractC18094a.A0h(4);
    public static final C1R<C3483od> A02 = new C1R() { // from class: com.facebook.ads.redexgen.X.oe
        @Override // com.facebook.ads.redexgen.core.C1R
        public final C1S A6X(Bundle bundle) {
            return new C3483od(bundle);
        }
    };

    public C3483od(Bundle bundle) {
        this(bundle.getString(A07), A09(bundle), bundle.getInt(A03, 1000), bundle.getLong(A04, SystemClock.elapsedRealtime()));
    }

    public C3483od(String str, Throwable th2, int i10, long j10) {
        super(str, th2);
        this.A00 = i10;
        this.A01 = j10;
    }
    ...
    public static Throwable A09(Bundle bundle) {
        ...
        try {
            Class<?> cls = Class.forName(string, true, C3483od.class.getClassLoader());
