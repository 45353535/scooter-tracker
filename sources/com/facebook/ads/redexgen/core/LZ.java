...
public final class LZ implements InterfaceC2552Xo {
    ...
    public final DX A09 = new DX() { // from class: com.facebook.ads.redexgen.X.5v
        ...
        public final void A03(C17863d c17863d) {
            this.A00.A06.A4c(A00(0, 21, 51), c17863d);
        }
    };
    ...
    public LZ(C2820dL c2820dL, YT yt, US us, InterfaceC2551Xn interfaceC2551Xn) {
        this.A04 = c2820dL;
        this.A05 = us;
        this.A07 = yt;
        this.A08 = new E1(c2820dL);
        this.A08.A0i(new C3D(c2820dL));
        ...
        interfaceC2551Xn.A3x(this.A08, layoutParams);
        C2559Xv closeButton = new C2559Xv(c2820dL);
        closeButton.setOnClickListener(new YR(this));
        RelativeLayout.LayoutParams params = closeButton.getDefaultLayoutParams();
        interfaceC2551Xn.A3x(closeButton, params);
    }
    ...
    public final void AAl(Intent intent, Bundle bundle, R0 r02) {
        ...
        if (stringExtra != null && !stringExtra.isEmpty()) {
            C2785cl c2785cl = new C2785cl(this.A04, stringExtra);
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, -2);
            int i10 = (int) (16.0f * AbstractC2523Wl.A02);
            layoutParams.setMargins(i10, i10, i10, i10);
            layoutParams.addRule(10);
            layoutParams.addRule(9);
            c2785cl.setOnClickListener(new YS(this));
            this.A06.A3x(c2785cl, layoutParams);
        }
        this.A00 = intent.getIntExtra(A02(77, 13, 119), 0);
        this.A02 = new C17913i(this.A04, this.A05, this.A08, this.A03, intent.getBundleExtra(A02(58, 11, 65)), null);
        if (U7.A1v(this.A04)) {
        ...
        if (intent.getBooleanExtra(A02(0, 8, 43), false)) {
            this.A08.A0h(EnumC2836db.A04, 17);
        }
    }
    ...
    public final void AF0(boolean z10) {
        ...
        if (!this.A08.A0r()) {
            this.A08.A0h(EnumC2836db.A04, 18);
        }
    }
