...
public final class C2236Lc extends RelativeLayout implements InterfaceC2552Xo {
    ...
    public boolean A0G;
    public boolean A0H;
    public final AbstractC3095hy A0I;
    public final NB A0J;
    public final R6 A0K;
    public final C2820dL A0L;
    public final US A0M;
    public final C2463Ua A0N;
    public final C2517Wd A0O;
    public final XC A0P;
    public final InterfaceC2551Xn A0Q;
    public final YY A0R;
    public final InterfaceC2631aH A0S;
    public final C2632aI A0T;
    public final C2804d4 A0U;
    public final AtomicBoolean A0V;
    public final AtomicBoolean A0W;
    public final boolean A0X;
    public final boolean A0Y;
    public final boolean A0Z;
    public final AbstractC2550Xm A0a;
    ...
    public static void A0N() {
        A0b = new byte[]{124, 85, 123, 83, 69, 67, 83, 125, 49, 62, 59, 49, 57, 13, 61, 32, 59, 53, 59, 60, Ascii.SI, 0, 5, Ascii.SI, 7, 51, Ascii.US, 3, Ascii.EM, Ascii.RS, Ascii.SI, 9, 62, 57, 35, 50, 37, 36, 35, 62, 35, 62, 54, 59, 87, 88, 77, 80, 79, 92, 102, 90, 85, 80, 90, 82, 65, 93, 80, 82, 84, 92, 84, 95, 69, 104, Ascii.DEL, 109, 123, 104, 126, Ascii.DEL, 126, 69, 108, 115, 126, Ascii.DEL, 117, Ascii.RS, Ascii.FF, Ascii.VT, Ascii.US, 0, Ascii.FF, Ascii.RS, 54, 10, 5, 0, 10, 2};
    }

    static {
        A0N();
        A0o = (int) (AbstractC2523Wl.A02 * 64.0f);
        A0g = (int) (AbstractC2523Wl.A02 * 16.0f);
        A0p = (int) (AbstractC2523Wl.A02 * 12.0f);
        A0e = (int) (AbstractC2523Wl.A02 * 10.0f);
        A0q = new RelativeLayout.LayoutParams(-1, -1);
        A0h = (int) (AbstractC2523Wl.A02 * 48.0f);
        A0i = (int) (AbstractC2523Wl.A02 * 16.0f);
        A0n = (int) (AbstractC2523Wl.A02 * 14.0f);
        A0l = (int) (AbstractC2523Wl.A02 * 12.0f);
        A0m = OP.A02(-1, 77);
        A0d = (int) (AbstractC2523Wl.A02 * 8.0f);
        A0j = (int) (AbstractC2523Wl.A02 * 20.0f);
        A0k = (int) (AbstractC2523Wl.A02 * 13.0f);
        A0f = (int) (AbstractC2523Wl.A02 * 8.0f);
    }

    public C2236Lc(C2820dL c2820dL, US us, InterfaceC2551Xn interfaceC2551Xn, AbstractC3095hy abstractC3095hy, String str, YY yy, C2799cz c2799cz) {
        this(c2820dL, us, interfaceC2551Xn, abstractC3095hy, str, yy, false, c2799cz);
    }

    public C2236Lc(C2820dL c2820dL, US us, InterfaceC2551Xn interfaceC2551Xn, AbstractC3095hy abstractC3095hy, String str, YY yy, boolean z10, C2799cz c2799cz) {
        int iA08;
        super(c2820dL);
        String strA0D = A0D(0, 0, 113);
        this.A0A = strA0D;
        this.A09 = strA0D;
        this.A0K = new C2254Lu(this);
        ...
        this.A0Z = z10;
        this.A0L = c2820dL;
        this.A0Q = interfaceC2551Xn;
        this.A0M = us;
        this.A0I = abstractC3095hy;
        this.A0J = abstractC3095hy.A20().A0H().A07();
        this.A0N = new C2463Ua(this.A0I.A25(), this.A0M);
        this.A0R = yy;
        this.A08 = new C2817dI(c2820dL, this.A0R, str, this.A0Q);
        if (abstractC3095hy.A20().A0H().A07() != null) {
            this.A0D = abstractC3095hy.A20().A0H().A07().A0N();
            this.A0A = abstractC3095hy.A20().A0H().A07().A0H();
            this.A09 = abstractC3095hy.A20().A0H().A07().A0G();
        }
        ...
        C2254Lu c2254Lu = null;
        this.A0O = new C2517Wd(iA08, new C2238Le(this, c2254Lu));
        this.A0X = U7.A0o(this.A0L);
        this.A0a = A07();
        if (this.A0J.A0P()) {
            this.A0a.A06();
        }
        this.A0U = new C2804d4(this.A0L, this.A0M, this.A0I);
        AbstractC2641aR.A00(c2820dL, this, abstractC3095hy.A20().A0H().A08());
        this.A0P = new XC(this);
        this.A0P.A05(XB.A02);
        if (U7.A2D(this.A0L)) {
            this.A0a.setProgressSpinnerInvisible(true);
        }
        C2237Ld c2237Ld = new C2237Ld(this, c2254Lu);
        if (c2799cz == null) {
            HashMap map = new HashMap();
            map.put(A0D(56, 9, 90), this.A0R.A8d());
            this.A07 = new C2799cz(this.A0L, this.A0I, this.A0J, this.A0M, c2237Ld, map);
        } else {
            this.A07 = c2799cz;
            this.A07.setPlayableAdsViewListener(c2237Ld);
        }
        A0K();
        this.A0Q.A3x(this, new RelativeLayout.LayoutParams(-1, -1));
        A0H();
        this.A0S = new C2251Lr(this);
        this.A0T = new C2632aI(this.A0L, this.A0a, this.A0I, (E1) null, this.A0Q, this.A0S, this.A06, this.A01, this.A07);
    ...
    private FullScreenAdToolbar A07() {
        ...
        fullScreenAdToolbar.setToolbarListener(new C2239Lf(this));
    ...
    private C2640aQ A0B() {
        C2820dL c2820dL = this.A0L;
        C2283My c2283MyA01 = this.A0I.A1z().A01();
        ...
        C2640aQ c2640aQ = new C2640aQ(c2820dL, c2283MyA01, true, i10, !z10 ? 14 : 13, 0);
        c2640aQ.A04(this.A0I.A20().A0I().A0F(), this.A0I.A20().A0I().A0E(), null, false, true);
        TextView descriptionTv = c2640aQ.getDescriptionTextView();
        descriptionTv.setAlpha(0.8f);
        descriptionTv.setMaxLines(1);
        descriptionTv.setEllipsize(TextUtils.TruncateAt.END);
        TextView descriptionTv2 = c2640aQ.getTitleTextView();
    ...
    private void A0G() {
        ...
        C2634aK c2634aK = new C2634aK(this.A0L);
        XP.A0K(c2634aK, 0);
        XP.A0I(c2634aK);
        new KZ(c2634aK, this.A0L).A05(A0h, A0h).A07(this.A0I.A23().A01());
        ...
        C2636aM c2636aM = new C2636aM(this.A0L, !this.A0D ? A0n : A0l, 5, A0m, -1);
        ...
        linearLayout.addView(c2636aM, layoutParams2);
        ...
        ratingInfoContainerParams.addRule(1, c2634aK.getId());
        ...
        if (this.A02 != null) {
            ...
            this.A02.addView(c2634aK, layoutParams);
        }
        ...
        c2636aM.setRating(Float.parseFloat(this.A0I.A20().A0I().A0B()));
        ...
        if (!this.A0D) {
            ...
            strA01 = AbstractC2532Wu.A01(Integer.parseInt(this.A0I.A20().A0I().A08()));
        }
        sb2.append(strA01);
    ...
    public void A0I() {
        ...
        if (this.A0I.A20().A0S()) {
            this.A08.A05();
            this.A0Q.A4c(this.A0R.A6d(), new C17863d(0, 0));
        }
    }

    private void A0J() {
        C2771cX c2771cXA0F = new C2769cV(this.A0L, this.A0I.A20().A0I(), this.A0I.A23()).A0A(this.A0I.A1z().A01()).A0D(this.A0J.A0J()).A0C(this.A0J.A0E()).A09(2000).A0E(this.A0D).A0B(this.A0A).A0F();
        AbstractC2465Uc.A04(c2771cXA0F, this.A0N, UZ.A0U);
        addView(c2771cXA0F, A0q);
        c2771cXA0F.A04(new C2249Lp(this));
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void A0L() {
        new C2463Ua(this.A0I.A25(), this.A0M).A04(UZ.A0z, null);
        this.A0V.set(true);
        XP.A0R(this);
        XP.A0F(this.A07);
        ...
        XP.A0J(this.A06);
        Pair<EnumC2803d3, View> pairA03 = this.A0U.A03(this.A06);
        this.A00 = (View) pairA03.second;
        switch (YE.A00[((EnumC2803d3) pairA03.first).ordinal()]) {
            case 1:
                ...
                if (!this.A0D) {
                    ...
                    addView(new C2764cQ(this.A0L, this.A0I.A23(), this.A0I.A20().A0I(), A09(), this.A09, new YC(this)), new RelativeLayout.LayoutParams(-1, -1));
                    removeView(this.A0a);
                }
                break;
            case 2:
    ...
    public void A0M() {
        ...
        AbstractC2550Xm abstractC2550Xm = this.A0a;
        if (A0c[3].length() == 2) {
            throw new RuntimeException();
        }
        String[] strArr = A0c;
        ...
        abstractC2550Xm.setVisibility(0);
        this.A07.setVisibility(0);
        if (this.A01 != null) {
            this.A01.setVisibility(0);
        }
        if (this.A06 != null && this.A0I.A1w() > 0 && this.A05 == null) {
            this.A05 = new C2517Wd(this.A0I.A1w(), new C2240Lg(this));
            this.A05.A07();
        }
        this.A0O.A07();
    }
    ...
    public final void onDestroy() {
        ...
        if (this.A07 != null) {
            if (!TextUtils.isEmpty(this.A0I.A25())) {
                this.A0M.AAt(this.A0I.A25(), new C2605Zp().A03(this.A07.getViewabilityChecker()).A02(this.A07.getTouchDataRecorder()).A05());
            }
            this.A07.A0C();
        }
        this.A0O.A06();
    ...
    public void setServerSideRewardHandler(C2817dI c2817dI) {
        this.A08 = c2817dI;
    }
}
