...
public class C18676g extends ViewGroup {
    ...
    public C2347Pm A01;
    public C3001gJ A02;
    public RunnableC2360Pz A03;
    public QC A04;
    public QK A05;
    public QO A06;
    public QX A07;
    public RunnableC2366Qf A08;
    public C2984g1 A09;
    public boolean A0A;
    public boolean A0B;
    public boolean A0C;
    ...
    public final QW A0r;
    public final C2364Qd A0s;
    public final C2375Qo A0t;
    public final Runnable A0u;
    public final ArrayList<RecyclerView.ItemDecoration> A0v;
    public final List<AbstractC2367Qg> A0w;
    public final int A0x;
    public final int A0y;
    public final Rect A0z;
    public final AccessibilityManager A10;
    public final C2986g4 A11;
    public final InterfaceC2374Qn A12;
     ...
     */
    public static C18676g A0H(View view) {
        if (!(view instanceof ViewGroup)) {
            return null;
        }
        if (view instanceof C18676g) {
            return (C18676g) view;
        }
        ViewGroup viewGroup = (ViewGroup) view;
        int childCount = viewGroup.getChildCount();
        for (int i10 = 0; i10 < childCount; i10++) {
            C18676g c18676gA0H = A0H(viewGroup.getChildAt(i10));
            if (c18676gA0H != null) {
                return c18676gA0H;
            }
        }
    ...
    private void A0N() {
        ...
        if (this.A0s.A0C) {
            for (int iA05 = this.A01.A05() - 1; iA05 >= 0; iA05--) {
                AbstractC2367Qg abstractC2367QgA0F = A0F(this.A01.A09(iA05));
                if (!abstractC2367QgA0F.A0l()) {
                    long jA0C = A0C(abstractC2367QgA0F);
                    QJ qjA0E = this.A05.A0E(this.A0s, abstractC2367QgA0F);
                    AbstractC2367Qg abstractC2367QgA05 = this.A0t.A05(jA0C);
                    if (abstractC2367QgA05 == null || abstractC2367QgA05.A0l()) {
                        this.A0t.A0E(abstractC2367QgA0F, qjA0E);
                    } else {
                        boolean zA0H = this.A0t.A0H(abstractC2367QgA05);
                        boolean zA0H2 = this.A0t.A0H(abstractC2367QgA0F);
                        if (zA0H && abstractC2367QgA05 == abstractC2367QgA0F) {
                            this.A0t.A0E(abstractC2367QgA0F, qjA0E);
                        } else {
                            QJ qjA04 = this.A0t.A04(abstractC2367QgA05);
                            this.A0t.A0E(abstractC2367QgA0F, qjA0E);
                            QJ qjA03 = this.A0t.A03(abstractC2367QgA0F);
                            if (qjA04 == null) {
                                A0m(jA0C, abstractC2367QgA0F, abstractC2367QgA05);
                            } else {
                                A0t(abstractC2367QgA05, abstractC2367QgA0F, qjA04, qjA03, zA0H, zA0H2);
                            }
                        }
                    }
                }
    ...
    public C18676g(Context context) {
        this(context, null);
    }

    public C18676g(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public C18676g(Context context, AttributeSet attributeSet, int i10) {
        super(context, attributeSet, i10);
        this.A11 = new C2986g4(this);
        this.A0r = new QW(this);
        this.A0t = new C2375Qo();
        ...
        this.A0U = 0;
        this.A0N = 0;
        this.A05 = new C18706j();
        this.A0W = 0;
        this.A0V = -1;
        this.A0L = Float.MIN_VALUE;
        this.A0M = Float.MIN_VALUE;
        this.A0o = true;
        this.A08 = new RunnableC2366Qf(this);
        this.A02 = A1E ? new C3001gJ() : null;
        this.A0s = new C2364Qd();
        this.A0G = false;
        this.A0H = false;
        this.A0f = new C2989g7(this);
        this.A0K = false;
        this.A14 = new int[2];
        this.A17 = new int[2];
        this.A16 = new int[2];
        ...
        setAccessibilityDelegateCompat(new C2984g1(this));
    ...
    private final long A0C(AbstractC2367Qg abstractC2367Qg) {
        return this.A04.A0M() ? abstractC2367Qg.A0Q() : abstractC2367Qg.A03;
    }

    private View A0D() {
        AbstractC2367Qg abstractC2367QgA1F;
        ...
        for (int startFocusSearchIndex = i10; startFocusSearchIndex < iA03; startFocusSearchIndex++) {
            AbstractC2367Qg abstractC2367QgA1F2 = A1F(startFocusSearchIndex);
            if (abstractC2367QgA1F2 == null) {
                break;
            }
            if (abstractC2367QgA1F2.A0H.hasFocusable()) {
                return abstractC2367QgA1F2.A0H;
            }
        }
        int startFocusSearchIndex2 = Math.min(iA03, i10);
        for (int limit = startFocusSearchIndex2 - 1; limit >= 0 && (abstractC2367QgA1F = A1F(limit)) != null; limit--) {
            if (abstractC2367QgA1F.A0H.hasFocusable()) {
                return abstractC2367QgA1F.A0H;
            }
        }
        return null;
    }

    private final AbstractC2367Qg A0E(long j10) {
        if (this.A04 == null || !this.A04.A0M()) {
            return null;
        }
        int iA06 = this.A01.A06();
        AbstractC2367Qg abstractC2367Qg = null;
        for (int i10 = 0; i10 < iA06; i10++) {
            AbstractC2367Qg holder = A0F(this.A01.A0A(i10));
            if (holder != null && !holder.A0g() && holder.A0Q() == j10) {
                if (this.A01.A0K(holder.A0H)) {
                    abstractC2367Qg = holder;
                } else {
                    return holder;
                }
            }
    ...
    public static AbstractC2367Qg A0F(View view) {
        if (view == null) {
            return null;
        }
    ...
    private final AbstractC2367Qg A0G(View view) {
    ...
    private void A0L() {
        ...
        if (this.A0s.A0C) {
            ...
            for (int i10 = 0; i10 < iA05; i10++) {
                AbstractC2367Qg holder = A0F(this.A01.A09(i10));
                if (!holder.A0l() && (!holder.A0f() || this.A04.A0M())) {
                    QK qk = this.A05;
                    C2364Qd c2364Qd = this.A0s;
                    int i11 = QK.A06(holder);
                    this.A0t.A0F(holder, qk.A0F(c2364Qd, holder, i11, holder.A0R()));
        ...
        if (this.A0s.A0B) {
            ...
            for (int i12 = 0; i12 < this.A01.A05(); i12++) {
                AbstractC2367Qg abstractC2367QgA0F = A0F(this.A01.A09(i12));
                boolean didStructureChange = abstractC2367QgA0F.A0l();
                if (!didStructureChange) {
                    boolean didStructureChange2 = this.A0t.A0I(abstractC2367QgA0F);
                    if (!didStructureChange2) {
                        int iA06 = QK.A06(abstractC2367QgA0F);
                        boolean zA0o = abstractC2367QgA0F.A0o(8192);
                        if (!zA0o) {
                            iA06 |= 4096;
                        }
                        QJ qjA0F = this.A05.A0F(this.A0s, abstractC2367QgA0F, iA06, abstractC2367QgA0F.A0R());
                        if (zA0o) {
                            A1k(abstractC2367QgA0F, qjA0F);
                        } else {
                            this.A0t.A0D(abstractC2367QgA0F, qjA0F);
                        }
                    }
                }
            }
    ...
    private void A0O() {
        this.A01 = new C2347Pm(new C2991g9(this));
    }
    ...
    */
    private void A0P() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C18676g.A0P():void");
    }
    ...
    private void A0Q() {
        ...
        if (this.A0o && this.A04 != null && hasFocus() && getDescendantFocusability() != 393216) {
            ...
            AbstractC2367Qg abstractC2367QgA0E = null;
            ...
            if (j10 != -1 && this.A04.A0M()) {
                abstractC2367QgA0E = A0E(this.A0s.A08);
            }
            View viewA0D = null;
            if (abstractC2367QgA0E == null || this.A01.A0K(abstractC2367QgA0E.A0H) || !abstractC2367QgA0E.A0H.hasFocusable()) {
                if (this.A01.A05() > 0) {
                    viewA0D = A0D();
                }
            } else {
                viewA0D = abstractC2367QgA0E.A0H;
            }
            if (viewA0D != null) {
    ...
    private void A0U() {
        ...
        AbstractC2367Qg abstractC2367QgA0G = focusedChild == null ? null : A0G(focusedChild);
        if (abstractC2367QgA0G == null) {
            A0S();
            return;
        }
        this.A0s.A08 = this.A04.A0M() ? abstractC2367QgA0G.A0Q() : -1L;
        C2364Qd c2364Qd = this.A0s;
        if (this.A0C) {
            iA0M = -1;
        } else {
            iA0M = abstractC2367QgA0G.A0g() ? abstractC2367QgA0G.A01 : abstractC2367QgA0G.A0M();
        }
        c2364Qd.A01 = iA0M;
        C2364Qd c2364Qd2 = this.A0s;
        View child = abstractC2367QgA0G.A0H;
        c2364Qd2.A02 = A0B(child);
    }
    ...
    private final void A0X() {
        int iA06 = this.A01.A06();
        for (int i10 = 0; i10 < iA06; i10++) {
            AbstractC2367Qg abstractC2367QgA0F = A0F(this.A01.A0A(i10));
            if (!abstractC2367QgA0F.A0l()) {
                abstractC2367QgA0F.A0S();
            }
        }
        this.A0r.A0K();
    }
    ...
    private final void A0Z() {
        ...
        for (int size = this.A0w.size() - 1; size >= 0; size--) {
            AbstractC2367Qg abstractC2367Qg = this.A0w.get(size);
            if (abstractC2367Qg.A0H.getParent() == this && !abstractC2367Qg.A0l() && (state = abstractC2367Qg.A02) != -1) {
                P3.A09(abstractC2367Qg.A0H, state);
                abstractC2367Qg.A02 = -1;
            }
        }
        this.A0w.clear();
    }
    ...
    private final void A0e() {
        this.A00 = new C3004gM(new C2990g8(this));
    }
    ...
    private final void A0h() {
        ...
        for (int i10 = 0; i10 < iA06; i10++) {
            AbstractC2367Qg abstractC2367QgA0F = A0F(this.A01.A0A(i10));
            if (abstractC2367QgA0F != null && !abstractC2367QgA0F.A0l()) {
                abstractC2367QgA0F.A0Z(6);
            }
        }
        A0g();
        this.A0r.A0N();
    ...
    private void A0j(float f10, float f11, float f12, float f13) {
        ...
        if (f11 < 0.0f) {
            A0b();
            AbstractC2338Pd.A00(this.A0a, (-f11) / getWidth(), 1.0f - (f12 / getHeight()));
            z10 = true;
        } else if (f11 > 0.0f) {
            A0c();
            AbstractC2338Pd.A00(this.A0b, f11 / getWidth(), f12 / getHeight());
            z10 = true;
        }
        if (f13 < 0.0f) {
            A0d();
            AbstractC2338Pd.A00(this.A0c, (-f13) / getHeight(), f10 / getWidth());
            z10 = true;
        } else if (f13 > 0.0f) {
            A0a();
            AbstractC2338Pd.A00(this.A0Z, f13 / getHeight(), 1.0f - (f10 / getWidth()));
            z10 = true;
        }
        if (!z10 && f11 == 0.0f) {
            if (A19[7].length() != 1) {
    ...
    private void A0m(long j10, AbstractC2367Qg abstractC2367Qg, AbstractC2367Qg abstractC2367Qg2) {
        int iA05 = this.A01.A05();
        for (int i10 = 0; i10 < iA05; i10++) {
            AbstractC2367Qg other = A0F(this.A01.A09(i10));
            if (other != abstractC2367Qg && A0C(other) == j10) {
                QC qc2 = this.A04;
                String[] strArr = A19;
                String str = strArr[0];
                String str2 = strArr[6];
                ...
                if (qc2 != null && this.A04.A0M()) {
                    throw new IllegalStateException(A0I(1696, 130, 15) + other + strA0I + abstractC2367Qg + A1J());
                }
                throw new IllegalStateException(A0I(1508, 188, 43) + other + strA0I + abstractC2367Qg + A1J());
            }
        }
        Log.e(A0I(1370, 12, 39), A0I(Sd.a.f41743c, 111, 51) + abstractC2367Qg2 + A0I(18, 41, 117) + abstractC2367Qg + A1J());
    }
    ...
    private void A0r(AbstractC2367Qg abstractC2367Qg) {
        View view = abstractC2367Qg.A0H;
        boolean z10 = view.getParent() == this;
        this.A0r.A0Y(A1I(view));
        boolean zA0i = abstractC2367Qg.A0i();
        String[] strArr = A19;
        if (strArr[4].charAt(24) != strArr[5].charAt(24)) {
            throw new RuntimeException();
        }
    ...
    public static void A0s(AbstractC2367Qg abstractC2367Qg) {
        if (abstractC2367Qg.A09 != null) {
            C18676g c18676g = abstractC2367Qg.A09.get();
            while (c18676g != null) {
                View item = abstractC2367Qg.A0H;
                if (c18676g == item) {
                    return;
                }
                Object parent = c18676g.getParent();
            ...
            abstractC2367Qg.A09 = null;
        }
    }

    private void A0t(AbstractC2367Qg abstractC2367Qg, AbstractC2367Qg abstractC2367Qg2, QJ qj, QJ qj2, boolean z10, boolean z11) {
        ...
        if (abstractC2367Qg != abstractC2367Qg2) {
            if (z11) {
                A0r(abstractC2367Qg2);
            }
            abstractC2367Qg.A06 = abstractC2367Qg2;
            A0r(abstractC2367Qg);
            this.A0r.A0Y(abstractC2367Qg);
            abstractC2367Qg2.A0d(false);
            abstractC2367Qg2.A07 = abstractC2367Qg;
        }
        if (this.A05.A0R(abstractC2367Qg, abstractC2367Qg2, qj, qj2)) {
            A1O();
        }
    }
    ...
    private void A0x(int[] iArr) {
        ...
        for (int i10 = 0; i10 < iA05; i10++) {
            AbstractC2367Qg abstractC2367QgA0F = A0F(this.A01.A09(i10));
            if (!abstractC2367QgA0F.A0l()) {
                int count = abstractC2367QgA0F.A0O();
    ...
    private boolean A0y() {
        ...
        for (int i10 = 0; i10 < iA05; i10++) {
            AbstractC2367Qg abstractC2367QgA0F = A0F(this.A01.A09(i10));
            if (abstractC2367QgA0F != null && !abstractC2367QgA0F.A0l()) {
                boolean zA0j = abstractC2367QgA0F.A0j();
    ...
    private final boolean A13(int consumedX, int consumedY, MotionEvent motionEvent) {
        ...
        if (A1v(iA1f, iA1g, i10, i11, this.A17, 0)) {
            ...
            if (motionEvent != null && !AbstractC2318Oj.A00(motionEvent, 8194)) {
    ...
    public final int A1B(View view) {
        AbstractC2367Qg holder = A0F(view);
        if (holder != null) {
            return holder.A0O();
        }
        return -1;
    ...
    public final int A1C(AbstractC2367Qg abstractC2367Qg) {
        if (abstractC2367Qg.A0o(IronSourceError.ERROR_PLACEMENT_CAPPED) || !abstractC2367Qg.A0e()) {
            return -1;
        }
        return this.A00.A05(abstractC2367Qg.A03);
    }
    ...
    public final AbstractC2367Qg A1F(int i10) {
        if (this.A0C) {
            return null;
        }
        int iA06 = this.A01.A06();
        AbstractC2367Qg hidden = null;
        for (int i11 = 0; i11 < iA06; i11++) {
            AbstractC2367Qg abstractC2367QgA0F = A0F(this.A01.A0A(i11));
            if (abstractC2367QgA0F != null && !abstractC2367QgA0F.A0g()) {
                int childCount = A1C(abstractC2367QgA0F);
                if (childCount != i10) {
                    continue;
                } else if (this.A01.A0K(abstractC2367QgA0F.A0H)) {
                    hidden = abstractC2367QgA0F;
                } else {
    ...
    public final AbstractC2367Qg A1G(int i10) {
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final com.facebook.ads.redexgen.core.AbstractC2367Qg A1H(int r9, boolean r10) {
        /*
            r8 = this;
        ...
        L25:
            int r6 = r3.A0O()
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.C18676g.A19
            r0 = 7
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 1
            ...
            throw r0
        L3b:
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C18676g.A19
        ...
        L57:
            return r7
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C18676g.A1H(int, boolean):com.facebook.ads.redexgen.X.Qg");
    }

    public final AbstractC2367Qg A1I(View view) {
        ViewParent parent = view.getParent();
    ...
    */
    public final void A1K() {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C18676g.A1K():void");
    }
    ...
    */
    public final void A1Q() {
        ...
        L41:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C18676g.A1Q():void");
    }
    ...
    public final void A1j(C2364Qd c2364Qd) {
        if (getScrollState() == 2) {
            OverScroller overScroller = this.A08.A01;
            c2364Qd.A06 = overScroller.getFinalX() - overScroller.getCurrX();
            c2364Qd.A07 = overScroller.getFinalY() - overScroller.getCurrY();
        } else {
            c2364Qd.A06 = 0;
            c2364Qd.A07 = 0;
        }
    ...
    public final void A1k(AbstractC2367Qg abstractC2367Qg, QJ qj) {
        abstractC2367Qg.A0a(0, 8192);
        if (this.A0s.A0E) {
            boolean zA0j = abstractC2367Qg.A0j();
            if (A19[1].charAt(14) != '5') {
                throw new RuntimeException();
            }
            String[] strArr = A19;
            ...
            if (zA0j && !abstractC2367Qg.A0g() && !abstractC2367Qg.A0l()) {
                this.A0t.A08(A0C(abstractC2367Qg), abstractC2367Qg);
            }
        }
        this.A0t.A0F(abstractC2367Qg, qj);
    }

    public final void A1l(AbstractC2367Qg abstractC2367Qg, QJ qj, QJ qj2) {
        abstractC2367Qg.A0d(false);
        if (this.A05.A0O(abstractC2367Qg, qj, qj2)) {
            A1O();
        }
    }

    public final void A1m(AbstractC2367Qg abstractC2367Qg, QJ qj, QJ qj2) {
        A0r(abstractC2367Qg);
        abstractC2367Qg.A0d(false);
        if (this.A05.A0P(abstractC2367Qg, qj, qj2)) {
            A1O();
        }
    }
    ...
    public final boolean A1x(View view) {
        ...
        if (zA0L) {
            AbstractC2367Qg viewHolder = A0F(view);
    ...
    public final boolean A1y(AbstractC2367Qg abstractC2367Qg) {
        return this.A05 == null || this.A05.A0S(abstractC2367Qg, abstractC2367Qg.A0R());
    }

    public final boolean A1z(AbstractC2367Qg abstractC2367Qg, int i10) {
        if (A1s()) {
            abstractC2367Qg.A02 = i10;
            this.A0w.add(abstractC2367Qg);
            return false;
        }
        P3.A09(abstractC2367Qg.A0H, i10);
        return true;
    }
    ...
    */
    public final void draw(android.graphics.Canvas r8) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C18676g.draw(android.graphics.Canvas):void");
    }
    ...
    */
    public final android.view.View focusSearch(android.view.View r11, int r12) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C18676g.focusSearch(android.view.View, int):android.view.View");
    }
    ...
    public C2984g1 getCompatAccessibilityDelegate() {
        return this.A09;
    }
    ...
    private C2320Ol getScrollingChildHelper() {
        if (this.A0d == null) {
            this.A0d = new C2320Ol(this);
        }
        return this.A0d;
    }
    ...
    public final void onAttachedToWindow() {
        ...
        this.A0K = false;
        if (A1E) {
            this.A03 = RunnableC2360Pz.A07.get();
            RunnableC2360Pz runnableC2360Pz = this.A03;
            String[] strArr = A19;
            if (strArr[4].charAt(24) != strArr[5].charAt(24)) {
                throw new RuntimeException();
            }
            ...
            if (runnableC2360Pz == null) {
                this.A03 = new RunnableC2360Pz();
                ...
                RunnableC2360Pz.A07.set(this.A03);
            }
            this.A03.A09(this);
        }
    }
    ...
    public void onMeasure(int i10, int i11) {
        ...
        if (z10) {
            ...
            if (this.A06.A21()) {
                ...
                qo.A13(iMakeMeasureSpec, View.MeasureSpec.makeMeasureSpec(widthMode4, 1073741824));
                this.A0s.A0A = true;
                A0M();
                if (A19[1].charAt(14) != '5') {
                    this.A06.A14(i10, i11);
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r21) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C18676g.onTouchEvent(android.view.MotionEvent):boolean");
    }

    @Override // android.view.ViewGroup
    public final void removeDetachedView(View view, boolean z10) {
        AbstractC2367Qg abstractC2367QgA0F = A0F(view);
        if (abstractC2367QgA0F != null) {
            if (abstractC2367QgA0F.A0i()) {
                abstractC2367QgA0F.A0V();
            } else if (!abstractC2367QgA0F.A0l()) {
                throw new IllegalArgumentException(A0I(Sdk.SDKError.Reason.MRAID_JS_COPY_FAILED_VALUE, 75, 84) + abstractC2367QgA0F + A1J());
            }
        }
        view.clearAnimation();
        A1g(view);
    ...
    public void setAccessibilityDelegateCompat(C2984g1 c2984g1) {
        this.A09 = c2984g1;
    ...
    public void setViewCacheExtension(AbstractC2365Qe abstractC2365Qe) {
        this.A0r.A0W(abstractC2365Qe);
    }
