...
public final class C2964fh extends R8 implements MediaViewApi, Repairable, SM {
    ...
    private void A07() {
        EnumC2528Wq.A04(this.A03, EnumC2528Wq.A0B);
        EnumC2528Wq.A04(this.A09, EnumC2528Wq.A0B);
        EnumC2528Wq.A04(this.A05, EnumC2528Wq.A0B);
        EnumC2528Wq.A04(this.A01, EnumC2528Wq.A0B);
    }
    ...
    private void A0A(View view, C2363Qc c2363Qc) {
        if (this.A0B != null) {
        ...
        String strA1D = c2363Qc.A1D();
        if (this.A03.getContext() == null) {
            return;
        }
        this.A0B = AbstractC2795cv.A01(this.A07, strA1D);
        if (this.A0B != null) {
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
    ...
    private final void A0C(C2820dL c2820dL, AttributeSet attributeSet, int i10, int i11, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c2820dL, attributeSet, i10, i11));
        A0H(new C2601Zl(c2820dL, attributeSet, i10, i11));
        this.A08 = new C0L(c2820dL, attributeSet, i10);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c2820dL, attributeSet, i10, i11));
        A07();
    }

    private final void A0D(C2820dL c2820dL, AttributeSet attributeSet, int i10, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c2820dL, attributeSet, i10));
        A0H(new C2601Zl(c2820dL, attributeSet, i10));
        this.A08 = new C0L(c2820dL, attributeSet, i10);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c2820dL, attributeSet, i10));
        A07();
    }

    private final void A0E(C2820dL c2820dL, AttributeSet attributeSet, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c2820dL, attributeSet));
        A0H(new C2601Zl(c2820dL, attributeSet));
        this.A08 = new C0L(c2820dL, attributeSet);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c2820dL, attributeSet));
        A07();
    }

    private final void A0F(C2820dL c2820dL, MediaView mediaView) {
        this.A03 = mediaView;
        A0B(new ImageView(c2820dL));
        A0H(new C2601Zl(c2820dL));
        this.A08 = new C0L(c2820dL);
        A06();
        setVideoRenderer(new DefaultMediaViewVideoRenderer(c2820dL));
        A07();
    }

    private void A0G(C2363Qc c2363Qc, boolean z10, C2478Up c2478Up) {
        KZ kzA04 = new KZ(this.A02, this.A07).A04();
        if (z10) {
            kzA04.A06(new C2971fo(this, c2363Qc));
        }
        kzA04.A07(c2478Up.getUrl());
    }

    private void A0H(C2601Zl c2601Zl) {
        if (!this.A0D) {
            if (this.A09 != null) {
                this.A03.removeView(this.A09);
            }
            c2601Zl.setVisibility(8);
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
            layoutParams.addRule(13);
            this.A03.addView(c2601Zl, layoutParams);
            this.A09 = c2601Zl;
            return;
        }
    ...
    */
    public final void A0L(com.facebook.ads.NativeAd r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2964fh.A0L(com.facebook.ads.NativeAd):void");
    }

    public final void A0M(NativeAdBaseApi nativeAdBaseApi, boolean z10) {
        C2820dL c2820dLA12 = ((C2363Qc) nativeAdBaseApi).A12();
        C2820dL adObjectContext = this.A07;
        adObjectContext.A0L(c2820dLA12);
        c2820dLA12.A0O(this);
        this.A0D = true;
        C2363Qc c2363QcA0L = C2363Qc.A0L(nativeAdBaseApi);
        c2363QcA0L.A1S(this.A03);
        ...
        if (this.A01 != null) {
            ...
            if (this.A01 instanceof C2592Zc) {
                ((C2592Zc) this.A01).A04();
            } else {
                ((C18676g) this.A01).setAdapter(null);
            }
        }
        ...
        if (adIcon != null) {
            ...
            if (bitmapA0N != null) {
                ...
                if (z10) {
                    this.A03.post(new C2972fp(this, c2363QcA0L));
                }
            } else {
                A0G(c2363QcA0L, z10, adIcon);
            }
        } else {
            QQ qqA16 = c2363QcA0L.A16();
            AdErrorType adErrorType = AdErrorType.NATIVE_AD_IS_NOT_LOADED;
            c2820dLA12.A0F().A3F(c2363QcA0L.A0y(), adErrorType.getErrorCode(), adErrorType.getDefaultErrorMessage());
            if (qqA16 != null) {
                qqA16.ADB(V1.A00(adErrorType));
            }
            Log.e(A04(46, 17, 121), adErrorType.getDefaultErrorMessage());
            if (nativeAdBaseApi.isAdLoaded()) {
                C2820dL adObjectContext2 = this.A07;
                adObjectContext2.A08().AAy(A04(258, 3, 44), AbstractC2433Sv.A0W, new C2434Sw(A04(192, 23, 42)));
            }
        }
        A0A(this.A02, c2363QcA0L);
    }
    ...
    */
    public final int getMediaWidth() {
        /*
            ...
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C2964fh.A0F
            r0 = 2
            r1 = r2[r0]
            r0 = 0
            r2 = r2[r0]
        ...
        L35:
            ...
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.C2964fh.A0F
            r0 = 1
            r1 = r1[r0]
            r0 = 7
            char r1 = r1.charAt(r0)
        ...
        L7c:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2964fh.getMediaWidth():int");
    }
    ...
    public final void setListener(MediaViewListener mediaViewListener) {
        ...
        if (mediaViewListener == null) {
            ...
            ((RH) this.A05.getMediaViewVideoRendererApi()).A07(new C2965fi(this, mediaViewListener));
        }
    }
    ...
    public final void setVideoRenderer(MediaViewVideoRenderer mediaViewVideoRenderer) {
        if (!this.A0D) {
            ...
            RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
            layoutParams.addRule(13);
            ((C2964fh) this.A03.getMediaViewApi()).A09(mediaViewVideoRenderer, layoutParams);
