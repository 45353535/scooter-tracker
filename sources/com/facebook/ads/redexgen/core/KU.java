...
public final class KU {
    ...
    public static void A09() {
        A08 = new byte[]{-19, -33, Ascii.DC4, 50, 40, 45, 38, -33, 19, 8, Ascii.FF, 4, Ascii.RS, Ascii.DC4, 13, Ascii.DC2, 4, 19, -33, 40, 45, 50, 51, 36, 32, 35, -19, Ascii.DC2, 55, Utf8.REPLACEMENT_BYTE, 42, 53, 50, 45, -23, 45, 62, 59, 42, 61, 50, 56, 55, 3, -23, Ascii.SYN, 57, 10, 59, 56, 39, 58, 47, 53, 52, Ascii.CAN, 43, 39, 42, 43, 56};
    }
    ...
    private int A00(InterfaceC3286lN interfaceC3286lN) {
        this.A06.A0i(AbstractC18094a.A07);
        this.A03 = true;
        interfaceC3286lN.AI1();
        return 0;
    }

    private int A01(InterfaceC3286lN interfaceC3286lN, C2124Gt c2124Gt) throws IOException {
        int iMin = (int) Math.min(20000L, interfaceC3286lN.A8G());
        ...
        c4j.A0d(iMin);
        interfaceC3286lN.AI1();
        interfaceC3286lN.AG9(this.A06.A0l(), 0, iMin);
        this.A01 = A04(this.A06);
        this.A04 = true;
        return 0;
    }

    private int A02(InterfaceC3286lN interfaceC3286lN, C2124Gt c2124Gt) throws IOException {
        long jA8G = interfaceC3286lN.A8G();
        int iMin = (int) Math.min(20000L, jA8G);
        long j10 = jA8G - ((long) iMin);
        long searchStartPosition = interfaceC3286lN.A8f();
    ...
    */
    ...
    public final int A0B(InterfaceC3286lN interfaceC3286lN, C2124Gt c2124Gt) throws IOException {
        if (!this.A05) {
            return A02(interfaceC3286lN, c2124Gt);
        }
