...
public class C3533pi {
    ...
    public final Map<String, C3544pu> A00;
    public final Set<C3544pu> A01;
    ...
    public Collection<C3544pu> A00() {
        return this.A01;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public Collection<C3544pu> A01() {
    ...
    public void A04() {
        this.A00.clear();
        Iterator<C3544pu> it = this.A01.iterator();
        while (true) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean A06(C3544pu c3544pu) {
        if (this.A01.add(c3544pu)) {
            this.A00.remove(c3544pu.A02);
            return true;
        }
        return false;
    }
