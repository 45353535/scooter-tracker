...
public final class C4H extends G2 {
    ...
    public C4H(C2820dL c2820dL, YY yy, US us, AbstractC3095hy abstractC3095hy, SF sf2, InterfaceC2551Xn interfaceC2551Xn) {
        super(c2820dL, yy, us, abstractC3095hy, sf2, interfaceC2551Xn);
        this.A03 = new C2101Fw(this);
        this.A05 = new AtomicBoolean(false);
        this.A04 = new AtomicBoolean(false);
        this.A06 = new AtomicBoolean(false);
        this.A02 = new ImageView(getContext());
        if (abstractC3095hy.A20().A0H().A04() > 0) {
            this.A01 = new C2023Cw(c2820dL, abstractC3095hy.A20().A0H().A04() * 1000);
        }
        this.A02.setScaleType(ImageView.ScaleType.CENTER);
        this.A02.setAdjustViewBounds(true);
        new KZ(this.A02, super.A04).A05(super.A02.A20().A0H().A00(), super.A02.A20().A0H().A01()).A06(new C2100Fv(this)).A07(super.A02.A20().A0H().A08());
    }

    private AbstractC2654ae A01(int i10) {
        if (this.A02.getParent() != null) {
            XP.A0H(this.A02);
        }
        C2657ah c2657ahA0N = new C2657ah(super.A04, super.A05, this.A09, super.A02, this.A02, this.A0B, this.A07).A0K(this.A08.getToolbarHeight()).A0R(this.A08).A0J(i10).A0N(super.A06);
        if (this.A01 != null) {
            c2657ahA0N.A0T(this.A01);
        }
        c2657ahA0N.A0M(MI.A00(super.A04, super.A05, A03(0, 0, 52), WQ.A00(super.A02.A20().A0J().A05()), new HashMap(), super.A02.A21()));
    ...
    private void A08(int i10) {
        ...
        C2283My colors = this.A00.getColors();
        XP.A0K(this, colors.A08(this.A00 != null && (this.A00.A1M() || (this.A00 instanceof AbstractC2204Jw))));
    ...
    public final AbstractC2550Xm A0b() {
        ...
        if (!A0j()) {
            c2302Nr = new FullScreenAdToolbar(super.A04, this.A09, super.A06, 1, super.A02.A1t(), super.A02.A1j());
        } else {
            c2302Nr = new C2302Nr(super.A04, this.A09, super.A06, 1);
        }
        if (super.A02.A2K()) {
            c2302Nr.setOnClickListener(new ViewOnClickListenerC2768cU(this));
        }
        return c2302Nr;
    }
    ...
    public final void A0f() {
        ...
        if (iA04 > 0) {
            ...
            A0g(iA04, new C2099Fu(this), this.A01);
            if (secondsForNextCta == 0 || secondsForNextCta >= iA04) {
                ...
                A0g(secondsForNextCta, new C2098Ft(this), null);
                return;
            }
        }
        this.A06.set(true);
        AbstractC2550Xm abstractC2550Xm = this.A08;
        int unskippableSeconds = getCloseButtonStyle();
        abstractC2550Xm.setToolbarActionMode(unskippableSeconds);
    }
    ...
    public final boolean A0i() {
        ...
        AbstractC2654ae abstractC2654ae = this.A00;
        if (A08[4].length() != 3) {
            throw new RuntimeException();
        }
        A08[4] = "kMg";
        return abstractC2654ae.A1N(false);
    }
