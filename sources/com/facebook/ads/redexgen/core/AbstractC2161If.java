...
public abstract class AbstractC2161If {
    ...
    public static void A03() {
        byte[] bArr = {-68, -33, -33, -44, -83, -32, -37, -39, -63, -32, -43, -40, -20, 5, 10, Ascii.FF, 7, 7, 6, 9, Ascii.VT, -4, -5, -73, 7, 10, 10, -1, -73, 13, -4, 9, 10, 0, 6, 5, -47, -73};
        String[] strArr = A01;
    ...
    public static C2160Ie A00(byte[] bArr) {
        ...
        return new C2160Ie(uuid, dataSize, bArr2);
    }

    public static UUID A02(byte[] bArr) {
        C2160Ie parsedAtom = A00(bArr);
        if (parsedAtom != null) {
