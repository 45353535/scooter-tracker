...
public final class C3S {
    ...
    public static <T extends C1S> AbstractC1964Am<T> A01(C1R<T> c1r, List<Bundle> list) {
        ...
        while (true) {
            ...
            if (i10 < size) {
                c17401hA01.A04(c1r.A6X((Bundle) C3M.A01(list.get(i10))));
                i10++;
            } else {
    ...
    public static void A02(Bundle bundle) {
        if (bundle != null) {
            bundle.setClassLoader((ClassLoader) AbstractC18094a.A0f(C3S.class.getClassLoader()));
        }
    }
}
