...
public final class C2544Xg {
    ...
    static {
        A01();
        A02 = C2544Xg.class.getSimpleName();
    }

    public static boolean A02(C2820dL c2820dL) {
        return A03(c2820dL) && C2545Xh.A03(c2820dL);
    }
    ...
    public static boolean A03(C2820dL c2820dL) {
        ...
        try {
            return ((PowerManager) c2820dL.getSystemService(A00(60, 5, 91))).isInteractive();
        } catch (Exception e10) {
            Log.e(A02, A00(0, 60, 20), e10);
            c2820dL.A08().AAy(A00(65, 5, 53), AbstractC2433Sv.A2S, new C2434Sw(e10));
            return true;
        }
    }
}
