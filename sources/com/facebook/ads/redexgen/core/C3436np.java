...
public final class C3436np implements InterfaceC18043v {
    public static final List<C3437nq> A01 = new ArrayList(50);
    public final Handler A00;

    public C3436np(Handler handler) {
        this.A00 = handler;
    }

    public static C3437nq A00() {
        C3437nq c3437nq;
        synchronized (A01) {
            c3437nq = A01.isEmpty() ? new C3437nq() : A01.remove(A01.size() - 1);
        }
        return c3437nq;
    }

    public static void A01(C3437nq c3437nq) {
        synchronized (A01) {
            if (A01.size() < 50) {
                A01.add(c3437nq);
            }
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC18043v
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC18043v
    public final C3437nq AC7(int i10) {
        return A00().A01(this.A00.obtainMessage(i10), this);
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC18043v
    public final C3437nq AC8(int i10, int i11, int i12) {
        return A00().A01(this.A00.obtainMessage(i10, i11, i12), this);
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC18043v
    public final C3437nq AC9(int i10, int i11, int i12, Object obj) {
        return A00().A01(this.A00.obtainMessage(i10, i11, i12, obj), this);
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC18043v
    public final C3437nq ACA(int i10, Object obj) {
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC18043v
    public final boolean AIT(InterfaceC18033u interfaceC18033u) {
        return ((C3437nq) interfaceC18033u).A03(this.A00);
    }
}
