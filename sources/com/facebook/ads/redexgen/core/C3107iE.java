...
public final class C3107iE extends MR {
    ...
    public final US A04;
    public final AbstractC2594Ze A05;
    ...
    static {
        A05();
        A07 = C3107iE.class.getSimpleName();
    }

    public C3107iE(C2820dL c2820dL, US us, AbstractC2594Ze abstractC2594Ze, C2893eX c2893eX, MS ms, V4 v42) {
        super(c2820dL, ms, c2893eX);
        this.A04 = us;
        this.A05 = abstractC2594Ze;
        this.A03 = c2820dL;
        this.A01 = v42;
    }
    ...
    public final void A08(Map<String, String> map) {
        ...
        if (this.A00 != null && !TextUtils.isEmpty(this.A00.A7G())) {
            this.A03.A0F().A3D();
            AbstractC2307Nw.A02(this.A00.A05(), X0.A00(A04(0, 6, 50)));
    ...
    public final synchronized void A09() {
        if (!this.A02 && this.A00 != null) {
            ...
            if (!TextUtils.isEmpty(this.A00.A03())) {
                XJ.A00(new C3108iF(this));
            }
        }
    }

    public final void A0A(C3109iG c3109iG) {
        this.A00 = c3109iG;
    }
}
