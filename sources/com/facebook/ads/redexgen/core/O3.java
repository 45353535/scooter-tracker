...
public abstract class O3 {
    ...
    public static String A01(int i10, int i11, int i12) {
        ...
        for (int i13 = 0; i13 < bArrCopyOfRange.length; i13++) {
            ...
            String[] strArr2 = A02;
            strArr2[1] = POBCoreNativeConstants.NATIVE_IMAGE_WIDTH;
            strArr2[0] = "P";
    ...
    public static O2 A00(C2794cu c2794cu) {
        if (A00 == null) {
            synchronized (O2.class) {
                if (A00 == null) {
                    A00 = new O2(new C3021gf(c2794cu.getSharedPreferences(ProcessUtils.getProcessSpecificName(A01(0, 36, 105), c2794cu), 0)));
                }
            }
        }
        return A00;
