...
public abstract class AbstractC2121Gq {
     ...
     */
    public static C2118Gn A06(byte[] bArr, int i10, int i11) {
        C2123Gs c2123Gs = new C2123Gs(bArr, i10, i11);
        int iA00 = -1;
        int i12 = -1;
        int iA01 = -1;
        c2123Gs.A07(4);
        int iA05 = c2123Gs.A05(3);
        c2123Gs.A06();
        int iA052 = c2123Gs.A05(2);
        boolean zA0A = c2123Gs.A0A();
        int iA053 = c2123Gs.A05(5);
        int i13 = 0;
        int i14 = 0;
        while (true) {
            if (A02[0].length() == 10) {
            ...
            if (i14 < 32) {
                ...
                for (int i15 = 0; i15 < iArr.length; i15++) {
                    iArr[i15] = c2123Gs.A05(8);
                }
                int iA054 = c2123Gs.A05(8);
                int i16 = 0;
                ...
                c2123Gs.A07(i16);
                if (iA05 > 0) {
                    c2123Gs.A07((8 - iA05) * 2);
                }
                int iA04 = c2123Gs.A04();
                int iA042 = c2123Gs.A04();
                if (iA042 == 3) {
                    c2123Gs.A06();
                }
                int iA043 = c2123Gs.A04();
                int iA044 = c2123Gs.A04();
                if (c2123Gs.A0A()) {
                    int iA045 = c2123Gs.A04();
                    int iA046 = c2123Gs.A04();
                    int iA047 = c2123Gs.A04();
                    int iA048 = c2123Gs.A04();
                ...
                c2123Gs.A04();
                c2123Gs.A04();
                int iA049 = c2123Gs.A04();
                for (int i19 = c2123Gs.A0A() ? 0 : iA05; i19 <= iA05; i19++) {
                    c2123Gs.A04();
                    c2123Gs.A04();
                    c2123Gs.A04();
                }
                ...
                A0E(c2123Gs);
                if (c2123Gs.A0A()) {
                    for (int i20 = 0; i20 < c2123Gs.A04(); i20++) {
                        c2123Gs.A07(iA049 + 4 + 1);
                    }
                }
                c2123Gs.A07(2);
                float f10 = 1.0f;
                boolean zA0A2 = c2123Gs.A0A();
                if (A02[0].length() != 10) {
                    String[] strArr3 = A02;
                    ...
                    if (zA0A2) {
                        if (c2123Gs.A0A()) {
                            int iA055 = c2123Gs.A05(8);
                            if (iA055 == 255) {
                                int iA056 = c2123Gs.A05(16);
                                int iA057 = c2123Gs.A05(16);
                                if (iA056 != 0 && iA057 != 0) {
                                    f10 = iA056 / iA057;
                                }
                        ...
                        if (c2123Gs.A0A()) {
                            c2123Gs.A07(3);
                            boolean zA0A3 = c2123Gs.A0A();
                            if (c2123Gs.A0A()) {
                                int iA058 = c2123Gs.A05(8);
                                int iA059 = c2123Gs.A05(8);
                                c2123Gs.A07(8);
                    ...
                    return new C2118Gn(iA052, zA0A, iA053, i13, iArr, iA054, iA04, iA043, iA044, f10, iA00, i12, iA01);
                }
            }
        }
    ...
    */
    public static com.facebook.ads.redexgen.core.C2120Gp A0A(byte[] r23, int r24, int r25) {
        /*
            Method dump skipped, instruction units count: 485
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.AbstractC2121Gq.A0A(byte[], int, int):com.facebook.ads.redexgen.X.Gp");
    }
    ...
    public static void A0C() {
        A00 = new byte[]{-7, Ascii.FF, Ascii.ETB, 0, Ascii.EM, Ascii.DC4, Ascii.US, 0, Ascii.US, Ascii.DC4, Ascii.ETB, Utf8.REPLACEMENT_BYTE, 88, 79, 98, 90, 79, 77, 94, 79, 78, 10, 75, 93, 90, 79, 77, 94, 73, 92, 75, 94, 83, 89, 73, 83, 78, 77, 10, 96, 75, 86, 95, 79, 36, 10, 66, 53, 48, 49, 59, -5, 45, 66, 47, Ascii.ETB, 10, 5, 6, Ascii.DLE, -48, 9, 6, Ascii.ETB, 4};
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static void A0E(com.facebook.ads.redexgen.core.C2123Gs r18) {
        /*
            Method dump skipped, instruction units count: 442
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.AbstractC2121Gq.A0E(com.facebook.ads.redexgen.X.Gs):void");
    }
    ...
    */
    public static int A03(byte[] r2, int r3, int r4) {
        ...
        L19:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.AbstractC2121Gq.A03(byte[], int, int):int");
    }
    ...
    */
    public static int A04(byte[] r8, int r9, int r10, boolean[] r11) {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.AbstractC2121Gq.A04(byte[], int, int, boolean[]):int");
    }

    public static C2118Gn A05(byte[] bArr, int i10, int i11) {
        return A06(bArr, i10 + 2, i11);
    }

    public static C2119Go A07(byte[] bArr, int i10, int i11) {
        return A08(bArr, i10 + 1, i11);
    }

    public static C2119Go A08(byte[] bArr, int i10, int i11) {
        C2123Gs data = new C2123Gs(bArr, i10, i11);
        int iA04 = data.A04();
        int seqParameterSetId = data.A04();
        data.A06();
        return new C2119Go(iA04, seqParameterSetId, data.A0A());
    }

    public static C2120Gp A09(byte[] bArr, int i10, int i11) {
        return A0A(bArr, i10 + 1, i11);
    }

    public static void A0D(C2123Gs c2123Gs) {
    ...
    public static void A0F(C2123Gs c2123Gs, int i10) {
        int i11 = 8;
        int lastScale = 8;
        for (int nextScale = 0; nextScale < i10; nextScale++) {
            if (lastScale != 0) {
                int lastScale2 = c2123Gs.A03();
    ...
    */
    public static void A0G(java.nio.ByteBuffer r6) {
        ...
        L3f:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.AbstractC2121Gq.A0G(java.nio.ByteBuffer):void");
    }
    ...
    public static boolean A0I(String str, byte b10) {
        if (A0B(46, 9, 96).equals(str) && (b10 & Ascii.US) == 6) {
            return true;
        }
