...
public abstract class MediaCodecPoolTracker {
    ...
    public abstract void A06(C3087ho c3087ho, int i10);

    public abstract void A07(EnumC3089hq enumC3089hq, int i10);

    public abstract void A08(EnumC3089hq enumC3089hq, int i10);

    public abstract void A09(EnumC3089hq enumC3089hq, int i10);

    public abstract void A0A(boolean z10, String str, EnumC3089hq enumC3089hq, int i10);

    private final long A02() {
        return C1979Bc.A00().AC6();
    }

    public final C3087ho A05(boolean z10, String str, EnumC3089hq enumC3089hq) {
        C3511p6.A09(str, A03(0, 9, 21));
        C3511p6.A09(enumC3089hq, A03(9, 6, 108));
        return new C3087ho(A02(), z10, str, enumC3089hq);
    }
}
