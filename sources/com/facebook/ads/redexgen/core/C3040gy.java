...
public class C3040gy extends MQ {
    public static byte[] A01;
    public final /* synthetic */ C3038gw A00;
    ...
    public C3040gy(C3038gw c3038gw) {
        this.A00 = c3038gw;
    }
    ...
    public final void A0A() {
        if (this.A00.A03 != null) {
            C2388Rb c2388Rb = (C2388Rb) this.A00.A03.buildShowAdConfig();
            c2388Rb.A02(System.currentTimeMillis() - this.A00.A02);
            this.A00.A03.show(c2388Rb.build());
            return;
        }
    ...
    public final void A0F(MP mp) {
        if (this.A00.A05 == null) {
            this.A00.A07.A08().AAy(A00(0, 3, 67), AbstractC2433Sv.A0N, new C2434Sw(A00(3, 18, 108)));
            return;
        }
        AbstractC3103iA abstractC3103iA = (AbstractC3103iA) mp;
        if (this.A00.A09.A03 != null) {
            abstractC3103iA.A02(this.A00.A09.A03);
        }
        this.A00.A09.A00 = abstractC3103iA.A0H();
        this.A00.A06 = true;
        this.A00.A04 = this.A00.A05.A0I();
        if (this.A00.A04 != null) {
            int iA1x = 0;
            if (!this.A00.A04.A1T()) {
                iA1x = ((AbstractC3095hy) this.A00.A04).A1x();
            }
            if (iA1x > 0) {
                WR wr = new WR();
        ...
        if (this.A00.A03 != null) {
            ((AbstractC3095hy) this.A00.A04).A2A(true);
            RewardedVideoAd.RewardedVideoLoadAdConfig loadAdConfig = this.A00.A03.buildLoadAdConfig().withFailOnCacheFailureEnabled(true).withRewardData(this.A00.A04.A0p()).withAdExperience(this.A00.A09.A02).withAdListener(new C2289Ne(this)).build();
