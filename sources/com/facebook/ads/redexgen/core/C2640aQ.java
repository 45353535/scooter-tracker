...
public final class C2640aQ extends LinearLayout {
    ...
    public static void A01() {
        A04 = new byte[]{Ascii.US, Ascii.SUB, Ascii.SUB, Ascii.ESC, 10, Ascii.US, Ascii.ETB, Ascii.DC2, 13};
    }
    ...
    public C2640aQ(C2820dL c2820dL, C2283My c2283My, boolean z10, int i10, int i11, int i12) {
        super(c2820dL);
        setOrientation(1);
        this.A02 = new TextView(c2820dL);
        XP.A0W(this.A02, true, i10);
        this.A02.setEllipsize(TextUtils.TruncateAt.END);
        this.A02.setLineSpacing(A08, 1.0f);
        this.A01 = new TextView(c2820dL);
        this.A00 = new TextView(c2820dL);
        XP.A0W(this.A00, false, i11);
        this.A00.setEllipsize(TextUtils.TruncateAt.END);
        this.A00.setLineSpacing(A08, 1.0f);
        this.A03 = U7.A17(c2820dL);
    ...
    public C2640aQ(C2820dL c2820dL, C2283My c2283My, boolean z10, boolean z11, boolean z12) {
        int i10 = z11 ? 18 : 22;
        int i11 = z11 ? 14 : 16;
        int i12 = A07;
        this(c2820dL, c2283My, z10, i10, i11, z12 ? i12 / 2 : i12);
    }
    ...
    public final void A03(C2283My c2283My, boolean z10) {
        this.A02.setTextColor(c2283My.A07(z10));
        this.A01.setTextColor(c2283My.A05(z10));
        this.A00.setTextColor(c2283My.A06(z10));
    }
    ...
    public void setCTAClickListener(KE ke2) {
        ViewOnClickListenerC2644aU viewOnClickListenerC2644aUA03 = AbstractC2645aV.A03(ke2, A00(0, 9, 20));
        this.A02.setOnClickListener(viewOnClickListenerC2644aUA03);
        this.A00.setOnClickListener(viewOnClickListenerC2644aUA03);
        this.A01.setOnClickListener(viewOnClickListenerC2644aUA03);
    }
