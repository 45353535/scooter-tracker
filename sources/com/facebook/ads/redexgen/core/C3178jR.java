...
public final class C3178jR implements InterfaceC2226Ks<Bitmap> {
    public static byte[] A06;
    public final int A00;
    public final int A01;
    public final String A02 = C3178jR.class.getSimpleName();
    ...
    public C3178jR(int i10, int i11, boolean z10, boolean z11, boolean z12) {
        this.A01 = i10;
        this.A00 = i11;
        this.A05 = z10;
        this.A03 = z11;
    ...
    public static C2225Kr<Bitmap> A00(Throwable th2) {
        return new C2225Kr<>(false, null, th2);
    }
    ...
    public final C2225Kr<Bitmap> A3p(File file, LA la2) {
        if (!this.A04) {
            return new C2225Kr<>(true, null);
        }
        try {
            Bitmap bitmapA03 = LB.A03(file.getCanonicalPath(), this.A01, this.A00, this.A05);
            if (bitmapA03 != null) {
                return new C2225Kr<>(true, bitmapA03);
            }
            la2.AAq(new C3171jJ(A01(4, 14, 118)));
            return A00(null);
        } catch (Throwable t10) {
            file.delete();
            la2.AAq(t10);
        ...
        if (this.A03) {
            try {
                ...
                if (bitmap != null) {
                    ...
                    file.delete();
                    throw new C3171jJ(A01(4, 14, 118));
                }
            } catch (C3171jJ e10) {
                la2.AB4(e10);
                throw e10;
                ...
                la2.AB4(th2);
                Throwable t10 = new C3171jJ(A01(18, 33, 57), th2);
                throw t10;
            }
        }
    }
