...
public final class KY {
    ...
    private int A00(InterfaceC3286lN interfaceC3286lN) {
        this.A07.A0i(AbstractC18094a.A07);
        this.A03 = true;
        interfaceC3286lN.AI1();
        return 0;
    }

    private int A01(InterfaceC3286lN interfaceC3286lN, C2124Gt c2124Gt, int i10) throws IOException {
        int iMin = (int) Math.min(this.A06, interfaceC3286lN.A8G());
        ...
        this.A07.A0d(iMin);
        interfaceC3286lN.AI1();
        interfaceC3286lN.AG9(this.A07.A0l(), 0, iMin);
        this.A01 = A03(this.A07, i10);
        this.A04 = true;
        return 0;
    }

    private int A02(InterfaceC3286lN interfaceC3286lN, C2124Gt c2124Gt, int i10) throws IOException {
        long inputLength = interfaceC3286lN.A8G();
        int iMin = (int) Math.min(this.A06, inputLength);
        long inputLength2 = inputLength - ((long) iMin);
        if (interfaceC3286lN.A8f() != inputLength2) {
            c2124Gt.A00 = inputLength2;
            return 1;
        }
        this.A07.A0d(iMin);
        interfaceC3286lN.AI1();
    ...
    private long A03(C4J c4j, int i10) {
        ...
        for (int iA09 = c4j.A09(); iA09 < iA0A; iA09++) {
            ...
            if (searchEndPosition == 71) {
                long jA01 = AbstractC2214Kg.A01(c4j, iA09, i10);
    ...
    private long A04(C4J c4j, int i10) {
        ...
        for (int i11 = iA0A - 188; i11 >= iA09; i11--) {
            if (AbstractC2214Kg.A03(c4j.A0l(), iA09, iA0A, i11)) {
                long jA01 = AbstractC2214Kg.A01(c4j, i11, i10);
                if (jA01 != -9223372036854775807L) {
                    return jA01;
                }
            }
    ...
    public final int A07(InterfaceC3286lN interfaceC3286lN, C2124Gt c2124Gt, int i10) throws IOException {
        if (i10 <= 0) {
            return A00(interfaceC3286lN);
        }
        if (!this.A05) {
            return A02(interfaceC3286lN, c2124Gt, i10);
        }
        if (this.A02 == -9223372036854775807L) {
            return A00(interfaceC3286lN);
        }
        if (!this.A04) {
            int iA01 = A01(interfaceC3286lN, c2124Gt, i10);
            if (A0A[0].charAt(2) == 'O') {
