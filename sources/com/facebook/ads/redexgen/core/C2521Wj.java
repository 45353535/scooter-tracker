...
public final class C2521Wj {
    ...
    public static void A05() {
        A00 = new byte[]{-73, -5, 1, -5, -4, -19, -11, -73, -23, -8, -8, -73, -37, -3, -8, -19, -6, -3, -5, -19, -6, -74, -23, -8, -13, -99, -121, -1, -16, 3, -9, 13, 2, -5, -21, -77, -119, -112, -117, -108, 1, -1, 8, -1, Ascii.FF, 3, -3, -1, 1, 42, Ascii.ESC, 41, 42, -29, 33, Ascii.ESC, 47, 41};
    }

    static {
        A05();
        A02 = C2521Wj.class.getSimpleName();
    }

    public static EnumC2520Wi A00(SQ sq) {
        try {
            boolean isRooted = A07() || A06() || A08(A01(47, 2, 78));
            return isRooted ? EnumC2520Wi.A03 : EnumC2520Wi.A05;
        } catch (Throwable t10) {
            sq.A08().AAy(A01(40, 7, 92), AbstractC2433Sv.A1M, new C2434Sw(t10));
            return EnumC2520Wi.A04;
        }
    }
    ...
    public static String A02(Context context, String str) throws PackageManager.NameNotFoundException, NoSuchAlgorithmException, CertificateException {
        ...
        for (Signature signature : signatureArr) {
            sb2.append(C2526Wo.A04(MessageDigest.getInstance(A01(31, 4, 124)).digest(A04(signature).getEncoded())));
    ...
    public static String A03(SQ sq, String str) {
        try {
            ...
            sq.A08().AAy(A01(40, 7, 92), AbstractC2433Sv.A1M, new C2434Sw(e10));
            return null;
        }
    }
