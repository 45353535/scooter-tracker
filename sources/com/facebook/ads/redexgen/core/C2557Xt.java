...
public final class C2557Xt extends AdNativeComponentView {
    ...
    public final C2480Ur A06;
    public final C2234La A07;
    ...
    public static final int A09 = ((int) AbstractC2523Wl.A02) * 500;
    public static final int A0H = (int) (AbstractC2523Wl.A02 * 500.0f);
    public static final int A0D = (int) (AbstractC2523Wl.A02 * 4.0f);
    public static final int A0B = (int) (AbstractC2523Wl.A02 * 8.0f);
    public static final int A0G = (int) (AbstractC2523Wl.A02 * 8.0f);
    public static final int A0E = (int) (AbstractC2523Wl.A02 * 4.0f);
    public static final int A0C = (int) AbstractC2523Wl.A02;
    public static final int A0F = (int) (AbstractC2523Wl.A02 * 4.0f);
    public static final int A0A = (int) (((double) AbstractC2523Wl.A02) * 0.5d);

    public C2557Xt(C2820dL c2820dL, C2480Ur c2480Ur) {
        super(c2820dL);
        this.A06 = c2480Ur;
        this.A05 = new TextView(c2820dL);
        this.A04 = new TextView(c2820dL);
        this.A03 = new TextView(c2820dL);
        this.A02 = new RelativeLayout(c2820dL);
        this.A00 = new LinearLayout(c2820dL);
        this.A01 = new RelativeLayout(c2820dL);
        this.A07 = new C2234La(c2820dL);
        A09();
        A0D();
        A05();
        A0A();
    ...
    private void A0B() {
        ...
        EnumC2528Wq.A04(this.A07, EnumC2528Wq.A0B);
        XP.A0I(this.A07);
    }
    ...
    */
    public final void onMeasure(int r3, int r4) {
        /*
            r2 = this;
            float r0 = com.facebook.ads.redexgen.core.AbstractC2523Wl.A02
            int r1 = (int) r0
        ...
        L22:
            ...
            goto L1e
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2557Xt.onMeasure(int, int):void");
    }
