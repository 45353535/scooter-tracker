...
public final class C3200jn implements KJ {
    ...
    public static void A03() {
        A0E = new byte[]{7, 125, 121, 122, Ascii.GS, 42, 46, 43, 42, 61, 93, 102, 109, 112, 120, 109, 107, 124, 109, 108, 40, 105, 123, 120, 109, 107, 124, 87, 122, 105, 124, 97, 103, 87, 97, 108, 107, 40, 126, 105, 100, 125, 109, 50, 40, Utf8.REPLACEMENT_BYTE, 32, 45, 44, 38, 102, 33, 44, Utf8.REPLACEMENT_BYTE, 42};
    }
    ...
    */
    public static com.facebook.ads.redexgen.core.C3497or A00(java.lang.String r22, com.facebook.ads.redexgen.core.KS r23, com.facebook.ads.redexgen.core.KS r24, com.facebook.ads.redexgen.core.KS r25) {
        /*
            Method dump skipped, instruction units count: 720
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C3200jn.A00(java.lang.String, com.facebook.ads.redexgen.X.KS, com.facebook.ads.redexgen.X.KS, com.facebook.ads.redexgen.X.KS):com.facebook.ads.redexgen.X.or");
    }
    ...
    private void A04(long j10, int i10, int i11, long j11) {
        ...
        if (ks.A04(i11)) {
            this.A06.A0j(this.A08.A01, AbstractC2121Gq.A02(this.A08.A01, this.A08.A00));
            this.A06.A0g(5);
            this.A0C.A02(j11, this.A06);
        }
        if (this.A0A.A04(i11)) {
            this.A06.A0j(this.A0A.A01, AbstractC2121Gq.A02(this.A0A.A01, this.A0A.A00));
            this.A06.A0g(5);
            this.A0C.A02(j11, this.A06);
        }
    }
    ...
    public static void A06(C2123Gs c2123Gs) {
    ...
    public static void A07(C2123Gs c2123Gs) {
        ...
        for (int stRpsIdx = 0; stRpsIdx < iA04; stRpsIdx++) {
            ...
            if (zA0A) {
                ...
                int previousNumDeltaPocs = c2123Gs.A04();
    ...
    public final void A52(C4J c4j) {
        ...
        while (c4j.A07() > 0) {
            ...
            h12.AI7(c4j, offset2);
            while (limit < iA0A) {
                int iA04 = AbstractC2121Gq.A04(bArrA0l, limit, iA0A, this.A0D);
                if (iA04 == iA0A) {
                    A08(bArrA0l, limit, iA0A);
                    return;
                }
                int bytesWrittenPastPosition = AbstractC2121Gq.A00(bArrA0l, iA04);
                int i10 = iA04 - limit;
                if (A0F[7].charAt(7) != 'e') {
                    throw new RuntimeException();
                }
