...
public final class C18515q extends KL {
    ...
    public C18515q(C2820dL c2820dL, KE ke2, int i10, boolean z10, C2283My c2283My, String str, US us, InterfaceC2551Xn interfaceC2551Xn, C2893eX c2893eX, XH xh2, AbstractC3095hy abstractC3095hy, C2023Cw c2023Cw, C2463Ua c2463Ua, boolean z11) {
        super(c2820dL, ke2, i10, z10, c2283My, false, str, us, interfaceC2551Xn, c2893eX, xh2, abstractC3095hy, c2023Cw, c2463Ua, z11);
        this.A00 = new RunnableC2618a2(this);
    ...
    private void A05(int i10) {
        if (i10 == 1) {
            this.A0M.addView(((AbstractC2611Zv) this).A09);
            this.A0M.addView(this.A0Q);
            this.A0M.addView(this.A0P);
            this.A0M.addView(this.A0I);
            this.A0M.addView(((AbstractC2611Zv) this).A08);
    ...
    private void A0C(int i10) {
        ...
        if (i10 == 1) {
            if (this.A0W.get()) {
                ((AbstractC2611Zv) this).A09.setVisibility(8);
            }
            ...
            layoutParams.setMargins(0, KL.A0l, 0, 0);
            ((AbstractC2611Zv) this).A09.setVisibility(0);
        }
        layoutParams.addRule(14);
    ...
    public final void A0h(int i10) {
        super.A0h(i10);
        A06(i10);
        XP.A0Z(this.A0N, ((AbstractC2611Zv) this).A09, this.A0Q, ((AbstractC2611Zv) this).A08, this.A0U, ((KL) this).A04, this.A0P, this.A0K, this.A0J, this.A0I);
        A0D(i10);
        A08(i10);
        A03();
        A0C(i10);
