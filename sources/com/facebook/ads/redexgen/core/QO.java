...
public abstract class QO {
    ...
    public int A0C;
    public int A0D;
    public final InterfaceC2370Qj A0G = new C2988g6(this);
    public final InterfaceC2370Qj A0H = new C2987g5(this);
    public C2372Ql A04 = new C2372Ql(this.A0G);
    public C2372Ql A05 = new C2372Ql(this.A0H);
    ...
    public abstract int A1f(int i10, QW qw, C2364Qd c2364Qd);

    public abstract int A1g(int i10, QW qw, C2364Qd c2364Qd);

    public abstract int A1h(C2364Qd c2364Qd);

    public abstract int A1i(C2364Qd c2364Qd);

    public abstract int A1j(C2364Qd c2364Qd);

    public abstract int A1k(C2364Qd c2364Qd);

    public abstract int A1l(C2364Qd c2364Qd);

    public abstract int A1m(C2364Qd c2364Qd);

    public abstract Parcelable A1n();

    public abstract View A1p(View view, int i10, QW qw, C2364Qd c2364Qd);

    public abstract QP A1q();

    public abstract void A1r(int i10);

    public abstract void A1s(int i10, int i11, C2364Qd c2364Qd, QM qm);

    public abstract void A1t(int i10, QM qm);

    public abstract void A1u(Parcelable parcelable);

    public abstract void A1w(QW qw, C2364Qd c2364Qd);

    public abstract void A1z(C18676g c18676g, C2364Qd c2364Qd, int i10);
    ...
    private final int A08(QW qw, C2364Qd c2364Qd) {
        return 0;
    }
    ...
    private final void A0H(View view, int i10, QP qp) {
        AbstractC2367Qg abstractC2367QgA0F = C18676g.A0F(view);
        if (abstractC2367QgA0F.A0g()) {
            this.A03.A0t.A09(abstractC2367QgA0F);
        } else {
            this.A03.A0t.A0A(abstractC2367QgA0F);
        }
        this.A01.A0H(view, i10, qp, abstractC2367QgA0F.A0g());
    }

    private void A0I(View view, int i10, boolean z10) {
        AbstractC2367Qg abstractC2367QgA0F = C18676g.A0F(view);
        if (z10 || abstractC2367QgA0F.A0g()) {
            this.A03.A0t.A09(abstractC2367QgA0F);
        } else {
            this.A03.A0t.A0A(abstractC2367QgA0F);
        }
        QP qp = (QP) view.getLayoutParams();
        if (abstractC2367QgA0F.A0m() || abstractC2367QgA0F.A0h()) {
            ...
            if (parent == c18676g) {
                ...
                qp.A01 = true;
                AbstractC2362Qb abstractC2362Qb = this.A02;
                if (A0J[4].charAt(12) == 'v') {
                    throw new RuntimeException();
                }
                A0J[6] = "si9YLNjLFs";
                if (abstractC2362Qb != null && this.A02.A0F()) {
                    this.A02.A0C(view);
                }
            }
        }
        if (qp.A02) {
            View view2 = abstractC2367QgA0F.A0H;
            if (A0J[1].length() != 8) {
                throw new RuntimeException();
            }
            A0J[1] = "bg493IDm";
    ...
    private void A0L(QW qw, int i10, View view) {
        ...
        if (abstractC2367QgA0F.A0f()) {
            boolean zA0g = abstractC2367QgA0F.A0g();
            if (A0J[3].charAt(19) == 'k') {
                throw new RuntimeException();
            }
            String[] strArr = A0J;
            ...
            if (!zA0g && !this.A03.A04.A0M()) {
                A0C(i10);
                qw.A0X(abstractC2367QgA0F);
                return;
            }
        }
        A0B(i10);
        qw.A0S(view);
        this.A03.A0t.A0C(abstractC2367QgA0F);
    }

    private final void A0M(QW qw, C2364Qd c2364Qd, AccessibilityEvent accessibilityEvent) {
    ...
    */
    private final void A0N(com.facebook.ads.redexgen.core.QW r6, com.facebook.ads.redexgen.core.C2364Qd r7, com.facebook.ads.redexgen.core.PS r8) {
        /*
            r5 = this;
    ...
    public void A0O(AbstractC2362Qb abstractC2362Qb) {
        if (this.A02 == abstractC2362Qb) {
            this.A02 = null;
        }
    }
    ...
    private final boolean A0R(QW qw, C2364Qd c2364Qd) {
        return false;
    }

    private final boolean A0S(QW qw, C2364Qd c2364Qd, int i10, Bundle bundle) {
        if (this.A03 == null) {
            return false;
        }
        int hScroll = 0;
    ...
    private final boolean A0T(QW qw, C2364Qd c2364Qd, View view, int i10, Bundle bundle) {
        return false;
    }

    private boolean A0U(C18676g c18676g, int i10, int i11) {
        View focusedChild = c18676g.getFocusedChild();
    ...
    @Deprecated
    private final boolean A0V(C18676g c18676g, View view, View view2) {
        return A0P() || c18676g.A1s();
    }
    ...
    public int A0s(QW qw, C2364Qd c2364Qd) {
    ...
    public int A0t(QW qw, C2364Qd c2364Qd) {
    ...
    public final void A1C(View view, int i10, int i11) {
        ...
        int iA03 = A03(A0j(), A0k(), A0g() + A0h() + qp.leftMargin + qp.rightMargin + i12, qp.width, A22());
        int iA0Z = A0Z();
        int iA0a = A0a();
        int widthSpec = A0i();
        int iA032 = A03(iA0Z, iA0a, widthSpec + A0f() + qp.topMargin + qp.bottomMargin + i13, qp.height, A23());
    ...
    public final void A1D(View view, int i10, int i11, int i12, int i13) {
        QP qp = (QP) view.getLayoutParams();
        Rect rect = qp.A03;
        view.layout(rect.left + i10 + qp.leftMargin, rect.top + i11 + qp.topMargin, (i12 - rect.right) - qp.rightMargin, (i13 - rect.bottom) - qp.bottomMargin);
    }
    ...
    public final void A1E(View view, PS ps) {
        ...
        if (abstractC2367QgA0F != null) {
            ...
            A0J[1] = "uJMRqraa";
            if (!zA0g && !this.A01.A0K(abstractC2367QgA0F.A0H)) {
    ...
    public final void A1G(View view, boolean z10, Rect rect) {
        ...
        if (c18676g != null && (matrix = view.getMatrix()) != null && !matrix.isIdentity()) {
    ...
    public final void A1I(QW qw) {
        ...
        for (int i10 = iA0E - 1; i10 >= 0; i10--) {
            ...
            AbstractC2367Qg abstractC2367QgA0F = C18676g.A0F(viewA0F);
            if (!abstractC2367QgA0F.A0l()) {
                abstractC2367QgA0F.A0d(false);
                if (abstractC2367QgA0F.A0i()) {
                    this.A03.removeDetachedView(viewA0F, false);
                }
                if (this.A03.A05 != null) {
                    this.A03.A05.A0L(abstractC2367QgA0F);
                }
                abstractC2367QgA0F.A0d(true);
                qw.A0R(viewA0F);
            }
        }
        qw.A0L();
    ...
    public final void A1K(QW qw) {
        for (int iA0Y = A0Y() - 1; iA0Y >= 0; iA0Y--) {
            if (!C18676g.A0F(A0v(iA0Y)).A0l()) {
                A16(iA0Y, qw);
            }
        }
    }

    public void A1L(QW qw, C2364Qd c2364Qd, int i10, int i11) {
        this.A03.A1c(i10, i11);
    }

    public void A1M(QW qw, C2364Qd c2364Qd, View view, PS ps) {
        PQ itemInfo = PQ.A00(A23() ? A0r(view) : 0, 1, A22() ? A0r(view) : 0, 1, false, false);
        ps.A0Q(itemInfo);
    }

    public final void A1N(AbstractC2362Qb abstractC2362Qb) {
        if (this.A02 != null) {
            AbstractC2362Qb abstractC2362Qb2 = this.A02;
            if (A0J[4].charAt(12) == 'v') {
                throw new RuntimeException();
            }
            A0J[6] = RequestConfiguration.MAX_AD_CONTENT_RATING_G;
            if (abstractC2362Qb != abstractC2362Qb2 && this.A02.A0F()) {
                AbstractC2362Qb abstractC2362Qb3 = this.A02;
                if (A0J[6].length() != 15) {
                    A0J[3] = "jdqDA9lv9LoPYcF6nkiuFYbBQf2p3Jna";
                    abstractC2362Qb3.A09();
                } else {
                    String[] strArr = A0J;
        ...
        this.A02 = abstractC2362Qb;
        this.A02.A0D(this.A03, this);
    }

    public void A1O(C18676g c18676g) {
    }

    public final void A1P(C18676g c18676g) {
        this.A07 = true;
    }

    public final void A1Q(C18676g c18676g) {
        A13(View.MeasureSpec.makeMeasureSpec(c18676g.getWidth(), 1073741824), View.MeasureSpec.makeMeasureSpec(c18676g.getHeight(), 1073741824));
    }

    public final void A1R(C18676g c18676g) {
        if (c18676g == null) {
            this.A03 = null;
            this.A01 = null;
            this.A0C = 0;
            ...
            this.A03 = c18676g;
            this.A01 = c18676g.A01;
            this.A0C = c18676g.getWidth();
            this.A0A = c18676g.getHeight();
        }
        this.A0D = 1073741824;
        this.A0B = 1073741824;
    }

    public final void A1S(C18676g c18676g, QW qw) {
        this.A07 = false;
        A1y(c18676g, qw);
    }
    ...
    public final boolean A1Y(View view, int i10, int i11, QP qp) {
        if (!view.isLayoutRequested()) {
            ...
            if (z10 && A0Q(view.getWidth(), i10, qp.width) && A0Q(view.getHeight(), i11, qp.height)) {
                return false;
            }
        }
        return true;
    ...
    public final boolean A1b(C18676g c18676g, View view, Rect rect, boolean z10) {
        return A1c(c18676g, view, rect, z10, false);
    }

    public final boolean A1c(C18676g c18676g, View view, Rect rect, boolean z10, boolean z11) {
        int[] scrollAmount = A0W(view, rect);
        int i10 = scrollAmount[0];
        int i11 = scrollAmount[1];
        if ((z11 && !A0U(c18676g, i10, i11)) || (i10 == 0 && i11 == 0)) {
            return false;
        }
        if (z10) {
            c18676g.scrollBy(i10, i11);
        } else {
            c18676g.A1e(i10, i11);
        }
        return true;
    ...
    public final boolean A1d(C18676g c18676g, C2364Qd c2364Qd, View view, View view2) {
        return A0V(c18676g, view, view2);
    }

    public final boolean A1e(C18676g c18676g, ArrayList<View> views, int i10, int i11) {
        return false;
    }
    ...
    public View A1o(int i10) {
        ...
        for (int i11 = 0; i11 < iA0Y; i11++) {
            View child = A0v(i11);
            AbstractC2367Qg abstractC2367QgA0F = C18676g.A0F(child);
            if (abstractC2367QgA0F != null) {
                int childCount = abstractC2367QgA0F.A0O();
                if (childCount == i10 && !abstractC2367QgA0F.A0l() && (this.A03.A0s.A07() || !abstractC2367QgA0F.A0g())) {
                    return child;
                }
            }
        }
    ...
    public void A1x(C2364Qd c2364Qd) {
    }

    public void A1y(C18676g c18676g, QW qw) {
    }
