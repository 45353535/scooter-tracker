...
public abstract class KB {
     ...
     */
    public static int A06(List<C2207Jz> list, String str, K7 k72) {
        List<K8> listA0E = A0E(list, str, k72);
        for (int i10 = 0; i10 < listA0E.size(); i10++) {
            C2207Jz c2207Jz = listA0E.get(i10).A01;
            if (c2207Jz.A07() != -1) {
                return c2207Jz.A07();
            }
        }
    ...
    */
    public static android.text.SpannedString A07(java.lang.String r11, java.lang.String r12, java.util.List<com.facebook.ads.redexgen.core.C2207Jz> r13) {
        /*
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    public static K3 A0A(C4J c4j, List<C2207Jz> list) {
    ...
    public static void A0H(SpannableStringBuilder spannableStringBuilder, String str, K7 k72, List<K6> list, List<C2207Jz> list2) {
        ...
        for (int i11 = 0; i11 < arrayList.size(); i11++) {
            if (A0C(TTAdConstant.VIDEO_COVER_URL_CODE, 2, 49).equals(((K6) arrayList.get(i11)).A01.A01)) {
                ...
                spannableStringBuilder.setSpan(new C3441nv(charSequenceSubSequence.toString(), iA00), i10, i12, 33);
    ...
    */
    ...
    public static C3448o2 A09(CharSequence charSequence) {
        KA infoBuilder = new KA();
        infoBuilder.A0A = charSequence;
        return infoBuilder.A07().A0H();
    }

    public static K3 A0B(String str, Matcher matcher, C4J c4j, List<C2207Jz> list) {
        KA ka2 = new KA();
        try {
    ...
    public static String A0D(String str) {
        ...
        return AbstractC18094a.A1P(strTrim, A0C(182, 5, 117))[0];
    }

    public static List<K8> A0E(List<C2207Jz> list, String str, K7 k72) {
        ArrayList arrayList = new ArrayList();
        for (int i10 = 0; i10 < list.size(); i10++) {
            C2207Jz c2207Jz = list.get(i10);
            int i11 = c2207Jz.A09(str, k72.A01, k72.A03, k72.A02);
            if (i11 > 0) {
                arrayList.add(new K8(i11, c2207Jz));
            }
        }
    ...
    public static void A0G(SpannableStringBuilder spannableStringBuilder, C2207Jz c2207Jz, int i10, int i11) {
        if (c2207Jz == null) {
            return;
        }
        if (c2207Jz.A08() != -1) {
            C3H.A00(spannableStringBuilder, new StyleSpan(c2207Jz.A08()), i10, i11, 33);
        }
        if (c2207Jz.A0S()) {
            spannableStringBuilder.setSpan(new StrikethroughSpan(), i10, i11, 33);
        }
        boolean zA0T = c2207Jz.A0T();
        if (A01[3].charAt(21) != 'Z') {
            ...
            if (c2207Jz.A0R()) {
                C3H.A00(spannableStringBuilder, new ForegroundColorSpan(c2207Jz.A05()), i10, i11, 33);
            }
            if (c2207Jz.A0Q()) {
                C3H.A00(spannableStringBuilder, new BackgroundColorSpan(c2207Jz.A04()), i10, i11, 33);
            }
            if (c2207Jz.A0K() != null) {
                C3H.A00(spannableStringBuilder, new TypefaceSpan(c2207Jz.A0K()), i10, i11, 33);
            }
            switch (c2207Jz.A06()) {
                case 1:
                    C3H.A00(spannableStringBuilder, new AbsoluteSizeSpan((int) c2207Jz.A03(), true), i10, i11, 33);
                    break;
                case 2:
                    C3H.A00(spannableStringBuilder, new RelativeSizeSpan(c2207Jz.A03()), i10, i11, 33);
                    break;
                case 3:
                    C3H.A00(spannableStringBuilder, new RelativeSizeSpan(c2207Jz.A03() / 100.0f), i10, i11, 33);
                    break;
            }
            if (c2207Jz.A0P()) {
                spannableStringBuilder.setSpan(new C3442nw(), i10, i11, 33);
                return;
            }
            return;
        }
    ...
    */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static void A0K(java.lang.String r8, com.facebook.ads.redexgen.core.K7 r9, java.util.List<com.facebook.ads.redexgen.core.K6> r10, android.text.SpannableStringBuilder r11, java.util.List<com.facebook.ads.redexgen.core.C2207Jz> r12) {
        /*
