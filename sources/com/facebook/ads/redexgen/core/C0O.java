...
public final class C0O extends AnonymousClass14 {
     ...
     */
    public static Point A07(AR ar, C3497or c3497or) throws C1973Av {
        boolean z10 = c3497or.A0A > c3497or.A0L;
        int i10 = z10 ? c3497or.A0A : c3497or.A0L;
        int i11 = z10 ? c3497or.A0L : c3497or.A0A;
        float f10 = i11 / i10;
        for (int i12 : A13) {
            int i13 = (int) (i12 * f10);
            if (i12 <= i10 || i13 <= i11) {
            ...
            if (AbstractC18094a.A02 >= 21) {
                int i14 = z10 ? i13 : i12;
                if (!z10) {
                    i12 = i13;
                }
                Point pointA0N = ar.A0N(i14, i12);
                if (ar.A0R(pointA0N.x, pointA0N.y, c3497or.A01)) {
                    return pointA0N;
                }
            } else {
                int iA05 = AbstractC18094a.A05(i12, 16) * 16;
                int iA052 = AbstractC18094a.A05(i13, 16) * 16;
                if (iA05 * iA052 <= C1976Ay.A00()) {
    ...
    public C0O(Context context, C3092hv c3092hv, MediaCodecRendererMetaParameters mediaCodecRendererMetaParameters, InterfaceC1969Ar interfaceC1969Ar, long j10, C9U c9u, boolean z10, boolean z11, Handler handler, InterfaceC2093Fo interfaceC2093Fo, int i10, int i11, int i12, int i13, int i14) {
        super(2, c3092hv, mediaCodecRendererMetaParameters, interfaceC1969Ar, c9u, z10, z11, i12, i13);
        this.A0e = true;
        this.A0Z = true;
        boolean z12 = false;
        this.A0f = false;
        ...
        this.A0c = false;
        this.A0h = false;
        this.A0w = MetaExoPlayerUpgradeConfig.A03(EnumC3096i2.A1r);
        this.A0h = MetaExoPlayerUpgradeConfig.A03(EnumC3096i2.A0w);
        this.A0p = j10;
        this.A0l = i10;
        this.A0m = i11;
        ...
        this.A0u = new C2092Fn(handler, interfaceC2093Fo);
        this.A0r = new FC(this.A0s, this, this.A0w);
        this.A0v = A0i();
        if (AbstractC18094a.A02 == 29 && AbstractC18094a.A06.startsWith(A0B(811, 6, 62))) {
            z12 = true;
        }
        this.A0a = z12;
    ...
    private int A00(C3497or c3497or) {
        if (c3497or.A0B != -1) {
            int i10 = 0;
            int i11 = c3497or.A0X.size();
            for (int initializationDataCount = 0; initializationDataCount < i11; initializationDataCount++) {
                int totalInitializationDataSize = c3497or.A0X.get(initializationDataCount).length;
                i10 += totalInitializationDataSize;
            }
            int totalInitializationDataSize2 = c3497or.A0B;
            return totalInitializationDataSize2 + i10;
        }
        int i12 = c3497or.A0L;
        String str = c3497or.A0W;
        int width = c3497or.A0A;
    ...
    */
    public static int A01(com.facebook.ads.redexgen.core.InterfaceC1969Ar r8, com.facebook.ads.redexgen.core.C3497or r9, boolean r10) throws com.facebook.ads.redexgen.core.C1973Av {
        /*
    ...
    */
    ...
    private final MediaFormat A08(C3497or c3497or, FA fa2, boolean z10, int i10) {
        MediaFormat mediaFormat = new MediaFormat();
        mediaFormat.setString(A0B(1462, 4, 83), c3497or.A0W);
        mediaFormat.setInteger(A0B(1755, 5, 79), c3497or.A0L);
        mediaFormat.setInteger(A0B(1307, 6, 73), c3497or.A0A);
        AnonymousClass46.A06(mediaFormat, c3497or.A0X);
        AnonymousClass46.A03(mediaFormat, A0B(1286, 10, 109), c3497or.A01);
        AnonymousClass46.A04(mediaFormat, A0B(1548, 16, 7), c3497or.A0F);
        AnonymousClass46.A02(mediaFormat, c3497or.A0N);
        ...
        AbstractC3074hY.A03(this.A11, mediaFormat);
        if (i10 != 0) {
            A0T(mediaFormat, i10);
        }
        return mediaFormat;
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private final com.facebook.ads.redexgen.core.FA A0A(com.facebook.ads.redexgen.core.AR r12, com.facebook.ads.redexgen.core.C3497or r13, com.facebook.ads.redexgen.core.C3497or[] r14) throws com.facebook.ads.redexgen.core.C1973Av {
        /*
    ...
    public static List<AR> A0C(InterfaceC1969Ar interfaceC1969Ar, C3497or c3497or) throws C1973Av {
        ArrayList arrayList = new ArrayList();
        String alternativeMimeType = C1976Ay.A0P(c3497or);
        if (alternativeMimeType != null) {
            List<AR> listA7g = interfaceC1969Ar.A7g(alternativeMimeType, false, false);
            if (AbstractC18094a.A02 >= 26) {
                if (A0B(1664, 18, 7).equals(c3497or.A0W) && !listA7g.isEmpty()) {
                    return listA7g;
                }
                return arrayList;
            }
    ...
    public static List<AR> A0D(InterfaceC1969Ar interfaceC1969Ar, C3497or c3497or, boolean z10) throws C1973Av {
        String str = c3497or.A0W;
        if (str == null) {
            return Collections.emptyList();
        }
        return Collections.unmodifiableList(interfaceC1969Ar.A7g(str, z10, false));
    }

    private void A0E() {
        AO aoA1j;
        this.A0i = false;
        if (AbstractC18094a.A02 >= 23 && this.A0k && (aoA1j = A1j()) != null) {
            this.A00 = new C3298la(this, aoA1j);
        }
    }
    ...
    private void A0G() {
        if (this.A0r.A0G() && MetaExoPlayerUpgradeConfig.A03(EnumC3096i2.A1p)) {
            this.A0r.A0A();
            throw null;
        }
    }
    ...
    private void A0K() {
        ...
        if (this.A0G != this.A08 || this.A0E != this.A06 || this.A0F != this.A07 || this.A03 != this.A01) {
            this.A0u.A07(new C3450o4(this.A08, this.A06, this.A07, this.A01));
            this.A0G = this.A08;
            this.A0E = this.A06;
            this.A0F = this.A07;
            this.A03 = this.A01;
    ...
    private void A0M() {
        if (this.A0G != -1 || this.A0E != -1) {
            this.A0u.A07(new C3450o4(this.A0G, this.A0E, this.A0F, this.A03));
        }
    }
    ...
    */
    private final void A0R(long r10, long r12, float r14) {
        /*
            r9 = this;
            long r0 = com.facebook.ads.redexgen.core.AbstractC17551w.A01(r10)
            int r6 = (int) r0
            long r0 = com.facebook.ads.redexgen.core.AbstractC17551w.A01(r12)
            int r5 = (int) r0
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void A0S(long j10, long j11, C3497or c3497or, MediaFormat mediaFormat) {
        if (this.A0X != null) {
            this.A0X.AFi(j10, j11, c3497or, mediaFormat);
        }
    }
    ...
    */
    ...
    private void A0V(C3497or c3497or) {
        AO codec = A1j();
        if (codec != null && c3497or != null) {
            Pair<Long, Integer> pairA8b = codec.A8b();
            if (((Long) pairA8b.first).longValue() > 0) {
                super.A0j.A04(pairA8b);
                C2092Fn c2092Fn = this.A0u;
                if (A12[2].charAt(6) == 'n') {
                    throw new RuntimeException();
                }
                A12[3] = "UGSzGWhN7NgjOmIm99IkQUILfPM9Cd";
                c2092Fn.A04(super.A0j.A00, c3497or);
            }
        }
    }

    private final void A0W(AO ao, int i10, long j10) {
    ...
    @MetaExoPlayerCustomization("D36797879: Adding implementation for calculating avg render time")
    private final void A0X(AO ao, int i10, long j10) {
        if (this.A0w) {
            A0Y(ao, i10, j10);
            return;
        }
    ...
    @MetaExoPlayerCustomization("D36797879: Adding implementation for calculating avg render time")
    private final void A0Y(AO ao, int i10, long j10) {
        C4S.A02(A0B(1529, 19, 51));
        long jElapsedRealtime = SystemClock.elapsedRealtime();
        ao.AGy(i10, true);
        long j11 = super.A0h;
    ...
    private final void A0Z(AO ao, int i10, long j10) {
    ...
    @MetaExoPlayerCustomization("D36797879: Adding implementation for calculating avg render time")
    private final void A0a(AO ao, int i10, long j10, long j11) {
        if (this.A0w) {
            A0c(ao, i10, j10, j11, true);
            return;
        }
        A0K();
    ...
    private final void A0b(@MetaExoPlayerCustomization AO ao, int i10, long j10, long j11, boolean z10) {
        if (this.A0w) {
            A0c(ao, i10, j10, j11, z10);
            return;
        }
        A0K();
        A0S(j10, j11, super.A0i, this.A0S);
    ...
    */
    ...
    public static boolean A0h() {
        return AbstractC18094a.A02 >= 21;
    }

    public static boolean A0i() {
        return AbstractC18094a.A02 <= 22 && A0B(1280, 6, 87).equals(AbstractC18094a.A03) && A0B(725, 6, 88).equals(AbstractC18094a.A05);
    }
    ...
    */
    ...
    private final boolean A0p(long j10, long j11) {
        return A0k(j10) && j11 > SilenceSkippingAudioProcessor.DEFAULT_MINIMUM_SILENCE_DURATION_US;
    }

    private final boolean A0q(AO ao, int i10, long j10, long j11) throws C9Y {
        int iA1Q = A1Q(j11);
        if (iA1Q == 0) {
            return false;
        }
        C18415g c18415g = super.A0j;
        int droppedSourceBufferCount = c18415g.A06;
        c18415g.A06 = droppedSourceBufferCount + 1;
    ...
    private boolean A0r(AR ar) {
        return AbstractC18094a.A02 >= 23 && this.A0e && !this.A0k && !A0u(ar.A03) && (!ar.A06 || DummySurface.A05(this.A0q));
    }
    ...
    */
    ...
    public static boolean A0v(boolean z10, C3497or c3497or, C3497or c3497or2) {
        return c3497or.A0W.equals(c3497or2.A0W) && c3497or.A0F == c3497or2.A0F && (z10 || (c3497or.A0L == c3497or2.A0L && c3497or.A0A == c3497or2.A0A)) && AbstractC18094a.A1E(c3497or.A0N, c3497or2.A0N);
    }
    ...
    @Override // com.facebook.ads.redexgen.core.AnonymousClass14, com.facebook.ads.redexgen.core.C9Z
    public final void A1c(C3497or[] c3497orArr, long j10, long j11) throws C9Y {
        ...
        super.A1c(c3497orArr, j10, j11);
    }

    @Override // com.facebook.ads.redexgen.core.AnonymousClass14
    public final int A1g(AO ao, AR ar, C3497or c3497or, C3497or c3497or2) {
        if (AbstractC3074hY.A04(this.A11, c3497or.A0L, c3497or.A0A, c3497or2.A0L, c3497or2.A0A)) {
            return 0;
        }
        if (A21() && c3497or.A0W.equals(c3497or2.A0W) && c3497or.A0F == c3497or2.A0F) {
            return 1;
        }
        if (!A0v(ar.A04, c3497or, c3497or2) || c3497or2.A0L > this.A0W.A02 || c3497or2.A0A > this.A0W.A00 || A00(c3497or2) > this.A0W.A01) {
            return 0;
        }
        boolean zA0A = c3497or.A0A(c3497or2);
        if (A12[2].charAt(6) == 'n') {
            throw new RuntimeException();
        }
    ...
    @Override // com.facebook.ads.redexgen.core.AnonymousClass14
    public final int A1h(InterfaceC1969Ar interfaceC1969Ar, C9U c9u, C3497or c3497or) throws C1973Av {
        if (A24(c3497or)) {
            return 20;
        }
        return A01(interfaceC1969Ar, c3497or, super.A0l);
    }

    @Override // com.facebook.ads.redexgen.core.AnonymousClass14
    public final List<AR> A1l(InterfaceC1969Ar interfaceC1969Ar, C3497or c3497or, boolean z10) throws C1973Av {
        return A0D(interfaceC1969Ar, c3497or, z10);
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void A1r(com.facebook.ads.redexgen.core.C3497or r6) {
        /*
            r5 = this;
        ...
        L53:
            ...
            throw r0
        L59:
            com.facebook.ads.redexgen.X.i3 r0 = com.facebook.ads.redexgen.core.EnumC3097i3.A09
    ...
    @Override // com.facebook.ads.redexgen.core.AnonymousClass14
    public final void A1s(C3497or c3497or) throws C9Y {
        super.A1s(c3497or);
        this.A0u.A05(c3497or, null);
        this.A02 = c3497or.A02;
        this.A0D = c3497or.A0F;
    }

    @Override // com.facebook.ads.redexgen.core.AnonymousClass14
    public final void A1t(C3497or c3497or) throws C9Y {
        if (!this.A0r.A0G()) {
            this.A0r.A0J(c3497or, A1i());
        }
    }

    @Override // com.facebook.ads.redexgen.core.AnonymousClass14
    public final void A1u(C3419nY c3419nY) {
        this.A04++;
        this.A0O = Math.max(c3419nY.A01, this.A0O);
        if (AbstractC18094a.A02 < 23 && this.A0k) {
            A27();
        }
    }
    ...
    public final void A1v(AO ao, MediaFormat mediaFormat) {
        ...
        this.A0V = new C3450o4(this.A08, this.A06, this.A07, this.A01);
    ...
    public final void A1w(AR ar, AO ao, C3497or c3497or, MediaCrypto mediaCrypto) throws C1973Av {
        this.A0W = A0A(ar, c3497or, A1e());
        MediaFormat mediaFormatA08 = A08(c3497or, this.A0W, this.A0v, this.A0o);
        if (this.A0U == null) {
            C3M.A08(A0r(ar));
            if (this.A0T == null) {
        ...
        boolean z13 = z11 && ar.A00 != null && ar.A00.isFeatureSupported(strA0B);
        if (ar.A03.equals(A0B(1181, 28, 58)) && this.A11.A09) {
            z12 = true;
        }
        if ((AbstractC18094a.A02 >= 30 || this.A11.A0I) && z13 && !z12) {
    ...
    public final void A1z(String str, C3497or c3497or) throws C9Y {
        this.A0u.A0F(str);
        if (!this.A0r.A0G()) {
            this.A0r.A0J(c3497or, A1i());
        }
    ...
    */
    ...
    @Override // com.facebook.ads.redexgen.core.AnonymousClass14, com.facebook.ads.redexgen.core.InterfaceC3407nM
    ...
    */
    public final boolean AAV() {
        ...
        L14:
            ...
            boolean r0 = r9.A0k
            if (r0 != 0) goto L22
            com.facebook.ads.redexgen.X.hX r0 = com.facebook.ads.redexgen.core.EnumC3073hX.A08
            r9.A0B = r0
        L22:
            boolean r0 = super.AAV()
            r8 = 1
