...
public final class C3274lB implements GX {
    ...
    public static final InterfaceC2106Gb A0F = new InterfaceC2106Gb() { // from class: com.facebook.ads.redexgen.X.lC
    ...
    public C3274lB(int i10) {
        this.A0D = new byte[42];
        this.A0A = new C4J(new byte[32768], 0);
        this.A0C = (i10 & 1) != 0;
        this.A0B = new C2107Gc();
        this.A03 = 0;
    }

    private int A00(InterfaceC3286lN interfaceC3286lN, C2124Gt c2124Gt) throws IOException {
        C3M.A01(this.A08);
        C3M.A01(this.A07);
        if (this.A09 != null && this.A09.A09()) {
            return this.A09.A06(interfaceC3286lN, c2124Gt);
        }
        long j10 = this.A04;
        if (A0E[2].length() == 19) {
            A0E[2] = "5vsaEOzV8f26KwvJg69";
            if (j10 == -1) {
                this.A04 = AbstractC2108Gd.A01(interfaceC3286lN, this.A07);
                return 0;
            }
            ...
            if (strArr[6].length() != strArr[1].length()) {
                ...
                if (iA0A < 32768) {
                    ...
                    int i10 = interfaceC3286lN.read(this.A0A.A0l(), iA0A, currentLimit);
                    z10 = i10 == -1;
                    if (!z10) {
    ...
    */
    private long A01(com.facebook.ads.redexgen.core.C4J r6, boolean r7) {
        ...
        L9:
            ...
            boolean r0 = com.facebook.ads.redexgen.core.AbstractC2108Gd.A07(r6, r2, r1, r0)
            if (r0 == 0) goto L28
            r6.A0f(r3)
            com.facebook.ads.redexgen.X.Gc r0 = r5.A0B
            long r0 = r0.A00
        ...
        L2d:
            ...
            boolean r2 = com.facebook.ads.redexgen.core.AbstractC2108Gd.A07(r6, r2, r1, r0)     // Catch: java.lang.IndexOutOfBoundsException -> L44
            goto L45
        L44:
            r2 = 0
        L45:
        ...
        L68:
            r3 = -1
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C3274lB.A0E
            r0 = 3
            r1 = r2[r0]
            r0 = 4
            r0 = r2[r0]
        ...
        L82:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C3274lB.A01(com.facebook.ads.redexgen.X.4J, boolean):long");
    }

    private InterfaceC2127Gw A02(long j10, long j11) {
        C3M.A01(this.A07);
        if (this.A07.A0A != null) {
            return new C3283lK(this.A07, j10);
        }
        if (j11 != -1 && this.A07.A09 > 0) {
            this.A09 = new C3276lD(this.A07, this.A01, j10, j11);
            return this.A09.A07();
        }
        return new C3281lI(this.A07.A06());
    }

    private void A03() {
        ((H1) AbstractC18094a.A0f(this.A08)).AIA((this.A04 * 1000000) / ((long) ((C2112Gh) AbstractC18094a.A0f(this.A07)).A07), 1, this.A00, 0, null);
    }

    private void A04(InterfaceC3286lN interfaceC3286lN) throws IOException {
        this.A01 = AbstractC2110Gf.A00(interfaceC3286lN);
        ((GY) AbstractC18094a.A0f(this.A06)).AIN(A02(interfaceC3286lN.A8f(), interfaceC3286lN.A8G()));
        this.A03 = 5;
    }

    private void A05(InterfaceC3286lN interfaceC3286lN) throws IOException {
        interfaceC3286lN.AG9(this.A0D, 0, this.A0D.length);
        interfaceC3286lN.AI1();
        this.A03 = 2;
    }

    private void A06(InterfaceC3286lN interfaceC3286lN) throws IOException {
        this.A05 = AbstractC2110Gf.A02(interfaceC3286lN, !this.A0C);
        this.A03 = 1;
    }

    private void A07(InterfaceC3286lN interfaceC3286lN) throws IOException {
        boolean zA0B = false;
        C2109Ge metadataHolder = new C2109Ge(this.A07);
        while (!zA0B) {
            zA0B = AbstractC2110Gf.A0B(interfaceC3286lN, metadataHolder);
            this.A07 = (C2112Gh) AbstractC18094a.A0f(metadataHolder.A00);
        }
        C3M.A01(this.A07);
        this.A02 = Math.max(this.A07.A06, 6);
        ((H1) AbstractC18094a.A0f(this.A08)).A6W(this.A07.A08(this.A0D, this.A05));
        this.A03 = 4;
    }

    private void A08(InterfaceC3286lN interfaceC3286lN) throws IOException {
        AbstractC2110Gf.A09(interfaceC3286lN);
        this.A03 = 3;
    }

    public static /* synthetic */ GX[] A09() {
        return new GX[]{new C3274lB()};
    }
    ...
    public final int AGb(InterfaceC3286lN interfaceC3286lN, C2124Gt c2124Gt) throws IOException {
        switch (this.A03) {
            ...
            case 4:
                ...
                return 0;
            case 5:
                return A00(interfaceC3286lN, c2124Gt);
            default:
    ...
    public final boolean AJL(InterfaceC3286lN interfaceC3286lN) throws IOException {
        AbstractC2110Gf.A01(interfaceC3286lN, false);
        return AbstractC2110Gf.A0A(interfaceC3286lN);
    }
}
