...
public final class C3189jc implements GP {
    ...
    public C3189jc(int i10, C4R c4r, int i11) {
        this.A00 = i10;
        this.A03 = c4r;
        this.A01 = i11;
    }
    ...
    private GN A00(C4J c4j, long j10, long j11) {
        ...
        while (c4j.A07() >= 188 && (iA002 = (iA00 = AbstractC2214Kg.A00(c4j.A0l(), c4j.A09(), iA0A)) + 188) <= iA0A) {
            long jA01 = AbstractC2214Kg.A01(c4j, iA00, this.A00);
            if (jA01 != -9223372036854775807L) {
                ...
                long j14 = jA06 + SilenceSkippingAudioProcessor.DEFAULT_MINIMUM_SILENCE_DURATION_US;
                String[] strArr3 = A04;
    ...
    public final void AFA() {
        this.A02.A0i(AbstractC18094a.A07);
    }

    @Override // com.facebook.ads.redexgen.core.GP
    public final GN AIC(InterfaceC3286lN interfaceC3286lN, long j10) throws IOException {
        long jA8f = interfaceC3286lN.A8f();
        int iMin = (int) Math.min(this.A01, interfaceC3286lN.A8G() - jA8f);
        this.A02.A0d(iMin);
        interfaceC3286lN.AG9(this.A02.A0l(), 0, iMin);
