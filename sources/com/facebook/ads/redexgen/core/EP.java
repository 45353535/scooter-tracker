...
public final class EP extends FrameLayout implements InterfaceC2821dM {
    public TextView A00;
    public TextView A01;
    public TextView A02;
    public TextView A03;
    ...
    public static final int A0E = (int) (AbstractC2523Wl.A02 * 6.0f);
    public static final int A0D = (int) (AbstractC2523Wl.A02 * 8.0f);
    public static final int A0C = (int) (AbstractC2523Wl.A02 * 12.0f);
    public static final int A0A = (int) (AbstractC2523Wl.A02 * 350.0f);
    public static final int A09 = (int) (AbstractC2523Wl.A02 * 250.0f);
    public static final int A0B = (int) (AbstractC2523Wl.A02 * 175.0f);

    public EP(C2820dL c2820dL, NativeAd nativeAd, C2480Ur c2480Ur, EnumC2481Us enumC2481Us, C2634aK c2634aK, MediaView mediaView, AdOptionsView adOptionsView) {
        super(c2820dL);
        this.A07 = new ArrayList<>();
        this.A05 = nativeAd;
        this.A04 = mediaView;
        this.A06 = new C2822dN(c2820dL, this.A05, c2480Ur, c2634aK, adOptionsView);
        this.A06.setPadding(A0C, A0C, A0C, A0E);
        addView(this.A06, new FrameLayout.LayoutParams(-1, -2));
        if (enumC2481Us == EnumC2481Us.A09 || enumC2481Us == EnumC2481Us.A0B) {
            A07(c2480Ur);
        }
        addView(this.A04, new FrameLayout.LayoutParams(-1, -2));
        if (enumC2481Us != EnumC2481Us.A0B || this.A05.getAdCreativeType() != NativeAd.AdCreativeType.CAROUSEL) {
            A06(c2480Ur);
            A04(c2480Ur);
            A05(c2480Ur);
        }
        this.A07.add(c2634aK);
    ...
    */
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2821dM
    public View getView() {
        return this;
    }
    ...
    public final void onLayout(boolean z10, int i10, int i11, int i12, int i13) {
        C2822dN c2822dN = this.A06;
        int top = this.A06.getMeasuredHeight();
        c2822dN.layout(i10, i11, i12, top + i11);
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (emptySpace == 0) {
            ...
            if (emptySpace2 == 0 || ((C2964fh) this.A04.getMediaViewApi()).A0N()) {
                iMin = iA00;
            } else {
