...
public final class C0L extends AbstractViewOnTouchListenerC17100d implements InterfaceC2784ck {
    ...
    public C0L(C2820dL c2820dL) {
        ...
        this.A00 = 0;
        this.A05 = false;
        this.A06 = new C6F(c2820dL, new C2781ch(), new C2780cg());
        A02();
    }

    public C0L(C2820dL c2820dL, AttributeSet attributeSet) {
    ...
    public C0L(C2820dL c2820dL, AttributeSet attributeSet, int i10) {
    ...
    @Override // com.facebook.ads.redexgen.core.AbstractViewOnTouchListenerC17100d
    public final void A20(int i10, boolean z10) {
        super.A20(i10, z10);
        A04(i10, 0);
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC2784ck
    public final int A8g(int i10) {
        int iAbs = Math.abs(i10);
        int scrollXAbs = ((AbstractViewOnTouchListenerC17100d) this).A06;
        if (iAbs <= scrollXAbs) {
            return 0;
        }
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        if (this.A05) {
            int i12 = (int) AbstractC2523Wl.A02;
        ...
        if (this.A05) {
            int verticalPadding5 = C2557Xt.A09;
    ...
    public void setOnPageChangedListener(InterfaceC2562Xy interfaceC2562Xy) {
        this.A04 = interfaceC2562Xy;
    }
