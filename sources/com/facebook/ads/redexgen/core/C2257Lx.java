...
public class C2257Lx implements Comparable<C2257Lx> {
    ...
    static {
        A01();
        A07 = C2257Lx.class.getSimpleName();
    }

    public C2257Lx(String str, long j10, long j11, long j12, File file) {
        this.A04 = str;
        this.A02 = j10;
        this.A01 = j11;
        this.A05 = file != null;
    ...
    public final int compareTo(C2257Lx c2257Lx) {
        if (!this.A04.equals(c2257Lx.A04)) {
            return this.A04.compareTo(c2257Lx.A04);
        }
        long j10 = this.A02 - c2257Lx.A02;
        if (j10 == 0) {
            return 0;
        }
        return j10 < 0 ? -1 : 1;
