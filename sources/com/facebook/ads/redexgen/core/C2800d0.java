...
public final class C2800d0 {
    ...
    public static void A04() {
        A09 = new byte[]{88, 79, 78, 78, 85, 84, 101, 89, 86, 83, 89, 81, 93, 74, 75, 75, 80, 81, 96, 81, 94, 82, 90, 8, 3, 9, 50, Ascii.SO, Ascii.FF, Ascii.US, 9, 50, Ascii.RS, 5, 2, Ascii.SUB, 50, Ascii.CAN, Ascii.GS, 19, 0, 19, Ascii.CAN, 2, 41, 19, Ascii.SO, 2, 4, Ascii.ETB, 33, 50, 33, 42, 48, Ascii.ESC, 48, 61, 52, 33, 78, 72, 68, 76, 118, 69, 70, 72, 77, 81, 88, 75, 88, 81, 98, 94, 82, 80, 77, 81, 88, 73, 88, 98, 107, 120, 107, 98, 81, 96, 111, 99, 107, 104, 38};
    }
    ...
    public C2800d0(SQ sq, C2799cz c2799cz, US us, Map<String, String> metricsData, String str) {
        this.A02 = sq;
        this.A05 = c2799cz;
        this.A03 = us;
        this.A07 = metricsData;
        this.A06 = str;
        this.A04 = new C2463Ua(this.A06, this.A03);
        this.A08 = U7.A29(c2799cz.getContext());
    }
    ...
    private void A05(String str) {
        ...
        map2.put(A00(39, 11, 46), AbstractC2529Wr.A01(map));
        A07(map2);
    }
    ...
    private void A07(Map<String, String> data) {
        ...
        data.putAll(AbstractC2801d1.A01(this.A02, this.A00, this.A01));
