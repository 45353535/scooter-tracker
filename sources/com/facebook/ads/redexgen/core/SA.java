...
public class SA implements Callable<Boolean> {
    ...
    public SA(SF sf2, SB sb2) {
        this.A01 = sf2;
        new Handler(Looper.getMainLooper()).post(new C2845dk(this, sf2, sb2));
    }
    ...
    public void A03(SB sb2) {
        ...
        C2879eJ c2879eJA06 = C2879eJ.A06(this.A01.A04.A02());
        Uri uriA00 = WQ.A00(sb2.A08);
        long jA0S = sb2.A00;
        if (jA0S == -1) {
            jA0S = U7.A0S(this.A01.A04);
        }
        c2879eJA06.A0I(uriA00, new C2844dj(this, sb2, jA0S, jCurrentTimeMillis), jA0S);
    }
}
