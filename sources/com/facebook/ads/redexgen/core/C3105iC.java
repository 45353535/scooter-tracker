...
public final class C3105iC extends MR {
    ...
    public EnumC2262Mc A03;
    public EnumC2263Md A04;
    public EnumC2481Us A05;
    public String A06;
    public WeakReference<C2980fx> A07;
    ...
    public static void A05() {
        A0G = new byte[]{Ascii.DEL, -88, -92, -93, 85, -102, -83, -104, -102, -91, -87, -98, -92, -93, -52, -38, -31, -44, -50, -54, -40, -33, -46, -36, -126, -112, -105, -108, -118, 126, -111, -112, -112, -117, -118, -98, -89, -100, -82, -82, -33, -24, -27, -33, -25, -35, -34, -24, -31, -104, -85, -89, -91, -108, -110, -101, -100, -95, -89, -90, -103, -108, -125, -121, 123, -127, Ascii.DEL, -119, -122, -112, -111, -82, -90, -91, -86, -94, -73, -86, -90, -72, -79, -92, -81, -80, -92, -69, -70, -17, -30, -19, -18, -22, -17, -8, -1, -14, -2, -7, -45, -58, -46, -36, -71, -84, -67, -84, -67, 2, -10, Ascii.VT, -3, 10, -38, -44, -33, -38, -43, -30, -26, -27, -18, -42, -43, -34, -55, -40, -56, -50, -61, -10, -7, -16, -18, -16, -11, -63, -61, -74, -76, -78, -76, -71, -74, -80, -66, -74, -75, -70, -78, -115, -125, -108, Ascii.DEL, -90, -95, -108, -93, -90, -101, -94, -89, -28, -43, -24, -28, -18, -13, -22, -33, -85, -103, -84, -88, -35, -42, -45, -42, -41, -33, -42, -99, -112, -116, -98, -13, -26, -30, -12, -28, -17, -20, -14, -19, -78, -97, 113, 92, -101, 99, 87, -82, 113, 92, -101, -76, -51, -54, -116, 119, -74, 126, 114, -53, -116, 119, -74, -49};
    }
    ...
    public C3105iC(C2820dL c2820dL, MS ms, C2893eX c2893eX, C3116iN c3116iN) {
        super(c2820dL, ms, c2893eX);
        this.A03 = EnumC2262Mc.A03;
        this.A04 = null;
        this.A0F = c3116iN;
    }
    ...
    private void A07(Map<String, String> map) {
        if (this.A02 != null && (this.A02.getNativeAdLayoutApi() instanceof C2963fg)) {
            C2963fg c2963fg = (C2963fg) this.A02.getNativeAdLayoutApi();
            if (c2963fg.A05()) {
                map.put(A01(87, 7, 108), Boolean.TRUE.toString());
            }
            boolean zA04 = c2963fg.A04();
            if (A0H[2].charAt(5) == '8') {
                throw new RuntimeException();
            }
            String[] strArr = A0H;
    ...
    public final void A08(Map<String, String> map) {
        ...
        if (this.A01 != null) {
            map.put(A01(98, 4, 80), String.valueOf((int) (this.A01.getWidth() / AbstractC2523Wl.A02)));
            map.put(A01(94, 4, 124), String.valueOf((int) (this.A01.getHeight() / AbstractC2523Wl.A02)));
        }
        if (this.A04 != null) {
    ...
    public final void A0C(EnumC2262Mc enumC2262Mc) {
        this.A03 = enumC2262Mc;
    }

    public final void A0D(EnumC2263Md enumC2263Md) {
        this.A04 = enumC2263Md;
    }

    public final void A0E(EnumC2481Us enumC2481Us) {
        this.A05 = enumC2481Us;
    }
    ...
    public final void A0G(WeakReference<C2980fx> weakReference) {
