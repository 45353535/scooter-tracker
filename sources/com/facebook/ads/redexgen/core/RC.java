...
public final class RC implements View.OnLongClickListener {
    ...
    @Nullable
    public final C2602Zm A01;

    public RC(C2602Zm c2602Zm, RelativeLayout relativeLayout) {
        this.A01 = c2602Zm;
    ...
    public final boolean onLongClick(View view) {
        if (this.A01 != null && this.A00 != null) {
            ...
            A02[7] = "";
            c2602Zm.setBounds(0, 0, width, relativeLayout.getHeight());
