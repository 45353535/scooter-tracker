...
public final class C2764cQ extends RelativeLayout {
    public KE A00;
    ...
    public static final int A0F = (int) (AbstractC2523Wl.A02 * 16.0f);
    public static final int A0D = (int) (AbstractC2523Wl.A02 * 20.0f);
    public static final int A0E = (int) (AbstractC2523Wl.A02 * 13.0f);
    public static final int A08 = (int) (AbstractC2523Wl.A02 * 72.0f);
    public static final int A0C = (int) (AbstractC2523Wl.A02 * 8.0f);
    public static final int A0A = (int) (AbstractC2523Wl.A02 * 24.0f);
    public static final int A09 = (int) (AbstractC2523Wl.A02 * 16.0f);

    public C2764cQ(C2820dL c2820dL, N9 n92, C2281Mw c2281Mw, KE ke2, String str, View.OnClickListener onClickListener) {
        super(c2820dL);
        this.A04 = c2820dL;
        this.A03 = n92;
        this.A02 = c2281Mw;
        ...
        this.A06 = new C2640aQ(this.A04, C2283My.A01(null), true, false, true);
        A00();
    }

    private void A00() {
        AbstractC2641aR.A00(this.A04, this, this.A03.A01());
