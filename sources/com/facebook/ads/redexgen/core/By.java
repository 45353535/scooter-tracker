...
public class By implements InterfaceC2924f2 {
    public static byte[] A05;
    public JSONObject A00;
    public JSONObject A01;
    public final EnumC2925f3 A03;
    public final List<InterfaceC2926f4> A04 = new ArrayList();
    ...
    public By(EnumC2925f3 enumC2925f3) {
        this.A03 = enumC2925f3;
    }
    ...
    private boolean A02(JSONObject jSONObject, JSONObject jSONObject2) {
        ...
        return true ^ AbstractC2923f1.A02(jSONObject, jSONObject2);
    }
    ...
    public final synchronized boolean A03(JSONObject jSONObject, JSONObject jSONObject2) {
        if (jSONObject != null) {
            ...
            if (jSONObject2 == null || this.A03.A05()) {
                ...
                this.A02 = true;
                Iterator<InterfaceC2926f4> it = this.A04.iterator();
                while (it.hasNext()) {
                    it.next().A4e();
                }
                try {
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2924f2
    public final synchronized void A3t(InterfaceC2926f4 interfaceC2926f4) {
        this.A04.add(interfaceC2926f4);
    }
