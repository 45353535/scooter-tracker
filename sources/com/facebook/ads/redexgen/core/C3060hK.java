...
public final class C3060hK implements VT {
    ...
    public C3060hK(C2820dL c2820dL, String str, V6 v62, AdSize adSize, int i10) {
        this.A08 = c2820dL;
        this.A0D = str;
        this.A0A = v62;
        this.A06 = adSize;
        ...
        this.A0C = new AbstractC2326Or<C3060hK>(this) { // from class: com.facebook.ads.redexgen.X.6s
            {
                super(this);
            }
            ...
            public final void A07() {
                C3060hK c3060hKA08 = A08();
                if (c3060hKA08 == null) {
                    return;
                }
                if (C2544Xg.A02(c3060hKA08.A08)) {
                    c3060hKA08.A07();
                } else {
                    c3060hKA08.A05.postDelayed(c3060hKA08.A0C, 5000L);
                }
            }
        };
    ...
    private List<C3116iN> A04() {
        ...
        for (TC tcA04 = te2.A04(); tcA04 != null; tcA04 = te2.A04()) {
            ...
            if (mpA00 != null && mpA00.A8c() == AdPlacementType.NATIVE) {
                final C3116iN nativeAdapter = (C3116iN) mpA00;
                nativeAdapter.A0L(this.A08, new AbstractC3061hL() { // from class: com.facebook.ads.redexgen.X.6v
                    @Override // com.facebook.ads.redexgen.core.InterfaceC2264Me
                    public final void AEH(C3116iN c3116iN) {
                        arrayList.add(nativeAdapter);
                    }
                }, this.A09, new NU(tcA04.A04(), te2.A05(), this.A0D, te2.A05().A0C()), C2363Qc.A0K());
            }
        }
        return arrayList;
    }
    ...
    public final void A07() {
        try {
            this.A0B.A0Q(new VR(this.A08, this.A0D, this.A06 != null ? new X1(this.A06.getWidth(), this.A06.getHeight()) : null, this.A0A, this.A04, new VB(this.A08, null, null, null), X7.A01(U7.A0N(this.A08)), this.A02, null, new C3052hB()));
        } catch (V2 e10) {
            ADB(V1.A02(e10));
        }
    }
