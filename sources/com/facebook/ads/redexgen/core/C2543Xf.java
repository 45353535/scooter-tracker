...
public final class C2543Xf implements SensorEventListener {
    ...
    public final Set<InterfaceC2542Xe> A09 = new CopyOnWriteArraySet();
    ...
    public static void A02() {
        A0A = new byte[]{122, 76, 71, 90, 70, 91, 90, 9, 71, 70, 93, 9, 90, 92, 89, 89, 70, 91, 93, 76, 77, 5, 62, 55, 61, Utf8.REPLACEMENT_BYTE, 56, 49, 118, 56, 57, 34, 118, 37, 35, 38, 38, 57, 36, 34, 51, 50, Ascii.EM, Ascii.SI, 4, Ascii.EM, 5, Ascii.CAN};
    }
    ...
    public C2543Xf(C2820dL c2820dL) {
        this.A08 = c2820dL;
    }
    ...
    public final void A03(InterfaceC2542Xe interfaceC2542Xe) {
        if (this.A09.isEmpty()) {
            A01();
        } else if (this.A09.contains(interfaceC2542Xe)) {
            return;
        }
        this.A09.add(interfaceC2542Xe);
    }
        ...
        if (now - this.A06 > 100) {
            ...
            if (speed > 800.0f) {
                ...
                if (i10 >= 3 && now - this.A05 > 1000) {
                    this.A05 = now;
                    this.A03 = 0;
                    Iterator<InterfaceC2542Xe> it = this.A09.iterator();
                    while (it.hasNext()) {
                        it.next().AFD();
                    }
                }
