...
public final class C2548Xk extends LinearLayout {
    ...
    static {
        A03();
        A08 = (int) (AbstractC2523Wl.A02 * 50.0f);
        A05 = (int) (AbstractC2523Wl.A02 * 10.0f);
        A06 = (int) (AbstractC2523Wl.A02 * 20.0f);
        A09 = (int) (AbstractC2523Wl.A02 * 4.0f);
        A07 = (int) (AbstractC2523Wl.A02 * 12.0f);
    }

    public C2548Xk(C2820dL c2820dL, int i10) {
        super(c2820dL);
        this.A03 = c2820dL;
        this.A02 = O3.A00(c2820dL.A02());
        setOrientation(0);
        this.A00 = new ImageView(c2820dL);
        this.A01 = new ImageView(c2820dL);
        A04(i10);
    }
    ...
    public void setAdDetails(N9 n92, String str, C2463Ua c2463Ua, InterfaceC2551Xn interfaceC2551Xn) {
        setOnClickListener(new ViewOnClickListenerC2547Xj(this, c2463Ua, interfaceC2551Xn, str, n92));
    }
