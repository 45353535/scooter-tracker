...
public class C3230kH<V> extends AbstractCollection<V> {
    ...
    public final /* synthetic */ AbstractC17411i A04;
    ...
    public final boolean addAll(Collection<? extends V> collection) {
        ...
        if (zAddAll) {
            AbstractC17411i.A02(this.A04, this.A00.size() - size);
            if (size == 0) {
                A03();
            }
        }
    ...
    public C3230kH(@ParametricNullness final AbstractC17411i this$0, @CheckForNull Object key, Collection delegate, C3230kH ancestor) {
        this.A04 = this$0;
        this.A02 = key;
        this.A00 = delegate;
        this.A01 = ancestor;
    ...
    public final void clear() {
        ...
        this.A00.clear();
        AbstractC17411i.A03(this.A04, size);
        A05();
    }
    ...
    public final boolean retainAll(Collection<?> c10) {
        AbstractC3162jA.A04(c10);
        int size = size();
        boolean zRetainAll = this.A00.retainAll(c10);
        if (zRetainAll) {
            int size2 = this.A00.size();
            AbstractC17411i abstractC17411i = this.A04;
            int i10 = size2 - size;
            String[] strArr = A05;
            String str = strArr[0];
            ...
            AbstractC17411i.A02(abstractC17411i, i10);
            A05();
        }
        return zRetainAll;
    }
