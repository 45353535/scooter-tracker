...
public final class C3337mE implements H1 {
    ...
    public final C2010Cj A0V;
    public final C2012Cl A0W = new C2012Cl();
    public int A01 = 1000;
    ...
    public C2130Gz[] A0S = new C2130Gz[this.A01];
    public final D2<C2013Cm> A0X = new D2<>(new C3X() { // from class: com.facebook.ads.redexgen.X.mF
     ...
     */
    private synchronized int A03(C6N c6n, C3419nY c3419nY, boolean z10, boolean z11, C2012Cl c2012Cl) {
        c3419nY.A04 = false;
        if (!A0K()) {
            if (!z11 && !this.A0G) {
                ...
                A0H((C3497or) C3M.A01(this.A0D), c6n);
                return -5;
            }
            c3419nY.A02(4);
            return -4;
        }
        C3497or c3497or = this.A0X.A01(A0O()).A00;
        if (z10 || c3497or != this.A0B) {
            A0H(c3497or, c6n);
            return -5;
        }
        ...
        c3419nY.A02(this.A0N[iA00]);
        c3419nY.A01 = this.A0R[iA00];
        if (c3419nY.A01 < this.A09) {
            c3419nY.A00(Integer.MIN_VALUE);
        }
        c2012Cl.A00 = this.A0O[iA00];
        c2012Cl.A01 = this.A0Q[iA00];
        c2012Cl.A02 = this.A0S[iA00];
        return -4;
    }
    ...
    public static void A0E() {
        A0Y = new byte[]{35, 74, 57, 70, 70, 61, 56, 61, 66, 59, -12, 73, 66, 57, 76, 68, 57, 55, 72, 57, 56, -12, 66, 67, 66, 1, 71, 77, 66, 55, -12, 71, 53, 65, 68, SignedBytes.MAX_POWER_OF_TWO, 57, -12, 58, 67, 70, -12, 58, 67, 70, 65, 53, 72, Ascii.SO, -12, -62, -48, -36, -33, -37, -44, -64, -28, -44, -28, -44};
    }

    /* JADX WARN: Failed to parse debug info
    java.lang.ArrayIndexOutOfBoundsException
     */
    private synchronized void A0G(long j10, int i10, long j11, int i11, C2130Gz c2130Gz) {
        if (this.A02 > 0) {
        ...
        this.A0O[iA002] = i11;
        this.A0N[iA002] = i10;
        this.A0S[iA002] = c2130Gz;
        this.A0P[iA002] = this.A05;
        if (this.A0X.A06() || !this.A0X.A00().A00.equals(this.A0D)) {
            this.A0X.A05(A0P(), new C2013Cm((C3497or) C3M.A01(this.A0D), this.A0U != null ? this.A0U.AGJ(this.A0T, this.A0D) : C9T.A00));
        }
        this.A02++;
        if (this.A02 == this.A01) {
            ...
            C2130Gz[] c2130GzArr = new C2130Gz[i12];
            ...
            System.arraycopy(this.A0S, this.A04, c2130GzArr, 0, i13);
            ...
            System.arraycopy(this.A0S, 0, c2130GzArr, i13, i14);
    ...
    public final /* synthetic */ int AI5(AnonymousClass20 anonymousClass20, int i10, boolean z10) {
        return AbstractC2129Gy.A00(this, anonymousClass20, i10, z10);
    }

    @Override // com.facebook.ads.redexgen.core.H1
    public final /* synthetic */ void AI7(C4J c4j, int i10) {
        AbstractC2129Gy.A01(this, c4j, i10);
    }
    ...
    public C3337mE(EO eo, C9U c9u, C9P c9p) {
        this.A0U = c9u;
        this.A0T = c9p;
        this.A0V = new C2010Cj(eo);
    }
    ...
    */
    private int A01(int r6, int r7, long r8, boolean r10) {
        ...
        L27:
            ...
            goto L2
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C3337mE.A01(int, int, long, boolean):int");
    }
    ...
    */
    private int A02(long r6) {
        ...
        La:
            ...
            if (r3 != r0) goto La
            int r3 = r5.A01
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C3337mE.A0Z
            r0 = 5
            r1 = r2[r0]
            r0 = 2
            r2 = r2[r0]
        ...
        L42:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C3337mE.A02(long):int");
    }
    ...
    */
    private long A07(int r8) {
        ...
        L71:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C3337mE.A07(int):long");
    }
    ...
    private final C3497or A0A(C3497or c3497or) {
        if (this.A08 != 0 && c3497or.A0M != Long.MAX_VALUE) {
            return c3497or.A07().A0s(c3497or.A0M + this.A08).A14();
        }
        return c3497or;
    }

    public static C3337mE A0B(EO eo, C9U c9u, C9P c9p) {
        return new C3337mE(eo, (C9U) C3M.A01(c9u), (C9P) C3M.A01(c9p));
    }
    ...
    private void A0H(C3497or c3497or, C6N c6n) {
        C3497or c3497orA08;
        boolean z10 = this.A0B == null;
        DrmInitData newDrmInitData = z10 ? null : this.A0B.A0O;
        this.A0B = c3497or;
        DrmInitData oldDrmInitData = c3497or.A0O;
        if (this.A0U != null) {
            c3497orA08 = c3497or.A08(this.A0U.A7O(c3497or));
        } else {
            c3497orA08 = c3497or;
        }
        c6n.A00 = c3497orA08;
        ...
        if (!z10) {
            boolean zA1E = AbstractC18094a.A1E(newDrmInitData, oldDrmInitData);
            String[] strArr = A0Z;
        ...
        C9G c9g = this.A0E;
        this.A0E = this.A0U.A34(this.A0T, c3497or);
        c6n.A01 = this.A0E;
        if (c9g != null) {
            c9g.AGs(this.A0T);
        }
    ...
    private synchronized boolean A0N(C3497or c3497or) {
        this.A0L = false;
        if (AbstractC18094a.A1E(c3497or, this.A0D)) {
            return false;
        }
        if (!this.A0X.A06() && this.A0X.A00().A00.equals(c3497or)) {
            this.A0D = this.A0X.A00().A00;
        } else {
            this.A0D = c3497or;
        }
        this.A0J = AbstractC17642h.A0G(this.A0D.A0W, this.A0D.A0R);
        this.A0H = false;
        return true;
    }
    ...
    public final int A0R(C6N c6n, C3419nY c3419nY, int i10, boolean z10) {
        int iA03 = A03(c6n, c3419nY, (i10 & 2) != 0, z10, this.A0W);
        if (iA03 == -4 && !c3419nY.A05()) {
            int result = i10 & 1;
            boolean z11 = result != 0;
            int result2 = i10 & 4;
            if (result2 == 0) {
                if (z11) {
                    this.A0V.A0E(c3419nY, this.A0W);
                } else {
                    this.A0V.A0F(c3419nY, this.A0W);
                }
            }
            if (!z11) {
    ...
    public final synchronized C3497or A0U() {
    ...
    */
    public final synchronized void A0a(int r3) {
        ...
        L17:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C3337mE.A0a(int):void");
    }
    ...
    public final void A0d(InterfaceC2014Cn interfaceC2014Cn) {
        this.A0F = interfaceC2014Cn;
    }
    ...
    @Override // com.facebook.ads.redexgen.core.H1
    public final void A6W(C3497or c3497or) {
        C3497or c3497orA0A = A0A(c3497or);
        this.A0K = false;
        this.A0C = c3497or;
        boolean upstreamFormatChanged = A0N(c3497orA0A);
        if (this.A0F != null && upstreamFormatChanged) {
            this.A0F.AFb(c3497orA0A);
        }
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public final void AIA(long r16, int r18, int r19, int r20, com.facebook.ads.redexgen.core.C2130Gz r21) {
        /*
            r15 = this;
            r10 = r18
            r8 = r16
        ...
        L97:
            ...
            long r11 = r0.A09()
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.C3337mE.A0Z
            r0 = 1
            r1 = r1[r0]
            r0 = 24
            char r1 = r1.charAt(r0)
        ...
        Lad:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C3337mE.AIA(long, int, int, int, com.facebook.ads.redexgen.X.Gz):void");
    }
