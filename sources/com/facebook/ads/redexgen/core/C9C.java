...
public abstract class C9C extends Timeline {
    ...
    @Override // com.facebook.ads.androidx.media3.common.Timeline
    public C3468oN A0I(int i10, C3468oN c3468oN, boolean z10) {
        return this.A00.A0I(i10, c3468oN, z10);
    }

    @Override // com.facebook.ads.androidx.media3.common.Timeline
    public C3466oL A0L(int i10, C3466oL c3466oL, long j10) {
        return this.A00.A0L(i10, c3466oL, j10);
    }
