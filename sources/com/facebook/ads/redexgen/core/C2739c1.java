...
public final class C2739c1 {
    ...
    public C2739c1(C2820dL c2820dL, C2731bt c2731bt, US us, C2718bg c2718bg, String str, String str2) {
        this.A03 = c2820dL;
        this.A00 = new WeakReference<>(c2731bt);
    ...
    private void A0A(C2731bt c2731bt, String str) throws JSONException {
        JSONObject jSONObject = new JSONObject(str);
        SharedPreferences sharedPreferencesA00 = AbstractC2492Ve.A00(this.A03);
        ...
        c2731bt.A0g(storageValue, strA012);
    }

    private void A0B(C2731bt c2731bt, String str) throws JSONException {
        JSONObject jSONObject = new JSONObject(str);
        ...
        AbstractC2492Ve.A00(this.A03).edit().putString(A01(14, 4, 0) + jSONObject.optString(A01(54, 3, 119), A01(7, 7, 34)), strOptString).apply();
        c2731bt.A0f(strOptString2);
    }
    ...
    */
    public void A0C(com.facebook.ads.redexgen.core.EnumC2737bz r5, java.lang.String r6) throws org.json.JSONException {
        /*
            Method dump skipped, instruction units count: 236
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2739c1.A0C(com.facebook.ads.redexgen.X.bz, java.lang.String):void");
    }

    private void A0D(EnumC2737bz enumC2737bz, String str) throws JSONException {
        I3 i32 = this.A01.get();
        if (i32 == null) {
        }
        switch (C2736by.A00[enumC2737bz.ordinal()]) {
            case 10:
                i32.ADQ();
                break;
            case 11:
    ...
    private void A0K(JSONObject jSONObject) {
        ...
        C2463Ua handler = new C2463Ua(this.A06, us);
    ...
    public void postMessage(String str) {
        XJ.A00(new RunnableC2735bx(this, str));
    }
}
