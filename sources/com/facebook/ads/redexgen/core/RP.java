...
public class RP extends AsyncTask<RR, Void, Drawable> {
    ...
    private final Drawable A00(RR... rrArr) throws Throwable {
        if (!AbstractC2499Vl.A02(this) && rrArr != null) {
            try {
                if (rrArr.length >= 1) {
                    ...
                    try {
                        ...
                        this.A01.A08().AAy(A01(0, 7, 4), AbstractC2433Sv.A1V, new C2434Sw(th2));
                    }
                    if (bitmapA0O != null) {
                        return C2363Qc.A05(this.A01, bitmapA0O, this.A02, str2);
                    }
                    return null;
                }
            } catch (Throwable th3) {
    ...
    public RP(C2820dL c2820dL, RQ rq, boolean z10) {
        this.A01 = c2820dL;
        this.A00 = rq;
        this.A02 = z10;
    }

    public /* synthetic */ RP(C2820dL c2820dL, RQ rq, boolean z10, C2956fZ c2956fZ) {
        this(c2820dL, rq, z10);
    }
