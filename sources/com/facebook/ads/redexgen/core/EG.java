...
public final class EG implements InterfaceC2826dR {
    public final C2820dL A01;
    public final US A02;
    public final C2823dO A03;
    public final E1 A04;
    ...
    public EG(C2820dL c2820dL, US us, E1 e12, String str, boolean z10, C2029Dc c2029Dc, Map<String, String> extraParams) {
        this.A01 = c2820dL;
        this.A02 = us;
        this.A07 = str;
        this.A04 = e12;
        this.A03 = new C2823dO(e12, str, z10, extraParams);
        if (U7.A25(this.A01)) {
            this.A01.A0F().AID();
            c2029Dc.A0m(this);
        } else {
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2826dR
