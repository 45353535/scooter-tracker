...
public final class VM implements InterfaceC2303Ns {
    ...
    public final InterfaceC2287Nc A03(String str) {
    ...
    public final void A06() {
        ...
        while (true) {
            ...
            if (zHasNext) {
                InterfaceC2287Nc interfaceC2287Nc = it.next().getValue().A00;
                if (interfaceC2287Nc != null) {
                    interfaceC2287Nc.destroy();
                }
                it.remove();
            } else {
                return;
