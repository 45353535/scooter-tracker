...
public interface C8N {
    void A51(C3497or c3497or, int i10, int[] iArr) throws C8G;
    ...
    void AIt(C3481ob c3481ob);

    void AIw(C18997m c18997m);

    void AIy(AudioDeviceInfo audioDeviceInfo);

    void AJ4(boolean z10);

    boolean AJc(C3497or c3497or);
