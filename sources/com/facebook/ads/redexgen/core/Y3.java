...
public abstract class Y3 extends RelativeLayout {
    ...
    public static final int A05 = (int) (AbstractC2523Wl.A02 * 40.0f);
    public static final int A03 = (int) (AbstractC2523Wl.A02 * 24.0f);

    public abstract int getMediaViewId();

    public Y3(C2820dL c2820dL, View.OnClickListener onClickListener) {
        super(c2820dL);
        this.A00 = true;
        this.A01 = c2820dL;
