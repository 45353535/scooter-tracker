...
public final class RunnableC17873e implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public RunnableC17873e(Handler handler) {
        this.A04 = handler;
    }
    ...
    public static EGLConfig A00(EGLDisplay eGLDisplay) {
        ...
        throw new C17853c(AbstractC18094a.A0n(A04(0, 67, 111), Boolean.valueOf(success), Integer.valueOf(iArr[0]), configs[0]));
    }
    ...
    public static void A06(int[] iArr) {
        ...
        if (iGlGetError == 0) {
            ...
            throw new C17853c(A04(181, 29, 50) + Integer.toHexString(iGlGetError));
        }
    }
