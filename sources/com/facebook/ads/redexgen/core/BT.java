...
public final class BT {
    ...
    public final BQ A0C;
    public final InterfaceC3352mT A0D;
    public final InterfaceC1993Br A0E;
    ...
    public BT(Context context, InterfaceC18214m interfaceC18214m, InterfaceC2247Ln interfaceC2247Ln, InterfaceC18314w interfaceC18314w, Executor executor) {
        this(context, new C9H(interfaceC18214m), new C3361mc(new C3150ix().A06(interfaceC2247Ln).A05(interfaceC18314w), executor));
    }

    public BT(Context context, InterfaceC3352mT interfaceC3352mT, InterfaceC1984Bh interfaceC1984Bh) {
        this.A0A = context.getApplicationContext();
        this.A0D = interfaceC3352mT;
        this.A01 = 3;
        this.A02 = 5;
        this.A07 = true;
        this.A06 = Collections.emptyList();
        this.A0F = new CopyOnWriteArraySet<>();
        Handler handlerA0b = AbstractC18094a.A0b(new Handler.Callback() { // from class: com.facebook.ads.redexgen.X.BM
        ...
        handlerThread.start();
        this.A0C = new BQ(handlerThread, interfaceC3352mT, interfaceC1984Bh, handlerA0b, this.A01, this.A02, this.A07);
        InterfaceC1993Br requirementsListener = new InterfaceC1993Br() { // from class: com.facebook.ads.redexgen.X.mb
            @Override // com.facebook.ads.redexgen.core.InterfaceC1993Br
            public final void AEz(C1997Bv c1997Bv, int i10) {
                this.A00.A07(c1997Bv, i10);
            }
        };
        this.A0E = requirementsListener;
        this.A05 = new C1997Bv(context, requirementsListener, A0I);
    ...
    public void A07(C1997Bv c1997Bv, int i10) {
        Requirements requirementsA0A = c1997Bv.A0A();
        if (this.A03 != i10) {
            this.A03 = i10;
            this.A04++;
