...
public final class C2403Rq {
    ...
    public C2403Rq(SQ sq) {
        this.A00 = sq.getSharedPreferences(ProcessUtils.getProcessSpecificName(A00(33, 21, 4), sq), 0);
    }

    public final C2402Rp A02() {
        SharedPreferences sharedPreferences = this.A00;
        String strA00 = A00(0, 13, 55);
        if (sharedPreferences.contains(strA00)) {
            return new C2402Rp(this.A00.getString(strA00, A00(0, 0, 75)), this.A00.getBoolean(A00(54, 15, 96), false), EnumC2401Ro.A08, this.A00.getLong(A00(26, 7, 65), -1L));
        }
        return C2402Rp.A00();
    }
    ...
    public final void A04(C2402Rp c2402Rp) {
        SharedPreferences.Editor editorEdit = this.A00.edit();
        editorEdit.putString(A00(0, 13, 55), c2402Rp.A03());
        editorEdit.putBoolean(A00(54, 15, 96), c2402Rp.A04());
        editorEdit.putLong(A00(26, 7, 65), c2402Rp.A01());
        editorEdit.apply();
    }
