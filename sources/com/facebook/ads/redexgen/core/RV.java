...
public final class RV implements RewardedInterstitialAdApi, Repairable {
    ...
    public static void A01() {
        A01 = new byte[]{82, 2, 86, 83, 84, 91, 81, 0, 55, 48, 52, 51, 51, 48, 54, 54, 111, 58, 59, 104, 61, 96, 105, 108, Ascii.FF, 8, 13, 95, Ascii.SI, 2, Ascii.SO, Ascii.VT, SignedBytes.MAX_POWER_OF_TWO, 119, 101, 115, 96, 118, 119, 118, 50, 123, 124, 102, 119, 96, 97, 102, 123, 102, 123, 115, 126, 50, 115, 118, 50, 118, 119, 97, 102, 96, 125, 107, 119, 118, Ascii.RS, 41, 59, 45, 62, 40, 41, 40, 108, 37, 34, 56, 41, 62, Utf8.REPLACEMENT_BYTE, 56, 37, 56, 37, 45, 32, 108, 45, 40, 108, 32, 35, 45, 40, 108, 62, 41, 61, 57, 41, Utf8.REPLACEMENT_BYTE, 56, 41, 40, 122, 77, 95, 73, 90, 76, 77, 76, 8, 65, 70, 92, 77, 90, 91, 92, 65, 92, 65, 73, 68, 8, 73, 76, 8, 91, SignedBytes.MAX_POWER_OF_TWO, 71, 95, 8, 75, 73, 68, 68, 77, 76, 126, Ascii.DEL, 105, 110, 104, 117, 99, Ascii.US, Ascii.FS, Ascii.DC2, Ascii.ETB, 50, Ascii.ETB, 41, 50, 53, 45};
    }
    ...
    public final boolean show() {
        ...
        return this.A00.A08(new C2388Rb().withAppOrientation(-1).build());
    }
