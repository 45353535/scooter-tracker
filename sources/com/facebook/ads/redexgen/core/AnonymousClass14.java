...
public abstract class AnonymousClass14 extends C9Z {
    ...
    public final C3419nY A0q;
    public final C3419nY A0r;
    public final C6N A0s;
    public final C9U A0t;
    public final InterfaceC1969Ar A0u;
    public final ArrayDeque<C1952Aa> A0v;
    public final List<Long> A0w;
    public final boolean A0x;
    public final boolean A0y;
    public final boolean A0z;
    public final MediaCodecRendererMetaParameters A10;
    public final C3092hv A11;
    ...
    public abstract boolean A23(long j10, long j11, AO ao, ByteBuffer byteBuffer, int i10, int i11, long j12, boolean z10, boolean z11) throws C9Y;

    static {
        A15();
        A15 = new byte[]{0, 0, 1, 103, 66, -64, Ascii.VT, -38, 37, -112, 0, 0, 1, 104, -50, Ascii.SI, 19, 32, 0, 0, 1, 101, -120, -124, 13, -50, 113, Ascii.CAN, -96, 0, 47, -65, Ascii.FS, 49, -61, 39, 93, 120};
    }

    public AnonymousClass14(int i10, C3092hv c3092hv, MediaCodecRendererMetaParameters mediaCodecRendererMetaParameters, InterfaceC1969Ar interfaceC1969Ar, C9U c9u, boolean z10, boolean z11, int i11, int i12) {
        super(i10);
        this.A09 = -9223372036854775807L;
        this.A08 = -9223372036854775807L;
        this.A0m = false;
        this.A0k = false;
        C3M.A08(AbstractC18094a.A02 >= 16);
        this.A11 = (C3092hv) C3M.A01(c3092hv);
        this.A10 = (MediaCodecRendererMetaParameters) C3M.A01(mediaCodecRendererMetaParameters);
        this.A0u = (InterfaceC1969Ar) C3M.A01(interfaceC1969Ar);
        this.A0t = c9u;
        this.A0z = z10;
        this.A0x = z11;
        this.A0o = i11;
        this.A0n = i12;
        this.A0q = new C3419nY(0);
        this.A0r = C3419nY.A02();
        this.A0s = new C6N();
        ...
        this.A0y = MetaExoPlayerUpgradeConfig.A03(EnumC3096i2.A1r);
        this.A12 = MetaExoPlayerUpgradeConfig.A03(EnumC3096i2.A1c);
    }
    ...
    */
    ...
    private List<AR> A10(boolean z10) throws C1973Av {
        ...
        if (listA1l.isEmpty() && this.A0l && (alternativeMimeType = C1976Ay.A0P(this.A0i)) != null) {
    ...
    private void A16(AR ar, MediaCrypto mediaCrypto) throws Exception {
        ...
        try {
            ...
            new C3373mo().A00();
            aoA0K = AV.A02().A0K(A22(), this.A11, this.A10.getA00(), EnumC3089hq.A05, str);
            try {
                this.A0K = str;
                C4S.A00();
    ...
    private void A17(AR ar, AR ar2, MediaCrypto mediaCrypto) throws Exception {
        int iA00 = MetaExoPlayerUpgradeConfig.A00(EnumC3097i3.A06);
        if (iA00 >= 0) {
            try {
                A16(ar2, mediaCrypto);
                return;
    ...
    private void A18(C1952Aa c1952Aa) {
        this.A0J = c1952Aa;
        if (c1952Aa.A02 != -9223372036854775807L) {
            this.A0a = true;
        }
    }
    ...
    private boolean A1A() throws C9Y {
        ...
        if (this.A0g) {
            ...
            boolean zA03 = MetaExoPlayerUpgradeConfig.A03(EnumC3096i2.A10);
        ...
        if (this.A0q.A05()) {
            ...
            try {
                ...
                C3497or c3497or = this.A0i;
                int adaptiveReconfigurationBytes = e10.getErrorCode();
                throw A1S(e10, c3497or, AbstractC18094a.A02(adaptiveReconfigurationBytes));
            }
        }
        ...
        if (bufferEncrypted4 && !skipIfSampleTooLarge) {
            AbstractC2121Gq.A0G(this.A0q.A02);
        ...
        try {
            ...
            C3497or c3497or2 = this.A0i;
            int adaptiveReconfigurationBytes2 = e11.getErrorCode();
            throw A1S(e11, c3497or2, AbstractC18094a.A02(adaptiveReconfigurationBytes2));
        }
    }
    ...
    */
    ...
    public static boolean A1G(C3497or c3497or) {
        return c3497or.A07 == 0 || c3497or.A07 == 2;
    }
    ...
    */
    public static boolean A1I(java.lang.String r6) {
        ...
        L34:
            ...
            r0 = 19
            if (r1 > r0) goto L96
            java.lang.String r3 = com.facebook.ads.redexgen.core.AbstractC18094a.A03
    ...
    public static boolean A1J(String str) {
        return AbstractC18094a.A02 == 21 && A0x(519, 22, 41).equals(str);
    }

    public static boolean A1K(String str) {
        if (AbstractC18094a.A02 >= 18 && (AbstractC18094a.A02 != 18 || (!A0x(382, 15, 68).equals(str) && !A0x(397, 22, 77).equals(str)))) {
            if (AbstractC18094a.A02 == 19 && AbstractC18094a.A06.startsWith(A0x(667, 7, 124))) {
    ...
    public static boolean A1L(String str, C3497or c3497or) {
        return AbstractC18094a.A02 < 21 && c3497or.A0X.isEmpty() && A0x(306, 25, 22).equals(str);
    }

    public static boolean A1M(String str, C3497or c3497or) {
        return AbstractC18094a.A02 <= 18 && c3497or.A06 == 1 && A0x(281, 25, 33).equals(str);
    }
    ...
    private boolean A1N(boolean z10) throws C9Y {
        ...
        throw A1S(c9eA7s, c3497or, drmSessionState);
    }
    ...
    public void A1b(boolean z10, boolean z11) throws C9Y {
        this.A0j = new C18415g();
        this.A0h = 0L;
    }

    @Override // com.facebook.ads.redexgen.core.C9Z
    public void A1c(C3497or[] c3497orArr, long j10, long j11) throws C9Y {
    }
    ...
    public void A1n() {
        ...
        if (this.A0G != null) {
            this.A0j.A03++;
            try {
                AV.A02().A0L(A22(), this.A11, this.A10.getA00(), EnumC3089hq.A05, this.A0K, this.A0G);
                this.A0G = null;
                C9G c9g = this.A0E;
                String[] strArr = A14;
                if (strArr[6].length() == strArr[5].length()) {
    ...
    public void A1r(C3497or c3497or) {
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void A1s(com.facebook.ads.redexgen.core.C3497or r9) throws com.facebook.ads.redexgen.core.C9Y {
        /*
    ...
    public void A1t(C3497or c3497or) throws C9Y {
    }

    public void A1z(String str, C3497or c3497or) throws C9Y {
        A1t(c3497or);
    }
    ...
    public final boolean A24(C3497or c3497or) {
        if (c3497or == null || !this.A0m || !A0x(838, 10, 89).equalsIgnoreCase(c3497or.A0W)) {
            return false;
        }
        return true;
    }
    ...
    public boolean AAV() {
        if (this.A0i == null) {
            super.A0B = EnumC3073hX.A07;
        } else if (this.A0g) {
            super.A0B = EnumC3073hX.A0A;
        } else if (!A1d() && !A1B()) {
            super.A0B = EnumC3073hX.A06;
        }
        if (this.A0i != null) {
    ...
    public final int AJb(C3497or c3497or) throws C9Y {
        try {
            return A1h(this.A0u, this.A0t, c3497or);
        } catch (C1973Av e10) {
            throw A1S(e10, c3497or, 4002);
        }
    }
