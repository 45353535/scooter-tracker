...
public abstract class AbstractC2911ep {
    ...
    public AbstractC2911ep(String str, C2913er c2913er, C2907el c2907el) {
        this.A03 = A00(0, 0, 34);
        if (str != null) {
            this.A03 = str;
        }
        if (c2913er != null && !c2913er.A06().isEmpty()) {
            this.A03 += A00(0, 1, 55) + c2913er.A06();
        }
        this.A00 = c2907el;
    }

    public final C2907el A02() {
        return this.A00;
    }

    public final EnumC2910eo A03() {
        return this.A01;
    }
