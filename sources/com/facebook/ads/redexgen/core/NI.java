...
public abstract class NI extends RelativeLayout implements InterfaceC2552Xo {
    ...
    public final AbstractC2550Xm A0E;
    ...
    public NI(C2820dL c2820dL, US us, InterfaceC2551Xn interfaceC2551Xn, AbstractC3095hy abstractC3095hy) {
        super(c2820dL);
        this.A07 = false;
        this.A04 = false;
        this.A03 = false;
        ...
        this.A0D = new C2463Ua(this.A0A.A25(), this.A0C);
    ...
    private void A0Q() {
        ...
        if (A0b() && this.A02 == null) {
            this.A04 = true;
            this.A02 = new C2769cV(this.A0B, this.A0A.A20().A0I(), this.A0A.A23()).A0A(this.A0A.A1z().A01()).A0F();
            AbstractC2465Uc.A04(this.A02, this.A0D, UZ.A0U);
    ...
    private void A0S(C2283My c2283My, boolean z10) {
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, this.A0E.getToolbarHeight());
        layoutParams.addRule(10);
        this.A0E.A0A(c2283My, KE.A05(this.A0A));
        addView(this.A0E, layoutParams);
    }

    public final void A0V() {
        if (this.A00 == null || !(this.A00 instanceof AbstractC2654ae)) {
            return;
        }
        if (A0c()) {
            ((AbstractC2654ae) this.A00).A1F();
        } else {
            ((AbstractC2654ae) this.A00).A1E();
        }
    }

    public final void A0X(int i10) {
        this.A01 = new C2517Wd(i10, new NJ(this, i10));
        this.A03 = true;
        A0V();
        this.A01.A07();
    }
    ...
    public final void A0Y(View view, boolean z10, int i10) {
        ...
        C2283My c2283MyA0M = A0M(i10);
        A0S(c2283MyA0M, z10);
        XP.A0K(this, c2283MyA0M.A08(false));
        if (this.A09 != null) {
            A0Q();
            if (z10) {
                this.A08.A05(XB.A03);
    ...
    public final void A0Z(R0 r02) {
        ...
        C2274Mp c2274MpA20 = null;
        C2274Mp adInfo = this.A0A.A20();
        if (adInfo != null) {
            C2274Mp adInfo2 = this.A0A.A20();
            if (adInfo2 != null) {
                c2274MpA20 = this.A0A.A20();
            }
        }
        this.A0E.setPageDetails(this.A0A.A23(), this.A0A.A25(), c2274MpA20 != null ? c2274MpA20.A0H().A04() : 0, this.A0A.A24());
    ...
    public InterfaceC2551Xn getAudienceNetworkListener() {
        return this.A09;
    }
