...
public final class C3151iy implements InterfaceC18294u {
    ...
    public final InterfaceC2247Ln A09;
    ...
    public static void A02() {
        A0A = new byte[]{86, 116, 118, 125, 112, 81, 116, 97, 116, 70, 124, 123, 126, 32, 52, 39, 33, 43, 35, 40, 50, Ascii.NAK, 47, 60, 35, 102, 47, 53, 102, 36, 35, 42, 41, 49, 102, 50, 46, 35, 102, 43, 47, 40, 47, 43, 51, 43, 102, 52, 35, 37, 41, 43, 43, 35, 40, 34, 35, 34, 102, 48, 39, 42, 51, 35, 102, 41, 32, 102, 116, 118, Ascii.DEL, 113, 119, 115, 116, 104, 102, Ascii.DC2, 46, 47, 53, 102, 43, 39, Utf8.REPLACEMENT_BYTE, 102, 37, 39, 51, 53, 35, 102, 54, 41, 41, 52, 102, 37, 39, 37, 46, 35, 102, 54, 35, 52, 32, 41, 52, 43, 39, 40, 37, 35, 104, 35, 55, 36, 34, 40, 32, 43, 49, Ascii.SYN, 44, Utf8.REPLACEMENT_BYTE, 32, 101, 40, 48, 54, 49, 101, 39, 32, 101, 53, 42, 54, 44, 49, 44, 51, 32, 101, 42, 55, 101, 6, 107, 9, 0, Ascii.VT, 2, 17, 13, Ascii.SUB, Ascii.DLE, Ascii.VT, Ascii.SYN, 0, 17, 107};
    }
    ...
    public C3151iy(InterfaceC2247Ln interfaceC2247Ln, long j10, int i10) {
        C3M.A0A(j10 > 0 || j10 == -1, A00(115, 48, 72));
        if (j10 != -1 && j10 < 2097152) {
            AnonymousClass44.A07(A00(0, 13, 24), A00(13, 102, 75));
        }
        this.A09 = (InterfaceC2247Ln) C3M.A01(interfaceC2247Ln);
    ...
    private void A01() throws IOException {
        ...
        try {
            this.A06.flush();
            AbstractC18094a.A10(this.A06);
            this.A06 = null;
            File file = (File) AbstractC18094a.A0f(this.A05);
            this.A05 = null;
            String[] strArr = A0B;
            ...
            AbstractC18094a.A10(this.A06);
            this.A06 = null;
            File fileToCommit = (File) AbstractC18094a.A0f(this.A05);
            this.A05 = null;
            if (0 != 0) {
    ...
    private void A03(AnonymousClass56 anonymousClass56) throws IOException {
        this.A05 = this.A09.AJN((String) AbstractC18094a.A0f(anonymousClass56.A08), anonymousClass56.A04 + this.A00, anonymousClass56.A03 != -1 ? Math.min(anonymousClass56.A03 - this.A00, this.A01) : -1L);
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC18294u
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC18294u
    public final void write(byte[] bArr, int i10, int i11) throws C3153j0 {
        ...
        while (i12 < i11) {
            try {
                ...
                ((OutputStream) AbstractC18094a.A0f(this.A06)).write(bArr, i10 + i12, iMin);
                i12 += iMin;
                this.A02 += (long) iMin;
                this.A00 += (long) iMin;
            } catch (IOException e10) {
