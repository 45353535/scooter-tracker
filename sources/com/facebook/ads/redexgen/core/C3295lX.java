...
public final class C3295lX implements FT {
    ...
    public C3295lX(WindowManager windowManager) {
        this.A00 = windowManager;
    }

    public static C3295lX A00(Context context) {
        WindowManager windowManager = (WindowManager) context.getSystemService(A01(0, 6, 15));
        if (windowManager != null) {
            return new C3295lX(windowManager);
        }
        return null;
    }
