...
public final class R0 implements AudienceNetworkActivityApi, Repairable {
    ...
    public EnumC2490Vb A07;
    public InterfaceC2552Xo A08;
    public AbstractC2567Yd A09;
    public C2796cw A0A;
    public String A0B;
    public String A0C;
    public boolean A0D;
    ...
    public final RA A0G;
    public final RJ A0H;
    public final C2389Rc A0I;
    public final C2820dL A0J;
    ...
    public static void A02() {
        A0L = new byte[]{3, 56, 55, 52, 58, 51, 118, 34, 57, 118, Utf8.REPLACEMENT_BYTE, 56, 48, 51, 36, 118, 32, Utf8.REPLACEMENT_BYTE, 51, 33, 2, 47, 38, 51, 118, 48, 36, 57, 59, 118, Utf8.REPLACEMENT_BYTE, 56, 34, 51, 56, 34, 118, 57, 36, 118, 37, 55, 32, 51, 50, Ascii.US, 56, 37, 34, 55, 56, 53, 51, 5, 34, 55, 34, 51, 42, 37, Ascii.DC4, 42, 40, Utf8.REPLACEMENT_BYTE, 34, 61, 34, Utf8.REPLACEMENT_BYTE, 50, 122, 120, 117, 117, 124, 107, 77, 96, 105, 124, 121, 118, 115, Ascii.DEL, 116, 110, 78, 117, 113, Ascii.DEL, 116, 116, 120, 122, 57, 113, 118, 116, 114, 117, 120, 120, 124, 57, 118, 115, 100, 57, 126, 121, 99, 114, 101, 100, 99, 126, 99, 126, 118, 123, 57, 115, 126, 100, 103, 123, 118, 110, 114, 115, 110, 99, 108, 102, 113, 97, 99, 114, 103, 62, 37, 60, 60, 49, 40, 59, 44, 44, 55, 58, 59, Ascii.SUB, 43, 51, 46, 45, 39, 45, 46, 49, 44, 42, 44, Utf8.REPLACEMENT_BYTE, 55, 42, 7, 5, Ascii.DC2, 19, Ascii.DC2, 17, Ascii.RS, Ascii.EM, Ascii.DC2, 19, 56, 5, Ascii.RS, Ascii.DC2, Ascii.EM, 3, Ascii.SYN, 3, Ascii.RS, Ascii.CAN, Ascii.EM, 60, Ascii.DC2, Ascii.SO, 79, 87, 85, 76, 125, 90, 72, 89, 78, 111, 89, 95, 83, 82, 88, 79, 122, 97, 81, 97, 124, 103, 107, 96, 122, 111, 122, 103, 97, 96, 112, 107, 108, 116, 112, 96, 76, 97, Ascii.SO, 17, Ascii.GS, Ascii.SI, 44, 1, 8, Ascii.GS};
    }
    ...
    public R0(AudienceNetworkActivity audienceNetworkActivity, AudienceNetworkActivityApi audienceNetworkActivityApi) {
        ...
        this.A0I = new C2389Rc(this.A0J, this.A0E);
    ...
    private void A03(Intent intent, Bundle bundle) {
        ...
        if (bundle != null) {
            ...
            this.A07 = (EnumC2490Vb) bundleA03.getSerializable(strA01);
            return;
        }
        this.A01 = intent.getIntExtra(strA013, -1);
        this.A0B = intent.getStringExtra(strA012);
        this.A07 = (EnumC2490Vb) intent.getSerializableExtra(strA01);
    ...
    public final void A0D(String str, N9 n92) {
        ...
        AbstractC2567Yd abstractC2567Yd = this.A09;
        if (A0M[6].charAt(30) != 'X') {
            throw new RuntimeException();
        }
        A0M[0] = "nOOhjPgmgj4ymGbfbhDfGuv2YA";
        if (abstractC2567Yd == null) {
            this.A09 = AbstractC2568Ye.A02(this.A0J, this.A0J.A0A(), str, n92, this.A08, new C2979fw(this));
    ...
    public final void A0E(String str, C2441Td c2441Td) {
        this.A0G.A08(str, c2441Td, this.A0B);
    }
    ...
    public final void onConfigurationChanged(Configuration configuration) {
        if (this.A00 != configuration.orientation) {
            ...
            C2463Ua.A02(UZ.A0K, map, this.A08 == null ? A01(0, 0, 15) : this.A08.getCurrentClientToken(), this.A0J.A0A());
    ...
    public final void onCreate(Bundle bundle) {
        ...
        C2820dL c2820dLA04 = WB.A04(this.A05);
        if (c2820dLA04 != null) {
            C2820dL startAdContext = this.A0J;
            startAdContext.A0M(c2820dLA04);
        }
        A03(this.A05, bundle);
        C2820dL startAdContext2 = this.A0J;
        ...
        C2820dL startAdContext3 = this.A0J;
        US usA0A = startAdContext3.A0A();
        C2820dL startAdContext4 = this.A0J;
        this.A08 = new R5(this, intent, usA0A, startAdContext4).A0N(this.A07, this.A06);
        if (this.A08 == null) {
            C2820dL startAdContext5 = this.A0J;
            startAdContext5.A08().AAy(A01(58, 11, 105), AbstractC2433Sv.A0A, new C2434Sw(A01(0, 58, 116)));
            A09();
            finish(7);
            return;
        }
    ...
    public final void onPause() {
        ...
        if (this.A08 != null) {
            this.A08.AEV(false);
            if (!this.A0E.isFinishing()) {
                C2463Ua.A02(UZ.A0E, null, this.A08.getCurrentClientToken(), this.A0J.A0A());
                this.A0D = true;
            }
        }
    }
    ...
    public final void onResume() {
        ...
        this.A04 = System.currentTimeMillis();
        if (this.A08 != null) {
            InterfaceC2552Xo interfaceC2552Xo = this.A08;
            if (A0M[5].charAt(17) != 'w') {
                throw new RuntimeException();
            }
            A0M[6] = "WHwDulcP2dZca7YA0PmotSPySBaz7ZXD";
            interfaceC2552Xo.AF0(false);
            if (this.A0D) {
                C2463Ua.A02(UZ.A0F, null, this.A08.getCurrentClientToken(), this.A0J.A0A());
            }
        }
    }
    ...
    public final void onStart() {
        ...
        if (this.A01 != -1) {
            AbstractC2546Xi.A02(this.A0E, this.A01, this.A0J);
        }
    }
