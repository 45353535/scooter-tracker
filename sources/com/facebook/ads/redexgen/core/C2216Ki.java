...
public final class C2216Ki extends AbstractC2594Ze {
    ...
    public final WeakReference<InterfaceC2597Zh> A0A;
    ...
    static {
        A04();
        A0H = C2216Ki.class.getSimpleName();
    }

    public C2216Ki(C2820dL c2820dL, WeakReference<InterfaceC2597Zh> weakReference, int i10, String str) {
        this(c2820dL, weakReference, i10, false);
        if (U7.A1u(c2820dL)) {
            c2820dL.A02().A0B().AK3(this, str == null ? A02(0, 0, 91) : str, false, true);
            this.A06 = true;
        }
    }

    public C2216Ki(C2820dL c2820dL, WeakReference<InterfaceC2597Zh> weakReference, int i10, boolean z10) {
        super(c2820dL);
        ...
        this.A02 = new C2228Ku(this);
        this.A03 = new C2893eX(this, i10, new WeakReference(this.A02), this.A09);
        setWebChromeClient(A0G());
        setWebViewClient(A0H());
        getSettings().setSupportZoom(false);
        getSettings().setCacheMode(1);
        addJavascriptInterface(new C2596Zg(this, weakReference.get(), this.A03, this.A0B, this.A0C, this.A09), A02(0, 9, 46));
    }
    ...
    @Override // com.facebook.ads.redexgen.core.AbstractC2594Ze
    ...
    public final WebViewClient A0H() {
        return new C2599Zj(this.A09, this.A0A, new WeakReference(this.A03), new WeakReference(this.A01), new WeakReference(this.A0C), new WeakReference(this), this.A0D, this.A0E, this.A04);
    }

    public final void A0K() {
        this.A09.A0F().AK5();
        this.A0B.set(true);
        new Handler(Looper.getMainLooper()).post(new C2222Ko(this.A03));
    }
    ...
    @Override // com.facebook.ads.redexgen.core.AbstractC2594Ze, android.webkit.WebView
