...
public final class C2605Zp {
    ...
    public C2605Zp(Map<String, String> extraData) {
        this.A00 = extraData;
    }

    public final C2605Zp A02(XH xh2) {
        if (xh2 != null) {
            this.A00.put(A00(11, 5, 48), AbstractC2529Wr.A01(xh2.A04()));
        }
        return this;
    }

    public final C2605Zp A03(C2893eX c2893eX) {
        if (c2893eX != null) {
            this.A00.putAll(c2893eX.A0S());
        }
        return this;
    }

    public final C2605Zp A04(String str) {
