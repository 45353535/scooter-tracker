...
public final class C2206Jy extends AbstractC2611Zv {
    ...
    private void A04() {
        ...
        XP.A0I(this.A05);
        this.A05.setLayoutParams(AbstractC2611Zv.A0B);
    ...
    static {
        A09();
        A0U = OP.A02(-1, 77);
        A0O = (int) (AbstractC2523Wl.A02 * 12.0f);
        A0P = (int) (AbstractC2523Wl.A02 * 8.0f);
        A0L = (int) (AbstractC2523Wl.A02 * 26.0f);
        A0N = (int) (AbstractC2523Wl.A02 * 144.0f);
        A0M = (int) (AbstractC2523Wl.A02 * 48.0f);
        A0Q = (int) (AbstractC2523Wl.A02 * 16.0f);
        A0V = (int) (AbstractC2523Wl.A02 * 14.0f);
        A0R = (int) (OE.A08 * 21.0f);
        A0S = (int) (OE.A08 * 12.0f);
        A0T = (int) (OE.A08 * 10.0f);
    }

    public C2206Jy(C2820dL c2820dL, KE ke2, int i10, boolean z10, C2283My c2283My, boolean z11, String str, US us, InterfaceC2551Xn interfaceC2551Xn, C2893eX c2893eX, XH xh2, N3 n32, boolean z12, String str2, boolean z13) {
        super(c2820dL, ke2, i10, c2283My, z11, str, us, interfaceC2551Xn, c2893eX, xh2, n32, z12, str2);
        this.A0C = false;
        this.A00 = 0;
        this.A01 = 0;
        this.A0A = true;
        ...
        this.A09 = new C2636aM(this.A0H, A0V, 5, A0U, -1);
    ...
    public C2206Jy(C2820dL c2820dL, KE ke2, int i10, boolean z10, C2283My c2283My, boolean z11, String str, US us, InterfaceC2551Xn interfaceC2551Xn, C2893eX c2893eX, XH xh2, AbstractC3095hy abstractC3095hy) {
        this(c2820dL, ke2, i10, z10, c2283My, false, str, us, interfaceC2551Xn, c2893eX, xh2, abstractC3095hy.A21(), abstractC3095hy.A1c(), abstractC3095hy.A0x(), abstractC3095hy.A1k());
    }
    ...
    private final void A0B() {
        super.A06.setLayoutParams(AbstractC2611Zv.A0B);
        A04();
        A03();
        if (!super.A03) {
            A02();
