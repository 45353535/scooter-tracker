...
public abstract class C1Q extends Binder {
     ...
     */
    public static AbstractC1964Am<Bundle> A00(IBinder iBinder) {
            ...
            try {
                ...
                try {
                    ...
                    while (true) {
                        ...
                        if (i11 == 1) {
                            c17401hA01.A04((Bundle) C3M.A01(parcelObtain2.readBundle()));
                            i10++;
                        }
                    }
    ...
    static {
        A00 = AbstractC18094a.A02 >= 30 ? IBinder.getSuggestedMaxIpcSizeBytes() : 65536;
    }
}
