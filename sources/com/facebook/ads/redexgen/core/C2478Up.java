...
public final class C2478Up implements NativeAdImageApi {
    ...
    public C2478Up(String str, int i10, int i11) {
        this.A02 = str;
        this.A01 = i10;
        this.A00 = i11;
    }

    public static C2478Up A00(JSONObject jSONObject) {
        String strOptString;
        if (jSONObject == null || (strOptString = jSONObject.optString(A01(6, 3, 75))) == null) {
            return null;
        }
        return new C2478Up(strOptString, jSONObject.optInt(A01(9, 5, 125), 0), jSONObject.optInt(A01(0, 6, 92), 0));
    }
