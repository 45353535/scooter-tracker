...
public final class C2879eJ {
    public static InterfaceC18214m A06;
    public static BT A07;
    public static InterfaceC2247Ln A08;
    public static C2879eJ A09;
    ...
    public boolean A00;
    public final C2794cu A04;
    public final Handler A01 = new Handler(Looper.getMainLooper());
    public final SparseArray<C2877eH> A02 = new SparseArray<>();
    public final Runnable A05 = new RunnableC2876eG(this);
    ...
    public C2879eJ(C2794cu c2794cu, BT bt) {
        this.A04 = c2794cu;
        if (bt != null) {
            A07 = bt;
            bt.A0F(this.A03);
    ...
    public static synchronized InterfaceC18214m A01(Context context) {
        if (A06 == null) {
            A06 = new C3435no(context);
        }
        return A06;
    }

    private C19359j A02() {
        return new C19359j().A01(A08(135, 3, 65)).A00(null);
    }
    ...
    public static synchronized InterfaceC2247Ln A04(Context context) {
        if (A08 == null) {
            A08 = new C3144ir(new File(A07(context), A08(121, 14, 26)), new C7R(U7.A0T(context)));
        }
        return A08;
    }

    public static C3150ix A05(C3431nk c3431nk, InterfaceC2247Ln interfaceC2247Ln) {
        return new C3150ix().A06(interfaceC2247Ln).A05(c3431nk).A04(new C3425ne()).A03(2);
    }

    public static synchronized C2879eJ A06(C2794cu c2794cu) {
        if (A09 == null) {
            A09 = new C2879eJ(c2794cu, null);
        }
        return A09;
    }
    ...
    public static String A09(C2794cu c2794cu, Uri uri) {
        try {
            if (!U7.A1r(c2794cu)) {
                return null;
            }
            ...
            c2794cu.A08().AAy(A08(138, 5, 50), AbstractC2433Sv.A0u, new C2434Sw(e10));
            return null;
        }
    }
    ...
    */
    public void A0A() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2879eJ.A0A():void");
    }
    ...
    public final InterfaceC18314w A0H(Context context) {
        return A05(new C3431nk(context, (C5H) null, A02()), A04(context));
    }

    public final void A0I(Uri uri, InterfaceC2878eI interfaceC2878eI, long j10) {
        ...
        this.A02.put(downloadRequestA05.A02.hashCode(), new C2877eH(interfaceC2878eI, j10, zA0J, null));
        A0B();
    }
