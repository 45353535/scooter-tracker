...
public final class C2016Cp implements InterfaceC2862e2 {
    ...
    public EnumC2861e1 A02 = EnumC2861e1.A04;

    public C2016Cp(View view, int i10, Drawable drawable, Drawable drawable2) {
        this.A03 = i10;
        this.A07 = view;
        this.A05 = drawable;
        this.A04 = drawable2;
    ...
    private void A04(boolean z10) {
        ...
        if (z10) {
            this.A02 = EnumC2861e1.A05;
            XP.A0Q(this.A07, this.A00);
            this.A00.startTransition(this.A03);
            this.A06.postDelayed(new C2017Cq(this), this.A03);
            return;
        }
        XP.A0Q(this.A07, this.A05);
        this.A02 = EnumC2861e1.A04;
    }

    private void A05(boolean z10) {
        this.A06.removeCallbacksAndMessages(null);
        if (z10) {
            this.A02 = EnumC2861e1.A03;
            XP.A0Q(this.A07, this.A01);
            this.A01.startTransition(this.A03);
            this.A06.postDelayed(new C2020Ct(this), this.A03);
            return;
        }
        XP.A0Q(this.A07, this.A04);
        this.A02 = EnumC2861e1.A02;
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC2862e2
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2862e2
    public final EnumC2861e1 A93() {
        return this.A02;
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC2862e2
    public final void cancel() {
        EnumC2861e1 enumC2861e1;
        this.A06.removeCallbacksAndMessages(null);
        this.A01.resetTransition();
        this.A00.resetTransition();
        if (this.A02 == EnumC2861e1.A03) {
            enumC2861e1 = EnumC2861e1.A04;
        } else {
            enumC2861e1 = EnumC2861e1.A02;
        }
        this.A02 = enumC2861e1;
    }
}
