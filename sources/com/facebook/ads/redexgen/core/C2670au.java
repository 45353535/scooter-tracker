...
public final class C2670au {
    ...
    public final AbstractC3095hy A0F;
    public final C2271Ml A0G;
    public final C2281Mw A0H;
    public final N0 A0I;
    public final C2820dL A0J;
    public final C2463Ua A0K;
    public final InterfaceC2551Xn A0L;
    ...
    public C2670au(C2820dL c2820dL, AbstractC3095hy abstractC3095hy, C2463Ua c2463Ua, Handler handler, InterfaceC2551Xn interfaceC2551Xn) {
        this.A0J = c2820dL;
        this.A0L = interfaceC2551Xn;
        this.A0H = abstractC3095hy.A20().A0I();
        this.A0I = abstractC3095hy.A20().A0K();
        this.A0G = abstractC3095hy.A1z();
        this.A0E = handler;
        this.A0C = abstractC3095hy.A2K();
        this.A0M = abstractC3095hy.A2H();
        this.A0A = abstractC3095hy.A2G();
        this.A0D = AbstractC2812dC.A00(c2820dL.getResources().getDisplayMetrics());
        this.A0K = c2463Ua;
        this.A0F = abstractC3095hy;
        A02();
    }
    ...
    */
    private void A06(android.widget.FrameLayout r14, com.facebook.ads.redexgen.core.KE r15) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2670au.A06(android.widget.FrameLayout, com.facebook.ads.redexgen.X.KE):void");
    }
    ...
    public final View A0A(KE ke2, ImageView imageView) {
        ...
        C2640aQ c2640aQ = new C2640aQ(this.A0J, this.A0G.A01(), true, false, false);
        c2640aQ.A04(this.A0H.A0F(), this.A0H.A0D().toLowerCase(Locale.getDefault()), null, false, false);
        c2640aQ.setAlignment(17);
        c2640aQ.setTitleTextSize(28);
        c2640aQ.setDescriptionTextSize(13);
        c2640aQ.A02();
        c2640aQ.setPadding(this.A05, 0, this.A05, 0);
        LinearLayout linearLayout = new LinearLayout(this.A0J);
        linearLayout.setClickable(true);
        if (U7.A1C(this.A0J)) {
            linearLayout.setOnClickListener(new ViewOnClickListenerC2668as(this, ke2));
        }
