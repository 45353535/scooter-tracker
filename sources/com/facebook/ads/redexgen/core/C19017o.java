...
public final class C19017o {
    ...
    public static int A00(int i10, int i11) {
        for (int i12 = 8; i12 > 0; i12--) {
            ...
            int channelCount = AbstractC18094a.A01(i12);
    ...
    public static int[] A01() {
        ...
        AbstractC3531pg it = C19027p.A06.keySet().iterator();
        while (it.hasNext()) {
            ...
            if (AudioTrack.isDirectPlaybackSupported(new AudioFormat.Builder().setChannelMask(12).setEncoding(encoding).setSampleRate(48000).build(), A00)) {
                c17401hA01.A04(Integer.valueOf(encoding));
            }
        }
        c17401hA01.A04(2);
        return AD.A0C(c17401hA01.A05());
    }
}
