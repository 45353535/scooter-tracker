...
public abstract class AbstractC1966Ao<E> extends AbstractC3358mZ<E> {
    ...
    public AbstractC1966Ao(int initialCapacity) {
        AbstractC3309ll.A00(initialCapacity, A00(0, 15, 58));
    ...
    private void A02(int minCapacity) {
        if (this.A02.length < minCapacity) {
            this.A02 = Arrays.copyOf(this.A02, AbstractC3358mZ.A03(this.A02.length, minCapacity));
            this.A01 = false;
        } else {
            if (!this.A01) {
                return;
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.Ao != com.google.common.collect.ImmutableCollection$ArrayBasedBuilder<E> */
    public AbstractC1966Ao<E> A03(E element) {
        AbstractC3162jA.A04(element);
        A02(this.A00 + 1);
