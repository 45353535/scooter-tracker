...
public final class C3517pF {
    ...
    public /* synthetic */ C3517pF(AbstractC3512p7 abstractC3512p7) {
        this();
    }
    ...
    public final int A02(Collection<?> collection) {
        C3511p6.A09(collection, A00(31, 1, 39));
        int i10 = 1;
    ...
    public final boolean A06(Collection<?> collection, Collection<?> collection2) {
        C3511p6.A09(collection, A00(31, 1, 39));
        C3511p6.A09(collection2, A00(50, 5, 95));
        ...
        while (it2.hasNext()) {
            if (!C3511p6.A0C(it2.next(), it.next())) {
                return false;
            }
        }
        return true;
