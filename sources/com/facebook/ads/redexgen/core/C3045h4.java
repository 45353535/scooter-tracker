...
public class C3045h4 extends MQ {
    ...
    public final /* synthetic */ C3041gz A00;
    ...
    public C3045h4(C3041gz c3041gz) {
        this.A00 = c3041gz;
    }
    ...
    public final void A04() {
        ...
        if (this.A00.A03 != null && U7.A26(this.A00.A06)) {
            this.A00.A03.A0S(new C3046h5(this));
            this.A00.A03.A0N();
            this.A00.A03.A0K();
            this.A00.A03 = null;
        }
    ...
    public final void A0F(MP mp) {
        if (this.A00.A03 != null) {
            ...
            if (!(this.A00.A02 instanceof AbstractC3095hy)) {
                ...
                AbstractC3095hy abstractC3095hy = (AbstractC3095hy) this.A00.A02;
                if (abstractC3095hy.A1x() > 0) {
                    WR wr = new WR();
                    if (wr.A09(this.A00.A06, this.A00.A08.A08(), abstractC3095hy.A1x())) {
                        wr.A08(this.A00.A06, true);
                        this.A00.A01 = wr.A06(this.A00.A06, this.A00.A08.A0A(), this.A00.A08.A08());
                    } else {
                        C3041gz c3041gz = this.A00;
                        if (A02[1].charAt(2) != 'w') {
                            A02[7] = "alFbtn3b1";
                            wr.A08(c3041gz.A06, false);
                        } else {
                            String[] strArr3 = A02;
                ...
                C3041gz c3041gz2 = this.A00;
                if (A02[1].charAt(2) != 'w') {
                    A02[1] = "23I4hcZMgJ395X2lYna8PMjzW0ozt3hz";
                    if (c3041gz2.A01 != null) {
                        abstractC3095hy.A2A(true);
                        InterstitialAd.InterstitialLoadAdConfig loadAdConfig = this.A00.A01.buildLoadAdConfig().withAdListener(new C2288Nd(this, abstractC3095hy)).withCacheFlags(this.A00.A08.A0B()).withRewardData(this.A00.A08.A03()).build();
                        this.A00.A01.loadAd(loadAdConfig);
                        return;
                    }
                    C3041gz c3041gz3 = this.A00;
                    String[] strArr4 = A02;
                    if (strArr4[0].charAt(8) != strArr4[3].charAt(8)) {
                        c3041gz3.A07.onAdLoaded(this.A00.A08.A6c());
                        return;
                    } else {
                        A02[2] = "joZPUUFug9Ts";
                        c3041gz3.A07.onAdLoaded(this.A00.A08.A6c());
        ...
        this.A00.A06.A08().AAy(A00(0, 3, 98), AbstractC2433Sv.A0N, new C2434Sw(A00(3, 18, 46)));
    }
