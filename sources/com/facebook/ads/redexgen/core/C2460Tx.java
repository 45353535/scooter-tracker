...
public final class C2460Tx {
    ...
    java.lang.ArrayIndexOutOfBoundsException
     */
    public final synchronized C2451To A06(int i10, byte[] bArr, int i11, int[] iArr, int i12) throws IOException {
        C2459Tw c2459TwA00 = A00();
        int i13 = 1;
        if (i10 < 0) {
        ...
        while (true) {
            ...
            long j11 = c2459TwA00.A03[i14];
            long j12 = (i14 == c2459TwA00.A00 - i13 ? c2459TwA00.A01 : c2459TwA00.A03[i14 + 1]) - j11;
            if (j10 == -1) {
                j10 = j11;
            }
        ...
        if (i14 <= i10) {
            return new C2451To(z10 ? EnumC2450Tn.A04 : EnumC2450Tn.A05, i10, i10, 0);
        }
        c2459TwA00.A02.seek(j10);
        c2459TwA00.A02.read(bArr, i11, i15);
        return new C2451To(EnumC2450Tn.A03, i10, i14, i15);
    }
    ...
    public final synchronized boolean A09(byte[] bArr) throws IOException {
        ...
        A03(c2459TwA00.A00, c2459TwA00.A01);
        A04(c2459TwA00.A01, bArr);
        c2459TwA00.A02.getFD().sync();
        c2459TwA00.A00++;
        c2459TwA00.A01 += (long) bArr.length;
        return true;
    }
    ...
    public C2460Tx(File file) throws IOException {
        this.A02 = file;
        if (!file.exists()) {
            this.A00 = C2459Tw.A03(file);
        } else if (!file.isFile()) {
            throw new IOException(String.format(Locale.US, A01(25, 32, 2), file.getCanonicalPath()));
        }
    }

    private C2459Tw A00() throws IOException {
        if (!this.A01) {
            if (this.A00 == null) {
                this.A00 = C2459Tw.A04(this.A02);
            }
            return this.A00;
        }
    ...
    private void A03(int i10, long j10) throws IOException {
        ...
        this.A00.A02.seek(C2459Tw.A02(i10));
