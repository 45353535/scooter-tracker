...
public final class C3220k7 implements J7 {
    public final long[] A00;
    public final C3448o2[] A01;

    public C3220k7(C3448o2[] c3448o2Arr, long[] jArr) {
        this.A01 = c3448o2Arr;
        this.A00 = jArr;
    }
    ...
    public final List<C3448o2> A7P(long j10) {
        int iA0L = AbstractC18094a.A0L(this.A00, j10, true, false);
        if (iA0L == -1 || this.A01[iA0L] == C3448o2.A0J) {
    ...
    public final int A8S(long j10) {
        int iA0K = AbstractC18094a.A0K(this.A00, j10, false, false);
