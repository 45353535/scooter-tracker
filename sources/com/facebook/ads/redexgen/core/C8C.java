...
public final class C8C {
    ...
    public final /* synthetic */ void A02(int i10, long j10, long j11) {
        ((C8D) AbstractC18094a.A0f(this.A01)).ACY(i10, j10, j11);
    }
    ...
    public final /* synthetic */ void A04(long j10) {
        ((C8D) AbstractC18094a.A0f(this.A01)).ACU(j10);
    }
    ...
    public final /* synthetic */ void A06(C3497or c3497or, C18445j c18445j) {
        ((C8D) AbstractC18094a.A0f(this.A01)).ACS(c3497or);
        ((C8D) AbstractC18094a.A0f(this.A01)).ACT(c3497or, c18445j);
    }

    public final void A07(final C18415g c18415g) {
        c18415g.A02();
        if (this.A00 != null) {
            this.A00.post(new Runnable() { // from class: com.facebook.ads.redexgen.X.85
                @Override // java.lang.Runnable
                public final void run() {
                    this.A01.A09(c18415g);
                }
            });
        }
    }

    public final void A08(final C18415g c18415g) {
        if (this.A00 != null) {
            this.A00.post(new Runnable() { // from class: com.facebook.ads.redexgen.X.8B
                @Override // java.lang.Runnable
                public final void run() {
                    this.A01.A0A(c18415g);
                }
            });
        }
    }

    public final /* synthetic */ void A09(C18415g c18415g) {
        c18415g.A02();
        ((C8D) AbstractC18094a.A0f(this.A01)).ACQ(c18415g);
    }

    public final /* synthetic */ void A0A(C18415g c18415g) {
        ((C8D) AbstractC18094a.A0f(this.A01)).ACR(c18415g);
    }
    ...
    public final /* synthetic */ void A0E(Exception exc) {
        ((C8D) AbstractC18094a.A0f(this.A01)).ACV(exc);
    }
    ...
    public final /* synthetic */ void A0H(String str, long j10, long j11) {
        ((C8D) AbstractC18094a.A0f(this.A01)).ACP(str, j10, j11);
    }
    ...
    public final /* synthetic */ void A0J(boolean z10) {
        ((C8D) AbstractC18094a.A0f(this.A01)).AFF(z10);
    }
