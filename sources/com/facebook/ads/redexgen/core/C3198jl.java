...
public final class C3198jl implements KJ {
    ...
    public static void A04() {
        A0L = new byte[]{3, Ascii.ETB, 6, Ascii.VT, 13, 77, Ascii.SI, Ascii.DC2, 86, 3, 79, Ascii.SO, 3, Ascii.SYN, Ascii.SI};
    }
    ...
    public C3198jl(String str) {
        this.A0K = str;
    }

    private int A00(C4I c4i) throws C17652i {
        int iA01 = c4i.A01();
    ...
    private int A01(C4I c4i) throws C17652i {
        int tmp;
        int i10 = 0;
    ...
    private void A06(C4I c4i) throws C17652i {
    ...
    @RequiresNonNull({"output"})
    private void A08(C4I c4i) throws C17652i {
        int iA04;
        boolean zA0H;
        int iA042 = c4i.A04(1);
        if (iA042 == 1) {
            ...
            if (c4i.A0H()) {
                ...
                if (iA043 == 0 && iA044 == 0) {
                    if (iA042 == 0) {
                        ...
                        C3497or c3497orA14 = new C2D().A0y(this.A0F).A11(A03(0, 15, 91)).A0w(this.A0E).A0b(this.A02).A0m(this.A05).A12(Collections.singletonList(bArr)).A10(this.A0K).A14();
                        if (!c3497orA14.equals(this.A0C)) {
                            this.A0C = c3497orA14;
                            this.A0A = 1024000000 / ((long) c3497orA14.A0G);
                            this.A0D.A6W(c3497orA14);
                        }
                    } else {
    ...
    public final void A52(C4J c4j) throws C17652i {
        C3M.A02(this.A0D);
        while (c4j.A07() > 0) {
            switch (this.A08) {
                case 0:
    ...
    public final void A5U(GY gy, C2212Ke c2212Ke) {
        c2212Ke.A05();
        this.A0D = gy.AJh(c2212Ke.A03(), 1);
        this.A0F = c2212Ke.A04();
    }
