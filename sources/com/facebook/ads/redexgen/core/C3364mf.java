...
public final class C3364mf implements AO {
    ...
    public C3364mf(MediaCodec mediaCodec) {
        this.A02 = mediaCodec;
    }

    public final /* synthetic */ void A00(AN an, MediaCodec mediaCodec, long j10, long j11) {
        an.ADL(this, j10, j11);
    }
    ...
    public final int A5m(MediaCodec.BufferInfo bufferInfo) {
        ...
        do {
            ...
            if (iDequeueOutputBuffer == -3 && AbstractC18094a.A02 < 21) {
    ...
    public final ByteBuffer A8B(int i10) {
        ...
        strArr[2] = "7Nv94jZvV7";
        strArr[1] = "iAeXpyFDwx";
        return ((ByteBuffer[]) AbstractC18094a.A0f(byteBufferArr))[i10];
    }
    ...
    public final ByteBuffer A8W(int i10) {
        ...
        return ((ByteBuffer[]) AbstractC18094a.A0f(this.A01))[i10];
    }
    ...
    public final void AIq(final AN an, Handler handler) {
        this.A02.setOnFrameRenderedListener(new MediaCodec.OnFrameRenderedListener() { // from class: com.facebook.ads.redexgen.X.Az
            ...
            public final void onFrameRendered(MediaCodec mediaCodec, long j10, long j11) {
                this.A01.A00(an, mediaCodec, j10, j11);
            }
        }, handler);
    }
