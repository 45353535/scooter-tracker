...
public final class C6Y {
    ...
    public long A03;
    public C6Y A04;
    public C3334mA A05 = C3334mA.A06;
    public EL A06;
    public final InterfaceC3345mM A07;
    public final Object A08;
    public final InterfaceC2018Cr[] A09;
    ...
    public C6Y(C7D[] c7dArr, long j10, EK ek, EO eo, CL cl, C6Z c6z, EL el) {
        this.A0C = c7dArr;
        ...
        this.A00 = c6z;
        this.A06 = el;
        this.A09 = new InterfaceC2018Cr[c7dArr.length];
        this.A0D = new boolean[c7dArr.length];
        this.A0A = new C3408nN(this, cl);
    ...
    public static InterfaceC3345mM A00(C3344mL c3344mL, C6X c6x, EO eo, long j10, long j11) {
        InterfaceC3345mM interfaceC3345mMA5O = c6x.A5O(c3344mL, eo, j10);
        if (j11 != -9223372036854775807L) {
            return new C9F(interfaceC3345mMA5O, true, 0L, j11);
        }
        return interfaceC3345mMA5O;
    }
    ...
    */
    ...
    public static void A05(C6X c6x, InterfaceC3345mM interfaceC3345mM) {
        try {
            if (interfaceC3345mM instanceof C9F) {
                c6x.AH0(((C9F) interfaceC3345mM).A05);
            } else {
                c6x.AH0(interfaceC3345mM);
            }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private void A06(com.facebook.ads.redexgen.core.InterfaceC2018Cr[] r4) {
        /*
            r3 = this;
            r2 = 0
        L1:
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private void A07(com.facebook.ads.redexgen.core.InterfaceC2018Cr[] r4) {
        /*
            r3 = this;
            r2 = 0
        L1:
    ...
    public final long A0F(EL el, long j10, boolean z10) {
        return A0G(el, j10, z10, new boolean[this.A0C.length]);
    }

    public final long A0G(EL el, long j10, boolean z10, boolean[] zArr) {
        int i10 = 0;
        while (true) {
            boolean z11 = false;
            if (i10 < el.A00) {
                ...
                if (!z10) {
                    boolean zA01 = el.A01(this.A06, i10);
                    if (A0F[5].length() != 8) {
                ...
                this.A06 = el;
                A03();
                long jAIP = this.A07.AIP(el.A04, this.A0D, this.A09, zArr, j10);
                A06(this.A09);
                this.A01 = false;
    ...
    public final EL A0L(float f10, Timeline timeline) throws C9Y {
        ...
        for (InterfaceC3307lj interfaceC3307lj : elA0b.A04) {
