...
public final class C2449Tm {
    ...
    public C2449Tm(int i10, int i11) {
        if (i10 < -1) {
    ...
    public final int A04(C2449Tm c2449Tm) {
        if (this.A00 != c2449Tm.A00) {
            return this.A00 - c2449Tm.A00;
        }
        return this.A01 - c2449Tm.A01;
    }

    public final C2449Tm A05(int i10) {
        if (this.A01 + i10 >= 0) {
            return new C2449Tm(this.A00, this.A01 + i10);
        }
    ...
    public final boolean equals(Object obj) {
        if (!(obj instanceof C2449Tm)) {
            return false;
        }
        C2449Tm c2449Tm = (C2449Tm) obj;
        return c2449Tm.A00 == this.A00 && c2449Tm.A01 == this.A01;
    }
