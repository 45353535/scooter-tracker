...
public class RunnableC2366Qf implements Runnable {
    ...
    public int A02;
    public int A03;
    public final /* synthetic */ C18676g A06;
    public Interpolator A00 = C18676g.A1A;
    ...
    public RunnableC2366Qf(C18676g c18676g) {
        this.A06 = c18676g;
        this.A01 = new OverScroller(c18676g.getContext(), C18676g.A1A);
    }
    ...
    private int A01(int i10, int i11, int i12, int i13) {
        ...
        C18676g c18676g = this.A06;
        int width = duration != 0 ? c18676g.getWidth() : c18676g.getHeight();
    ...
    public final void run() {
        ...
        this.A06.A1K();
        OverScroller overScroller = this.A01;
        AbstractC2362Qb abstractC2362Qb = this.A06.A06.A02;
        if (overScroller.computeScrollOffset()) {
            ...
            if (this.A06.A04 != null) {
                ...
                if (vresult != 0) {
                    QO qo = this.A06.A06;
                    QW qw = this.A06.A0r;
                    C18676g c18676g2 = this.A06;
                    if (A08[4].charAt(19) != '9') {
                        A08[4] = "aF9lT9JucYAVgVWisB0rNkK4be7J2iGb";
                        iA1f = qo.A1f(vresult, qw, c18676g2.A0s);
                        i10 = vresult - iA1f;
                    } else {
                        iA1f = qo.A1f(vresult, qw, c18676g2.A0s);
                        i10 = vresult - iA1f;
                ...
                this.A06.A1N();
                this.A06.A1p(false);
                if (abstractC2362Qb != null && !abstractC2362Qb.A0E() && abstractC2362Qb.A0F()) {
                    int x10 = this.A06.A0s.A03();
                    if (x10 == 0) {
                        abstractC2362Qb.A09();
                    } else if (abstractC2362Qb.A07() >= x10) {
                        abstractC2362Qb.A0A(x10 - 1);
                        abstractC2362Qb.A04(vresult - i10, velX - i11);
                    } else {
                        int y10 = vresult - i10;
                        if (A08[4].charAt(19) != 57) {
                            String[] strArr4 = A08;
                            ...
                            abstractC2362Qb.A04(y10, velX - i11);
                        } else {
                            abstractC2362Qb.A04(y10, velX - i11);
                        }
                    }
            ...
            if (iA1f != 0 || iA1g != 0) {
                C18676g c18676g4 = this.A06;
                if (A08[6].length() != 25) {
                    A08[3] = "MhQkdHLAPY6K0mrvY0I8ZqPtgRA1J8Gx";
                    c18676g4.A1d(iA1f, iA1g);
                } else {
        ...
        if (abstractC2362Qb != null) {
            if (abstractC2362Qb.A0E()) {
                abstractC2362Qb.A04(0, 0);
            }
            if (!this.A05) {
                abstractC2362Qb.A09();
            }
