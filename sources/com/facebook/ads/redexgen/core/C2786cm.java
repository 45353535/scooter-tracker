...
public final class C2786cm extends LinearLayout {
    public static final int A04 = (int) (AbstractC2523Wl.A02 * 32.0f);
    public static final int A05 = (int) (AbstractC2523Wl.A02 * 8.0f);
    public TextView A00;
    public TextView A01;
    public C2634aK A02;
    public final C2820dL A03;

    public C2786cm(C2820dL c2820dL) {
        super(c2820dL);
        this.A03 = c2820dL;
        A00(c2820dL);
    }

    private final void A00(C2820dL c2820dL) {
        setGravity(16);
        this.A02 = new C2634aK(c2820dL);
        ...
        LinearLayout pageInfoView = new LinearLayout(c2820dL);
