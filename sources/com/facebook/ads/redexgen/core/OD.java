...
public class OD extends RelativeLayout implements InterfaceC2552Xo {
    ...
    public static void A0D() {
        A0F = new byte[]{90, 112, 112, 125, 112, Ascii.DC4, Utf8.REPLACEMENT_BYTE, 61, 112, 19, Utf8.REPLACEMENT_BYTE, 62, 36, 53, 62, 36, 112, Ascii.FS, Utf8.REPLACEMENT_BYTE, 49, 52, 53, 52, 112, 4, 57, 61, 53, 106, 112, 48, Ascii.SUB, Ascii.SUB, Ascii.ETB, Ascii.SUB, 118, 85, 91, 94, Ascii.SUB, 124, 83, 84, 83, 73, 82, Ascii.SUB, 110, 83, 87, 95, 0, Ascii.SUB, 95, 117, 117, 120, 117, Ascii.EM, 58, 52, 49, 117, 6, 33, 52, 39, 33, 117, 1, 60, 56, 48, 111, 117, 117, 95, 95, 82, 95, 45, Ascii.SUB, Ascii.FF, Ascii.SI, Ascii.DLE, 17, Ascii.FF, Ascii.SUB, 95, 58, 17, Ascii.ESC, 95, 43, Ascii.SYN, Ascii.DC2, Ascii.SUB, 69, 95, 109, 71, 71, 74, 71, 52, 4, Ascii.NAK, 8, Ascii.VT, Ascii.VT, 71, 53, 2, 6, 3, Ascii.RS, 71, 51, Ascii.SO, 10, 2, 93, 71, 87, 125, 125, 112, 125, Ascii.SO, 56, 46, 46, 52, 50, 51, 125, Ascii.ESC, 52, 51, 52, 46, 53, 125, 9, 52, 48, 56, 103, 125, 42, Ascii.SUB, 48, 48, 61, 48, 88, 113, 126, 116, 124, 117, 98, 48, 68, 121, 125, 117, 42, 48, 97, 81, 76, 84, 80, 70, 81, 3, 80, 70, 80, 80, 74, 76, 77, 3, 71, 66, 87, 66, 3, 79, 76, 68, 68, 70, 71, 3, 99, 3, 126, 125, 112, 106, 107, 37, 125, 115, 126, 113, 116, 67, 83, 78, 86, 82, 68, 83, 116, 115, 109, 85, 90, 95, 83, 88, 66, 98, 89, 93, 83, 88, 37, 44, 35, 41, 33, 40, Utf8.REPLACEMENT_BYTE, Ascii.EM, 36, 32, 40};
    }
    ...
    public OD(R0 r02, C2820dL c2820dL, US us, InterfaceC2551Xn interfaceC2551Xn) {
        LJ lj;
        super(c2820dL);
        this.A06 = new C2317Oi(this);
        this.A05 = true;
        this.A01 = -1L;
        this.A03 = true;
        this.A07 = r02;
        ...
        this.A0D = A0E();
        if (U8.A02(c2820dL) || c2820dL.A0E() == null) {
            lj = new LJ(c2820dL, this.A0D);
        } else {
            lj = new LJ(c2820dL, c2820dL.A0E(), this.A0D);
        }
        this.A0E = lj;
        this.A0B = new ZO(c2820dL, this.A0E);
        this.A0B.setId(View.generateViewId());
        this.A0B.setListener(new C2314Of(this));
        this.A0E.setBrowserNavigationListener(this.A0B.getBrowserNavigationListener());
        this.A0C = new ZP(c2820dL, null, R.attr.progressBarStyleHorizontal);
        A0F();
        r02.A0A(this.A06);
    }
    ...
    public void A0F() {
        ...
        RelativeLayout.LayoutParams webViewParams2 = new RelativeLayout.LayoutParams(-1, (int) (AbstractC2523Wl.A02 * 2.0f));
