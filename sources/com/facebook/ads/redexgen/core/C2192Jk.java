...
public final class C2192Jk {
    ...
    public List<C2192Jk> A00;
    public final long A01;
    public final long A02;
    public final C2192Jk A03;
    public final C2199Jr A04;
    ...
    public C2192Jk(String str, String str2, long j10, long j11, C2199Jr c2199Jr, String[] strArr, String str3, String str4, C2192Jk c2192Jk) {
        this.A07 = str;
        this.A08 = str2;
        this.A05 = str4;
        this.A04 = c2199Jr;
    ...
    public static C2192Jk A01(String str) {
        return new C2192Jk(null, AbstractC2194Jm.A04(str), -9223372036854775807L, -9223372036854775807L, null, null, A03(0, 0, 119), null, null);
    }

    public static C2192Jk A02(String str, long j10, long j11, C2199Jr c2199Jr, String[] strArr, String str2, String str3, C2192Jk c2192Jk) {
        return new C2192Jk(str, null, j10, j11, c2199Jr, strArr, str2, str3, c2192Jk);
    }
    ...
    */
    private void A06(long r21, java.util.Map<java.lang.String, com.facebook.ads.redexgen.core.C2199Jr> r23, java.util.Map<java.lang.String, com.facebook.ads.redexgen.core.C2193Jl> r24, java.lang.String r25, java.util.Map<java.lang.String, com.facebook.ads.redexgen.core.C3C> r26) {
        /*
            r20 = this;
            r2 = r20
            r3 = r25
        ...
        L54:
            ...
            com.facebook.ads.redexgen.X.Jl r0 = (com.facebook.ads.redexgen.core.C2193Jl) r0
        ...
        L9d:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2192Jk.A06(long, java.util.Map, java.util.Map, java.lang.String, java.util.Map):void");
    }
    ...
    */
    private void A07(long r12, boolean r14, java.lang.String r15, java.util.Map<java.lang.String, com.facebook.ads.redexgen.core.C3C> r16) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2192Jk.A07(long, boolean, java.lang.String, java.util.Map):void");
    }

    public static void A08(SpannableStringBuilder spannableStringBuilder) {
        for (C2185Jd c2185Jd : (C2185Jd[]) spannableStringBuilder.getSpans(0, spannableStringBuilder.length(), C2185Jd.class)) {
            spannableStringBuilder.replace(spannableStringBuilder.getSpanStart(c2185Jd), spannableStringBuilder.getSpanEnd(c2185Jd), (CharSequence) A03(0, 0, 119));
        }
    ...
    private void A09(Map<String, C2199Jr> map, C3C c3c, int i10, int i11, int i12) {
        C2199Jr c2199JrA02 = AbstractC2194Jm.A02(this.A04, this.A0C, map);
        ...
        if (c2199JrA02 != null) {
            AbstractC2194Jm.A06(spannableStringBuilder, i10, i11, c2199JrA02, this.A03, map, i12);
            if (A03(13, 1, 127).equals(this.A07)) {
                if (c2199JrA02.A04() != Float.MAX_VALUE) {
                    c3c.A05((c2199JrA02.A04() * (-90.0f)) / 100.0f);
                }
                if (c2199JrA02.A0C() != null) {
                    c3c.A0F(c2199JrA02.A0C());
                }
                if (c2199JrA02.A0B() != null) {
                    c3c.A0E(c2199JrA02.A0B());
                }
            }
        }
    }
    ...
    private void A0A(TreeSet<Long> treeSet, boolean z10) {
        ...
        for (int i10 = 0; i10 < this.A00.size(); i10++) {
            C2192Jk c2192Jk = this.A00.get(i10);
            boolean isPNode2 = z10 || zEquals;
            c2192Jk.A0A(treeSet, isPNode2);
        }
    }
    ...
    */
    private final boolean A0B(long r8) {
        ...
        L11:
            ...
            if (r0 > 0) goto L36
            long r2 = r7.A01
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.C2192Jk.A0E
            r0 = 1
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 19
            if (r1 == r0) goto L52
            java.lang.String[] r4 = com.facebook.ads.redexgen.core.C2192Jk.A0E
        ...
        L52:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2192Jk.A0B(long):boolean");
    }
    ...
    public final C2192Jk A0D(int i10) {
        if (this.A00 != null) {
    ...
    public final List<C3448o2> A0E(long j10, Map<String, C2199Jr> map, Map<String, C2193Jl> map2, Map<String, String> imageMap) {
        ...
        for (Pair<String, String> pair : arrayList) {
            ...
            if (str != null) {
                ...
                C2193Jl c2193Jl = (C2193Jl) C3M.A01(map2.get(pair.first));
                arrayList2.add(new C3C().A0D(bitmapDecodeByteArray).A04(c2193Jl.A02).A0A(0).A07(c2193Jl.A01, 0).A09(c2193Jl.A05).A06(c2193Jl.A04).A03(c2193Jl.A00).A0B(c2193Jl.A08).A0H());
            }
        }
        for (Map.Entry entry : treeMap.entrySet()) {
            C2193Jl c2193Jl2 = (C2193Jl) C3M.A01(map2.get(entry.getKey()));
            C3C c3c = (C3C) entry.getValue();
            A08((SpannableStringBuilder) C3M.A01(c3c.A0I()));
            c3c.A07(c2193Jl2.A01, c2193Jl2.A06);
            c3c.A09(c2193Jl2.A05);
            c3c.A04(c2193Jl2.A02);
            c3c.A06(c2193Jl2.A04);
            c3c.A08(c2193Jl2.A03, c2193Jl2.A07);
            c3c.A0B(c2193Jl2.A08);
            arrayList2.add(c3c.A0H());
        }
        return arrayList2;
    }

    public final void A0F(C2192Jk c2192Jk) {
        if (this.A00 == null) {
            this.A00 = new ArrayList();
        }
        this.A00.add(c2192Jk);
    }
