...
public final class FC {
    ...
    public Handler A04;
    public Pair<Long, C3497or> A05;
    public Pair<Surface, C4N> A06;
    public CopyOnWriteArrayList<InterfaceC17883f> A08;
    public boolean A0A;
    public boolean A0B;
    ...
    public final ArrayDeque<Pair<Long, C3497or>> A0E = new ArrayDeque<>();
    public int A00 = -1;
    public boolean A09 = true;
    public long A02 = -9223372036854775807L;
    public C3450o4 A07 = C3450o4.A06;
    ...
    public static boolean A04(long j10) {
        if (MetaExoPlayerUpgradeConfig.A03(EnumC3096i2.A1s)) {
            return j10 > ServiceProvider.SCAR_SIGNALS_FETCH_TIMEOUT;
        }
        int releaseLowerThresholdUs = MetaExoPlayerUpgradeConfig.A00(EnumC3097i3.A08);
        int releaseUpperThresholdUs = MetaExoPlayerUpgradeConfig.A00(EnumC3097i3.A07);
    ...
    public final MediaFormat A06(MediaFormat mediaFormat) {
        if (AbstractC18094a.A02 >= 29 && this.A0C.A0q.getApplicationContext().getApplicationInfo().targetSdkVersion >= 29) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:42:0x010e, code lost:
        ...
        r30.A0C.A0S(r24, r2, (com.facebook.ads.redexgen.core.C3497or) r30.A05.second, null);
     */
    ...
    */
    ...
    public final void A0D(C3497or c3497or) {
        C3M.A01(null);
        final int i10 = c3497or.A0L;
        final int i11 = c3497or.A0A;
    ...
    public final void A0E(String str) {
        this.A00 = AbstractC18094a.A09(this.A0C.A0q, str, false);
    }

    public final void A0F(List<InterfaceC17883f> list) {
        if (this.A08 == null) {
    ...
    public final boolean A0J(C3497or c3497or, long j10) throws C9Y {
        C3M.A08(!A0G());
        if (!this.A09) {
            return false;
        }
        ...
        this.A04 = AbstractC18094a.A0Y();
        this.A0C.A26(c3497or.A0N);
        try {
            if (!C0O.A0h() && c3497or.A0F != 0) {
                CopyOnWriteArrayList<InterfaceC17883f> copyOnWriteArrayList = this.A08;
                FB.A00(c3497or.A0F);
            ...
            new ExecutorC19188l(handler);
            new C3297lZ(this, c3497or);
            throw new NullPointerException(A01(16, 6, 36));
        } catch (Exception e10) {
            throw this.A0C.A1S(e10, c3497or, 7000);
        }
    }

    public final boolean A0K(C3497or c3497or, long j10, boolean z10) {
        C3M.A02(null);
        C3M.A08(this.A00 != -1);
