...
public final class C18766p extends AbstractC3054hD {
    ...
    public C18766p(C3028gm c3028gm, String str) {
        super(c3028gm.A0B, str, A00(c3028gm));
        this.A01 = c3028gm;
    }

    public static C3027gl A00(C3028gm c3028gm) {
        return new C3027gl(c3028gm);
    }

    @Override // com.facebook.ads.redexgen.core.AbstractC3054hD
    ...
    public final void A09() {
        this.A00 = new C3038gw(this.A01, this, A04());
    ...
    public final void A0G(RewardData rewardData) {
        ...
        if (super.A01.A01) {
            super.A01.A0F(2003, AbstractC2305Nu.A00(new Bundle(), rewardData));
    ...
    public final boolean A0J(Ad ad2, RewardedVideoAd.RewardedVideoShowAdConfig rewardedVideoShowAdConfig) {
        int iA00 = ((C2388Rb) rewardedVideoShowAdConfig).A00();
        long jA01 = ((C2388Rb) rewardedVideoShowAdConfig).A01();
        if (super.A00.A6N()) {
            return false;
        }
        this.A01.A02(ad2);
