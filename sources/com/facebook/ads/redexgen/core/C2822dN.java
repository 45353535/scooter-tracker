...
public final class C2822dN extends LinearLayout {
    public static final int A00 = (int) (AbstractC2523Wl.A02 * 32.0f);
    public static final int A01 = (int) (AbstractC2523Wl.A02 * 8.0f);

    public C2822dN(C2820dL c2820dL, NativeAd nativeAd, C2480Ur c2480Ur, C2634aK c2634aK, AdOptionsView adOptionsView) {
        super(c2820dL);
        setOrientation(0);
        ...
        addView(c2634aK, iconViewParams);
        TextView textView = new TextView(c2820dL);
        c2480Ur.A08(textView);
        textView.setMaxLines(1);
        textView.setText(nativeAd.getAdvertiserName());
        TextView sponsoredTextView = new TextView(c2820dL);
        c2480Ur.A06(sponsoredTextView);
