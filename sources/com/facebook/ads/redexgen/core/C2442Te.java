...
import com.facebook.ads.redexgen.core.AbstractC2443Tf;
import com.facebook.ads.redexgen.core.C2441Td;
...
public final class C2442Te<T extends AbstractC2443Tf, E extends C2441Td> {
    ...
    private void A00(E e10) {
        ...
        while (it.hasNext()) {
            AbstractC2443Tf abstractC2443Tf = (AbstractC2443Tf) ((WeakReference) it.next()).get();
            if (abstractC2443Tf != null && abstractC2443Tf.A00(e10)) {
                abstractC2443Tf.A03(e10);
            }
        }
    }
    ...
    */
    private void A01(java.util.List<java.lang.ref.WeakReference<T>> r5) {
        ...
        L2d:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2442Te.A01(java.util.List):void");
    }
