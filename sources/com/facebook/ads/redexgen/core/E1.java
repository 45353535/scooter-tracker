...
public class E1 extends RelativeLayout implements InterfaceC2891eV, InterfaceC2825dQ {
    ...
    public final C2442Te<AbstractC2443Tf, C2441Td> A0C;
    public final List<InterfaceC2837dc> A0D;
    public final InterfaceC2888eS A0E;
    ...
    public E1(C2820dL c2820dL) {
        super(c2820dL);
        this.A0D = new ArrayList();
        this.A08 = new Handler();
        this.A09 = new Handler();
        this.A0C = new C2442Te<>();
        this.A06 = true;
        this.A01 = 200;
        this.A00 = 1.0f;
        this.A0A = new ViewOnTouchListenerC2824dP(this);
        this.A0B = c2820dL;
        if (A0W(c2820dL)) {
            this.A0E = new CM(c2820dL);
        } else {
            this.A0E = new CJ(c2820dL);
        }
        A0H();
    }

    public E1(C2820dL c2820dL, AttributeSet attributeSet) {
        ...
        this.A0B = c2820dL;
        if (A0W(c2820dL)) {
            this.A0E = new CM(c2820dL, attributeSet);
        } else {
            this.A0E = new CJ(c2820dL, attributeSet);
        }
        A0H();
    }

    public E1(C2820dL c2820dL, AttributeSet attributeSet, int i10) {
        ...
        this.A0B = c2820dL;
        if (A0W(c2820dL)) {
            this.A0E = new CM(c2820dL, attributeSet, i10);
        } else {
            this.A0E = new CJ(c2820dL, attributeSet, i10);
        }
        A0H();
    }

    private float A06(InterfaceC2888eS interfaceC2888eS) {
        int videoHeight = interfaceC2888eS.getVideoHeight();
        if (videoHeight == 0) {
            return 1.0f;
        }
        int height = interfaceC2888eS.getVideoWidth();
    ...
    private void A0H() {
        ...
        this.A03 = new C2833dY(this.A0B, this.A0E);
    ...
    private final void A0K() {
        for (InterfaceC2837dc interfaceC2837dc : this.A0D) {
            boolean z10 = interfaceC2837dc instanceof AbstractC2027Da;
            String[] strArr = A0G;
            ...
            if (z10) {
                A0R((AbstractC2027Da) interfaceC2837dc);
            }
            interfaceC2837dc.AAm(this);
        }
    }
    ...
    private void A0Q(InterfaceC2837dc interfaceC2837dc) {
        if (interfaceC2837dc instanceof AbstractC2027Da) {
            A0S((AbstractC2027Da) interfaceC2837dc);
        }
        interfaceC2837dc.AJk(this);
    }

    private void A0R(AbstractC2027Da abstractC2027Da) {
        if (abstractC2027Da.getParent() == null) {
            if (abstractC2027Da instanceof C17722p) {
                this.A03.A02(abstractC2027Da);
            } else {
                addView(abstractC2027Da);
            }
        }
    }

    private void A0S(AbstractC2027Da abstractC2027Da) {
        if (abstractC2027Da instanceof C17722p) {
            this.A03.A03(abstractC2027Da);
        } else {
            XP.A0H(abstractC2027Da);
        }
    }
    ...
    private boolean A0W(C2820dL c2820dL) {
        return U7.A2t(c2820dL, C2875eF.A03());
    }
    ...
    public final void A0b() {
        Iterator<InterfaceC2837dc> it = this.A0D.iterator();
        while (it.hasNext()) {
            A0Q(it.next());
        }
        this.A0D.clear();
    ...
    public final void A0c(int i10) {
        ...
        C2833dY c2833dY = this.A03;
        if (A0G[3].length() == 1) {
            throw new RuntimeException();
        }
        A0G[7] = "Fk13SNDKaQVX0dV87s1e6TAwbDOb9nQX";
        c2833dY.setLayoutParams(layoutParams);
    }
    ...
    public final void A0g(EnumC2828dT enumC2828dT) {
        E8 e82 = new E8(this);
        if (this.A07) {
            XJ.A00(e82);
        } else {
        ...
        this.A0E.AJH(enumC2828dT.A03());
    }

    public final void A0h(EnumC2836db enumC2836db, int i10) {
        if (this.A04 && this.A0E.getState() == EnumC2890eU.A06) {
            this.A04 = false;
        }
        this.A0E.AJM(enumC2836db, i10);
        if (A0G[7].charAt(27) == '4') {
            throw new RuntimeException();
        }
        A0G[3] = "hMpnI8E";
    ...
    public final void A0i(InterfaceC2837dc interfaceC2837dc) {
        this.A0D.add(interfaceC2837dc);
    }

    public final void A0j(InterfaceC2837dc interfaceC2837dc) {
        this.A0D.remove(interfaceC2837dc);
        A0Q(interfaceC2837dc);
    }
    ...
    public final boolean A0q() {
        return getState() == EnumC2890eU.A05;
    }
    ...
    public final boolean A0s() {
        return getState() == EnumC2890eU.A0A;
    }
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2825dQ
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2891eV
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2891eV
    public final void AFt(EnumC2890eU enumC2890eU) {
        int currentPositionInMillis = getCurrentPositionInMillis();
        int currentPositionMS = getDuration();
        ED ed2 = new ED(this, enumC2890eU, currentPositionInMillis, currentPositionMS);
        if (this.A07) {
            XJ.A00(ed2);
        } else {
            this.A09.post(ed2);
    ...
    public C2442Te<AbstractC2443Tf, C2441Td> getEventBus() {
        return this.A0C;
    }
    ...
    public List<InterfaceC2837dc> getPlugins() {
        return this.A0D;
    }
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2825dQ
    public EnumC2836db getVideoStartReason() {
    ...
    public void setFunnelLoggingHandler(C2463Ua c2463Ua) {
        this.A02 = c2463Ua;
    }
