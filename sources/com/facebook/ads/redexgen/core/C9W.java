...
public final class C9W implements Handler.Callback, InterfaceC3346mN, EJ, CK, InterfaceC18485n, InterfaceC18866z {
    ...
    public boolean A0U;
    public boolean A0V;
    public InterfaceC3407nM[] A0W;
    public final long A0Y;
    public final long A0Z;
    public final Handler A0a;
    public final HandlerThread A0b;
    public final C3468oN A0c;
    public final C3466oL A0d;
    public final C3T A0e;
    public final InterfaceC18043v A0f;
    public final C3415nU A0g;
    public final C6A A0h;
    public final C6S A0i;
    public final C3401nG A0k;
    public final EK A0l;
    public final EL A0m;
    public final EU A0n;
    ...
    public final InterfaceC3407nM[] A0v;
    public final C7D[] A0w;
    public long A05 = -9223372036854775807L;

    @MetaExoPlayerCustomization("D18870411: Adding start stall debug reason")
    public EnumC3073hX A0E = EnumC3073hX.A09;

    @MetaExoPlayerCustomization("D63737392: Added for negative testing")
    public boolean A0J = false;

    @MetaExoPlayerCustomization("D63737392: Added for negative testing")
    public C18816u A09 = null;
    ...
    public final C18636c A0j = new C18636c();
  ...
  0x021b: PHI (r8v4 com.facebook.ads.redexgen.X.mL) = (r8v2 com.facebook.ads.redexgen.X.mL), (r8v6 com.facebook.ads.redexgen.X.mL) binds: [B:93:0x024d, B:83:0x0219] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    private void A0f(C6B c6b) throws Throwable {
        ...
        if (pairA09 == null) {
            ...
            c3344mLA0K = this.A0j.A0K(this.A0A.A03, obj, jLongValue);
            if (c3344mLA0K.A00()) {
                jLongValue2 = 0;
                z10 = true;
            } else {
                ...
                if (this.A0D == null || this.A02 > 0) {
                    ...
                    try {
                        if (jLongValue2 == -9223372036854775807L) {
                            ...
                            if (c3344mLA0K.equals(this.A0A.A05)) {
                                C6Y c6yA0F = this.A0j.A0F();
                                if (c6yA0F != null && jA6j != 0) {
                                    jA6j = c6yA0F.A07.A6j(jA6j, this.A0C);
                                }
                                if (AbstractC17551w.A01(jA6j) == AbstractC17551w.A01(this.A0A.A0C)) {
                                    this.A0A = this.A0A.A06(c3344mLA0K, this.A0A.A0C, jLongValue, A01());
                                    if (z10) {
                                        this.A0h.A04(2);
                                        return;
                                    }
                            ...
                            long jA06 = A06(c3344mLA0K, jA6j);
                            z10 |= jLongValue2 != jA06;
                            jLongValue2 = jA06;
                        }
                    } catch (Throwable th2) {
                        th = th2;
                        this.A0A = this.A0A.A06(c3344mLA0K, jLongValue2, jLongValue, A01());
                        if (z10) {
                            this.A0h.A04(2);
                        }
                        throw th;
    ...
    public C9W(InterfaceC3407nM[] interfaceC3407nMArr, EK ek, EL el, C6S c6s, EU eu, boolean z10, int i10, boolean z11, Handler handler, C3T c3t, boolean z12, boolean z13, boolean z14, boolean z15, boolean z16, boolean z17, long j10, boolean z18, int i11, boolean z19, boolean z20, boolean z21, boolean z22, boolean z23, boolean z24, C18997m c18997m) {
        this.A0v = interfaceC3407nMArr;
        this.A0l = ek;
        this.A0m = el;
        this.A0i = c6s;
        this.A0n = eu;
        ...
        this.A0t = z24;
        this.A0N = j10 > 0;
        this.A0Y = c6s.A6s(c18997m);
        this.A0r = c6s.AI3(c18997m);
        this.A0C = C7I.A03;
        this.A0A = new C18846x(Timeline.A02, -9223372036854775807L, C3334mA.A06, el);
        this.A0h = new C6A();
        this.A0w = new C7D[interfaceC3407nMArr.length];
        for (int i12 = 0; i12 < interfaceC3407nMArr.length; i12++) {
            interfaceC3407nMArr[i12].AA1(i12, c18997m);
            this.A0w[i12] = interfaceC3407nMArr[i12].A75();
        }
        this.A0g = new C3415nU(this, c3t);
        this.A0k = new C3401nG(c3t);
        this.A0o = z20 ? new AnonymousClass91(c3t) : null;
        this.A0p = new ArrayList<>();
        this.A0W = new InterfaceC3407nM[0];
        this.A0d = new C3466oL();
        this.A0c = new C3468oN();
        ek.A02(this, eu);
    ...
    @MetaExoPlayerCustomization
    private int A00() {
        int exoplayerThreadPollingIntervalMs = MetaExoPlayerUpgradeConfig.A00(EnumC3097i3.A04);
    ...
    private final long A05(C6Y c6y) {
        ...
        InterfaceC2018Cr[] interfaceC2018CrArr = c6y.A09;
        for (int i10 = 0; i10 < interfaceC2018CrArr.length; i10++) {
            if (interfaceC2018CrArr[i10] instanceof InterfaceC2019Cs) {
                long periodStartPositionUs = ((InterfaceC2019Cs) interfaceC2018CrArr[i10]).A81();
    ...
    private long A06(C3344mL c3344mL, long j10) throws C9Y {
        return A07(false, c3344mL, j10, this.A0j.A0F() != this.A0j.A0G());
    }

    private long A07(boolean z10, C3344mL c3344mL, long j10, boolean z11) throws C9Y {
        A0O();
        this.A0R = false;
        A0V(2);
        C6Y c6yA0F = this.A0j.A0F();
        ...
        if (c6yA0F != c6yA0B || z11) {
            for (InterfaceC3407nM interfaceC3407nM : this.A0W) {
                A0l(interfaceC3407nM);
            }
            this.A0W = new InterfaceC3407nM[0];
            if (A0y[1].length() == 31) {
                throw new RuntimeException();
            ...
            if (elA0L != null) {
                if (z11) {
                    ...
                    for (int i11 = 0; i11 < this.A0v.length; i11++) {
                        InterfaceC3407nM interfaceC3407nM = this.A0v[i11];
                        zArr2[i11] = interfaceC3407nM.A92() != 0;
                        InterfaceC2018Cr interfaceC2018Cr = c6yA0F2.A09[i11];
                        if (interfaceC2018Cr != null) {
                            i10++;
                        }
                        if (zArr2[i11]) {
                            InterfaceC2018Cr interfaceC2018CrA95 = interfaceC3407nM.A95();
                            if (A0y[7].charAt(12) == '2') {
                                throw new RuntimeException();
                            }
                            A0y[1] = "PyyQ9suxdi7C";
                            if (interfaceC2018Cr != interfaceC2018CrA95) {
                                A0l(interfaceC3407nM);
                            } else if (zArr[i11]) {
                                interfaceC3407nM.AI2(this.A06);
                            }
                        }
                    }
    ...
    private void A0Q() throws C9Y {
        ...
        if (jAGg != -9223372036854775807L) {
            ...
            C3415nU c3415nU = this.A0g;
            C6Y playingPeriodHolder = this.A0j.A0G();
            this.A06 = c3415nU.A04(c6yA0F != playingPeriodHolder);
    ...
    private void A0T(float f10) {
        for (C6Y c6yA0D = this.A0j.A0D(); c6yA0D != null && c6yA0D.A02; c6yA0D = c6yA0D.A0I()) {
            for (InterfaceC3307lj interfaceC3307lj : c6yA0D.A0K().A04) {
                if (interfaceC3307lj != null) {
                    interfaceC3307lj.AEc(f10);
                }
            }
        }
    }
    ...
    private void A0W(int i10, boolean z10) {
        if (this.A0A.A00 != i10) {
            C18846x c18846xA03 = this.A0A.A03(i10, z10);
            if (A0y[1].length() == 31) {
                throw new RuntimeException();
            }
            A0y[1] = "pTubBuiOOGTe";
    ...
    private void A0X(int i10, boolean playing, int i11) throws C9Y {
        C6Y c6yA0F = this.A0j.A0F();
        InterfaceC3407nM interfaceC3407nM = this.A0v[i10];
        this.A0W[i11] = interfaceC3407nM;
        if (interfaceC3407nM.A92() == 0) {
            ...
            C3497or[] c3497orArrA1A = A1A(c6yA0F.A0K().A04[i10]);
            boolean z11 = this.A0P && this.A0A.A00 == 3;
            interfaceC3407nM.A6D(c7g, c3497orArrA1A, c6yA0F.A09[i10], this.A06, !playing && z11, z10, c6yA0G.A0H(this.A0K), c6yA0F.A0B());
            this.A0g.A09(interfaceC3407nM);
            if (z11) {
                interfaceC3407nM.start();
            }
        }
    ...
    */
    ...
    private void A0b(C3481ob c3481ob) {
        this.A0g.AIt(c3481ob);
        if (this.A0o != null) {
            this.A0o.AIt(c3481ob);
        }
        if (this.A0k != null) {
            this.A0k.AIt(c3481ob);
        }
    }
    ...
    */
    ...
    private void A0l(InterfaceC3407nM interfaceC3407nM) throws C9Y {
        this.A0g.A08(interfaceC3407nM);
        A0m(interfaceC3407nM);
        interfaceC3407nM.A5p();
    }

    private void A0m(InterfaceC3407nM interfaceC3407nM) throws C9Y {
        if (interfaceC3407nM.A92() == 2) {
            interfaceC3407nM.stop();
        }
    }
    ...
    private void A0o(InterfaceC3345mM interfaceC3345mM) {
        if (!this.A0j.A0T(interfaceC3345mM)) {
            return;
        }
        this.A0j.A0L(this.A06);
        A0w(false);
    ...
    private void A0p(InterfaceC3345mM interfaceC3345mM) throws C9Y {
        byte b10;
        if (!this.A0j.A0T(interfaceC3345mM)) {
            return;
        }
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2021Cu
    /* JADX INFO: renamed from: A0q, reason: merged with bridge method [inline-methods] */
    public final void ACs(InterfaceC3345mM interfaceC3345mM) {
        this.A0f.ACA(10, interfaceC3345mM).A02();
    }

    private void A0r(CL cl, boolean z10, boolean z11) {
        this.A02++;
        A13(true, z10, z11);
        this.A0i.AEj(C18997m.A03);
        this.A0D = cl;
        A0V(2);
        cl.AGN(this, null);
        this.A0f.AIQ(2);
    ...
    private void A0s(C3334mA c3334mA, EL el) {
        this.A0i.AFV(new C6R(C18997m.A03, this.A0A.A03, this.A0A.A04, this.A0A.A0C, A01(), this.A0g.A8e().A01, this.A0P, this.A0R, -9223372036854775807L, this.A04), c3334mA, el.A04);
    }

    @MetaExoPlayerCustomization("D18870411: Adding start stall debug reason")
    private void A0t(EnumC3073hX enumC3073hX, boolean z10) {
        if (this.A0A.A00 != 3) {
            this.A0A = this.A0A.A02(3, enumC3073hX, z10);
            this.A04 = -1L;
        }
    }
    ...
    private void A0v(boolean z10) {
        ...
        if (c6yA0E == null) {
            ...
            c3344mL = c6yA0E.A00.A04;
        }
        C3344mL loadingMediaPeriodId = this.A0A.A04;
        boolean loadingMediaPeriodChanged = !loadingMediaPeriodId.equals(c3344mL);
        if (loadingMediaPeriodChanged) {
            this.A0A = this.A0A.A05(c3344mL);
        }
    ...
    private void A0w(boolean z10) {
        ...
        Timeline timeline = this.A0A.A03;
        C3344mL c3344mL = c6yA0E.A00.A04;
        float f10 = this.A0g.A8e().A01;
        boolean z11 = this.A0P || z10;
        boolean z12 = this.A0R;
        long nextLoadPositionUs2 = this.A04;
        boolean zAJB = this.A0i.AJB(new C6R(null, timeline, c3344mL, jA0D, jA0C, f10, z11, z12, -9223372036854775807L, nextLoadPositionUs2));
        if (this.A0T && this.A0P && this.A0R && !zAJB && this.A0A.A00 == 2) {
            ...
            this.A0a.obtainMessage(5, AbstractC18094a.A0n(A0D(125, 70, 5), lValueOf, lValueOf2, lValueOf3)).sendToTarget();
            this.A0T = false;
        }
        A0y(zAJB);
        if (zAJB) {
    ...
    private void A0x(boolean z10) throws C9Y {
        C3344mL c3344mL = this.A0j.A0F().A00.A04;
        long jA07 = A07(false, c3344mL, this.A0A.A0C, true);
        if (jA07 != this.A0A.A0C) {
            this.A0A = this.A0A.A06(c3344mL, jA07, this.A0A.A01, A01());
            if (z10) {
                C6A c6a = this.A0h;
                String[] strArr = A0y;
                if (strArr[4].charAt(1) == strArr[3].charAt(1)) {
    ...
    private void A13(boolean z10, boolean z11, boolean z12) {
        ...
        C3344mL c3344mLA0A = z11 ? A0A() : this.A0A.A05;
        ...
        if (z12) {
            ...
            C18846x c18846x3 = this.A0A;
            if (A0y[7].charAt(12) == '2') {
                throw new RuntimeException();
            }
            A0y[5] = "yizxhFEcEwEbIh7DB6ScCbr86G64zHmf";
            c3334mA = c18846x3.A06;
        }
        if (z12) {
            el = this.A0m;
        } else {
        ...
        this.A0A = new C18846x(timeline, c3344mLA0A, j10, j11, i10, false, c3334mA, el, c3344mLA0A, j10, 0L, j10);
    ...
    */
    private void A14(boolean[] r6, int r7) throws com.facebook.ads.redexgen.core.C9Y {
        /*
            r5 = this;
            com.facebook.ads.redexgen.X.nM[] r0 = new com.facebook.ads.redexgen.core.InterfaceC3407nM[r7]
            r5.A0W = r0
            r4 = 0
    ...
    private boolean A16(AnonymousClass69 anonymousClass69) {
        if (anonymousClass69.A02 == null) {
            Pair<Object, Long> pairA09 = A09(new C6B(anonymousClass69.A03.A04(), anonymousClass69.A03.A00(), AbstractC17551w.A00(anonymousClass69.A03.A02())), false);
            if (pairA09 == null) {
                return false;
            }
    ...
    private boolean A17(InterfaceC3407nM interfaceC3407nM) {
        C6Y c6yA0G = this.A0j.A0G();
        C6Y readingPeriodHolder = c6yA0G.A0I();
        if (readingPeriodHolder != null) {
            C6Y readingPeriodHolder2 = c6yA0G.A0I();
            if (readingPeriodHolder2.A02 && interfaceC3407nM.A9h()) {
                return true;
            }
        }
        return false;
    ...
    private boolean A18(C3344mL c3344mL, long j10, C6Y c6y) {
        if (!c3344mL.equals(c6y.A00.A04)) {
            return false;
        }
        boolean z10 = c6y.A02;
        if (A0y[1].length() == 31) {
    ...
    */
    private boolean A19(boolean r19) {
        ...
        La6:
            if (r9 != 0) goto Lac
            com.facebook.ads.redexgen.X.hX r0 = com.facebook.ads.redexgen.core.EnumC3073hX.A04
            r3.A0E = r0
        Lac:
            return r9
        Lad:
    ...
    public static C3497or[] A1A(EE ee2) {
        int length = ee2 != null ? ee2.length() : 0;
        C3497or[] c3497orArr = new C3497or[length];
        for (int i10 = 0; i10 < length; i10++) {
            c3497orArr[i10] = ee2.A83(i10);
        }
        return c3497orArr;
    }
    ...
    */
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC18485n
    public final void AEb(C3481ob c3481ob) {
        this.A0a.obtainMessage(1, c3481ob).sendToTarget();
        A0T(c3481ob.A01);
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC3346mN
    public final void AEk(InterfaceC3345mM interfaceC3345mM) {
        this.A0f.ACA(9, interfaceC3345mM).A02();
    }
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC18866z
    ...
    public final boolean handleMessage(Message message) throws Throwable {
        ...
        switch (message.what) {
            ...
            case 8:
                ...
                return true;
            case 9:
                A0p((InterfaceC3345mM) message.obj);
                A0H();
                return true;
            case 10:
                A0o((InterfaceC3345mM) message.obj);
                A0H();
                return true;
            case 11:
                A0L();
