...
public class VD extends AbstractRunnableC2507Vt {
    ...
    public final void A07() {
        ...
        try {
            ...
            if (all.size() > 1) {
                C2466Ud.A06(this.A00, C2917ev.A00(this.A00), all);
            }
            ...
            this.A00.A08().AAy(A00(31, 14, 46), 3502, new C2434Sw(e10));
            sharedPreferences.edit().clear().apply();
        }
        synchronized (C2466Ud.class) {
            SharedPreferences.Editor editorEdit = sharedPreferences.edit();
            for (Map.Entry entry : C2466Ud.A02.entrySet()) {
