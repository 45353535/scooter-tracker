...
public class C2382Qv<T> implements InvocationHandler {
    ...
    public C2382Qv(T impl, ClassLoader classLoader) {
        this.A01 = impl;
    ...
    public static Object A00(ClassLoader classLoader, Method method) {
        ...
        return Proxy.newProxyInstance(classLoader, new Class[]{returnType}, new C2381Qu(classLoader));
    }
    ...
    public final Object invoke(Object obj, Method method, Object[] objArr) {
        try {
            ...
            if (t10 instanceof InvocationTargetException) {
                ...
                if (targetException instanceof C2286Nb) {
            ...
            if (c2794cuA00 != null) {
                c2794cuA00.A08().AAy(A02(0, 3, 54), AbstractC2433Sv.A0O, new C2434Sw(t10));
                return objA00;
            }
            return objA00;
        }
