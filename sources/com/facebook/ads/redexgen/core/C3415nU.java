...
public final class C3415nU implements C6W {
    ...
    public C6W A00;
    public InterfaceC3407nM A01;
    public boolean A04;
    public final InterfaceC18485n A05;
    public final C3401nG A06;
    ...
    public boolean A02 = MetaExoPlayerUpgradeConfig.A03(EnumC3096i2.A1d);
    ...
    public static void A01() {
        A07 = new byte[]{86, 110, 119, 111, 114, 107, 119, 126, 59, 105, 126, 117, Ascii.DEL, 126, 105, 126, 105, 59, 118, 126, Ascii.DEL, 114, 122, 59, 120, 119, 116, 120, 112, 104, 59, 126, 117, 122, 121, 119, 126, Ascii.DEL, 53};
    }
    ...
    public C3415nU(InterfaceC18485n interfaceC18485n, C3T c3t) {
        this.A05 = interfaceC18485n;
        this.A06 = new C3401nG(c3t);
    }
    ...
    private void A02(boolean z10) {
        ...
        this.A06.A02(jA8h);
        C3481ob c3481obA8e = c6w.A8e();
        C6W rendererClock2 = this.A06;
        if (!c3481obA8e.equals(rendererClock2.A8e())) {
            C6W rendererClock3 = this.A06;
            rendererClock3.AIt(c3481obA8e);
            this.A05.AEb(c3481obA8e);
        }
    }

    private boolean A03(boolean z10) {
        if (this.A01 != null) {
            InterfaceC3407nM interfaceC3407nM = this.A01;
            String[] strArr = A08;
            if (strArr[0].charAt(6) != strArr[7].charAt(6)) {
                throw new RuntimeException();
            }
    ...
    public final void A08(InterfaceC3407nM interfaceC3407nM) {
        if (interfaceC3407nM == this.A01) {
            this.A00 = null;
            this.A01 = null;
            this.A03 = true;
        }
    ...
    public final void A09(InterfaceC3407nM interfaceC3407nM) throws C9Y {
        C6W c6wA8L = interfaceC3407nM.A8L();
        if (c6wA8L != null) {
    ...
    public final void AIt(C3481ob c3481ob) {
        if (this.A00 != null) {
            this.A00.AIt(c3481ob);
            c3481ob = this.A00.A8e();
        }
        this.A06.AIt(c3481ob);
        if (this.A02) {
            this.A05.AEb(c3481ob);
        }
    }
}
