...
public class C3000gI extends QO implements InterfaceC2361Qa {
    ...
    public C3000gI(Context context) {
        this(context, 1, false);
    }

    public C3000gI(Context context, int i10, boolean z10) {
        this.A0A = false;
        this.A05 = false;
        this.A0C = false;
        this.A0B = true;
    ...
    private final int A04(int i10, QW qw, C2364Qd c2364Qd) {
        if (A0Y() == 0 || i10 == 0) {
            return 0;
        }
        this.A07.A0B = true;
        ...
        A0Y(absDy, consumed, true, c2364Qd);
        int i11 = this.A07.A07;
        int layoutDirection = A07(qw, this.A07, c2364Qd, false);
    ...
    private int A05(int i10, QW qw, C2364Qd c2364Qd, boolean z10) {
        int fixOffset;
        int gap = this.A04.A07() - i10;
        if (gap > 0) {
            int i11 = -A04(-gap, qw, c2364Qd);
            int i12 = i10 + i11;
    ...
    private int A06(int i10, QW qw, C2364Qd c2364Qd, boolean z10) {
        int iA0A;
    ...
    private final int A07(QW qw, Q3 q32, C2364Qd c2364Qd, boolean z10) {
        int i10 = q32.A00;
        int start = q32.A07;
        ...
        Q2 q22 = this.A0E;
        while (true) {
            if ((!q32.A09 && i13 <= 0) || !q32.A05(c2364Qd)) {
                break;
            }
            q22.A00();
            A2F(qw, c2364Qd, q32, q22);
            if (!q22.A01) {
                int i14 = q32.A06;
                int remainingSpace = q22.A00;
                int start5 = q32.A05;
                q32.A06 = i14 + (remainingSpace * start5);
                if (!q22.A03 || this.A07.A08 != null || !c2364Qd.A07()) {
    ...
    private int A08(C2364Qd c2364Qd) {
        if (A0Y() == 0) {
            return 0;
        }
        A2B();
        return AbstractC2368Qh.A00(c2364Qd, this.A04, A0R(!this.A0B, true), A0Q(!this.A0B, true), this, this.A0B);
    }

    private int A0A(C2364Qd c2364Qd) {
        if (A0Y() != 0) {
            A2B();
            return AbstractC2368Qh.A02(c2364Qd, this.A04, A0R(!this.A0B, true), A0Q(!this.A0B, true), this, this.A0B, this.A05);
        }
    ...
    private int A0B(C2364Qd c2364Qd) {
        if (A0Y() == 0) {
            return 0;
        }
        A2B();
        return AbstractC2368Qh.A01(c2364Qd, this.A04, A0R(!this.A0B, true), A0Q(!this.A0B, true), this, this.A0B);
    }

    private final int A0C(C2364Qd c2364Qd) {
        if (c2364Qd.A06()) {
            return this.A04.A0B();
        }
        return 0;
    ...
    private View A0J(QW qw, C2364Qd c2364Qd) {
        return A2A(qw, c2364Qd, 0, A0Y(), c2364Qd.A03());
    }

    private View A0L(QW qw, C2364Qd c2364Qd) {
        return A2A(qw, c2364Qd, A0Y() - 1, -1, c2364Qd.A03());
    }

    private View A0M(QW qw, C2364Qd c2364Qd) {
        return this.A05 ? A0D() : A0E();
    }

    private View A0N(QW qw, C2364Qd c2364Qd) {
        return this.A05 ? A0E() : A0D();
    }

    private View A0O(QW qw, C2364Qd c2364Qd) {
        return this.A05 ? A0J(qw, c2364Qd) : A0L(qw, c2364Qd);
    }

    private View A0P(QW qw, C2364Qd c2364Qd) {
        return this.A05 ? A0L(qw, c2364Qd) : A0J(qw, c2364Qd);
    }
    ...
    private void A0Y(int i10, int i11, boolean z10, C2364Qd c2364Qd) {
        int iA0A;
        this.A07.A09 = A0i();
        this.A07.A02 = A0C(c2364Qd);
        this.A07.A05 = i10;
        if (i10 == 1) {
    ...
    private void A0f(QW qw, C2364Qd c2364Qd, int scrapExtraEnd, int scrapExtraEnd2) {
        if (!c2364Qd.A08() || A0Y() == 0 || c2364Qd.A07() || !A24()) {
            return;
        }
        int iA0D = 0;
        int scrapExtraStart = 0;
        List<AbstractC2367Qg> listA0J = qw.A0J();
        int i10 = listA0J.size();
        int iA0r = A0r(A0v(0));
        for (int scrapSize = 0; scrapSize < i10; scrapSize++) {
            AbstractC2367Qg abstractC2367Qg = listA0J.get(scrapSize);
            if (!abstractC2367Qg.A0g()) {
                int direction = 1;
                if ((abstractC2367Qg.A0O() < iA0r) != this.A05) {
                    direction = -1;
                }
                if (direction == -1) {
                    iA0D += this.A04.A0D(abstractC2367Qg.A0H);
                } else {
                    scrapExtraStart += this.A04.A0D(abstractC2367Qg.A0H);
                }
            }
        }
    ...
    private void A0g(QW qw, C2364Qd c2364Qd, Q1 q12) {
        if (A0k(c2364Qd, q12) || A0j(qw, c2364Qd, q12)) {
            return;
        }
        q12.A02();
        q12.A01 = this.A0C ? c2364Qd.A03() - 1 : 0;
    }
    ...
    private boolean A0j(QW qw, C2364Qd c2364Qd, Q1 q12) {
        View viewA0P;
        int iA0A;
        if (A0Y() == 0) {
            return false;
        ...
        View viewA0u = A0u();
        if (viewA0u != null && q12.A06(viewA0u, c2364Qd)) {
            q12.A05(viewA0u);
            return true;
        }
        ...
        if (q12.A02) {
            viewA0P = A0O(qw, c2364Qd);
        } else {
            viewA0P = A0P(qw, c2364Qd);
        }
        if (viewA0P == null) {
            return false;
        }
    ...
    */
    private boolean A0k(com.facebook.ads.redexgen.core.C2364Qd r9, com.facebook.ads.redexgen.core.Q1 r10) {
        /*
            Method dump skipped, instruction units count: 347
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C3000gI.A0k(com.facebook.ads.redexgen.X.Qd, com.facebook.ads.redexgen.X.Q1):boolean");
    }

    @Override // com.facebook.ads.redexgen.core.QO
    public int A1f(int i10, QW qw, C2364Qd c2364Qd) {
        if (this.A00 == 1) {
            return 0;
        }
        return A04(i10, qw, c2364Qd);
    }

    @Override // com.facebook.ads.redexgen.core.QO
    public int A1g(int i10, QW qw, C2364Qd c2364Qd) {
        if (this.A00 == 0) {
            return 0;
        }
        return A04(i10, qw, c2364Qd);
    ...
    @Override // com.facebook.ads.redexgen.core.QO
    public final int A1h(C2364Qd c2364Qd) {
        return A08(c2364Qd);
    }

    @Override // com.facebook.ads.redexgen.core.QO
    public final int A1i(C2364Qd c2364Qd) {
        return A0A(c2364Qd);
    }

    @Override // com.facebook.ads.redexgen.core.QO
    public final int A1j(C2364Qd c2364Qd) {
        return A0B(c2364Qd);
    }

    @Override // com.facebook.ads.redexgen.core.QO
    public final int A1k(C2364Qd c2364Qd) {
        return A08(c2364Qd);
    }

    @Override // com.facebook.ads.redexgen.core.QO
    public final int A1l(C2364Qd c2364Qd) {
        return A0A(c2364Qd);
    }

    @Override // com.facebook.ads.redexgen.core.QO
    public final int A1m(C2364Qd c2364Qd) {
        return A0B(c2364Qd);
    }
    ...
    @Override // com.facebook.ads.redexgen.core.QO
    public View A1p(View view, int i10, QW qw, C2364Qd c2364Qd) {
        int maxScroll;
        View nextFocus;
        View viewA0F;
        A0U();
        ...
        A0Y(maxScroll, (int) (layoutDir * 0.33333334f), false, c2364Qd);
        this.A07.A07 = Integer.MIN_VALUE;
        this.A07.A0B = false;
        A07(qw, this.A07, c2364Qd, true);
        if (maxScroll == -1) {
            nextFocus = A0N(qw, c2364Qd);
        } else {
            nextFocus = A0M(qw, c2364Qd);
        }
        if (maxScroll == -1) {
            viewA0F = A0G();
        } else {
    ...
    @Override // com.facebook.ads.redexgen.core.QO
    public final void A1s(int i10, int i11, C2364Qd c2364Qd, QM qm) {
        if (this.A00 != 0) {
            i10 = i11;
        }
        int delta = A0Y();
        ...
        A0Y(i12, delta2, true, c2364Qd);
        A2G(c2364Qd, this.A07, qm);
    }

    @Override // com.facebook.ads.redexgen.core.QO
    public final void A1t(int i10, QM qm) {
        boolean z10;
        int direction;
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public void A1w(com.facebook.ads.redexgen.core.QW r10, com.facebook.ads.redexgen.core.C2364Qd r11) {
        /*
            Method dump skipped, instruction units count: 608
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C3000gI.A1w(com.facebook.ads.redexgen.X.QW, com.facebook.ads.redexgen.X.Qd):void");
    }
    ...
    @Override // com.facebook.ads.redexgen.core.QO
    public final void A1y(C18676g c18676g, QW qw) {
        super.A1y(c18676g, qw);
        if (this.A09) {
            A1K(qw);
            qw.A0P();
        }
    ...
    @Override // com.facebook.ads.redexgen.core.QO
    public void A1z(C18676g c18676g, C2364Qd c2364Qd, int i10) {
        C2999gH linearSmoothScroller = new C2999gH(c18676g.getContext());
    ...
    public View A2A(QW qw, C2364Qd c2364Qd, int i10, int i11, int i12) {
        A2B();
        View view = null;
        View view2 = null;
    ...
    public void A2E(QW qw, C2364Qd c2364Qd, Q1 q12, int i10) {
    }

    public void A2F(QW qw, C2364Qd c2364Qd, Q3 q32, Q2 q22) {
        int iA0i;
        int right;
        int iA0g;
        int iA0E;
    ...
    public void A2G(C2364Qd c2364Qd, Q3 q32, QM qm) {
        int i10 = q32.A01;
        if (i10 >= 0) {
            int pos = c2364Qd.A03();
            if (i10 < pos) {
                int pos2 = q32.A07;
                qm.A3u(i10, Math.max(0, pos2));
            }
        }
    }
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2361Qa
