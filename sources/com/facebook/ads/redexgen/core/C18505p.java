...
public final class C18505p extends KL {
    ...
    public static final int A02 = (int) (AbstractC2523Wl.A02 * 152.0f);
    public static final int A01 = (int) (AbstractC2523Wl.A02 * 60.0f);

    public C18505p(C2820dL c2820dL, KE ke2, int i10, boolean z10, C2283My c2283My, String str, US us, InterfaceC2551Xn interfaceC2551Xn, C2893eX c2893eX, XH xh2, AbstractC3095hy abstractC3095hy, C2023Cw c2023Cw, C2463Ua c2463Ua, boolean z11) {
        super(c2820dL, ke2, i10, z10, c2283My, false, str, us, interfaceC2551Xn, c2893eX, xh2, abstractC3095hy, c2023Cw, c2463Ua, z11);
    ...
    private void A01(int i10) {
        if (i10 == 1) {
            ...
            this.A0O.addView(((AbstractC2611Zv) this).A08);
            ...
            this.A0L.addView(((AbstractC2611Zv) this).A08);
            this.A0N.addView(this.A0L);
            this.A0N.addView(((AbstractC2611Zv) this).A09);
    ...
    private void A05(int i10) {
        ...
        if (i10 == 1) {
            ...
            ((AbstractC2611Zv) this).A08.setMinWidth(-1);
        } else {
            ...
            ((AbstractC2611Zv) this).A08.setMinWidth((int) (getResources().getDisplayMetrics().widthPixels * 0.12f));
        }
        layoutParams.addRule(14);
        ((AbstractC2611Zv) this).A08.setLayoutParams(layoutParams);
        ((AbstractC2611Zv) this).A08.setPadding(KL.A0s, 0, KL.A0s, 0);
        A0k();
    }
    ...
    private void A06(int i10) {
        ...
        if (i10 == 1) {
            layoutParams.addRule(2, ((AbstractC2611Zv) this).A08.getId());
    ...
    private void A07(int i10) {
        ...
        if (i10 != 1) {
            ...
            layoutParams.addRule(12);
            layoutParams.addRule(7, ((AbstractC2611Zv) this).A08.getId());
            layoutParams.setMargins(0, 0, 0, KL.A0l);
        }
    ...
    private void A09(int i10) {
        int topMargin;
        RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) ((AbstractC2611Zv) this).A09.getLayoutParams();
        if (i10 == 1) {
        ...
        if (!this.A0X) {
            ((AbstractC2611Zv) this).A09.setRadius(topMargin);
        }
        ((AbstractC2611Zv) this).A09.setLayoutParams(layoutParams);
    }
    ...
    private void A0C(int i10) {
        ...
        if (i10 == 1) {
            ...
            i11 = 4;
            layoutParams.addRule(14);
            layoutParams.addRule(3, ((AbstractC2611Zv) this).A09.getId());
            int i12 = KL.A0r;
            int i13 = KL.A0l;
            ...
            i11 = 5;
            layoutParams.addRule(15);
            layoutParams.addRule(1, ((AbstractC2611Zv) this).A09.getId());
    ...
    @Override // com.facebook.ads.redexgen.core.KL, com.facebook.ads.redexgen.core.AbstractC2611Zv
    public final void A0h(int i10) {
        super.A0h(i10);
        XP.A0Z(this.A0N, this.A0L, ((AbstractC2611Zv) this).A09, this.A0Q, ((AbstractC2611Zv) this).A08, this.A0U, ((KL) this).A04, this.A0P, this.A0I, this.A0K, this.A0J);
        A03(i10);
        A04(i10);
        A07(i10);
        A0A(i10);
    ...
    public final void A0s(ViewGroup viewGroup, RelativeLayout relativeLayout, int i10) {
        if (i10 == 1) {
            ...
            ((AbstractC2611Zv) this).A09.setLayoutParams(layoutParams);
            viewGroup.addView(((AbstractC2611Zv) this).A09);
