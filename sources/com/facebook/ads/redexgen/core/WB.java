...
public final class WB {
    ...
    public static final Set<C2820dL> A06;
    ...
    public static void A08() {
        A00 = new byte[]{89, 54, 51, 57, 32, 40, 54, 51, 40, 56, 53, 61, 40, 62, 51, 40, 60, 50, 46, 57, 86, 83, 89, SignedBytes.MAX_POWER_OF_TWO, 72, 88, 69, 94, 80, 94, 89, 86, 91, 72, 82, 79, 67, 69, 86, 68, Ascii.NAK, 122, Ascii.DEL, 117, 108, 100, 104, 122, 109, 126, Ascii.DEL, 100, 104, 111, 122, 111, 126, 100, Ascii.DEL, 122, 111, 122, 75, 121, 110, 125, 124, 56, 107, 108, 121, 108, 125, 56, 122, 109, 118, 124, 116, 125, 56, 113, 107, 56, 125, 117, 104, 108, 97, 57, Ascii.ETB, Ascii.NAK, 2, 41, 3, 2, Ascii.US, Ascii.SUB, Ascii.SUB, Ascii.NAK, 36, Ascii.CAN, Ascii.ETB, Ascii.DC2, Ascii.RS, Ascii.NAK, Ascii.SI, 36, Ascii.SI, Ascii.DC4, Ascii.DLE, Ascii.RS, Ascii.NAK, 100, 104, 106, 41, 97, 102, 100, 98, 101, 104, 104, 108, 41, 102, 99, 116, 41, 110, 105, 115, 98, 117, 105, 102, 107, 41, 110, 119, 100, 41, 70, 114, 99, 110, 98, 105, 100, 98, 73, 98, 115, 112, 104, 117, 108, 85, 98, 106, 104, 115, 98, 70, 100, 115, 110, 113, 110, 115, 126, 109, 100, 107, 97, 105, 96, 80, 119, 108, 67, 106, 119, 87, 96, 118, 112, 105, 113, Ascii.SI, 8, Ascii.GS, Ascii.SO, 8, 61, Ascii.US, 8, Ascii.NAK, 10, Ascii.NAK, 8, 5, 3, 4, 17, 2, 4, 49, 19, 4, Ascii.EM, 6, Ascii.EM, 4, 9, 54, Ascii.US, 2, 34, Ascii.NAK, 3, 5, Ascii.FS, 4};
    }
    ...
    public static int A00(C2820dL c2820dL, Intent intent) throws W9 {
        Intent intentA01 = A01(intent);
        int usedContext = 0;
        try {
            Activity activityA00 = ActivityUtils.A00();
            if (activityA00 == null) {
                activityA00 = c2820dL.A0E();
                usedContext = 1;
            }
            if (activityA00 != null) {
            ...
            c2820dL.startActivity(intentA01);
            return 2;
    ...
    public static C2820dL A04(Intent intent) {
        String stringExtra = intent.getStringExtra(A03);
        if (stringExtra != null) {
            for (C2820dL c2820dL : A06) {
                String adId = c2820dL.A0F().getId();
    ...
    public static AdActivityIntent A05(C2820dL c2820dL) {
        AdActivityIntent adActivityIntent = new AdActivityIntent(c2820dL.getApplicationContext(), A06());
        adActivityIntent.putExtra(A03, c2820dL.A0F().getId());
        A06.add(c2820dL);
    ...
    public static void A0B(C2820dL c2820dL, AdActivityIntent adActivityIntent) throws W9 {
        Context launchContext;
        Context applicationContext = c2820dL.getApplicationContext();
        if (U7.A2V(c2820dL) && (launchContext = c2820dL.A0E()) != null) {
        ...
        try {
            if (ProcessUtils.isRemoteRenderingProcess()) {
                if (!A0I(c2820dL, adActivityIntent)) {
                    c2820dL.A0F().AHS();
                    return;
                }
                return;
    ...
    public static boolean A0D(C2820dL c2820dL, Intent intent) throws W9 {
        A07.get();
        return A0F(c2820dL, intent, null);
    }

    public static boolean A0E(C2820dL c2820dL, Intent intent) throws W9 {
        A07.get();
        if (0 != 0) {
            ...
            if (activityA0E != null) {
                ...
                try {
                    ...
                    c2820dL.A08().AAy(A07(90, 8, 57), AbstractC2433Sv.A07, new C2434Sw(e11));
                    return false;
                }
            }
        }
    ...
    public static boolean A0F(C2820dL c2820dL, Intent intent, WK wk) throws W9 {
        if (A0C(intent, U7.A0Z(c2820dL))) {
            return false;
        }
        Context context = c2820dL;
        if (A01[1].charAt(5) != 'g') {
            A01[2] = "mGLT8eS8inmCxtBfGXr0XCfYNSNKmj30";
            Context startContext = c2820dL.A0E();
            if (startContext != null) {
                context = startContext;
            } else {
                intent.addFlags(268435456);
            }
            if (wk != null && !A0C(intent, U7.A0b(c2820dL))) {
                c2820dL.A0C();
                try {
                    ...
                    c2820dL.A08().AAy(A07(90, 8, 57), AbstractC2433Sv.A08, new C2434Sw(e11));
                    return false;
                }
            }
            try {
    ...
    public static boolean A0G(C2820dL c2820dL, Uri uri, String str) throws ActivityNotFoundException {
        A08.get();
        return A0H(c2820dL, uri, str, null);
    }

    public static boolean A0H(C2820dL c2820dL, Uri uri, String str, WM wm) throws ActivityNotFoundException {
        if (wm == null || c2820dL.A0E() == null) {
            return false;
        }
    ...
    public static boolean A0I(C2820dL c2820dL, AdActivityIntent adActivityIntent) throws W9 {
        Intent intentA01 = A01(adActivityIntent);
        try {
            Activity currentActivity = ActivityUtils.A00();
            if (currentActivity == null) {
                currentActivity = c2820dL.A0E();
            }
            if (currentActivity == null) {
                return false;
            }
