...
public final class C18385d extends AbstractC2204Jw {
    ...
    public C2820dL A03;
    public C2517Wd A04;
    public AbstractC2550Xm A05;
    public AbstractC2550Xm A06;
    public AbstractC2654ae A07;
    public C2804d4 A08;
    public C2810dA A09;
    public CU A0A;
    public boolean A0B;
    ...
    public final InterfaceC2551Xn A0F;
    public final InterfaceC2631aH A0G;
    public final C2632aI A0H;
    public final C2658ai A0I;
    public final E1 A0J;
    public final C2023Cw A0K;
    ...
    public static void A0C() {
        A0L = new byte[]{-23, -117, 1, -6, Ascii.SI, -2, Ascii.CAN, Ascii.FF, 13, -6, Ascii.VT, 13, 2, 7, 0, Ascii.CAN, -6, 7, 2, 6, -6, 13, 2, 8, 7, Ascii.FF, Ascii.CAN, 9, 5, -6, Ascii.DC2, -2, -3, Ascii.SUB, Ascii.GS, 33, 19, 45, 32, 19, 37, Ascii.SI, 32, Ascii.DC2, 45, 33, 17, 32, 19, 19, Ascii.FS, 45, 33, Ascii.SYN, Ascii.GS, 37, Ascii.FS, -7, -29, -11, 1, -25, -16, -26, 1, -27, -29, -12, -26, 1, -11, -22, -15, -7, -16, -17, -19, -33, -20, -35, -26, -29, -35, -27};
    }

    static {
        A0C();
        A0Q = (int) (AbstractC2523Wl.A02 * 16.0f);
        A0b = (int) (AbstractC2523Wl.A02 * 12.0f);
        A0N = (int) (AbstractC2523Wl.A02 * 8.0f);
        A0O = (int) (AbstractC2523Wl.A02 * 10.0f);
        A0W = (int) (AbstractC2523Wl.A02 * 20.0f);
        A0X = (int) (AbstractC2523Wl.A02 * 13.0f);
        A0R = (int) (AbstractC2523Wl.A02 * 48.0f);
        A0a = (int) (AbstractC2523Wl.A02 * 14.0f);
        A0Y = (int) (AbstractC2523Wl.A02 * 12.0f);
        A0P = (int) (AbstractC2523Wl.A02 * 8.0f);
        A0Z = OP.A02(-1, 77);
        A0V = (int) (AbstractC2523Wl.A02 * 16.0f);
        A0c = (int) (AbstractC2523Wl.A02 * 12.0f);
        A0S = (int) (AbstractC2523Wl.A02 * 12.0f);
        A0T = (int) (AbstractC2523Wl.A02 * 16.0f);
        A0U = (int) (AbstractC2523Wl.A02 * 48.0f);
    }

    public C18385d(C2658ai c2658ai) {
        super(c2658ai, false);
        this.A0D = new Handler(Looper.getMainLooper());
        this.A0E = new Handler(Looper.getMainLooper());
        this.A0C = false;
        this.A0B = false;
        this.A03 = c2658ai.A06();
        this.A06 = c2658ai.A0C();
        this.A05 = c2658ai.A0B();
        this.A0I = c2658ai;
        ...
        A09();
        this.A0F = c2658ai.A0D();
        AbstractC2641aR.A00(c2658ai.A06(), this, getAdInfo().A0H().A08());
        this.A0J = A01(c2658ai);
        XP.A0I(this.A0J);
        getAdDetailsView().bringToFront();
        if (!A03()) {
            this.A0K = A02(c2658ai);
        } else {
            this.A0K = null;
        }
        ...
        A1R();
        this.A08 = new C2804d4(this.A03, c2658ai.A07(), getAdDataBundle());
        this.A0G = new C2200Js(this);
        this.A0H = new C2632aI(c2658ai, getAdDataBundle(), this.A0J, this.A0K, getAdDetailsView(), this.A0F, this.A0G);
        C2518Wg c2518WgA02 = super.A09.A02(getAdDataBundle());
        this.A03.A0H().A00(c2518WgA02.A01);
        getCtaButton().setCreativeAsCtaLoggingHelper(super.A09);
        if (c2518WgA02.A00) {
            this.A0J.getVideoImplView().setOnClickListener(new ViewOnClickListenerC2661al(this));
        } else if (U7.A1K(getAdContextWrapper())) {
            AbstractC2608Zs.A00(this.A0J.getVideoImplView(), U7.A1L(getAdContextWrapper()), new ViewOnClickListenerC2662am(this));
        }
        if (c2658ai.A05().A1f()) {
            if (this.A0I.A05().A1i()) {
                this.A07 = new JR(c2658ai);
            } else {
                this.A07 = new JS(c2658ai);
            }
            View view = this.A07;
    ...
    private E1 A01(C2658ai c2658ai) {
        RelativeLayout.LayoutParams layoutParams;
        E1 e12 = (E1) c2658ai.A02();
        int iA1O = A1O(c2658ai.A0C());
        this.A02 = (ImageView) c2658ai.A03();
        if (!A03()) {
            ImageView imageView = this.A02;
            int i10 = AbstractC2204Jw.A0M;
            int i11 = AbstractC2204Jw.A0M;
            int toolbarHeight = AbstractC2204Jw.A0M;
            imageView.setPadding(i10, i11, toolbarHeight, AbstractC2204Jw.A0M);
            int toolbarHeight2 = AbstractC2204Jw.A0N;
            layoutParams = new RelativeLayout.LayoutParams(toolbarHeight2, AbstractC2204Jw.A0N);
            int toolbarHeight3 = AbstractC2204Jw.A0L;
            layoutParams.setMargins(0, iA1O, toolbarHeight3, 0);
            layoutParams.addRule(11);
        } else {
            int toolbarHeight4 = AbstractC2654ae.A0J;
            layoutParams = new RelativeLayout.LayoutParams(toolbarHeight4, AbstractC2654ae.A0J);
            int i12 = A0T;
            int i13 = A0U;
    ...
    private C2023Cw A02(C2658ai c2658ai) {
        C2023Cw c2023CwA0F = c2658ai.A0F();
        c2023CwA0F.A08(-1, AbstractC2204Jw.A0E, false);
        c2023CwA0F.setPadding(AbstractC2204Jw.A0Q, AbstractC2204Jw.A0Q, AbstractC2204Jw.A0Q, AbstractC2204Jw.A0Q);
        RelativeLayout.LayoutParams progressBarLayoutParams = new RelativeLayout.LayoutParams(-1, AbstractC2204Jw.A0P);
        progressBarLayoutParams.addRule(12);
        addView(c2023CwA0F, progressBarLayoutParams);
        return c2023CwA0F;
    }
    ...
    private void A05() {
        addView(new C2670au(this.A0I.A06(), getAdDataBundle(), this.A0I.A08(), this.A0E, this.A0I.A0D()).A09(getCtaButton()));
    }

    private void A06() {
        XP.A0Z(this.A02, getCtaButton(), getAdDetailsView(), this.A01, this.A0H, this.A0I.A0C());
        for (InterfaceC2837dc interfaceC2837dc : this.A0J.getPlugins()) {
            if (interfaceC2837dc instanceof C2R) {
                this.A0J.A0j(interfaceC2837dc);
                return;
            }
        }
    }
    ...
    private void A0A() {
        new C2463Ua(getAdDataBundle().A25(), getAdEventManager()).A04(UZ.A0z, null);
        if (!getAdInfo().A0V()) {
            return;
        }
        super.A0A.set(true);
        ...
        XP.A0J(this.A06);
        Pair<EnumC2803d3, View> pairA03 = this.A08.A03(getCtaButton());
        this.A00 = (View) pairA03.second;
        A0E((EnumC2803d3) pairA03.first);
        if (getAdInfo().A0K().A00() >= 0) {
            ...
            this.A04 = new C2517Wd((int) getAdInfo().A0K().A00(), 20.0f, 20L, new Handler(Looper.getMainLooper()), new C2198Jq(this));
            this.A04.A07();
        }
    }
    ...
    private void A0D(RelativeLayout relativeLayout) {
        ...
        XP.A0K(c2634aK, 0);
        XP.A0I(c2634aK);
        new KZ(c2634aK, this.A03).A05(A0R, A0R).A07(getAdDataBundle().A23().A01());
        ...
        C2636aM c2636aM = new C2636aM(c2820dL, i10, 5, A0Z, -1);
        ...
        linearLayout.addView(c2636aM, ratingCountParams);
        ...
        iconParams.addRule(1, c2634aK.getId());
        ...
        c2636aM.setRating(Float.parseFloat(getAdDataBundle().A20().A0I().A0B()));
        ...
        if (!getAdDataBundle().A1j()) {
            ...
            formattingRatingCount = AbstractC2532Wu.A01(Integer.parseInt(getAdDataBundle().A20().A0I().A08()));
        }
    ...
    private void A0E(EnumC2803d3 enumC2803d3) {
        if (!getAdDataBundle().A20().A0K().A02().isEmpty()) {
            if (getAdDataBundle().A20().A0K().A03()) {
                this.A09 = new C2810dA(this.A03, getAdDataBundle(), this.A0F, getCtaButton(), this.A0E, this.A0I.A08());
    ...
    private void A0F(EnumC2803d3 enumC2803d3) {
        this.A0J.A0k(false);
        this.A0J.setVisibility(8);
        if (this.A06 instanceof C2302Nr) {
            AbstractC2550Xm abstractC2550Xm = this.A05;
        ...
        switch (enumC2803d3) {
            case A03:
                AbstractC2611Zv oldEndCardAdDetailsView = getOldEndCardAdDetailsView();
                if (A0M[4].charAt(31) != 'A') {
                    A0M[2] = "XFfDcp5VJF8GQaNSTNs87nOmJmOzmbPV";
                    if (oldEndCardAdDetailsView == null) {
                        AbstractC2611Zv oldEndCard = getAdDetailsView();
                    ...
                    if (oldEndCardAdDetailsView != null) {
                        ...
                        AbstractC2611Zv oldEndCard2 = getAdDetailsView();
            ...
            case A02:
                ...
                RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-1, -1);
                layoutParams.setMargins(AbstractC2204Jw.A0O, AbstractC2204Jw.A0O, AbstractC2204Jw.A0O, AbstractC2204Jw.A0O);
    ...
    public final void A1H(C17863d c17863d) {
        super.A1H(c17863d);
        if (A03()) {
            AbstractC2611Zv adDetailsView = getAdDetailsView();
            if (A0M[0].length() == 5) {
                throw new RuntimeException();
            }
    ...
    public final void A1I(DO r10) {
        ...
        if (A03()) {
            this.A03.A0F().AJw(AbstractC2514Wa.A00((float) this.A0I.A05().A0h()), getResources().getConfiguration().orientation, true, false, MH.A0C(this.A0I.A04()));
        }
    ...
    public final AbstractC2611Zv A1P(C2658ai c2658ai, C2274Mp c2274Mp, String str) {
        double dA0h = c2658ai.A05().A0h();
        if (A03()) {
            if (E1.A0T((float) dA0h)) {
                return new C18515q(c2658ai.A06(), getCtaButton(), AbstractC2204Jw.A0I, false, getColors(), str, c2658ai.A07(), c2658ai.A0D(), c2658ai.A0G(), c2658ai.A0A(), c2658ai.A05(), c2658ai.A0F(), c2658ai.A08(), false);
            }
            if (E1.A0V((float) dA0h)) {
                return new C18505p(c2658ai.A06(), getCtaButton(), AbstractC2204Jw.A0I, false, getColors(), str, c2658ai.A07(), c2658ai.A0D(), c2658ai.A0G(), c2658ai.A0A(), c2658ai.A05(), c2658ai.A0F(), c2658ai.A08(), false);
            }
            return new C18525r(c2658ai.A06(), getCtaButton(), AbstractC2204Jw.A0I, false, getColors(), str, c2658ai.A07(), c2658ai.A0D(), c2658ai.A0G(), c2658ai.A0A(), c2658ai.A05(), c2658ai.A0F(), c2658ai.A08(), false);
        }
        return new C2206Jy(c2658ai.A06(), getCtaButton(), AbstractC2204Jw.A0J, c2274Mp.A0I().A00() == EnumC2279Mu.A05, getColors(), c2274Mp.A0J().A06(), str, c2658ai.A07(), c2658ai.A0D(), c2658ai.A0G(), c2658ai.A0A(), c2658ai.A05());
    }

    @Override // com.facebook.ads.redexgen.core.AbstractC2204Jw
    public final C2206Jy A1Q(C2658ai c2658ai, C2274Mp c2274Mp, String str) {
        return new C2206Jy(c2658ai.A06(), getCtaButton(), AbstractC2204Jw.A0J, c2274Mp.A0I().A00() == EnumC2279Mu.A05, getColors(), c2274Mp.A0J().A06(), str, c2658ai.A07(), c2658ai.A0D(), c2658ai.A0G(), c2658ai.A0A(), c2658ai.A05());
    }
    ...
    public final void A1Y() {
        new C2463Ua(this.A0I.A05().A25(), getAdEventManager()).A04(UZ.A0h, null);
        if (this.A0I.A0C() != null) {
            AbstractC2550Xm abstractC2550XmA0C = this.A0I.A0C();
            if (A0M[4].charAt(31) == 'A') {
                throw new RuntimeException();
            }
            A0M[2] = "qVUXWES3bTCAG5k5pbCpCu4g17099rEp";
            abstractC2550XmA0C.setVisibility(8);
    ...
    public final void A1a(C17913i c17913i) {
        if (this.A07 != null) {
            if (this.A07 instanceof JR) {
                ((JR) this.A07).A1O(c17913i);
            }
            if (this.A07 instanceof JS) {
                ((JS) this.A07).A1O(c17913i);
            }
            this.A07.A1B();
            AbstractC2654ae abstractC2654ae = this.A07;
            String[] strArr = A0M;
            if (strArr[3].charAt(21) == strArr[6].charAt(21)) {
                throw new RuntimeException();
            }
    ...
    @Override // com.facebook.ads.redexgen.core.AbstractC2204Jw, com.facebook.ads.redexgen.core.AbstractC2654ae, android.view.View
    public final void onConfigurationChanged(Configuration configuration) {
        ...
        if (this.A07 != null) {
            ...
            if (abstractC2654ae.getVisibility() == 0) {
                getAdDetailsView().setVisibility(8);
                return;
            }
        }
    ...
    public void setVideoAdViewListener(InterfaceC2778ce interfaceC2778ce) {
        if (this.A07 instanceof JR) {
            ((JR) this.A07).setVideoAdViewListener(interfaceC2778ce);
        }
        if (this.A07 instanceof JS) {
            ((JS) this.A07).setVideoAdViewListener(interfaceC2778ce);
        }
    }
}
