...
public final class FV {
    ...
    public static FT A01(Context context) {
        C3294lW c3294lWA01 = null;
        if (context == null) {
            return null;
        }
        Context applicationContext = context.getApplicationContext();
        if (AbstractC18094a.A02 >= 17) {
            c3294lWA01 = C3294lW.A01(applicationContext);
        }
        if (c3294lWA01 == null) {
            return C3295lX.A00(applicationContext);
        }
        return c3294lWA01;
    }

    private void A03() {
        if (AbstractC18094a.A02 < 30 || this.A0C == null || this.A04 == Integer.MIN_VALUE || this.A03 == 0.0f) {
            return;
        }
        this.A03 = 0.0f;
    ...
    */
    ...
    private void A09(boolean z10) {
        if (AbstractC18094a.A02 < 30 || this.A0C == null || this.A04 == Integer.MIN_VALUE) {
            return;
        }
        float f10 = 0.0f;
