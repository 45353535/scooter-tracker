...
public final class WR {
    ...
    public static int A00(C2820dL c2820dL, int i10) {
        return AbstractC2492Ve.A00(c2820dL).getInt(A01(0, 21, 52), i10);
    }

    public static String A02(C2820dL c2820dL, String str) {
        int iA00 = A00(c2820dL, -1);
        if (iA00 == -1) {
            return null;
        }
        try {
    ...
    public final InterstitialAd A06(C2820dL c2820dL, String str, String str2) {
        if (c2820dL == null) {
            return null;
        }
        try {
            InterstitialAd interstitialAd = new InterstitialAd(c2820dL, str);
    ...
    public final RewardedVideoAd A07(C2820dL c2820dL, String str, String str2) {
        if (c2820dL == null) {
            return null;
        }
        try {
            RewardedVideoAd rewardedVideoAd = new RewardedVideoAd(c2820dL, str);
    ...
    public final void A08(C2820dL c2820dL, boolean z10) {
        int i10 = 0;
        String strA01 = A01(0, 21, 52);
        if (!z10) {
            int lastNonChainedAds = AbstractC2492Ve.A00(c2820dL).getInt(strA01, 0);
            i10 = lastNonChainedAds + 1;
        }
        AbstractC2492Ve.A00(c2820dL).edit().putInt(strA01, i10).apply();
    }

    public final boolean A09(C2820dL c2820dL, String str, int i10) {
        if (i10 <= 0) {
            return false;
        }
        try {
            if (!A05(str)) {
                int lastNonChainedAds = A00(c2820dL, i10 - 1);
