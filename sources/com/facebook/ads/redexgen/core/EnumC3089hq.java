...
public final class EnumC3089hq {
    ...
    public static final /* synthetic */ EnumC3089hq[] A03;
    public static final EnumC3089hq A04;
    public static final EnumC3089hq A05;
    ...
    public static final /* synthetic */ EnumC3089hq[] A02() {
        EnumC3089hq[] enumC3089hqArr = new EnumC3089hq[2];
        EnumC3089hq enumC3089hq = A04;
        String[] strArr = A01;
        if (strArr[5].charAt(11) == strArr[7].charAt(11)) {
            throw new RuntimeException();
        }
        A01[4] = "Fkm6UCeGNRQRi4wWDBIOpvvd9TujRbQP";
        enumC3089hqArr[0] = enumC3089hq;
        enumC3089hqArr[1] = A05;
        return enumC3089hqArr;
    }

    static {
        A01();
        A04 = new EnumC3089hq(A00(0, 11, 97), 0);
        A05 = new EnumC3089hq(A00(11, 8, 38), 1);
        A03 = A02();
        A02 = AbstractC3513pB.A01(A03);
    }

    public EnumC3089hq(String str, int i10) {
    }

    public static EnumC3089hq valueOf(String str) {
        return (EnumC3089hq) Enum.valueOf(EnumC3089hq.class, str);
    }

    public static EnumC3089hq[] values() {
        return (EnumC3089hq[]) A03.clone();
    }
}
