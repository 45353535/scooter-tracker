...
public final class C2948fR {
    ...
    public final InterfaceC2396Rj A00;
    public final SF A01;
    ...
    public static void A02() {
        A02 = new byte[]{81, 115, 100, 109, 110, 96, 101, 104, 111, 102, 33, 36, 101, 33, 96, 114, 114, 100, 117, 114, 60, Ascii.RS, 9, 0, 3, 13, 8, 5, 2, Ascii.VT, 76, 5, 1, 13, Ascii.VT, 9, 86, 76, 73, Ascii.US, 118, 84, 67, 74, 73, 71, 66, 79, 72, 65, 6, 75, 71, 84, 77, 83, 86, Ascii.FS, 6, 3, 85, 86, 116, 99, 106, 105, 103, 98, 111, 104, 97, 38, 112, 111, 98, 99, 105, 60, 38, 35, 117, 50, 101, 48, 48, 96, 97, 98, 98, 123, 52, 110, 101, 100, 123, 103, 103, 51, 111, 123, 55, 100, 55, 101, 123, 100, 55, 100, 55, 51, 100, 50, 52, 53, 53, 51, 98, 55, 53, 34, 33, 34, 51, 36, 47, 106, 113, 116, 113, 112, 104, 113};
    }

    static {
        A02();
        A04 = C2948fR.class.getSimpleName();
    }

    public C2948fR(InterfaceC2396Rj interfaceC2396Rj, C2794cu c2794cu) {
        this.A00 = interfaceC2396Rj;
        this.A00.A3s(new C2950fT(this));
        this.A01 = new SF(c2794cu);
        A01();
    }
    ...
    public void A01() {
        if (BuildConfigApi.isDebug()) {
            ...
            InterfaceC2396Rj interfaceC2396Rj = this.A00;
            if (A03[2].charAt(7) != 'V') {
            ...
            String.format(locale, A00(0, 20, 44), Integer.valueOf(interfaceC2396Rj.A6p().size()));
        }
        for (InterfaceC2399Rm interfaceC2399Rm : this.A00.A6p()) {
            switch (C2395Ri.A00[interfaceC2399Rm.A9G().ordinal()]) {
                case 1:
                    A04(interfaceC2399Rm.getUrl());
                    break;
                case 2:
                    A06(interfaceC2399Rm.getUrl());
                    break;
                case 3:
                    A05(interfaceC2399Rm.getUrl());
                    break;
            }
        }
        this.A01.A0X(new C2949fS(this), new S8(A00(81, 36, 123), A00(125, 7, 50)));
    }
