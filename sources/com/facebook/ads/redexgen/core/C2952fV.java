...
public class C2952fV extends AbstractRunnableC2507Vt {
    ...
    public final /* synthetic */ C2392Rf A00;
    ...
    public C2952fV(C2392Rf c2392Rf) {
        this.A00 = c2392Rf;
    }
    ...
    public final void A07() {
        try {
            ...
            for (int i10 = 0; i10 < jSONArray.length(); i10++) {
                C2390Rd assetData = C2390Rd.A00(jSONArray.getJSONObject(i10));
                this.A00.A09(assetData.A04, assetData);
            }
            this.A00.A02.A0X(new C2954fX(this), new S8(this.A00.A04, this.A00.A03));
        } catch (JSONException unused) {
            this.A00.A00.post(new C2953fW(this));
        }
    }
}
