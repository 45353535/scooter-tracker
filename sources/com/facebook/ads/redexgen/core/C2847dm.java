...
public class C2847dm extends AbstractRunnableC2507Vt {
    ...
    public C2847dm(SF sf2, ArrayList arrayList, S8 s82, S7 s72, ArrayList arrayList2) {
        this.A02 = sf2;
        this.A03 = arrayList;
        this.A01 = s82;
        this.A00 = s72;
    ...
    public final void A07() {
        ...
        if (this.A02.A04 instanceof C2820dL) {
            C2820dL c2820dL = (C2820dL) this.A02.A04;
            if (this.A01.A00 == -1) {
                ...
                if (strArr[6].length() == strArr[7].length()) {
                    ...
                    if (z10) {
                        c2820dL.A0F().A4h(XG.A01(this.A02.A00));
                    } else {
                        c2820dL.A0F().A4f(XG.A01(this.A02.A00));
                    }
                }
            ...
            c2820dL.A0F().A4g(XG.A01(this.A02.A00), this.A01.A00);
        }
        this.A02.A02.post(new C2848dn(this, atomicBooleanA0D));
        SF.A0D(this.A04);
    }
}
