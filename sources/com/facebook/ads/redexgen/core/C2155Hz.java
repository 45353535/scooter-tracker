...
public final class C2155Hz {
     ...
     */
    public static C2155Hz A02(C4J c4j) {
        long jA0Q = c4j.A0Q();
        ...
        if (!z10) {
            ...
            if (!z12) {
                ...
                for (int i10 = 0; i10 < iA0I4; i10++) {
                    arrayList.add(new C2154Hy(c4j.A0I(), c4j.A0Q(), null));
                }
                if (A0B[3].charAt(19) == '7') {
        ...
        return new C2155Hz(jA0Q, z10, z11, z12, arrayList, jA0Q, z13, jA0Q2, iA0M, iA0I, iA0I2);
    }

    public C2155Hz(long j10, boolean z10, boolean z11, boolean z12, List<C2154Hy> list, long j11, boolean z13, long j12, int i10, int i11, int i12) {
        this.A04 = j10;
        this.A0A = z10;
        this.A08 = z11;
        this.A09 = z12;
    ...
    public C2155Hz(Parcel parcel) {
        ...
        for (int i11 = 0; i11 < i10; i11++) {
            arrayList.add(C2154Hy.A00(parcel));
        }
    ...
    public static C2155Hz A00(Parcel parcel) {
        return new C2155Hz(parcel);
    }
