...
public final class C2566Yc extends RelativeLayout {
    public final int A00;
    public final int A01;
    public final O2 A02;
    public final C2820dL A03;
    public final InterfaceC2569Yf A04;
    public final boolean A05;
    public static final int A09 = (int) (AbstractC2523Wl.A02 * 16.0f);
    public static final int A0A = (int) (AbstractC2523Wl.A02 * 8.0f);
    public static final int A0D = (int) (AbstractC2523Wl.A02 * 44.0f);
    public static final int A08 = (int) (AbstractC2523Wl.A02 * 10.0f);
    public static final int A07 = A09 - A08;
    public static final int A0E = (int) (AbstractC2523Wl.A02 * 75.0f);
    public static final int A0B = (int) (AbstractC2523Wl.A02 * 25.0f);
    public static final int A0F = (int) (AbstractC2523Wl.A02 * 45.0f);
    public static final int A0C = (int) (AbstractC2523Wl.A02 * 15.0f);
    public static final int A06 = (int) (AbstractC2523Wl.A02 * 16.0f);

    public C2566Yc(C2565Yb c2565Yb) {
        super(c2565Yb.A0C);
        this.A03 = c2565Yb.A0C;
        this.A02 = O3.A00(this.A03.A02());
        this.A04 = c2565Yb.A02;
        this.A01 = c2565Yb.A0B ? A0E : A0F;
        this.A00 = c2565Yb.A0B ? A0B : A0C;
        this.A05 = c2565Yb.A07;
        setFocusable(true);
        View viewA01 = A01(c2565Yb);
        View viewA00 = A00(c2565Yb);
        ...
        footerView.setVisibility(c2565Yb.A08 ? 0 : 8);
    }

    public /* synthetic */ C2566Yc(C2565Yb c2565Yb, YZ yz) {
        this(c2565Yb);
    }

    private View A00(C2565Yb c2565Yb) {
        ImageView imageView = new ImageView(getContext());
        imageView.setPadding(this.A00, this.A00, this.A00, this.A00);
        imageView.setImageBitmap(XY.A01(c2565Yb.A01));
        imageView.setColorFilter(-1);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(this.A01, this.A01);
        GradientDrawable gradientDrawable = new GradientDrawable();
        gradientDrawable.setShape(1);
        gradientDrawable.setColor(c2565Yb.A00);
        ...
        subtitleView.setText(c2565Yb.A06);
        ...
        if (c2565Yb.A09) {
            ...
            if (!TextUtils.isEmpty(c2565Yb.A04)) {
                ...
                new KZ(c2634aK, this.A03).A05(A0F, A0F).A07(c2565Yb.A04);
                linearLayout2.addView(c2634aK, iconParams);
            }
            C2571Yh c2571Yh = new C2571Yh(this.A03);
            c2571Yh.setData(c2565Yb.A03, XX.CHECKMARK);
            c2571Yh.setSelected(true);
            linearLayout2.addView(c2571Yh, new LinearLayout.LayoutParams(-2, -2));
            linearLayout.addView(linearLayout2);
        }
        return linearLayout;
    }

    private View A01(C2565Yb c2565Yb) {
        LinearLayout linearLayout = new LinearLayout(getContext());
    ...
    private View getFooterView() {
        ...
        linearLayout.setOrientation(0);
        linearLayout.setGravity(17);
        linearLayout.setOnClickListener(new ViewOnClickListenerC2564Ya(this));
        linearLayout.addView(imageView, layoutParams);
