...
public final class C2103Fy extends FrameLayout implements InterfaceC2552Xo {
    ...
    public int A02;
    public C2622a8 A03;
    public AbstractC2147Hr A04;
    public C2817dI A05;
    public boolean A06;
    public boolean A07;
    public boolean A08;
    public boolean A09;
    public final C3093hw A0A;
    public final R6 A0B;
    public final SF A0C;
    public final C2820dL A0D;
    public final US A0E;
    public final C2463Ua A0F;
    public final XC A0G;
    public final AbstractC2550Xm A0H;
    public final InterfaceC2551Xn A0I;
    public final YY A0J;
    public final ArrayList<C2765cR> A0K;
    ...
    static {
        ...
        A0O = (int) (AbstractC2523Wl.A02 * 48.0f);
        A0P = (int) (AbstractC2523Wl.A02 * 64.0f);
    }

    public C2103Fy(C2820dL c2820dL, YY yy, US us, C3093hw c3093hw, SF sf2, InterfaceC2551Xn interfaceC2551Xn) {
        ...
        this.A0A = c3093hw;
        this.A0C = sf2;
        this.A0I = interfaceC2551Xn;
        this.A0F = new C2463Ua(this.A0A.A1x(0).A25(), this.A0E);
        this.A0G = new XC(this);
        this.A0G.A05(XB.A02);
        this.A05 = new C2817dI(this.A0D, this.A0J, this.A0A.A1A(), interfaceC2551Xn);
        this.A0H = A05();
        if (this.A0A.A1U()) {
    ...
    */
    private int A00() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2103Fy.A00():int");
    }

    private int A01(int i10) {
        if (this.A0A.A26()) {
            C3093hw c3093hw = this.A0A;
            String[] strArr = A0M;
    ...
    public static /* synthetic */ int A02(C2103Fy c2103Fy, int i10) {
        int i11 = c2103Fy.A01 + i10;
        c2103Fy.A01 = i11;
        return i11;
    }

    private AbstractC2550Xm A05() {
        AbstractC2550Xm c2302Nr;
        if (!this.A0A.A1U()) {
            c2302Nr = new FullScreenAdToolbar(this.A0D, this.A0I, this.A0F, 2, -1, false);
        } else {
            c2302Nr = new C2302Nr(this.A0D, this.A0I, this.A0F, 2);
        }
        c2302Nr.setFullscreen(true);
        c2302Nr.setToolbarListener(new C2104Fz(this));
        return c2302Nr;
    }
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private com.facebook.ads.redexgen.core.AbstractC2147Hr A0A(boolean r33, int r34) {
        /*
            Method dump skipped, instruction units count: 476
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2103Fy.A0A(boolean, int):com.facebook.ads.redexgen.X.Hr");
    }
    ...
    private void A0D() {
        if (this.A00 > 0 && !TextUtils.isEmpty(this.A0A.A1x(this.A00 - 1).A25())) {
            ...
            C2605Zp c2605ZpA03 = new C2605Zp().A03(this.A04 != null ? this.A04.getAdViewabilityChecker() : null);
            AbstractC2147Hr abstractC2147Hr = this.A04;
            String[] strArr = A0M;
            ...
            us.AAt(strA25, c2605ZpA03.A02(abstractC2147Hr != null ? this.A04.getTouchDataRecorder() : null).A05());
        }
    }
    ...
    public void A0E() {
        if (this.A0H.getToolbarActionMode() == 8) {
            AbstractC2550Xm abstractC2550Xm = this.A0H;
            String[] strArr = A0M;
            ...
            abstractC2550Xm.setToolbarActionMode(2);
        }
        int i10 = this.A00 - 1;
        if (this.A0A.A27(i10)) {
            AbstractC3095hy abstractC3095hyA1x = this.A0A.A1x(i10);
            AbstractC2550Xm abstractC2550Xm2 = this.A0H;
            String[] strArr3 = A0M;
            ...
            abstractC2550Xm2.setProgressSpinnerInvisible(!abstractC3095hyA1x.A2J());
            abstractC3095hyA1x.A2B(false);
            abstractC3095hyA1x.A20().A0M(-1);
        }
    }
    ...
    private void A0F() {
        this.A0D.A0F().A4o();
        this.A07 = true;
        this.A03 = new C2622a8(this.A0D, this.A0A, this.A0E, this.A0I, this.A0H.getToolbarHeight(), this.A02);
        C2765cR c2765cR = null;
        Iterator<C2765cR> it = this.A0K.iterator();
        while (true) {
            if (!it.hasNext()) {
                break;
            }
            C2765cR next = it.next();
            if (next.A00 == C2765cR.A06) {
                c2765cR = next;
                break;
            }
        }
        if (c2765cR != null) {
            A0L(this.A03, c2765cR);
        } else {
    ...
    private void A0L(ViewGroup viewGroup, C2765cR c2765cR) {
        if (c2765cR.A00 == C2765cR.A06 && c2765cR.A03 != null) {
            AbstractC2641aR.A00(this.A0D, viewGroup, c2765cR.A03);
        } else {
            int i10 = c2765cR.A01;
            String[] strArr = A0M;
            if (strArr[0].length() == strArr[1].length()) {
        ...
        this.A0H.setFullscreen(c2765cR.A05);
        this.A0H.A0A(c2765cR.A02, c2765cR.A04);
    }

    private void A0M(AbstractC3095hy abstractC3095hy) {
        if (this.A0H instanceof FullScreenAdToolbar) {
            if (A0Z(abstractC3095hy) && this.A02 == 2) {
                ((FullScreenAdToolbar) this.A0H).setOnlyPageDetails(abstractC3095hy.A23());
            } else {
                ((FullScreenAdToolbar) this.A0H).setOnlyPageDetails(null);
            }
        }
    ...
    */
    public void A0U(boolean r7) {
        /*
            ...
            if (r0 != 0) goto La5
            boolean r5 = r6.A0Y()
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C2103Fy.A0M
            r0 = 0
            r1 = r2[r0]
            r0 = 1
            r0 = r2[r0]
        ...
        Lad:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2103Fy.A0U(boolean):void");
    }
    ...
    public void A0V(boolean z10, int i10) {
        ...
        if (!A0W()) {
            ...
            AbstractC3095hy abstractC3095hyA1x = this.A0A.A1x(this.A00);
            String[] strArr3 = A0M;
            if (strArr3[6].length() != strArr3[3].length()) {
                String[] strArr4 = A0M;
                strArr4[0] = "SeXhCWKDArfU2xbUHE";
                strArr4[1] = "icHjaKCGoPIgSTYVXjnx";
                boolean isLoaded = sjA01.AAD(abstractC3095hyA1x.A25(), this.A0A.A1y());
                if (!isLoaded) {
                    this.A0D.A0F().A4m();
                    A0K(2);
                    return;
                }
                AbstractC2147Hr abstractC2147HrA0A = A0A(z10, i10);
                this.A04 = abstractC2147HrA0A;
                AbstractC2147Hr abstractC2147Hr = this.A04;
                boolean isLoaded2 = this.A09;
                abstractC2147Hr.A1F(isLoaded2);
                setupToolbarForAd(abstractC2147HrA0A);
    ...
    public static boolean A0Z(AbstractC3095hy abstractC3095hy) {
    ...
    public AbstractC2147Hr getContentView() {
        return this.A04;
    }
    ...
    private void setupToolbarForAd(AbstractC2147Hr abstractC2147Hr) {
        if (this.A0H == null) {
            return;
        }
        this.A06 = true;
        ...
        if (this.A0H instanceof FullScreenAdToolbar) {
            ((FullScreenAdToolbar) this.A0H).A0D(this.A0D, abstractC3095hyA1x.A1t());
            ((FullScreenAdToolbar) this.A0H).A0C(abstractC3095hyA1x.A23(), abstractC3095hyA1x.A25(), iA01);
        } else if (this.A0H instanceof C2302Nr) {
            ((C2302Nr) this.A0H).setInitialUnskippableSeconds(iA01);
        }
        C2765cR fullScreenAdStyle = abstractC2147Hr.getFullScreenAdStyle();
        A0L(abstractC2147Hr, fullScreenAdStyle);
        this.A0K.add(fullScreenAdStyle);
        this.A0H.setToolbarActionMessage(A0B(4, 3, 90) + (this.A00 + 1) + A0B(0, 4, 21) + this.A0A.A1u());
        if (this.A08) {
            this.A0H.setToolbarActionMode(1);
        }
        A0M(abstractC3095hyA1x);
    }
}
