...
public final class C17260t extends C18967j implements Comparable<C17260t> {
    ...
    public final int compareTo(C17260t c17260t) {
        if (A05() != c17260t.A05()) {
            return A05() ? 1 : -1;
        }
        long j10 = this.A01 - c17260t.A01;
        if (j10 == 0) {
            long j11 = this.A00;
            long delta = c17260t.A00;
            j10 = j11 - delta;
            if (j10 == 0) {
                return 0;
            }
