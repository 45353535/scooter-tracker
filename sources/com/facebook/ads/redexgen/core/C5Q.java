...
public abstract class C5Q extends AbstractC2173Ir implements Wf {
    ...
    public final C2519Wh A0C;
    public final InterfaceC2551Xn A0D;
    public final C2658ai A0E;
    public final DX A0F;
    public final DR A0G;
    public final DP A0H;
    public final DN A0I;
    ...
    public abstract void A1V(C2820dL c2820dL);

    static {
        A03();
        A0O = (int) (AbstractC2523Wl.A02 * 1.0f);
        A0P = (int) (AbstractC2523Wl.A02 * 4.0f);
        A0N = (int) (AbstractC2523Wl.A02 * 6.0f);
    }

    public C5Q(C2658ai c2658ai, boolean z10, String str, FH fh2) {
        super(c2658ai, z10);
        this.A09 = new Path();
        this.A0A = new RectF();
        ...
        this.A0D = c2658ai.A0D();
        this.A0E = c2658ai;
        this.A03 = fh2;
        this.A0K = str;
        this.A0B = c2658ai.A06();
        this.A0C = C2519Wh.A00(c2658ai.A06(), c2658ai.A05(), this);
        setGravity(17);
    ...
    @Override // com.facebook.ads.redexgen.core.AbstractC2173Ir
    ...
    public final void A1Q() {
        if (A1T()) {
            A1R();
            C2789cp c2789cp = this.A04;
            EnumC2836db enumC2836db = EnumC2836db.A02;
            if (A0M[2].length() == 4) {
                throw new RuntimeException();
            }
            A0M[2] = "GrzUS";
            c2789cp.A05(enumC2836db);
        }
    }
    ...
    public final C2789cp getVideoView() {
        return this.A04;
    }
    ...
    public void setCTAInfo(C2284Mz c2284Mz, Map<String, String> extraData) {
        getCtaButton().setCta(c2284Mz, this.A0K, extraData);
    }

    public void setImageUrl(String str) {
        this.A01.setVisibility(0);
        this.A04.setVisibility(8);
        new KZ(this.A01, this.A0B).A04().A06(new C2167Il(this)).A07(str);
    }
    ...
    public void setOnAssetsLoadedListener(InterfaceC2709bX interfaceC2709bX) {
        this.A02 = interfaceC2709bX;
    }

    public void setUpImageView(C2820dL c2820dL) {
        this.A01 = new YM(c2820dL);
        if (U7.A1I(c2820dL)) {
            AbstractC2608Zs.A00(this.A01, U7.A1J(c2820dL), new ViewOnClickListenerC2715bd(this));
        }
        A04(this.A01);
    }

    public void setUpMediaContainer(C2820dL c2820dL) {
        this.A00 = new RelativeLayout(c2820dL);
        A04(this.A00);
        C2518Wg c2518WgA02 = this.A0C.A02(this.A0E.A05());
        this.A0E.A06().A0H().A00(c2518WgA02.A01);
        getCtaButton().setCreativeAsCtaLoggingHelper(this.A0C);
        if (this.A0E.A05().A1W() && U7.A2o(this.A0B)) {
            this.A00.setOnClickListener(new ViewOnClickListenerC2714bc(this));
        } else {
            if (!c2518WgA02.A00) {
                return;
            }
    ...
    public void setUpVideoView(C2820dL c2820dL) {
        this.A04 = new C2789cp(c2820dL, new C2463Ua(this.A0K, getAdEventManager()));
        if (U7.A1K(c2820dL)) {
            AbstractC2608Zs.A00(this.A04, U7.A1L(c2820dL), new ViewOnClickListenerC2716be(this));
        }
        A04(this.A04);
    }

    private void setUpView(C2820dL c2820dL) {
        setUpImageView(c2820dL);
        setUpVideoView(c2820dL);
        setUpMediaContainer(c2820dL);
