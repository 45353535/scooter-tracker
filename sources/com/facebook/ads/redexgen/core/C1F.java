...
public abstract class C1F<E> extends A3<E> implements List<E> {
    ...
    public static final C3517pF A02;
    ...
    public static void A07() {
        A00 = new byte[]{-19, Ascii.SO, 3, Ascii.DLE, -1, Ascii.DC2, 7, 13, Ascii.FF, -66, 7, 17, -66, Ascii.FF, 13, Ascii.DC2, -66, 17, 19, Ascii.SO, Ascii.SO, 13, Ascii.DLE, Ascii.DC2, 3, 2, -66, 4, 13, Ascii.DLE, -66, Ascii.DLE, 3, -1, 2, -53, 13, Ascii.FF, 10, Ascii.ETB, -66, 1, 13, 10, 10, 3, 1, Ascii.DC2, 7, 13, Ascii.FF};
    }
    ...
    public int indexOf(E element) {
        ...
        while (it.hasNext()) {
            if (C3511p6.A0C(it.next(), element)) {
                return i10;
            }
            i10++;
        }
    ...
    public int lastIndexOf(E element) {
        ...
        while (listIterator.hasPrevious()) {
            if (C3511p6.A0C(listIterator.previous(), element)) {
