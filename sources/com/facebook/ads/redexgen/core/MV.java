...
public final class MV {
    ...
    public static void A02() {
        A03 = new byte[]{-67, -65, -63, -65, -50, -3, 6, -5, 10, 17, 8, Ascii.FF, -3, -4, -9, -7, -4, -9, 1, -4, -9, 7, 10, 1, -1, 1, 6, -7, 4, -19, -10, -21, -6, 1, -8, -4, -19, -20, -25, -15, -20, Ascii.EM, 13, 36, Ascii.VT, Ascii.SI, 13, Ascii.FS, Ascii.FS, 17, Ascii.DLE, Ascii.VT, 13, Ascii.RS, Ascii.RS, 13, 37, Ascii.VT, Ascii.CAN, 17, Ascii.SUB, 19, 32, Ascii.DC4, 47, 35, 35, 53, 50, 50, 37, 46, 35, 37, 51, -1, -12, 1, -8, -2, -13, 37, Ascii.FS, 34, 33, Ascii.FF, Ascii.FS, Ascii.DLE, Ascii.DLE, 34, Ascii.US, Ascii.US, Ascii.DC2, Ascii.ESC, Ascii.DLE, Ascii.DC2, Ascii.FF, 32, Ascii.DC2, Ascii.DLE, 32, Ascii.RS, Ascii.NAK, Ascii.ESC, Ascii.SUB, 5, Ascii.SYN, Ascii.VT, Ascii.CAN, Ascii.SI, Ascii.NAK, 10};
    }

    /* JADX WARN: Failed to parse debug info
    java.lang.ArrayIndexOutOfBoundsException
     */
    public final synchronized void A0A(@Nullable String str) throws C2434Sw, JSONException {
        if (str != null) {
            if (!str.trim().isEmpty()) {
    ...
    private final synchronized N2 A00(String str, JSONObject jSONObject) throws C2434Sw, JSONException {
        ...
        if (str.equals(jSONObject.optString(A01(29, 12, 70), null))) {
            ...
            C2434Sw c2434Sw = new C2434Sw(new IllegalArgumentException());
