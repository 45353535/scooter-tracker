...
public final class C3024gi {
    public static byte[] A03;
    public final O1 A00;
    public final InterfaceC2834dZ A01;
    public final List<C3023gh> A02;
    ...
    public C3024gi(List<AbstractC2309Nz> list, Bundle bundle, InterfaceC2834dZ interfaceC2834dZ) {
        this.A02 = new ArrayList(list.size());
        this.A01 = interfaceC2834dZ;
        ArrayList parcelableArrayList = bundle.getParcelableArrayList(A00(10, 5, 76));
        for (int i10 = 0; i10 < list.size(); i10++) {
            this.A02.add(new C3023gh(list.get(i10), (Bundle) parcelableArrayList.get(i10)));
        }
        this.A00 = (O1) X2.A00(bundle.getByteArray(A00(0, 10, 126)));
    }

    public C3024gi(List<AbstractC2309Nz> list, InterfaceC2834dZ interfaceC2834dZ) {
        this.A02 = new ArrayList(list.size());
        this.A01 = interfaceC2834dZ;
        Iterator<AbstractC2309Nz> it = list.iterator();
        while (it.hasNext()) {
            this.A02.add(new C3023gh(it.next()));
        }
        this.A00 = new O1();
    }
    ...
    public final Bundle A02() {
        ...
        Iterator<C3023gh> it = this.A02.iterator();
        while (it.hasNext()) {
