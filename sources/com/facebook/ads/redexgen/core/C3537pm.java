...
public final class C3537pm {
    ...
    public InterfaceC3539pp A00;
    public boolean A01;
    public final Rect A02;
    public final Rect A03;
    public final Handler A04;
    public final InterfaceC3002gK A05;
    public final InterfaceC3547px A06;
    ...
    public final List<C3544pu<?, ?>> A0D;

    public C3537pm(ViewpointQeConfig viewpointQeConfig, InterfaceC3547px interfaceC3547px, InterfaceC3002gK interfaceC3002gK, A6 a62, ViewpointRegistry viewpointRegistry, Handler handler) {
        this(viewpointQeConfig, interfaceC3547px, interfaceC3002gK, a62, viewpointRegistry, handler, 100);
    }

    public C3537pm(ViewpointQeConfig viewpointQeConfig, InterfaceC3547px interfaceC3547px, InterfaceC3002gK interfaceC3002gK, A6 a62, ViewpointRegistry viewpointRegistry, Handler handler, int i10) {
        this.A03 = new Rect();
        this.A02 = new Rect();
        ...
        this.A06 = interfaceC3547px;
        this.A05 = interfaceC3002gK;
        this.A09 = a62;
        this.A08 = viewpointRegistry;
        this.A04 = handler;
        this.A0A = new RunnableC3538pn(this, i10, new Exception());
    }
        ...
        if (this.A0C.isEmpty()) {
            if (this.A0D.isEmpty()) {
                ...
                for (final DspViewableNode dspViewableNode : this.A0C) {
                    if (this.A07.A00) {
                        this.A08.A09(dspViewableNode, new InterfaceC19479v() { // from class: com.facebook.ads.redexgen.X.1I
                            @Override // com.facebook.ads.redexgen.core.InterfaceC19479v
                            public final Object AAB(Object obj) {
                                return this.A00.A0B(dspViewableNode, (C3544pu) obj);
                            }
                        });
                    } else {
    ...
    private void A07(DspViewableNode dspViewableNode, C3544pu<?, ?> c3544pu) {
        for (Rect rect : this.A0B) {
            Rect containerRect = this.A03;
            if (dspViewableNode.A9Q(containerRect, this.A02, rect) && c3544pu != C3544pu.A0B) {
                A6 a62 = this.A09;
                Rect rect2 = this.A03;
                Rect rect3 = this.A02;
                ...
                strArr2[1] = "vG";
                strArr2[7] = "kB";
                a62.A3y(c3544pu, rect2, rect3, viewpointQeConfig.A01);
            }
        }
    }
    ...
    public final /* synthetic */ C3520pL A0B(DspViewableNode dspViewableNode, C3544pu c3544pu) {
        A07(dspViewableNode, c3544pu);
        return null;
    }
    ...
    public final void A0E(InterfaceC3541pr interfaceC3541pr) {
        this.A09.AJA(interfaceC3541pr);
    }

    public final void A0F(InterfaceC3539pp interfaceC3539pp) {
        this.A00 = interfaceC3539pp;
    }
}
