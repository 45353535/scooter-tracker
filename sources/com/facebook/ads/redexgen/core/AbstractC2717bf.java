...
public abstract class AbstractC2717bf {
    public static C5Q A00(final C2658ai c2658ai, int i10, final String str, final FH fh2) {
        if (i10 == 1) {
            return new C5Q(c2658ai, str, fh2) { // from class: com.facebook.ads.redexgen.X.0e
                public static final int A00 = (int) (AbstractC2523Wl.A02 * 20.0f);
                public static final int A01 = (int) (AbstractC2523Wl.A02 * 16.0f);
                ...
                public final void A1V(C2820dL c2820dL) {
                    C2640aQ titleDescContainer = getTitleDescContainer();
        ...
        return new C5Q(c2658ai, str, fh2) { // from class: com.facebook.ads.redexgen.X.0f
            public static final int A00 = (int) (AbstractC2523Wl.A02 * 12.0f);
            ...
            @Override // com.facebook.ads.redexgen.core.C5Q, com.facebook.ads.redexgen.core.AbstractC2654ae
