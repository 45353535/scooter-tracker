...
public final class NT {
    ...
    public NT(String str, V6 v62, AdPlacementType adPlacementType, V4 v42, int i10, TL tl) {
        this(str, v62, adPlacementType, v42, i10, EnumSet.of(CacheFlag.NONE), tl);
    }

    public NT(String str, V6 v62, AdPlacementType adPlacementType, V4 v42, int i10, EnumSet<CacheFlag> cacheFlags, TL tl) {
        this.A0A = str;
    ...
    public final VR A00(C2820dL c2820dL, VB vb2, AdExperienceType adExperienceType) {
        return new VR(c2820dL, this.A0A, this.A08 != null ? new X1(this.A08.A04(), this.A08.A03()) : null, this.A09, this.A0C, vb2, X7.A01(U7.A0N(c2820dL)), this.A04, adExperienceType != null ? adExperienceType.getAdExperienceType() : null, this.A07);
    }
    ...
    public final void A05(EnumC2474Ul enumC2474Ul) {
        this.A03 = enumC2474Ul;
    }
