...
public abstract class AbstractC2166Ik {
    ...
    public static boolean A01(InterfaceC3286lN interfaceC3286lN) throws IOException {
        return A03(interfaceC3286lN, true, false);
    }

    public static boolean A02(InterfaceC3286lN interfaceC3286lN, boolean z10) throws IOException {
        return A03(interfaceC3286lN, false, z10);
    }

    public static boolean A03(InterfaceC3286lN interfaceC3286lN, boolean z10, boolean z11) throws IOException {
        ...
        while (i11 < i10) {
            int i12 = 8;
            c4j.A0d(8);
            if (!interfaceC3286lN.AGA(c4j.A0l(), 0, 8, true)) {
                break;
            }
            long jA0Q = c4j.A0Q();
            ...
            if (jA0Q == 1) {
                i12 = 16;
                interfaceC3286lN.AG9(c4j.A0l(), 8, 8);
                c4j.A0e(16);
                jA0Q = c4j.A0P();
            } else if (jA0Q == 0) {
                long jA8G2 = interfaceC3286lN.A8G();
                if (jA8G2 != -1) {
                    jA0Q = (jA8G2 - interfaceC3286lN.A8a()) + ((long) 8);
                }
            }
            if (jA0Q < i12) {
                return false;
            ...
            if (headerSize == 1836019574) {
                ...
                if (headerSize == 1718909296) {
                    if (atomDataSize >= 8) {
                        ...
                        interfaceC3286lN.AG9(c4j.A0l(), 0, atomDataSize);
                    ...
                    interfaceC3286lN.A3z(atomDataSize);
                }
            }
        }
        return z12 && z10 == z13;
