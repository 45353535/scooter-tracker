...
public abstract class AbstractC2465Uc {
    ...
    public static List<String> A02(C2820dL c2820dL, JSONArray jSONArray) {
        ArrayList arrayList = new ArrayList();
        for (int eventIndex = 0; eventIndex < jSONArray.length(); eventIndex++) {
            try {
                arrayList.add(jSONArray.getString(eventIndex));
            } catch (JSONException e10) {
                c2820dL.A08().AAy(A00(39, 17, 76), AbstractC2433Sv.A1C, new C2434Sw(e10));
            }
        }
        return arrayList;
    }

    public static void A04(View view, C2463Ua c2463Ua, UZ uz) {
        view.addOnAttachStateChangeListener(new ViewOnAttachStateChangeListenerC2464Ub(c2463Ua, uz));
    }

    public static void A05(C2820dL c2820dL, String str, long j10) {
        US adEventManager = c2820dL.A0A();
        C2463Ua c2463Ua = new C2463Ua(str, adEventManager);
        HashMap map = new HashMap();
        map.put(A00(24, 15, 67), XG.A07(j10));
        map.put(A00(12, 12, 71), XG.A05(j10));
        c2463Ua.A04(UZ.A0D, map);
    }

    public static void A06(C2820dL c2820dL, JSONObject jSONObject, long j10, String str) {
        ...
        if (TextUtils.isEmpty(str) && jSONArrayOptJSONArray != null) {
            A07(c2820dL, jSONObjectOptJSONObject, A02(c2820dL, jSONArrayOptJSONArray), j10, null);
            return;
        }
        ...
        A07(c2820dL, jSONObjectOptJSONObject, A03.get(str), j10, str);
    }

    public static void A07(C2820dL c2820dL, JSONObject jSONObject, List<String> list, long j10, String str) {
        String strA00 = A00(0, 2, 106);
        if (jSONObject.has(strA00)) {
            String clientToken = jSONObject.optString(strA00);
            A08(clientToken, str);
            A09(clientToken, list);
            A05(c2820dL, clientToken, j10);
        }
    }
