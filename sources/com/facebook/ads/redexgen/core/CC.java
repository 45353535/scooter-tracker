...
public final class CC extends AsyncTask<AbstractC2911ep, Void, InterfaceC2898ec> implements InterfaceC2908em {
     ...
     */
    private final InterfaceC2898ec A00(AbstractC2911ep... abstractC2911epArr) throws Throwable {
        ...
        try {
            if (abstractC2911epArr != null) {
                try {
                    if (abstractC2911epArr.length > 0) {
                        InterfaceC2898ec interfaceC2898ecA0J = this.A01.A0J(abstractC2911epArr[0]);
                        if (this.A01.A0K().A04() && interfaceC2898ecA0J != null) {
                            String.format(Locale.US, A01(108, 21, 5), Integer.valueOf(interfaceC2898ecA0J.A94()), interfaceC2898ecA0J.getUrl(), interfaceC2898ecA0J.A6v());
                        }
                        if (interfaceC2898ecA0J != null) {
                            return interfaceC2898ecA0J;
                        }
    ...
    public CC(C8 c82, InterfaceC2900ee interfaceC2900ee, Executor executor) {
        this.A01 = c82;
        this.A00 = interfaceC2900ee;
        this.A03 = executor;
    }

    private final void A03(InterfaceC2898ec result) throws Throwable {
        if (AbstractC2499Vl.A02(this)) {
            return;
        }
        try {
    ...
    public final void A04(AbstractC2911ep abstractC2911ep) {
        super.executeOnExecutor(this.A03, abstractC2911ep);
    }

    @Override // android.os.AsyncTask
    public final /* bridge */ /* synthetic */ InterfaceC2898ec doInBackground(AbstractC2911ep[] abstractC2911epArr) throws Throwable {
        if (AbstractC2499Vl.A02(this)) {
            return null;
        }
        try {
            return A00(abstractC2911epArr);
        } catch (Throwable th2) {
            AbstractC2499Vl.A00(th2, this);
            return null;
        }
    ...
    @Override // android.os.AsyncTask
    public final /* bridge */ /* synthetic */ void onPostExecute(InterfaceC2898ec interfaceC2898ec) throws Throwable {
        if (AbstractC2499Vl.A02(this)) {
            return;
        }
        try {
            A03(interfaceC2898ec);
        } catch (Throwable th2) {
            AbstractC2499Vl.A00(th2, this);
        }
    }
