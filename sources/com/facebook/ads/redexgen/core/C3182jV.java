...
public final class C3182jV implements InterfaceC2217Kj {
    ...
    public final C3497or A06;
    public final C4J A07;
    public final GY A08;
    public final H1 A09;
    public final C2219Kl A0A;
    ...
    public static void A04() {
        A0C = new byte[]{-120, 109, -76, -68, -63, -121, 109, -51, 0, -8, -19, -21, -4, -19, -20, -88, -18, -6, -23, -11, -19, -5, -88, -8, -19, -6, -88, -22, -12, -9, -21, -13, -62, -88, -7, 13, -4, 1, 7, -57, 10, -7, Ascii.SI};
    }
    ...
    private void A06(byte[] bArr, int i10, int i11, byte[] bArr2) {
        ...
        for (int i19 = 0; i19 < i16 * 2; i19++) {
            ...
            iA07 = AbstractC18094a.A07(iA07 + i22, -32768, 32767);
            i18 += i13 * 2;
            bArr2[i18] = (byte) (iA07 & 255);
            bArr2[i18 + 1] = (byte) (iA07 >> 8);
            iMin = AbstractC18094a.A07(iMin + A0E[i21], 0, A0F.length - 1);
            i17 = A0F[iMin];
        }
    }
    ...
    public C3182jV(GY gy, H1 h12, C2219Kl c2219Kl) throws C17652i {
        this.A08 = gy;
        this.A09 = h12;
        this.A0A = c2219Kl;
        this.A05 = Math.max(1, c2219Kl.A04 / 10);
        C4J scratch = new C4J(c2219Kl.A06);
        scratch.A0G();
        this.A04 = scratch.A0G();
        int i10 = c2219Kl.A05;
        int i11 = (((c2219Kl.A02 - (i10 * 4)) * 8) / (c2219Kl.A01 * i10)) + 1;
        if (this.A04 == i11) {
            int numChannels = AbstractC18094a.A05(this.A05, this.A04);
            this.A0B = new byte[c2219Kl.A02 * numChannels];
            int maxBlocksToDecode = A02(this.A04, i10);
            this.A07 = new C4J(maxBlocksToDecode * numChannels);
            int maxBlocksToDecode2 = c2219Kl.A04;
            int constantBitrate = ((maxBlocksToDecode2 * c2219Kl.A02) * 8) / this.A04;
            this.A06 = new C2D().A11(A03(34, 9, 83)).A0a(constantBitrate).A0j(constantBitrate).A0h(A02(this.A05, i10)).A0b(c2219Kl.A05).A0m(c2219Kl.A04).A0i(2).A14();
            return;
        }
        throw C17652i.A01(A03(7, 27, 67) + i11 + A03(0, 7, 8) + this.A04, null);
    }
    ...
    private void A05(int i10) {
        long jA0U = this.A03 + AbstractC18094a.A0U(this.A02, 1000000L, this.A0A.A04);
        int iA01 = A01(i10);
    ...
    */
    private void A07(byte[] r4, int r5, com.facebook.ads.redexgen.core.C4J r6) {
        ...
        L17:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C3182jV.A07(byte[], int, com.facebook.ads.redexgen.X.4J):void");
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC2217Kj
    public final void AA0(int i10, long j10) {
        this.A08.AIN(new C3179jS(this.A0A, this.A04, i10, j10));
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2217Kj
    public final boolean AI9(InterfaceC3286lN interfaceC3286lN, long j10) throws IOException {
        int iA00 = this.A05 - A00(this.A01);
        int targetFramesRemaining = this.A04;
        int blocksToDecode = AbstractC18094a.A05(iA00, targetFramesRemaining);
        ...
        while (!z10) {
            ...
            int blocksToDecode2 = interfaceC3286lN.read(bArr, targetFramesRemaining4, targetReadBytes);
