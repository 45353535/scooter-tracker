...
public final class C18686h extends AbstractC2981fy {
    ...
    @Override // com.facebook.ads.redexgen.core.AbstractC2981fy
    public final int A0C(QO qo, int i10, int i11) {
        int iA0r;
        int centerPosition;
        int iA0b = qo.A0b();
        if (iA0b == 0) {
        ...
        boolean z10 = false;
        if (qo instanceof InterfaceC2361Qa) {
            int itemCount = iA0b - 1;
            PointF pointFA4y = ((InterfaceC2361Qa) qo).A4y(itemCount);
            if (pointFA4y != null) {
    ...
    @Override // com.facebook.ads.redexgen.core.AbstractC2981fy
    public final C2999gH A0E(QO qo) {
        if (!(qo instanceof InterfaceC2361Qa)) {
            return null;
        }
        final Context context = super.A00.getContext();
        return new C2999gH(context) { // from class: com.facebook.ads.redexgen.X.6i
            @Override // com.facebook.ads.redexgen.core.C2999gH, com.facebook.ads.redexgen.core.AbstractC2362Qb
            public final void A0I(View view, C2364Qd c2364Qd, QZ qz) {
                int[] iArrA0H = this.A00.A0H(((AbstractC2981fy) this.A00).A00.getLayoutManager(), view);
                int time = iArrA0H[0];
                int dy = iArrA0H[1];
                int dx = A0M(Math.max(Math.abs(time), Math.abs(dy)));
                if (dx > 0) {
                    qz.A04(time, dy, dx, ((C2999gH) this).A04);
                }
            }

            @Override // com.facebook.ads.redexgen.core.C2999gH
