...
public abstract class AbstractC2981fy extends QR {
    ...
    public C18676g A00;
    public Scroller A01;
    public final QT A02 = new C2982fz(this);
    ...
    public abstract int A0C(QO qo, int i10, int i11);

    public abstract View A0D(QO qo);

    @Deprecated
    public abstract C2999gH A0E(QO qo);
    ...
    private final C2999gH A05(QO qo) {
        return A0E(qo);
    }
    ...
    private boolean A0A(QO qo, int i10, int i11) {
        C2999gH c2999gHA05;
        int iA0C;
        if (!(qo instanceof InterfaceC2361Qa) || (c2999gHA05 = A05(qo)) == null || (iA0C = A0C(qo, i10, i11)) == -1) {
            return false;
        }
        c2999gHA05.A0A(iA0C);
        qo.A1N(c2999gHA05);
    ...
    public final void A0G(C18676g c18676g) throws IllegalStateException {
        if (this.A00 == c18676g) {
            return;
        }
        C18676g c18676g2 = this.A00;
