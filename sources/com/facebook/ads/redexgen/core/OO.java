    ...
    public final void A05(BroadcastReceiver broadcastReceiver) {
        synchronized (this.A04) {
            ...
            for (int size = arrayListRemove.size() - 1; size >= 0; size--) {
                ...
                on.A01 = true;
                for (int j10 = 0; j10 < on.A03.countActions(); j10++) {
                    String action = on.A03.getAction(j10);
                    ArrayList<ON> arrayList = this.A03.get(action);
                    if (arrayList != null) {
                        int i10 = arrayList.size();
                        for (int i11 = i10 - 1; i11 >= 0; i11--) {
                            ON on2 = arrayList.get(i11);
        ...
        synchronized (this.A04) {
            ...
            if (arrayList != null) {
                ...
                for (int i10 = 0; i10 < arrayList.size(); i10++) {
                    ON on = arrayList.get(i10);
                    if (debug) {
                        StringBuilder sb4 = new StringBuilder();
                        String type6 = A01(104, 24, 106);
                        sb4.append(type6).append(on.A03).toString();
                    }
                    if (!on.A00) {
