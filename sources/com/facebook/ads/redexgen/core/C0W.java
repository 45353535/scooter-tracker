...
public class C0W<E> extends AbstractC17461n<E> {
    public final AbstractC1964Am<E> A00;
    ...
    public C0W(AbstractC1964Am<E> list, final int index) {
        ...
        new AF<E>(size, index) { // from class: com.facebook.ads.redexgen.X.1n
            ...
            {
                AbstractC3162jA.A01(index, size);
                this.A01 = size;
                this.A00 = index;
            }
    ...
    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.0W != com.google.common.collect.ImmutableList$Itr<E> */
    @Override // com.facebook.ads.redexgen.core.AbstractC17461n
