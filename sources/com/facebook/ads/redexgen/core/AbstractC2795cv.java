...
public abstract class AbstractC2795cv {
    ...
    public static BitmapDrawable A00(C2820dL c2820dL, String str) {
        try {
            ...
            if (overlayBm != null && (!A00 || A05(c2820dL, overlayBm))) {
                ...
                Resources resources = c2820dL.getResources();
                if (resources != null) {
                    DisplayMetrics displayMetrics = resources.getDisplayMetrics();
                    if (displayMetrics != null) {
                        overlayRepeat.setTargetDensity(displayMetrics.densityDpi);
                    } else {
                        A04(c2820dL, A02(0, 23, 41));
                    }
                } else {
                    A04(c2820dL, A02(23, 18, 119));
                }
                return overlayRepeat;
            }
            return null;
        } catch (Throwable th2) {
            c2820dL.A08().AAy(A02(59, 3, 58), AbstractC2433Sv.A1u, new C2434Sw(th2));
            return null;
        }
    }

    public static C2796cw A01(C2820dL c2820dL, String str) {
        BitmapDrawable bitmapDrawableA00;
        try {
            if (TextUtils.isEmpty(str) || (bitmapDrawableA00 = A00(c2820dL, str)) == null) {
                return null;
            }
            C2796cw c2796cw = new C2796cw(c2820dL);
            c2796cw.setBackground(bitmapDrawableA00);
            c2796cw.setClickable(false);
            c2796cw.setFocusable(false);
            return c2796cw;
        } catch (Throwable th2) {
            c2820dL.A08().AAy(A02(59, 3, 58), AbstractC2433Sv.A1u, new C2434Sw(th2));
            return null;
    ...
    public static void A04(C2820dL c2820dL, String str) {
        c2820dL.A08().AAy(A02(59, 3, 58), AbstractC2433Sv.A1u, new C2434Sw(str));
    }
    ...
    */
    public static boolean A05(com.facebook.ads.redexgen.core.C2820dL r4, android.graphics.Bitmap r5) {
        /*
            r3 = 0
        L1:
            int r0 = r5.getWidth()
        ...
        L36:
            r3 = 1
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.AbstractC2795cv.A02
            r0 = 2
            r1 = r2[r0]
            r0 = 3
            r0 = r2[r0]
        ...
        L4f:
            ...
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.AbstractC2795cv.A05(com.facebook.ads.redexgen.X.dL, android.graphics.Bitmap):boolean");
    }
}
