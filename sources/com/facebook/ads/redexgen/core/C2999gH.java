...
public class C2999gH extends AbstractC2362Qb {
    ...
    private final int A03(View view, int i10) {
        ...
        return A0N(qoA08.A0q(view) - qp.topMargin, qoA08.A0l(view) + qp.bottomMargin, qoA08.A0i(), qoA08.A0Z() - qoA08.A0f(), i10);
    }
    ...
    public int A0O(View view, int i10) {
        ...
        QP qp = (QP) view.getLayoutParams();
        return A0N(qoA08.A0m(view) - qp.leftMargin, qoA08.A0p(view) + qp.rightMargin, qoA08.A0g(), qoA08.A0j() - qoA08.A0h(), i10);
    }
    ...
    public C2999gH(Context context) {
    ...
    @Override // com.facebook.ads.redexgen.core.AbstractC2362Qb
    ...
    @Override // com.facebook.ads.redexgen.core.AbstractC2362Qb
    public final void A0H(int i10, int i11, C2364Qd c2364Qd, QZ qz) {
        if (A06() == 0) {
            A09();
            if (A07[2].length() != 19) {
                throw new RuntimeException();
    ...
    @Override // com.facebook.ads.redexgen.core.AbstractC2362Qb
    public void A0I(View view, C2364Qd c2364Qd, QZ qz) {
    ...
    public PointF A0P(int i10) {
        Object objA08 = A08();
        if (objA08 instanceof InterfaceC2361Qa) {
            return ((InterfaceC2361Qa) objA08).A4y(i10);
        }
        Log.w(A04(0, 20, 26), A04(20, 93, 94) + InterfaceC2361Qa.class.getCanonicalName());
        return null;
    }
}
