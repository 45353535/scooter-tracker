...
public final class D0 extends ImageView implements InterfaceC2837dc {
    ...
    static {
        A06();
        A08 = (int) (AbstractC2523Wl.A02 * 40.0f);
        A07 = (int) (AbstractC2523Wl.A02 * 10.0f);
    }

    public D0(C2820dL c2820dL, C2463Ua c2463Ua) {
        super(c2820dL);
        ...
        A05();
        setOnClickListener(new ViewOnClickListenerC2854du(this));
    }
    ...
    public final void AJk(E1 e12) {
        if (this.A00 != null) {
            C2442Te<AbstractC2443Tf, C2441Td> eventBus = this.A00.getEventBus();
            DE de2 = this.A04;
            String[] strArr = A06;
