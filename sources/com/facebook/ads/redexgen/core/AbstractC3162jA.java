...
public abstract class AbstractC3162jA {
    ...
    public static void A0G(boolean expression, String errorMessageTemplate, int p12, int p22) {
        if (!expression) {
            throw new IllegalArgumentException(Strings.A02(errorMessageTemplate, new Object[]{Integer.valueOf(p12), Integer.valueOf(p22)}));
        }
    }
