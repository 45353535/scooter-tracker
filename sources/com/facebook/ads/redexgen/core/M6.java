...
public final class M6 {
    ...
    public M6(InterfaceC18214m interfaceC18214m, File file, byte[] bArr, boolean z10, boolean z11) {
        C3M.A08((interfaceC18214m == null && file == null) ? false : true);
        this.A05 = new HashMap<>();
        this.A02 = new SparseArray<>();
        this.A04 = new SparseBooleanArray();
        this.A03 = new SparseBooleanArray();
        C3147iu c3147iu = interfaceC18214m != null ? new C3147iu(interfaceC18214m) : null;
        M5 databaseStorage = file != null ? new C3146it(new File(file, A04(42, 24, 47)), bArr, z10) : null;
        if (c3147iu == null || (databaseStorage != null && z11)) {
            M5 legacyStorage = (M5) AbstractC18094a.A0f(databaseStorage);
    ...
    public static C3145is A02(DataInputStream dataInputStream) throws IOException {
        ...
        for (int nextBytesToRead = 0; nextBytesToRead < i10; nextBytesToRead++) {
            ...
            if (bytesRead >= 0) {
                ...
                byte[] bArrCopyOf = AbstractC18094a.A07;
    ...
    public static void A08(C3145is c3145is, DataOutputStream dataOutputStream) throws IOException {
        Set<Map.Entry<String, byte[]>> setA06 = c3145is.A06();
    ...
    public final C3145is A0E(String str) {
        M4 cachedContent = A0C(str);
        return cachedContent != null ? cachedContent.A03() : C3145is.A03;
    }
    ...
    public final void A0H() {
        AbstractC3531pg abstractC3531pgA0N = AbstractC1963Al.A07(this.A05.keySet()).A0N();
        while (true) {
            boolean zHasNext = abstractC3531pgA0N.hasNext();
            String[] strArr = A07;
            ...
            if (zHasNext) {
                A0K((String) abstractC3531pgA0N.next());
            } else {
                return;
            }
        }
