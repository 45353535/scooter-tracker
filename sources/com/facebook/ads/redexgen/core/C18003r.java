...
public final class C18003r extends G2 {
    ...
    public int A00;
    public UZ A01;
    public AbstractC2550Xm A02;
    public AbstractC2654ae A03;
    public InterfaceC2779cf A04;
    public C2817dI A05;
    public EnumC2836db A06;
    public boolean A07;
    public boolean A08;
    public boolean A09;
    public boolean A0A;
    ...
    public final R6 A0I;
    public final InterfaceC2778ce A0J;
    public final EG A0K;
    public final E1 A0L;
    public final C17913i A0M;
    public final DX A0N;
    public final DV A0O;
    public final DR A0P;
    public final DP A0Q;
    ...
    public C18003r(C2820dL c2820dL, YY yy, US us, AbstractC3095hy abstractC3095hy, SF sf2, InterfaceC2551Xn interfaceC2551Xn) {
        super(c2820dL, yy, us, abstractC3095hy, sf2, interfaceC2551Xn);
        ...
        this.A0N = new DX() { // from class: com.facebook.ads.redexgen.X.3t
            ...
            public final void A03(C17863d c17863d) {
                this.A00.A0O(c17863d, this.A00.A0L.getState() != EnumC2890eU.A06, false);
            }
        };
        this.A0O = new C18013s(this);
        boolean z10 = false;
        this.A0E = false;
        this.A0F = false;
        this.A0D = false;
        ...
        this.A0B = abstractC3095hy.A1k();
        this.A0M = new C17913i(super.A04, super.A05, this.A0L, super.A02.A25(), 0, 0, super.A02.A20().A0U(), null, null);
        if (U7.A1v(super.A04)) {
            this.A0K = new EG(super.A04, super.A05, this.A0L, super.A02.A25(), super.A02.A20().A0U(), this.A0M, null);
        } else {
            this.A0K = null;
        }
        this.A05 = new C2817dI(super.A04, super.A0A, super.A02.A1A(), interfaceC2551Xn);
        if (!A0j()) {
        ...
        if (!A0j()) {
            this.A0T = new C2023Cw(super.A04, iA02);
        } else {
            this.A0T = new C2023Cw(super.A04, iA02, C2023Cw.A0D);
        }
        ...
        this.A08 = z10;
        C2283My colors = super.A02.A1z().A01();
    ...
    public static int A02(AbstractC3095hy abstractC3095hy) {
        if (abstractC3095hy.A0v().equals(A0A(18, 14, 49))) {
            return abstractC3095hy.A20().A0H().A03();
        }
        if (abstractC3095hy.A0v().equals(A0A(6, 12, 112))) {
            return abstractC3095hy.A20().A0H().A04();
        }
        String[] strArr = A0V;
    ...
    private AbstractC2654ae A06(int i10) {
        C2657ah c2657ahA0N = new C2657ah(super.A04, super.A05, super.A09, super.A02, this.A0L, super.A0B, super.A07).A0K(super.A08.getToolbarHeight()).A0R(super.A08).A0J(i10).A0L(this.A0H).A0T(this.A0T).A0Q(this.A02).A0N(super.A06);
        if (super.A02.A20().A0S() && U7.A1Y(super.A04) && super.A02.A20().A0L() != null) {
            c2657ahA0N.A0P(getPackageInstallListener());
        }
        c2657ahA0N.A0M(MI.A00(super.A04, super.A05, A0A(0, 0, 98), WQ.A00(super.A02.A20().A0J().A05()), new HashMap(), super.A02.A21()));
        C2658ai params = c2657ahA0N.A0W();
        return AbstractC2655af.A00(params, null, true);
    }
    ...
    private void A0B() {
        if (!super.A02.A20().A0K().A03()) {
            ...
            this.A02.setToolbarListener(new C2090Fl(this));
            if (super.A02.A2K()) {
                this.A02.setOnClickListener(new ViewOnClickListenerC2773cZ(this));
            }
        }
    }

    private void A0C() {
        this.A0L.postDelayed(new C2081Fc(this), U7.A0O(super.A04));
    }

    private void A0D() {
        this.A0L.postDelayed(new C2080Fb(this), U7.A0P(super.A04));
    }
    ...
    private void A0F() {
        ...
        if (this.A0H instanceof InterfaceC2837dc) {
            this.A0L.A0i((InterfaceC2837dc) this.A0H);
        }
        if (!TextUtils.isEmpty(super.A02.A20().A0H().A08())) {
            C17722p c17722p = new C17722p(super.A04, A0j());
            this.A0L.A0i(c17722p);
            c17722p.setImage(super.A02.A20().A0H().A08());
        }
        if (!A0j()) {
            C2R c2r = new C2R(super.A04, true, super.A06);
            this.A0L.A0i(c2r);
            this.A0L.A0i(new D4(c2r, EnumC2851dr.A02, true));
        }
        this.A0L.A0i(new C2Y(super.A04));
    }

    private void A0H(UZ uz) {
        new C2463Ua(super.A02.A25(), super.A04.A0A()).A04(uz, null);
        super.A09.A4b(super.A0A.A6d());
        this.A05.A05();
        if (this.A03 instanceof C18385d) {
            ((C18385d) this.A03).A1Y();
        }
        if (!super.A02.A1i()) {
            this.A0G.postDelayed(new RunnableC2775cb(this), 2000L);
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void A0O(C17863d c17863d, boolean z10, boolean z11) {
        if (this.A04 != null) {
            if (z10) {
                super.A04.A0F().ADu();
            }
        ...
        if (!z10 && this.A08 && this.A0B) {
            this.A00++;
            this.A0L.A0h(EnumC2836db.A02, 20);
            return;
        }
        if (!this.A0C) {
            A0E();
        ...
        if (!z10 && this.A00 < super.A02.A20().A0G()) {
            this.A0L.A0h(EnumC2836db.A02, 32);
        } else {
            this.A0D = true;
            if (this.A03 != null) {
                this.A03.A1H(c17863d);
            }
        }
        if (this.A00 == 0) {
            A0S(z10, z11);
    ...
    public void A0P(C3Q c3q) {
        if (this.A0L.getState() == EnumC2890eU.A02 && U7.A1Z(super.A04)) {
    ...
    public void A0Q(C3Q c3q) {
        ...
        if (this.A08) {
            ...
            AbstractC3095hy abstractC3095hy = super.A02;
            if (A0V[6].length() != 22) {
                String[] strArr = A0V;
                strArr[0] = "";
                strArr[1] = "CRWrhlQnYLwh";
                if (!KE.A05(abstractC3095hy)) {
        ...
        if (!zA1j) {
            ...
            AbstractC2550Xm abstractC2550Xm = super.A08;
            String[] strArr3 = A0V;
            ...
            if (totalSecondsForNextCta4 != currentPosMs6) {
                ...
                abstractC2550Xm.A09(unskippableSeconds2, i10);
            } else {
                A0V[3] = "ksHgyK5pJeiIhpnbSmOLRLGEWkwS8h7S";
                float unskippableSeconds3 = 100.0f * f10;
                abstractC2550Xm.A09(unskippableSeconds3, i10);
            }
        }
        if (f10 >= 1.0f && !this.A0C) {
            A0E();
            AbstractC2550Xm abstractC2550Xm2 = super.A08;
            int currentPosMs7 = getCloseButtonStyle();
            abstractC2550Xm2.setToolbarActionMode(currentPosMs7);
        }
    }
    ...
    public void A0R(String str) {
        ...
        if (U7.A1a(super.A04)) {
            A0O(new C17863d(currentPositionInMillis, duration), false, true);
        } else {
    ...
    public final AbstractC2550Xm A0b() {
        AbstractC2550Xm c2302Nr;
        if (!A0j()) {
            c2302Nr = new FullScreenAdToolbar(super.A04, super.A09, super.A06, 1, super.A02.A1t(), super.A02.A1j());
        } else {
            c2302Nr = new C2302Nr(super.A04, super.A09, super.A06, 1);
            A0B();
            if (super.A02.A2K()) {
                c2302Nr.setOnTouchListener(new ViewOnTouchListenerC2777cd(this));
            }
        }
        if (super.A02.A2K()) {
            c2302Nr.setOnClickListener(new ViewOnClickListenerC2772cY(this));
        }
        return c2302Nr;
    }
    ...
    public final void A0h(R0 r02) {
        ...
        XP.A0F(this.A03);
        XP.A0F(super.A08);
        if (super.A02.A1f() && (this.A03 instanceof C18385d)) {
            ((C18385d) this.A03).setVideoAdViewListener(this.A0J);
        }
        AbstractC2654ae abstractC2654ae = this.A03;
        if (A0V[6].length() == 22) {
            throw new RuntimeException();
        }
        A0V[5] = "wo0V9GMefx8z7FmkoRuQRU6XLmQOOAjz";
        if (abstractC2654ae != null && this.A03.A1M()) {
            z10 = true;
        }
    ...
    public final void A0k() {
        ...
        if (A0j()) {
            ...
            if (abstractC2654ae instanceof C18385d) {
                ((C18385d) this.A03).A1Z(getResources().getConfiguration().orientation);
                ((C18385d) this.A03).A1X();
            }
        }
        this.A0L.A0h(EnumC2836db.A02, 20);
    ...
    public final void AF0(boolean z10) {
        ...
        if (this.A0L.getVisibility() != 0 || this.A0L.A0r() || this.A0D || this.A0L.getState() == EnumC2890eU.A06 || this.A06 == null) {
            return;
        }
        if (!this.A0A || z10) {
    ...
    private InterfaceC2533Wv getPackageInstallListener() {
        return new FP(this);
    }

    @Override // com.facebook.ads.redexgen.core.G2, com.facebook.ads.redexgen.core.InterfaceC2552Xo
    ...
    public void setVideoLeadingPlayableAdListener(InterfaceC2779cf interfaceC2779cf) {
        this.A04 = interfaceC2779cf;
    }
}
