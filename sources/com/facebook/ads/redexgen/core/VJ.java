...
public final class VJ implements UR {
    ...
    public final C2794cu A06;
    public final UQ A07;
    public final InterfaceC2899ed A08;
    ...
    public static void A07() {
        A0D = new byte[]{106, 121, 99, 84, 88, 117, 111, 108, 125, 104, Ascii.DEL, 116, 117, 114, 123, 60, 121, 106, 121, 114, 104, 60, 52, SignedBytes.MAX_POWER_OF_TWO, 125, 102, 96, 117, 113, 108, 106, 107, 37, 114, 109, 108, 105, 96, 37, 97, 108, 118, 117, 100, 113, 102, 109, 108, 107, 98, 37, 96, 115, 96, 107, 113, 118, 43, 73, Ascii.DEL, 104, 108, Ascii.DEL, 104, 58, 106, 104, 117, 121, Ascii.DEL, 105, 105, Ascii.DEL, 126, 58, 106, 123, 104, 110, 115, 123, 118, 58, 120, 123, 110, 121, 114, 54, 58, 121, 117, 116, 110, 115, 116, 111, 115, 116, 125, 58, 110, 117, 58, 116, Ascii.DEL, 98, 110, 58, 117, 116, Ascii.DEL, 52, 89, 111, 120, 124, 111, 120, 42, 120, 111, 121, 122, 101, 100, 121, 111, 42, 99, 121, 42, 111, 103, 122, 126, 115, 36, 0, 54, 33, 37, 54, 33, 115, 33, 54, 39, 38, 33, 61, 54, 55, 115, 50, 115, 61, 60, 61, 126, 32, 38, 48, 48, 54, 32, 32, 53, 38, Utf8.REPLACEMENT_BYTE, 115, 32, 39, 50, 39, 38, 32, 115, 48, 60, 55, 54, 115, 60, 53, 115, 70, 112, 103, 99, 112, 103, 53, 98, 116, 102, 53, 96, 123, 116, 119, 121, 112, 53, 97, 122, 53, 101, 103, 122, 118, 112, 102, 102, 53, 116, 121, 121, 53, 112, 99, 112, 123, 97, 102, 57, 53, 97, 103, 108, 124, 123, 114, 53, 116, 114, 116, 124, 123, 59, 57, 1, 3, Ascii.SUB, Ascii.SUB, 3, 4, 13, 74, Ascii.SO, 3, Ascii.EM, Ascii.SUB, Ascii.VT, Ascii.RS, 9, 2, 74, Ascii.SO, Ascii.US, Ascii.SI, 74, Ascii.RS, 5, 74, 6, Ascii.VT, 9, 1, 74, 5, Ascii.FF, 74, 9, 5, 4, 4, Ascii.SI, 9, Ascii.RS, 3, Ascii.FS, 3, Ascii.RS, 19, 68, 74, 95, 95, 78, 70, 91, 95, 93, 81, 80, 80, 91, 93, 74, 87, 72, 87, 74, 71, 32, 37, 48, 37, 3, Ascii.DLE, 3, 8, Ascii.DC2, Ascii.NAK, 59, 42, 50, 39, 36, 42, 47};
    }
    ...
    public VJ(C2794cu c2794cu, UQ uq) {
        this.A07 = uq;
        this.A06 = c2794cu;
        this.A04 = (ConnectivityManager) c2794cu.getSystemService(A03(293, 12, 115));
        this.A08 = C2917ev.A01(c2794cu);
        this.A03 = U9.A0K(c2794cu);
        this.A02 = U9.A0J(c2794cu);
    }
    ...
    public final void A0B() throws Exception {
        try {
            ...
            C2913er c2913er = new C2913er();
            c2913er.put(A03(315, 7, 6), jSONObjectA5D.toString());
            InterfaceC2898ec interfaceC2898ecAGD = this.A08.AGD(this.A06.A05().A7y(), c2913er.A08());
            String strA6v = interfaceC2898ecAGD != null ? interfaceC2898ecAGD.A6v() : null;
            if (!TextUtils.isEmpty(strA6v) && interfaceC2898ecAGD != null) {
                if (interfaceC2898ecAGD.A94() != 200) {
                    if (this.A06.A05().AAF()) {
                        String responseBody = A0F;
                        Log.e(responseBody, A03(138, 48, 30) + interfaceC2898ecAGD.A94() + A03(3, 1, 55));
                    }
                    if (interfaceC2898ecAGD.A94() == 413 && U7.A2R(this.A06)) {
                        this.A07.AEr();
                        A05();
                        return;
                    } else {
