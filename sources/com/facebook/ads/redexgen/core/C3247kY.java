...
public final class C3247kY implements GX, InterfaceC2127Gw {
    ...
    public static final InterfaceC2106Gb A0S;
    public int A00;
    public int A01;
    public int A02;
    public int A03;
    ...
    public final C2165Ij A0N;
    public final ArrayDeque<C3258kj> A0O;
    ...
    */
    private int A03(com.facebook.ads.redexgen.core.InterfaceC3286lN r22, com.facebook.ads.redexgen.core.C2124Gt r23) throws java.io.IOException {
        /*
            Method dump skipped, instruction units count: 426
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C3247kY.A03(com.facebook.ads.redexgen.X.lN, com.facebook.ads.redexgen.X.Gt):int");
    }
    ...
    public static void A0C() {
        A0Q = new byte[]{-47, 4, -1, -3, -80, 3, -7, 10, -11, -80, -4, -11, 3, 3, -80, 4, -8, -15, -2, -80, -8, -11, -15, -12, -11, 2, -80, -4, -11, -2, -9, 4, -8, -80, -72, 5, -2, 3, 5, 0, 0, -1, 2, 4, -11, -12, -71, -66, Ascii.DC2, 55, Utf8.REPLACEMENT_BYTE, 42, 53, 50, 45, -23, Ascii.ETB, 10, Ascii.NAK, -23, 53, 46, 55, 48, 61, 49, -8, Ascii.FF, -5, 0, 6, -58, -8, -6, -53, 49, 69, 52, 57, Utf8.REPLACEMENT_BYTE, -1, 68, 66, 69, 53, -3, 56, 52};
    }

    static {
        A0C();
        A0S = new InterfaceC2106Gb() { // from class: com.facebook.ads.redexgen.X.kZ
    ...
    public C3247kY(int i10) {
        this.A0I = i10;
        this.A04 = (i10 & 4) != 0 ? 3 : 0;
        this.A0N = new C2165Ij();
        this.A0P = new ArrayList();
        this.A0J = new C4J(16);
        this.A0O = new ArrayDeque<>();
        this.A0L = new C4J(AbstractC2121Gq.A03);
        this.A0K = new C4J(4);
        this.A0M = new C4J();
        this.A08 = -1;
        this.A0E = GY.A00;
        this.A0G = new C2158Ic[0];
    }
    ...
    private int A01(long j10) {
        ...
        int i12 = 0;
        while (true) {
            C2158Ic[] c2158IcArr = this.A0G;
            String[] strArr = A0R;
            if (strArr[3].length() != strArr[7].length()) {
                throw new RuntimeException();
            }
            A0R[6] = "Fcko3uaud46cO6nUcug7HhLZFNYBY";
            if (i12 >= c2158IcArr.length) {
            ...
            C2158Ic c2158Ic = this.A0G[i12];
            int i13 = c2158Ic.A00;
            if (i13 != c2158Ic.A04.A01) {
                long j14 = c2158Ic.A04.A06[i13];
                long minAccumulatedBytes = ((long[][]) AbstractC18094a.A0f(this.A0H))[i12][i13];
                long j15 = j14 - j10;
                int i14 = (j15 < 0 || j15 >= PlaybackStateCompat.ACTION_SET_REPEAT_MODE) ? 1 : 0;
    ...
    private int A04(InterfaceC3286lN interfaceC3286lN, C2124Gt c2124Gt) throws IOException {
        int iA07 = this.A0N.A07(interfaceC3286lN, c2124Gt, this.A0P);
        if (iA07 == 1 && c2124Gt.A00 == 0) {
            A0A();
        }
        return iA07;
    }

    public static int A05(C2171Ip c2171Ip, long j10) {
        int iA00 = c2171Ip.A00(j10);
        if (iA00 == -1) {
            return c2171Ip.A01(j10);
        }
        return iA00;
    }

    public static long A06(C2171Ip c2171Ip, long j10, long j11) {
        int iA05 = A05(c2171Ip, j10);
        if (iA05 == -1) {
            return j11;
        }
        return Math.min(c2171Ip.A06[iA05], j11);
    }

    private final C2126Gv A07(long j10, int i10) {
        long jA06;
        long j11;
        int mainTrackIndex;
        ...
        if (i11 != -1) {
            C2171Ip c2171Ip = this.A0G[i11].A04;
            int iA05 = A05(c2171Ip, j10);
            if (iA05 == -1) {
                return new C2126Gv(C2128Gx.A04);
            }
            j11 = c2171Ip.A07[iA05];
            jA06 = c2171Ip.A06[iA05];
            if (A0R[6].length() != 29) {
                throw new RuntimeException();
            }
            A0R[1] = "zbT5rN6sguJCvWwII8HLCHwSkH7sQNQT";
            if (j11 < j10 && iA05 < c2171Ip.A01 - 1 && (mainTrackIndex = c2171Ip.A01(j10)) != -1 && mainTrackIndex != iA05) {
                j12 = c2171Ip.A07[mainTrackIndex];
                jA062 = c2171Ip.A06[mainTrackIndex];
            }
        } else {
            jA06 = Long.MAX_VALUE;
            if (A0R[4].length() != 11) {
        ...
        if (i10 == -1) {
            for (int i12 = 0; i12 < this.A0G.length; i12++) {
                if (i12 != this.A03) {
                    C2171Ip sampleTable = this.A0G[i12].A04;
        ...
        C2128Gx c2128Gx = new C2128Gx(j11, jA06);
        if (j12 == -9223372036854775807L) {
            return new C2126Gv(c2128Gx);
        }
        return new C2126Gv(c2128Gx, new C2128Gx(j12, jA062));
    }

    public static /* synthetic */ C2168Im A08(C2168Im c2168Im) {
        return c2168Im;
    }
    ...
    private void A0B() {
        if (this.A02 == 2 && (this.A0I & 2) != 0) {
            ...
            this.A0E.A6G();
            this.A0E.AIN(new C3281lI(-9223372036854775807L));
        }
    }

    private void A0D(long j10) throws C17652i {
        while (!this.A0O.isEmpty() && this.A0O.peek().A00 == j10) {
            C3258kj c3258kjPop = this.A0O.pop();
            if (((II) c3258kjPop).A00 == 1836019574) {
                A0G(c3258kjPop);
                this.A0O.clear();
                this.A04 = 2;
            } else if (!this.A0O.isEmpty()) {
                C3258kj containerAtom = this.A0O.peek();
                containerAtom.A08(c3258kjPop);
            }
        }
        if (this.A04 != 2) {
            A0A();
    ...
    private void A0F(InterfaceC3286lN interfaceC3286lN) throws IOException {
        this.A0M.A0d(8);
        interfaceC3286lN.AG9(this.A0M.A0l(), 0, 8);
        IO.A0Q(this.A0M);
        interfaceC3286lN.AJJ(this.A0M.A09());
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    private void A0G(com.facebook.ads.redexgen.core.C3258kj r36) throws com.facebook.ads.redexgen.core.C17652i {
        /*
            Method dump skipped, instruction units count: 462
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C3247kY.A0G(com.facebook.ads.redexgen.X.kj):void");
    }

    private void A0H(C2158Ic c2158Ic, long j10) {
        C2171Ip c2171Ip = c2158Ic.A04;
        int sampleIndex = c2171Ip.A00(j10);
        if (sampleIndex == -1) {
            sampleIndex = c2171Ip.A01(j10);
        }
        c2158Ic.A00 = sampleIndex;
        if (A0R[2].length() == 19) {
            throw new RuntimeException();
        }
    ...
    */
    public static boolean A0J(int r4) {
        /*
            ...
            java.lang.String[] r1 = com.facebook.ads.redexgen.core.C3247kY.A0R
            r0 = 4
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 11
            ...
            throw r0
        L20:
            java.lang.String[] r2 = com.facebook.ads.redexgen.core.C3247kY.A0R
        ...
        L91:
            ...
            goto L6f
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C3247kY.A0J(int):boolean");
    }

    private boolean A0K(InterfaceC3286lN interfaceC3286lN) throws IOException {
        C3258kj containerAtom;
        if (this.A00 == 0) {
            if (!interfaceC3286lN.AGh(this.A0J.A0l(), 0, 8, true)) {
                A0B();
                return false;
            }
            this.A00 = 8;
        ...
        if (this.A09 == 1) {
            ...
            interfaceC3286lN.readFully(this.A0J.A0l(), 8, 8);
            ...
            if (jA8G != -1) {
                this.A09 = (jA8G - interfaceC3286lN.A8f()) + ((long) this.A00);
            }
        }
        if (this.A09 >= this.A00) {
            if (A0I(this.A01)) {
                long jA8f = (interfaceC3286lN.A8f() + this.A09) - ((long) this.A00);
                if (this.A09 != this.A00 && this.A01 == 1835365473) {
                    A0F(interfaceC3286lN);
                }
                this.A0O.push(new C3258kj(this.A01, jA8f));
                if (this.A09 == this.A00) {
                    A0D(jA8f);
                } else {
                    A0A();
                ...
                A0E(interfaceC3286lN.A8f() - ((long) this.A00));
                this.A0D = null;
                this.A04 = 1;
            }
            return true;
        }
        throw C17652i.A00(A09(0, 48, 61));
    }

    private boolean A0L(InterfaceC3286lN interfaceC3286lN, C2124Gt c2124Gt) throws IOException {
        long j10 = this.A09 - ((long) this.A00);
        long atomEndPosition = interfaceC3286lN.A8f() + j10;
        boolean z10 = false;
        C4J c4j = this.A0D;
        if (c4j != null) {
            interfaceC3286lN.readFully(c4j.A0l(), this.A00, (int) j10);
            if (this.A01 == 1718909296) {
                this.A02 = A02(c4j);
            } else if (!this.A0O.isEmpty()) {
                this.A0O.peek().A09(new C3257ki(this.A01, c4j));
            }
        } else if (j10 < PlaybackStateCompat.ACTION_SET_REPEAT_MODE) {
            interfaceC3286lN.AJJ((int) j10);
        } else {
            long atomPayloadSize = interfaceC3286lN.A8f();
            c2124Gt.A00 = atomPayloadSize + j10;
            z10 = true;
        }
        A0D(atomEndPosition);
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static long[][] A0N(com.facebook.ads.redexgen.core.C2158Ic[] r16) {
        /*
            Method dump skipped, instruction units count: 214
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C3247kY.A0N(com.facebook.ads.redexgen.X.Ic[]):long[][]");
    }
    ...
    public final int AGb(InterfaceC3286lN interfaceC3286lN, C2124Gt c2124Gt) throws IOException {
        while (true) {
            switch (this.A04) {
                case 0:
                    if (!A0K(interfaceC3286lN)) {
                        return -1;
                    }
                    break;
                    break;
                case 1:
                    if (A0L(interfaceC3286lN, c2124Gt)) {
                        return 1;
                    }
                    break;
                case 2:
                    return A03(interfaceC3286lN, c2124Gt);
                case 3:
                    return A04(interfaceC3286lN, c2124Gt);
                default:
    ...
    public final boolean AJL(InterfaceC3286lN interfaceC3286lN) throws IOException {
        return AbstractC2166Ik.A02(interfaceC3286lN, (this.A0I & 2) != 0);
    }
}
