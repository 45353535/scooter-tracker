...
public abstract class AbstractC2147Hr extends RelativeLayout implements Wf {
    ...
    public final AbstractC2892eW A03;
    ...
    public abstract C2765cR getFullScreenAdStyle();

    static {
        A17();
        A0G = (int) (AbstractC2523Wl.A02 * 80.0f);
    }

    public AbstractC2147Hr(C2820dL c2820dL, YY yy, US us, AbstractC3095hy abstractC3095hy, int i10, boolean z10, boolean z11, InterfaceC2551Xn interfaceC2551Xn, int i11) {
        super(c2820dL);
        this.A0A = new XH();
        this.A01 = false;
        this.A00 = A16(0, 0, 48);
        this.A03 = new C2148Hs(this);
        this.A02 = i10;
        this.A07 = c2820dL;
        this.A05 = z10;
        this.A04 = z11;
        ...
        this.A08 = us;
        this.A0D = new C2893eX(this, 1, new WeakReference(this.A03), c2820dL);
        this.A0D.A0W(abstractC3095hy.A0i());
        this.A0D.A0X(abstractC3095hy.A0j());
        this.A09 = C2519Wh.A00(this.A07, this.A06, this);
        if (this.A06.A1U()) {
    ...
    public C2893eX getAdViewabilityChecker() {
        return this.A0D;
    }
