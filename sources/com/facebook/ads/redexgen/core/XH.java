...
public final class XH {
    ...
    public static void A02() {
        A0I = new byte[]{0, Ascii.FF, 115, Ascii.DEL, 60, 51, 54, 60, 52, 56, 42, 62, 45, 59, Ascii.VT, 54, 50, 58, 101, Ascii.DEL, 75, 78, 122, 69, 89, 67, 94, 67, 69, 68, 114, 94, 91, 111, 80, 76, 86, 75, 86, 80, 81, 102, 105, 102, 99, 105, 97, 78, 111, 102, 107, 115, 94, 99, 103, 111, 119, 120, 125, 119, Ascii.DEL, 76, 47, 32, 37, 47, 39, Ascii.NAK, 95, 80, 85, 95, 87, 89, 88, 106, 85, 89, 75, 104, 93, 91, 1, 10, 0, 48, 13, 9, 1, 115, 120, 114, 78, 46, 37, 47, Ascii.DC2, Ascii.DC4, Ascii.GS, 0, 17, Ascii.ETB, 108, 97, 109, 99, 108, 112, 56, 34, Ascii.DC2, 61, 56, 50, 58, Ascii.SYN, 36, 48, 35, 53, Ascii.DC4, Utf8.REPLACEMENT_BYTE, 48, 51, 61, 52, 53, 107, 113, 84, 71, 66, 79, 83, 85, 126, 118, 101, 96, 109, 113, 119, 93, Ascii.SO, Ascii.EM, Ascii.US, 19, Ascii.SO, Ascii.CAN, Ascii.NAK, Ascii.DC2, Ascii.ESC, 92, Ascii.NAK, 17, Ascii.FF, Ascii.SO, Ascii.EM, Ascii.SI, Ascii.SI, Ascii.NAK, 19, Ascii.DC2, 70, 92, 99, 100, 113, 98, 100, 68, 121, 125, 117, 115, 116, 97, 114, 116, 88, 36, 35, 54, 37, 35, Ascii.SO, Ascii.SI, 17, Ascii.FS, Ascii.FF, Ascii.DLE};
    }
    ...
    private EnumC2528Wq A00() {
        if (this.A0G == null || this.A0F == null) {
            return EnumC2528Wq.A0J;
        }
        View view = this.A0G;
        String[] strArr = A0J;
        if (strArr[6].length() == strArr[4].length()) {
            ...
            strArr2[4] = "";
            if (view != this.A0F) {
                EnumC2528Wq enumC2528Wq = EnumC2528Wq.A0H;
                String[] strArr3 = A0J;
            ...
            Object tag = this.A0G.getTag(EnumC2528Wq.A02);
            if (tag == null) {
                return EnumC2528Wq.A0I;
            }
            if (!(tag instanceof EnumC2528Wq)) {
                EnumC2528Wq enumC2528Wq2 = EnumC2528Wq.A0K;
                if (A0J[2].charAt(2) == 'm') {
                    A0J[0] = "fnwPYOgaVMSkQLAdq2SZMccx8Jl2b0fK";
                    return enumC2528Wq2;
                }
            } else {
                return (EnumC2528Wq) tag;
            }
        }
        throw new RuntimeException();
    }
    ...
    public final void A06(C2820dL c2820dL, MotionEvent motionEvent, View view, View view2) {
        if (view == null) {
            c2820dL.A0F().AK0();
            return;
        }
        ...
        switch (motionEvent.getAction()) {
            case 0:
                this.A04 = (int) (iArr[0] / AbstractC2523Wl.A02);
                this.A05 = (int) (iArr[1] / AbstractC2523Wl.A02);
                this.A06 = (int) (view.getWidth() / AbstractC2523Wl.A02);
                this.A03 = (int) (view.getHeight() / AbstractC2523Wl.A02);
                this.A09 = 1;
                this.A0E = System.currentTimeMillis();
                this.A0A = (int) (((((int) (motionEvent.getX() + 0.5f)) + iArr2[0]) - iArr[0]) / AbstractC2523Wl.A02);
                int touchStartYInPx = (((int) (motionEvent.getY() + 0.5f)) + iArr2[1]) - iArr[1];
                this.A0B = (int) (touchStartYInPx / AbstractC2523Wl.A02);
            ...
            case 3:
                ...
                this.A07 = (int) (((((int) (motionEvent.getX() + 0.5f)) + iArr2[0]) - iArr[0]) / AbstractC2523Wl.A02);
                int touchEndYInPx = (((int) (motionEvent.getY() + 0.5f)) + iArr2[1]) - iArr[1];
                this.A08 = (int) (touchEndYInPx / AbstractC2523Wl.A02);
                this.A0F = view2;
                return;
            case 2:
