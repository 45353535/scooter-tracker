...
public final class LU extends AbstractC2567Yd {
    ...
    static {
        A01();
        A09 = (int) (AbstractC2523Wl.A02 * 4.0f);
        A08 = (int) (AbstractC2523Wl.A02 * 10.0f);
        A07 = (int) (AbstractC2523Wl.A02 * 44.0f);
    }

    public LU(C2820dL c2820dL, US us, String str) {
        super(c2820dL, us, str);
        this.A05 = c2820dL;
        this.A04 = O3.A00(c2820dL.A02());
    ...
    public final void A0N() {
        ...
        this.A01.setOnClickListener(new ViewOnClickListenerC2576Ym(this));
        this.A01.setContentDescription(A00(4, 18, 84));
        C2571Yh c2571Yh = new C2571Yh(this.A05);
        c2571Yh.setData(this.A04.A0H(), XX.HIDE_AD);
        c2571Yh.setOnClickListener(new ViewOnClickListenerC2577Yn(this, c2571Yh));
        C2571Yh c2571Yh2 = new C2571Yh(this.A05);
        c2571Yh2.setData(this.A04.A0L(), XX.REPORT_AD);
        c2571Yh2.setOnClickListener(new ViewOnClickListenerC2578Yo(this, c2571Yh2));
        C2571Yh c2571Yh3 = new C2571Yh(this.A05);
        c2571Yh3.setData(this.A04.A0M(), XX.AD_CHOICES_ICON);
        c2571Yh3.setOnClickListener(new ViewOnClickListenerC2579Yp(this, c2571Yh3));
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(-2, -2);
        layoutParams.setMargins(0, A09, A09, A09);
        XP.A0R(this.A03);
        this.A02.removeAllViews();
        this.A02.addView(c2571Yh, layoutParams);
        this.A02.addView(c2571Yh2, layoutParams);
        this.A02.addView(c2571Yh3, layoutParams);
    }
    ...
    public final void A0Q(O6 o62, O4 o42) {
        ...
        this.A01.setOnClickListener(new ViewOnClickListenerC2580Yq(this));
        ...
        for (O6 o63 : o62.A05()) {
            C2571Yh c2571Yh = new C2571Yh(this.A05);
            c2571Yh.setData(o63.A04(), null);
            c2571Yh.setOnClickListener(new ViewOnClickListenerC2581Yr(this, c2571Yh, o63));
            this.A02.addView(c2571Yh, layoutParams);
        }
    }
