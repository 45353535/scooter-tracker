...
public abstract class BZ implements InterfaceC3163jB<Character> {
    ...
    public static C17080b A02(final char match) {
        return new AbstractC17481p(match) { // from class: com.facebook.ads.redexgen.X.0b
    ...
    public int A08(CharSequence sequence, int start) {
        ...
        AbstractC3162jA.A01(start, length);
        while (start < length) {
