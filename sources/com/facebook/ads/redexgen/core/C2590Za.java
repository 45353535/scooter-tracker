...
public class C2590Za extends WebChromeClient {
    ...
    public final WeakReference<C2820dL> A00;
    ...
    public C2590Za(WeakReference<C2820dL> weakReference, WeakReference<ZY> weakReference2, WeakReference<ZT> weakReference3) {
    ...
    private boolean A02(ValueCallback valueCallback) {
        C2820dL c2820dL = this.A00.get();
        if (c2820dL != null && c2820dL.A0E() != null && LJ.A09) {
            if (LJ.A08 != null) {
            ...
            try {
                ...
                c2820dL.A0E().startActivityForResult(Intent.createChooser(intent, A00(3, 12, 84)), 1001);
                return true;
            } catch (Exception e10) {
                c2820dL.A08().AAz(A00(80, 8, 33), AbstractC2433Sv.A2d, new C2434Sw(e10));
