...
public final class C17280v extends AbstractC18947h {
    ...
    public int A03;
    public long A05;
    public List<C3448o2> A07;
    public List<C3448o2> A08;
    public boolean A09;
    public boolean A0A;
    public boolean A0B;
    ...
    public static void A09() {
        A0I = new byte[]{10, 44, 40, Ascii.DEL, 121, 113, 13, 44, 42, 38, 45, 44, 59, 90, 125, 101, 114, Ascii.DEL, 122, 119, 51, 112, 123, 114, 125, 125, 118, Ascii.DEL, 61, 51, 87, 118, 117, 114, 102, Ascii.DEL, 103, 122, 125, 116, 51, 103, 124, 51, 80, 80, 34, 61, 7, Ascii.SYN, Ascii.SYN, 10, Ascii.SI, 5, 7, Ascii.DC2, Ascii.SI, 9, 8, 73, Ascii.RS, 75, Ascii.VT, Ascii.SYN, 82, 75, 5, 3, 7, 75, 80, 86, 94};
    }
    ...
    public C17280v(String str, int i10, long j10) {
    ...
    public static char A00(byte b10) {
        int index = A0K[(b10 & Ascii.DEL) - 32];
        return (char) index;
    }

    public static char A01(byte b10) {
        int index = A0O[b10 & Ascii.US];
        return (char) index;
    }

    public static char A02(byte b10) {
        int index = A0P[b10 & Ascii.US];
        return (char) index;
    }

    public static char A03(byte b10) {
        int index = A0N[b10 & Ascii.SI];
        return (char) index;
    }
    ...
    private List<C3448o2> A07() {
        int iMin = 2;
        int size = this.A0H.size();
        ArrayList arrayList = new ArrayList(size);
        for (int i10 = 0; i10 < size; i10++) {
            C3448o2 c3448o2A08 = this.A0H.get(i10).A08(Integer.MIN_VALUE);
            arrayList.add(c3448o2A08);
            if (c3448o2A08 != null) {
                int positionAnchor = c3448o2A08.A08;
                iMin = Math.min(iMin, positionAnchor);
            }
        }
        List<Cue> displayCues = new ArrayList<>(size);
        for (int i11 = 0; i11 < size; i11++) {
            C3448o2 c3448o2 = (C3448o2) arrayList.get(i11);
            if (c3448o2 != null) {
                int cueBuilderCount = c3448o2.A08;
                if (cueBuilderCount != iMin) {
                    c3448o2 = (C3448o2) C3M.A01(this.A0H.get(i11).A08(iMin));
                }
                displayCues.add(c3448o2);
            }
        }
        return displayCues;
    }
    ...
    */
    private void A0E(int r3) {
        ...
        L34:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C17280v.A0E(int):void");
    }
    ...
    @Override // com.facebook.ads.redexgen.core.AbstractC18947h
    /* JADX INFO: renamed from: A0W */
    public final /* bridge */ /* synthetic */ C18967j A5j() throws C3235kM {
        return super.A5j();
    }

    @Override // com.facebook.ads.redexgen.core.AbstractC18947h, com.facebook.ads.redexgen.core.C5O
    /* JADX INFO: renamed from: A0X, reason: merged with bridge method [inline-methods] */
    public final AbstractC18957i A5l() throws C3235kM {
        AbstractC18957i abstractC18957iA0Y;
        AbstractC18957i outputBuffer = super.A5l();
        if (outputBuffer != null) {
            return outputBuffer;
        }
        if (A0G() && (abstractC18957iA0Y = A0Y()) != null) {
            this.A07 = Collections.emptyList();
            this.A05 = -9223372036854775807L;
            abstractC18957iA0Y.A0C(A0V(), A0Z(), Long.MAX_VALUE);
            return abstractC18957iA0Y;
        }
        return null;
    }

    @Override // com.facebook.ads.redexgen.core.AbstractC18947h
    public final C3231kI A0Z() {
        this.A08 = this.A07;
        return new C3231kI((List) C3M.A01(this.A07));
    }

    @Override // com.facebook.ads.redexgen.core.AbstractC18947h
    /* JADX INFO: renamed from: A0a */
    public final /* bridge */ /* synthetic */ void AGZ(C18967j c18967j) throws C3235kM {
        super.AGZ(c18967j);
    }

    @Override // com.facebook.ads.redexgen.core.AbstractC18947h
    public final void A0b(C18967j c18967j) {
        ByteBuffer subtitleData = (ByteBuffer) C3M.A01(c18967j.A02);
    ...
    @Override // com.facebook.ads.redexgen.core.AbstractC18947h, com.facebook.ads.redexgen.core.InterfaceC3236kN
