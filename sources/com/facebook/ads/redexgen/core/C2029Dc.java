...
public class C2029Dc {
    ...
    public boolean A0A;
    public boolean A0B;
    public final C3024gi A0C;
    public final C2820dL A0D;
    public final US A0E;
    public final InterfaceC2825dQ A0F;
    public final InterfaceC2834dZ A0G;
    public final C2835da A0H;
     ...
     */
    public C2029Dc(C2820dL c2820dL, US us, InterfaceC2825dQ interfaceC2825dQ, String str, boolean z10, int i10, int i11, boolean z11, Bundle bundle, Map<String, String> map, InterfaceC2834dZ interfaceC2834dZ) {
        this.A02 = 0;
        this.A01 = 0;
        this.A05 = false;
        this.A0B = false;
        ...
        this.A0D = c2820dL;
        this.A0E = us;
        this.A0F = interfaceC2825dQ;
        this.A0J = str;
        this.A0K = map;
        this.A08 = z10;
        this.A07 = z11;
        this.A0G = interfaceC2834dZ;
        ArrayList arrayList = new ArrayList();
        arrayList.add(new C2031De(this, 0.5d, -1.0d, 2.0d, true));
        arrayList.add(new C2030Dd(this, 1.0E-7d, -1.0d, 0.001d, false));
        if (bundle != null) {
            this.A0C = new C3024gi(arrayList, bundle.getBundle(A0H(6, 16, 57)), this.A0G);
            this.A02 = bundle.getInt(A0H(97, 18, 74));
            this.A01 = bundle.getInt(A0H(79, 18, 108));
            this.A06 = bundle.getBoolean(A0H(POBCoreNativeConstants.POB_NATIVE_MAIN_IMG_H, 10, 97), false);
            this.A0A = bundle.getBoolean(A0H(171, 20, 71), false);
            this.A09 = bundle.getBoolean(A0H(156, 15, 59), false);
        } else {
            this.A02 = i10;
            this.A01 = i11;
            this.A0C = new C3024gi(arrayList, this.A0G);
        }
        this.A05 = U7.A2P(this.A0D);
        this.A0B = U7.A2T(this.A0D);
        this.A0H = new C2835da(new Handler(), this);
    }
    ...
    public Map<String, String> A0J(EnumC2827dS enumC2827dS) {
        int currentPositionInMillis = this.A0F.getCurrentPositionInMillis();
        int i10 = this.A00 + 1;
        this.A00 = i10;
        return A0K(enumC2827dS, currentPositionInMillis, i10);
    }

    private Map<String, String> A0K(EnumC2827dS enumC2827dS, int i10, int i11) {
        HashMap map = new HashMap();
        XM.A03(map, this.A0F.getVideoStartReason() == EnumC2836db.A02, !this.A0F.AAM());
        A0U(map);
        A0S(map);
        A0W(map, i10);
        A0V(map);
        A0T(map);
        A0n(enumC2827dS, map);
        map.put(A0H(0, 6, 24), String.valueOf(enumC2827dS.A00));
    ...
    private void A0M() {
        ...
        A0R(this.A0J, A0J(EnumC2827dS.A04));
    }
    ...
    private final void A0P(int i10, boolean z10, boolean z11) {
        ...
        if (i10 > this.A02) {
            ...
            if (z11 || i10 - this.A01 >= 5000) {
                String str = this.A0J;
                EnumC2827dS enumC2827dS = EnumC2827dS.A09;
                int i11 = this.A00 + 1;
                this.A00 = i11;
                A0R(str, A0K(enumC2827dS, i10, i11));
                this.A01 = this.A02;
                this.A0C.A05();
                return;
            }
        ...
        if (z10) {
            ...
            EnumC2827dS enumC2827dS2 = EnumC2827dS.A09;
            int i12 = this.A00 + 1;
            this.A00 = i12;
            A0R(str2, A0K(enumC2827dS2, i10, i12));
        }
    }
    ...
    private void A0S(Map<String, String> params) {
        ...
        params.put(A0H(122, 7, 81), String.valueOf(o0A00.A04() * 1000.0d));
        if (this.A04 != null) {
    ...
    public final Bundle A0c() {
        ...
        bundle.putBoolean(A0H(POBCoreNativeConstants.POB_NATIVE_MAIN_IMG_H, 10, 97), this.A06);
    ...
    public final void A0d() {
        ...
        A0R(this.A0J, A0J(EnumC2827dS.A07));
    }
    ...
    public final void A0e() {
        ...
        A0R(this.A0J, A0J(EnumC2827dS.A08));
    }
    ...
    public final void A0i(int i10) {
        ...
        this.A0C.A04();
        A0R(this.A0J, A0J(EnumC2827dS.A05));
        if (this.A05) {
            A0P(i10, false, true);
        } else {
    ...
    public final void A0m(InterfaceC2826dR interfaceC2826dR) {
        this.A03 = interfaceC2826dR;
    }

    public void A0n(EnumC2827dS enumC2827dS, Map<String, String> params) {
    }

    public final void A0o(C2029Dc c2029Dc) {
        c2029Dc.A06 = this.A06;
        c2029Dc.A07 = this.A07;
        c2029Dc.A0A = this.A0A;
        c2029Dc.A09 = this.A09;
        c2029Dc.A02 = this.A02;
        c2029Dc.A01 = this.A01;
    }
}
