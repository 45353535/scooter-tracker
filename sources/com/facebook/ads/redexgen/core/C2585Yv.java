...
public final class C2585Yv extends LinearLayout {
    public static final int A03 = (int) (AbstractC2523Wl.A02 * 40.0f);
    public static final int A04 = (int) (AbstractC2523Wl.A02 * 20.0f);
    public static final int A05 = (int) (AbstractC2523Wl.A02 * 10.0f);
    public final O6 A00;
    public final C2820dL A01;
    public final InterfaceC2569Yf A02;

    public C2585Yv(C2820dL c2820dL, O6 o62, InterfaceC2569Yf interfaceC2569Yf, XX xx) {
        this(c2820dL, o62, interfaceC2569Yf, null, xx);
    }

    public C2585Yv(C2820dL c2820dL, O6 o62, InterfaceC2569Yf interfaceC2569Yf, String str, XX xx) {
        super(c2820dL);
        this.A01 = c2820dL;
        this.A00 = o62;
        this.A02 = interfaceC2569Yf;
        setOrientation(1);
    ...
    private View A01(String str) {
        ...
        imageView.setOnClickListener(new ViewOnClickListenerC2583Yt(this));
        TextView textView = new TextView(getContext());
    ...
    private Z1 A03() {
        ...
        for (O6 o62 : this.A00.A05()) {
            C2571Yh c2571Yh = new C2571Yh(this.A01);
            c2571Yh.setData(o62.A04(), null);
            c2571Yh.setOnClickListener(new ViewOnClickListenerC2584Yu(this, c2571Yh, o62));
            z12.addView(c2571Yh);
        }
        return z12;
    }
