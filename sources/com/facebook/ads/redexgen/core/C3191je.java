...
public final class C3191je implements GX {
    ...
    public static final InterfaceC2106Gb A0C = new InterfaceC2106Gb() { // from class: com.facebook.ads.redexgen.X.jf
    ...
    */
    public final int AGb(com.facebook.ads.redexgen.core.InterfaceC3286lN r12, com.facebook.ads.redexgen.core.C2124Gt r13) throws java.io.IOException {
        /*
            Method dump skipped, instruction units count: 460
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C3191je.AGb(com.facebook.ads.redexgen.X.lN, com.facebook.ads.redexgen.X.Gt):int");
    }
    ...
    private void A00(long j10) {
        if (!this.A06) {
            ...
            if (this.A0A.A0C() != -9223372036854775807L) {
                this.A02 = new C3193jg(this.A0A.A0D(), this.A0A.A0C(), j10);
                this.A01.AIN(this.A02.A07());
            } else {
                this.A01.AIN(new C3281lI(this.A0A.A0C()));
            }
        }
    }

    public static /* synthetic */ GX[] A01() {
        return new GX[]{new C3191je()};
    }
    ...
    public final boolean AJL(InterfaceC3286lN interfaceC3286lN) throws IOException {
        ...
        interfaceC3286lN.AG9(bArr, 0, 14);
        ...
        interfaceC3286lN.A3z(packStuffingLength);
        interfaceC3286lN.AG9(bArr, 0, 3);
