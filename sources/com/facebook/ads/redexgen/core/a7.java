...
public final class a7 extends View {
    ...
    public static void A01() {
        A0D = new byte[]{96, 98, Ascii.DEL, 119, 98, 117, 99, 99};
    }

    static {
        A01();
        A0F = (int) (AbstractC2523Wl.A02 * 5.0f);
        A0G = (int) (AbstractC2523Wl.A02 * 4.0f);
        A0H = (int) (AbstractC2523Wl.A02 * 10.0f);
    }

    public a7(C2820dL c2820dL, boolean z10) {
        super(c2820dL);
