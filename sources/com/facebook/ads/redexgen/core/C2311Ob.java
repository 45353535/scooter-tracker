...
public class C2311Ob<K, V> {
    ...
    */
    public final V A0A(int r10) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2311Ob.A0A(int):java.lang.Object");
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof C2311Ob) {
            C2311Ob c2311Ob = (C2311Ob) obj;
            if (size() != c2311Ob.size()) {
                return false;
            }
            for (int i10 = 0; i10 < this.A00; i10++) {
                try {
                    K kA09 = A09(i10);
                    V vA0B = A0B(i10);
                    Object obj2 = c2311Ob.get(kA09);
                    if (vA0B == null) {
                        if (obj2 == null && c2311Ob.containsKey(kA09)) {
                        }
                        return false;
                    }
                    if (!vA0B.equals(obj2)) {
