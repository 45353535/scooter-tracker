...
public final class C2363Qc implements Ad, NativeAdBaseApi, Repairable, InterfaceC2486Ux {
    ...
    public static final WeakHashMap<View, WeakReference<C2363Qc>> A0o;
    public long A00;
    public Drawable A01;
    ...
    public EnumC2262Mc A08;
    public C3105iC A09;
    public C18836w A0A;
    public C3060hK A0B;
    public SL A0C;
    public TF A0D;
    public EnumC2474Ul A0E;
    public ViewOnClickListenerC2393Rg A0F;
    public QQ A0G;
    public C2480Ur A0H;
    public EnumC2481Us A0I;
    public V6 A0J;
    public YX A0K;
    public C2602Zm A0L;
    public C2731bt A0M;
    public C2796cw A0N;
    public AbstractC2892eW A0O;
    public AbstractC2892eW A0P;
    public C2893eX A0Q;
    public C2893eX A0R;
    public String A0S;
    public String A0T;
    public WeakReference<C2980fx> A0U;
    public WeakReference<AbstractC2892eW> A0V;
    public boolean A0W;
    public boolean A0X;
    public boolean A0Y;
    public boolean A0Z;
    ...
    public final InterfaceC2477Uo A0d;
    public final C2488Uz A0e;
    public final XH A0f;
    ...
    */
    private void A0g(android.view.View r13, android.view.View r14, java.util.List<android.view.View> r15, boolean r16) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2363Qc.A0g(android.view.View, android.view.View, java.util.List, boolean):void");
    }

    static {
        A0e();
        A0n = C2363Qc.class.getSimpleName();
        A0o = new WeakHashMap<>();
    }

    public C2363Qc(Context context, String str, InterfaceC2477Uo interfaceC2477Uo, boolean z10) {
        this.A0h = UUID.randomUUID().toString();
        this.A0J = V6.A06;
        this.A0E = EnumC2474Ul.A04;
        this.A08 = EnumC2262Mc.A03;
        ...
        this.A0e = new C2488Uz(this.A0c, this);
    }

    public C2363Qc(C2363Qc c2363Qc) {
        this((Context) c2363Qc.A0c, (String) null, c2363Qc.A0d, true);
        this.A0D = c2363Qc.A0D;
        this.A0a = c2363Qc.A0a;
        this.A0B = c2363Qc.A0B;
        this.A0j = true;
        this.A05 = new View(this.A0c);
    }

    public C2363Qc(C2820dL c2820dL, C3116iN c3116iN, TF tf2, InterfaceC2477Uo interfaceC2477Uo) {
        this((Context) c2820dL, (String) null, interfaceC2477Uo, true);
        this.A0a = c3116iN;
        this.A0D = tf2;
        this.A0j = true;
        this.A05 = new View(c2820dL);
    }

    public C2363Qc(C2820dL c2820dL, C3116iN c3116iN, TF tf2, InterfaceC2477Uo interfaceC2477Uo, C3060hK c3060hK) {
        this(c2820dL, c3116iN, tf2, interfaceC2477Uo);
        this.A0B = c3060hK;
    }
    ...
    private int A03() {
        ...
        C18836w c18836w = this.A0A;
        if (A0m[3].charAt(5) != 'B') {
            throw new RuntimeException();
        }
        A0m[5] = "Xt";
        if (c18836w == null || this.A0A.A0J() == null) {
            return 0;
        }
        return this.A0A.A0J().A09();
    }

    public static Drawable A05(C2820dL c2820dL, Bitmap bitmap, boolean z10, String str) {
        BitmapDrawable bitmapDrawableA00;
        BitmapDrawable bitmapDrawable = new BitmapDrawable(c2820dL.getResources(), bitmap);
        if (z10 && (bitmapDrawableA00 = AbstractC2795cv.A00(c2820dL, str)) != null) {
    ...
    private final C3116iN A0C() {
        C3116iN c3116iN = this.A0a;
        if (c3116iN != null && c3116iN.A0R()) {
            return c3116iN;
        }
        return null;
    }
    ...
    private C3104iB A0G(boolean z10) {
        if (this.A0a != null) {
            C3116iN c3116iN = this.A0a;
            if (A0m[3].charAt(5) == 'B') {
                String[] strArr = A0m;
    ...
    public static C2363Qc A0L(NativeAdBaseApi nativeAdBaseApi) {
        if (nativeAdBaseApi instanceof Proxy) {
            return (C2363Qc) ((C2382Qv) Proxy.getInvocationHandler(nativeAdBaseApi)).A04();
        }
        return (C2363Qc) nativeAdBaseApi;
    }
    ...
    public final C2478Up getAdChoicesIcon() {
        return A0F().A0D();
    }
    ...
    public final C2479Uq getAdStarRating() {
        return A0F().A0G();
    }
    ...
    private void A0h(FrameLayout frameLayout, String str) {
        ...
        this.A0N = AbstractC2795cv.A01(RB.A03(this.A0c), str);
        if (this.A0N != null) {
    ...
    private void A0i(C3116iN c3116iN, boolean z10) {
        if (c3116iN == null) {
            return;
        }
        boolean zEquals = this.A0E.equals(EnumC2474Ul.A04);
        String strA0W = A0W(596, 6, 7);
        if (zEquals) {
            C3104iB c3104iBA0E = c3116iN.A0E();
            String clientToken = c3116iN.A7G();
            if (!TextUtils.isEmpty(clientToken)) {
                this.A0b.A0e(new C2463Ua(clientToken, this.A0c.A0A()));
            }
            C2478Up c2478UpA0F = c3104iBA0E.A0F();
            String[] strArr = A0m;
            ...
            if (c2478UpA0F != null) {
                SD sd2 = new SD(c3104iBA0E.A0F().getUrl(), c3104iBA0E.A0F().getHeight(), c3104iBA0E.A0F().getWidth(), c3116iN.A0G(), A0W(596, 6, 7));
                sd2.A01 = this.A0C;
                this.A0b.A0W();
                this.A0b.A0c(sd2);
            }
            if (!this.A0J.equals(V6.A05)) {
                if (c3104iBA0E.A0E() != null) {
                    this.A0b.A0c(new SD(c3104iBA0E.A0E().getUrl(), c3104iBA0E.A0E().getHeight(), c3104iBA0E.A0E().getWidth(), c3116iN.A0G(), A0W(596, 6, 7)));
                }
                if (c3116iN.A0H() != null) {
                    for (C2363Qc c2363Qc : c3116iN.A0H()) {
                        if (c2363Qc.getAdCoverImage() != null) {
                            this.A0b.A0c(new SD(c2363Qc.getAdCoverImage().getUrl(), c2363Qc.getAdCoverImage().getHeight(), c2363Qc.getAdCoverImage().getWidth(), c3116iN.A0G(), A0W(596, 6, 7)));
                        }
                    }
                }
                String strA0b = c3104iBA0E.A0b();
                if (!TextUtils.isEmpty(strA0b)) {
                    this.A0b.A0b(new SB(strA0b, c3116iN.A0G(), A0W(596, 6, 7), c3104iBA0E.A0A()));
                }
            }
            AbstractC3095hy abstractC3095hyA0C = c3104iBA0E.A0C();
            if (abstractC3095hyA0C != null && abstractC3095hyA0C.A1Y()) {
                SB sb2 = new SB(abstractC3095hyA0C.A0s(), abstractC3095hyA0C.A17(), strA0W);
                sb2.A04 = true;
                sb2.A03 = A0W(0, 5, 66);
                this.A0b.A0Y(sb2);
            }
        }
        this.A0b.A0X(new T7(this, c3116iN, z10), new S8(c3116iN.A0G(), strA0W));
    }

    private void A0j(InterfaceC2264Me interfaceC2264Me) {
        if (this.A0a == null) {
            return;
        }
        this.A0a.A0K(interfaceC2264Me);
    }

    public static void A0k(NativeAdImageApi nativeAdImageApi, ImageView imageView, C2820dL c2820dL) {
        if (nativeAdImageApi != null && imageView != null) {
            new KZ(imageView, c2820dL).A05(nativeAdImageApi.getHeight(), nativeAdImageApi.getWidth()).A07(nativeAdImageApi.getUrl());
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean A0q() {
        return A19() == EnumC2483Uu.A05 || A19() == EnumC2483Uu.A03;
    }
    ...
    public final C3116iN A0z() {
        return this.A0a;
    }

    public final AbstractC3095hy A10() {
        return A0F().A0C();
    }
    ...
    public final C2480Ur A17() {
        return this.A0H;
    }

    public final EnumC2481Us A18() {
        return this.A0I;
    }

    public final EnumC2483Uu A19() {
        return A0F().A0H();
    }
    ...
    public final void A1J() {
        ...
        AbstractC2567Yd abstractC2567YdA01 = AbstractC2568Ye.A01(this.A0c, this.A0c.A0A(), A1C(), this.A07);
        if (abstractC2567YdA01 == null) {
            A0b();
        } else {
            ((C2963fg) this.A07.getNativeAdLayoutApi()).A03(abstractC2567YdA01);
    ...
    public final void A1W(C3116iN c3116iN) {
        A0i(c3116iN, true);
        if (this.A0G != null && c3116iN.A0H() != null) {
            T9 t92 = new T9(this);
            for (C2363Qc c2363Qc : c3116iN.A0H()) {
                if (A0m[3].charAt(5) != 'B') {
                    throw new RuntimeException();
    ...
    public final void A1X(C2980fx c2980fx) {
        this.A0U = new WeakReference<>(c2980fx);
    }

    public final void A1Y(EnumC2474Ul enumC2474Ul, String str, SL sl) {
        if (str == null) {
            this.A0c.A0F().A3I();
        } else {
            this.A0c.A0F().A3H();
        ...
        if (strArr[0].charAt(21) != strArr[4].charAt(21)) {
            ...
            if (z10) {
                ...
                if (!integrationErrorMode.equals(integrationErrorModeA00)) {
                    ...
                    C2434Sw c2434Sw = new C2434Sw(strA0W);
                    A12().A08().AAy(A0W(550, 3, 101), AbstractC2433Sv.A0c, c2434Sw);
                } else {
                    throw new C2286Nb(strA0W);
                }
            }
            this.A0j = true;
            this.A0E = enumC2474Ul;
            if (enumC2474Ul.equals(EnumC2474Ul.A05)) {
                EnumC2262Mc enumC2262Mc = EnumC2262Mc.A05;
                if (A0m[3].charAt(5) == 'B') {
                    A0m[3] = "N11XMBa1eBkGGouoRChlRsXEwEtHvHDZ";
                    this.A08 = enumC2262Mc;
                }
            }
            this.A0C = sl;
            NT nt = new NT(this.A0g, this.A0J, A0R(), null, 1, new C3052hB());
            nt.A05(enumC2474Ul);
            nt.A06(this.A0S);
            nt.A07(this.A0T);
            this.A0A = new C18836w(this.A0c, nt);
    ...
    public final void A1Z(C2480Ur c2480Ur) {
        this.A0H = c2480Ur;
    }

    public final void A1a(EnumC2481Us enumC2481Us) {
        this.A0I = enumC2481Us;
    }
    ...
    public final void A1c(AbstractC2892eW abstractC2892eW) {
        this.A0V = new WeakReference<>(abstractC2892eW);
    }
    ...
    public final void A1f(boolean z10, boolean z11) {
        String strA0W;
        if (z10) {
            if (this.A0E.equals(EnumC2474Ul.A05)) {
                boolean zA0r = A0r();
                if (A0m[3].charAt(5) != 'B') {
                    throw new RuntimeException();
                }
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2486Ux
    public final int A7V() {
        View view = this.A06;
        if (view instanceof AdNativeComponentView) {
            View videoView = ((AdNativeComponentView) view).getAdContentsView();
            if (videoView instanceof C2833dY) {
                return ((C2833dY) videoView).getCurrentPosition();
            }
            return -1;
        }
        return -1;
    ...
    public final NativeAdBase.NativeAdLoadConfigBuilder buildLoadAdConfig(NativeAdBase nativeAdBase) {
        return new C2484Uv(this, nativeAdBase);
    }
    ...
    public final Drawable getPreloadedIconViewDrawable() {
        C2478Up c2478UpA0F;
        Bitmap bitmapA0N;
        C3116iN adapter = this.A0a;
        if (adapter != null && (c2478UpA0F = A0F().A0F()) != null && (bitmapA0N = this.A0b.A0N(c2478UpA0F.getUrl())) != null) {
    ...
    public final void loadAd() {
        ...
        A1Y(EnumC2474Ul.A00(NativeAdBase.MediaCacheFlag.ALL), null, new SL(false, -1, -1));
    }
    ...
    public final void loadAd(NativeAdBase.NativeLoadAdConfig nativeLoadAdConfig) {
        ...
        ((C2484Uv) nativeLoadAdConfig).A00();
    }
    ...
    */
    public final void unregisterView() {
        /*
            ...
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C2363Qc.unregisterView():void");
    }
}
