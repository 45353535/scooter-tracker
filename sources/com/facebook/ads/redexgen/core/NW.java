...
public abstract class NW {
    ...
    public static void A02() {
        A00 = new byte[]{-121, -122, UnsignedBytes.MAX_POWER_OF_TWO, -109, 125, -126, -120, 121, 123, -122, 117, -120, 125, -125, -126, -109, 121, -122, -122, -125, -122, -109, -127, -125, 120, 121, -109, Ascii.DEL, 121, -115};
    }

    public static AdSettings.IntegrationErrorMode A00(C2820dL c2820dL) {
        ...
        if (integrationErrorMode == integrationErrorMode2 && !A03(c2820dL)) {
    ...
    public static boolean A03(C2820dL c2820dL) {
        return (c2820dL.getApplicationInfo().flags & 2) != 0;
    }
}
