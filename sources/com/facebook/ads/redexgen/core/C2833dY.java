...
public final class C2833dY extends RelativeLayout {
    ...
    public int A00;
    public C17722p A01;
    public WeakReference<InterfaceC2832dX> A02;
    public final InterfaceC2888eS A03;

    public C2833dY(C2820dL c2820dL, InterfaceC2888eS interfaceC2888eS) {
        super(c2820dL);
        this.A00 = 0;
        this.A03 = interfaceC2888eS;
    ...
    public final void A01(AnimatorSet animatorSet, boolean z10) {
        if (z10) {
            ...
            C2830dV c2830dV = new C2830dV(this);
            this.A03.getView().setOutlineProvider(c2830dV);
            if (this.A01 != null) {
                this.A01.setClipToOutline(true);
                this.A01.setOutlineProvider(c2830dV);
            }
    ...
    public final void A02(AbstractC2027Da abstractC2027Da) {
        addView(abstractC2027Da, new RelativeLayout.LayoutParams(-1, -1));
        this.A01 = (C17722p) abstractC2027Da;
    }

    public final void A03(AbstractC2027Da abstractC2027Da) {
    ...
    public final void onMeasure(int i10, int i11) {
        ...
        WeakReference<InterfaceC2832dX> weakReference = this.A02;
    ...
    public void setRoundedCornersVideoStyle(float f10) {
        this.A03.getView().setClipToOutline(true);
        this.A03.getView().setOutlineProvider(new C2831dW(this, f10));
    }

    public void setViewImplInflationListener(InterfaceC2832dX interfaceC2832dX) {
        this.A02 = new WeakReference<>(interfaceC2832dX);
    }
}
