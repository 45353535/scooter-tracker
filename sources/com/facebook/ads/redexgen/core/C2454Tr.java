...
public final class C2454Tr {
    ...
    public C2454Tr(File file) {
        this.A00 = file;
    }

    public static C2454Tr A00(String str, Context context) throws IOException {
        File filesDir = new File(context.getFilesDir(), A01(64, 9, 96));
        A03(filesDir);
        File fbsdklogDir = new File(filesDir, str);
        A03(fbsdklogDir);
        return new C2454Tr(fbsdklogDir);
    }
    ...
    public static void A03(File file) throws IOException {
        if (file.exists() || file.mkdir()) {
            if (file.isDirectory()) {
                ...
                throw new C2455Ts(String.format(Locale.US, A01(0, 33, 62), file.getCanonicalPath()));
            }
        }
        throw new C2455Ts(String.format(Locale.US, A01(33, 31, 59), file.getCanonicalPath()));
    }

    public final C2454Tr A04(String str) throws IOException {
        File file = new File(this.A00, str);
        A03(file);
        return new C2454Tr(file);
    }
