...
public abstract class AbstractC2282Mx {
    ...
    public static List<C2274Mp> A01(JSONArray jSONArray, JSONObject jSONObject, C2820dL c2820dL, N1 n12) {
        ...
        for (int i10 = 0; i10 < jSONArray.length(); i10++) {
            try {
                ...
                C2274Mp c2274MpA00 = C2274Mp.A00(jSONObject2);
                n12.A3q(c2274MpA00, jSONObject2);
                arrayList.add(c2274MpA00);
            } catch (JSONException e10) {
                c2820dL.A08().AAy(A00(8, 7, 90), AbstractC2433Sv.A2B, new C2434Sw(e10));
            }
        }
        return arrayList;
    }
