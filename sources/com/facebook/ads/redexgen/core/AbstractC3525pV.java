...
public abstract class AbstractC3525pV<F, T> implements Iterator<T> {
    ...
    public AbstractC3525pV(Iterator<? extends F> backingIterator) {
        this.A00 = (Iterator) AbstractC3162jA.A04(backingIterator);
    }
