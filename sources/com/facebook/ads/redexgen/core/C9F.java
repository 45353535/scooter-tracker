...
public final class C9F implements InterfaceC3345mM, InterfaceC3346mN {
    ...
    public long A01;
    public long A02;
    public InterfaceC3346mN A03;
    public C3349mQ[] A04 = new C3349mQ[0];
    public final InterfaceC3345mM A05;

    public C9F(InterfaceC3345mM interfaceC3345mM, boolean z10, long j10, long j11) {
        this.A05 = interfaceC3345mM;
    ...
    private C7I A00(long j10, C7I c7i) {
        long toleranceBeforeUs = AbstractC18094a.A0T(c7i.A01, 0L, j10 - this.A01);
        long jA0T = AbstractC18094a.A0T(c7i.A00, 0L, this.A00 == Long.MIN_VALUE ? Long.MAX_VALUE : this.A00 - j10);
    ...
    public final void ACs(InterfaceC3345mM interfaceC3345mM) {
        ((InterfaceC3346mN) C3M.A01(this.A03)).ACs(this);
    }

    public static boolean A02(long j10, InterfaceC3307lj[] interfaceC3307ljArr) {
        if (j10 != 0) {
            for (InterfaceC3307lj interfaceC3307lj : interfaceC3307ljArr) {
                if (interfaceC3307lj != null) {
                    C3497or c3497orA8u = interfaceC3307lj.A8u();
                    if (!AbstractC17642h.A0G(c3497orA8u.A0W, c3497orA8u.A0R)) {
                        return true;
                    }
                }
            }
    ...
    public final void AEk(InterfaceC3345mM interfaceC3345mM) {
        ...
        ((InterfaceC3346mN) C3M.A01(this.A03)).AEk(this);
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC3345mM
    public final void AGL(InterfaceC3346mN interfaceC3346mN, long j10) {
        this.A03 = interfaceC3346mN;
    ...
    public final long AGg() {
        ...
        InterfaceC3345mM interfaceC3345mM = this.A05;
        if (A06[2].length() == 0) {
            throw new RuntimeException();
        }
        A06[6] = "ABWUoGiNBoa";
        long jAGg2 = interfaceC3345mM.AGg();
    ...
    */
    public final long AIP(com.facebook.ads.redexgen.core.InterfaceC3307lj[] r18, boolean[] r19, com.facebook.ads.redexgen.core.InterfaceC2018Cr[] r20, boolean[] r21, long r22) {
        /*
