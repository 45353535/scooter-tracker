...
public final class C3181jU implements InterfaceC2217Kj {
    ...
    public static void A01() {
        A08 = new byte[]{-68, -95, -24, -16, -11, -69, -95, -34, 17, 9, -2, -4, 13, -2, -3, -71, -5, 5, 8, -4, 4, -71, Ascii.FF, 2, 19, -2, -45, -71};
    }
    ...
    public final boolean AI9(InterfaceC3286lN interfaceC3286lN, long j10) throws IOException {
        ...
        while (true) {
            ...
            int iAI5 = this.A06.AI5(interfaceC3286lN, (int) Math.min(this.A03 - this.A00, j11), true);
            if (iAI5 == -1) {
                j11 = 0;
            } else {
                this.A00 += iAI5;
        ...
        if (i11 > 0) {
            long jA0U = this.A02 + AbstractC18094a.A0U(this.A01, 1000000L, this.A07.A04);
            int i12 = i11 * i10;
    ...
    public C3181jU(GY gy, H1 h12, C2219Kl c2219Kl, String str, int i10) throws C17652i {
        this.A05 = gy;
        this.A06 = h12;
        this.A07 = c2219Kl;
        int i11 = (c2219Kl.A05 * c2219Kl.A01) / 8;
        int bytesPerFrame = c2219Kl.A02;
        if (bytesPerFrame == i11) {
            int bytesPerFrame2 = c2219Kl.A04;
            int constantBitrate = bytesPerFrame2 * i11 * 8;
            int bytesPerFrame3 = c2219Kl.A04;
            ...
            int bytesPerFrame5 = c2219Kl.A05;
            C2D c2dA0b = c2dA0h.A0b(bytesPerFrame5);
            int bytesPerFrame6 = c2219Kl.A04;
        ...
        int bytesPerFrame7 = c2219Kl.A02;
        throw C17652i.A01(sbAppend.append(bytesPerFrame7).toString(), null);
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC2217Kj
    public final void AA0(int i10, long j10) {
        this.A05.AIN(new C3179jS(this.A07, 1, i10, j10));
