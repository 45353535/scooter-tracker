 118, 106, 101, 104, 69, 103, 112, 109, 114, 109, 112, 125, 109, 97, 99, 32, 104, 111, 109, 107, 108, 97, 97, 101, 32, 101, 111, 122, 111, 96, 111, 66, 78, 79, 71, 72, 70, 126, 82, 84, 81, 81, 78, 83, 85, 82, 108, 84, 77, 85, 72, 118, 72, 79, 69, 78, 86, 3, Ascii.SI, Ascii.SO, 6, 9, 7, Utf8.REPLACEMENT_BYTE, 19, Ascii.NAK, Ascii.DLE, Ascii.DLE, Ascii.SI, Ascii.DC2, Ascii.DC4, 19, 51, Ascii.DLE, Ascii.FF, 9, Ascii.DC4, 51, 3, Ascii.DC2, 5, 5, Ascii.SO, 45, Ascii.NAK, Ascii.FF, Ascii.DC4, 9, 55, 9, Ascii.SO, 4, Ascii.SI, Ascii.ETB, 5, Ascii.DC4, 3, 7, Ascii.DC2, 3, 57, 8, 3, 17, 57, Ascii.DC2, 7, 4, 75, 79, 4, Ascii.VT, Ascii.SO, Ascii.SYN, 7, Ascii.DLE, 7, 6, 61, 1, Ascii.SO, Ascii.VT, 1, 9, 61, 6, 7, Ascii.SO, 3, Ascii.ESC, 61, Ascii.SI, 17, 39, 46, 33, 43, 35, 42, 61, Ascii.ESC, 38, 34, 42, Ascii.ETB, Ascii.VT, Ascii.VT, Ascii.SI, 36, 56, 56, 60, 118, 99, 99, 60, 32, 45, 53, 98, 43, 35, 35, 43, 32, 41, 98, 47, 35, 33, 99, Utf8.REPLACEMENT_BYTE, 56, 35, 62, 41, 99, 45, 60, 60, Utf8.REPLACEMENT_BYTE, 99, 38, 58, 58, 62, 61, 82, 78, 78, 74, 73, 0, Ascii.NAK, Ascii.NAK, 74, 86, 91, 67, Ascii.DC4, 93, 85, 85, 93, 86, 95, Ascii.DC4, 89, 85, 87, Ascii.NAK, 94, 5, Ascii.CAN, Ascii.NAK, SignedBytes.MAX_POWER_OF_TWO, 71, 90, 93, 72, 71, 93, 118, 78, 72, 68, 76, 90, 61, 39, Ascii.VT, 55, 53, 55, Ascii.VT, 50, 61, 56, 32, 49, 38, Ascii.VT, 55, 56, 61, 55, Utf8.REPLACEMENT_BYTE, 39, Ascii.VT, 59, 58, Ascii.VT, 55, 32, 53, 13, Ascii.ETB, 59, 7, Ascii.SYN, 1, 5, Ascii.DLE, 13, Ascii.DC2, 1, 59, 5, Ascii.ETB, 59, 7, Ascii.DLE, 5, 59, Ascii.DC2, 86, 106, 102, 117, 108, 98, 115, 85, 76, 95, 72, 86, 91, 67, 57, 37, 40, 48, 103, 46, 38, 38, 46, 37, 44, 103, 42, 38, 36, 53, 34, 52, 46, 61, 34, 10, 40, 35, 34, 35, 56, Utf8.REPLACEMENT_BYTE, 39, 35, 51, Ascii.US, 50, 65, 94, 82, SignedBytes.MAX_POWER_OF_TWO, 99, 78, 71, 82};
    }
    ...
    private int A00(C2820dL c2820dL) {
        PackageInfo packageInfo;
        try {
            PackageManager packageManager = c2820dL.getPackageManager();
    ...
    public static Intent A02(C2820dL c2820dL, Uri uri) {
        Intent intentA01 = A01(uri);
        intentA01.addCategory(A07(212, 33, 20));
        intentA01.addFlags(268435456);
        intentA01.putExtra(A07(288, 34, 93), c2820dL.getPackageName());
    ...
    public static Intent A03(C2820dL c2820dL, Uri uri) {
        Intent intentA01 = A01(uri);
        intentA01.setPackage(A07(322, 19, 35));
        intentA01.putExtra(A07(259, 8, 30), c2820dL.getPackageName());
        intentA01.putExtra(A07(682, 7, 117), true);
        return intentA01;
    }

    public static Uri A04(C2820dL c2820dL, Uri uri) {
    ...
    private final ME A05(C2820dL c2820dL, Uri uri, String str, Map<String, String> map) throws W9 {
        boolean zA05 = U8.A05(c2820dL);
        boolean isInAppBrowserEnabled = A0F(uri);
        if (isInAppBrowserEnabled && zA05) {
            A0C(c2820dL, uri, str, map);
            ME me2 = ME.A08;
            if (A01[7].length() == 30) {
        ...
        c2820dL.A0F().A9p(zA05);
        A0A(c2820dL, uri);
        return ME.A07;
    }

    public static ME A06(WN wn, C2820dL c2820dL, Uri uri, String str, Map<String, String> extraData) throws W9 {
        ...
        if (!isGooglePlayWebLink && !z10) {
            return wn.A05(c2820dL, uri, str, extraData);
        }
        try {
            wn.A0B(c2820dL, uri, str);
            return ME.A03;
        } catch (WL unused) {
            return wn.A05(c2820dL, uri, str, extraData);
        }
    ...
    private void A0A(C2820dL c2820dL, Uri uri) throws W9 {
        WB.A0D(c2820dL, A02(c2820dL, uri));
    }

    private final void A0B(C2820dL c2820dL, Uri uri, String str) throws W9, WL {
        if (A0H(c2820dL)) {
            if (U7.A1H(c2820dL)) {
                ...
                if (!TextUtils.isEmpty(queryParameter)) {
                    ...
                    AbstractC2307Nw.A03(queryParameter, strA07, packageName);
                }
            }
            boolean z10 = (c2820dL.A0H().A01() && U7.A1b(c2820dL)) || (U7.A1z(c2820dL) && A0I(c2820dL));
            if (!z10) {
                boolean shouldTryToOpenSplitScreen = U7.A2L(c2820dL);
                if (shouldTryToOpenSplitScreen) {
                    boolean shouldTryToOpenSplitScreen2 = WB.A0E(c2820dL, A03(c2820dL, uri));
                    if (shouldTryToOpenSplitScreen2) {
                        return;
                    }
                }
            }
            boolean zA0M = A0M(c2820dL, uri, str);
            if (A01[3].charAt(29) != 'Z') {
            ...
            boolean shouldTryToOpenSplitScreen3 = A0K(c2820dL, uri);
            if (shouldTryToOpenSplitScreen3) {
                return;
            }
            Intent intentA02 = A02(c2820dL, uri);
            intentA02.setPackage(A07(322, 19, 35));
            if (Build.VERSION.SDK_INT >= 24 && z10) {
                intentA02.addFlags(268472320);
            }
            WB.A0D(c2820dL, intentA02);
            return;
        }
        throw new WL();
    }

    private void A0C(C2820dL c2820dL, Uri uri, String str, Map<String, String> map) {
        AdActivityIntent adActivityIntentA05 = WB.A05(c2820dL);
        if (!ProcessUtils.isRemoteRenderingProcess()) {
            adActivityIntentA05.addFlags(268435456);
        }
        adActivityIntentA05.putExtra(A07(722, 8, 120), EnumC2490Vb.A03);
        ...
        try {
            WB.A0B(c2820dL, adActivityIntentA05);
        } catch (W9 e10) {
            ...
            c2820dL.A08().AAy(A07(168, 11, 110), AbstractC2433Sv.A0D, new C2434Sw(cause2));
            Log.e(A07(149, 17, 28), A07(50, 90, 84), cause2);
        }
    }

    public static void A0D(WN wn, C2820dL c2820dL, Uri uri, String str) {
        wn.A0N(c2820dL, uri, str);
    }

    public static void A0E(WN wn, C2820dL c2820dL, Uri uri, String str) throws W9 {
        A06(wn, c2820dL, uri, str, null);
    }
    ...
    */
    ...
    private boolean A0G(C2820dL c2820dL) {
        if (!U7.A1E(c2820dL)) {
            return false;
        }
        int deviceFBVersion = U7.A0E(c2820dL);
        int iA00 = A00(c2820dL);
    ...
    private boolean A0H(C2820dL c2820dL) {
        Intent playStoreIntent = new Intent(A07(186, 26, 10), WQ.A00(A07(548, 34, 3)));
        Iterator<ResolveInfo> it = c2820dL.getPackageManager().queryIntentActivities(playStoreIntent, 0).iterator();
        do {
  ...
  0x0079: PHI (r5v2 java.lang.String) = (r5v0 java.lang.String), (r5v3 java.lang.String) binds: [B:33:0x00d7, B:19:0x0077] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    /*
        ...
        To view partially-correct code enable 'Show inconsistent code' option in preferences
    */
    public static boolean A0I(com.facebook.ads.redexgen.core.C2820dL r12) {
        /*
    ...
    public static boolean A0J(C2820dL c2820dL) {
        ActivityInfo activityInfo;
        try {
            Activity activityA0E = c2820dL.A0E();
            PackageManager packageManager = c2820dL.getPackageManager();
            ...
            c2820dL.A0F().ABV(e10.getMessage());
        }
        return false;
    }

    public static boolean A0K(C2820dL c2820dL, Uri uri) {
        ...
        try {
            ...
            if (packageInfo != null && !TextUtils.isEmpty(packageInfo.versionName)) {
                ...
                if (Integer.parseInt(strArrSplit[0]) < U7.A0G(c2820dL)) {
                    c2820dL.A0F().AB3(3);
                    return false;
                }
            }
            Intent intent = new Intent(A07(186, 26, 10));
            String packageName = c2820dL.getPackageName();
            intent.setPackage(strA07);
            Uri hsdpUri = A04(c2820dL, uri);
            if (hsdpUri == null) {
                return false;
            }
    ...
    private boolean A0L(C2820dL c2820dL, Uri uri, String str) throws W9 {
        try {
            Activity activityA0E = c2820dL.A0E();
            ...
            if (activityA0E != null && !TextUtils.isEmpty(string)) {
                ...
                if (U7.A1F(c2820dL)) {
                    String strA06 = AbstractC3095hy.A06(str);
            ...
            c2820dL.A0F().AB2(e10.getMessage());
            return false;
        }
    }

    private boolean A0M(C2820dL c2820dL, Uri uri, String str) throws W9 {
        return A0G(c2820dL) && A0L(c2820dL, uri, str);
    }

    private final boolean A0N(C2820dL c2820dL, Uri uri, String str) {
        return WB.A0G(c2820dL, uri, str);
    }

    public static boolean A0O(WN wn, C2820dL c2820dL, Uri uri, String str) {
        try {
            A0E(wn, c2820dL, uri, str);
            return true;
        } catch (W9 e10) {
            Throwable cause = e10.getCause();
            W9 cause2 = e10;
            ...
            c2820dL.A08().AAy(A07(168, 11, 110), AbstractC2433Sv.A05, new C2434Sw(cause2));
            return false;
        }
    }
}
