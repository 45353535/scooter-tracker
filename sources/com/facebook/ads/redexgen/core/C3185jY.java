...
public class C3185jY implements KW {
    ...
    public final /* synthetic */ C3184jX A04;
    public final C4I A03 = new C4I(new byte[5]);
    public final SparseArray<InterfaceC2213Kf> A01 = new SparseArray<>();
    ...
    */
    public final void A52(com.facebook.ads.redexgen.core.C4J r13) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C3185jY.A52(com.facebook.ads.redexgen.X.4J):void");
    }

    public C3185jY(C3184jX c3184jX, int i10) {
        this.A04 = c3184jX;
        this.A00 = i10;
    }

    private C2209Kb A00(C4J c4j, int i10) {
                ...
                if (positionOfNextDescriptor == 127) {
                    ...
                    if (positionOfNextDescriptor == 10) {
                        ...
                        while (c4j.A09() < iA09) {
                            ...
                            c4j.A0k(bArr, 0, 4);
                            arrayList.add(new C2208Ka(strTrim2, iA0I, bArr));
                        }
        ...
        return new C2209Kb(i11, strTrim, arrayList, Arrays.copyOfRange(c4j.A0l(), descriptorTag, descriptorLength));
    }
