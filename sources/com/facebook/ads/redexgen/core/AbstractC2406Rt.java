...
public abstract class AbstractC2406Rt {
    ...
    public static C2405Rs A00(ContentResolver contentResolver) {
        ...
        try {
            ...
            if (c10 == null || !c10.moveToFirst()) {
                return new C2405Rs(null, null, false);
            }
            String string = c10.getString(c10.getColumnIndex(strA013));
            String attributionId = c10.getString(c10.getColumnIndex(strA012));
            C2405Rs c2405Rs = new C2405Rs(string, attributionId, Boolean.valueOf(c10.getString(c10.getColumnIndex(strA01))).booleanValue());
            if (c10 != null) {
                c10.close();
            }
            return c2405Rs;
