...
public final class C3175jO implements InterfaceC2223Kp {
    ...
    public final C2233Kz A03 = new C2233Kz();
 ...
 INTERFACE call: com.facebook.ads.redexgen.X.LA.AGk(java.lang.String, int, java.lang.String, java.lang.Long, java.lang.Long, com.facebook.ads.redexgen.X.Kv):void A[MD:(java.lang.String, int, java.lang.String, java.lang.Long, java.lang.Long, com.facebook.ads.redexgen.X.Kv):void (m)], block:B:49:0x0135 */
    ...
    private File A02(C2229Kv c2229Kv, String str, String str2, int i10, C2232Ky c2232Ky) throws Exception {
        C2229Kv c2229Kv2;
        String strAGk;
        C2229Kv c2229Kv3;
        String strAGk2;
        ...
        try {
            ...
            C3170jI c3170jI = new C3170jI(file, new AbstractC3174jN(jA0R) { // from class: com.facebook.ads.redexgen.X.7f
                ...
                @Override // com.facebook.ads.redexgen.core.AbstractC3174jN
                public final boolean A08(File file2, long j10, int i11) {
                    return j10 <= this.A00;
                }

                @Override // com.facebook.ads.redexgen.core.AbstractC3174jN, com.facebook.ads.redexgen.core.L0
            ...
            if (c3170jI.A09()) {
                if (this.A08) {
                    String str4 = A03(49, 22, 36) + c3170jI.A00.getName();
                }
                this.A06.put(str3, file);
                c3170jI.A06();
                this.A04.AGl(str3, true, c2229Kv);
                return file;
            }
            if (this.A08) {
                String str5 = A03(71, 26, 76) + c3170jI.A00.getName();
            }
            if (!c2232Ky.A04()) {
                return null;
            }
            this.A04.AGl(str3, false, c2229Kv);
            for (int i11 = 0; i11 < this.A00; i11++) {
                try {
                    ...
                    str3 = str3;
                    try {
                        A05(sq, c3170jI, str3, i10, i11, jCurrentTimeMillis);
                        break;
                    } catch (L6 e10) {
                        e = e10;
                        if (i11 == this.A00 - 1) {
                            A06(c3170jI);
                            if (e instanceof C3171jJ) {
                                throw ((C3171jJ) e);
                            }
                            if (e instanceof C3166jE) {
                                throw ((C3166jE) e);
                            }
                        }
                    }
            ...
            int iA03 = c3170jI.A03();
            c3170jI.A06();
            long jCurrentTimeMillis2 = System.currentTimeMillis() - jCurrentTimeMillis;
            c2232Ky.A00().A55(file, this.A04);
            this.A06.put(str3, file);
            this.A04.AGk(str3, 2112, null, Long.valueOf(iA03), Long.valueOf(jCurrentTimeMillis2), c2229Kv);
            return file;
        } catch (C3166jE e12) {
            this.A04.AGk(strAGk2, 2113, e12.toString(), null, null, c2229Kv3);
            if (!this.A08) {
                return null;
            }
            ...
            this.A04.AGk(strAGk, 2119, e13.toString(), null, null, c2229Kv2);
            if (!this.A08) {
                return null;
            }
        ...
        try {
            ...
            while (true) {
                ...
                if (i10 != -1) {
                    ...
                    return new C3172jK(byteArrayOutputStream.toByteArray());
                }
            }
  ...
  0x00b5: PHI (r21v2 int) = (r21v0 int), (r21v1 int) binds: [B:26:0x00ac, B:27:0x00ae] A[DONT_GENERATE, DONT_INLINE], TRY_ENTER, TRY_LEAVE, TryCatch #7 {all -> 0x00c8, blocks: (B:25:0x00aa, B:28:0x00b5), top: B:105:0x00aa }] */
    ...
    */
    private void A05(android.content.Context r24, com.facebook.ads.redexgen.core.C3170jI r25, java.lang.String r26, int r27, int r28, long r29) throws java.lang.Exception {
        /*
            Method dump skipped, instruction units count: 532
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C3175jO.A05(android.content.Context, com.facebook.ads.redexgen.X.jI, java.lang.String, int, int, long):void");
    }

    private void A06(C3170jI c3170jI) {
        try {
            File fileA04 = c3170jI.A04();
            if (fileA04.exists()) {
                c3170jI.A06();
    ...
    private boolean A07(C3170jI c3170jI) {
        try {
            c3170jI.A05();
    ...
    public final <T> C2225Kr<T> A08(C2229Kv c2229Kv, C2232Ky<T> c2232Ky) {
        Semaphore semaphore;
        if (c2232Ky.A03()) {
            File file = this.A06.get(c2229Kv.A09);
            if (file != null) {
                this.A04.AGl(c2229Kv.A09, true, c2229Kv);
                return c2232Ky.A00().A3p(file, this.A04);
            }
            this.A04.AGl(c2229Kv.A09, false, c2229Kv);
            return new C2225Kr<>(false, null);
        }
        String str = c2229Kv.A09;
        String str2 = c2229Kv.A04;
        ...
        try {
            semaphore.acquire();
            File fileA02 = A02(c2229Kv, str, extension, this.A01, c2232Ky);
            if (fileA02 != null) {
                C2225Kr<T> c2225KrA3p = c2232Ky.A00().A3p(fileA02, this.A04);
                semaphore.release();
                synchronized (this.A07) {
                    this.A07.remove(extension);
                }
            ...
            C2225Kr<T> c2225Kr = new C2225Kr<>(false, null);
            semaphore.release();
            synchronized (this.A07) {
                this.A07.remove(extension);
            }
            ...
            C2225Kr<T> c2225Kr2 = new C2225Kr<>(false, null);
            semaphore.release();
            synchronized (this.A07) {
                this.A07.remove(extension);
                return c2225Kr2;
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2223Kp
    public final C2225Kr<Bitmap> AHu(C2229Kv c2229Kv, boolean z10) {
        return A08(c2229Kv, new C2232Ky(new C3178jR(c2229Kv.A01, c2229Kv.A00, this.A02.A04(), this.A02.A03(), z10)));
    }
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2223Kp
    public final File AHv(C2229Kv c2229Kv) {
        C2232Ky c2232Ky = new C2232Ky(new C3177jQ());
        c2232Ky.A01(true);
        c2232Ky.A02(false);
        return (File) A08(c2229Kv, c2232Ky).A00();
    }

    @Override // com.facebook.ads.redexgen.core.InterfaceC2223Kp
    public final String AHw(C2229Kv c2229Kv) {
        return (String) A08(c2229Kv, new C2232Ky(new C3176jP())).A00();
    }
    ...
    @Override // com.facebook.ads.redexgen.core.InterfaceC2223Kp
    public final String AHx(C2229Kv c2229Kv) {
        C2232Ky c2232Ky = new C2232Ky(new C3176jP());
        c2232Ky.A01(true);
        c2232Ky.A02(false);
        return (String) A08(c2229Kv, c2232Ky).A00();
    }
}
