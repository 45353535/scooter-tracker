...
public final class C3041gz implements InterfaceC2287Nc {
    ...
    static {
        A0A();
        A0A = C3041gz.class.getSimpleName();
    }

    public C3041gz(C3037gv c3037gv, InterfaceC2303Ns interfaceC2303Ns, String str) {
        this.A08 = c3037gv;
        this.A06 = c3037gv.A05();
        this.A07 = new C3026gk(str, interfaceC2303Ns, this);
    }
    ...
    public final C3037gv A0E() {
        return this.A08;
    }

    public final C2820dL A0F() {
        return this.A06;
    }
    ...
    public final void A0G(EnumSet<CacheFlag> cacheFlags, String str) {
        ...
        if (this.A04 && !U7.A0i(this.A06)) {
            this.A06.A08().AAy(A09(130, 3, 68), AbstractC2433Sv.A0L, new C2434Sw(A09(78, 52, 22)));
        ...
        nt.A07(this.A08.A09());
        nt.A04(this.A08.A03());
        this.A03 = new C18856y(this.A06, nt);
        this.A03.A0S(new C3045h4(this));
        this.A03.A0W(str);
    }
    ...
    public final boolean A0J() {
        ...
        if (this.A03 == null) {
            this.A06.A08().AAy(A09(130, 3, 68), AbstractC2433Sv.A0S, new C2434Sw(AdErrorType.INTERSTITIAL_CONTROLLER_IS_NULL.getDefaultErrorMessage()));
            this.A06.A0F().A3F(XG.A01(this.A00), adError.getErrorCode(), adError.getErrorMessage());
            this.A07.onError(this.A08.A6c(), adError);
            return false;
        }
