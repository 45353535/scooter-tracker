...
public class C3229kG<V> implements Iterator<V> {
    public final Collection<V> A00;
    public final Iterator<V> A01;
    public final /* synthetic */ C3230kH A02;
    ...
    public C3229kG(final C3230kH this$1) {
        this.A02 = this$1;
        this.A00 = this.A02.A00;
        this.A01 = AbstractC17411i.A05(this$1.A00);
    }

    /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.kG != com.google.common.collect.AbstractMapBasedMultimap<K, V>$WrappedCollection$WrappedIterator */
    public C3229kG(final C3230kH this$1, Iterator<V> delegateIterator) {
        this.A02 = this$1;
        this.A00 = this.A02.A00;
    ...
    public final void remove() {
        this.A01.remove();
        AbstractC17411i.A01(this.A02.A04);
        this.A02.A05();
    }
}
