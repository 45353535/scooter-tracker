...
public class C2459Tw {
     ...
     */
    public static C2459Tw A04(File file) throws IOException {
        try {
            ...
            if (j11 < 0 || j11 > SilenceSkippingAudioProcessor.DEFAULT_MINIMUM_SILENCE_DURATION_US) {
            ...
            return new C2459Tw(randomAccessFile, jArr, randomAccessFile.length());
    ...
    public C2459Tw(RandomAccessFile randomAccessFile, long[] jArr, long j10) throws IOException {
    ...
    public static C2459Tw A03(File file) throws IOException {
        RandomAccessFile randomAccessFile = new RandomAccessFile(file, A05(416, 3, 33));
        try {
            randomAccessFile.writeLong(-360011992771067903L);
            randomAccessFile.writeLong(C2460Tx.A03);
            randomAccessFile.write(new byte[C2460Tx.A03 * 8]);
            randomAccessFile.getFD().sync();
            return new C2459Tw(randomAccessFile, new long[C2460Tx.A03], randomAccessFile.length());
        } catch (IOException unused) {
