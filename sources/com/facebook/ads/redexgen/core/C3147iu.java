...
public final class C3147iu implements M5 {
    public static byte[] A04;
    public static final String[] A05;
    public String A00;
    public String A01;
    public final SparseArray<M4> A02 = new SparseArray<>();
    public final InterfaceC18214m A03;
    ...
    public final void AAj(HashMap<String, M4> map, SparseArray<String> sparseArray) throws IOException {
        ...
        try {
            if (AbstractC18234o.A00(this.A03.getReadableDatabase(), 1, (String) C3M.A01(this.A00)) != 1) {
    ...
    public C3147iu(InterfaceC18214m interfaceC18214m) {
        this.A03 = interfaceC18214m;
    }
    ...
    private void A04(SQLiteDatabase sQLiteDatabase) throws C18204l {
        AbstractC18234o.A04(sQLiteDatabase, 1, (String) C3M.A01(this.A00), 1);
    ...
    public static void A08(InterfaceC18214m interfaceC18214m, String str) throws C18204l {
        try {
            String strA02 = A02(str);
            SQLiteDatabase writableDatabase = interfaceC18214m.getWritableDatabase();
            writableDatabase.beginTransactionNonExclusive();
            try {
                AbstractC18234o.A03(writableDatabase, 1, str);
    ...
    @Override // com.facebook.ads.redexgen.core.M5
    public final void A5h() throws C18204l {
        A08(this.A03, (String) C3M.A01(this.A00));
    }

    @Override // com.facebook.ads.redexgen.core.M5
    public final boolean A6K() throws C18204l {
        try {
            return AbstractC18234o.A00(this.A03.getReadableDatabase(), 1, (String) C3M.A01(this.A00)) != -1;
        } catch (SQLException e10) {
            throw new C18204l(e10);
        }
    }
