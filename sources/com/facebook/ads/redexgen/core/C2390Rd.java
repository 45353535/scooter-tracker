...
public class C2390Rd {
    ...
    public C2390Rd(String str, String str2, String str3, boolean z10, String str4) {
        this.A03 = str;
        this.A02 = str2;
        this.A01 = str3;
        this.A04 = z10;
    ...
    public static C2390Rd A00(JSONObject jSONObject) throws JSONException {
        return new C2390Rd(jSONObject.getString(A01(30, 3, 49)), jSONObject.getString(A01(26, 4, 87)), jSONObject.optString(A01(5, 9, 106)), jSONObject.getString(A01(14, 8, 37)).equals(A01(22, 4, 109)), jSONObject.optString(A01(0, 5, 69)));
    }
}
