...
public final class C2571Yh extends LinearLayout {
    public boolean A00;
    public final ImageView A01;
    public final TextView A02;
    public static final int A04 = (int) (AbstractC2523Wl.A02 * 16.0f);
    public static final int A05 = (int) (AbstractC2523Wl.A02 * 12.0f);
    public static final int A06 = (int) (AbstractC2523Wl.A02 * 12.0f);
    public static final int A03 = (int) (AbstractC2523Wl.A02 * 16.0f);

    public C2571Yh(C2820dL c2820dL) {
        super(c2820dL);
        this.A00 = false;
        setOrientation(0);
