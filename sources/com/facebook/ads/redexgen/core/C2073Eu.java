...
public final class C2073Eu {
    ...
    public static final Comparator<C2072Et> A08 = new Comparator() { // from class: com.facebook.ads.redexgen.X.Eq
        @Override // java.util.Comparator
        public final int compare(Object obj, Object obj2) {
            return C2073Eu.A00((C2072Et) obj, (C2072Et) obj2);
        }
    };
    public static final Comparator<C2072Et> A09 = new Comparator() { // from class: com.facebook.ads.redexgen.X.Er
        @Override // java.util.Comparator
        public final int compare(Object obj, Object obj2) {
            return Float.compare(((C2072Et) obj).A00, ((C2072Et) obj2).A00);
        }
    };
    public int A01;
    public int A02;
    ...
    public final C2072Et[] A06 = new C2072Et[5];
    public final ArrayList<C2072Et> A05 = new ArrayList<>();
    public int A00 = -1;

    public C2073Eu(int i10) {
        this.A04 = i10;
    }

    public static /* synthetic */ int A00(C2072Et c2072Et, C2072Et c2072Et2) {
        return c2072Et.A01 - c2072Et2.A01;
    }
    ...
    private final void A04(int i10, float f10) {
        C2072Et oldestSample;
        A02();
        if (this.A02 > 0) {
            C2072Et[] c2072EtArr = this.A06;
            int i11 = this.A02 - 1;
            this.A02 = i11;
            oldestSample = c2072EtArr[i11];
        } else {
            oldestSample = new C2072Et();
        }
        int i12 = this.A01;
        this.A01 = i12 + 1;
        ...
        while (this.A03 > this.A04) {
            ...
            C2072Et c2072Et = this.A05.get(0);
            if (c2072Et.A02 <= excessWeight) {
                this.A03 -= c2072Et.A02;
                this.A05.remove(0);
                if (this.A02 < 5) {
                    C2072Et[] c2072EtArr2 = this.A06;
                    int excessWeight2 = this.A02;
                    this.A02 = excessWeight2 + 1;
                    c2072EtArr2[excessWeight2] = c2072Et;
                }
            } else {
                c2072Et.A02 -= excessWeight;
    ...
    public final float A05(float f10) {
        ...
        while (true) {
            ...
            if (i11 < size) {
                C2072Et c2072Et = this.A05.get(i11);
                i10 += c2072Et.A02;
                float desiredWeight = i10;
                if (desiredWeight >= f11) {
                    float desiredWeight2 = c2072Et.A00;
    ...
    public final void A07(int i10, float f10) {
        C2072Et oldestSample;
        if (MetaExoPlayerUpgradeConfig.A03(EnumC3096i2.A1G)) {
            A04(i10, f10);
            return;
        }
        A02();
