...
public class DynamicLoaderFactory {
    ...
    class a implements Runnable {
        ...
        final /* synthetic */ Context f19609b;

        /* JADX INFO: renamed from: c, reason: collision with root package name */
        final /* synthetic */ boolean f19610c;

        /* JADX INFO: renamed from: d, reason: collision with root package name */
        final /* synthetic */ MultithreadedBundleWrapper f19611d;

        /* JADX INFO: renamed from: e, reason: collision with root package name */
        final /* synthetic */ AudienceNetworkAds.InitListener f19612e;
        ...
        a(Context context, boolean z10, MultithreadedBundleWrapper multithreadedBundleWrapper, AudienceNetworkAds.InitListener initListener) {
            ...
            this.f19610c = z10;
            this.f19611d = multithreadedBundleWrapper;
            this.f19612e = initListener;
        }
        ...
        public void run() {
            ...
            int i10;
            ANActivityLifecycleCallbacksListener.registerActivityCallbacks(this.f19609b);
            synchronized (DynamicLoaderFactory.class) {
                ...
                while (i11 < 3) {
                    try {
                        dynamicLoaderDoMakeLoader = DynamicLoaderFactory.doMakeLoader(this.f19609b, false);
                        break;
                    } finally {
                        if (i11 == i10) {
                            try {
            ...
            DynamicLoaderFactory.doCallInitialize(this.f19609b, dynamicLoader, th2, this.f19610c, this.f19611d, this.f19612e);
    ...
    class b implements Runnable {
        ...
        /* JADX INFO: renamed from: b, reason: collision with root package name */
        final /* synthetic */ AudienceNetworkAds.InitListener f19613b;

        /* JADX INFO: renamed from: c, reason: collision with root package name */
        final /* synthetic */ Throwable f19614c;

        b(AudienceNetworkAds.InitListener initListener, Throwable th2) {
            this.f19613b = initListener;
            this.f19614c = th2;
        }

        @Override // java.lang.Runnable
        public void run() {
            this.f19613b.onInitialized(DynamicLoaderFactory.createErrorInitResult(this.f19614c));
        }
    }
    ...
    class c implements AudienceNetworkAds.InitResult {
        ...
        final /* synthetic */ Throwable f19615a;
        ...
        public String getMessage() {
            return DynamicLoaderFactory.createErrorMessage(this.f19615a);
        }
