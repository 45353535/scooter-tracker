...
import com.facebook.ads.redexgen.core.C17571y;
...
public final class ColorInfo implements C1S, Parcelable {
    ...
    public static void A08() {
        A05 = new byte[]{49, 97, 109, 59, 45, 75, 73, 75, 73, 59, 45, 79, 73, 72, 62, 40, 75, 76, 69, 32, Ascii.FF, Ascii.SI, Ascii.FF, 17, 42, 13, 5, Ascii.FF, 75, 13, 62, 39, 39, 107, 57, 42, 37, 44, 46, 71, 97, 109, 109, 97, 32, 50, 46, 50, 42, 46, 37, 122, 95, 91, 95, 66, 83, 82, Ascii.SYN, 68, 87, 88, 81, 83, 92, 121, 126, 117, 113, 98, 83, 68, 82, 32, 83, 77, 80, 84, 69, 32, 49, 55, 48, 77, 39, 32, 70, 68, 76, SignedBytes.MAX_POWER_OF_TWO, 84, 36, 37, 74, 113, 123, 122, 121, 118, 113, 122, 123, Utf8.REPLACEMENT_BYTE, 124, 112, 115, 112, 109, Utf8.REPLACEMENT_BYTE, 109, 126, 113, 120, 122, 121, 66, 72, 73, 74, 69, 66, 73, 72, Ascii.FF, 79, 67, SignedBytes.MAX_POWER_OF_TWO, 67, 94, Ascii.FF, 95, 92, 77, 79, 73, 47, Ascii.DC4, Ascii.RS, Ascii.US, Ascii.FS, 19, Ascii.DC4, Ascii.US, Ascii.RS, 90, Ascii.EM, Ascii.NAK, Ascii.SYN, Ascii.NAK, 8, 90, Ascii.SO, 8, Ascii.ESC, Ascii.DC4, 9, Ascii.FS, Ascii.US, 8, 9, 50, 47, 57, 40, 124, Utf8.REPLACEMENT_BYTE, 51, 48, 51, 46, 124, 46, 61, 50, 59, 57, 90, 97, 124, 106, 123, 47, 108, 96, 99, 96, 125, 47, 124, Ascii.DEL, 110, 108, 106, 58, 1, Ascii.FS, 10, Ascii.ESC, 79, Ascii.FF, 0, 3, 0, Ascii.GS, 79, Ascii.ESC, Ascii.GS, Ascii.SO, 1, Ascii.FS, 9, 10, Ascii.GS, 1, 32, 53, 48};
    }

    static {
        A08();
        A09 = new ColorInfo(1, 2, 3, null);
        A0A = new C17571y().A01(1).A00(1).A02(2).A03();
    ...
    public ColorInfo(Parcel parcel) {
        ...
        boolean hasHdrStaticInfo = AbstractC18094a.A1C(parcel);
    ...
    public final C17571y A0A() {
        return new C17571y(this);
    }
    ...
    public final void writeToParcel(Parcel parcel, int i10) {
        ...
        AbstractC18094a.A0w(parcel, this.A04 != null);
        if (this.A04 != null) {
