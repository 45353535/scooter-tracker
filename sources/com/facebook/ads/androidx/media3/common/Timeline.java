...
import com.facebook.ads.redexgen.core.AbstractC1964Am;
import com.facebook.ads.redexgen.core.C17401h;
import com.facebook.ads.redexgen.core.C19389m;
...
import com.facebook.ads.redexgen.core.C3466oL;
import com.facebook.ads.redexgen.core.C3468oN;
...
public abstract class Timeline implements C1S {
    ...
    public static final String A05 = AbstractC18094a.A0h(0);
    public static final String A03 = AbstractC18094a.A0h(1);
    public static final String A04 = AbstractC18094a.A0h(2);
    ...
    public abstract C3468oN A0I(int i10, C3468oN c3468oN, boolean z10);

    public abstract C3466oL A0L(int i10, C3466oL c3466oL, long j10);
    ...
    public static C19389m A02(Bundle bundle) {
        final AbstractC1964Am abstractC1964AmA04 = A04(C3466oL.A0J, C3R.A00(bundle, A05));
        final AbstractC1964Am abstractC1964AmA042 = A04(C3468oN.A08, C3R.A00(bundle, A03));
        final int[] intArray = bundle.getIntArray(A04);
        if (intArray == null) {
            intArray = A05(abstractC1964AmA04.size());
        }
        return new Timeline(abstractC1964AmA04, abstractC1964AmA042, intArray) { // from class: com.facebook.ads.redexgen.X.9m
            ...
            public final AbstractC1964Am<C3468oN> A00;
            public final AbstractC1964Am<C3466oL> A01;
            ...
            /* JADX WARN: Incorrect condition in loop: B:7:0x001b */
            {
                ...
                L28:
                    return
                */
                throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.core.C19389m.<init>(com.facebook.ads.redexgen.X.Am, com.facebook.ads.redexgen.X.Am, int[]):void");
            }
            ...
            @Override // com.facebook.ads.androidx.media3.common.Timeline
            public final C3468oN A0I(int i10, C3468oN p10, boolean z10) {
                C3468oN p11 = this.A00.get(i10);
            ...
            @Override // com.facebook.ads.androidx.media3.common.Timeline
            public final C3466oL A0L(int i10, C3466oL c3466oL, long j10) {
                C3466oL c3466oL2 = this.A01.get(i10);
                c3466oL.A07(c3466oL2.A0C, c3466oL2.A09, c3466oL2.A0A, c3466oL2.A06, c3466oL2.A07, c3466oL2.A04, c3466oL2.A0G, c3466oL2.A0D, c3466oL2.A08, c3466oL2.A02, c3466oL2.A03, c3466oL2.A00, c3466oL2.A01, c3466oL2.A05);
                c3466oL.A0F = c3466oL2.A0F;
                return c3466oL;
            }
    ...
    public static <T extends C1S> AbstractC1964Am<T> A04(C1R<T> c1r, IBinder iBinder) {
        if (iBinder == null) {
            return AbstractC1964Am.A03();
        }
        C17401h c17401h = new C17401h();
        AbstractC1964Am<Bundle> abstractC1964AmA00 = C1Q.A00(iBinder);
        for (int i10 = 0; i10 < abstractC1964AmA00.size(); i10++) {
            c17401h.A04(c1r.A6X(abstractC1964AmA00.get(i10)));
        }
        return c17401h.A05();
    }
    ...
    public final int A09(int i10, C3468oN c3468oN, C3466oL c3466oL, int i11, boolean z10) {
        int i12 = A0H(i10, c3468oN).A00;
        int windowIndex = A0K(i12, c3466oL).A01;
        if (windowIndex == i10) {
            int nextWindowIndex = A08(i12, i11, z10);
            if (nextWindowIndex == -1) {
                return -1;
            }
            int windowIndex2 = A0K(nextWindowIndex, c3466oL).A00;
            return windowIndex2;
        }
    ...
    @Deprecated
    public final Pair<Object, Long> A0D(C3466oL c3466oL, C3468oN c3468oN, int i10, long j10) {
        return A0E(c3466oL, c3468oN, i10, j10);
    }

    public final Pair<Object, Long> A0E(C3466oL c3466oL, C3468oN c3468oN, int i10, long j10) {
        return (Pair) C3M.A01(A0G(c3466oL, c3468oN, i10, j10, 0L));
    }

    @Deprecated
    public final Pair<Object, Long> A0F(C3466oL c3466oL, C3468oN c3468oN, int i10, long j10, long j11) {
        return A0G(c3466oL, c3468oN, i10, j10, j11);
    }

    public final Pair<Object, Long> A0G(C3466oL c3466oL, C3468oN c3468oN, int i10, long j10, long j11) {
        C3M.A00(i10, 0, A07());
        A0L(i10, c3466oL, j11);
        ...
        int i11 = c3466oL.A00;
        A0H(i11, c3468oN);
        while (i11 < c3466oL.A01 && c3468oN.A02 != j10 && A0H(i11 + 1, c3468oN).A02 <= j10) {
            i11++;
        }
        A0I(i11, c3468oN, true);
        long jMin = j10 - c3468oN.A02;
        if (c3468oN.A01 != -9223372036854775807L) {
            long j12 = c3468oN.A01;
        ...
        return Pair.create(C3M.A01(c3468oN.A04), Long.valueOf(Math.max(0L, jMin)));
    }

    public final C3468oN A0H(int i10, C3468oN c3468oN) {
        return A0I(i10, c3468oN, false);
    }

    public C3468oN A0J(Object obj, C3468oN c3468oN) {
        return A0I(A0A(obj), c3468oN, true);
    }

    public final C3466oL A0K(int i10, C3466oL c3466oL) {
        return A0L(i10, c3466oL, 0L);
    }
    ...
    public final boolean A0O(int i10, C3468oN c3468oN, C3466oL c3466oL, int i11, boolean z10) {
        return A09(i10, c3468oN, c3466oL, i11, z10) == -1;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        C3468oN c3468oN = new C3468oN();
        C3466oL window = new C3466oL();
        C3468oN otherPeriod = new C3468oN();
        for (int i10 = 0; i10 < A07(); i10++) {
            if (!A0K(i10, c3466oL).equals(timeline.A0K(i10, window))) {
                return false;
            }
        }
        for (int i11 = 0; i11 < A06(); i11++) {
            boolean zEquals = A0I(i11, c3468oN, true).equals(timeline.A0I(i11, otherPeriod, true));
            if (A00[6].length() != 11) {
                throw new RuntimeException();
            }
            String[] strArr = A00;
    ...
    public final int hashCode() {
        ...
        for (int i11 = 0; i11 < A07(); i11++) {
            C3466oL window = A0K(i11, c3466oL);
            i10 = (i10 * 31) + window.hashCode();
        }
        int result2 = i10 * 31;
        int i12 = result2 + A06();
        for (int i13 = 0; i13 < A06(); i13++) {
            i12 = (i12 * 31) + A0I(i13, c3468oN, true).hashCode();
        }
        int iA0B = A0B(true);
        while (iA0B != -1) {
