...
class FieldData implements Cloneable {
    ...
    <T> FieldData(Extension<?, T> extension, T t10) {
    ...
    /* JADX WARN: Multi-variable type inference failed */
    <T> void setValue(Extension<?, T> extension, T t10) {
        this.cachedExtension = extension;
        this.value = t10;
        this.unknownFieldData = null;
    }
    ...
    public final FieldData m7680clone() {
        ...
        try {
            ...
            if (obj != null) {
                if (obj instanceof MessageNano) {
                    fieldData.value = ((MessageNano) obj).mo7678clone();
                    return fieldData;
                }
                ...
                if (obj instanceof byte[][]) {
                    ...
                    if (obj instanceof MessageNano[]) {
                        ...
                        while (i10 < messageNanoArr.length) {
                            messageNanoArr2[i10] = messageNanoArr[i10].mo7678clone();
                            i10++;
                        }
                    }
                }
