...
public final class EncodeRegex extends Function {
    ...
    protected Object mo7589evaluateex6DHhM(@NotNull EvaluationContext evaluationContext, @NotNull Evaluable expressionContext, @NotNull List<? extends Object> args) {
        ...
        return new Regex("[.*+?^${}()|\\[\\]\\\\]").h((String) obj, new Function1<MatchResult, CharSequence>() { // from class: com.yandex.div.evaluable.function.EncodeRegex$evaluate$1
            @Override // kotlin.jvm.functions.Function1
            @NotNull
            public final CharSequence invoke(@NotNull MatchResult it) {
                Intrinsics.checkNotNullParameter(it, "it");
                return IOUtils.DIR_SEPARATOR_WINDOWS + it.getValue();
            }
        });
    }
