...
public final class StringToUrl extends Function {
    ...
    protected Object mo7589evaluateex6DHhM(@NotNull EvaluationContext evaluationContext, @NotNull Evaluable expressionContext, @NotNull List<? extends Object> args) {
        ...
        try {
            return Url.m7670boximpl(Url.INSTANCE.m7677fromVcSV9u8((String) objFirst));
        } catch (IllegalArgumentException e10) {
            EvaluableExceptionKt.throwExceptionOnFunctionEvaluationFailed(getName(), args, "Unable to convert value to Url.", e10);
            throw new g();
        }
    }
