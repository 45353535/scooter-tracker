...
public final class IntegerSum extends Function {
    ...
    protected Object mo7589evaluateex6DHhM(@NotNull EvaluationContext evaluationContext, @NotNull Evaluable expressionContext, @NotNull List<? extends Object> args) {
        ...
        while (it.hasNext()) {
            Object objEvalSum$div_evaluable = Evaluator.INSTANCE.evalSum$div_evaluable(Token.Operator.Binary.Sum.Plus.INSTANCE, Long.valueOf(l10.longValue()), it.next());
            Intrinsics.checkNotNull(objEvalSum$div_evaluable, "null cannot be cast to non-null type kotlin.Long");
            l10 = (Long) objEvalSum$div_evaluable;
            l10.longValue();
        }
        return l10;
    }
