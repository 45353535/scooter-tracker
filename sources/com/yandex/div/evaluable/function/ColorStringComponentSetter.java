...
public abstract class ColorStringComponentSetter extends Function {
    ...
    protected Object mo7589evaluateex6DHhM(@NotNull EvaluationContext evaluationContext, @NotNull Evaluable expressionContext, @NotNull List<? extends Object> args) {
        ...
        try {
            return this.componentSetter.m7618invokeex6DHhM(evaluationContext, expressionContext, CollectionsKt.listOf(Color.m7659boximpl(Color.INSTANCE.m7669parseC4zCDoM((String) obj)), args.get(1)));
        } catch (IllegalArgumentException e10) {
            EvaluableExceptionKt.throwExceptionOnFunctionEvaluationFailed(getName(), args, "Unable to convert value to Color, expected format #AARRGGBB.", e10);
            throw new g();
        }
    }
