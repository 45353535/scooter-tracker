    ...
    private ColorBlueComponentSetter() {
        super(new Function2<Color, Double, Color>() { // from class: com.yandex.div.evaluable.function.ColorBlueComponentSetter.1
            ...
            public /* bridge */ /* synthetic */ Color invoke(Color color, Double d10) {
                return Color.m7659boximpl(m7624invokeGnj5c28(color.getValue(), d10.doubleValue()));
            }

            /* JADX INFO: renamed from: invoke-Gnj5c28, reason: not valid java name */
            public final int m7624invokeGnj5c28(int i10, double d10) {
                return Color.INSTANCE.m7668argbH0kstlE(Color.m7657alphaimpl(i10), Color.m7665redimpl(i10), Color.m7663greenimpl(i10), ColorFunctionsKt.toColorIntComponentValue(d10));
            }
        });
    }
