...
public final class StringEncodeUri extends Function {
    ...
    protected Object mo7589evaluateex6DHhM(@NotNull EvaluationContext evaluationContext, @NotNull Evaluable expressionContext, @NotNull List<? extends Object> args) throws UnsupportedEncodingException {
        ...
        return StringsKt.W(StringsKt.W(StringsKt.W(StringsKt.W(StringsKt.W(StringsKt.W(strEncode, "+", "%20", false, 4, null), "%21", "!", false, 4, null), "%7E", "~", false, 4, null), "%27", "'", false, 4, null), "%28", "(", false, 4, null), "%29", ")", false, 4, null);
    }
