...
public abstract class ColorStringComponentGetter extends Function {
    ...
    protected Object mo7589evaluateex6DHhM(@NotNull EvaluationContext evaluationContext, @NotNull Evaluable expressionContext, @NotNull List<? extends Object> args) {
        ...
        try {
            return this.componentGetter.m7618invokeex6DHhM(evaluationContext, expressionContext, CollectionsKt.listOf(Color.m7659boximpl(Color.INSTANCE.m7669parseC4zCDoM((String) objFirst))));
