...
public abstract class DictOptUrlWithUrlFallback extends Function {
    ...
    protected Object mo7589evaluateex6DHhM(@NotNull EvaluationContext evaluationContext, @NotNull Evaluable expressionContext, @NotNull List<? extends Object> args) {
        ...
        String value = ((Url) obj).getValue();
        Object objEvaluateSafe$default = DictFunctionsKt.evaluateSafe$default(args, Url.m7670boximpl(value), false, 4, null);
        String str = objEvaluateSafe$default instanceof String ? (String) objEvaluateSafe$default : null;
        return (str == null || (strSafeConvertToUrl = ArrayFunctionsKt.safeConvertToUrl(str)) == null) ? Url.m7670boximpl(value) : Url.m7670boximpl(strSafeConvertToUrl);
    }
