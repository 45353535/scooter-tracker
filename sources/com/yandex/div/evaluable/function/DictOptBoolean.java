...
public abstract class DictOptBoolean extends Function {
    ...
    protected Object mo7589evaluateex6DHhM(@NotNull EvaluationContext evaluationContext, @NotNull Evaluable expressionContext, @NotNull List<? extends Object> args) {
        ...
        bool.booleanValue();
        Object objEvaluateSafe$default = DictFunctionsKt.evaluateSafe$default(args, bool, false, 4, null);
        Boolean bool2 = objEvaluateSafe$default instanceof Boolean ? (Boolean) objEvaluateSafe$default : null;
