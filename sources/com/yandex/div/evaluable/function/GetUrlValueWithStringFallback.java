...
public final class GetUrlValueWithStringFallback extends Function {
    ...
    protected Object mo7589evaluateex6DHhM(@NotNull EvaluationContext evaluationContext, @NotNull Evaluable expressionContext, @NotNull List<? extends Object> args) {
        ...
        String value = obj3 instanceof Url ? ((Url) obj3).getValue() : null;
        if (value != null) {
            return Url.m7670boximpl(value);
        }
        String strSafeConvertToUrl = ArrayFunctionsKt.safeConvertToUrl(str);
        if (strSafeConvertToUrl != null) {
            return Url.m7670boximpl(strSafeConvertToUrl);
        }
