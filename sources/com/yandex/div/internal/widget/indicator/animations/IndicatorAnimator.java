...
public interface IndicatorAnimator {
    ...
    void overrideItemWidth(float width);

    void setItemsCount(int count);

    void updateSpaceBetweenCenters(float spaceBetweenCenters);
}
