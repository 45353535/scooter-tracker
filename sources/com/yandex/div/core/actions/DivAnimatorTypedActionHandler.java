...
public final class DivAnimatorTypedActionHandler implements DivActionTypedHandler {
    ...
    public boolean handleAction(@Nullable String scopeId, @NotNull m5 action, @NotNull Div2View view, @NotNull ExpressionResolver resolver) {
        if (!(action instanceof m5.a)) {
            ...
            view.getViewComponent().getAnimatorController().stopAnimator(scopeId, ((m5.b) action).c().f90295a);
            return true;
        }
        if (scopeId == null) {
            return true;
        ...
        view.getViewComponent().getAnimatorController().startAnimator(scopeId, (View) CollectionsKt.first((List) listFindViewsWithTag), ((m5.a) action).c(), resolver);
        return true;
    }
}
