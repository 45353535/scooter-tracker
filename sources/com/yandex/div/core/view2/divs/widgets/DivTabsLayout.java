...
public class DivTabsLayout extends TabsLayout implements DivHolderView<y0.q> {
    ...
    @Nullable
    public y0.q getDiv() {
        return (y0.q) this.$$delegate_0.getDiv();
    }
    ...
    @Override // com.yandex.div.core.view2.divs.widgets.DivHolderView
    public void setDiv(@Nullable y0.q qVar) {
