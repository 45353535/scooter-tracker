...
public final class StoredValuesActionHandler {
    ...
    private final StoredValue createStoredValue(StoredValue.Type type, String name, String value) throws StoredValueDeclarationException {
        switch (WhenMappings.$EnumSwitchMapping$0[type.ordinal()]) {
            ...
            case 5:
                return new StoredValue.ColorStoredValue(name, m7594parseAsColorC4zCDoM(value), null);
            case 6:
                return new StoredValue.UrlStoredValue(name, m7595parseAsUrlVcSV9u8(value), null);
            default:
    ...
    public static final boolean handleAction(@NotNull Uri uri, @NotNull DivViewFacade view) {
        ...
        if (param3 != null && (param = storedValuesActionHandler.getParam(uri, "value")) != null && (param2 = storedValuesActionHandler.getParam(uri, "lifetime")) != null && (lX = StringsKt.x(param2)) != null) {
    ...
    private final int m7594parseAsColorC4zCDoM(String str) throws StoredValueDeclarationException {
    ...
    private final String m7595parseAsUrlVcSV9u8(String str) throws StoredValueDeclarationException {
        try {
            return Url.INSTANCE.m7677fromVcSV9u8(str);
