...
public final class AdmobInterstitialImpl implements AdSource.Interstitial<AdmobFullscreenAdAuctionParams>, AdEventFlow, StatisticsCollector {
    ...
    public AdmobInterstitialImpl(@NotNull GetAdRequestUseCase getAdRequest, @NotNull GetFullScreenContentCallbackUseCase getFullScreenContentCallback, @NotNull GetAdAuctionParamsUseCase obtainAdAuctionParams) {
    ...
    public void load(@NotNull AdmobFullscreenAdAuctionParams adParams) {
        ...
        if (adUnitId == null) {
            ...
            InterstitialAd.load(adParams.getActivity(), adUnitId, adRequestInvoke, new AdmobInterstitialImpl$load$requestListener$1(this, adParams));
        }
    }

    public /* synthetic */ AdmobInterstitialImpl(GetAdRequestUseCase getAdRequestUseCase, GetFullScreenContentCallbackUseCase getFullScreenContentCallbackUseCase, GetAdAuctionParamsUseCase getAdAuctionParamsUseCase, int i10, DefaultConstructorMarker defaultConstructorMarker) {
