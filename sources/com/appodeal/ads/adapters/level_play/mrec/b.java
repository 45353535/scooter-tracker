...
public final class b extends k implements Function2 {
    ...
    public final /* synthetic */ LevelPlayBannerAdView f12452s;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    public final /* synthetic */ com.appodeal.ads.adapters.level_play.b f12453t;

    /* JADX INFO: renamed from: u, reason: collision with root package name */
    public final /* synthetic */ LevelPlayAdSize f12454u;
    ...
    public b(LevelPlayBannerAdView levelPlayBannerAdView, com.appodeal.ads.adapters.level_play.b bVar, LevelPlayAdSize levelPlayAdSize, Continuation continuation) {
        ...
        this.f12452s = levelPlayBannerAdView;
        this.f12453t = bVar;
        this.f12454u = levelPlayAdSize;
    }

    @Override // kotlin.coroutines.jvm.internal.a
    public final Continuation create(Object obj, Continuation continuation) {
        return new b(this.f12452s, this.f12453t, this.f12454u, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i10 == 0) {
            d.b(obj);
            ArrayList arrayList = this.f12453t.f12382c;
            LevelPlayAdSize levelPlayAdSize = this.f12454u;
            this.f12451r = 1;
