...
public final class a implements BannerListener {
    ...
    public final void onAdLoadFailed(AuctionInfo auctionInfo, BidonError cause) {
        ...
        if (auctionInfo != null) {
            this.f12115b.onAdditionalInfoLoaded(f.c(auctionInfo));
        }
        this.f12115b.onAdLoadFailed(f.b(cause));
    }
    ...
    public final void onAdLoaded(Ad ad2, AuctionInfo auctionInfo) {
        ...
        BannerView bannerView = this.f12114a.f12116a;
        ...
        this.f12115b.onAdditionalInfoLoaded(strC);
        this.f12115b.onAdLoaded(bannerView, adSize.getHeightDp(), impressionLevelDataA);
    }

    @Override // org.bidon.sdk.ads.AdListener
    public final void onAdShowFailed(BidonError cause) {
        Intrinsics.checkNotNullParameter(cause, "cause");
        this.f12115b.onAdShowFailed(new ShowError.NetworkShowError.ErrorOnCallback(cause.toString(), null, 2, null));
    }
    ...
    public final void onRevenuePaid(Ad ad2, AdValue adValue) {
        ...
        this.f12115b.onAdRevenueReceived(f.a(ad2, adValue, true));
    }
}
