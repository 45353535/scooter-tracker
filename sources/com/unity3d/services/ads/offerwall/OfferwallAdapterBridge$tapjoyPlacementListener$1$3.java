...
final class OfferwallAdapterBridge$tapjoyPlacementListener$1$3 extends k implements Function2<CoroutineScope, Continuation, Object> {
    ...
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation continuation) {
        return ((OfferwallAdapterBridge$tapjoyPlacementListener$1$3) create(coroutineScope, continuation)).invokeSuspend(Unit.f93236a);
    }
}
