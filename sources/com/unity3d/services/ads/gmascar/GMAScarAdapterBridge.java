...
public class GMAScarAdapterBridge {
    ...
    private void loadInterstitialAd(m6.c cVar) {
    ...
    private void loadRewardedAd(m6.c cVar) {
    ...
    public void getSCARSignal(String str, d dVar) {
        ...
        if (fVar != null) {
            fVar.c(ClientProperties.getApplicationContext(), str, dVar, signalsHandler);
        } else {
    ...
    public void load(boolean z10, String str, String str2, String str3, String str4, int i10) {
        m6.c cVar = new m6.c(str, str2, str4, str3, Integer.valueOf(i10));
        f scarAdapterObject = getScarAdapterObject();
        this._scarAdapter = scarAdapterObject;
        if (scarAdapterObject == null) {
    ...
    public void loadBanner(Context context, BannerView bannerView, String str, m6.c cVar, UnityBannerSize unityBannerSize) {
        this._scarAdapter = getScarAdapterObject();
