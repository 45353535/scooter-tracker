...
public class GameSessionIdReader implements IGameSessionIdReader {
    ...
    private void generate() {
        ...
        this.gameSessionId = Long.valueOf((Long.toString(uuidRandomUUID.getMostSignificantBits()) + Long.toString(uuidRandomUUID.getLeastSignificantBits())).replace(TokenBuilder.TOKEN_DELIMITER, "").substring(0, 12));
    }
