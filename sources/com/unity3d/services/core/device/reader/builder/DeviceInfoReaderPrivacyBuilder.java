...
public class DeviceInfoReaderPrivacyBuilder extends DeviceInfoReaderBuilder {
    ...
    private JsonFlattenerRules getPrivacyRequestStorageRules() {
        return new JsonFlattenerRules(Arrays.asList("privacy", "gdpr", "unity", "pipl"), Collections.singletonList("value"), Arrays.asList("ts", POBProfileInfo.COUNTRY_FILTERING_BLOCK_MODE, C4240b4.a.f42515t));
    }
