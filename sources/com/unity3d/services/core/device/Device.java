...
public class Device {
    ...
    public static String getConnectionType() {
        return isUsingWifi() ? X3.f42018b : isActiveNetworkConnected() ? X3.f42023g : "none";
    }
    ...
    */
    ...
    public static JSONObject getPackageInfo(PackageManager packageManager) throws JSONException, PackageManager.NameNotFoundException {
        ...
        jSONObject.put(C4240b4.j.X, packageInfo.firstInstallTime);
        jSONObject.put(C4240b4.j.V, packageInfo.lastUpdateTime);
