...
public class DeviceLog {
    ...
    static {
        ...
        _deviceLogLevel = map;
        if (map.size() == 0) {
            map.put(UnityAdsLogLevel.INFO, new DeviceLogLevel(CmcdData.Factory.OBJECT_TYPE_INIT_SEGMENT));
            map.put(UnityAdsLogLevel.DEBUG, new DeviceLogLevel("d"));
            map.put(UnityAdsLogLevel.WARNING, new DeviceLogLevel(POBCoreNativeConstants.NATIVE_IMAGE_WIDTH));
            map.put(UnityAdsLogLevel.ERROR, new DeviceLogLevel(EidRequestBuilder.REQUEST_FIELD_EMAIL));
        }
    ...
    private static void writeToLog(DeviceLogEntry deviceLogEntry) {
        ...
        try {
            ...
            Log.e(N6.H1, "Writing to log failed!", e10);
            method = null;
        }
        if (method != null) {
            try {
                ...
                Log.e(N6.H1, "Writing to log failed!", e11);
            }
        }
    }
