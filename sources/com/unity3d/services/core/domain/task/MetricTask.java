...
public abstract class MetricTask<P extends BaseParams, R> implements BaseTask<P, R> {
    ...
    private final void captureMetric(Object result) {
        this.taskStatus = Result.j(result) ? "success" : "failure";
        sendMetric();
    }
    ...
    private final SDKMetricsSender getSDKMetrics() {
        return (SDKMetricsSender) getServiceProvider().getRegistry().getService("", v0.b(SDKMetricsSender.class));
    }
    ...
    */
    static /* synthetic */ java.lang.Object m7483invokegIAlus$suspendImpl(com.unity3d.services.core.domain.task.MetricTask<? super P, R> r8, P r9, kotlin.coroutines.Continuation r10) {
        /*
        ...
        L51:
            ...
            r0.J$0 = r4
            r0.label = r3
            java.lang.Object r9 = com.unity3d.services.core.domain.task.BaseTask.DefaultImpls.m7467invokegIAlus(r8, r9, r0)
            if (r9 != r1) goto L74
            return r1
        L74:
            r0 = r8
        ...
        L79:
            ...
            r8.duration = r1
            java.lang.Object r8 = r9.f93280b
            r0.captureMetric(r8)
            java.lang.Object r8 = r9.f93280b
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.unity3d.services.core.domain.task.MetricTask.m7483invokegIAlus$suspendImpl(com.unity3d.services.core.domain.task.MetricTask, com.unity3d.services.core.domain.task.BaseParams, kotlin.coroutines.Continuation):java.lang.Object");
    }
    ...
    public Object mo7466invokegIAlus(@NotNull P p10, @NotNull Continuation continuation) {
        return m7483invokegIAlus$suspendImpl(this, p10, continuation);
    }
