...
final class AndroidGetWebViewContainerUseCase$invoke$webview$1 extends k implements Function2<CoroutineScope, Continuation, Object> {
    int label;
    ...
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation continuation) {
        return ((AndroidGetWebViewContainerUseCase$invoke$webview$1) create(coroutineScope, continuation)).invokeSuspend(Unit.f93236a);
    }
}
