...
final class AndroidGetLifecycleFlow$invoke$2$listener$1$onActivityResumed$1 extends k implements Function2<CoroutineScope, Continuation, Object> {
    final /* synthetic */ v $$this$channelFlow;
    final /* synthetic */ Activity $activity;
    int label;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    AndroidGetLifecycleFlow$invoke$2$listener$1$onActivityResumed$1(v vVar, Activity activity, Continuation continuation) {
    ...
    public final Object invoke(@NotNull CoroutineScope coroutineScope, @Nullable Continuation continuation) {
        return ((AndroidGetLifecycleFlow$invoke$2$listener$1$onActivityResumed$1) create(coroutineScope, continuation)).invokeSuspend(Unit.f93236a);
    }
}
