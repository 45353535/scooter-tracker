...
public interface BuildHeaderBiddingToken {
    ...
    public static final class DefaultImpls {
        public static /* synthetic */ Object invoke$default(BuildHeaderBiddingToken buildHeaderBiddingToken, int i10, TokenConfiguration tokenConfiguration, boolean z10, Continuation continuation, int i11, Object obj) {
            if (obj != null) {
            ...
            return buildHeaderBiddingToken.invoke(i10, tokenConfiguration, z10, continuation);
        }
    }

    @Nullable
    Object invoke(int i10, @Nullable TokenConfiguration tokenConfiguration, boolean z10, @NotNull Continuation continuation);
}
