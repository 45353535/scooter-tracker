...
public interface GetAsyncHeaderBiddingToken {
    @Nullable
    Object invoke(int i10, @Nullable TokenConfiguration tokenConfiguration, @Nullable IUnityAdsTokenListener iUnityAdsTokenListener, @NotNull Continuation continuation);
}
