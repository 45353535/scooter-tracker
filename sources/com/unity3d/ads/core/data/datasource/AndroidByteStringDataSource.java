...
public final class AndroidByteStringDataSource implements ByteStringDataSource {
    ...
    static final class AnonymousClass2 extends k implements Function3<FlowCollector, Throwable, Continuation, Object> {
        ...
        public final Object invokeSuspend(@NotNull Object obj) throws Throwable {
            ...
            if (i10 == 0) {
                ...
                this.L$0 = null;
                this.label = 1;
                if (flowCollector.emit(byteStringStore_build, this) == objG) {
                    return objG;
                }
            } else {
                if (i10 != 1) {
    ...
    static final class C47652 extends k implements Function2<ByteStringStoreOuterClass.ByteStringStore, Continuation, Object> {
        final /* synthetic */ ByteString $data;
        /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C47652(ByteString byteString, Continuation continuation) {
        ...
        public final Continuation create(@Nullable Object obj, @NotNull Continuation continuation) {
            C47652 c47652 = new C47652(this.$data, continuation);
            c47652.L$0 = obj;
            return c47652;
        }
        ...
        public final Object invoke(@NotNull ByteStringStoreOuterClass.ByteStringStore byteStringStore, @Nullable Continuation continuation) {
            return ((C47652) create(byteStringStore, continuation)).invokeSuspend(Unit.f93236a);
        }
    ...
    public Object get(@NotNull Continuation continuation) {
        return i.x(i.h(this.dataStore.getData(), new AnonymousClass2(null)), continuation);
    }

    @Override // com.unity3d.ads.core.data.datasource.ByteStringDataSource
    @Nullable
    public Object set(@NotNull ByteString byteString, @NotNull Continuation continuation) {
        Object objUpdateData = this.dataStore.updateData(new C47652(byteString, null), continuation);
