...
public interface CacheDataSource {
    ...
    public static final class DefaultImpls {
        public static /* synthetic */ Object getFile$default(CacheDataSource cacheDataSource, File file, String str, String str2, Integer num, Continuation continuation, int i10, Object obj) {
            if (obj != null) {
    ...
    @Nullable
    Object getFile(@NotNull File file, @NotNull String str, @Nullable String str2, @Nullable Integer num, @NotNull Continuation continuation);
}
