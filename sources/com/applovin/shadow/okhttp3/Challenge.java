...
public final class Challenge {
    ...
    public final Map<String, String> m4289deprecated_authParams() {
        return this.authParams;
    }

    @NotNull
    /* JADX INFO: renamed from: -deprecated_charset, reason: not valid java name */
    public final Charset m4290deprecated_charset() {
        return charset();
    }

    @Nullable
    /* JADX INFO: renamed from: -deprecated_realm, reason: not valid java name */
    public final String m4291deprecated_realm() {
        return realm();
    }
    ...
    public final Charset charset() {
        String str = this.authParams.get(D5.M);
        if (str != null) {
            try {
