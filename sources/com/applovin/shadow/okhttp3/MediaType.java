...
public final class MediaType {
    ...
    public static final class Companion {
        ...
        public final MediaType m4343deprecated_get(@NotNull String mediaType) {
        ...
        public final MediaType m4344deprecated_parse(@NotNull String mediaType) {
            Intrinsics.checkNotNullParameter(mediaType, "mediaType");
    ...
    public final String parameter(@NotNull String name) {
        ...
        while (!StringsKt.N(this.parameterNamesAndValues[i10], name, true)) {
            if (i10 == iC) {
                return null;
            }
            i10 += 2;
    ...
    public final Charset charset(@Nullable Charset defaultValue) {
        String strParameter = parameter(D5.M);
