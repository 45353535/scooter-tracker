...
public final class Http2 {
    ...
    static {
        ...
        for (int i10 = 0; i10 < 256; i10++) {
            ...
            strArr[i10] = StringsKt.V(Util.format("%8s", binaryString), ' ', '0', false, 4, null);
        }
        BINARY = strArr;
    ...
    public final String formatFlags(int type, int flags) {
        ...
        if (type != 2 && type != 3) {
            ...
            if (type != 7 && type != 8) {
                ...
                String str2 = str;
                return (type != 5 || (flags & 4) == 0) ? (type != 0 || (flags & 32) == 0) ? str2 : StringsKt.W(str2, "PRIORITY", "COMPRESSED", false, 4, null) : StringsKt.W(str2, "HEADERS", "PUSH_PROMISE", false, 4, null);
            }
        }
        return BINARY[flags];
    }
