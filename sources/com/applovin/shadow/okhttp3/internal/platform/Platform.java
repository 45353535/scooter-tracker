...
public class Platform {
    ...
    public X509TrustManager trustManager(@NotNull SSLSocketFactory sslSocketFactory) throws IllegalAccessException {
        ...
        try {
            ...
            Object fieldOrNull = Util.readFieldOrNull(sslSocketFactory, sslContextClass, POBCoreNativeConstants.NATIVE_CONTEXT);
            if (fieldOrNull == null) {
                return null;
            }
