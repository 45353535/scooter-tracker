...
public final class OkHostnameVerifier implements HostnameVerifier {
    ...
    private final boolean verifyHostname(String hostname, String pattern) {
        if (hostname != null && hostname.length() != 0 && !StringsKt.a0(hostname, ".", false, 2, null) && !StringsKt.M(hostname, "..", false, 2, null) && pattern != null && pattern.length() != 0 && !StringsKt.a0(pattern, ".", false, 2, null) && !StringsKt.M(pattern, "..", false, 2, null)) {
            if (!StringsKt.M(hostname, ".", false, 2, null)) {
                hostname = hostname + '.';
            }
            String str = hostname;
            if (!StringsKt.M(pattern, ".", false, 2, null)) {
                pattern = pattern + '.';
            }
            String strAsciiToLowercase = asciiToLowercase(pattern);
            if (!StringsKt.g0(strAsciiToLowercase, ProxyConfig.MATCH_ALL_SCHEMES, false, 2, null)) {
                return Intrinsics.areEqual(str, strAsciiToLowercase);
            }
            if (!StringsKt.a0(strAsciiToLowercase, "*.", false, 2, null) || StringsKt.u0(strAsciiToLowercase, '*', 1, false, 4, null) != -1 || str.length() < strAsciiToLowercase.length() || Intrinsics.areEqual("*.", strAsciiToLowercase)) {
                return false;
            }
            String strSubstring = strAsciiToLowercase.substring(1);
            Intrinsics.checkNotNullExpressionValue(strSubstring, "this as java.lang.String).substring(startIndex)");
            if (!StringsKt.M(str, strSubstring, false, 2, null)) {
                return false;
            }
            int length = str.length() - strSubstring.length();
            return length <= 0 || StringsKt.B0(str, '.', length + (-1), false, 4, null) == -1;
        }
        return false;
    }
}
