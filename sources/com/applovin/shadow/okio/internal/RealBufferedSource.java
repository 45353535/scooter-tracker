...
public final class RealBufferedSource {
    ...
    public static final String commonReadUtf8LineStrict(@NotNull buffer bufferVar, long j10) throws EOFException {
        ...
        long jIndexOf = bufferVar.indexOf((byte) 10, 0L, j11);
        if (jIndexOf != -1) {
            return Buffer.readUtf8Line(bufferVar.bufferField, jIndexOf);
        }
        if (j11 < Long.MAX_VALUE && bufferVar.request(j11) && bufferVar.bufferField.getByte(j11 - 1) == 13 && bufferVar.request(j11 + 1) && bufferVar.bufferField.getByte(j11) == 10) {
