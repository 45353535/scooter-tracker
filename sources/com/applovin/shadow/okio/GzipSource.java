...
public final class GzipSource implements Source, AutoCloseable {
    ...
    private final void updateCrc(Buffer buffer, long offset, long byteCount) {
        ...
        while (byteCount > 0) {
            int i12 = (int) (((long) segment.pos) + offset);
            int iMin = (int) Math.min(segment.limit - i12, byteCount);
