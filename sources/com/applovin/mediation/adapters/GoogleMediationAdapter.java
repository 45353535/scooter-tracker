...
public class GoogleMediationAdapter extends MediationAdapterBase implements MaxSignalProvider, MaxInterstitialAdapter, MaxAppOpenAdapter, MaxRewardedAdapter, MaxAdViewAdapter, MaxNativeAdAdapter {
    ...
    static class AutoMeasuringMediaView extends MediaView {
        ...
        public static /* synthetic */ void a(AutoMeasuringMediaView autoMeasuringMediaView) {
        ...
        public void requestLayout() {
            ...
            post(new Runnable() { // from class: com.applovin.mediation.adapters.f
                ...
                public final void run() {
                    GoogleMediationAdapter.AutoMeasuringMediaView.a(this.f11685b);
                }
            });
        }
    }
    ...
    public static /* synthetic */ void a(GoogleMediationAdapter googleMediationAdapter, String str, RewardItem rewardItem) {
    ...
    public static /* synthetic */ void b(GoogleMediationAdapter googleMediationAdapter, MaxAdapter.OnCompletionListener onCompletionListener, InitializationStatus initializationStatus) {
        googleMediationAdapter.getClass();
    ...
    */
    ...
    public void initialize(MaxAdapterInitializationParameters maxAdapterInitializationParameters, @Nullable Activity activity, final MaxAdapter.OnCompletionListener onCompletionListener) {
        ...
        if (!maxAdapterInitializationParameters.getServerParameters().getBoolean("init_without_callback", false)) {
            ...
            MobileAds.initialize(context, new OnInitializationCompleteListener() { // from class: com.applovin.mediation.adapters.e
                @Override // com.google.android.gms.ads.initialization.OnInitializationCompleteListener
                public final void onInitializationComplete(InitializationStatus initializationStatus) {
                    GoogleMediationAdapter.b(this.f11683a, onCompletionListener, initializationStatus);
                }
            });
        } else {
    ...
    public void showRewardedAd(MaxAdapterResponseParameters maxAdapterResponseParameters, @Nullable Activity activity, MaxRewardedAdapterListener maxRewardedAdapterListener) {
        ...
        if (this.rewardedAd != null) {
            ...
            this.rewardedAd.show(activity, new OnUserEarnedRewardListener() { // from class: com.applovin.mediation.adapters.d
                @Override // com.google.android.gms.ads.OnUserEarnedRewardListener
                public final void onUserEarnedReward(RewardItem rewardItem) {
                    GoogleMediationAdapter.a(this.f11681b, thirdPartyAdPlacementId, rewardItem);
                }
            });
            return;
        }
