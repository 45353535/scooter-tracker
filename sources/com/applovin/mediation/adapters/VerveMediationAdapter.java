...
public class VerveMediationAdapter extends MediationAdapterBase implements MaxInterstitialAdapter, MaxRewardedAdapter, MaxAdViewAdapter, MaxSignalProvider {
    ...
    private class AdViewListener implements HyBidAdView.Listener {
        ...
        public void onAdLoadFailed(Throwable th2) {
            VerveMediationAdapter.this.log("AdView failed to load with error: " + th2);
            this.listener.onAdViewAdLoadFailed(VerveMediationAdapter.toMaxError(th2));
        }
    ...
    private class InterstitialListener implements HyBidInterstitialAd.Listener {
        ...
        public void onInterstitialLoadFailed(Throwable th2) {
            VerveMediationAdapter.this.log("Interstitial ad failed to load with error: " + th2);
            this.listener.onInterstitialAdLoadFailed(VerveMediationAdapter.toMaxError(th2));
        }
    ...
    private class RewardedListener implements HyBidRewardedAd.Listener {
        ...
        public void onRewardedLoadFailed(Throwable th2) {
            VerveMediationAdapter.this.log("Rewarded ad failed to load with error: " + th2);
            this.listener.onRewardedAdLoadFailed(VerveMediationAdapter.toMaxError(th2));
        }
    ...
    public static MaxAdapterError toMaxError(Throwable th2) {
        ...
        return new MaxAdapterError(maxAdapterError, 0, th2.getMessage());
    }
