...
public class GoogleAdManagerMediationAdapter extends MediationAdapterBase implements MaxInterstitialAdapter, MaxAppOpenAdapter, MaxRewardedAdapter, MaxAdViewAdapter, MaxNativeAdAdapter {
        ...
        public void requestLayout() {
            ...
            post(new Runnable() { // from class: com.applovin.mediation.adapters.c
                ...
                public final void run() {
                    GoogleAdManagerMediationAdapter.AutoMeasuringMediaView.a(this.f11680b);
                }
            });
        }
    }
    ...
    public static /* synthetic */ void a(GoogleAdManagerMediationAdapter googleAdManagerMediationAdapter, String str, RewardItem rewardItem) {
        ...
        if (this.rewardedAd != null) {
            ...
            this.rewardedAd.show(activity, new OnUserEarnedRewardListener() { // from class: com.applovin.mediation.adapters.b
                ...
                public final void onUserEarnedReward(RewardItem rewardItem) {
                    GoogleAdManagerMediationAdapter.a(this.f11678b, thirdPartyAdPlacementId, rewardItem);
                }
            });
            return;
        }
