...
public class AppLovinSdkUtils {
    ...
    private static final Handler f11818a = new Handler(Looper.getMainLooper());
    ...
    public static final class Size {
        ...
        public boolean equals(Object obj) {
            ...
            Size size = (Size) obj;
            return this.f11819a == size.getWidth() && this.f11820b == size.getHeight();
        }
        ...
        public String toString() {
            return this.f11819a + "x" + this.f11820b;
        }
    }
    ...
    public static void runOnUiThreadDelayed(Runnable runnable, long j10) {
        runOnUiThreadDelayed(runnable, j10, f11818a);
    }
