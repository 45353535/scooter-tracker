...
public class j7 {
    ...
    private final Intent f9132a = new Intent();
    ...
    public j7 a(String str, String str2) {
        ...
        if (zIsValidString && zIsValidString2) {
            this.f9132a.setDataAndType(Uri.parse(str), str2);
            return this;
        }
        if (zIsValidString) {
            this.f9132a.setData(Uri.parse(str));
            return this;
        }
        if (zIsValidString2) {
            this.f9132a.setType(str2);
        }
        return this;
    }
    ...
    public j7 b(String str) {
        if (StringUtils.isValidString(str)) {
            this.f9132a.addFlags(Integer.parseInt(str));
        }
        return this;
    }

    public Intent c(String str) {
        Intent intentCreateChooser = Intent.createChooser(this.f9132a, StringUtils.emptyIfNull(str));
        intentCreateChooser.addFlags(this.f9132a.getFlags());
        return intentCreateChooser;
    }

    public j7 d(String str) {
        if (StringUtils.isValidString(str)) {
            this.f9132a.setAction(str);
        }
        return this;
    }
    ...
    public j7 e(String str) {
        if (StringUtils.isValidString(str)) {
            this.f9132a.putExtras(JsonUtils.toBundle(JsonUtils.jsonObjectFromJsonString(str, new JSONObject())));
        }
        return this;
    }
    ...
    public j7 g(String str) {
        if (StringUtils.isValidString(str)) {
            this.f9132a.setSelector(new Intent(str));
        }
        return this;
    }
    ...
    public j7 h(String str) {
        if (StringUtils.isValidString(str)) {
            ...
            if (strArrSplit.length == 4) {
                this.f9132a.setSourceBounds(new Rect(Integer.parseInt(strArrSplit[0]), Integer.parseInt(strArrSplit[1]), Integer.parseInt(strArrSplit[2]), Integer.parseInt(strArrSplit[3])));
            }
        }
        return this;
    }
    ...
    public j7 b(String str, String str2, String str3) {
        if (StringUtils.isValidString(str)) {
            ...
            if (componentNameUnflattenFromString != null) {
                this.f9132a.setComponent(componentNameUnflattenFromString);
                return this;
            }
        } else {
            if (StringUtils.isValidString(str2) && StringUtils.isValidString(str3)) {
                this.f9132a.setClassName(str3, str2);
                return this;
            }
            if (StringUtils.isValidString(str3)) {
                this.f9132a.setPackage(str3);
            }
        }
        return this;
    }
    ...
    public j7 a(String str, String str2, String str3) {
        ...
        if (StringUtils.isValidString(str)) {
            ...
            this.f9132a.setClipData(clipDataNewRawUri);
        }
        return this;
    }
