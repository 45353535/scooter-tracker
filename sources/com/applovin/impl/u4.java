...
public abstract class u4 {
    ...
    private static final byte[] f11063a = {-83, -98, -53, -112, -29, -118, 55, 117, 59, 8, -12, -15, 73, 110, -67, 57, 117, 4, -26, 97, 66, -12, 125, 91, -119, -103, -30, 114, 123, 54, 51, -77};

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final byte[] f11064b;
    ...
    private static int c(byte[] bArr, String str, com.applovin.impl.sdk.k kVar) {
        ...
        byte[] bytes = a(f11064b, kVar).getBytes();
        int i11 = iA + 1;
    ...
    private static byte[] a(String str, long j10, String str2, com.applovin.impl.sdk.k kVar) {
        ...
        try {
            ...
            byte[] bArrA = a(strSubstring2, f11063a, kVar);
            ...
            while (i10 < bytes.length) {
                ...
                char c15 = c10;
                byteArrayOutputStream.write((byte) (((long) ((i10 >= bytes.length ? b10 : bytes[i10]) ^ bArrA[i10 % bArrA.length])) ^ (j14 & 255)));
                byteArrayOutputStream.write((byte) (((long) (bArrA[r4 % bArrA.length] ^ (i10 + 1 >= bytes.length ? (byte) 0 : bytes[r4]))) ^ ((j14 >> c13) & 255)));
                byteArrayOutputStream.write((byte) (((long) (bArrA[r4 % bArrA.length] ^ (i10 + 2 >= bytes.length ? (byte) 0 : bytes[r4]))) ^ ((j14 >> c14) & 255)));
                byteArrayOutputStream.write((byte) (((long) (bArrA[r4 % bArrA.length] ^ (i10 + 3 >= bytes.length ? (byte) 0 : bytes[r4]))) ^ ((j14 >> 24) & 255)));
                byteArrayOutputStream.write((byte) (((long) (bArrA[r4 % bArrA.length] ^ (i10 + 4 >= bytes.length ? (byte) 0 : bytes[r4]))) ^ ((j14 >> c15) & 255)));
            ...
            return ("1:" + a(f11063a, kVar) + StringUtils.PROCESS_POSTFIX_DELIMITER + strSubstring + StringUtils.PROCESS_POSTFIX_DELIMITER + strC).getBytes("UTF-8");
    ...
    private static String a(String str, String str2, com.applovin.impl.sdk.k kVar) {
        ...
        try {
            try {
                ...
                try {
                    char c14 = 7;
                    long j10 = (((long) ((byteArrayInputStream.read() ^ bArrA[1]) & 255)) << 8) | ((long) ((byteArrayInputStream.read() ^ bArrA[0]) & 255)) | (((long) ((byteArrayInputStream.read() ^ bArrA[2]) & 255)) << 16) | (((long) ((byteArrayInputStream.read() ^ bArrA[3]) & 255)) << 24) | (((long) ((byteArrayInputStream.read() ^ bArrA[4]) & 255)) << 32) | (((byteArrayInputStream.read() ^ bArrA[5]) & 255) << 40) | (((long) ((byteArrayInputStream.read() ^ bArrA[6]) & 255)) << 48) | (((long) ((byteArrayInputStream.read() ^ bArrA[7]) & 255)) << 56);
                    ByteArrayOutputStream byteArrayOutputStream = new ByteArrayOutputStream();
                    ...
                    while (i10 >= 0) {
                        ...
                        long j13 = (j12 ^ (j12 >> 29)) * (-8796714831421723037L);
                        long j14 = j13 ^ (j13 >> 32);
                        byteArrayOutputStream.write((byte) (((long) (bArr2[0] ^ bArrA[i11 % bArrA.length])) ^ (j14 & 255)));
                        byteArrayOutputStream.write((byte) (((long) (bArr2[1] ^ bArrA[(i11 + 1) % bArrA.length])) ^ ((j14 >> 8) & 255)));
                        byteArrayOutputStream.write((byte) (((long) (bArr2[r23] ^ bArrA[(i11 + 2) % bArrA.length])) ^ ((j14 >> 16) & 255)));
                        byteArrayOutputStream.write((byte) (((long) (bArr2[r27] ^ bArrA[(i11 + 3) % bArrA.length])) ^ ((j14 >> 24) & 255)));
                        byteArrayOutputStream.write((byte) (((long) (bArr2[4] ^ bArrA[(i11 + 4) % bArrA.length])) ^ ((j14 >> 32) & 255)));
                        byteArrayOutputStream.write((byte) (((long) (bArr2[r26] ^ bArrA[(i11 + 5) % bArrA.length])) ^ ((j14 >> r28) & 255)));
                        byteArrayOutputStream.write((byte) (((long) (bArr2[6] ^ bArrA[(i11 + 6) % bArrA.length])) ^ ((j14 >> 48) & 255)));
                        byteArrayOutputStream.write((byte) (((j14 >> 56) & 255) ^ ((long) (bArr2[c15] ^ bArrA[(i11 + 7) % bArrA.length]))));
                        i11 += 8;
                        c10 = c10;
                        c12 = c12;
                        c11 = c11;
    ...
    private static String a(byte[] bArr, String str, com.applovin.impl.sdk.k kVar) {
        try {
            ...
            byte[] bArrA = a(str.substring(0, 32), f11064b, kVar);
    ...
    private static String a(byte[] bArr, com.applovin.impl.sdk.k kVar) {
        try {
            ...
            kVar.D().a("AppLovinSdk", com.taurusx.tax.y.s.w.f67666t, e10);
            throw new RuntimeException("SHA-1 algorithm not found", e10);
        }
    }

    private static String a(String str) {
        return str.replace('-', '+').replace('_', IOUtils.DIR_SEPARATOR_UNIX).replace('*', D5.T);
    }

    private static String a(byte[] bArr) {
        return new String(bArr, "UTF-8").replace('+', '-').replace(IOUtils.DIR_SEPARATOR_UNIX, '_').replace(D5.T, '*');
    }
}
