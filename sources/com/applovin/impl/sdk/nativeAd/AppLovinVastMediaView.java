...
public class AppLovinVastMediaView extends AppLovinMediaView implements AppLovinCommunicatorSubscriber {
    ...
    private class d implements AppLovinTouchToClickListener.OnClickListener {
        ...
        public void onClick(View view, MotionEvent motionEvent) {
            ...
            if (AppLovinVastMediaView.this.vastAd.B0() && (uriC0 = AppLovinVastMediaView.this.vastAd.c0()) != null) {
                ...
                AppLovinVastMediaView.this.nativeAd.handleNativeAdClick(uriC0, null, (!((Boolean) AppLovinVastMediaView.this.sdk.a(x4.f11447w)).booleanValue() || AppLovinVastMediaView.this.viewActivity == null) ? AppLovinVastMediaView.this.getContext() : AppLovinVastMediaView.this.viewActivity);
            }
        }
    ...
    public AppLovinVastMediaView(AppLovinNativeAdImpl appLovinNativeAdImpl, com.applovin.impl.sdk.k kVar, Context context) {
        ...
        if (((Boolean) kVar.a(x4.f11292d5)).booleanValue()) {
            ...
            this.videoWidgetLinearLayout.setAlpha(((Float) kVar.a(x4.f11283c5)).floatValue());
            ImageView imageView = new ImageView(context);
            this.playPauseButtonImageView = imageView;
            imageView.setClickable(true);
            f fVar = new f(this, aVar);
            this.playPauseButtonImageView.setOnClickListener(fVar);
            int iDpToPx3 = AppLovinSdkUtils.dpToPx(context, ((Integer) kVar.a(x4.f11266a5)).intValue());
            ...
            int iDpToPx4 = AppLovinSdkUtils.dpToPx(context, ((Integer) kVar.a(x4.f11274b5)).intValue());
        ...
        if (((Boolean) kVar.a(x4.f11301e5)).booleanValue()) {
            ...
            int iDpToPx5 = AppLovinSdkUtils.dpToPx(context, ((Integer) kVar.a(x4.f11310f5)).intValue());
        ...
        appLovinVideoView.setOnTouchListener(new AppLovinTouchToClickListener(kVar, x4.f11305f0, getContext(), new d(this, aVar)));
        ...
        hashSet.addAll(vastAd.a(o7.d.VIDEO, z7.f11655a));
    }
