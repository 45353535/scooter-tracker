...
public abstract class f3 extends n3 {
    ...
    class a implements s2.a {
        ...
        public void a(j2 j2Var, r2 r2Var) {
            ...
            com.applovin.impl.sdk.k kVarO = this.f8829a.o();
            e3.b bVarY = this.f8829a.y();
            if (!f3.this.f8827a.a(j2Var)) {
                n7.a(r2Var.c(), r2Var.b(), f3.this);
                return;
            }
            if (e3.b.READY == bVarY) {
                d.a(f3.this, MaxDebuggerMultiAdActivity.class, kVarO.e(), new C0171a());
    ...
    public void onMessageReceived(AppLovinCommunicatorMessage appLovinCommunicatorMessage) {
        if (this.f8827a.h().b().equals(appLovinCommunicatorMessage.getMessageData().getString("adapter_class", ""))) {
            this.f8827a.k();
            this.f8827a.c();
        }
    }
