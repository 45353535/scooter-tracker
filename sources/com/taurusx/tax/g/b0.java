...
public enum b0 {
    ...
    public Bitmap f66101w;

    /* JADX INFO: renamed from: z, reason: collision with root package name */
    public final String f66102z;
    ...
    public Drawable createDrawable(Context context) {
        ...
        bitmapDrawable.setTargetDensity(j0.w(context.getResources().getDisplayMetrics().xdpi, context));
        return bitmapDrawable;
    }

    public Bitmap getBitmap() {
        if (this.f66101w == null) {
            byte[] bArrDecode = Base64.decode(this.f66102z, 0);
            this.f66101w = BitmapFactory.decodeByteArray(bArrDecode, 0, bArrDecode.length);
        }
        return this.f66101w;
    }
}
