...
public class ab {
    ...
    private static int f62051a = -1;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static int f62052b = -1;
    ...
    private static void m(Context context) {
        ...
        ax.b(context, "hac", f62051a);
        ax.b(context, "tac", f62052b);
    }
    ...
    public static void b(Context context) {
        try {
            ...
            if (f62051a != 0) {
                m(context);
                com.pgl.ssdk.ces.a.meta(160, null, new int[]{f62051a, f62052b});
            }
        } catch (Throwable unused) {
        }
    }
