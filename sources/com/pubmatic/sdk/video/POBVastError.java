...
public class POBVastError {
    ...
    public POBVastError(int i10, @NonNull String str) {
        String str2;
        this.f62973a = i10;
        if (i10 == 405) {
        ...
        this.f62974b = "VAST error: " + str2 + ", Message: " + str;
    }
    ...
    public String toString() {
        return "POBVastError{errorCode=" + this.f62973a + ", errorMessage='" + this.f62974b + "'}";
    }
}
