...
public final class POBSharedPreferenceUtil {
    ...
    public static final void init(@NotNull final Context context) {
        Intrinsics.checkNotNullParameter(context, "context");
        POBTaskHandler.INSTANCE.getInstance().runOnBackgroundThread(new Runnable() { // from class: com.pubmatic.sdk.common.utility.c
    ...
    public static final <T> void writeValueInSharedPreference(@NotNull Context context, @NotNull String prefName, @NotNull String key, T value) {
        ...
        if (value != 0) {
            String simpleName = v0.b(value.getClass()).getSimpleName();
            if (Intrinsics.areEqual(simpleName, v0.b(Integer.TYPE).getSimpleName())) {
                if (editorEdit != null) {
                    editorEdit.putInt(key, ((Integer) value).intValue());
                }
            } else if (Intrinsics.areEqual(simpleName, v0.b(Float.TYPE).getSimpleName())) {
                if (editorEdit != null) {
                    editorEdit.putFloat(key, ((Float) value).floatValue());
                }
            } else if (Intrinsics.areEqual(simpleName, v0.b(Long.TYPE).getSimpleName())) {
                if (editorEdit != null) {
                    editorEdit.putLong(key, ((Long) value).longValue());
                }
            } else if (Intrinsics.areEqual(simpleName, v0.b(Boolean.TYPE).getSimpleName())) {
                if (editorEdit != null) {
                    editorEdit.putBoolean(key, ((Boolean) value).booleanValue());
                }
            } else if (!Intrinsics.areEqual(simpleName, v0.b(String.class).getSimpleName())) {
                POBLog.debug(TAG, v0.b(value.getClass()).getSimpleName() + " data type is not supported for putting value in shared preference", new Object[0]);
