...
public final class AFj1eSDK {
    ...
    public static String getMediationNetwork(String str, boolean z10) {
        return str + (!z10 ? "&buildnumber=6.17.3" : "");
    }
    ...
    public final String getMonetizationNetwork(@Nullable String str, @Nullable String str2) {
        ...
        if (strAreAllFieldsValid != null && !StringsKt.y0(strAreAllFieldsValid)) {
            strAreAllFieldsValid = TokenBuilder.TOKEN_DELIMITER + StringsKt.v1(strAreAllFieldsValid).toString();
        }
        if (strAreAllFieldsValid == null) {
            strAreAllFieldsValid = "";
        }
        String string = StringsKt.v1(strAreAllFieldsValid).toString();
        ...
        if (str == null || str2 == null) {
            ...
            builderAppendPath.appendQueryParameter("af_sig", AFj1bSDK.getRevenue(str2 + str, str));
        }
        String string2 = builderAppendPath.appendQueryParameter(ADJPConstants.KEY_SDK_VERSION, AFa1uSDK.AFAdRevenueData).build().toString();
    ...
    public final String getMonetizationNetwork(String str, boolean z10) {
        ...
        String strAreAllFieldsValid = this.toString.areAllFieldsValid();
        if (strAreAllFieldsValid != null) {
            str2 = "&channel=" + strAreAllFieldsValid;
        } else {
            str2 = null;
        }
        if (str2 == null) {
