...
public final class AFe1kSDK extends AFe1eSDK<String> {
    ...
    public AFe1kSDK(@NonNull AFc1bSDK aFc1bSDK, @NonNull UUID uuid, @NonNull String str, @NonNull Map<String, String> map, @Nullable String str2, @Nullable LinkGenerator.ResponseListener responseListener, @NonNull LinkGenerator linkGenerator) {
