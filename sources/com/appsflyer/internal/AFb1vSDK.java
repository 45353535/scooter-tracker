...
public abstract class AFb1vSDK<T> {
    ...
    public final boolean getMediationNetwork() {
        try {
            ProviderInfo providerInfoResolveContentProvider = this.getCurrencyIso4217Code.getPackageManager().resolveContentProvider(this.getRevenue, 128);
            if (providerInfoResolveContentProvider != null) {
                if (Arrays.asList(this.AFAdRevenueData).contains(AFj1iSDK.N_(this.getCurrencyIso4217Code.getPackageManager(), ((PackageItemInfo) providerInfoResolveContentProvider).packageName))) {
                    return true;
                }
            }
            return false;
