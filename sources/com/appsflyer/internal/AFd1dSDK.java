...
public class AFd1dSDK {
    ...
    public AFd1dSDK(@NonNull String str, @Nullable byte[] bArr, @NonNull String str2, @NonNull Map<String, String> map, boolean z10) {
    ...
    private AFd1dSDK(@NonNull String str, @Nullable byte[] bArr, @NonNull String str2, @NonNull Map<String, String> map, boolean z10, byte b10) {
