...
public final class AFj1aSDK {
    ...
    public static final void AFAdRevenueData(@NotNull ScheduledExecutorService p02, @NotNull Runnable p12, long p22, @NotNull TimeUnit p32) {
    ...
    public static final Map<String, Object> AFAdRevenueData(@NotNull Map<String, Object> p02) {
        Intrinsics.checkNotNullParameter(p02, "");
        Object obj = p02.get(Constants.REFERRER_API_META);
        Map<String, Object> map = b1.q(obj) ? (Map) obj : null;
        if (map != null) {
            return map;
        }
        LinkedHashMap linkedHashMap = new LinkedHashMap();
        p02.put(Constants.REFERRER_API_META, linkedHashMap);
