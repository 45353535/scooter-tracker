...
public final class AFa1gSDK {
    ...
    public static final class Companion {
        ...
        @NotNull
        public static AFa1gSDK AFAdRevenueData(@NotNull AFa1hSDK p02) {
            Intrinsics.checkNotNullParameter(p02, "");
            return new AFa1gSDK(new LinkedHashMap(), p02, null);
        }

        @NotNull
        public static AFa1gSDK getMediationNetwork(@NotNull AFh1jSDK p02) {
            Intrinsics.checkNotNullParameter(p02, "");
            Map<String, Object> map = p02.getCurrencyIso4217Code;
    ...
    public final void getCurrencyIso4217Code(@NotNull String p02, @Nullable Object p12) {
        Intrinsics.checkNotNullParameter(p02, "");
        this.getMediationNetwork.put(p02, p12);
    ...
    public final boolean getCurrencyIso4217Code(@NotNull String p02) {
        Intrinsics.checkNotNullParameter(p02, "");
        return this.getMediationNetwork.containsKey(p02);
    }
