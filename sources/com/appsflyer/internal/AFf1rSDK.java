...
public final class AFf1rSDK extends AFf1uSDK {
    ...
    protected final void getMediationNetwork(AFh1jSDK aFh1jSDK) {
        AFh1qSDK aFh1qSDK;
        AFh1qSDK aFh1qSDK2;
        ...
        if (aFh1tSDK.getRevenue()) {
            ...
            if (j10 != 0) {
                aFh1tSDK.getMonetizationNetwork.put("from_fg", Long.valueOf(jCurrentTimeMillis - j10));
        ...
        Map map = (Map) aFh1jSDK.getCurrencyIso4217Code.get(Constants.REFERRER_API_META);
        if (map == null) {
            map = new HashMap();
            aFh1jSDK.getCurrencyIso4217Code.put(Constants.REFERRER_API_META, map);
        }
        ...
        if (revenue != null) {
            ...
            if (j12 > 0) {
                map2.put(POBCTAOverlayData.KEY_CTA_DELAY, Long.valueOf(j12));
            }
            int i11 = revenue.getRevenue;
            if (i11 > 0) {
                map2.put("res_code", Integer.valueOf(i11));
            }
            ...
            map.put(DownloadCommon.DOWNLOAD_REPORT_RETRY_COUNT, map2);
        }
        ...
        if (map.isEmpty()) {
            aFh1jSDK.getCurrencyIso4217Code.remove(Constants.REFERRER_API_META);
        }
        if (i10 <= 2) {
    ...
    public final void getRevenue() {
        ...
        if (aFh1tSDK.getRevenue()) {
            ...
            aFh1tSDK.getMonetizationNetwork.put("net", Long.valueOf(jCurrentTimeMillis - j10));
            aFh1tSDK.getCurrencyIso4217Code.AFAdRevenueData("first_launch", new JSONObject(aFh1tSDK.getMonetizationNetwork).toString());
        }
    }
}
