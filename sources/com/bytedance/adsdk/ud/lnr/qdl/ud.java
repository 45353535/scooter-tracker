...
public class ud extends rdp<Float, Float> {
    public ud(List<com.bytedance.adsdk.ud.wd.qdl<Float>> list) {
        super(list);
    }
    ...
    public com.bytedance.adsdk.ud.qdl.ud.qdl<Float, Float> qdl() {
        return new com.bytedance.adsdk.ud.qdl.ud.mml(this.qdl);
    }
