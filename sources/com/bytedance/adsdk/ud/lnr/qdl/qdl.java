...
public class qdl extends rdp<Integer, Integer> {
    public qdl(List<com.bytedance.adsdk.ud.wd.qdl<Integer>> list) {
        super(list);
    }
    ...
    public com.bytedance.adsdk.ud.qdl.ud.qdl<Integer, Integer> qdl() {
        return new com.bytedance.adsdk.ud.qdl.ud.ud(this.qdl);
    }
