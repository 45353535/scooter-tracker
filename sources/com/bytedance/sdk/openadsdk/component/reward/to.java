...
public class to {
    public static void qdl(String str, int i10, String str2, String str3, String str4) {
        try {
            ...
            if (ljhVarQdl != null) {
                if (ljhVarQdl.tdy() != null) {
                    ljhVarQdl.tdy().mml(str5);
                }
                if (ljhVarQdl.fhs() != null) {
                    if (TextUtils.isEmpty(str2)) {
                        ljhVarQdl.fhs().qdl((String) null);
                        ljhVarQdl.fhs().ud("");
                    } else {
                        ljhVarQdl.fhs().qdl(str2);
                        ljhVarQdl.fhs().ud("Test the downloaded app");
                    }
                    if (TextUtils.isEmpty(str2)) {
                        str2 = str4;
                    } else {
                        ljhVarQdl.fhs().lnr(str3);
                    }
                    if (!TextUtils.isEmpty(str2)) {
                        if (ljhVarQdl.bo() != null) {
                            ljhVarQdl.bo().qdl(str2);
                        } else {
                            com.bytedance.sdk.openadsdk.core.model.exu exuVar = new com.bytedance.sdk.openadsdk.core.model.exu();
                            exuVar.qdl(str2);
                            ljhVarQdl.qdl(exuVar);
                        }
                    }
                }
                if (i10 == 1) {
            ...
            new rdp(yt.qdl(), qdlVar).qdl(true);
        } catch (Exception e10) {
            aaj.lnr("PlayableVerityHelper", e10.getMessage());
        }
    }
}
