...
public class fs {
    ...
    private static volatile fs qdl;
    private final qdl.C0250qdl lnr;

    /* JADX INFO: renamed from: ud, reason: collision with root package name */
    private final Context f17030ud;

    private fs(Context context) {
        this.f17030ud = context == null ? yt.qdl() : context.getApplicationContext();
        this.lnr = new qdl.C0250qdl("sp_reward_video");
    }

    public void qdl(String str, ljh ljhVar) {
        if (com.bytedance.sdk.openadsdk.utils.ud.qdl()) {
            com.bytedance.sdk.openadsdk.common.qdl.qdl("sp_reward_video_new").qdl(str, ljhVar);
            return;
        }
    ...
    public void qdl() {
        ...
        if (com.bytedance.sdk.openadsdk.utils.ud.qdl()) {
            com.bytedance.sdk.openadsdk.common.qdl.qdl("sp_reward_video_new").qdl();
            return;
        }
        try {
            int i10 = Build.VERSION.SDK_INT;
            boolean zWd = com.bytedance.sdk.openadsdk.core.tvp.wd("sp_reward_video");
            if (zWd) {
                str = "files";
            } else {
                str = "shared_prefs";
            ...
            if (i10 >= 24) {
                file = new File(this.f17030ud.getDataDir(), str);
            } else {
                file = new File(this.f17030ud.getDatabasePath("1").getParentFile().getParentFile(), str);
            }
            if (file.exists() && file.isDirectory() && (fileArrListFiles2 = file.listFiles(new FileFilter() { // from class: com.bytedance.sdk.openadsdk.component.reward.fs.1
                ...
                for (File file2 : fileArrListFiles2) {
                    if (zWd) {
                        ...
                        if (Build.VERSION.SDK_INT >= 24) {
                            this.f17030ud.deleteSharedPreferences(strReplace);
                        } else {
                            this.f17030ud.getSharedPreferences(strReplace, 0).edit().clear().apply();
                            com.bytedance.sdk.component.utils.wd.lnr(file2);
                        }
                    }
                }
        ...
        try {
            File cacheDir = this.f17030ud.getCacheDir();
            if (cacheDir == null || !cacheDir.exists() || !cacheDir.isDirectory() || (fileArrListFiles = cacheDir.listFiles(new FileFilter() { // from class: com.bytedance.sdk.openadsdk.component.reward.fs.2
                @Override // java.io.FileFilter
    ...
    public void qdl(AdSlot adSlot, com.bytedance.sdk.openadsdk.core.model.qdl qdlVar) {
        ...
        if (qdlVar == null || qdlVar.mo() == null || !qdlVar.mo().ilu()) {
            if (com.bytedance.sdk.openadsdk.utils.ud.qdl()) {
                com.bytedance.sdk.openadsdk.common.qdl.qdl("sp_reward_video_new").qdl(adSlot, qdlVar);
                return;
            }
            if (qdlVar == null || qdlVar.jpc() || adSlot == null || !TextUtils.isEmpty(adSlot.getBidAdm()) || (ljhVarMo = qdlVar.mo()) == null || ljhVarMo.ly() == 2) {
                return;
            }
            ...
            synchronized (qdlVar) {
                try {
                    if (!qdlVar.jpc()) {
                        try {
                            this.lnr.qdl(adSlot, qdlVar.exu().toString(), strUd);
                        } catch (Throwable unused) {
                            qdlVar.tvp();
                        }
                    }
    ...
    public static fs qdl(Context context) {
        if (qdl == null) {
    ...
    public String qdl(String str, boolean z10) {
        com.bytedance.sdk.openadsdk.common.qdl qdlVarQdl = com.bytedance.sdk.openadsdk.common.qdl.qdl("sp_reward_video_new");
    ...
    public boolean qdl(com.bytedance.sdk.openadsdk.core.model.qdl qdlVar) {
        return com.bytedance.sdk.openadsdk.common.qdl.qdl("sp_reward_video_new").qdl(qdlVar, true);
    }
    ...
    public void qdl(String str) {
        if (com.bytedance.sdk.openadsdk.utils.ud.qdl()) {
            com.bytedance.sdk.openadsdk.common.qdl.qdl("sp_reward_video_new").lnr(str);
        } else {
            this.lnr.mo(str);
        }
    }
