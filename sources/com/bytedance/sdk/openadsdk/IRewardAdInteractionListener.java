...
public interface IRewardAdInteractionListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IRewardAdInteractionListener {
        ...
        private static class qdl implements IRewardAdInteractionListener {
            public static IRewardAdInteractionListener qdl;

            /* JADX INFO: renamed from: ud, reason: collision with root package name */
            private IBinder f16762ud;

            qdl(IBinder iBinder) {
                this.f16762ud = iBinder;
            }

            @Override // android.os.IInterface
            public IBinder asBinder() {
                return this.f16762ud;
            }
            ...
            public void onAdClose() throws RemoteException {
                ...
                try {
                    ...
                    if (this.f16762ud.transact(4, parcelObtain, parcelObtain2, 0) || Stub.getDefaultImpl() == null) {
            ...
            public void onAdShow() throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken("com.bytedance.sdk.openadsdk.IRewardAdInteractionListener");
                    if (this.f16762ud.transact(2, parcelObtain, parcelObtain2, 0) || Stub.getDefaultImpl() == null) {
                        parcelObtain2.readException();
                    } else {
            ...
            public void onAdVideoBarClick() throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken("com.bytedance.sdk.openadsdk.IRewardAdInteractionListener");
                    if (this.f16762ud.transact(3, parcelObtain, parcelObtain2, 0) || Stub.getDefaultImpl() == null) {
                        parcelObtain2.readException();
                    } else {
            ...
            public void onDestroy() throws RemoteException {
                ...
                try {
                    parcelObtain.writeInterfaceToken("com.bytedance.sdk.openadsdk.IRewardAdInteractionListener");
                    if (this.f16762ud.transact(1, parcelObtain, parcelObtain2, 0) || Stub.getDefaultImpl() == null) {
                        parcelObtain2.readException();
                    } else {
            ...
            public void onRewardVerify(boolean z10, int i10, String str, int i11, String str2) throws RemoteException {
                ...
                try {
                    ...
                    if (this.f16762ud.transact(5, parcelObtain, parcelObtain2, 0) || Stub.getDefaultImpl() == null) {
                        parcelObtain2.readException();
                    } else {
        ...
        public static IRewardAdInteractionListener asInterface(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof IRewardAdInteractionListener)) ? new qdl(iBinder) : (IRewardAdInteractionListener) iInterfaceQueryLocalInterface;
        }
        ...
        public static boolean setDefaultImpl(IRewardAdInteractionListener iRewardAdInteractionListener) {
            ...
            qdl.qdl = iRewardAdInteractionListener;
            return true;
        }
