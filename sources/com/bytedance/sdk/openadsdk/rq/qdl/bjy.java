...
public class bjy extends com.bytedance.sdk.component.qdl.mml<JSONObject, JSONObject> {
    private final hkc qdl;

    public bjy(hkc hkcVar) {
        this.qdl = hkcVar;
    }

    public static void qdl(com.bytedance.sdk.component.qdl.bjy bjyVar, hkc hkcVar) {
        bjyVar.qdl("commonConvert", new bjy(hkcVar));
    }
