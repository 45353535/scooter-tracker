...
import com.bytedance.sdk.component.adexpress.dynamic.mml.mml;
...
public class lnr {
    public JSONObject qdl(List<mml.qdl> list, int i10, JSONObject jSONObject) {
        mml.qdl next;
        ...
        while (true) {
            ...
            next = it.next();
            if (next != null && next.qdl == i10) {
                break;
            }
        }
        if (next == null || (jSONObject2 = next.f16366ud) == null) {
            return null;
        }
        return qdl(jSONObject2, jSONObject);
    }

    private static JSONObject qdl(JSONObject jSONObject, JSONObject jSONObject2) {
