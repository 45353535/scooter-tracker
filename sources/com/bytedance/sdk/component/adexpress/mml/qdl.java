...
public class qdl {
    public static Bitmap qdl(Context context, Bitmap bitmap, int i10) {
        ...
        try {
            ...
            return com.bytedance.sdk.component.adexpress.mml.mml() == 0 ? ud(context, bitmapCreateScaledBitmap, i10) : com.bytedance.sdk.component.adexpress.mml.mml() == 1 ? qdl(bitmapCreateScaledBitmap, i10) : ud(bitmapCreateScaledBitmap, i10);
    ...
    public static Bitmap ud(Context context, Bitmap bitmap, int i10) {
        RenderScript renderScriptCreate;
        Allocation allocationCreateFromBitmap;
        ?? Create;
        ?? CreateFromBitmap;
        com.bytedance.sdk.component.adexpress.qdl.qdl.lnr lnrVarLnr;
        try {
            Bitmap bitmapCreateBitmap = Bitmap.createBitmap(bitmap);
            renderScriptCreate = RenderScript.create(context);
            if (renderScriptCreate == null) {
                try {
                    com.bytedance.sdk.component.adexpress.qdl.qdl.lnr lnrVarLnr2 = com.bytedance.sdk.component.adexpress.qdl.qdl.qdl.qdl().lnr();
                    if (lnrVarLnr2 != null && lnrVarLnr2.yt() && renderScriptCreate != null) {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        com.bytedance.sdk.component.adexpress.qdl.qdl.lnr lnrVarLnr3 = com.bytedance.sdk.component.adexpress.qdl.qdl.qdl.qdl().lnr();
                        if (lnrVarLnr3 != null && lnrVarLnr3.yt()) {
                            RenderScript.releaseAllContexts();
                    ...
                    try {
                        th.getMessage();
                        try {
                            lnrVarLnr = com.bytedance.sdk.component.adexpress.qdl.qdl.qdl.qdl().lnr();
                            return lnrVarLnr == null ? null : null;
                        } catch (Throwable th7) {
                            th7.getMessage();
                            return null;
                        }
                        ...
                        try {
                            com.bytedance.sdk.component.adexpress.qdl.qdl.lnr lnrVarLnr4 = com.bytedance.sdk.component.adexpress.qdl.qdl.qdl.qdl().lnr();
                            if (lnrVarLnr4 != null && lnrVarLnr4.yt()) {
                                if (renderScriptCreate != null) {
                                    RenderScript.releaseAllContexts();
                                }
                                if (allocationCreateFromBitmap != null) {
                ...
                th.getMessage();
                lnrVarLnr = com.bytedance.sdk.component.adexpress.qdl.qdl.qdl.qdl().lnr();
                if (lnrVarLnr == null && lnrVarLnr.yt()) {
                    if (renderScriptCreate != null) {
                        RenderScript.releaseAllContexts();
                    }
                    if (allocationCreateFromBitmap != null) {
    ...
    public static Bitmap qdl(Bitmap bitmap, int i10) {
        int i11;
        int i12;
        int i13 = i10;
        try {
            ...
            while (i60 < width) {
                ...
                int i77 = 0;
                while (i77 < height) {
                    iArr16[i76] = (iArr16[i76] & ViewCompat.MEASURED_STATE_MASK) | (iArr4[i63] << 16) | (iArr4[i64] << 8) | iArr4[i65];
    ...
    public static Bitmap ud(Bitmap bitmap, int i10) {
        try {
