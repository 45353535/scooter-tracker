...
import com.bytedance.sdk.component.mzz.mml.lnr.lnr;
...
public class ud implements bjy {
    ...
    public InputStream qdl(String str, String str2) {
        ...
        if (this.qdl != null) {
            ...
            jl jlVarUd = this.qdl.ud();
            if (jlVarUd != null && (bArrQdl = jlVarUd.qdl(str2)) != null) {
            ...
            if (collectionLnr != null) {
                ...
                while (it.hasNext()) {
                    InputStream inputStreamQdl = it.next().qdl(str2);
