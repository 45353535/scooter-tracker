...
public class mzz implements exu {
    ...
    private ExecutorService f16616ud;

    /* JADX INFO: renamed from: wd, reason: collision with root package name */
    private com.bytedance.sdk.component.mzz.ud f16617wd;
    ...
    public static class qdl {
        ...
        /* JADX INFO: renamed from: ud, reason: collision with root package name */
        private ExecutorService f16618ud;

        /* JADX INFO: renamed from: wd, reason: collision with root package name */
        private com.bytedance.sdk.component.mzz.ud f16619wd;
    ...
    private mzz(qdl qdlVar) {
        this.qdl = qdlVar.qdl;
        this.f16616ud = qdlVar.f16618ud;
        this.lnr = qdlVar.lnr;
        this.mml = qdlVar.mml;
        this.mzz = qdlVar.mzz;
        this.mo = qdlVar.mo;
        this.f16617wd = qdlVar.f16619wd;
        this.jpc = qdlVar.jpc;
        this.tvp = qdlVar.tvp;
        this.to = qdlVar.to;
    }
