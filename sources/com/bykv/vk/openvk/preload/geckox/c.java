...
public final class c {
    ...
    private static File f15791a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static Context f15792b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static String f15793c;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    private static final Set<String> f15794g = new HashSet(Arrays.asList("js", "css", "html", "ico", "jpeg", "jpg", "png", "gif", "woff", "svg", "ttf", "woff2", "webp", "otf", "sfnt"));

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private Map.Entry<String, JSONObject> f15795d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private Map.Entry<String, JSONObject> f15796e;

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private INetWork f15797f;

    static class a {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        private static c f15798a = new c(0);
    }
    ...
    public static c a(Context context) {
        f15792b = context;
        if (f15791a == null) {
            f15791a = new File(f15792b.getCacheDir() + File.separator + "gecko");
        }
        return a.f15798a;
    }
    ...
    private void c(String str) {
        try {
            if (this.f15797f == null || TextUtils.isEmpty(str)) {
                return;
            }
            this.f15797f.syncDoGet(str);
    ...
    public static com.bykv.vk.openvk.preload.falconx.loader.a b() {
        try {
            return new com.bykv.vk.openvk.preload.falconx.loader.a(f15792b, "f36c832c8dbb162c49b46a7a6dd47fbd", f15791a);
        } catch (Throwable unused) {
            return null;
        }
    }
    ...
    public final void a(String str, IStatisticMonitor iStatisticMonitor, Set<String> set, INetWork iNetWork) {
        ...
        b bVar = new b(new b.a(f15792b).b("f36c832c8dbb162c49b46a7a6dd47fbd").a("f36c832c8dbb162c49b46a7a6dd47fbd").b().b(str).a("9999999.0.0").a(new a.C0198a().a().a(com.bykv.vk.openvk.preload.geckox.a.a.b.f15732b).b()).a(f15791a).a().c(f15793c).a(iStatisticMonitor).a(iNetWork).a(SystemClock.elapsedRealtime()), (byte) 0);
        this.f15797f = iNetWork;
    ...
    private JSONObject a(String str, String str2) {
        if (str != null && str2 != null) {
            try {
                Map.Entry<String, JSONObject> entry = this.f15795d;
                if (entry == null || !str.equals(entry.getKey())) {
                    String strA = com.bykv.vk.openvk.preload.geckox.utils.b.a(new com.bykv.vk.openvk.preload.falconx.loader.a(f15792b, "f36c832c8dbb162c49b46a7a6dd47fbd", f15791a).getInputStream(str + "/manifest.json"));
                    if (TextUtils.isEmpty(strA)) {
                        return null;
                    }
                    this.f15795d = new AbstractMap.SimpleEntry(str, new JSONObject(strA));
                }
                Map.Entry<String, JSONObject> entry2 = this.f15796e;
                if (entry2 == null || !str.equals(entry2.getKey())) {
                    String strA2 = com.bykv.vk.openvk.preload.geckox.utils.b.a(new com.bykv.vk.openvk.preload.falconx.loader.a(f15792b, "f36c832c8dbb162c49b46a7a6dd47fbd", f15791a).getInputStream(str + "/md5_url_map.json"));
                    if (TextUtils.isEmpty(strA2)) {
                        return null;
                    }
                    this.f15796e = new AbstractMap.SimpleEntry(str, new JSONObject(strA2));
                }
                JSONObject value = this.f15795d.getValue();
                JSONObject value2 = this.f15796e.getValue();
    ...
    public final WebResourceResponseModel a(ILoader iLoader, String str, String str2) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(str2) && !str2.matches("^https?:\\/\\/www\\.google-analytics\\.com/(?:ga|urchin|analytics)\\.js") && !str2.matches("^https?:\\/\\/www\\.googletagmanager\\.com\\/(gtag\\/js|gtm\\.js)") && !str2.matches("^https?:\\/\\/analytics\\.tiktok\\.com\\/i18n\\/pixel") && !str2.matches("https?:\\/\\/connect\\.facebook\\.net\\/(.*)\\/fbevents\\.js") && !str2.matches("https?:\\/\\/mc\\.yandex\\.ru\\/") && !str2.contains("jsonp") && !str2.contains("Callback") && !str2.contains("analytics.tiktok.com/i18n/pixel") && !str2.contains("google-analytics.com/analytics") && !str2.contains("connect.facebook.net")) {
                ...
                String strOptString = jSONObjectA.optString(V5.c.f41892b, null);
    ...
    public static int a(ILoader iLoader, String str) {
        ...
        try {
            return new com.bykv.vk.openvk.preload.falconx.loader.a(f15792b, "f36c832c8dbb162c49b46a7a6dd47fbd", f15791a).a(str + File.separator);
        } catch (Throwable unused) {
            return 0;
        }
    }
