...
public class InterceptorModel {
    ...
    public InterceptorModel fromJson(String str) {
        try {
            ...
            if (jSONObject.has(AppsFlyerProperties.CHANNEL)) {
                this.channel = (String) a.a(jSONObject, AppsFlyerProperties.CHANNEL, String.class);
            }
            ...
            if (jSONObject.has(CampaignEx.KEY_ACTIVITY_PATH_AND_NAME)) {
                this.f15705ac = (String) a.a(jSONObject, CampaignEx.KEY_ACTIVITY_PATH_AND_NAME, String.class);
            }
    ...
    public String toJson() {
        try {
            ...
            jSONObject.put(CampaignEx.KEY_ACTIVITY_PATH_AND_NAME, this.f15705ac);
