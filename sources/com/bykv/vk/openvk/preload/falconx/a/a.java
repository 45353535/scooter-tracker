...
public final class a {
    ...
    private final Map<Class<? extends d<?, ?>>, b> f15702a = new HashMap();
    ...
    public final void a(Class<? extends d<?, ?>> cls, com.bykv.vk.openvk.preload.a.b.a aVar) {
        synchronized (this.f15702a) {
            try {
                b bVar = this.f15702a.get(cls);
                if (bVar == null) {
                    bVar = new b(new com.bykv.vk.openvk.preload.a.b.a[0]);
                    this.f15702a.put(cls, bVar);
                }
                bVar.a(aVar);
            } catch (Throwable th2) {
                throw th2;
