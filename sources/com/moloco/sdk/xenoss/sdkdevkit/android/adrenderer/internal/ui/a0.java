...
public abstract class a0 {
    public static final w a(Painter painter, long j10, Shape shape, long j11, Composer composer, int i10, int i11) {
        composer.startReplaceableGroup(571957227);
        if ((i11 & 1) != 0) {
            painter = PainterResources_androidKt.painterResource(R$drawable.f53874a, composer, 0);
        }
        ...
        w.b bVar = new w.b(painter2, "Close", j12, shape2, jD, null);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final Function10 b(Alignment alignment, PaddingValues paddingValues, long j10, long j11, long j12, w wVar, Function0 function0, com.moloco.sdk.internal.ortb.model.k kVar, Composer composer, int i10, int i11) {
        ...
        w wVarA = (i11 & 32) != 0 ? a(null, 0L, null, 0L, composer, 0, 15) : wVar;
        ...
        int i12 = i10 << 3;
        Function10 function10A = l.a(topEnd, paddingValuesM411PaddingValues0680j_4, jM962getPrimary0d7_KjU, jB, jC, wVarA, a.AbstractC0780a.c.EnumC0782a.f58911c, function02, kVar2, composer, (i12 & 234881024) | (i10 & 14) | 1572864 | (i10 & 112) | (i10 & 896) | (i10 & 7168) | (57344 & i10) | (458752 & i10) | (29360128 & i12));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        composer.endReplaceableGroup();
