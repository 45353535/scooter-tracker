...
final class DtbMetric {
    ...
    private static /* synthetic */ DtbMetric[] $values() {
    ...
    static {
        ...
        SIS_COUNTER_IDENTIFIED_DEVICE_CHANGED = new DtbMetric("SIS_COUNTER_IDENTIFIED_DEVICE_CHANGED", 10, "sid", "sid", dtbMetricType2);
    ...
    public String toString() {
        return C4240b4.j.f42672d + getAAXName() + ", " + getMetricType() + C4240b4.j.f42674e;
    }
}
