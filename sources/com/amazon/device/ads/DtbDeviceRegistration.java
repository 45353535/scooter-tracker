...
public class DtbDeviceRegistration {
    ...
    /* JADX WARN: Type inference failed for: r2v8, types: [com.amazon.device.ads.DtbMetrics] */
    ...
    private synchronized void initializeAds() {
        ...
        if (DtbSharedPreferences.getInstance().getIsSisRegisterationSuccessful()) {
            ...
            if (j10 <= SignalManager.TWENTY_FOUR_HOURS_MILLIS) {
                DtbLog.debug("SIS call not required, last registration duration:" + j10 + ", expiration:" + SignalManager.TWENTY_FOUR_HOURS_MILLIS);
                return;
            }
        }
        ...
        try {
            ...
            try {
                ...
                this.metrics.startTimer(dtbMetric3);
                dtbHttpClient.executePOST(60000);
                this.metrics.stopTimer(dtbMetric3);
    ...
    private boolean isRegistrationRequestSuccessful(JSONObject jSONObject) throws JSONException {
        ...
        if (jSONObject.getInt("rcode") == 1 && jSONObject.has(f.b.f45109c)) {
            String string = jSONObject.getString(f.b.f45109c);
    ...
    private void pingSis(String str, String str2) {
        if (System.currentTimeMillis() - DtbSharedPreferences.getInstance().getSisLastPing() < UserAgentInfo.USER_AGENT_MAX_VALIDITY_TIME_MILLIS) {
            return;
        }
        String adId = DtbSharedPreferences.getInstance().getAdId();
    ...
    private boolean registerConfig(String str) {
        ...
        dtbHttpClient.addHeader("Accept", D5.L);
    ...
    public static synchronized void verifyRegistration() {
        try {
            ...
            if (!ApsMigrationUtil.isApsRemoteConfigInProgress()) {
                ...
                DtbThreadService.getInstance().execute(new Runnable() { // from class: com.amazon.device.ads.q0
