...
public class DtbConstants {
    ...
    public static final String SDK_VERSION = "11.1.1";
    ...
    static final String displayImpressionPath = "e/msdk/imp";
    ...
    static final String videoImpressionPath = "e/msdk/impv";
    static final String INTEGRATED_OM_VERSION = Omid.getVersion().split(TokenBuilder.TOKEN_DELIMITER)[0].replace(".", "_");
