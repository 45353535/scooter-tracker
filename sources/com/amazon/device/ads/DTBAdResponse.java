...
public class DTBAdResponse {
    ...
    private static final String AMZNH_PARAMETER_KEY = "amznh";
    private static final String LOG_TAG = "DTBAdResponse";
    private String bidId;
    private String bidder;
    private JSONObject bridgingBidderExtra;
    private String crid;
    ...
    private String defaultImpressionUrl() {
        return String.format("https://%s/%s?b=%s&ps=%s", resolvedHostName(), isVideo() ? "e/msdk/impv" : "e/msdk/imp", getBidId(), getDefaultPricePoints());
    }
    ...
    private String getAmazonInfo() {
        ...
        return String.format(AMAZON_AD_INFO, this.bidId, strResolvedHostName, str, Integer.valueOf(width), Integer.valueOf(height), SDKUtilities.getPricePoint(this));
    }
    ...
    public String getImpressionUrl() {
        return !ApsUtils.INSTANCE.isNullOrEmpty(this.impressionUrl) ? this.impressionUrl : defaultImpressionUrl();
    }
    ...
    protected void setVideo(boolean z10) {
        this.isVideo = z10;
    }
    ...
    void setVideoSkipAfterDurationInSeconds(int i10) {
