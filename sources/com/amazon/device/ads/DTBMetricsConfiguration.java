...
public class DTBMetricsConfiguration {
    ...
    private static final String METRICS_CONFIG_OVERRIDE_PREF_KEY = "aps_metrics_config_override";
    ...
    public static Double getClientConfigVal(String str, String str2, String str3, double d10) {
        try {
            ...
            ApsLog.d(LOG_TAG, "Error reading the int config value " + str + " : " + str2 + " : " + str3 + " - " + e10);
        }
    ...
    File createTempFile(File file) {
        try {
            return File.createTempFile(C4274d4.D, "json", file);
        } catch (Exception unused) {
    ...
    protected void loadMobileClientConfig() {
        ...
        DtbThreadService.getInstance().execute(new Runnable() { // from class: com.amazon.device.ads.n0
            ...
            public final void run() {
                this.f7451b.loadConfigurationFromWeb();
            }
        });
    }
    ...
    public static String getClientConfigVal(String str, String str2, String str3, String str4) {
        try {
            ...
            ApsLog.d(LOG_TAG, "Error reading the String config value " + str + " : " + str2 + " : " + str3 + " - " + e10);
        }
        return str4;
    }
