...
public class ApsAdUtils {
    ...
    public static void addApsAdInAdManagerAdRequest(@NonNull AdManagerAdRequest adManagerAdRequest, @NonNull ApsAd apsAd) {
    ...
    public static void addApsAdInAdManagerAdRequestBuilder(@NonNull AdManagerAdRequest.Builder builder, @NonNull ApsAd apsAd) {
    ...
    public static Bundle createAdMobBannerRequestBundle(@NonNull String str, @NonNull ApsAdFormat apsAdFormat) {
    ...
    public static JSONObject getUnityLevelPlayDataForBanner(@NonNull String str, @NonNull ApsAd apsAd) {
    ...
    public static JSONObject getUnityLevelPlayDataForInterstitial(String str, @NonNull ApsAd apsAd) {
        checkNullAndLogInvalidArg(str, apsAd);
        JSONObject jSONObject = new JSONObject();
        try {
            JSONObject jSONObject2 = new JSONObject();
    ...
    public static boolean sdkRenderingBridgeEnabled(String str) {
        return !ApsUtils.INSTANCE.isNullOrEmpty(str) && str.contains(DtbConstants.AMZN_SDK_BIDDER_ID_KEY) && str.contains(DtbConstants.AMZN_BIDDER_REQUEST_KEY) && str.contains(DtbConstants.AMZN_IMP_URL_KEY);
    }
    ...
    public static Bundle createAdMobInterstitialRequestBundle(@NonNull String str, @NonNull ApsSlotInfoExtra apsSlotInfoExtra) {
        checkNullAndLogInvalidArg(str);
        return DTBAdUtil.createAdMobInterstitialRequestBundle(str, apsSlotInfoExtra);
    }

    public static Bundle createAdMobInterstitialVideoRequestBundle(@NonNull String str, @NonNull ApsSlotInfoExtra apsSlotInfoExtra) {
        checkNullAndLogInvalidArg(str);
        return DTBAdUtil.createAdMobInterstitialVideoRequestBundle(str, apsSlotInfoExtra);
    }

    public static Bundle createAdMobBannerRequestBundle(@NonNull String str, @NonNull ApsAdFormat apsAdFormat, ApsSlotInfoExtra apsSlotInfoExtra) {
        checkNullAndLogInvalidArg(str, apsAdFormat);
