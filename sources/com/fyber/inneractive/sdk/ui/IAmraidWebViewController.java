...
public class IAmraidWebViewController extends i0 {
    ...
    public IAmraidWebViewController(boolean z10, c0 c0Var, z zVar, d0 d0Var, boolean z11, com.fyber.inneractive.sdk.measurement.e eVar, r rVar) {
        ...
        this.f23811p0 = new f(this);
        this.F = z11;
        this.f23971b.setId(R.id.ia_inneractive_webview_mraid);
    }
    ...
    public final boolean a(String str, g1 g1Var) {
        ...
        if (string.startsWith("iaadfinishedloading")) {
            if (string.endsWith("success")) {
                ...
                if (!this.f23970a && this.f23975f != null && (mVar = this.f23971b) != null) {
                    mVar.a();
                    this.f23970a = true;
                    q();
                }
        ...
        if (mVar2 != null && mVar2.isShown() && this.N != f0.HIDDEN) {
            ...
            try {
                ...
                switch (com.fyber.inneractive.sdk.mraid.j.f21267a[k.a(host).ordinal()]) {
                    case 1:
    ...
    public final void e() {
        b(false);
        Handler handler = com.fyber.inneractive.sdk.util.r.f23896b;
        handler.removeCallbacks(this.f23811p0);
    ...
    */
    public final void k() {
        /*
            r5 = this;
            super.k()
            com.fyber.inneractive.sdk.web.m r0 = r5.f23971b
            r1 = 1
            r2 = 0
            if (r0 == 0) goto L30
            ...
            r3.<init>(r0, r4)
            android.app.Application r0 = com.fyber.inneractive.sdk.util.o.f23888a     // Catch: java.lang.Throwable -> L2b
        ...
        L4d:
            ...
            if (r0 == 0) goto L60
            android.app.Application r0 = com.fyber.inneractive.sdk.util.o.f23888a
    ...
    public final void n() {
        ...
        if (this.C && this.D && this.A && (mVar = this.f23971b) != null) {
            ...
            f fVar = this.f23811p0;
            if (fVar != null) {
                com.fyber.inneractive.sdk.util.r.f23896b.postDelayed(fVar, 5000L);
            }
            if (this.E) {
        ...
        if (lowerCase != null) {
            ...
            if (lowerCase.startsWith("FyMraidVideo".toLowerCase(locale))) {
                if (lowerCase.endsWith("fyMraidVideoAd".toLowerCase(locale))) {
                    ...
                    com.fyber.inneractive.sdk.response.e eVarB = this.f23989t;
                    if (eVarB == null) {
                        x xVar = this.f23988s;
                    ...
                    if (j1Var != null) {
                        ...
                        InneractiveAdRequest inneractiveAdRequest2 = this.f23987r;
                        x xVar3 = this.f23988s;
                        com.fyber.inneractive.sdk.response.e eVarB2 = xVar3 == null ? null : xVar3.b();
                        x xVar4 = this.f23988s;
                        JSONArray jSONArrayB2 = xVar4 == null ? null : xVar4.f21037c.b();
                    ...
                    j1 j1Var3 = this.f23976g;
                    if (j1Var3 instanceof g0) {
                        ((com.fyber.inneractive.sdk.renderers.s) ((g0) j1Var3)).f23698a.J();
                    }
                }
                return true;
            }
