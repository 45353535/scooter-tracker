...
public final class d implements Comparator {
    ...
    public final int compare(Object obj, Object obj2) {
        ...
        int iA = v.a(cVar.f21184h, cVar2.f21184h);
        if (iA != 0) {
            return iA;
        }
        com.fyber.inneractive.sdk.model.vast.i iVar = cVar.f21177a;
        ...
        com.fyber.inneractive.sdk.model.vast.i iVar3 = cVar2.f21177a;
        if (iVar3 == iVar2) {
            i10 = 1;
        ...
        int iCompare = Float.compare(Math.abs((cVar.f21179c / cVar.f21180d) - this.f21009b), Math.abs((cVar2.f21179c / cVar2.f21180d) - this.f21009b));
        if (iCompare != 0) {
            return iCompare;
        }
        return v.a(Math.abs((cVar.f21179c * cVar.f21180d) - this.f21008a), Math.abs((cVar2.f21179c * cVar2.f21180d) - this.f21008a));
    }
}
