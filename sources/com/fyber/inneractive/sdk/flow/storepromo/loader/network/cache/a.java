...
public final class a implements com.fyber.inneractive.sdk.cache.a {
    ...
    public final String c() {
        return String.valueOf(("dt_store.promo_" + this.f20945a).hashCode());
    }
    ...
    public final void a(Object obj) {
        ...
        if (str != null) {
            o.f23888a.getSharedPreferences("IAConfigurationPreferences", 0).edit().putString("dt_store.promo.data", str).apply();
        }
    }
