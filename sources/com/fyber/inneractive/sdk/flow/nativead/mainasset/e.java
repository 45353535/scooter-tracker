...
public abstract class e {
    public static d a(r rVar, j jVar, InneractiveAdRequest inneractiveAdRequest, i iVar, String str, com.fyber.inneractive.sdk.flow.nativead.f fVar) {
        ...
        String str2;
        ArrayList arrayList = iVar.f23768a;
        if (arrayList != null && !arrayList.isEmpty()) {
            for (com.fyber.inneractive.sdk.response.nativead.f fVar2 : iVar.f23768a) {
                if (fVar2.f23755a == 3 && jVar.T.d()) {
                ...
                if (fVar2.f23755a == 2 && (cVar = fVar2.f23758d) != null && (str2 = cVar.f23752a) != null && !str2.trim().isEmpty()) {
