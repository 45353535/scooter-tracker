...
public class InneractiveAdViewUnitController extends s0 implements g0, InneractiveFullscreenAdActivity.FullScreenRendererProvider {
    ...
    public final HashSet f20582a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public boolean f20583b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public ViewGroup f20584c;
    ...
    public InneractiveAdViewUnitController() {
        ...
        this.f20585d = 0;
        this.f20582a = new HashSet();
    }

    public final void a() {
        this.f20583b = true;
        Iterator it = new HashSet(this.f20582a).iterator();
        while (it.hasNext()) {
    ...
    public void bindView(ViewGroup viewGroup) {
        ...
        for (InneractiveAdRenderer inneractiveAdRenderer : new HashSet(this.f20582a)) {
        ...
        this.f20584c = viewGroup;
        Iterator it = com.fyber.inneractive.sdk.factories.b.f20611a.f20612a.iterator();
        while (true) {
            if (!it.hasNext()) {
                dVarA = null;
                break;
    ...
    public int getAdContentHeight() {
        int iO;
        for (InneractiveAdRenderer inneractiveAdRenderer : this.f20582a) {
    ...
    public com.fyber.inneractive.sdk.interfaces.f getFullscreenRenderer() {
        ...
        Iterator it = com.fyber.inneractive.sdk.factories.h.f20615a.f20616a.iterator();
        while (true) {
            if (!it.hasNext()) {
                fVarB = null;
                break;
    ...
    public void onAdRefreshed(InneractiveAdSpot inneractiveAdSpot) {
        ...
        try {
            if (inneractiveAdSpot instanceof h0) {
                ...
                ((h0) inneractiveAdSpot).f20744h.f20850d.b();
            }
    ...
    public boolean supports(InneractiveAdSpot inneractiveAdSpot) {
        com.fyber.inneractive.sdk.config.r0 r0Var = (com.fyber.inneractive.sdk.config.r0) inneractiveAdSpot.getAdContent().f21038d;
        if (r0Var.f20437e != null) {
            return false;
        }
        l0 l0Var = r0Var.f20435c;
        if (l0Var != null) {
            if (UnitDisplayType.BANNER.equals(l0Var.f20420b) || UnitDisplayType.MRECT.equals(l0Var.f20420b)) {
                return true;
            }
            if (UnitDisplayType.INTERSTITIAL.equals(l0Var.f20420b)) {
        ...
        return t0Var != null && (UnitDisplayType.LANDSCAPE.equals(t0Var.f20498j) || UnitDisplayType.SQUARE.equals(t0Var.f20498j) || UnitDisplayType.MRECT.equals(t0Var.f20498j));
    }
    ...
    public void unbindView(View view) {
        if (this.f20584c != view) {
            IAlog.f("%s unbindView invoked with incorrect view, was - %s received - %s", logPrefix(), this.f20584c, view);
        } else {
            this.f20584c = null;
        }
