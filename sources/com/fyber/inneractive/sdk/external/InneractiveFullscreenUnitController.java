...
public class InneractiveFullscreenUnitController extends s0 implements InneractiveFullscreenAdActivity.FullScreenRendererProvider, InneractiveFullscreenAdActivity.OnInneractiveFullscreenAdDestroyListener {
    ...
    public InneractiveFullScreenAdRewardedListener f20587b;
    protected com.fyber.inneractive.sdk.interfaces.f mRenderer;

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public boolean f20586a = false;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public final g f20588c = new g(this);
    ...
    public void setRewardedListener(InneractiveFullScreenAdRewardedListener inneractiveFullScreenAdRewardedListener) {
        this.f20587b = inneractiveFullScreenAdRewardedListener;
    }
    ...
    public void show(Activity activity) {
        ...
        if (adContent != null) {
            ...
            InneractiveAdRequest inneractiveAdRequest = adContent.f21035a;
            com.fyber.inneractive.sdk.response.e eVarB = adContent.b();
            JSONArray jSONArrayB = adContent.f21037c.b();
            w wVar = new w(eVarB);
            wVar.f21418c = uVar;
        ...
        if (this.mRenderer == null) {
            i iVar = com.fyber.inneractive.sdk.factories.h.f20615a;
            InneractiveAdSpot adSpot2 = getAdSpot();
            Iterator it = iVar.f20616a.iterator();
            while (true) {
                if (!it.hasNext()) {
                    break;
                }
    ...
    public boolean supports(InneractiveAdSpot inneractiveAdSpot) {
        com.fyber.inneractive.sdk.config.s0 s0Var = inneractiveAdSpot.getAdContent().f21038d;
        if (s0Var != null) {
            r0 r0Var = (r0) s0Var;
            if (r0Var.f20437e == null) {
                l0 l0Var = r0Var.f20435c;
                if (l0Var != null && UnitDisplayType.INTERSTITIAL.equals(l0Var.f20420b)) {
                    return true;
                }
                t0 t0Var = r0Var.f20438f;
                return t0Var != null && (UnitDisplayType.REWARDED.equals(t0Var.f20498j) || UnitDisplayType.INTERSTITIAL.equals(t0Var.f20498j) || UnitDisplayType.VERTICAL.equals(t0Var.f20498j));
            }
        }
