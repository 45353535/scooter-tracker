...
public class NativeAdUnitController extends s0 implements com.fyber.inneractive.sdk.flow.nativead.a {
    ...
    public final void a() {
        ...
        if (viewGroup != null) {
            ...
            Iterator it = new HashSet(this.f20600a).iterator();
            while (true) {
                if (!it.hasNext()) {
                    break;
                }
        ...
        Iterator it2 = new HashSet(this.f20600a).iterator();
        while (it2.hasNext()) {
        ...
        if (adSpot == null) {
            ...
            while (true) {
                if (it.hasNext()) {
                    ...
                    this.f20601b = mediaView;
                    Iterator it2 = j.f20617a.f20618a.iterator();
                    while (true) {
                        if (!it2.hasNext()) {
                            c0Var = null;
                            break;
                    ...
                    if (c0Var != null) {
                        ((w0) adSpot.getAdContent()).f21031u.f20803b = c0Var;
                        c0Var.initialize(adSpot);
                        selectContentController();
                        c0Var.b(mediaView);
                        this.f20600a.add(c0Var);
    ...
    public void destroy() {
        if (Looper.myLooper() == null || Looper.getMainLooper() != Looper.myLooper()) {
            com.fyber.inneractive.sdk.util.r.f23896b.post(new h(this));
        } else {
            a();
        }
    }
