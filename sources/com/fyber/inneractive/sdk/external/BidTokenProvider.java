...
public final class BidTokenProvider {
    public static String getBidderToken() {
        ...
        if (bVar.f20177e.get() == null) {
            IAConfigManager.b();
            synchronized (bVar.f20179g) {
                bVar.b();
            }
        } else {
            bVar.d();
        }
        String str = (String) bVar.f20177e.get();
        IAConfigManager iAConfigManager = IAConfigManager.O;
        String str2 = iAConfigManager.f20306l;
        o oVar = iAConfigManager.f20315u.f20484b;
