...
public final class e {
    ...
    public final a f20238b = new a();

    public static JSONObject a(e eVar) {
        eVar.getClass();
        JSONObject jSONObject = new JSONObject();
        try {
            jSONObject.put("currentSession", eVar.f20237a.a());
            for (Map.Entry entry : eVar.f20238b.entrySet()) {
    ...
    public final void a(com.fyber.inneractive.sdk.cache.session.enums.c cVar, g gVar) {
        synchronized (this.f20240d) {
            try {
                k kVar = (k) this.f20238b.get(cVar);
                if (kVar != null) {
                    kVar.add(gVar);
                }
            } catch (Throwable th2) {
