...
public final class z0 extends t0 {
    ...
    public final AtomicInteger f21433q;

    public z0(f0 f0Var, String str) {
        super(f0Var, g0.f21317c.a(), null);
        this.f21433q = new AtomicInteger();
        this.f21432p = str;
    }

    public static void b(String str) {
        IAConfigManager.O.f20313s.a(new z0(new y0(str, System.currentTimeMillis()), str));
    }
    ...
    public final o0 a(l lVar, Map map, int i10) throws n0 {
        try {
            ...
            o0Var.f21353b = com.fyber.inneractive.sdk.util.v.b(inputStream).toString();
            return o0Var;
        } catch (Exception e10) {
    ...
    @Override // com.fyber.inneractive.sdk.network.t0
    public final int g() {
        return ((int) Math.pow(2.0d, this.f21433q.get())) * 1000;
    }
    ...
    public final boolean u() {
        return this.f21433q.getAndIncrement() < 4;
    }
}
