...
public final class a1 extends t0 {
    ...
    @Override // com.fyber.inneractive.sdk.network.t0
    public final int g() {
        return ((int) Math.pow(2.0d, this.f21285q.get())) * 1000;
    }
    ...
    public final boolean u() {
        return this.f21285q.getAndIncrement() < 4;
    }
}
