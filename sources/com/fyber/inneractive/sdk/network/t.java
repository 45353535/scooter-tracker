...
public enum t {
    ...
    DV_ERROR_PHASE(1001),
    ODT_ENCRYPTION_EXCEPTION(p1.d.ENCRYPTION_EXCEPTION.d()),
    ODT_RAW_ONE_DT_ERROR(p1.d.RAW_ONE_DT_ERROR.d()),
    ODT_ONE_DT_PARSE_ERROR(p1.d.ONE_DT_PARSE_ERROR.d()),
    ODT_ONE_DT_AUTHENTICATION_ERROR(p1.d.ONE_DT_AUTHENTICATION_ERROR.d()),
    ODT_ONE_DT_BROADCAST_ERROR(p1.d.ONE_DT_BROADCAST_ERROR.d()),
    ODT_ONE_DT_REQUEST_ERROR(p1.d.ONE_DT_REQUEST_ERROR.d()),
    ODT_ONE_DT_GENERAL_ERROR(p1.d.ONE_DT_GENERAL_ERROR.d());
    ...
    public static t a(p1.d dVar) {
        return sMap.get(Integer.valueOf(dVar.d()));
    }
}
