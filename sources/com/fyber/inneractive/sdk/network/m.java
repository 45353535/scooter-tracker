...
public abstract class m {
    ...
    public com.fyber.inneractive.sdk.flow.o f21343a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public volatile boolean f21344b = false;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public final com.fyber.inneractive.sdk.config.global.r f21345c;
    ...
    public final void a(InneractiveAdRequest inneractiveAdRequest, com.fyber.inneractive.sdk.response.e eVar) {
        ...
        com.fyber.inneractive.sdk.config.r0 r0VarA = com.fyber.inneractive.sdk.config.a.a(eVar.f23735o);
        ...
        eVar2.f20372a = impressionData != null ? impressionData.getDemandId() : null;
        try {
            eVar2.f20373b = Long.valueOf(IAConfigManager.O.f20298d);
        } catch (NumberFormatException unused) {
            IAlog.a("invalid publisherId", new Object[0]);
        }
        this.f21345c.a(eVar2);
        InneractiveErrorCode inneractiveErrorCodeA = r0VarA == null ? InneractiveErrorCode.ERROR_CONFIGURATION_MISMATCH : eVar.a(inneractiveAdRequest, this.f21345c);
        if (inneractiveErrorCodeA != null) {
            ...
            Exception exc = eVar.f23746z;
            if (exc != null) {
                inneractiveInfrastructureError.setCause(exc);
            }
            com.fyber.inneractive.sdk.response.a aVarA = com.fyber.inneractive.sdk.response.a.a(eVar.f23727g);
            if (aVarA != null) {
                Exception exc2 = eVar.f23746z;
                if (exc2 != null) {
                    inneractiveInfrastructureError.setCause(exc2);
                }
                com.fyber.inneractive.sdk.util.r.f23895a.execute(new com.fyber.inneractive.sdk.flow.e(new com.fyber.inneractive.sdk.flow.f(eVar, inneractiveAdRequest, aVarA == com.fyber.inneractive.sdk.response.a.RETURNED_ADTYPE_HTML ? "send_failed_display_creatives" : "send_failed_vast_creatives", this.f21345c.b()), inneractiveInfrastructureError));
            }
            com.fyber.inneractive.sdk.config.global.r rVar = this.f21345c;
            if (rVar == null) {
                InneractiveAdSpot spot = InneractiveAdSpotManager.get().getSpot(this.f21346d);
                rVar = (spot == null || spot.getAdContent() == null) ? null : spot.getAdContent().f21037c;
            }
            com.fyber.inneractive.sdk.flow.a.a(inneractiveAdRequest, inneractiveInfrastructureError, null, eVar, rVar != null ? rVar.b() : null);
            if (this.f21344b || (oVar = this.f21343a) == null) {
                return;
            }
            oVar.a(inneractiveAdRequest, eVar, inneractiveInfrastructureError);
            return;
        }
        com.fyber.inneractive.sdk.flow.o oVar2 = this.f21343a;
        if (oVar2.f20852f) {
            IAlog.e("IAAdSourceBase: load cancelled: ignoring response. Previous load request was cancelled", new Object[0]);
            return;
        }
        com.fyber.inneractive.sdk.config.global.r rVar2 = oVar2.f20849c;
        ...
        com.fyber.inneractive.sdk.response.a aVarA2 = com.fyber.inneractive.sdk.response.a.a(eVar.f23727g);
        com.fyber.inneractive.sdk.interfaces.c cVar = oVar2.f20847a;
        if (cVar != null && (xVar = ((com.fyber.inneractive.sdk.flow.k) cVar).f20754c) != null) {
            xVar.destroy();
        }
        com.fyber.inneractive.sdk.factories.e eVar3 = (com.fyber.inneractive.sdk.factories.e) com.fyber.inneractive.sdk.factories.d.f20613a.f20614a.get(aVarA2);
        ...
        if (cVarA == null) {
            ...
            com.fyber.inneractive.sdk.flow.n nVar = oVar2.f20848b;
            if (nVar != null) {
            ...
            IAlog.e("%sonAdDataAvailable: found response loader: %s", oVar2.d(), oVar2.f20847a);
        }
        com.fyber.inneractive.sdk.interfaces.c cVar2 = oVar2.f20847a;
        if (cVar2 != null) {
