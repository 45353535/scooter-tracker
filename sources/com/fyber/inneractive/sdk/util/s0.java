...
public final class s0 {
    ...
    public final void a(String[][] strArr) {
        ...
        while (i10 < strArr.length) {
            ...
            r0 r0Var = this.f23902a;
            r0Var.f23897a.put(str, Integer.valueOf(i11));
            u0 u0Var = r0Var.f23898b;
            t0[] t0VarArr = u0Var.f23912a;
            int i12 = i11 & Integer.MAX_VALUE;
            int length = i12 % t0VarArr.length;
            t0 t0Var = t0VarArr[length];
            while (true) {
                if (t0Var == null) {
                    if (u0Var.f23913b >= u0Var.f23914c) {
                        t0[] t0VarArr2 = u0Var.f23912a;
                        int length2 = t0VarArr2.length;
                        int i13 = (length2 * 2) + 1;
                        t0[] t0VarArr3 = new t0[i13];
                        u0Var.f23914c = (int) (i13 * 0.75f);
                        u0Var.f23912a = t0VarArr3;
                        while (true) {
                            int i14 = length2 - 1;
                            if (length2 <= 0) {
                                break;
                            ...
                            while (t0Var2 != null) {
                                t0 t0Var3 = t0Var2.f23910c;
                                int i15 = (t0Var2.f23908a & Integer.MAX_VALUE) % i13;
                                t0Var2.f23910c = t0VarArr3[i15];
    ...
    */
    public final void a(java.io.StringWriter r11, java.lang.String r12, int r13) throws java.io.IOException {
        ...
        L65:
            ...
            goto L75
        L6b:
            com.fyber.inneractive.sdk.util.r0 r2 = r10.f23902a
            java.util.HashMap r2 = r2.f23897a
