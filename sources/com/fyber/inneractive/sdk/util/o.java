...
public abstract class o {
    ...
    public static Application f23888a;

    public static void a() {
    }

    public static String b(String str) {
        String string = (String) n.f23883a.get(str);
        ...
        try {
            InputStream inputStreamOpen = f23888a.getAssets().open(str, 3);
        ...
        if (!TextUtils.isEmpty(string)) {
            n.f23883a.put(str, string);
        }
        return string;
    }

    public static int c() {
        Application application = f23888a;
    ...
    public static int d() {
        ...
        if (f23888a == null || (windowManager = (WindowManager) IAConfigManager.O.f20316v.a().getSystemService("window")) == null || (defaultDisplay = windowManager.getDefaultDisplay()) == null) {
            i10 = -1;
        } else {
    ...
    public static String h() {
        ...
        while (true) {
            ...
            if (!iAConfigManager.f20319y.f23903a.get() || iAConfigManager.f20319y.f23906d.compareAndSet(true, true) || i10 >= 25) {
                break;
            }
        ...
        return iAConfigManager.f20319y.a();
    }

    public static boolean a(String str) {
        return f23888a.checkCallingOrSelfPermission(str) == 0;
    }
    ...
    public static int a(int i10) {
        return Math.round(((IAConfigManager.O.f20316v.a().getResources().getConfiguration().densityDpi / 160.0f) * i10) + 0.5f);
    }

    public static int c(int i10) {
        try {
            return (int) ((i10 / (IAConfigManager.O.f20316v.a().getResources().getConfiguration().densityDpi / 160.0f)) + 0.5f);
    ...
    public static int a(float f10) {
        return (int) (TypedValue.applyDimension(1, f10, IAConfigManager.O.f20316v.a().getResources().getDisplayMetrics()) + 0.5f);
    }

    public static Drawable d(int i10) {
        return IAConfigManager.O.f20316v.a().getDrawable(i10);
    }

    public static String a(ArrayList arrayList) {
        if (Build.VERSION.SDK_INT >= 26) {
            return uc.a(StringUtils.COMMA, arrayList);
        }
    ...
    public static int b(int i10) {
        return (int) (((IAConfigManager.O.f20316v.a().getResources().getConfiguration().densityDpi / 160.0f) * i10) + 0.5f);
    }
    ...
    public static int b() {
        return ((WindowManager) IAConfigManager.O.f20316v.a().getSystemService("window")).getDefaultDisplay().getRotation();
    }
