...
public final class b extends i1 {
                        ...
                        switch (authority) {
                            case "success":
                                ...
                                if (!TextUtils.isEmpty(queryParameter)) {
                                    qVar.f20711c = queryParameter;
                                }
                                g gVar2 = this.f23975f;
                                if (gVar2 != null) {
                                    gVar2.a(this);
                                    break;
                                }
                            ...
                            case "click":
                                if (j1Var != null) {
                                    com.fyber.inneractive.sdk.model.vast.b bVar = qVar.f20710b;
                                    com.fyber.inneractive.sdk.flow.endcard.k kVar = bVar.f21175o;
                                    if (kVar != null) {
                                        com.fyber.inneractive.sdk.flow.endcard.b bVarA = kVar.f20665b.a();
                                        str2 = kVar.f20664a.f21045e.f21162b;
                                        ...
                                        if (cVar == null && (cVar = (com.fyber.inneractive.sdk.flow.endcard.c) kVar.f20665b.a(com.fyber.inneractive.sdk.model.vast.i.Html)) == null && (cVar = (com.fyber.inneractive.sdk.flow.endcard.c) kVar.f20665b.a(com.fyber.inneractive.sdk.model.vast.i.Iframe)) == null) {
                                            cVar = (com.fyber.inneractive.sdk.flow.endcard.c) kVar.f20665b.a(com.fyber.inneractive.sdk.model.vast.i.Static);
                                        }
                                        if (bVarA != null && bVarA.j() && cVar != null) {
                                            String str3 = cVar.f20652g.f21183g;
    ...
    public final void d() {
        if (this.N == null || this.f23975f == null) {
            return;
        }
        this.f23975f.a(this, new InneractiveInfrastructureError(InneractiveErrorCode.SDK_INTERNAL_ERROR, com.fyber.inneractive.sdk.flow.i.WEBVIEW_FMP_ENDCARD_ERROR));
    }
    ...
    public final void a(WebView webView) {
        ...
        com.fyber.inneractive.sdk.flow.endcard.q qVar = this.N;
        com.fyber.inneractive.sdk.flow.endcard.p pVar = (com.fyber.inneractive.sdk.flow.endcard.p) qVar.f20712d.f();
        pVar.getClass();
        try {
            JSONObject jSONObject = new JSONObject();
            com.fyber.inneractive.sdk.util.c1.a(jSONObject, "name", pVar.f20706j);
            JSONArray jSONArray = new JSONArray();
            String str = pVar.f20707k;
            ...
            IAlog.a("%s FMP End-Card JSON error: %s", e10, pVar.f20644a, e10.getMessage());
            string = null;
        }
        if (TextUtils.isEmpty(string)) {
            IAlog.f("%s FMP End-Card JSON required", qVar.f20709a);
            return;
        }
    ...
    public final void a() {
        ...
        if (this.f23975f != null) {
            this.f23975f.a(this, new InneractiveInfrastructureError(InneractiveErrorCode.SDK_INTERNAL_ERROR, com.fyber.inneractive.sdk.flow.i.WEBVIEW_FMP_ENDCARD_ERROR, new WebViewRendererProcessHasGoneError()));
        }
    }
}
