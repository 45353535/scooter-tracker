...
public final class f extends ConnectivityManager.NetworkCallback {
    ...
    public final ConnectivityManager f20338b;

    public f(ConnectivityManager connectivityManager, h hVar) {
        this.f20337a = hVar;
        this.f20338b = connectivityManager;
    }

    public final void a() {
        this.f20337a = null;
        ConnectivityManager connectivityManager = this.f20338b;
    ...
    */
    public final void onCapabilitiesChanged(android.net.Network r3, android.net.NetworkCapabilities r4) {
        ...
        L3e:
            ...
            com.fyber.inneractive.sdk.util.z0 r3 = com.fyber.inneractive.sdk.util.z0.WIFI
        L47:
            com.fyber.inneractive.sdk.config.cellular.h r4 = r2.f20337a
            if (r4 == 0) goto L4e
            r4.a(r3)
        L4e:
            return
