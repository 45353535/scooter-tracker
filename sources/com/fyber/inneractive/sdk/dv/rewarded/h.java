...
public final class h extends p0 implements com.fyber.inneractive.sdk.dv.interstitial.a {
    ...
    public com.fyber.inneractive.sdk.external.g f20558w;

    /* JADX INFO: renamed from: x, reason: collision with root package name */
    public boolean f20559x = false;
    ...
    public final void c() {
        i iVar;
        x xVar = this.f20622b;
        if (xVar != null && (iVar = (i) ((com.fyber.inneractive.sdk.a) xVar).f21036b) != null) {
            b0.a(iVar);
        }
    ...
    public final void h() {
        ...
        if (this.f20559x || (eventsListener = this.f20623c) == null) {
            return;
        }
        this.f20559x = true;
    ...
    public final void onReward() {
        com.fyber.inneractive.sdk.external.g gVar = this.f20558w;
        if (gVar != null) {
            i0 i0Var = (i0) v.a(((s0) gVar.f20609a).mAdSpot);
    ...
    public final void w() {
        x xVar = this.f20622b;
        if (xVar != null) {
            b((i) ((com.fyber.inneractive.sdk.a) xVar).f21036b);
        }
