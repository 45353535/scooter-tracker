...
public final class e extends a {
    ...
    public static final List f20533e = Arrays.asList(UnitDisplayType.INTERSTITIAL, UnitDisplayType.REWARDED, UnitDisplayType.BANNER);

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final HashMap f20534a = new HashMap();
    ...
    */
    ...
    public final void a() {
        AdFormat adFormat;
        Iterator it = f20533e.iterator();
        while (it.hasNext()) {
            int i10 = d.f20532a[((UnitDisplayType) it.next()).ordinal()];
            if (i10 == 1 || i10 == 2) {
            ...
            r.f23895a.execute(new c(this, adFormat));
        }
    }
    ...
    public final j a(UnitDisplayType unitDisplayType) {
        AdFormat adFormat;
        j jVar;
        int i10 = d.f20532a[unitDisplayType.ordinal()];
        if (i10 == 1 || i10 == 2) {
            adFormat = AdFormat.BANNER;
        } else if (i10 != 3) {
            adFormat = AdFormat.INTERSTITIAL;
        ...
        QueryInfo queryInfo = (QueryInfo) this.f20534a.get(adFormat);
        if (queryInfo != null) {
            synchronized (this.f20536c) {
                this.f20534a.remove(adFormat);
            }
    ...
    public static void a(String str, com.fyber.inneractive.sdk.dv.enums.a aVar, InneractiveAdRequest inneractiveAdRequest, com.fyber.inneractive.sdk.response.e eVar, String str2) {
        ...
        wVar.f21421f.put(new x().a(str, "spot_id").a(aVar.name().toLowerCase(Locale.US), TypedValues.CycleType.S_WAVE_PHASE).a(b(), "version").a(str2, PglCryptUtils.KEY_MESSAGE).f21423a);
        wVar.a((String) null);
    }
}
