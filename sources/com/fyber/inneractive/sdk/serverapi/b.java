...
public abstract class b {
    ...
    public static final List f23774b = Arrays.asList("POWER_SAVE_MODE_OPEN", "SmartModeStatus");
    ...
    public static String b() {
        try {
            if (o.f23888a.registerReceiver(null, new IntentFilter("android.intent.action.BATTERY_CHANGED")) == null) {
                return "";
            }
    ...
    public static Long c() {
        ...
        try {
            String str = "";
            String str2 = (String) x0Var.f20512c.get("SESSION_STAMP");
    ...
    public static Boolean f() {
        try {
            return Boolean.valueOf(Settings.System.getInt(o.f23888a.getContentResolver(), "airplane_mode_on", 0) != 0);
        } catch (Throwable unused) {
            return null;
        }
    }
    ...
    public static Boolean g() {
        ...
        try {
            BluetoothAdapter adapter = ((BluetoothManager) o.f23888a.getSystemService(X3.f42020d)).getAdapter();
    ...
    public static Boolean h() {
        return Boolean.valueOf((o.f23888a.getResources().getConfiguration().uiMode & 48) == 32);
    }

    public static Boolean i() {
        int intExtra;
        try {
            Intent intentRegisterReceiver = o.f23888a.registerReceiver(null, new IntentFilter("android.intent.action.BATTERY_CHANGED"));
            boolean z10 = false;
    ...
    public static Boolean j() {
        try {
            AudioManager audioManager = (AudioManager) o.f23888a.getSystemService("audio");
    ...
    public static Boolean k() {
        try {
            int ringerMode = ((AudioManager) o.f23888a.getSystemService("audio")).getRingerMode();
            boolean z10 = true;
    ...
    public static Boolean l() {
        try {
            int currentInterruptionFilter = ((NotificationManager) o.f23888a.getSystemService("notification")).getCurrentInterruptionFilter();
    ...
    public static Boolean m() {
        try {
            boolean z10 = false;
            for (AudioDeviceInfo audioDeviceInfo : ((AudioManager) o.f23888a.getSystemService("audio")).getDevices(2)) {
    ...
    public static Boolean n() {
        ...
        try {
            ...
            if (TextUtils.isEmpty(upperCase) || !f23773a.containsKey(upperCase)) {
                return Boolean.valueOf(((PowerManager) o.f23888a.getSystemService("power")).isPowerSaveMode());
            }
            try {
                Iterator it = f23774b.iterator();
                while (it.hasNext()) {
                    int i10 = Settings.System.getInt(o.f23888a.getContentResolver(), (String) it.next(), -1);
                    if (i10 != -1 && (num = (Integer) f23773a.get(upperCase)) != null) {
    ...
    public static UnitDisplayType a(String str) {
        ...
        q0 q0Var = (map == null || !map.containsKey(str)) ? null : (q0) iAConfigManager.f20295a.get(str);
        if (q0Var != null && q0Var.f20431a.size() > 0 && (r0Var = (r0) q0Var.f20431a.get(0)) != null) {
            t0 t0Var = r0Var.f20438f;
            l0 l0Var = r0Var.f20435c;
            p0 p0Var = r0Var.f20437e;
            if (t0Var != null) {
                return t0Var.f20498j;
            }
            if (l0Var != null) {
                return l0Var.f20420b;
            }
            if (p0Var != null) {
