...
public final class o extends l {
    ...
    public final long a(com.fyber.inneractive.sdk.player.exoplayer2.util.n nVar) {
        int i10;
        byte b10 = nVar.f23134a[0];
        if ((b10 & 1) == 1) {
            return -1L;
        }
        n nVar2 = this.f22371n;
        if (!nVar2.f22369c[(b10 >> 1) & (255 >>> (8 - nVar2.f22370d))].f22376a) {
            i10 = nVar2.f22367a.f22380d;
        } else {
            i10 = nVar2.f22367a.f22381e;
        }
        long j10 = this.f22373p ? (this.f22372o + i10) / 4 : 0;
        nVar.d(nVar.f23136c + 4);
    ...
    public final boolean a(com.fyber.inneractive.sdk.player.exoplayer2.util.n nVar, long j10, j jVar) throws com.fyber.inneractive.sdk.player.exoplayer2.r {
        ...
        if (this.f22374q == null) {
            this.f22374q = s.a(nVar);
        } else if (this.f22375r == null) {
            s.a(3, nVar, false);
            nVar.b((int) nVar.e());
            long jE = nVar.e();
            ...
            int i15 = nVar.f23136c;
            byte[] bArr = new byte[i15];
            System.arraycopy(nVar.f23134a, 0, bArr, 0, i15);
            int i16 = this.f22374q.f22377a;
            int i17 = 5;
            s.a(5, nVar, false);
            int iJ = nVar.j() + 1;
            m mVar = new m(nVar.f23134a);
            int i18 = 8;
            mVar.b(nVar.f23135b * 8);
            int i19 = 0;
            while (true) {
                int i20 = 4;
                int i21 = 16;
                if (i19 < iJ) {
                    if (mVar.a(24) == 5653314) {
                        ...
                        throw new com.fyber.inneractive.sdk.player.exoplayer2.r("expected code book to start with [0x56, 0x43, 0x42] at " + ((mVar.f22365c * 8) + mVar.f22366d));
                    }
                } else {
                    int i29 = i18;
                    int i30 = 6;
                    ...
                    if (mVar.a()) {
                        ...
                        nVar2 = new n(this.f22374q, bArr, qVarArr, i62);
                    } else {
        ...
        arrayList.add(this.f22371n.f22367a.f22382f);
        arrayList.add(this.f22371n.f22368b);
        r rVar = this.f22371n.f22367a;
        jVar.f22348a = com.fyber.inneractive.sdk.player.exoplayer2.o.a(null, "audio/vorbis", rVar.f22379c, -1, rVar.f22377a, (int) rVar.f22378b, arrayList, null, null);
        return true;
    }
    ...
    public final void a(long j10) {
        ...
        this.f22373p = j10 != 0;
        r rVar = this.f22374q;
        this.f22372o = rVar != null ? rVar.f22380d : 0;
    }
}
