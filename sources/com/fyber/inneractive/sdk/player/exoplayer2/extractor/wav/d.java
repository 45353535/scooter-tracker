...
public abstract class d {
    public static b a(com.fyber.inneractive.sdk.player.exoplayer2.extractor.b bVar) throws InterruptedException, r, EOFException {
        n nVar = new n(16);
        if (c.a(bVar, nVar).f22640a != z.a("RIFF")) {
            return null;
        }
        ...
        while (cVarA.f22640a != z.a("fmt ")) {
            bVar.a((int) cVarA.f22641b, false);
            cVarA = c.a(bVar, nVar);
        }
        if (cVarA.f22641b < 16) {
            throw new IllegalStateException();
        }
        bVar.a(nVar.f23134a, 0, 16, false);
        nVar.e(0);
        int iF = nVar.f();
        int iF2 = nVar.f();
        int iD = nVar.d();
        ...
        if (iF == 1 || iF == 65534) {
            bVar.a(((int) cVarA.f22641b) - 16, false);
