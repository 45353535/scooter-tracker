...
public final class k implements Closeable, AutoCloseable {
    ...
    public final InputStream f21467a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final Charset f21468b;
    ...
    public k(FileInputStream fileInputStream) {
        ...
        this.f21467a = fileInputStream;
        this.f21468b = charset;
        this.f21469c = new byte[8192];
    }
    ...
    */
    public final java.lang.String a() {
        /*
            r8 = this;
            java.io.InputStream r0 = r8.f21467a
            monitor-enter(r0)
            byte[] r1 = r8.f21469c     // Catch: java.lang.Throwable -> L1d
            if (r1 == 0) goto La5
            int r2 = r8.f21470d     // Catch: java.lang.Throwable -> L1d
            int r3 = r8.f21471e     // Catch: java.lang.Throwable -> L1d
            r4 = -1
            r5 = 0
            if (r2 < r3) goto L26
            java.io.InputStream r2 = r8.f21467a     // Catch: java.lang.Throwable -> L1d
            int r3 = r1.length     // Catch: java.lang.Throwable -> L1d
            int r1 = r2.read(r1, r5, r3)     // Catch: java.lang.Throwable -> L1d
            if (r1 == r4) goto L20
            r8.f21470d = r5     // Catch: java.lang.Throwable -> L1d
            r8.f21471e = r1     // Catch: java.lang.Throwable -> L1d
            goto L26
        L1d:
            r1 = move-exception
            goto Lad
        ...
        L26:
            int r1 = r8.f21470d     // Catch: java.lang.Throwable -> L1d
        L28:
            int r2 = r8.f21471e     // Catch: java.lang.Throwable -> L1d
            r3 = 10
            if (r1 == r2) goto L57
            byte[] r2 = r8.f21469c     // Catch: java.lang.Throwable -> L1d
            r6 = r2[r1]     // Catch: java.lang.Throwable -> L1d
            if (r6 != r3) goto L54
            int r3 = r8.f21470d     // Catch: java.lang.Throwable -> L1d
            if (r1 == r3) goto L41
            int r4 = r1 + (-1)
        ...
        L42:
            ...
            int r4 = r4 - r3
            java.nio.charset.Charset r6 = r8.f21468b     // Catch: java.lang.Throwable -> L1d
            java.lang.String r6 = r6.name()     // Catch: java.lang.Throwable -> L1d
            r5.<init>(r2, r3, r4, r6)     // Catch: java.lang.Throwable -> L1d
            int r1 = r1 + 1
            r8.f21470d = r1     // Catch: java.lang.Throwable -> L1d
        ...
        L57:
            ...
            int r2 = r8.f21471e     // Catch: java.lang.Throwable -> L1d
            int r6 = r8.f21470d     // Catch: java.lang.Throwable -> L1d
            int r2 = r2 - r6
            int r2 = r2 + 80
        ...
        L63:
            byte[] r2 = r8.f21469c     // Catch: java.lang.Throwable -> L1d
            int r6 = r8.f21470d     // Catch: java.lang.Throwable -> L1d
            int r7 = r8.f21471e     // Catch: java.lang.Throwable -> L1d
            int r7 = r7 - r6
            r1.write(r2, r6, r7)     // Catch: java.lang.Throwable -> L1d
            r8.f21471e = r4     // Catch: java.lang.Throwable -> L1d
            java.io.InputStream r2 = r8.f21467a     // Catch: java.lang.Throwable -> L1d
            byte[] r6 = r8.f21469c     // Catch: java.lang.Throwable -> L1d
            int r7 = r6.length     // Catch: java.lang.Throwable -> L1d
            int r2 = r2.read(r6, r5, r7)     // Catch: java.lang.Throwable -> L1d
            if (r2 == r4) goto L9f
            r8.f21470d = r5     // Catch: java.lang.Throwable -> L1d
            r8.f21471e = r2     // Catch: java.lang.Throwable -> L1d
            r2 = r5
        L7f:
            int r6 = r8.f21471e     // Catch: java.lang.Throwable -> L1d
            if (r2 == r6) goto L63
            byte[] r6 = r8.f21469c     // Catch: java.lang.Throwable -> L1d
        ...
        L92:
            int r2 = r2 + 1
            r8.f21470d = r2     // Catch: java.lang.Throwable -> L1d
