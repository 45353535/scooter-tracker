...
public class o extends l {
    ...
    public o(Context context, com.fyber.inneractive.sdk.flow.g gVar, a aVar, com.fyber.inneractive.sdk.config.global.r rVar, boolean z10, String str) {
        ...
        this.P = null;
        this.f23371z.inflate(R.layout.ia_layout_video_view, (ViewGroup) this, true);
        q();
        com.fyber.inneractive.sdk.flow.g gVar2 = this.A;
        if (gVar2 != null) {
            IFyberAdIdentifier.Corner corner = IFyberAdIdentifier.Corner.BOTTOM_LEFT;
            IFyberAdIdentifier iFyberAdIdentifier = gVar2.f20736d;
    ...
    public final void destroy() {
        ...
        p();
        ViewGroup viewGroup = this.f23412l;
        if (viewGroup != null) {
    ...
    public View[] getTrackingFriendlyView() {
        return new View[]{this.L, this.S, this.T, this.M, this.O, this.P, this.f23421u};
    }
    ...
    public void q() {
        this.f23412l = (ViewGroup) findViewById(R.id.ia_texture_view_host);
        this.f23417q = (ViewGroup) findViewById(R.id.ia_default_endcard_video_overlay);
        this.f23418r = (ViewGroup) findViewById(R.id.ia_endcard_video_overlay);
        this.f23413m = (Button) findViewById(R.id.ia_b_end_card_call_to_action);
        TextView textView = (TextView) findViewById(R.id.ia_endcard_tv_app_info_button);
        this.f23421u = textView;
        a(textView, 10);
        a(this.f23413m, 8);
        a(this.f23412l, 7);
        a(this.f23417q, -1);
    ...
    public void setSkipText(String str) {
        if (this.T != null) {
            try {
                ...
                str = String.format(Locale.US, IAConfigManager.O.f20316v.a().getString(i10), Integer.valueOf(Integer.parseInt(str)));
    ...
    */
    public final void a(boolean r5, com.fyber.inneractive.sdk.ignite.m r6) {
        /*
            ...
            if (r0 == 0) goto L72
            com.fyber.inneractive.sdk.config.global.r r1 = r4.f23422v
            r2 = 0
            if (r1 == 0) goto L26
        ...
        L48:
            ...
            java.lang.String r6 = r6.getString(r1)
        L5c:
            java.lang.String r1 = r4.f23423w
            boolean r1 = android.text.TextUtils.isEmpty(r1)
            if (r1 != 0) goto L66
            java.lang.String r6 = r4.f23423w
        L66:
            r0.setText(r6)
