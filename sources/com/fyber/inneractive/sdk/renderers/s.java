...
public final class s implements g0 {
    ...
    public final /* synthetic */ t f23698a;
    ...
    public final com.fyber.inneractive.sdk.util.d0 a(String str, g1 g1Var) {
        ...
        Context contextY = this.f23698a.y();
        t tVar2 = this.f23698a;
        com.fyber.inneractive.sdk.interfaces.e eVar = tVar2.f20855k;
        if (eVar != null) {
            contextY = tVar2.c(eVar.getLayout());
        }
        Context context = contextY;
        t tVar3 = this.f23698a;
        if (!tVar3.f20626f) {
        ...
        com.fyber.inneractive.sdk.flow.x xVar = tVar3.f20622b;
        com.fyber.inneractive.sdk.response.e eVar2 = xVar == null ? null : ((q0) xVar).f21036b;
        if (eVar2 != null) {
            com.fyber.inneractive.sdk.flow.b0.a(eVar2);
        }
        com.fyber.inneractive.sdk.flow.b0.a(com.fyber.inneractive.sdk.cache.session.enums.a.CLICK, this.f23698a.F == UnitDisplayType.REWARDED ? com.fyber.inneractive.sdk.cache.session.enums.c.REWARDED_DISPLAY : com.fyber.inneractive.sdk.cache.session.enums.c.INTERSTITIAL_DISPLAY);
        return this.f23698a.a(context, str, g1Var, com.fyber.inneractive.sdk.util.g.DISPLAY, false, null);
    }
    ...
    public final void onClose() {
        ...
        com.fyber.inneractive.sdk.interfaces.e eVar = this.f23698a.f20855k;
        if (eVar != null) {
            eVar.dismissAd(true);
        }
    }
    ...
    public final void b(boolean z10) {
        if (z10) {
            ...
            if (!tVar.f20863s) {
                tVar.f20863s = true;
                com.fyber.inneractive.sdk.interfaces.e eVar = tVar.f20855k;
                if (eVar != null) {
            ...
            if (!tVar2.f20861q) {
                tVar2.f20861q = true;
                v1 v1Var = new v1(TimeUnit.MILLISECONDS, tVar2.f20862r);
                tVar2.f20857m = v1Var;
                v1Var.f23920e = new n0(tVar2);
                t1 t1Var = new t1(v1Var);
                v1Var.f23918c = t1Var;
                v1Var.f23919d = false;
                t1Var.sendEmptyMessage(1932593528);
            }
            com.fyber.inneractive.sdk.interfaces.e eVar2 = this.f23698a.f20855k;
            if (eVar2 == null || !eVar2.isCloseButtonDisplay()) {
                return;
            }
            t tVar3 = this.f23698a;
            tVar3.f20860p = false;
            com.fyber.inneractive.sdk.interfaces.e eVar3 = tVar3.f20855k;
            if (eVar3 != null) {
                eVar3.disableCloseButton();
            }
            com.fyber.inneractive.sdk.util.a aVar = tVar3.f20865u;
            aVar.f23846d = 0L;
            aVar.f23847e = 0L;
            aVar.f23848f = 0L;
            aVar.f23844b = false;
    ...
    @Override // com.fyber.inneractive.sdk.web.j1
    public final void a() {
        this.f23698a.a(new WebViewRendererProcessHasGoneError());
        this.f23698a.destroy();
    }
    ...
    public final void a(String str, String str2) {
        ...
        t tVar2 = this.f23698a;
        if (!tVar2.D) {
            com.fyber.inneractive.sdk.network.b0.a(tVar2.f20855k.getLayout().getContext(), str, str2, this.f23698a.f20622b);
            t tVar3 = this.f23698a;
            tVar3.D = true;
    ...
    public final void a(boolean z10) {
        ...
        if (z10) {
            ...
            if (!tVar.f23700x) {
                tVar.f23700x = true;
                if (tVar.f20622b != null) {
                    IAmraidWebViewController iAmraidWebViewController = tVar.f23701y;
                    if (iAmraidWebViewController != null) {
                        iAmraidWebViewController.l();
                    }
                    com.fyber.inneractive.sdk.response.e eVar = ((q0) tVar.f20622b).f21036b;
                    if (eVar != null && (str = eVar.f23731k) != null && str.trim().length() > 0) {
                        IAlog.e("%sfiring impression!", IAlog.a(tVar));
                        z0.b(str);
                    }
                    com.fyber.inneractive.sdk.web.m mVar = tVar.f23701y.f23971b;
                    if (mVar != null) {
    ...
    public final boolean a(String str) {
        ...
        t tVar = this.f23698a;
        Context contextC = tVar.c(tVar.f20855k.getLayout());
        ...
        if (zStartRichMediaIntent) {
            this.f23698a.a(contextC, false, Float.NaN, Float.NaN);
        }
    ...
    public final void a(IAmraidWebViewController.MraidVideoFailedToDisplayError mraidVideoFailedToDisplayError) {
        this.f23698a.d(false);
        t tVar = this.f23698a;
        InneractiveUnitController.EventsListener eventsListener = tVar.f20623c;
        if (eventsListener != null) {
            ((InneractiveFullscreenAdEventsListener) eventsListener).onAdEnteredErrorState(tVar.f20621a, mraidVideoFailedToDisplayError);
        }
    }
}
