...
public final class i2 implements t2 {
    ...
    public static final int[] f23489q = new int[0];

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    public static final Unsafe f23490r;
    ...
    public final k2 f23502l;

    /* JADX INFO: renamed from: m, reason: collision with root package name */
    public final t1 f23503m;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    public final o3 f23504n;

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    public final j0 f23505o;

    /* JADX INFO: renamed from: p, reason: collision with root package name */
    public final z1 f23506p;
    ...
    public i2(int[] iArr, Object[] objArr, int i10, int i11, d2 d2Var, boolean z10, int[] iArr2, int i12, int i13, k2 k2Var, t1 t1Var, o3 o3Var, j0 j0Var, z1 z1Var) {
        ...
        this.f23493c = i10;
        this.f23494d = i11;
        this.f23497g = d2Var instanceof z0;
        this.f23498h = z10;
        this.f23496f = j0Var != null && (d2Var instanceof GeneratedMessageLite$ExtendableMessage);
        this.f23499i = iArr2;
        this.f23500j = i12;
        this.f23501k = i13;
        this.f23502l = k2Var;
    ...
    */
    public static com.fyber.inneractive.sdk.protobuf.i2 a(com.fyber.inneractive.sdk.protobuf.r2 r35, com.fyber.inneractive.sdk.protobuf.k2 r36, com.fyber.inneractive.sdk.protobuf.t1 r37, com.fyber.inneractive.sdk.protobuf.o3 r38, com.fyber.inneractive.sdk.protobuf.j0 r39, com.fyber.inneractive.sdk.protobuf.z1 r40) {
        /*
    ...
    */
    ...
    public final t2 c(int i10) {
        int i11 = (i10 / 3) * 2;
        Object[] objArr = this.f23492b;
        t2 t2Var = (t2) objArr[i11];
        if (t2Var != null) {
            return t2Var;
        }
        t2 t2VarA = p2.f23544c.a((Class) objArr[i11 + 1]);
        this.f23492b[i11] = t2VarA;
        return t2VarA;
    }

    public final void e(int i10, Object obj, Object obj2) {
        int[] iArr = this.f23491a;
        int i11 = iArr[i10 + 1];
        int i12 = iArr[i10];
  ...
  0x0100: PHI (r2v30 int) = (r2v10 int), (r2v31 int) binds: [B:82:0x0227, B:40:0x00fe] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    public final void c(Object obj) {
        int i10;
        int i11 = this.f23500j;
        while (true) {
            i10 = this.f23501k;
            if (i11 >= i10) {
                break;
            }
            long j10 = this.f23491a[this.f23499i[i11] + 1] & 1048575;
            Object objE = x3.e(obj, j10);
            if (objE != null) {
                this.f23506p.getClass();
                ((y1) objE).f23639a = false;
                x3.a(j10, obj, objE);
            }
            i11++;
        }
        int length = this.f23499i.length;
        while (i10 < length) {
            this.f23503m.a(obj, this.f23499i[i10]);
            i10++;
        }
        this.f23504n.getClass();
        ((z0) obj).unknownFields.f23539e = false;
        if (this.f23496f) {
            this.f23505o.getClass();
            ((GeneratedMessageLite$ExtendableMessage) obj).extensions.e();
        }
    }

    public final void c(int i10, Object obj, Object obj2) {
        long j10 = this.f23491a[i10 + 1] & 1048575;
        Object objE = x3.e(obj, j10);
        if (objE != null) {
            this.f23506p.getClass();
            if (!((y1) objE).f23639a) {
  ...
  0x0185: PHI (r4v102 int) = (r4v40 int), (r4v104 int) binds: [B:237:0x0630, B:61:0x017d] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public final int b(java.lang.Object r25) {
        /*
            Method dump skipped, instruction units count: 3692
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
    ...
    public final Object a() {
        k2 k2Var = this.f23502l;
        d2 d2Var = this.f23495e;
        k2Var.getClass();
    ...
    */
    ...
    public final void a(Object obj, s2 s2Var, h0 h0Var) throws Throwable {
        h0Var.getClass();
        a(this.f23504n, this.f23505o, obj, s2Var, h0Var);
    }
    ...
    */
    ...
    public final void b(Object obj, int i10, int i11) {
        x3.a(obj, this.f23491a[i11 + 2] & 1048575, i10);
    }
    ...
    public final int a(Object obj, byte[] bArr, int i10, int i11, int i12, int i13, int i14, long j10, int i15, long j11, f fVar) throws n1 {
        ...
        switch (i15) {
            ...
            case 35:
                ...
                for (int i19 = i10 + 8; i19 < i11; i19 = iA + 8) {
                    iA = i19 + 1;
                    byte b10 = bArr[i19];
                    if (b10 >= 0) {
                        fVar.f23469a = b10;
            ...
            case 36:
                ...
                for (int i21 = i10 + 4; i21 < i11; i21 = iA2 + 4) {
                    iA2 = i21 + 1;
                    byte b11 = bArr[i21];
                    if (b11 >= 0) {
                        fVar.f23469a = b11;
                    } else {
                        iA2 = g.a(b11, bArr, iA2, fVar);
                    }
                    if (i12 != fVar.f23469a) {
                        return i21;
                    }
            ...
            case 38:
                if (i13 == 2) {
                    ...
                    int i22 = fVar.f23469a + iD3;
                    while (iD3 < i22) {
                        iD3 = g.e(bArr, iD3, fVar);
                        u1Var.a(fVar.f23470b);
                    }
                    if (iD3 == i22) {
                        return iD3;
                    }
            ...
            case 43:
                i16 = i10;
                if (i13 == 2) {
                    return g.a(bArr, i16, k1VarB, fVar);
                }
                if (i13 == 0) {
                    return g.c(i12, bArr, i16, i11, k1VarB, fVar);
                }
                return i16;
            case 23:
            case 32:
            ...
            case 46:
                ...
                if (i13 == 2) {
                    u1 u1Var3 = (u1) k1VarB;
                    int iD4 = g.d(bArr, i16, fVar);
                    int i23 = fVar.f23469a + iD4;
                    while (iD4 < i23) {
                ...
                if (i13 == 1) {
                    u1 u1Var4 = (u1) k1VarB;
                    u1Var4.a(g.b(i16, bArr));
                    for (int i24 = i16 + 8; i24 < i11; i24 = iA3 + 8) {
                        iA3 = i24 + 1;
                        byte b13 = bArr[i24];
                        if (b13 >= 0) {
                            fVar.f23469a = b13;
                        } else {
                            iA3 = g.a(b13, bArr, iA3, fVar);
                        }
                        if (i12 != fVar.f23469a) {
                            return i24;
                        }
            ...
            case 45:
                ...
                if (i13 == 2) {
                    a1 a1Var = (a1) k1VarB;
                    int iD5 = g.d(bArr, i16, fVar);
                    int i25 = fVar.f23469a + iD5;
                    while (iD5 < i25) {
                ...
                if (i13 == 5) {
                    a1 a1Var2 = (a1) k1VarB;
                    a1Var2.c(g.a(i16, bArr));
                    for (int i26 = i16 + 4; i26 < i11; i26 = iA4 + 4) {
                        iA4 = i26 + 1;
                        byte b14 = bArr[i26];
                        if (b14 >= 0) {
                            fVar.f23469a = b14;
                        } else {
                            iA4 = g.a(b14, bArr, iA4, fVar);
                        }
                        if (i12 != fVar.f23469a) {
                            return i26;
                        }
            ...
            case 42:
                ...
                if (i13 == 2) {
                    j jVar = (j) k1VarB;
                    int iD6 = g.d(bArr, i16, fVar);
                    int i27 = fVar.f23469a + iD6;
                    while (iD6 < i27) {
                        iD6 = g.e(bArr, iD6, fVar);
                        jVar.a(fVar.f23470b != 0);
                    }
                    if (iD6 == i27) {
                        return iD6;
                    }
                ...
                if (i13 == 0) {
                    j jVar2 = (j) k1VarB;
                    int iE2 = g.e(bArr, i16, fVar);
                    jVar2.a(fVar.f23470b != 0);
                    while (iE2 < i11) {
                        int iA6 = iE2 + 1;
                        byte b15 = bArr[iE2];
                        if (b15 >= 0) {
            ...
            case 26:
                ...
                if (i13 == 2) {
                    if ((j10 & 536870912) == 0) {
                        return g.a(i12, bArr, i17, i11, k1VarB, fVar);
                    }
                    return g.b(i12, bArr, i17, i11, k1VarB, fVar);
                }
                return i17;
            case 27:
                i17 = i10;
                if (i13 == 2) {
                    t2 t2VarC = c(i14);
                    int iA7 = g.a(t2VarC, bArr, i17, i11, fVar);
                    k1VarB.add(fVar.f23471c);
                    while (iA7 < i11) {
                        int iA8 = iA7 + 1;
                        byte b16 = bArr[iA7];
                        if (b16 >= 0) {
            ...
            case 28:
                i17 = i10;
                if (i13 == 2) {
                    int iD7 = g.d(bArr, i17, fVar);
                    int i28 = fVar.f23469a;
                    if (i28 >= 0) {
                        if (i28 > bArr.length - iD7) {
                            throw new n1("While parsing a protocol message, the input ended unexpectedly in the middle of a field.  This could mean either that the input has been truncated or that an embedded message misreported its own length.");
                        }
                        if (i28 == 0) {
                            k1VarB.add(s.f23563b);
                        } else {
                            int i29 = iD7 + i28;
                            s.a(iD7, i29, bArr.length);
                            k1VarB.add(new q(s.f23564c.a(bArr, iD7, i28)));
                            iD7 = i29;
                        }
                        while (iD7 < i11) {
                            int iA9 = iD7 + 1;
                            ...
                            if (i30 >= 0) {
                                ...
                                if (i30 == 0) {
                                    ...
                                    k1VarB.add(new q(s.f23564c.a(bArr, iD7, i30)));
                                    iD7 = i31;
                                }
                            } else {
            ...
            case 44:
                if (i13 == 2) {
                    iC = g.a(bArr, i10, k1VarB, fVar);
                } else {
                    if (i13 != 0) {
                        return i10;
                    }
                    iC = g.c(i12, bArr, i10, i11, k1VarB, fVar);
                }
                z0 z0Var = (z0) obj;
            ...
            case 47:
                if (i13 == 2) {
                    a1 a1Var3 = (a1) k1VarB;
                    int iD8 = g.d(bArr, i10, fVar);
                    int i32 = fVar.f23469a + iD8;
                    while (iD8 < i32) {
                        int i33 = iD8 + 1;
                        byte b19 = bArr[iD8];
                        if (b19 >= 0) {
                ...
                a1 a1Var4 = (a1) k1VarB;
                int iD9 = g.d(bArr, i10, fVar);
                a1Var4.c(w.b(fVar.f23469a));
                while (iD9 < i11) {
                    int iA10 = iD9 + 1;
                    byte b20 = bArr[iD9];
                    if (b20 >= 0) {
            ...
            case 48:
                if (i13 == 2) {
                    u1 u1Var5 = (u1) k1VarB;
                    int iD10 = g.d(bArr, i10, fVar);
                    int i34 = fVar.f23469a + iD10;
                    while (iD10 < i34) {
                        iD10 = g.e(bArr, iD10, fVar);
                        u1Var5.a(w.a(fVar.f23470b));
                    }
                    if (iD10 == i34) {
                        return iD10;
                    }
            ...
            case 49:
                if (i13 == 3) {
                    ...
                    int i36 = i11;
                    f fVar2 = fVar;
                    k1VarB.add(fVar2.f23471c);
                    while (iA12 < i36) {
                        int iD11 = g.d(bArr2, iA12, fVar2);
                        if (i12 != fVar2.f23469a) {
                            return iA12;
                        }
                        byte[] bArr3 = bArr2;
                        t2 t2Var2 = t2Var;
                        int i37 = i36;
                        f fVar3 = fVar2;
                        iA12 = g.a(t2Var2, bArr3, iD11, i37, i35, fVar3);
                        k1VarB.add(fVar3.f23471c);
                        t2Var = t2Var2;
                        bArr2 = bArr3;
                        i36 = i37;
                        fVar2 = fVar3;
    ...
    public final int a(Object obj, byte[] bArr, int i10, int i11, int i12, int i13, int i14, int i15, int i16, long j10, int i17, f fVar) throws n1 {
        Object object;
        Unsafe unsafe = f23490r;
        long j11 = this.f23491a[i17 + 2] & 1048575;
        switch (i16) {
            case 51:
                if (i14 != 1) {
                    return i10;
            ...
            case 54:
                ...
                int iE = g.e(bArr, i10, fVar);
                unsafe.putObject(obj, j10, Long.valueOf(fVar.f23470b));
                unsafe.putInt(obj, j11, i13);
                return iE;
            case 55:
            case 62:
                ...
                int iD = g.d(bArr, i10, fVar);
                unsafe.putObject(obj, j10, Integer.valueOf(fVar.f23469a));
                unsafe.putInt(obj, j11, i13);
                return iD;
            case 56:
            case 65:
            ...
            case 58:
                ...
                unsafe.putObject(obj, j10, Boolean.valueOf(fVar.f23470b != 0));
                unsafe.putInt(obj, j11, i13);
                return iE2;
            case 59:
                if (i14 != 2) {
                ...
                int iD2 = g.d(bArr, i10, fVar);
                int i22 = fVar.f23469a;
                if (i22 == 0) {
                    unsafe.putObject(obj, j10, "");
                } else {
                    if ((i15 & 536870912) != 0) {
                        if (!d4.f23458a.b(bArr, iD2, iD2 + i22)) {
                            throw new n1("Protocol message had invalid UTF-8.");
                        }
                    }
                    unsafe.putObject(obj, j10, new String(bArr, iD2, i22, l1.f23521a));
                    iD2 += i22;
                }
                unsafe.putInt(obj, j11, i13);
                return iD2;
            case 60:
                ...
                if (object == null) {
                    unsafe.putObject(obj, j10, fVar.f23471c);
                } else {
                    unsafe.putObject(obj, j10, l1.a(object, fVar.f23471c));
                }
                unsafe.putInt(obj, j11, i13);
                return iA;
            case 61:
            ...
            case 66:
                ...
                unsafe.putObject(obj, j10, Integer.valueOf(w.b(fVar.f23469a)));
                unsafe.putInt(obj, j11, i13);
                return iD4;
            case 67:
                if (i14 != 0) {
                ...
                int iE3 = g.e(bArr, i10, fVar);
                unsafe.putObject(obj, j10, Long.valueOf(w.a(fVar.f23470b)));
                unsafe.putInt(obj, j11, i13);
                return iE3;
            case 68:
                if (i14 == 3) {
    ...
    public final void a(int i10) {
        if (this.f23492b[((i10 / 3) * 2) + 1] != null) {
            throw new ClassCastException();
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:328:0x0843, code lost:
        ...
        if (r0 >= r8.f23501k) goto L367;
     */
    /* JADX WARN: Code restructure failed: missing block: B:329:0x0845, code lost:
    
        r1 = (com.fyber.inneractive.sdk.protobuf.n3) r8.b(r8.f23499i[r0], r9, r1);
        r0 = r0 + 1;
     */
    ...
    public final void a(Object obj, byte[] bArr, int i10, int i11, f fVar) throws n1 {
        ...
        if (i2Var.f23498h) {
            ...
            while (iA2 < i25) {
                ...
                if (i33 > i28) {
                    int i35 = i30 / 3;
                    if (i33 >= i2Var.f23493c && i33 <= i2Var.f23494d) {
                        iA = i2Var.a(i33, i35);
                        i30 = iA;
                    }
                    i30 = i26;
                    ...
                    if (i37 <= 17) {
                        ...
                        switch (i37) {
                            case 0:
                                ...
                                i12 = i32;
                                if (i34 == 1) {
                                    x3.f23629c.a(obj3, j10, Double.longBitsToDouble(g.b(iA3, bArr2)));
                                    iE = iA3 + 8;
                                    i29 = i42 | i39;
                                    obj2 = obj3;
                                    i24 = i21;
                            ...
                            case 1:
                                ...
                                i12 = i32;
                                if (i34 == 5) {
                                    x3.f23629c.a(obj3, j10, Float.intBitsToFloat(g.a(iA3, bArr2)));
                                    iE = iA3 + 4;
                                    i29 = i42 | i39;
                                    obj2 = obj3;
                                    i24 = i21;
                            ...
                            case 3:
                                ...
                                if (i34 == 0) {
                                    ...
                                    unsafe3.putLong(obj3, j10, fVar2.f23470b);
                                    unsafe2 = unsafe3;
                                    i29 = i42 | i39;
                                    obj2 = obj3;
                                    i24 = i21;
                            ...
                            case 11:
                                ...
                                if (i34 == 0) {
                                    ...
                                    iE = iA4;
                                    unsafe3.putInt(obj3, j10, fVar2.f23469a);
                                    unsafe2 = unsafe3;
                                    i29 = i42 | i39;
                                    obj2 = obj3;
                                    i24 = i21;
                            ...
                            case 7:
                                ...
                                if (i34 == 0) {
                                    iE = g.e(bArr2, iA3, fVar2);
                                    x3.f23629c.a(obj3, j10, fVar2.f23470b != 0);
                                    unsafe2 = unsafe3;
                                    i21 = i23;
                                    i29 = i42 | i39;
                                    obj2 = obj3;
                            ...
                            case 8:
                                ...
                                if (i34 == 2) {
                                    ...
                                    iE = iC;
                                    unsafe3.putObject(obj3, j10, fVar2.f23471c);
                                    unsafe2 = unsafe3;
                                    i21 = i23;
                                    i29 = i42 | i39;
                                    obj2 = obj3;
                            ...
                            case 9:
                                if (i34 != 2) {
                                    ...
                                    if (object == null) {
                                        ...
                                        unsafe3.putObject(obj3, j10, l1.a(object, fVar2.f23471c));
                                    }
                                    unsafe2 = unsafe3;
                                    i21 = i23;
                                    i29 = i42 | i39;
                            ...
                            case 15:
                                if (i34 != 0) {
                                    ...
                                    iE = iA6;
                                    unsafe3.putInt(obj3, j10, w.b(fVar2.f23469a));
                                    i21 = i11;
                                    unsafe2 = unsafe3;
                                    i29 = i42 | i39;
                                    obj2 = obj3;
                            ...
                            case 16:
                                if (i34 != 0) {
                                    ...
                                    iE = g.e(bArr2, iA3, fVar2);
                                    unsafe3.putLong(obj3, j10, w.a(fVar2.f23470b));
                                    i21 = i11;
                                    unsafe2 = unsafe3;
                                    i29 = i42 | i39;
                                    obj2 = obj3;
                        ...
                        if (i37 != 27) {
                            ...
                            if (i37 <= 49) {
                                ...
                                byte[] bArr3 = bArr2;
                                int i47 = i30;
                                int iA7 = a(obj4, bArr3, i46, i11, i12 == true ? 1 : 0, i34, i47, i36, i37, j10, fVar2);
                                i12 = i12 == true ? 1 : 0;
                                i15 = i47;
                                unsafe2 = unsafe4;
                                if (iA7 != i46) {
                                ...
                                if (i37 != 50) {
                                    ...
                                    i17 = i45;
                                    unsafe2 = unsafe;
                                    int iA8 = a(obj5, bArr, i16, i11, i12 == true ? 1 : 0, i14, i34, i36, i37, j10, i15, fVar);
                                    obj2 = obj5;
                                    i12 = i12 == true ? 1 : 0;
                                    if (iA8 != i16) {
                                        iA2 = iA8;
                                    ...
                                    Unsafe unsafe5 = f23490r;
                                    Object objB = b(i15);
                                    Object object2 = unsafe5.getObject(obj3, j10);
                                    this.f23506p.getClass();
                                    if (!((y1) object2).f23639a) {
                                        this.f23506p.getClass();
                                        y1 y1Var = y1.f23638b;
                                        y1 y1Var2 = y1Var.isEmpty() ? new y1() : new y1(y1Var);
                                        this.f23506p.getClass();
                ...
                i24 = i11;
                iA2 = g.a(i12 == true ? 1 : 0, bArr, i19, i11, n3Var, fVar);
                i29 = i17;
                i2Var = this;
                bArr2 = bArr;
                fVar2 = fVar;
    ...
    */
    ...
    public static void a(int i10, Object obj, c0 c0Var) {
        if (obj instanceof String) {
            c0Var.f23447a.a((String) obj, i10);
        } else {
            c0Var.f23447a.a(i10, (s) obj);
        }
    }

    public final void a(Object obj, int i10, s2 s2Var) {
        if ((536870912 & i10) != 0) {
            s2Var.b(this.f23503m.b(obj, i10 & 1048575));
        } else {
            s2Var.q(this.f23503m.b(obj, i10 & 1048575));
        }
    }

    public final void a(Object obj, int i10, s2 s2Var, t2 t2Var, h0 h0Var) {
        s2Var.b(this.f23503m.b(obj, i10 & 1048575), t2Var, h0Var);
    }

    public final void a(Object obj, long j10, s2 s2Var, t2 t2Var, h0 h0Var) {
        s2Var.a(this.f23503m.b(obj, j10), t2Var, h0Var);
    }
    ...
    public final boolean a(int i10, Object obj) {
        ...
        switch ((i12 & 267386880) >>> 20) {
            case 0:
                return x3.f23629c.c(obj, j11) != 0.0d;
            case 1:
                return x3.f23629c.d(obj, j11) != 0.0f;
            case 2:
            ...
            case 8:
                ...
                if (objE instanceof s) {
                    return !s.f23563b.equals(objE);
                }
                throw new IllegalArgumentException();
            case 9:
                return x3.e(obj, j11) != null;
            case 10:
                return !s.f23563b.equals(x3.e(obj, j11));
            case 11:
                return x3.c(obj, j11) != 0;
            case 12:
                return x3.c(obj, j11) != 0;
    ...
    public final boolean a(Object obj, int i10, int i11) {
        return x3.c(obj, (long) (this.f23491a[i11 + 2] & 1048575)) == i10;
    }
    ...
    public final int a(int i10, int i11) {
        int length = (this.f23491a.length / 3) - 1;
        while (i11 <= length) {
            int i12 = (length + i11) >>> 1;
            int i13 = i12 * 3;
            int i14 = this.f23491a[i13];
            if (i10 == i14) {
                return i13;
            }
            if (i10 < i14) {
