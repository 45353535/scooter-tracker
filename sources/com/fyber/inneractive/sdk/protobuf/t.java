...
public final class t extends w {
    ...
    public int f23573k = Integer.MAX_VALUE;

    public t(byte[] bArr, int i10, int i11, boolean z10) {
        this.f23567e = bArr;
        this.f23568f = i11 + i10;
        this.f23570h = i10;
        this.f23571i = i10;
    }
    ...
    @Override // com.fyber.inneractive.sdk.protobuf.w
    public final int b() {
        return this.f23570h - this.f23571i;
    }
    ...
    public final boolean e(int i10) throws n1 {
        ...
        int i12 = 0;
        if (i11 == 0) {
            if (this.f23568f - this.f23570h >= 10) {
                while (i12 < 10) {
                    byte[] bArr = this.f23567e;
                    int i13 = this.f23570h;
                    this.f23570h = i13 + 1;
                    if (bArr[i13] < 0) {
                        i12++;
                    }
    ...
    */
    ...
    public final String r() throws n1 {
        ...
        if (iM > 0) {
            ...
            if (iM <= i10 - i11) {
                String str = new String(this.f23567e, i11, iM, l1.f23521a);
                this.f23570h += iM;
                return str;
            }
        }
    ...
    public final String s() throws n1 {
        ...
        if (iM > 0) {
            ...
            int i11 = this.f23570h;
            if (iM <= i10 - i11) {
                String strA = d4.f23458a.a(this.f23567e, i11, iM);
                this.f23570h += iM;
                return strA;
            }
        }
    ...
    public final void z() {
        int i10 = this.f23568f + this.f23569g;
        this.f23568f = i10;
        int i11 = i10 - this.f23571i;
    ...
    public final int d(int i10) {
        ...
        int i11 = (this.f23570h - this.f23571i) + i10;
        int i12 = this.f23573k;
        if (i11 > i12) {
            throw new n1("While parsing a protocol message, the input ended unexpectedly in the middle of a field.  This could mean either that the input has been truncated or that an embedded message misreported its own length.");
        }
    ...
    public final boolean c() {
        return this.f23570h == this.f23568f;
    }
    ...
    */
    public final com.fyber.inneractive.sdk.protobuf.q e() throws com.fyber.inneractive.sdk.protobuf.n1 {
        /*
            ...
            if (r0 > r1) goto L28
            byte[] r1 = r5.f23567e
            com.fyber.inneractive.sdk.protobuf.q r3 = com.fyber.inneractive.sdk.protobuf.s.f23563b
            int r3 = r2 + r0
            int r4 = r1.length
            ...
            com.fyber.inneractive.sdk.protobuf.o r4 = com.fyber.inneractive.sdk.protobuf.s.f23564c
        ...
        L28:
            if (r0 != 0) goto L2d
            com.fyber.inneractive.sdk.protobuf.q r0 = com.fyber.inneractive.sdk.protobuf.s.f23563b
            return r0
        L2d:
            if (r0 <= 0) goto L40
            int r1 = r5.f23568f
        ...
        L40:
            if (r0 > 0) goto L56
            if (r0 != 0) goto L4e
            byte[] r0 = com.fyber.inneractive.sdk.protobuf.l1.f23522b
        L46:
            com.fyber.inneractive.sdk.protobuf.q r1 = com.fyber.inneractive.sdk.protobuf.s.f23563b
    ...
    public final int a() {
        ...
        return i10 - (this.f23570h - this.f23571i);
    }
}
