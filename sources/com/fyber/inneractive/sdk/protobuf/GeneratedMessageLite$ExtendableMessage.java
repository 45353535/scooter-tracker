...
public abstract class GeneratedMessageLite$ExtendableMessage<MessageType extends GeneratedMessageLite$ExtendableMessage<MessageType, BuilderType>, BuilderType> extends z0 implements e2 {
    protected n0 extensions = n0.f23529d;
    ...
    private void mergeMessageSetExtensionFromBytes(s sVar, h0 h0Var, x0 x0Var) throws IOException {
        d2 d2Var = (d2) this.extensions.f23530a.get(x0Var.f23623d);
        c2 builder = d2Var != null ? d2Var.toBuilder() : null;
        if (builder == null) {
            builder = x0Var.f23622c.newBuilderForType();
        }
        t0 t0Var = (t0) builder;
        t0Var.getClass();
        try {
    ...
    */
    ...
    private void verifyExtensionContainingType(x0 x0Var) {
        if (x0Var.f23620a != getDefaultInstanceForType()) {
    ...
    public n0 ensureExtensionsAreMutable() {
        ...
        if (n0Var.f23531b) {
            this.extensions = n0Var.m4487clone();
        }
    ...
    public final <Type> Type getExtension(e0 e0Var) {
        ...
        n0 n0Var = this.extensions;
        Type type = (Type) n0Var.f23530a.get(x0VarAccess$000.f23623d);
        if (type == 0) {
            return (Type) x0VarAccess$000.f23621b;
        }
        w0 w0Var = x0VarAccess$000.f23623d;
        if (w0Var.f23609d) {
            if (w0Var.f23608c.a() == k4.ENUM) {
                ?? r12 = (Type) new ArrayList();
                for (Object objA : (List) type) {
                    if (x0VarAccess$000.f23623d.f23608c.a() == k4.ENUM) {
                        objA = x0VarAccess$000.f23623d.f23606a.a(((Integer) objA).intValue());
                    }
                    r12.add(objA);
                }
                return r12;
            }
        } else if (w0Var.f23608c.a() == k4.ENUM) {
            return (Type) x0VarAccess$000.f23623d.f23606a.a(((Integer) type).intValue());
        }
        return type;
    }
    ...
    public final <Type> int getExtensionCount(e0 e0Var) {
        ...
        Object obj = n0Var.f23530a.get(w0Var);
        if (obj == null) {
            return 0;
        }
    ...
    public final <Type> boolean hasExtension(e0 e0Var) {
        ...
        return n0Var.f23530a.get(w0Var) != null;
    }
    ...
    public final <Type> Type getExtension(e0 e0Var, int i10) {
        ...
        if (w0Var.f23609d) {
            ...
            if (obj != null) {
                ...
                return x0VarAccess$000.f23623d.f23608c.a() == k4.ENUM ? (Type) x0VarAccess$000.f23623d.f23606a.a(((Integer) type).intValue()) : type;
            }
