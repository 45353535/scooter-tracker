...
public abstract class b0 extends k {
    ...
    public static final Logger f23440b = Logger.getLogger(b0.class.getName());

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public static final boolean f23441c = x3.f23631e;
    ...
    public static int a(String str) {
        ...
        try {
            ...
            length = str.getBytes(l1.f23521a).length;
        }
    ...
    public final void a(String str, b4 b4Var) throws z {
        f23440b.log(Level.WARNING, "Converting ill-formed UTF-16. Your Protocol Buffer will not round trip correctly!", (Throwable) b4Var);
        byte[] bytes = str.getBytes(l1.f23521a);
        try {
            g(bytes.length);
