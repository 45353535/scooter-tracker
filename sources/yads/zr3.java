...
public final class zr3 implements eh3 {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final Context f118782a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final ad3 f118783b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public final ud3 f118784c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public final List f118785d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public final bh3 f118786e;

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    public final p82 f118787f;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    public final dm2 f118788g;
    ...
    public boolean f118792k;

    public zr3(Context context, ad3 ad3Var, ud3 ud3Var, List list, bh3 bh3Var, p82 p82Var, dm2 dm2Var) {
        this.f118782a = context;
        this.f118783b = ad3Var;
        this.f118784c = ud3Var;
        this.f118785d = list;
        this.f118786e = bh3Var;
        this.f118787f = p82Var;
        this.f118788g = dm2Var;
    }
    ...
    @Override // yads.eh3
    public final void b() {
        uj1 uj1Var = this.f118790i;
        if (uj1Var != null) {
            try {
                if (this.f118792k) {
                    return;
                }
                lu3.a(uj1Var.f116673a);
                uj1Var.f116673a.f110065e.a("complete", (JSONObject) null);
            } catch (Exception e10) {
                boolean z10 = lb1.f113032a;
                this.f118788g.reportError("Failed to execute safely", e10);
            }
        }
    }
    ...
    public final void c() {
        ...
        if (uj1Var != null) {
            try {
                ...
                lu3.a(uj1Var.f116673a);
                uj1Var.f116673a.f110065e.a("resume", (JSONObject) null);
            } catch (Exception e10) {
                boolean z10 = lb1.f113032a;
                this.f118788g.reportError("Failed to execute safely", e10);
            }
    ...
    public final void d() {
        ...
        if (uj1Var != null) {
            try {
                ...
                lu3.a(uj1Var.f116673a);
                uj1Var.f116673a.f110065e.a("pause", (JSONObject) null);
            } catch (Exception e10) {
                boolean z10 = lb1.f113032a;
                this.f118788g.reportError("Failed to execute safely", e10);
            }
    ...
    public final void f() {
        ...
        if (uj1Var != null) {
            try {
                ...
                lu3.a(uj1Var.f116673a);
                uj1Var.f116673a.f110065e.a("bufferStart", (JSONObject) null);
            } catch (Exception e10) {
                boolean z10 = lb1.f113032a;
                this.f118788g.reportError("Failed to execute safely", e10);
            }
    ...
    public final void j() {
        ...
        if (uj1Var != null) {
            try {
                ...
                lu3.a(uj1Var.f116673a);
                uj1Var.f116673a.f110065e.a("bufferFinish", (JSONObject) null);
            } catch (Exception e10) {
                boolean z10 = lb1.f113032a;
                this.f118788g.reportError("Failed to execute safely", e10);
            }
    ...
    public final void m() {
        ...
        if (uj1Var != null) {
            try {
                ...
                bb1 bb1Var = bb1.f108957c;
                lu3.a(uj1Var.f116673a);
                JSONObject jSONObject = new JSONObject();
                st3.a(jSONObject, "interactionType", bb1Var);
                uj1Var.f116673a.f110065e.a("adUserInteraction", jSONObject);
            } catch (Exception e10) {
                boolean z10 = lb1.f113032a;
                this.f118788g.reportError("Failed to execute safely", e10);
            }
    ...
    public final n82 a(Context context) {
        hr2 hr2VarA;
        dt3 dt3Var;
        l82 l82VarA = m82.a(context);
        Object obj = e82.f110248c;
        e82 e82VarA = d82.a();
        Object obj2 = vt2.f117186j;
        vt2 vt2VarA = ut2.a();
        Context applicationContext = context.getApplicationContext();
        List list = this.f118785d;
        n82 n82Var = null;
        if (rb.a(applicationContext) && (hr2VarA = vt2VarA.a(applicationContext)) != null && !hr2VarA.f111759w) {
            synchronized (e82.f110248c) {
                try {
                    if (e82VarA.f110250a.a(applicationContext) && !e82VarA.f110251b) {
                        r82.a(applicationContext);
                        e82VarA.f110251b = true;
                    }
            ...
            while (it.hasNext()) {
                try {
                    listCreateListBuilder.add(q82.a((ua3) it.next()));
                } catch (wa3 e10) {
                    Map mapMapOf = MapsKt.mapOf(TuplesKt.to("[REASON]", String.valueOf(e10.f117382c.f116949b)));
                    bh3 bh3Var = this.f118786e;
                    ua3 ua3Var = e10.f117381b;
                    bh3Var.getClass();
                    List list2 = (List) ua3Var.a().get(com.taurusx.tax.f.z.f66064m);
                    if (list2 != null) {
                        bh3Var.f109007a.a(list2, mapMapOf);
                    }
            ...
            if (listBuild.isEmpty()) {
                ...
                String strC = ((ff1) l82VarA.f113000a).c("YmadOmSdkJs");
                if (strC == null) {
                    strC = "";
                }
                if (strC.length() == 0) {
                ...
                if (!TextUtils.isEmpty("7.17.0")) {
                    ga gaVar = new ga(new ea2(), strC, listBuild);
                    fa faVar = new fa();
                    if (r82.f115366a.f114782a) {
                        dt3Var = new dt3(faVar, gaVar, UUID.randomUUID().toString());
                    } else {
            ...
            if (dt3Var != null) {
                if (r92.f115374c == dt3Var.f110062b.f110665b) {
                    if (!dt3Var.f110066f) {
                        boolean z11 = dt3Var.f110067g;
                        if (!z11) {
                            ia iaVar = dt3Var.f110065e;
                            if (iaVar.f111924d == null) {
                                uj1 uj1Var = new uj1(dt3Var);
                                iaVar.f111924d = uj1Var;
                                if (iaVar.f111923c != null) {
                                    throw new IllegalStateException("AdEvents already exists for AdSession");
                                }
                                if (!z11) {
                                    d4 d4Var = new d4(dt3Var);
                                    iaVar.f111923c = d4Var;
                                    n82Var = new n82(dt3Var, uj1Var, d4Var);
                                } else {
    ...
    public final void a(View view, List list) {
        ...
        Unit unit = Unit.f93236a;
        try {
            n82 n82VarA = a(this.f118782a);
            if (n82VarA != null) {
                dt3 dt3Var = n82VarA.f113755a;
                dt3Var.a(view);
                this.f118789h = dt3Var;
                this.f118790i = n82VarA.f113756b;
                this.f118791j = n82VarA.f113757c;
            }
        } catch (Exception e10) {
            boolean z10 = lb1.f113032a;
            this.f118788g.reportError("Failed to execute safely", e10);
        }
        if (this.f118789h != null) {
            Iterator it = list.iterator();
            if (it.hasNext()) {
        ...
        if (dt3Var2 != null) {
            try {
                ...
                this.f118788g.reportError("Failed to execute safely", e11);
            }
        }
        d4 d4Var = this.f118791j;
        if (d4Var != null) {
            try {
                ...
                p82 p82Var = this.f118787f;
                ud3 ud3Var = this.f118784c;
                ad3 ad3Var = this.f118783b;
                p82Var.getClass();
                int iOrdinal = ad3Var.ordinal();
                if (iOrdinal == 0) {
                    ae2Var = ae2.f108660c;
                } else if (iOrdinal == 1) {
                    ae2Var = ae2.f108661d;
                ...
                if (ud3Var != null) {
                    ba3Var = new ba3(true, Float.valueOf(ud3Var.f116620a / 1000), ae2Var);
                } else {
                    ba3Var = new ba3(false, null, ae2Var);
                }
                d4Var.a(ba3Var);
            } catch (Exception e12) {
                boolean z12 = lb1.f113032a;
                this.f118788g.reportError("Failed to execute safely", e12);
            }
        }
    }
    ...
    public final void a(dh3 dh3Var) {
        ...
        if (uj1Var != null) {
            try {
                ...
                if (iOrdinal == 0) {
                    lu3.a(uj1Var.f116673a);
                    uj1Var.f116673a.f110065e.a("firstQuartile", (JSONObject) null);
                } else if (iOrdinal == 1) {
                    lu3.a(uj1Var.f116673a);
                    uj1Var.f116673a.f110065e.a("midpoint", (JSONObject) null);
                } else {
                    if (iOrdinal != 2) {
                        return;
                    }
                    lu3.a(uj1Var.f116673a);
                    uj1Var.f116673a.f110065e.a("thirdQuartile", (JSONObject) null);
                }
            } catch (Exception e10) {
                boolean z10 = lb1.f113032a;
                this.f118788g.reportError("Failed to execute safely", e10);
