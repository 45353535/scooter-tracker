...
public class i extends g {
    ...
    final class AnonymousClass4 implements u.a {
        AnonymousClass4() {
        }
    ...
    static /* synthetic */ void a(i iVar) {
        if (((b) iVar).f100951y == null || iVar.f100922w) {
            return;
        }
        final boolean zV = iVar.v();
        final boolean[] zArr = {false, false};
        Context context = ((b) iVar).f100951y.getContext();
        ...
        transitionSet.addListener((Transition.TransitionListener) new sg.bigo.ads.common.h() { // from class: sg.bigo.ads.ad.interstitial.d.i.3
            ...
            public final void onTransitionStart(final Transition transition) {
                sg.bigo.ads.common.w.b.a(((b) i.this).f100951y, -1, new b.a() { // from class: sg.bigo.ads.ad.interstitial.d.i.3.1
                ...
                sg.bigo.ads.ad.interstitial.multi_img.e.a(button, button, c1234aU.f100944a, zArr, zV, transition.getDuration());
            }
        });
        transitionSet.setDuration(300L);
        TransitionManager.beginDelayedTransition(iVar.f100917r, transitionSet);
        TextView textView = iVar.E;
        if (textView != null) {
            sg.bigo.ads.common.w.b.a(textView.getCurrentTextColor(), sg.bigo.ads.ad.interstitial.b.f100662a.f100668f, transitionSet.getDuration(), iVar.E);
        }
        TextView textView2 = iVar.F;
        if (textView2 != null) {
            sg.bigo.ads.common.w.b.a(textView2.getCurrentTextColor(), sg.bigo.ads.ad.interstitial.b.f100662a.f100669g, transitionSet.getDuration(), iVar.F);
        }
        ((b) iVar).f100951y.setOutlineProvider(new sg.bigo.ads.common.view.b.b(sg.bigo.ads.common.utils.e.a(context, 12)));
        ((b) iVar).f100951y.setPadding(iA, iA, iA, iA);
        ((b) iVar).f100951y.getLayoutParams().width = sg.bigo.ads.common.utils.e.a(((b) iVar).f100951y.getContext(), 288);
        ...
        bVar.b(((b) iVar).f100951y);
        bVar.a(iVar.G);
        bVar.a(iVar.I);
        ((b) iVar).f100951y.requestLayout();
    }

    @Override // sg.bigo.ads.ad.interstitial.d.b
    protected final void A() {
        if (((b) this).f100951y == null) {
            return;
        }
        ...
        a(iMax, new Runnable() { // from class: sg.bigo.ads.ad.interstitial.d.i.2
            @Override // java.lang.Runnable
            public final void run() {
                ((b) i.this).f100951y.post(new Runnable() { // from class: sg.bigo.ads.ad.interstitial.d.i.2.1
                    @Override // java.lang.Runnable
                    public final void run() {
                        if (i.this.N != null) {
                            ((RelativeLayout.LayoutParams) i.this.N.getLayoutParams()).width = (((b) i.this).f100951y.getMeasuredWidth() - ((b) i.this).f100951y.getPaddingLeft()) - ((b) i.this).f100951y.getPaddingRight();
                            i.this.N.requestLayout();
                        }
                        AnonymousClass2 anonymousClass2 = AnonymousClass2.this;
                        ((b) i.this).f100951y.post(runnable);
                    }
                });
            }
        });
    ...
    protected final boolean a(@NonNull sg.bigo.ads.ad.interstitial.b bVar) {
        ...
        if (!super.a(bVar) || (realtimeBlurLinearLayout = ((b) this).f100951y) == null) {
            return false;
        }
