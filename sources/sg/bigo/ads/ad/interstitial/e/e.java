...
public class e extends d {
    ...
    protected List<View> a(@NonNull a aVar) {
        ...
        if (size == 2) {
            ...
            this.f101194a.addView(new Space(this.f101197d), new LinearLayout.LayoutParams(sg.bigo.ads.common.utils.e.a(this.f101197d, 15), iA));
    ...
    @Override // sg.bigo.ads.ad.interstitial.e.d
    protected final b a() {
        return new b(sg.bigo.ads.common.utils.e.a(this.f101197d, 8), this.f101201h, this.f101200g);
    }
}
