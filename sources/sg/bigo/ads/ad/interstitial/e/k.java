...
public final class k extends e {
    ...
    protected final List<View> a(@NonNull a aVar) {
        if (this.f101195b.size() != 1) {
            return super.a(aVar);
        }
        View viewA = sg.bigo.ads.common.utils.a.a(this.f101197d, R.layout.bigo_ad_layout_word_icon, this.f101194a, false);
        FrameLayout.LayoutParams layoutParams = new FrameLayout.LayoutParams(-1, -2);
        layoutParams.gravity = 17;
        FrameLayout frameLayout = new FrameLayout(this.f101197d);
        frameLayout.setBackgroundColor(ViewCompat.MEASURED_STATE_MASK);
        View viewA2 = sg.bigo.ads.common.utils.a.a(this.f101197d, R.layout.bigo_ad_layout_word_icon_first_page, frameLayout, false);
        u.a(viewA2, frameLayout, layoutParams, -1);
        u.a(viewA, frameLayout, layoutParams, -1);
        u.a(frameLayout, this.f101194a, new LinearLayout.LayoutParams(-1, sg.bigo.ads.common.utils.e.a(this.f101197d, 32)), -1);
        Handler handler = new Handler(Looper.getMainLooper());
        c.AnonymousClass7 anonymousClass7 = new Runnable() { // from class: sg.bigo.ads.ad.interstitial.c.7

            /* JADX INFO: renamed from: a */
            boolean f100715a = true;

            /* JADX INFO: renamed from: b */
            final /* synthetic */ WeakReference f100716b;

            /* JADX INFO: renamed from: c */
            final /* synthetic */ WeakReference f100717c;

            /* JADX INFO: renamed from: d */
            final /* synthetic */ Handler f100718d;

            /* JADX INFO: renamed from: sg.bigo.ads.ad.interstitial.c$7$1 */
            final class AnonymousClass1 extends AnimatorListenerAdapter {

                /* JADX INFO: renamed from: a */
                final /* synthetic */ View f100719a;
            ...
            public final void run() {
                ...
                animatorSet2.start();
                boolean z11 = this.f100715a;
                this.f100715a = true ^ z11;
    ...
    protected final void a(TextView textView) {
        if (textView != null) {
            textView.setMaxWidth(this.f101197d.getResources().getDisplayMetrics().widthPixels - sg.bigo.ads.common.utils.e.a(this.f101197d, 60));
        }
    }
}
