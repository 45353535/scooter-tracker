...
public final class a {
    ...
    public static boolean f101874a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static boolean f101875b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static List<ObjectAnimator> f101876c;
    ...
    public static void b(ObjectAnimator objectAnimator) {
        if (f101876c == null) {
            f101876c = new ArrayList();
        }
        f101876c.add(objectAnimator);
    }

    @NonNull
    static SplashAd.Style c(@NonNull m mVar) {
        h hVar = i.f102116a;
    ...
    public static void a() {
        List<ObjectAnimator> list = f101876c;
        if (list != null) {
    ...
    static /* synthetic */ void c(final ViewGroup viewGroup, int i10) {
    ...
    protected static void a(int i10, @NonNull sg.bigo.ads.ad.b.b bVar, @NonNull final ViewGroup viewGroup) {
    ...
    public static void a(@NonNull final sg.bigo.ads.ad.b.b bVar, final ValueCallback<Bitmap> valueCallback) {
        ...
        if (!nVar.aR()) {
            ...
            if (q.a((CharSequence) strAT)) {
                ...
                sg.bigo.ads.common.p.e.a(bVar.f100335b.f102178e, strAT, nVar.al(), new g() { // from class: sg.bigo.ads.ad.splash.a.7
        ...
        String strB = o.b(bVar.f100335b.f102178e, nVar.aN());
        if (q.a((CharSequence) strB)) {
            ...
            d.a(3, new Runnable() { // from class: sg.bigo.ads.ad.splash.a.6
                @Override // java.lang.Runnable
                public final void run() {
                    valueCallback.onReceiveValue(sg.bigo.ads.common.utils.d.a(Uri.parse(path).getPath(), bVar.f100335b.f102178e));
                }
            });
        }
    }
