...
public class c implements SplashAdInteractionListener {
    ...
    private boolean f102075a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    @Nullable
    SplashAdInteractionListener f102076b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    @Nullable
    SplashAdInteractionListener f102077c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private boolean f102078d = false;

    @Override // sg.bigo.ads.api.AdInteractionListener
    public void onAdClicked() {
        SplashAdInteractionListener splashAdInteractionListener = this.f102076b;
        if (splashAdInteractionListener != null) {
            splashAdInteractionListener.onAdClicked();
        }
        SplashAdInteractionListener splashAdInteractionListener2 = this.f102077c;
    ...
    public void onAdError(@NonNull AdError adError) {
        if (adError.getCode() == 2002 && this.f102078d) {
