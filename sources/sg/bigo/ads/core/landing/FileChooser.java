...
public class FileChooser {
    ...
    final Activity f104343a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    ValueCallback<Uri> f104344b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    ValueCallback<Uri[]> f104345c;

    public FileChooser(Activity activity) {
        this.f104343a = activity;
    }
    ...
    final void a(String... strArr) {
        ...
        this.f104343a.startActivityForResult(Intent.createChooser(intent, "Select File"), 101);
    }

    @Keep
    public void openFileChooser(ValueCallback<Uri> valueCallback, String str, String str2) {
        sg.bigo.ads.common.t.a.a(0, 3, "FileChooser", "openFileChooser");
        this.f104344b = valueCallback;
        a(str);
    }
}
