...
public final class c {
    ...
    private static final c f104041e = new c();

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public sg.bigo.ads.core.d.a.a f104042a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public sg.bigo.ads.core.d.b.b f104043b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public final AtomicBoolean f104044c = new AtomicBoolean(false);
    ...
    private void b(final String str, final Map<String, String> map) {
        d.a(3, new Runnable() { // from class: sg.bigo.ads.core.d.c.1
            ...
            public final void run() {
                try {
                    sg.bigo.ads.common.g.b.b bVarA = sg.bigo.ads.core.d.b.b.b(str, map).a(c.this.f104045d, 0L);
    ...
    public final void a(String str, Map<String, String> map) {
        ...
        if (this.f104042a == null) {
            ...
            if (q.a((CharSequence) str) || map == null) {
                ...
                if (this.f104042a.a(str)) {
                    sg.bigo.ads.core.d.b.b bVar = this.f104043b;
                    if (bVar != null) {
                        bVar.a(str, map);
                        return;
                    }
