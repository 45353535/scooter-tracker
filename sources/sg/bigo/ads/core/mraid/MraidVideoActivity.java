...
public class MraidVideoActivity extends Activity {
    ...
    private MediaView f104363a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private VideoController f104364b;
    ...
    protected void onCreate(@Nullable Bundle bundle) {
        ...
        try {
            ...
            this.f104363a = mediaView;
            mediaView.a(stringExtra);
            this.f104364b = this.f104363a.getVideoController();
            this.f104363a.setOnClickListener(new View.OnClickListener() { // from class: sg.bigo.ads.core.mraid.MraidVideoActivity.1
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    if (MraidVideoActivity.this.f104364b != null) {
                        if (MraidVideoActivity.this.f104364b.isPlaying()) {
                            MraidVideoActivity.this.f104364b.pause();
                        } else {
                            MraidVideoActivity.this.f104364b.play();
                        }
                    }
                }
            });
            ...
            frameLayout.addView(this.f104363a, new FrameLayout.LayoutParams(-1, -2, 17));
    ...
    protected void onDestroy() {
        super.onDestroy();
        try {
            VideoController videoController = this.f104364b;
            if (videoController != null) {
                videoController.pause();
            }
            MediaView mediaView = this.f104363a;
            if (mediaView != null) {
                mediaView.c();
            }
        } catch (Throwable unused) {
