...
public abstract class e implements f {
    ...
    @NonNull
    public final Context f102308b;

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private final Runnable f102307a = new Runnable() { // from class: sg.bigo.ads.common.e.1
        @Override // java.lang.Runnable
        public final void run() {
            e eVar = e.this;
            eVar.c(eVar.f102308b);
        }
    };

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public boolean f102309c = false;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    protected boolean f102310d = false;

    public e(@NonNull Context context) {
        this.f102308b = context;
    }
    ...
    public final void a(long j10) {
        sg.bigo.ads.common.n.d.a(this.f102307a);
        if (j10 <= 0) {
            sg.bigo.ads.common.n.d.a(1, this.f102307a);
        } else {
            sg.bigo.ads.common.n.d.a(1, this.f102307a, j10);
        }
    }
