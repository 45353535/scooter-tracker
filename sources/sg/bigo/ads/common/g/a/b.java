...
public final class b extends SQLiteOpenHelper {
    ...
    private static b f102423a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static WeakReference<Context> f102424b;

    private b(Context context, String str) {
        super(context, str, (SQLiteDatabase.CursorFactory) null, 4);
        f102424b = new WeakReference<>(context);
    ...
    public static synchronized b a(@NonNull Context context) {
        try {
            if (f102423a == null) {
                f102423a = new b(context, "bigo_ads_sdk.db");
            }
        } catch (Throwable th2) {
            throw th2;
        }
    ...
    public final void onDowngrade(SQLiteDatabase sQLiteDatabase, int i10, int i11) {
        ...
        WeakReference<Context> weakReference = f102424b;
