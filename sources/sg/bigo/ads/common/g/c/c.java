...
public final class c {
    ...
    public static boolean c(sg.bigo.ads.common.g.b.c cVar) {
        ...
        Cursor cursorA = sg.bigo.ads.common.g.a.a.a("tb_tracker", a(new String[]{"_id"}), new String[]{String.valueOf(cVar.f102449a)});
        if (cursorA == null) {
            return false;
        }
    ...
    private static ContentValues d(sg.bigo.ads.common.g.b.c cVar) {
        ...
        contentValues.put("ext", cVar.f102453e);
        long jCurrentTimeMillis = cVar.f102454f;
        if (jCurrentTimeMillis == 0) {
            jCurrentTimeMillis = System.currentTimeMillis();
        }
        contentValues.put("ctime", Long.valueOf(jCurrentTimeMillis));
        long jCurrentTimeMillis2 = cVar.f102455g;
    ...
    public static long b(sg.bigo.ads.common.g.b.c cVar) {
        ...
        cVar.f102455g = System.currentTimeMillis();
        return sg.bigo.ads.common.g.a.a.a("tb_tracker", d(cVar), a(new String[]{"_id"}), new String[]{String.valueOf(cVar.f102449a)});
    }
