...
public class AdActivity extends Activity {
    ...
    @Nullable
    private BaseAdActivityImpl f102079a;
    ...
    public void finish() {
        super.finish();
        try {
            BaseAdActivityImpl baseAdActivityImpl = this.f102079a;
    ...
    protected void onCreate(@Nullable Bundle bundle) {
        ...
        try {
            ...
            this.f102079a = (BaseAdActivityImpl) declaredConstructor.newInstance(this);
            a();
