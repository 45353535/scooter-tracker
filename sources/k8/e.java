...
public final class e implements JSONSerializable, JsonTemplate {

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static final b f87134b = new b(null);

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final Function2 f87135c = a.f87137f;

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final Field f87136a;

    static final class a extends Lambda implements Function2 {

        /* JADX INFO: renamed from: f, reason: collision with root package name */
        public static final a f87137f = new a();
    ...
    public JSONObject writeToJSON() {
        return ((c) BuiltInParserKt.getBuiltInParserComponent().b().getValue()).serialize(BuiltInParserKt.getBuiltInParsingContext(), this);
    }
