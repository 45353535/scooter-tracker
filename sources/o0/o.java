...
public class o implements n0 {
    ...
    private l0.d b(l0.d dVar, List list) {
        int i10 = this.f96291a * 4;
        if (list.size() <= i10) {
            return dVar;
        }
        float[] fArrE = dVar.e();
        ...
        for (int i11 = 1; i11 < fArr.length; i11++) {
            ...
            if (f11 >= f10 || i11 == fArr.length - 1) {
                if (f11 <= f10) {
                    ...
                    int i12 = i11 - 1;
                    float f12 = fArr[i12];
                    fI = q0.l.i(fArr2[i12], fArr2[i11], (f10 - f12) / (f11 - f12));
                }
    ...
    int c(float f10, float f11, float[] fArr, int[] iArr) {
        ...
        for (int i10 = 1; i10 < fArr.length; i10++) {
            ...
            if (f12 >= f10 || i10 == fArr.length - 1) {
                ...
                int i11 = i10 - 1;
                float f13 = fArr[i11];
                int iC = q0.e.c((f10 - f13) / (f12 - f13), iArr[i11], iArr[i10]);
    ...
    */
    public l0.d a(p0.c r18, float r19) {
        /*
            Method dump skipped, instruction units count: 223
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: o0.o.a(p0.c, float):l0.d");
    }
}
