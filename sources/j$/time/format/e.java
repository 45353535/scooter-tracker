    ...
    */
    public final boolean j(j$.time.format.p r8, java.lang.StringBuilder r9) {
        /*
            ...
            int r0 = r9.length()
            r1 = 1
            boolean r2 = r7.f84620b
            if (r2 == 0) goto Le
            int r3 = r8.f84652c
            int r3 = r3 + r1
            r8.f84652c = r3
        Le:
            j$.time.format.f[] r3 = r7.f84619a     // Catch: java.lang.Throwable -> L27
    ...
    public final String toString() {
        ...
        f[] fVarArr = this.f84619a;
        if (fVarArr != null) {
            boolean z10 = this.f84620b;
            sb2.append(z10 ? C4240b4.j.f42672d : "(");
            for (f fVar : fVarArr) {
                sb2.append(fVar);
            }
            sb2.append(z10 ? C4240b4.j.f42674e : ")");
        }
        return sb2.toString();
    }
}
