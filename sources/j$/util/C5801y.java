...
public final class C5801y implements IntConsumer {
    private long count;
    private long sum;
    ...
    public final void b(C5801y c5801y) {
        this.count += c5801y.count;
        this.sum += c5801y.sum;
        this.min = Math.min(this.min, c5801y.min);
        this.max = Math.max(this.max, c5801y.max);
    }

    public final String toString() {
        String simpleName = C5801y.class.getSimpleName();
