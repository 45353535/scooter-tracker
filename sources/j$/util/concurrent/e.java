...
public final class e extends b implements Set, j$.util.Set {
    ...
    public final boolean add(Object obj) {
        ...
        return this.f84853a.f(entry.getKey(), entry.getValue(), false) == null;
    }
    ...
    public final boolean contains(Object obj) {
        ...
        Object obj2;
        Object value;
        if (!(obj instanceof Map.Entry) || (key = (entry = (Map.Entry) obj).getKey()) == null || (obj2 = this.f84853a.get(key)) == null || (value = entry.getValue()) == null) {
            return false;
        }
    ...
    public final boolean remove(Object obj) {
        ...
        Object key;
        Object value;
        return (obj instanceof Map.Entry) && (key = (entry = (Map.Entry) obj).getKey()) != null && (value = entry.getValue()) != null && this.f84853a.remove(key, value);
    }
    ...
    public final boolean addAll(java.util.Collection collection) {
        ...
        while (it.hasNext()) {
            ...
            if (this.f84853a.f(entry.getKey(), entry.getValue(), false) == null) {
                z10 = true;
            }
        }
        return z10;
    ...
    public final j$.util.Spliterator spliterator() {
        ...
        k[] kVarArr = concurrentHashMap.f84837a;
        int length = kVarArr == null ? 0 : kVarArr.length;
        return new f(kVarArr, length, 0, length, j10 >= 0 ? j10 : 0L, concurrentHashMap);
    }
    ...
    public final void forEach(Consumer consumer) {
        ...
        while (true) {
            ...
            if (kVarA == null) {
                ...
                consumer.p(new j(kVarA.f84864b, kVarA.f84865c, this.f84853a));
            }
        }
    }
}
