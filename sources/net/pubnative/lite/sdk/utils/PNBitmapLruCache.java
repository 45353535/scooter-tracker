...
public class PNBitmapLruCache {
    ...
    private static final LruCache<String, Bitmap> mMemoryCache = new LruCache<String, Bitmap>(Math.min((int) (Runtime.getRuntime().maxMemory() / 1024), 31457280)) { // from class: net.pubnative.lite.sdk.utils.PNBitmapLruCache.1
