...
public class HyBidInterstitialBroadcastReceiver extends BroadcastReceiver {
    ...
    static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                $SwitchMap$net$pubnative$lite$sdk$interstitial$HyBidInterstitialBroadcastReceiver$Action[Action.PLAYABLE_SKIP_CLICK.ordinal()] = 16;
            } catch (NoSuchFieldError unused16) {
            }
            try {
                $SwitchMap$net$pubnative$lite$sdk$interstitial$HyBidInterstitialBroadcastReceiver$Action[Action.NONE.ordinal()] = 17;
    ...
    HyBidInterstitialBroadcastReceiver(long j10, PNLocalBroadcastManager pNLocalBroadcastManager, IntentFilter intentFilter) {
