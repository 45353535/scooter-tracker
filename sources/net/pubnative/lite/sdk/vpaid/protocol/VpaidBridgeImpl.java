...
public class VpaidBridgeImpl implements VpaidBridge {
    ...
    public void getAdDurationResult(int i10) {
        Logger.d(LOG_TAG, "JS: getAdDurationResult: " + i10);
    }
    ...
    public void getAdLinearResult(boolean z10) {
        Logger.d(LOG_TAG, "getAdLinearResult: " + z10);
    }

    @JavascriptInterface
    public void getAdRemainingTimeResult(int i10) {
        Logger.d(LOG_TAG, "JS: getAdRemainingTimeResult: " + i10);
        if (i10 == 0) {
            this.mBridge.postEvent("complete", true);
        } else {
            this.mBridge.postEvent("progress", i10, false);
        }
    }
    ...
    public void getAdSkippableStateResult(boolean z10) {
        Logger.d(LOG_TAG, "JS: SkippableState: " + z10);
        this.mBridge.setSkippableState(z10);
    }
    ...
    public void vpaidAdStopped() {
        ...
        final BridgeEventHandler bridgeEventHandler = this.mBridge;
        Objects.requireNonNull(bridgeEventHandler);
        runOnUiThread(new Runnable() { // from class: gh.b
            @Override // java.lang.Runnable
            public final void run() {
