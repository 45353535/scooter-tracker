...
class ReversedListReadOnly<T> extends AbstractList<T> {
    ...
    public static final class AnonymousClass1 implements ListIterator<T>, yf.a {
        ...
        AnonymousClass1(ReversedListReadOnly<? extends T> reversedListReadOnly, int i10) {
            ...
            this.delegateIterator = ((ReversedListReadOnly) reversedListReadOnly).delegate.listIterator(CollectionsKt__ReversedViewsKt.reversePositionIndex$CollectionsKt__ReversedViewsKt(reversedListReadOnly, i10));
        }
