...
public final class ArraysKt___ArraysKt$asIterable$$inlined$Iterable$1<T> implements Iterable<T>, yf.a {
    ...
    public Iterator<T> iterator() {
        return kotlin.jvm.internal.i.a(this.$this_asIterable$inlined);
    }
}
