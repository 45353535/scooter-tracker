...
public final class KClasses {
    ...
    public static final Iterable _get_allSupertypes_$lambda$15(KType kType) {
        ...
        for (KType kType2 : list) {
            ...
            arrayList.add(new KTypeImpl(kotlinTypeSubstitute, function0, 2, b10 == true ? 1 : 0));
        }
        return arrayList;
    }
    ...
    public static final <T> T cast(@NotNull KClass<T> kClass, @Nullable Object obj) {
        ...
        throw new q("Value cannot be cast to " + kClass.getQualifiedName());
    }
    ...
    public static final boolean isSubclassOf(@NotNull KClass<?> kClass, @NotNull final KClass<?> base) {
        ...
        final AnonymousClass1 anonymousClass1 = new n0() { // from class: kotlin.reflect.full.KClasses.isSubclassOf.1
