...
public final class TypesJVMKt {
    ...
    public static final Type computeJavaType(KType kType, boolean z10) {
        ...
        Class clsC = z10 ? a.c(kClass) : a.b(kClass);
    ...
    public static final Type getJavaType(@NotNull KType kType) {
        ...
        return (!(kType instanceof b0) || (javaType = ((b0) kType).getJavaType()) == null) ? computeJavaType$default(kType, false, 1, null) : javaType;
    }
    ...
    public static final String typeToString(Type type) {
        ...
        Sequence sequenceQ = k.q(type, TypesJVMKt$typeToString$unwrap$1.INSTANCE);
        return ((Class) k.P(sequenceQ)).getName() + StringsKt.S(HttpUrl.PATH_SEGMENT_ENCODE_SET_URI, k.C(sequenceQ));
    }
