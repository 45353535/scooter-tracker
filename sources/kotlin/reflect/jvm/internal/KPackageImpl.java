...
public final class KPackageImpl extends KDeclarationContainerImpl {
    ...
    final class Data extends KDeclarationContainerImpl.Data {
        static final /* synthetic */ KProperty<Object>[] $$delegatedProperties = {v0.j(new n0(Data.class, "kotlinClass", "getKotlinClass()Lorg/jetbrains/kotlin/descriptors/runtime/components/ReflectKotlinClass;", 0)), v0.j(new n0(Data.class, "scope", "getScope()Lorg/jetbrains/kotlin/resolve/scopes/MemberScope;", 0)), v0.j(new n0(Data.class, "members", "getMembers()Ljava/util/Collection;", 0))};
        ...
        public Data() {
            ...
            l lVar = l.f94210c;
            this.multifileFacade = i.b(lVar, new Function0(this, KPackageImpl.this) { // from class: kotlin.reflect.jvm.internal.KPackageImpl$Data$$Lambda$2
                private final KPackageImpl.Data arg$0;
            ...
            this.metadata = i.b(lVar, new Function0(this) { // from class: kotlin.reflect.jvm.internal.KPackageImpl$Data$$Lambda$3
                private final KPackageImpl.Data arg$0;
        ...
        public static final Class multifileFacade_delegate$lambda$2(Data data, KPackageImpl kPackageImpl) {
            ...
            return kPackageImpl.getJClass().getClassLoader().loadClass(StringsKt.V(multifileClassName, IOUtils.DIR_SEPARATOR_UNIX, '.', false, 4, null));
        }
    ...
    public KPackageImpl(@NotNull Class<?> jClass) {
        ...
        this.jClass = jClass;
        this.data = i.b(l.f94210c, new Function0(this) { // from class: kotlin.reflect.jvm.internal.KPackageImpl$$Lambda$0
            private final KPackageImpl arg$0;
    ...
    public PropertyDescriptor getLocalProperty(int index) {
        ...
        if (metadata != null) {
            JvmNameResolver jvmNameResolver = (JvmNameResolver) metadata.d();
            ProtoBuf.Package r22 = (ProtoBuf.Package) metadata.g();
            JvmMetadataVersion jvmMetadataVersion = (JvmMetadataVersion) metadata.h();
            ...
            ProtoBuf.Property property = (ProtoBuf.Property) ProtoBufUtilKt.getExtensionOrNull(r22, packageLocalVariable, index);
            if (property != null) {
