...
public final class ProtoBuf {
    ...
    public static final class Annotation extends GeneratedMessageLite implements AnnotationOrBuilder {
            ...
            public static final class Value extends GeneratedMessageLite implements ValueOrBuilder {
                ...
                public int getSerializedSize() {
                    ...
                    for (int i11 = 0; i11 < this.arrayElement_.size(); i11++) {
                        iComputeEnumSize += CodedOutputStream.computeMessageSize(9, this.arrayElement_.get(i11));
                    }
        ...
        public int getSerializedSize() {
            ...
            for (int i11 = 0; i11 < this.argument_.size(); i11++) {
                iComputeInt32Size += CodedOutputStream.computeMessageSize(2, this.argument_.get(i11));
            }
            int size = iComputeInt32Size + this.unknownFields.size();
            this.memoizedSerializedSize = size;
            return size;
    ...
    public static final class Class extends GeneratedMessageLite.ExtendableMessage<Class> implements ClassOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i11 = 0; i11 < this.supertypeId_.size(); i11++) {
                iComputeInt32SizeNoTag += CodedOutputStream.computeInt32SizeNoTag(this.supertypeId_.get(i11).intValue());
            }
            ...
            for (int i12 = 0; i12 < this.typeParameter_.size(); i12++) {
                iComputeMessageSize += CodedOutputStream.computeMessageSize(5, this.typeParameter_.get(i12));
            }
            for (int i13 = 0; i13 < this.supertype_.size(); i13++) {
                iComputeMessageSize += CodedOutputStream.computeMessageSize(6, this.supertype_.get(i13));
            }
            int iComputeInt32SizeNoTag2 = 0;
            for (int i14 = 0; i14 < this.nestedClassName_.size(); i14++) {
                iComputeInt32SizeNoTag2 += CodedOutputStream.computeInt32SizeNoTag(this.nestedClassName_.get(i14).intValue());
            }
            ...
            for (int i15 = 0; i15 < this.constructor_.size(); i15++) {
                iComputeMessageSize2 += CodedOutputStream.computeMessageSize(8, this.constructor_.get(i15));
            }
            for (int i16 = 0; i16 < this.function_.size(); i16++) {
                iComputeMessageSize2 += CodedOutputStream.computeMessageSize(9, this.function_.get(i16));
            }
            for (int i17 = 0; i17 < this.property_.size(); i17++) {
                iComputeMessageSize2 += CodedOutputStream.computeMessageSize(10, this.property_.get(i17));
            }
            for (int i18 = 0; i18 < this.typeAlias_.size(); i18++) {
                iComputeMessageSize2 += CodedOutputStream.computeMessageSize(11, this.typeAlias_.get(i18));
            }
            for (int i19 = 0; i19 < this.enumEntry_.size(); i19++) {
                iComputeMessageSize2 += CodedOutputStream.computeMessageSize(13, this.enumEntry_.get(i19));
            }
            int iComputeInt32SizeNoTag3 = 0;
            for (int i20 = 0; i20 < this.sealedSubclassFqName_.size(); i20++) {
                iComputeInt32SizeNoTag3 += CodedOutputStream.computeInt32SizeNoTag(this.sealedSubclassFqName_.get(i20).intValue());
            }
            ...
            for (int i21 = 0; i21 < this.contextReceiverType_.size(); i21++) {
                iComputeMessageSize3 += CodedOutputStream.computeMessageSize(20, this.contextReceiverType_.get(i21));
            }
            int iComputeInt32SizeNoTag4 = 0;
            for (int i22 = 0; i22 < this.contextReceiverTypeId_.size(); i22++) {
                iComputeInt32SizeNoTag4 += CodedOutputStream.computeInt32SizeNoTag(this.contextReceiverTypeId_.get(i22).intValue());
            }
            ...
            for (int i23 = 0; i23 < this.multiFieldValueClassUnderlyingName_.size(); i23++) {
                iComputeInt32SizeNoTag6 += CodedOutputStream.computeInt32SizeNoTag(this.multiFieldValueClassUnderlyingName_.get(i23).intValue());
            }
            ...
            for (int i24 = 0; i24 < this.multiFieldValueClassUnderlyingType_.size(); i24++) {
                iComputeMessageSize4 += CodedOutputStream.computeMessageSize(23, this.multiFieldValueClassUnderlyingType_.get(i24));
            }
            int iComputeInt32SizeNoTag7 = 0;
            for (int i25 = 0; i25 < this.multiFieldValueClassUnderlyingTypeId_.size(); i25++) {
                iComputeInt32SizeNoTag7 += CodedOutputStream.computeInt32SizeNoTag(this.multiFieldValueClassUnderlyingTypeId_.get(i25).intValue());
            }
            ...
            for (int i26 = 0; i26 < this.versionRequirement_.size(); i26++) {
                iComputeInt32SizeNoTag8 += CodedOutputStream.computeInt32SizeNoTag(this.versionRequirement_.get(i26).intValue());
            }
    ...
    public static final class Constructor extends GeneratedMessageLite.ExtendableMessage<Constructor> implements ConstructorOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i11 = 0; i11 < this.valueParameter_.size(); i11++) {
                iComputeInt32Size += CodedOutputStream.computeMessageSize(2, this.valueParameter_.get(i11));
            }
            int iComputeInt32SizeNoTag = 0;
            for (int i12 = 0; i12 < this.versionRequirement_.size(); i12++) {
                iComputeInt32SizeNoTag += CodedOutputStream.computeInt32SizeNoTag(this.versionRequirement_.get(i12).intValue());
            }
    ...
    public static final class Contract extends GeneratedMessageLite implements ContractOrBuilder {
        ...
        public static final class Builder extends GeneratedMessageLite.Builder<Contract, Builder> implements ContractOrBuilder {
            ...
            public Contract buildPartial() {
                ...
                if ((this.bitField0_ & 1) == 1) {
                    this.effect_ = DesugarCollections.unmodifiableList(this.effect_);
                    this.bitField0_ &= -2;
                }
        ...
        public int getSerializedSize() {
            ...
            for (int i11 = 0; i11 < this.effect_.size(); i11++) {
                iComputeMessageSize += CodedOutputStream.computeMessageSize(1, this.effect_.get(i11));
            }
    ...
    public static final class Effect extends GeneratedMessageLite implements EffectOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i11 = 0; i11 < this.effectConstructorArgument_.size(); i11++) {
                iComputeEnumSize += CodedOutputStream.computeMessageSize(2, this.effectConstructorArgument_.get(i11));
            }
            if ((this.bitField0_ & 2) == 2) {
    ...
    public static final class Expression extends GeneratedMessageLite implements ExpressionOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i11 = 0; i11 < this.andArgument_.size(); i11++) {
                iComputeInt32Size += CodedOutputStream.computeMessageSize(6, this.andArgument_.get(i11));
            }
            for (int i12 = 0; i12 < this.orArgument_.size(); i12++) {
                iComputeInt32Size += CodedOutputStream.computeMessageSize(7, this.orArgument_.get(i12));
            }
            int size = iComputeInt32Size + this.unknownFields.size();
            this.memoizedSerializedSize = size;
            return size;
    ...
    public static final class Function extends GeneratedMessageLite.ExtendableMessage<Function> implements FunctionOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i11 = 0; i11 < this.typeParameter_.size(); i11++) {
                iComputeInt32Size += CodedOutputStream.computeMessageSize(4, this.typeParameter_.get(i11));
            }
            if ((this.bitField0_ & 32) == 32) {
            ...
            for (int i12 = 0; i12 < this.valueParameter_.size(); i12++) {
                iComputeInt32Size += CodedOutputStream.computeMessageSize(6, this.valueParameter_.get(i12));
            }
            if ((this.bitField0_ & 16) == 16) {
            ...
            for (int i13 = 0; i13 < this.contextReceiverType_.size(); i13++) {
                iComputeInt32Size += CodedOutputStream.computeMessageSize(10, this.contextReceiverType_.get(i13));
            }
            int iComputeInt32SizeNoTag = 0;
            ...
            for (int i15 = 0; i15 < this.versionRequirement_.size(); i15++) {
                iComputeInt32SizeNoTag2 += CodedOutputStream.computeInt32SizeNoTag(this.versionRequirement_.get(i15).intValue());
            }
            ...
            while (true) {
                ...
                if (!z10) {
                    try {
                        ...
                        if (((i10 == true ? 1 : 0) & 1024) == unknownField) {
                            this.valueParameter_ = DesugarCollections.unmodifiableList(this.valueParameter_);
                        }
    ...
    public static final class Package extends GeneratedMessageLite.ExtendableMessage<Package> implements PackageOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i11 = 0; i11 < this.function_.size(); i11++) {
                iComputeMessageSize += CodedOutputStream.computeMessageSize(3, this.function_.get(i11));
            }
            for (int i12 = 0; i12 < this.property_.size(); i12++) {
                iComputeMessageSize += CodedOutputStream.computeMessageSize(4, this.property_.get(i12));
            }
            for (int i13 = 0; i13 < this.typeAlias_.size(); i13++) {
                iComputeMessageSize += CodedOutputStream.computeMessageSize(5, this.typeAlias_.get(i13));
            }
            if ((this.bitField0_ & 1) == 1) {
                iComputeMessageSize += CodedOutputStream.computeMessageSize(30, this.typeTable_);
            }
    ...
    public static final class PackageFragment extends GeneratedMessageLite.ExtendableMessage<PackageFragment> implements PackageFragmentOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i11 = 0; i11 < this.class__.size(); i11++) {
                iComputeMessageSize += CodedOutputStream.computeMessageSize(4, this.class__.get(i11));
            }
            int iExtensionsSerializedSize = iComputeMessageSize + extensionsSerializedSize() + this.unknownFields.size();
            this.memoizedSerializedSize = iExtensionsSerializedSize;
            return iExtensionsSerializedSize;
    ...
    public static final class Property extends GeneratedMessageLite.ExtendableMessage<Property> implements PropertyOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i12 = 0; i12 < this.contextReceiverType_.size(); i12++) {
                iComputeInt32Size += CodedOutputStream.computeMessageSize(12, this.contextReceiverType_.get(i12));
            }
            int iComputeInt32SizeNoTag = 0;
            for (int i13 = 0; i13 < this.contextReceiverTypeId_.size(); i13++) {
                iComputeInt32SizeNoTag += CodedOutputStream.computeInt32SizeNoTag(this.contextReceiverTypeId_.get(i13).intValue());
            }
            ...
            int iComputeInt32SizeNoTag3 = 0;
            for (int i14 = 0; i14 < this.versionRequirement_.size(); i14++) {
                iComputeInt32SizeNoTag3 += CodedOutputStream.computeInt32SizeNoTag(this.versionRequirement_.get(i14).intValue());
            }
            ...
            while (true) {
                ...
                if (!z10) {
                    try {
                        ...
                        if (((i10 == true ? 1 : 0) & 256) == unknownField) {
                            this.contextReceiverType_ = DesugarCollections.unmodifiableList(this.contextReceiverType_);
                        }
                        if (((i10 == true ? 1 : 0) & 512) == 512) {
                            this.contextReceiverTypeId_ = DesugarCollections.unmodifiableList(this.contextReceiverTypeId_);
    ...
    public static final class QualifiedNameTable extends GeneratedMessageLite implements QualifiedNameTableOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i11 = 0; i11 < this.qualifiedName_.size(); i11++) {
                iComputeMessageSize += CodedOutputStream.computeMessageSize(1, this.qualifiedName_.get(i11));
            }
            int size = iComputeMessageSize + this.unknownFields.size();
            this.memoizedSerializedSize = size;
            return size;
    ...
    public static final class StringTable extends GeneratedMessageLite implements StringTableOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i11 = 0; i11 < this.string_.size(); i11++) {
                iComputeBytesSizeNoTag += CodedOutputStream.computeBytesSizeNoTag(this.string_.getByteString(i11));
            }
    ...
    public static final class TypeAlias extends GeneratedMessageLite.ExtendableMessage<TypeAlias> implements TypeAliasOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i11 = 0; i11 < this.typeParameter_.size(); i11++) {
                iComputeInt32Size += CodedOutputStream.computeMessageSize(3, this.typeParameter_.get(i11));
            }
            if ((this.bitField0_ & 4) == 4) {
            ...
            for (int i12 = 0; i12 < this.annotation_.size(); i12++) {
                iComputeInt32Size += CodedOutputStream.computeMessageSize(8, this.annotation_.get(i12));
            }
            int iComputeInt32SizeNoTag = 0;
            for (int i13 = 0; i13 < this.versionRequirement_.size(); i13++) {
    ...
    public static final class TypeParameter extends GeneratedMessageLite.ExtendableMessage<TypeParameter> implements TypeParameterOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i11 = 0; i11 < this.upperBound_.size(); i11++) {
                iComputeInt32Size += CodedOutputStream.computeMessageSize(5, this.upperBound_.get(i11));
            }
            int iComputeInt32SizeNoTag = 0;
            for (int i12 = 0; i12 < this.upperBoundId_.size(); i12++) {
                iComputeInt32SizeNoTag += CodedOutputStream.computeInt32SizeNoTag(this.upperBoundId_.get(i12).intValue());
            }
            int iComputeInt32SizeNoTag2 = iComputeInt32Size + iComputeInt32SizeNoTag;
    ...
    public static final class TypeTable extends GeneratedMessageLite implements TypeTableOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i11 = 0; i11 < this.type_.size(); i11++) {
                iComputeInt32Size += CodedOutputStream.computeMessageSize(1, this.type_.get(i11));
            }
            if ((this.bitField0_ & 1) == 1) {
    ...
    public static final class VersionRequirementTable extends GeneratedMessageLite implements VersionRequirementTableOrBuilder {
        ...
        public int getSerializedSize() {
            ...
            for (int i11 = 0; i11 < this.requirement_.size(); i11++) {
                iComputeMessageSize += CodedOutputStream.computeMessageSize(1, this.requirement_.get(i11));
            }
            int size = iComputeMessageSize + this.unknownFields.size();
            this.memoizedSerializedSize = size;
            return size;
