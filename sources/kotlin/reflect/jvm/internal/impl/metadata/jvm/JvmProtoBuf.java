    ...
    public static final class StringTableTypes extends GeneratedMessageLite implements StringTableTypesOrBuilder {
        ...
        public static final class Record extends GeneratedMessageLite implements RecordOrBuilder {
            ...
            public int getSerializedSize() {
                ...
                for (int i11 = 0; i11 < this.substringIndex_.size(); i11++) {
                    iComputeInt32SizeNoTag += CodedOutputStream.computeInt32SizeNoTag(this.substringIndex_.get(i11).intValue());
                }
                ...
                for (int i12 = 0; i12 < this.replaceChar_.size(); i12++) {
                    iComputeInt32SizeNoTag3 += CodedOutputStream.computeInt32SizeNoTag(this.replaceChar_.get(i12).intValue());
                }
        ...
        public int getSerializedSize() {
            ...
            for (int i11 = 0; i11 < this.record_.size(); i11++) {
                iComputeMessageSize += CodedOutputStream.computeMessageSize(1, this.record_.get(i11));
            }
            int iComputeInt32SizeNoTag = 0;
            for (int i12 = 0; i12 < this.localName_.size(); i12++) {
                iComputeInt32SizeNoTag += CodedOutputStream.computeInt32SizeNoTag(this.localName_.get(i12).intValue());
            }
