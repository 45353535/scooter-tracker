    ...
    */
    ...
    private static String safeToString(Object obj) {
        try {
            ...
            return "[Exception while computing toString(): " + th2 + C4240b4.j.f42674e;
        }
    }
    ...
    private TypeProjection substituteCompoundType(TypeProjection typeProjection, int i10) throws SubstitutionException {
        ...
        if (type.getConstructor().mo8663getDeclarationDescriptor() instanceof TypeParameterDescriptor) {
            return typeProjection;
        }
        ...
        KotlinType kotlinTypeReplace = TypeSubstitutionKt.replace(type, substituteTypeArguments(type.getConstructor().getParameters(), type.getArguments(), i10), this.substitution.filterAnnotations(type.getAnnotations()));
    ...
    private List<TypeProjection> substituteTypeArguments(List<TypeParameterDescriptor> list, List<TypeProjection> list2, int i10) throws SubstitutionException {
        ...
        for (int i11 = 0; i11 < list.size(); i11++) {
            ...
            TypeProjection typeProjectionUnsafeSubstitute = unsafeSubstitute(typeProjection, typeParameterDescriptor, i10 + 1);
            int i12 = AnonymousClass2.$SwitchMap$org$jetbrains$kotlin$types$TypeSubstitutor$VarianceConflictType[conflictType(typeParameterDescriptor.getVariance(), typeProjectionUnsafeSubstitute.getProjectionKind()).ordinal()];
            if (i12 == 1 || i12 == 2) {
    ...
    private TypeProjection unsafeSubstitute(@NotNull TypeProjection typeProjection, @Nullable TypeParameterDescriptor typeParameterDescriptor, int i10) throws SubstitutionException {
        ...
        if (!typeProjection.isStarProjection()) {
            ...
            if (type instanceof TypeWithEnhancement) {
                ...
                TypeProjection typeProjectionUnsafeSubstitute = unsafeSubstitute(new TypeProjectionImpl(typeProjection.getProjectionKind(), origin), typeParameterDescriptor, i10 + 1);
            ...
            if (!DynamicTypesKt.isDynamic(type) && !(type.unwrap() instanceof RawType)) {
                TypeProjection typeProjectionMo8668get = this.substitution.mo8668get(type);
                TypeProjection typeProjectionProjectedTypeForConflictedTypeWithUnsafeVariance = typeProjectionMo8668get != null ? projectedTypeForConflictedTypeWithUnsafeVariance(type, typeProjectionMo8668get, typeParameterDescriptor, typeProjection) : null;
                Variance projectionKind = typeProjection.getProjectionKind();
                if (typeProjectionProjectedTypeForConflictedTypeWithUnsafeVariance == null && FlexibleTypesKt.isFlexible(type) && !TypeCapabilitiesKt.isCustomTypeParameter(type)) {
                    ...
                    int i11 = i10 + 1;
                    TypeProjection typeProjectionUnsafeSubstitute2 = unsafeSubstitute(new TypeProjectionImpl(projectionKind, flexibleTypeAsFlexibleType.getLowerBound()), typeParameterDescriptor, i11);
                    TypeProjection typeProjectionUnsafeSubstitute3 = unsafeSubstitute(new TypeProjectionImpl(projectionKind, flexibleTypeAsFlexibleType.getUpperBound()), typeParameterDescriptor, i11);
                    ...
                    if (typeProjectionProjectedTypeForConflictedTypeWithUnsafeVariance != null) {
                        ...
                        if (!CapturedTypeConstructorKt.isCaptured(type)) {
                            int i12 = AnonymousClass2.$SwitchMap$org$jetbrains$kotlin$types$TypeSubstitutor$VarianceConflictType[varianceConflictTypeConflictType.ordinal()];
                            if (i12 == 1) {
