...
public abstract class AbstractClassTypeConstructor extends AbstractTypeConstructor {
    ...
    */
    ...
    protected KotlinType defaultSupertypeIfEmpty() {
        if (KotlinBuiltIns.isSpecialClassWithNoSupertypes(mo8663getDeclarationDescriptor())) {
            return null;
        }
    ...
    protected Collection<KotlinType> getAdditionalNeighboursInSupertypeGraph(boolean z10) {
        DeclarationDescriptor containingDeclaration = mo8663getDeclarationDescriptor().getContainingDeclaration();
        ...
        ClassDescriptor classDescriptorMo8656getCompanionObjectDescriptor = classDescriptor.mo8656getCompanionObjectDescriptor();
        if (z10 && classDescriptorMo8656getCompanionObjectDescriptor != null) {
            smartList.add(classDescriptorMo8656getCompanionObjectDescriptor.getDefaultType());
        }
        return smartList;
    }
    ...
    public KotlinBuiltIns getBuiltIns() {
        KotlinBuiltIns builtIns = DescriptorUtilsKt.getBuiltIns(mo8663getDeclarationDescriptor());
        if (builtIns == null) {
            $$$reportNull$$$0(1);
        }
        return builtIns;
    ...
    public abstract ClassDescriptor mo8663getDeclarationDescriptor();
    ...
    protected boolean isSameClassifier(@NotNull ClassifierDescriptor classifierDescriptor) {
        ...
        return (classifierDescriptor instanceof ClassDescriptor) && areFqNamesEqual(mo8663getDeclarationDescriptor(), classifierDescriptor);
    }
}
