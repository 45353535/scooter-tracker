...
public final class OperatorNameConventions {
    ...
    static {
        ...
        TOKENS_BY_OPERATOR_NAME = MapsKt.mapOf(TuplesKt.to(nameIdentifier22, "++"), TuplesKt.to(nameIdentifier23, "--"), TuplesKt.to(nameIdentifier28, "+"), TuplesKt.to(nameIdentifier27, TokenBuilder.TOKEN_DELIMITER), TuplesKt.to(nameIdentifier26, "!"), TuplesKt.to(nameIdentifier29, ProxyConfig.MATCH_ALL_SCHEMES), TuplesKt.to(nameIdentifier24, "+"), TuplesKt.to(nameIdentifier25, TokenBuilder.TOKEN_DELIMITER), TuplesKt.to(nameIdentifier30, "/"), TuplesKt.to(nameIdentifier32, "%"), TuplesKt.to(nameIdentifier33, ".."), TuplesKt.to(nameIdentifier34, "..<"));
    }
