...
public abstract class AbstractTypeParameterDescriptor extends DeclarationDescriptorNonRootImpl implements TypeParameterDescriptor {
    ...
    private class TypeParameterTypeConstructor extends AbstractTypeConstructor {
        ...
        protected void reportSupertypeLoopError(@NotNull KotlinType kotlinType) {
            ...
            this.this$0.mo8666reportSupertypeLoopError(kotlinType);
        }
    ...
    public List<KotlinType> getUpperBounds() {
        List<KotlinType> listMo8664getSupertypes = ((TypeParameterTypeConstructor) getTypeConstructor()).mo8664getSupertypes();
        if (listMo8664getSupertypes == null) {
            $$$reportNull$$$0(8);
        }
        return listMo8664getSupertypes;
    }
    ...
    protected abstract void mo8666reportSupertypeLoopError(@NotNull KotlinType kotlinType);
