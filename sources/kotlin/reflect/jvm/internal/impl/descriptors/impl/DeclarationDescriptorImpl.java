...
public abstract class DeclarationDescriptorImpl extends AnnotatedImpl implements DeclarationDescriptor {
    ...
    public static String toString(@NotNull DeclarationDescriptor declarationDescriptor) {
        ...
        try {
            String str = DescriptorRenderer.DEBUG_TEXT.render(declarationDescriptor) + C4240b4.j.f42672d + declarationDescriptor.getClass().getSimpleName() + "@" + Integer.toHexString(System.identityHashCode(declarationDescriptor)) + C4240b4.j.f42674e;
            if (str == null) {
                $$$reportNull$$$0(5);
            }
            return str;
