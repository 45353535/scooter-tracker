...
public final class JvmPackagePartSource implements DeserializedContainerSource {
    ...
    public JvmPackagePartSource(@NotNull JvmClassName className, @Nullable JvmClassName jvmClassName, @NotNull ProtoBuf.Package packageProto, @NotNull NameResolver nameResolver, @Nullable IncompatibleVersionErrorData<JvmMetadataVersion> incompatibleVersionErrorData, boolean z10, @NotNull DeserializedContainerAbiStability abiStability, @Nullable KotlinJvmBinaryClass kotlinJvmBinaryClass) {
        ...
        this.moduleName = (num == null || (string = nameResolver.getString(num.intValue())) == null) ? C4240b4.i.Z : string;
    }
    ...
    public final Name getSimpleName() {
        ...
        Name nameIdentifier = Name.identifier(StringsKt.k1(internalName, IOUtils.DIR_SEPARATOR_UNIX, null, 2, null));
    ...
    public JvmPackagePartSource(@NotNull KotlinJvmBinaryClass kotlinClass, @NotNull ProtoBuf.Package packageProto, @NotNull NameResolver nameResolver, @Nullable IncompatibleVersionErrorData<JvmMetadataVersion> incompatibleVersionErrorData, boolean z10, @NotNull DeserializedContainerAbiStability abiStability) {
        ...
        this(jvmClassNameByClassId, jvmClassNameByInternalName, packageProto, nameResolver, incompatibleVersionErrorData, z10, abiStability, kotlinClass);
    }
}
