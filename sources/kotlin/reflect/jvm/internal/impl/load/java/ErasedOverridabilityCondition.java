    ...
    public ExternalOverridabilityCondition.Result isOverridable(@NotNull CallableDescriptor superDescriptor, @NotNull CallableDescriptor subDescriptor, @Nullable ClassDescriptor classDescriptor) {
        ...
        if (subDescriptor instanceof JavaMethodDescriptor) {
            ...
            if (typeParameters.isEmpty()) {
                ...
                Sequence sequenceQ = k.Q(CollectionsKt.asSequence(valueParameters), new Function1() { // from class: kotlin.reflect.jvm.internal.impl.load.java.ErasedOverridabilityCondition$$Lambda$0
                ...
                Sequence sequenceV = k.V(sequenceQ, returnType);
                ReceiverParameterDescriptor extensionReceiverParameter = javaMethodDescriptor.getExtensionReceiverParameter();
                for (KotlinType kotlinType : k.U(sequenceV, CollectionsKt.listOfNotNull(extensionReceiverParameter != null ? extensionReceiverParameter.getType() : null))) {
