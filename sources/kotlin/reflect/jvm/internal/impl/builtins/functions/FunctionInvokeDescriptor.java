...
public final class FunctionInvokeDescriptor extends SimpleFunctionDescriptorImpl {
    ...
    public static final class Factory {
        ...
        private final ValueParameterDescriptor createValueParameter(FunctionInvokeDescriptor functionInvokeDescriptor, int i10, TypeParameterDescriptor typeParameterDescriptor) {
            ...
            return new ValueParameterDescriptorImpl(functionInvokeDescriptor, null, i10, empty, nameIdentifier, defaultType, false, false, false, null, NO_SOURCE);
        }
    ...
    private final FunctionDescriptor replaceParameterNames(List<Name> list) {
        ...
        FunctionDescriptorImpl.CopyConfiguration original = copyConfigurationNewCopyBuilder.setHasSynthesizedParameterNames(z10).setValueParameters((List<ValueParameterDescriptor>) arrayList).setOriginal((CallableMemberDescriptor) getOriginal());
