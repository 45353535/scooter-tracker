...
public final class FunctionTypesKt {
    public static final int contextFunctionTypeParamsCount(@NotNull KotlinType kotlinType) {
        ...
        AnnotationDescriptor annotationDescriptorMo8658findAnnotation = kotlinType.getAnnotations().mo8658findAnnotation(StandardNames.FqNames.contextFunctionTypeParams);
        if (annotationDescriptorMo8658findAnnotation == null) {
            return 0;
        }
        ConstantValue constantValue = (ConstantValue) MapsKt.getValue(annotationDescriptorMo8658findAnnotation.getAllValueArguments(), StandardNames.CONTEXT_FUNCTION_TYPE_PARAMETER_COUNT_NAME);
    ...
    public static final SimpleType createFunctionType(@NotNull KotlinBuiltIns builtIns, @NotNull Annotations annotations, @Nullable KotlinType kotlinType, @NotNull List<? extends KotlinType> contextReceiverTypes, @NotNull List<? extends KotlinType> parameterTypes, @Nullable List<Name> list, @NotNull KotlinType returnType, boolean z10) {
        ...
        ClassDescriptor functionDescriptor = getFunctionDescriptor(builtIns, parameterTypes.size() + contextReceiverTypes.size() + (kotlinType == null ? 0 : 1), z10);
        if (kotlinType != null) {
    ...
    public static final Name extractParameterNameFromFunctionTypeArgument(@NotNull KotlinType kotlinType) {
        String value;
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        AnnotationDescriptor annotationDescriptorMo8658findAnnotation = kotlinType.getAnnotations().mo8658findAnnotation(StandardNames.FqNames.parameterName);
        if (annotationDescriptorMo8658findAnnotation == null) {
            return null;
        }
    ...
    public static final FunctionTypeKind getFunctionTypeKind(@NotNull KotlinType kotlinType) {
        ...
        if (classifierDescriptorMo8663getDeclarationDescriptor != null) {
            return getFunctionTypeKind(classifierDescriptorMo8663getDeclarationDescriptor);
        }
        return null;
    }
    ...
    public static final boolean isBuiltinFunctionalType(@NotNull KotlinType kotlinType) {
        Intrinsics.checkNotNullParameter(kotlinType, "<this>");
        ClassifierDescriptor classifierDescriptorMo8663getDeclarationDescriptor = kotlinType.getConstructor().mo8663getDeclarationDescriptor();
        return classifierDescriptorMo8663getDeclarationDescriptor != null && isBuiltinFunctionalClassDescriptor(classifierDescriptorMo8663getDeclarationDescriptor);
    }
    ...
    private static final boolean isTypeAnnotatedWithExtensionFunctionType(KotlinType kotlinType) {
        return kotlinType.getAnnotations().mo8658findAnnotation(StandardNames.FqNames.extensionFunctionType) != null;
    }
