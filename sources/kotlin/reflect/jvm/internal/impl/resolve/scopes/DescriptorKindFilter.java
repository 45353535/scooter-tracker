...
public final class DescriptorKindFilter {
    ...
    static {
        ...
        int i10 = iNextMask | iNextMask2 | iNextMask3;
        CLASSIFIERS_MASK = i10;
        int i11 = iNextMask2 | iNextMask5 | iNextMask6;
        VALUES_MASK = i11;
        int i12 = iNextMask5 | iNextMask6;
        CALLABLES_MASK = i12;
        int i13 = 2;
        ALL = new DescriptorKindFilter(iNextMask7, 0 == true ? 1 : 0, i13, 0 == true ? 1 : 0);
        CALLABLES = new DescriptorKindFilter(i12, 0 == true ? 1 : 0, i13, 0 == true ? 1 : 0);
        NON_SINGLETON_CLASSIFIERS = new DescriptorKindFilter(iNextMask, 0 == true ? 1 : 0, i13, 0 == true ? 1 : 0);
        SINGLETON_CLASSIFIERS = new DescriptorKindFilter(iNextMask2, 0 == true ? 1 : 0, i13, 0 == true ? 1 : 0);
        TYPE_ALIASES = new DescriptorKindFilter(iNextMask3, 0 == true ? 1 : 0, i13, 0 == true ? 1 : 0);
        CLASSIFIERS = new DescriptorKindFilter(i10, 0 == true ? 1 : 0, i13, 0 == true ? 1 : 0);
        PACKAGES = new DescriptorKindFilter(iNextMask4, 0 == true ? 1 : 0, i13, 0 == true ? 1 : 0);
        FUNCTIONS = new DescriptorKindFilter(iNextMask5, 0 == true ? 1 : 0, i13, 0 == true ? 1 : 0);
        VARIABLES = new DescriptorKindFilter(iNextMask6, 0 == true ? 1 : 0, i13, 0 == true ? 1 : 0);
