...
public final class InlineClassManglingRulesKt {
    ...
    private static final boolean isTypeParameterWithUpperBoundThatRequiresMangling(KotlinType kotlinType, boolean z10) {
        ...
        return (z10 || !InlineClassesUtilsKt.isMultiFieldValueClass(typeParameterDescriptor)) && requiresFunctionNameManglingInParameterTypes(TypeUtilsKt.getRepresentativeUpperBound(typeParameterDescriptor));
    }
    ...
    public static final boolean isValueClassThatRequiresMangling(@NotNull KotlinType kotlinType) {
        ...
        ClassifierDescriptor classifierDescriptorMo8663getDeclarationDescriptor = kotlinType.getConstructor().mo8663getDeclarationDescriptor();
        return classifierDescriptorMo8663getDeclarationDescriptor != null && ((InlineClassesUtilsKt.isInlineClass(classifierDescriptorMo8663getDeclarationDescriptor) && isValueClassThatRequiresMangling(classifierDescriptorMo8663getDeclarationDescriptor)) || InlineClassesUtilsKt.needsMfvcFlattening(kotlinType));
    }
}
