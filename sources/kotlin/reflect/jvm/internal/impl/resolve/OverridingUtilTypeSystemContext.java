...
public final class OverridingUtilTypeSystemContext implements ClassicTypeSystemContext {
    ...
    public TypeArgumentMarker get(TypeArgumentListMarker typeArgumentListMarker, int i10) {
        ...
        throw new IllegalStateException(("unknown type argument list type: " + typeArgumentListMarker + ", " + v0.b(typeArgumentListMarker.getClass())).toString());
    }
    ...
    public TypeCheckerState newTypeCheckerState(boolean z10, boolean z11) {
        if (this.customSubtype != null) {
            return new TypeCheckerState(z10, z11, this, this.kotlinTypePreparator, this.kotlinTypeRefiner) { // from class: kotlin.reflect.jvm.internal.impl.resolve.OverridingUtilTypeSystemContext.newTypeCheckerState.1
