...
public final class KParameterImpl implements KParameter {
    static final /* synthetic */ KProperty<Object>[] $$delegatedProperties = {v0.j(new n0(KParameterImpl.class, "descriptor", "getDescriptor()Lorg/jetbrains/kotlin/descriptors/ParameterDescriptor;", 0)), v0.j(new n0(KParameterImpl.class, "annotations", "getAnnotations()Ljava/util/List;", 0))};
    ...
    private static final class CompoundTypeImpl implements Type {
        ...
        public String getTypeName() {
            return ArraysKt.joinToString$default(this.types, ", ", C4240b4.j.f42672d, C4240b4.j.f42674e, 0, (CharSequence) null, (Function1) null, 56, (Object) null);
        }
    ...
    public static final Type _get_type_$lambda$1(KParameterImpl kParameterImpl) {
        ...
        if (kParameterImpl.callable.isBound()) {
            ...
            int iF = valueClassAwareCaller.getRealSlicesOfParameters(0).f() + 1;
            listSlice = CollectionsKt.slice((List) valueClassAwareCaller.getParameterTypes(), new IntRange(realSlicesOfParameters.e() - iF, realSlicesOfParameters.f() - iF));
        } else {
