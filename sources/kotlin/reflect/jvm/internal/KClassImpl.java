...
public final class KClassImpl<T> extends KDeclarationContainerImpl implements KClass<T>, KClassifierImpl, KTypeParameterOwnerImpl {
    ...
    public final class Data extends KDeclarationContainerImpl.Data {
        static final /* synthetic */ KProperty<Object>[] $$delegatedProperties = {v0.j(new n0(Data.class, "descriptor", "getDescriptor()Lorg/jetbrains/kotlin/descriptors/ClassDescriptor;", 0)), v0.j(new n0(Data.class, "annotations", "getAnnotations()Ljava/util/List;", 0)), v0.j(new n0(Data.class, "simpleName", "getSimpleName()Ljava/lang/String;", 0)), v0.j(new n0(Data.class, "qualifiedName", "getQualifiedName()Ljava/lang/String;", 0)), v0.j(new n0(Data.class, "constructors", "getConstructors()Ljava/util/Collection;", 0)), v0.j(new n0(Data.class, "nestedClasses", "getNestedClasses()Ljava/util/Collection;", 0)), v0.j(new n0(Data.class, "typeParameters", "getTypeParameters()Ljava/util/List;", 0)), v0.j(new n0(Data.class, "supertypes", "getSupertypes()Ljava/util/List;", 0)), v0.j(new n0(Data.class, "sealedSubclasses", "getSealedSubclasses()Ljava/util/List;", 0)), v0.j(new n0(Data.class, "declaredNonStaticMembers", "getDeclaredNonStaticMembers()Ljava/util/Collection;", 0)), v0.j(new n0(Data.class, "declaredStaticMembers", "getDeclaredStaticMembers()Ljava/util/Collection;", 0)), v0.j(new n0(Data.class, "inheritedNonStaticMembers", "getInheritedNonStaticMembers()Ljava/util/Collection;", 0)), v0.j(new n0(Data.class, "inheritedStaticMembers", "getInheritedStaticMembers()Ljava/util/Collection;", 0)), v0.j(new n0(Data.class, "allNonStaticMembers", "getAllNonStaticMembers()Ljava/util/Collection;", 0)), v0.j(new n0(Data.class, "allStaticMembers", "getAllStaticMembers()Ljava/util/Collection;", 0)), v0.j(new n0(Data.class, "declaredMembers", "getDeclaredMembers()Ljava/util/Collection;", 0)), v0.j(new n0(Data.class, "allMembers", "getAllMembers()Ljava/util/Collection;", 0))};
        ...
        public Data() {
            ...
            this.objectInstance = i.b(l.f94210c, new Function0(this, KClassImpl.this) { // from class: kotlin.reflect.jvm.internal.KClassImpl$Data$$Lambda$6
                private final KClassImpl.Data arg$0;
        ...
        private final String calculateLocalClassName(Class<?> jClass) {
            ...
            if (enclosingMethod != null) {
                ...
                return StringsKt.h1(simpleName, enclosingMethod.getName() + '$', null, 2, null);
            }
        ...
        public static final List supertypes_delegate$lambda$18(final Data data, final KClassImpl kClassImpl) {
            Collection<KotlinType> collectionMo8664getSupertypes = data.getDescriptor().getTypeConstructor().mo8664getSupertypes();
            Intrinsics.checkNotNullExpressionValue(collectionMo8664getSupertypes, "getSupertypes(...)");
            ArrayList arrayList = new ArrayList(collectionMo8664getSupertypes.size());
            for (final KotlinType kotlinType : collectionMo8664getSupertypes) {
        ...
        public static final Type supertypes_delegate$lambda$18$lambda$15$lambda$14(KotlinType kotlinType, Data data, KClassImpl kClassImpl) {
            ...
            if (!(classifierDescriptorMo8663getDeclarationDescriptor instanceof ClassDescriptor)) {
                throw new KotlinReflectionInternalError("Supertype not a class: " + classifierDescriptorMo8663getDeclarationDescriptor);
            }
            Class<?> javaClass = UtilKt.toJavaClass((ClassDescriptor) classifierDescriptorMo8663getDeclarationDescriptor);
            if (javaClass == null) {
                throw new KotlinReflectionInternalError("Unsupported superclass of " + data + ": " + classifierDescriptorMo8663getDeclarationDescriptor);
            }
            ...
            throw new KotlinReflectionInternalError("No superclass of " + data + " in Java reflection for " + classifierDescriptorMo8663getDeclarationDescriptor);
        }
    ...
    public KClassImpl(@NotNull Class<T> jClass) {
        ...
        this.jClass = jClass;
        this.data = i.b(l.f94210c, new Function0(this) { // from class: kotlin.reflect.jvm.internal.KClassImpl$$Lambda$0
            private final KClassImpl arg$0;
    ...
    public boolean equals(@Nullable Object other) {
        return (other instanceof KClassImpl) && Intrinsics.areEqual(xf.a.c(this), xf.a.c((KClass) other));
    }
    ...
    @Override // kotlin.reflect.jvm.internal.KDeclarationContainerImpl, kotlin.jvm.internal.q
    @NotNull
    ...
    public PropertyDescriptor getLocalProperty(int index) {
        ...
        if (Intrinsics.areEqual(getJClass().getSimpleName(), "DefaultImpls") && (declaringClass = getJClass().getDeclaringClass()) != null && declaringClass.isInterface()) {
            KClass kClassE = xf.a.e(declaringClass);
            Intrinsics.checkNotNull(kClassE, "null cannot be cast to non-null type kotlin.reflect.jvm.internal.KClassImpl<*>");
            return ((KClassImpl) kClassE).getLocalProperty(index);
        }
        ClassDescriptor descriptor = getDescriptor();
    ...
    public boolean isInstance(@Nullable Object value) {
        ...
        if (functionClassArity != null) {
            return b1.o(value, functionClassArity.intValue());
        }
    ...
    public String toString() {
        ...
        sb2.append(str + StringsKt.V(classId.getRelativeClassName().asString(), '.', '$', false, 4, null));
        return sb2.toString();
    }
