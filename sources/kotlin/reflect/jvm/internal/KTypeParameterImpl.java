...
public final class KTypeParameterImpl implements KTypeParameter, KClassifierImpl {
    static final /* synthetic */ KProperty<Object>[] $$delegatedProperties = {v0.j(new n0(KTypeParameterImpl.class, "upperBounds", "getUpperBounds()Ljava/util/List;", 0))};
        ...
        if (kTypeParameterOwnerImpl == null) {
            ...
            if (containingDeclaration instanceof ClassDescriptor) {
                ...
                if (containingDeclaration2 instanceof ClassDescriptor) {
                    ...
                    KClass kClassE = xf.a.e(getContainerClass(deserializedMemberDescriptor));
                    Intrinsics.checkNotNull(kClassE, "null cannot be cast to non-null type kotlin.reflect.jvm.internal.KClassImpl<*>");
                    kClassImpl = (KClassImpl) kClassE;
                }
                objAccept = containingDeclaration.accept(new CreateKCallableVisitor(kClassImpl), Unit.f93236a);
            }
    ...
    private final KClassImpl<?> toKClassImpl(ClassDescriptor classDescriptor) {
        ...
        KClassImpl<?> kClassImpl = (KClassImpl) (javaClass != null ? xf.a.e(javaClass) : null);
        if (kClassImpl != null) {
            return kClassImpl;
        }
