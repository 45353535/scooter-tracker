...
public final class ReflectJvmMapping {
    ...
    public static final <T> Constructor<T> getJavaConstructor(@NotNull KFunction<? extends T> kFunction) {
        ...
        Member memberMo8655getMember = (kCallableImplAsKCallableImpl == null || (caller = kCallableImplAsKCallableImpl.getCaller()) == null) ? null : caller.mo8655getMember();
        if (memberMo8655getMember instanceof Constructor) {
            return (Constructor) memberMo8655getMember;
        }
        return null;
    }
    ...
    public static final Method getJavaMethod(@NotNull KFunction<?> kFunction) {
        ...
        KCallableImpl<?> kCallableImplAsKCallableImpl = UtilKt.asKCallableImpl(kFunction);
        Member memberMo8655getMember = (kCallableImplAsKCallableImpl == null || (caller = kCallableImplAsKCallableImpl.getCaller()) == null) ? null : caller.mo8655getMember();
        if (memberMo8655getMember instanceof Method) {
            return (Method) memberMo8655getMember;
        }
        return null;
    }
    ...
    public static final KFunction<?> getKotlinFunction(@NotNull Method method) {
        ...
        if (Modifier.isStatic(method.getModifiers())) {
            ...
            Intrinsics.checkNotNullExpressionValue(declaringClass, "getDeclaringClass(...)");
            KClass<?> companionObject = KClasses.getCompanionObject(a.e(declaringClass));
            if (companionObject != null) {
                Class clsB = a.b(companionObject);
                String name = method.getName();
                Intrinsics.checkNotNullExpressionValue(name, "getName(...)");
                Class<?>[] parameterTypes = method.getParameterTypes();
                Method declaredMethodOrNull = UtilKt.getDeclaredMethodOrNull(clsB, name, (Class[]) Arrays.copyOf(parameterTypes, parameterTypes.length));
        ...
        Intrinsics.checkNotNullExpressionValue(declaringClass2, "getDeclaringClass(...)");
        return findKFunction(KClasses.getFunctions(a.e(declaringClass2)), method);
    }
    ...
    public static final KProperty<?> getKotlinProperty(@NotNull Field field) {
        ...
        return findKProperty(KClasses.getMemberProperties(a.e(declaringClass3)), field);
    }
    ...
    public static final <T> KFunction<T> getKotlinFunction(@NotNull Constructor<T> constructor) {
        ...
        Intrinsics.checkNotNullExpressionValue(declaringClass, "getDeclaringClass(...)");
        Iterator<T> it = a.e(declaringClass).getConstructors().iterator();
        while (true) {
            if (!it.hasNext()) {
                next = null;
                break;
