...
public class Intrinsics {
    ...
    public static void checkHasClass(String str) throws ClassNotFoundException {
        ...
        try {
            ...
            throw ((ClassNotFoundException) sanitizeStackTrace(new ClassNotFoundException("Class " + strReplace + " is not found. Please update the Kotlin runtime to the latest version", e10)));
        }
    }
    ...
    public static void throwNpe() {
        throw ((lf.h) sanitizeStackTrace(new lf.h()));
    }
    ...
    public static void throwUninitializedProperty(String str) {
        throw ((lf.a0) sanitizeStackTrace(new lf.a0(str)));
    }
    ...
    static <T extends Throwable> T sanitizeStackTrace(T t10, String str) {
    ...
    public static void throwNpe(String str) {
        throw ((lf.h) sanitizeStackTrace(new lf.h(str)));
    }
    ...
    public static void checkHasClass(String str, String str2) throws ClassNotFoundException {
        ...
        try {
            ...
            throw ((ClassNotFoundException) sanitizeStackTrace(new ClassNotFoundException("Class " + strReplace + " is not found: this code requires the Kotlin runtime of version at least " + str2, e10)));
        }
    }
