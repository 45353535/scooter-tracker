...
public interface CoroutineContext {
    ...
    public interface Element extends CoroutineContext {
        ...
        public static final class a {
            ...
            public static CoroutineContext c(Element element, b key) {
                Intrinsics.checkNotNullParameter(key, "key");
                return Intrinsics.areEqual(element.getKey(), key) ? e.f93267b : element;
            }
    ...
    public static final class a {
        public static CoroutineContext b(CoroutineContext coroutineContext, CoroutineContext context) {
            Intrinsics.checkNotNullParameter(context, "context");
            return context == e.f93267b ? coroutineContext : (CoroutineContext) context.fold(coroutineContext, new Function2() { // from class: of.d
